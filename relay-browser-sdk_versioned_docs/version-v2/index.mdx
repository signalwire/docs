...
The SDKs that run on the client side, like the [JS SDK](/sdks/relay-browser-sdk) or [React Native SDK](https://docs.signalwire.com/reference/relay-sdk-react-native/v1/#relay-sdk-for-react-native), cannot safely use the **Project Token** to authenticate your users as you do in the other, server-side SDKs.
...
For more information about automatically refreshing JWT as they're about to expire, see [`refreshToken` Event Documentation](/sdks/relay-browser-sdk/v2/client#refreshtoken)
