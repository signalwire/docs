...
This is a generic method that allows you to dial multiple devices in series, parallel, or combinations of both with the use of a [DeviceBuilder](./voice-devicebuilder.md). For simpler use cases, prefer using [dialPhone](./voice-client.mdx#dialphone) or [dialSip](./voice-client.mdx#dialsip).
