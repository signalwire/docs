...
- [RealtimeClient](/sdks/realtime-sdk/v3/tech-ref/realtime-client)

## Functions

### ~~createClient~~

▸ `Const` **createClient**(`userOptions`): `Promise<RealtimeClient>` ⚠️ **Deprecated** — See [RealtimeClient](/sdks/realtime-sdk/v3/tech-ref/realtime-client) for more details.

> ⚠️ **Deprecated**  
> You no longer need to create the client manually. You can use the product constructors, like [Video.Client](/sdks/realtime-sdk/v3/tech-ref/video/room-session), to access the same functionality.
...
`Promise<RealtimeClient>` ⚠️ **Deprecated** — See [RealtimeClient](/sdks/realtime-sdk/v3/tech-ref/realtime-client) for more details.
