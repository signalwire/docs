...
Please use [getRecordings](#getrecordings) instead.
...
▸ **getPlaybacks**(): `Promise<{ playbacks: RoomSessionPlayback }>` - See [RoomSessionPlayback](./video-roomsessionplayback.md) for more details.

Obtains a list of playbacks for the current room session.

#### Returns

`Promise<{ playbacks: RoomSessionPlayback }>` - See [RoomSessionPlayback](./video-roomsessionplayback.md) for more details.
...
▸ **getRecordings**(): `Promise<{ recordings: RoomSessionRecording }>` - See [RoomSessionRecording](./video-roomsessionrecording.md) for more details.

Obtains a list of recordings for the current room session.

#### Returns

`Promise<{ recordings: RoomSessionRecording }>` - See [RoomSessionRecording](./video-roomsessionrecording.md) for more details.
...
▸ **getStreams**(): `Promise<{ streams: RoomSessionStream }>` - See [RoomSessionStream](./video-roomsessionstream.mdx) for more details.
...
`Promise<{ streams: RoomSessionStream }>` - See [RoomSessionStream](./video-roomsessionstream.mdx) for more details.
...
▸ **play**(`params`): `Promise<RoomSessionPlayback>` - See [RoomSessionPlayback](./video-roomsessionplayback.md) for more details.
...
`Promise<RoomSessionPlayback>` - See [RoomSessionPlayback](./video-roomsessionplayback.md) for more details.
...
Show or hide muted videos in the room layout. Members that have been muted via [videoMute](./video-roomsession.mdx#videomute) not appear in the video stream, instead of appearing as a mute image, if this setting is enabled.
...
> ⚠️ Deprecated.
> Use [setInputVolume](./video-roomsession.mdx#setinputvolume) instead.
...
> ⚠️ Deprecated.
> Use [setOutputVolume](./video-roomsession.mdx#setoutputvolume) instead.
...
▸ **startRecording**(): `Promise<RoomSessionRecording>` - See [RoomSessionRecording](./video-roomsessionrecording.md) for more details.
...
`Promise<RoomSessionRecording>` - See [RoomSessionRecording](./video-roomsessionrecording.md) for more details.
...
▸ **startStream**(): `Promise<RoomSessionStream>` - See [RoomSessionStream](./video-roomsessionstream.mdx) for more details.
...
`Promise<RoomSessionStream>` - See [RoomSessionStream](./video-roomsessionstream.mdx) for more details.
...
▸ **subscribe**(): `Promise<RoomSessionFullState>` - See [RoomSessionFullState](./video-roomsessionfullstate.md) for more details.

Listens for the events for which you have provided event handlers and returns the [RoomSessionFullState](./video-roomsessionfullstate.md) that contains the full state of the room session.

Note that you don't need to manually call this method to start listening to events, since they are listened automatically.

#### Returns

`Promise<RoomSessionFullState>` - See [RoomSessionFullState](./video-roomsessionfullstate.md) for more details.
...
Emitted when the room session is, respectively, started, updated, or ended. Your event handler receives an object which is an instance of [RoomSession](./video-roomsession.mdx).

- **recording.started**,
- **recording.updated**,
- **recording.ended**:

Emitted when a recording is, respectively, started, updated, or ended. Your event handler receives an object which is an instance of [RoomSessionRecording](./video-roomsessionrecording.md).

- **playback.started**,
- **playback.updated**,
- **playback.ended**:

Emitted when a playback is, respectively, started, updated, or ended. Your event handler receives an object which is an instance of [RoomSessionPlayback](./video-roomsessionplayback.md).
...
Emitted when a member joins the room. Your event handler receives an object of type [RoomSessionMember](./video-roomsessionmember.md).

- **member.left**:

Emitted when a member leaves the room. Your event handler receives an object of type [RoomSessionMember](./video-roomsessionmember.md).

- **member.talking**:

Emitted when a member starts or stops talking. Your event handler receives an object of type [RoomSessionMember](./video-roomsessionmember.md).

- **member.talking.started**:

Emitted when a member starts talking. Your event handler receives an object of type [RoomSessionMember](./video-roomsessionmember.md).

- **member.talking.ended**:

Emitted when a member stops talking. Your event handler receives an object of type [RoomSessionMember](./video-roomsessionmember.md).

- **member.updated**:

Emitted when any property of one of the members is updated. Your event handler receives an object `member` of type [RoomSessionMember](./video-roomsessionmember.md). Use
...
Each of the above events is emitted when the associated property changes. Your event handler receives an object `member` of type [RoomSessionMember](./video-roomsessionmember.md).
