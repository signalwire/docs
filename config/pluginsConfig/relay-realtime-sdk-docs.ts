...
export const relayRealtimeSdkPlugin: PluginConfig = [
  "@docusaurus/plugin-content-docs",
  {
    id: "relay-realtime-sdk",
    path: "relay-realtime-sdk-docs",
    routeBasePath: "sdks/relay-realtime-sdk",
    sidebarPath: require.resolve("../sidebarsConfig/relay-realtime-sdk/index.ts"),
