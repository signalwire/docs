...
<Frame caption="The redesigned main menu.">
  ![The main sidebar menu of the new SignalWire Space Dashboard UI.](/docs/assets/images/dashboard/sidebar/new-sidebar.webp)
</Frame>
...
<Frame caption="The new SignalWire Dashboard features a streamlined sidebar menu. Many items are now located in the unified My Resources menu.">
  ![The selection menu when a new Resource is created.](/docs/assets/images/dashboard/resources/add-new-resource.webp)
</Frame>
...
<Frame caption="The legacy main menu.">
  ![The main sidebar menu of the legacy SignalWire Space Dashboard UI.](/docs/assets/images/dashboard/legacy/sidebar.webp)
</Frame>
