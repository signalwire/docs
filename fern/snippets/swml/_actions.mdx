[toggle_functions]: /swml/guides/toggle-functions
[set_meta_data]: /swml/guides/set-meta-data
[context_switch]: /swml/guides/context-switch
[properties]: /swml/reference/ai#properties
[contexts]: /swml/reference/ai/prompt
[steps]: /swml/reference/ai/prompt
...
<ParamField path="action[].hold" type="integer | object">
  Places the caller on hold while playing hold music (configured via the [`params.hold_music`](swml/reference/ai/params) parameter).
  ...
  - Use the [Calling API `ai_unhold` command](apis/calling/calls/call-commands) to programmatically unhold the call with a custom prompt.
  </Note>
</ParamField>
