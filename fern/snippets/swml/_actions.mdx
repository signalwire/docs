...
<Indent>
<ParamField toc={true} path="hold.timeout" type="integer" default="300">
  The duration to hold the caller in seconds. Maximum is `900` seconds (15 minutes).
</ParamField>
</Indent>

<ParamField toc={true} path="action[].change_context" type="string">
...
<ParamField toc={true} path="action[].change_step" type="string">
...
<ParamField toc={true} path="action[].toggle_functions" type="object[]">
...
<Indent>
<ParamField toc={true} path="toggle_functions[].function" type="string" required={true}>
  The name of the SWAIG function to toggle.
</ParamField>

<ParamField toc={true} path="toggle_functions[].active" type="boolean" default="true">
  Whether to activate or deactivate the function.
</ParamField>
</Indent>

<ParamField toc={true} path="action[].set_global_data" type="object">
...
<ParamField toc={true} path="action[].set_meta_data" type="object">
...
<ParamField toc={true} path="action[].unset_global_data" type="string | object">
...
<ParamField toc={true} path="action[].unset_meta_data" type="string | object">
...
<ParamField toc={true} path="action[].playback_bg" type="object">
  A JSON object containing the audio file to play.
</ParamField>

<Indent>
<ParamField toc={true} path="playback_bg.file" type="string">
...
<ParamField toc={true} path="playback_bg.wait" type="boolean" default="false">
  Whether to wait for the audio file to finish playing before continuing.
</ParamField>
</Indent>

<ParamField toc={true} path="action[].stop_playback_bg" type="boolean">
  Whether to stop the background audio file.
</ParamField>

<ParamField toc={true} path="action[].user_input" type="string">
  Used to inject text into the users queue as if they input the data themselves.
</ParamField>

<ParamField toc={true} path="action[].context_switch" type="object">
...
<Indent>
<ParamField toc={true} path="context_switch.system_prompt" type="string">
  The instructions to send to the agent.
</ParamField>

<ParamField toc={true} path="context_switch.consolidate" type="boolean" default="false">
  Whether to consolidate the context.
</ParamField>

<ParamField toc={true} path="context_switch.user_prompt" type="string">
...
<ParamField toc={true} path="action[].transfer" type="object">
  Transfer the call to a new destination.
</ParamField>

<Indent>
<ParamField toc={true} path="transfer.dest" type="string">
  The destination to transfer to (phone number, SIP URI, or SWML URL).
</ParamField>

<ParamField toc={true} path="transfer.summarize" type="boolean" default="false">
