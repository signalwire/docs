[SWML Function properties]: /swml/methods/ai/swaig/functions#properties
...
<ParamField toc={true} path="response" type="string" required={true}>
  Static text that will be added to the AI agent's context.
</ParamField>

<ParamField toc={true} path="action" type="object[]">
  A list of SWML-compatible objects that are executed upon the execution of a SWAIG function.

  See [list of valid actions](#list-of-valid-actions) for additional details.
</ParamField>

<Accordion title="List of valid actions">
...
<ParamField toc={true} path="global_data" type="object">
...
<ParamField toc={true} path="channel_active" type="boolean">
  Whether the channel is currently active.
</ParamField>

<ParamField toc={true} path="channel_offhook" type="boolean">
  Whether the channel is off-hook.
</ParamField>

<ParamField toc={true} path="channel_ready" type="boolean">
...
<ParamField toc={true} path="function" type="string">
  Name of the function that was invoked.
</ParamField>

<ParamField toc={true} path="meta_data" type="object">
...
<ParamField toc={true} path="purpose" type="string">
...
<ParamField toc={true} path="argument_desc" type="string | object">
