...
## TEST 1: products=apis — Should be VISIBLE

We are in the apis product.

</If>

<If products={["swml"]}>

## TEST 2: products=swml — Should be HIDDEN

We are NOT in the swml product.

</If>

<If products={["apis"]} not>

## TEST 3: products=apis + not — Should be HIDDEN

We ARE in apis, and not inverts it.
