...
The AI chat endpoint also uses numeric JSON-RPC error codes. They are listed under
[AI chat](#ai-chat).
...
The [AI chat endpoint](/docs/apis/rest/ai-chat/chat-methods) returns these codes in JSON-RPC error
responses.
