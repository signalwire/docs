...
```mermaid
flowchart TD
    setup["1. Call setup<br/>Receive call, look up webhook, request SWML"] --> swml["2. SWML generation<br/>Build document and SWAIG tokens, return JSON"]
    swml --> conversation["3. AI conversation<br/>Answer, greet, listen, transcribe, respond"]
    conversation -->|as needed| functions["4. Function calls<br/>POST /swaig, execute handler, return result"]
    functions --> conversation
    conversation --> ending["5. Call end<br/>Generate summary and POST /post_prompt"]
```
