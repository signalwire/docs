...
my $available = $client->phone_numbers->search(areacode => '512');
print $available;
```
</Tab>
<Tab title="C++">
...
// Search for available phone numbers
$available = $client->phoneNumbers->search(['areacode' => '512']);
print_r($available);
```
</Tab>
<Tab title="C#">
...
| Create | `client.fabric.ai_agents.create(name="x", prompt=...)` |
