...
<ParamField path="body" type="str | None" toc={true}>
  Text content of the message.
</ParamField>

<ParamField path="media" type="list[str] | None" toc={true}>
  URLs of media attachments. Supplying media sends the message as MMS.
</ParamField>

<ParamField path="send_as_mms" type="bool | None" toc={true}>
  Send as MMS even when no media is attached.
</ParamField>

<ParamField path="status_callback" type="str | None" toc={true}>
  URL that receives delivery status updates for this message.
</ParamField>

<ParamField path="custom_variables" type="dict[str, str] | None" toc={true}>
