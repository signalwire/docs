...
[list]: /docs/server-sdks/reference/python/rest/fabric/relay-applications/list
[create]: /docs/server-sdks/reference/python/rest/fabric/relay-applications/create
[get]: /docs/server-sdks/reference/python/rest/fabric/relay-applications/get
[update]: /docs/server-sdks/reference/python/rest/fabric/relay-applications/update
...
<CardGroup cols={3}>
  ...
  <Card title="get" href="/docs/server-sdks/reference/python/rest/fabric/relay-applications/get">
    Retrieve a single RELAY application resource.
  </Card>
  <Card title="update" href="/docs/server-sdks/reference/python/rest/fabric/relay-applications/update">
    Replace a RELAY application resource.
  </Card>
  <Card title="delete" href="/docs/server-sdks/reference/python/rest/fabric/relay-applications/delete">
    Delete a RELAY application resource.
  </Card>
  <Card title="list_addresses" href="/docs/server-sdks/reference/python/rest/fabric/relay-applications/list-addresses">
