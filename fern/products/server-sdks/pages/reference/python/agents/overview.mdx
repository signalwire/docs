...
<CardGroup cols={2}>
  <Card
    title="AIChatClient"
    href="/docs/server-sdks/reference/python/agents/ai-chat-client"
  >
    Async client for creating, messaging, inspecting, and ending AI chat conversations.
  </Card>
  <Card
    title="ChatGateway"
    href="/docs/server-sdks/reference/python/agents/chat-gateway"
  >
    Browser-facing gateway that keeps AI chat credentials and agent configuration on your server.
  </Card>
  <Card
    title="HandoffRouter"
    href="/docs/server-sdks/reference/python/agents/handoff-router"
  >
    Routes that move a chat conversation to a phone call and back, beside a ChatGateway.
  </Card>
  <Card
    title="AgentBase"
