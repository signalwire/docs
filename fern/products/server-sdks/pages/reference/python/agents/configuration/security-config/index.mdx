...
<ParamField path="ssl_cert_path" type="str | None" default="None" toc={true}>
  Path to the SSL certificate file. Required when `ssl_enabled` is `True`.
</ParamField>

<ParamField path="ssl_key_path" type="str | None" default="None" toc={true}>
...
<ParamField path="basic_auth_user" type="str | None" default="None" toc={true}>
  Basic auth username. Defaults to `"signalwire"` when accessed via `get_basic_auth()`.
</ParamField>

<ParamField path="basic_auth_password" type="str | None" default="None" toc={true}>
