...
<ParamField path="pom" type="PromptObjectModel | None" default="None" toc={true}>
...
<ParamField path="basic_auth" type="tuple[str, str] | None" default="None" toc={true}>
...
<ParamField path="default_webhook_url" type="str | None" default="None" toc={true}>
...
<ParamField path="config_file" type="str | None" default="None" toc={true}>
  Path to a JSON config file. If not provided, the SDK searches default paths.
  See [`ConfigLoader`][configloader].
</ParamField>

<ParamField path="native_functions" type="list[str] | None" default="None" toc={true}>
...
<ParamField path="schema_path" type="str | None" default="None" toc={true}>
...
<ParamField path="signing_key" type="str | None" default="None" toc={true}>
...
<ParamField path="trust_proxy_for_signature" type="bool" default="False" toc={true}>
...
<ParamField path="swaig_secret" type="str | None" default="None" toc={true}>
  ...
  verifying and callers mid-call see a "security token is invalid or expired"
  error on their next tool call. Set it in production and whenever more than one
  replica serves the same agent. Distinct from `signing_key`, which validates
  inbound webhooks.
</ParamField>
...
<ParamField path="description" type="str | None" default="None" toc={true}>
...
<ParamField path="parameters" type="dict[str, Any] | None" default="None" toc={true}>
...
<ParamField path="fillers" type="dict[str, list[str]] | None" default="None" toc={true}>
  Filler phrases by language code, spoken while the function runs.
</ParamField>

<ParamField path="webhook_url" type="str | None" default="None" toc={true}>
  External webhook URL. If set, SignalWire calls this URL instead of executing locally.
</ParamField>

<ParamField path="required" type="list[str] | None" default="None" toc={true}>
...
<CardGroup cols={3}>
  ...
  <Card title="add_per_call_config" href="/docs/server-sdks/reference/python/agents/agent-base/add-per-call-config">
    Register an additional per-request configuration callback.
  </Card>
  ...
  <Card title="handle_request" href="/docs/server-sdks/reference/python/agents/agent-base/handle-request">
    Dispatch one HTTP request without a web framework.
  </Card>
  ...
  <Card title="get_language_params" href="/docs/server-sdks/reference/python/agents/agent-base/get-language-params">
  ...
  <Card title="mount" href="/docs/server-sdks/reference/python/agents/agent-base/mount">
    Attach a router or ASGI app to the agent's web app.
  </Card>
  ...
  <Card title="on_call_end" href="/docs/server-sdks/reference/python/agents/agent-base/on-call-end">
    Run a handler with the call log when a call ends.
  </Card>
  ...
  <Card title="set_language_params" href="/docs/server-sdks/reference/python/agents/agent-base/set-language-params">
  ...
  <Card title="set_multilingual" href="/docs/server-sdks/reference/python/agents/agent-base/set-multilingual">
    Let the caller switch languages mid-call with one configuration object.
  </Card>
