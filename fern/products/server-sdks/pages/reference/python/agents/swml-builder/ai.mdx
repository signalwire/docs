...
<ParamField path="prompt_text" type="str | None" default="None" toc={true}>
  Plain text system prompt for the AI. Mutually exclusive with `prompt_pom`.
</ParamField>

<ParamField path="prompt_pom" type="list[dict[str, Any]] | None" default="None" toc={true}>
...
<ParamField path="post_prompt" type="str | None" default="None" toc={true}>
...
<ParamField path="swaig" type="dict[str, Any] | None" default="None" toc={true}>
