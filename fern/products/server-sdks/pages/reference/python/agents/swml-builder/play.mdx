...
<ParamField path="urls" type="list[str] | None" default="None" toc={true}>
...
<ParamField path="say_voice" type="str | None" default="None" toc={true}>
  Voice name for text-to-speech playback.
</ParamField>

<ParamField path="say_language" type="str | None" default="None" toc={true}>
  Language code for text-to-speech (e.g., `"en-US"`).
</ParamField>

<ParamField path="say_gender" type="str | None" default="None" toc={true}>
  Gender for text-to-speech voice selection.
</ParamField>

<ParamField path="auto_answer" type="bool | None" default="None" toc={true}>
