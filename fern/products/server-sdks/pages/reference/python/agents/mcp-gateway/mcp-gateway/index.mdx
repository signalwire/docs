...
<CardGroup cols={2}>
  <Card title="run" href="/docs/server-sdks/reference/python/agents/mcp-gateway/mcp-gateway/run">
    Start the gateway HTTP server, blocking until shutdown.
  </Card>
  <Card title="shutdown" href="/docs/server-sdks/reference/python/agents/mcp-gateway/mcp-gateway/shutdown">
