...
<ParamField path="allowed_extensions" type="list[str] | None" default="None" toc={true}>
...
<ParamField path="blocked_extensions" type="list[str] | None" default="None" toc={true}>
...
<Note>
The constructor also accepts `basic_auth` (`tuple[str, str] | None`) and
`config_file` (`str | None`) parameters. These are not exposed as public
