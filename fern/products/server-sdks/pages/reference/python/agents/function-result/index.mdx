...
<ParamField path="response" type="str | dict[str, Any] | None" default="None" toc={true}>
...
<ParamField path="tool_result" type="str | None" default="None" toc={true}>
  ...
  [`set_tool_response()`][settoolresponse].
</ParamField>
...
<ParamField path="response" type="str | dict[str, Any]" default="''" toc={true}>
...
<CardGroup cols={3}>
  ...
  <Card title="set_tool_response" href="/docs/server-sdks/reference/python/agents/function-result/set-tool-response">
...
<CardGroup cols={3}>
  ...
  <Card title="rpc_ai_global_data" href="/docs/server-sdks/reference/python/agents/function-result/rpc-ai-global-data">
