...
Raises `ValueError` if `format` is not `"wav"`, `"mp3"`, or `"mp4"`, or if `direction`
...
<ParamField path="format" type="Literal['wav', 'mp3', 'mp4']" default="wav" toc={true}>
...
<ParamField path="direction" type="Literal['speak', 'listen', 'both']" default="both" toc={true}>
...
<ParamField path="terminators" type="str | None" default="None" toc={true}>
...
<ParamField path="max_length" type="float | None" default="None" toc={true}>
