...
<ParamField path="user_message" type="str | None" default="None" toc={true}>
  An opening message from the user, sent as part of creating the conversation.
</ParamField>

<ParamField path="timeout" type="int | None" default="None" toc={true}>
  Idle seconds before the conversation ends. Sent as `conversation_timeout`; the service default is
  3600.
</ParamField>

<ParamField path="user_metadata" type="dict[str, Any] | None" default="None" toc={true}>
