...
async def handle_call(call):
    ...
    if digit == "1":
        await call.play([{"type": "tts", "params": {"text": "Transferring to sales."}}])
        await call.transfer(dest="+15551234567")
    elif digit == "2":
        await call.play([{"type": "tts", "params": {"text": "Transferring to support."}}])
        await call.transfer(dest="+15559876543")
    else:
        await call.play([{"type": "tts", "params": {"text": "Goodbye."}}])
        await call.hangup()
