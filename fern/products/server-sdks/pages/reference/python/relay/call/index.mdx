...
<CardGroup cols={3}>
  ...
  <Card title="wait_for_ringing" href="/docs/server-sdks/reference/python/relay/call/wait-for-ringing">
    Wait until the call is ringing.
  </Card>
  <Card title="wait_for_answered" href="/docs/server-sdks/reference/python/relay/call/wait-for-answered">
    Wait until the call is answered.
  </Card>
  <Card title="wait_for_ending" href="/docs/server-sdks/reference/python/relay/call/wait-for-ending">
  ...
  <Card title="play_tts" href="/docs/server-sdks/reference/python/relay/call/play-tts">
    Play text-to-speech.
  </Card>
  <Card title="play_audio" href="/docs/server-sdks/reference/python/relay/call/play-audio">
    Play an audio file from a URL.
  </Card>
  <Card title="play_silence" href="/docs/server-sdks/reference/python/relay/call/play-silence">
    Play silence for a number of seconds.
  </Card>
  <Card title="play_ringtone" href="/docs/server-sdks/reference/python/relay/call/play-ringtone">
  ...
  <Card title="prompt_tts" href="/docs/server-sdks/reference/python/relay/call/prompt-tts">
    Play text-to-speech, then collect input.
  </Card>
  <Card title="prompt_audio" href="/docs/server-sdks/reference/python/relay/call/prompt-audio">
  ...
  <Card title="detect_digit" href="/docs/server-sdks/reference/python/relay/call/detect-digit">
    Detect DTMF digits.
  </Card>
  <Card title="detect_answering_machine" href="/docs/server-sdks/reference/python/relay/call/detect-answering-machine">
    Detect a human versus an answering machine.
  </Card>
  <Card title="detect_fax" href="/docs/server-sdks/reference/python/relay/call/detect-fax">
    Detect a fax tone.
  </Card>
