...
<ParamField path="bind_params" type="dict | None" default="None" toc={true}>
  Parameters to pass to the bound method when triggered.
</ParamField>

<ParamField path="realm" type="str | None" default="None" toc={true}>
  A namespace for grouping digit bindings. Useful for selectively clearing
  bindings by realm.
</ParamField>

<ParamField path="max_triggers" type="int | None" default="None" toc={true}>
