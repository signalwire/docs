...
<ParamField path="control_id" type="str | None" default="None" toc={true}>
  Custom control ID. Auto-generated if not provided.
</ParamField>

<ParamField path="input_method" type="str | None" default="None" toc={true}>
...
<ParamField path="status_url" type="str | None" default="None" toc={true}>
  URL to receive payment status webhooks.
</ParamField>

<ParamField path="payment_method" type="str | None" default="None" toc={true}>
  Payment method type. Valid values: `"credit-card"`.
</ParamField>

<ParamField path="timeout" type="str | None" default="None" toc={true}>
  Timeout for the payment session.
</ParamField>

<ParamField path="max_attempts" type="str | None" default="None" toc={true}>
  Maximum number of input attempts before failing.
</ParamField>

<ParamField path="security_code" type="str | None" default="None" toc={true}>
...
<ParamField path="postal_code" type="str | None" default="None" toc={true}>
...
<ParamField path="min_postal_code_length" type="str | None" default="None" toc={true}>
  Minimum length for the postal code.
</ParamField>

<ParamField path="token_type" type="str | None" default="None" toc={true}>
  Tokenization type for the payment data.
</ParamField>

<ParamField path="charge_amount" type="str | None" default="None" toc={true}>
  Amount to charge (e.g., `"29.99"`).
</ParamField>

<ParamField path="currency" type="str | None" default="None" toc={true}>
...
<ParamField path="valid_card_types" type="str | None" default="None" toc={true}>
  Comma-separated list of accepted card types (e.g., `"visa,mastercard,amex"`).
</ParamField>

<ParamField path="parameters" type="list[dict] | None" default="None" toc={true}>
  Additional parameters to pass to the payment connector.
</ParamField>

<ParamField path="prompts" type="list[dict] | None" default="None" toc={true}>
