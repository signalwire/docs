...
<ParamField path="codec" type="str | None" default="None" toc={true}>
...
<ParamField path="track" type="str | None" default="None" toc={true}>
...
<ParamField path="status_url_method" type="str | None" default="None" toc={true}>
...
<ParamField path="authorization_bearer_token" type="str | None" default="None" toc={true}>
  Bearer token for authenticating with the WebSocket server.
</ParamField>

<ParamField path="custom_parameters" type="dict | None" default="None" toc={true}>
