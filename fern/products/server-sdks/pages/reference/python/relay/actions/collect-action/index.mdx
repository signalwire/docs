...
[pause]: /docs/server-sdks/reference/python/relay/actions/collect-action/pause
[resume]: /docs/server-sdks/reference/python/relay/actions/collect-action/resume
...
<CardGroup cols={3}>
  ...
  <Card title="pause" href="/docs/server-sdks/reference/python/relay/actions/collect-action/pause">
    Pause the play-and-collect operation.
  </Card>
  <Card title="resume" href="/docs/server-sdks/reference/python/relay/actions/collect-action/resume">
