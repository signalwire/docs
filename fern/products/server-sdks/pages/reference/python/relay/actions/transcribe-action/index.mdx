...
[stop]: /docs/server-sdks/reference/python/relay/actions/transcribe-action/stop
...
<CardGroup cols={2}>
  <Card title="stop" href="/docs/server-sdks/reference/python/relay/actions/transcribe-action/stop">
    Stop transcription.
  </Card>
</CardGroup>
