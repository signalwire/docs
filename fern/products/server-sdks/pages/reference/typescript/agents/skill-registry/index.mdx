...
<CardGroup cols={3}>
  ...
  <Card title="addSkillDirectory" href="/docs/server-sdks/reference/typescript/agents/skill-registry/add-skill-directory">
    Register an external skill directory (strict validation).
  </Card>
  <Card title="getExternalPaths" href="/docs/server-sdks/reference/typescript/agents/skill-registry/get-external-paths">
    Get registered external skill directories.
  </Card>
