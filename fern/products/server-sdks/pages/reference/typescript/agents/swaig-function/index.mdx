...
[swaig-function-definition]: /docs/swml/reference/calling/ai/swaig/functions
...
<ParamField path="secure" type="boolean" default="true" toc={true}>
  Whether the tool requires session token authentication. Pass `false` to
  expose the tool on the shared, unauthenticated webhook URL.
</ParamField>
...
<CardGroup cols={3}>
  ...
  <Card title="validateArgs" href="/docs/server-sdks/reference/typescript/agents/swaig-function/validate-args">
