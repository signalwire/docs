...
<CardGroup cols={3}>
  ...
  <Card title="renderXml" href="/docs/server-sdks/reference/typescript/agents/pom-builder/render-xml">
  ...
  <Card title="toJson" href="/docs/server-sdks/reference/typescript/agents/pom-builder/to-json">
    Serialize all sections to a JSON string.
  </Card>
  <Card title="fromSections" href="/docs/server-sdks/reference/typescript/agents/pom-builder/from-sections">
    Create a new PomBuilder from section data (static).
  </Card>
  <Card title="addPomAsSubsection" href="/docs/server-sdks/reference/typescript/agents/pom-builder/add-pom-as-subsection">
    Append another PomBuilder's sections as subsections.
  </Card>
  <Card title="pom" href="/docs/server-sdks/reference/typescript/agents/pom-builder/pom">
    Get a PromptObjectModel snapshot of the builder's sections.
  </Card>
  <Card title="reset" href="/docs/server-sdks/reference/typescript/agents/pom-builder/reset">
