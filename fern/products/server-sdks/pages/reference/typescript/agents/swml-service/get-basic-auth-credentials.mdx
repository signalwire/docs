...
<ParamField path="includeSource" type="boolean" default="false" toc={true}>
  ...
  - `"generated"` -- credentials were randomly generated at startup
</ParamField>
...
`[string, string, 'provided' | 'environment' | 'generated']` -- A
...
console.log(`Auth source: ${source}`); // "provided", "environment", or "generated"
```
