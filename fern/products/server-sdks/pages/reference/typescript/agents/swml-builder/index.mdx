...
<ParamField path="initialDocument" type={"{ version?: string; sections?: Record<string, unknown[]> }"} toc={true}>
...
<ParamField path="enableValidation" type="boolean" toc={true}>
...
<CardGroup cols={3}>
  ...
  <Card title="addSection" href="/docs/server-sdks/reference/typescript/agents/swml-builder/add-section">
    Add a new named section to the document.
  </Card>
  <Card title="build" href="/docs/server-sdks/reference/typescript/agents/swml-builder/build">
    Build and return the SWML document as an object.
  </Card>
  <Card title="render" href="/docs/server-sdks/reference/typescript/agents/swml-builder/render">
    Render the SWML document as a JSON string.
  </Card>
  <Card title="document" href="/docs/server-sdks/reference/typescript/agents/swml-builder/document">
    Property-style read-only accessor for the underlying document.
  </Card>
  <Card title="setValidation" href="/docs/server-sdks/reference/typescript/agents/swml-builder/set-validation">
