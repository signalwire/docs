...
<Note>
Prefer [`build()`][ref-build] when you want an explicit method call for
symmetry with other accessors. The `document` getter exists for callers that
want property-style access.
</Note>
