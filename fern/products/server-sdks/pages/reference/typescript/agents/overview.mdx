...
[ai-chat-client]: /docs/server-sdks/reference/typescript/agents/ai-chat-client
...
<Info>
The Server SDK generates [SWML][swml] documents under the hood.
...
<CardGroup cols={2}>
  ...
  <Card
    title="BedrockAgent"
    href="/docs/server-sdks/reference/typescript/agents/bedrock-agent"
  >
    Agent backed by the Amazon Bedrock voice-to-voice model.
  </Card>
  <Card
    title="AIChatClient"
    href="/docs/server-sdks/reference/typescript/agents/ai-chat-client"
  >
    Hold a text conversation with an AI agent from your own server.
  </Card>
  <Card
    title="ParameterSchema"
    href="/docs/server-sdks/reference/typescript/agents/parameter-schema"
  >
    Fluent builder for typed SWAIG tool parameter schemas.
  </Card>
  <Card
    title="Prefabs"
  ...
  <Card
    title="CLI"
    href="/docs/server-sdks/reference/typescript/agents/cli"
  >
    Test SWAIG functions and render SWML locally with swaig-test.
  </Card>
  <Card
    title="Configuration"
