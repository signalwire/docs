...
<ParamField path="opts.direction" type={'"speak" | "hear" | "both"'} default="both" toc={true}>
...
<ParamField path="opts.codec" type={'"PCMU" | "PCMA"'} default="PCMU" toc={true}>
...
<ParamField path="opts.rtpPtime" type="number" default="20" toc={true}>
