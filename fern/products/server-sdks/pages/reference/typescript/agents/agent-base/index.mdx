...
<ParamField path="signingKey" type="string" toc={true}>
...
<ParamField path="webhookTrustProxy" type="boolean" default="false" toc={true}>
...
<ParamField path="signingKey" type="string | null" toc={true}>
  The Signing Key used for webhook signature validation, from the constructor
  option or `SIGNALWIRE_SIGNING_KEY`. `null` when validation is disabled.
</ParamField>
...
<CardGroup cols={3}>
  ...
  <Card title="onRequest" href="/docs/server-sdks/reference/typescript/agents/agent-base/on-request">
    Public hook called on every inbound request before rendering.
  </Card>
  <Card title="pom" href="/docs/server-sdks/reference/typescript/agents/agent-base/pom">
    Get the agent's prompt as a PromptObjectModel snapshot.
  </Card>
  <Card title="getRawPrompt" href="/docs/server-sdks/reference/typescript/agents/agent-base/get-raw-prompt">
    Retrieve the raw stored prompt text, unrendered.
  </Card>
  <Card title="getContexts" href="/docs/server-sdks/reference/typescript/agents/agent-base/get-contexts">
    Retrieve the agent's contexts as a serialized dictionary.
  </Card>
  <Card title="createToolToken" href="/docs/server-sdks/reference/typescript/agents/agent-base/create-tool-token">
    Create a per-call SWAIG token for a tool.
  </Card>
  <Card title="setLanguageParams" href="/docs/server-sdks/reference/typescript/agents/agent-base/set-language-params">
    Set engine-specific params on an added language.
  </Card>
  <Card title="getLanguageParams" href="/docs/server-sdks/reference/typescript/agents/agent-base/get-language-params">
    Read engine-specific params on an added language.
  </Card>
  <Card title="setMultilingual" href="/docs/server-sdks/reference/typescript/agents/agent-base/set-multilingual">
    Answer in whatever language the caller speaks.
  </Card>
  <Card title="onError" href="/docs/server-sdks/reference/typescript/agents/agent-base/on-error">
    Hook that runs when any tool handler throws.
  </Card>
  <Card title="replaceGlobalData" href="/docs/server-sdks/reference/typescript/agents/agent-base/replace-global-data">
    Replace the global data object, discarding prior keys.
  </Card>
  <Card title="registerRoutingCallback" href="/docs/server-sdks/reference/typescript/agents/agent-base/register-routing-callback">
    Route requests dynamically from the POST body.
  </Card>
  <Card title="handleRequest" href="/docs/server-sdks/reference/typescript/agents/agent-base/handle-request">
    Dispatch a request from plain HTTP primitives.
  </Card>
</CardGroup>
