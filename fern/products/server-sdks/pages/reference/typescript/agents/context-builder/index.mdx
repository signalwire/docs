...
<CardGroup cols={3}>
  ...
  <Card title="reset" href="/docs/server-sdks/reference/typescript/agents/context-builder/reset">
  ...
  <Card title="createSimpleContext" href="/docs/server-sdks/reference/typescript/agents/context-builder/create-simple-context">
