...
<CardGroup cols={3}>
  ...
  <Card title="setHistory" href="/docs/server-sdks/reference/typescript/agents/context-builder/context/set-history">
    Set the default history visibility mode for every step.
  </Card>
