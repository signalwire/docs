...
<CardGroup cols={3}>
  ...
  <Card title="setHistory" href="/docs/server-sdks/reference/typescript/agents/context-builder/step/set-history">
    Control how much prior conversation the model sees at this step.
  </Card>
