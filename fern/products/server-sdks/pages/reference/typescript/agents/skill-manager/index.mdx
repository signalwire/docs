...
<CardGroup cols={3}>
  ...
  <Card title="loadSkill" href="/docs/server-sdks/reference/typescript/agents/skill-manager/load-skill">
    Instantiate a skill class and add it; returns [ok, error].
  </Card>
  <Card title="loadSkillByName" href="/docs/server-sdks/reference/typescript/agents/skill-manager/load-skill-by-name">
  ...
  <Card title="hasSkillByKey" href="/docs/server-sdks/reference/typescript/agents/skill-manager/has-skill-by-key">
    Check if a skill with the given instance key is loaded.
  </Card>
  <Card title="listSkillKeys" href="/docs/server-sdks/reference/typescript/agents/skill-manager/list-skill-keys">
  ...
  <Card title="loadedSkills" href="/docs/server-sdks/reference/typescript/agents/skill-manager/loaded-skills">
