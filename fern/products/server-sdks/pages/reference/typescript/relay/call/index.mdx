...
<ParamField path="isTerminal" type="boolean" toc={true}>
...
<CardGroup cols={3}>
  ...
  <Card title="waitForAnswered" href="/docs/server-sdks/reference/typescript/relay/call/wait-for-answered">
    Wait for a call to be answered.
  </Card>
  <Card title="waitForRinging" href="/docs/server-sdks/reference/typescript/relay/call/wait-for-ringing">
    Wait for a call to start ringing.
  </Card>
  <Card title="waitForEnding" href="/docs/server-sdks/reference/typescript/relay/call/wait-for-ending">
  ...
  <Card title="playTTS" href="/docs/server-sdks/reference/typescript/relay/call/play-tts">
    Play text-to-speech.
  </Card>
  <Card title="playAudio" href="/docs/server-sdks/reference/typescript/relay/call/play-audio">
    Play an audio file from a URL.
  </Card>
  <Card title="playSilence" href="/docs/server-sdks/reference/typescript/relay/call/play-silence">
    Play silence for a number of seconds.
  </Card>
  <Card title="playRingtone" href="/docs/server-sdks/reference/typescript/relay/call/play-ringtone">
  ...
  <Card title="promptTTS" href="/docs/server-sdks/reference/typescript/relay/call/prompt-tts">
    Speak a prompt, then collect input.
  </Card>
  <Card title="promptAudio" href="/docs/server-sdks/reference/typescript/relay/call/prompt-audio">
  ...
  <Card title="detectAnsweringMachine" href="/docs/server-sdks/reference/typescript/relay/call/detect-answering-machine">
    Detect whether a human or a machine picked up.
  </Card>
  <Card title="detectDigit" href="/docs/server-sdks/reference/typescript/relay/call/detect-digit">
    Detect DTMF digits.
  </Card>
  <Card title="detectFax" href="/docs/server-sdks/reference/typescript/relay/call/detect-fax">
    Detect a fax tone.
  </Card>
