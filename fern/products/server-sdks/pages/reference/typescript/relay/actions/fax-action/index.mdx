...
[call-send-fax]: /docs/server-sdks/reference/typescript/relay/call/send-fax
[call-receive-fax]: /docs/server-sdks/reference/typescript/relay/call/receive-fax
[base-action-interface]: /docs/server-sdks/reference/typescript/relay/actions
[stop]: /docs/server-sdks/reference/typescript/relay/actions/fax-action/stop
...
<CardGroup cols={2}>
  <Card title="stop" href="/docs/server-sdks/reference/typescript/relay/actions/fax-action/stop">
