...
[call-pay]: /docs/server-sdks/reference/typescript/relay/call/pay
[base-action-interface]: /docs/server-sdks/reference/typescript/relay/actions
[stop]: /docs/server-sdks/reference/typescript/relay/actions/pay-action/stop
...
<CardGroup cols={2}>
  <Card title="stop" href="/docs/server-sdks/reference/typescript/relay/actions/pay-action/stop">
