...
For whole-call background transcription delivered after the call ends, see
[`transcribe`](/docs/server-sdks/reference/typescript/rest/calling/transcribe) instead.
