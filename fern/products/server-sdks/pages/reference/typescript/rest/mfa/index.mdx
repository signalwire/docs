...
[sms]: /docs/server-sdks/reference/typescript/rest/mfa/sms
[call]: /docs/server-sdks/reference/typescript/rest/mfa/call
[verify]: /docs/server-sdks/reference/typescript/rest/mfa/verify
...
<CardGroup cols={3}>
  <Card title="sms" href="/docs/server-sdks/reference/typescript/rest/mfa/sms">
    Send an MFA verification code via SMS.
  </Card>
  <Card title="call" href="/docs/server-sdks/reference/typescript/rest/mfa/call">
    Send an MFA verification code via voice call.
  </Card>
  <Card title="verify" href="/docs/server-sdks/reference/typescript/rest/mfa/verify">
