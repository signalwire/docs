...
<div class="lp-page-container">
  <div class="main-content">
    ...
    <div class="products-section">
      ...
      <CardGroup cols={3}>
        <Card title="REST APIs" icon="fa-regular fa-code" href="/apis">
          Complete API reference for voice, video, messaging, and AI services.
        </Card>
        <Card title="SWML" icon="fa-regular fa-file-code" href="/swml">
          Markup language that unifies LLMs, TTS, and STT with PSTN, SIP, and WebRTC.
        </Card>
        <Card title="Agents SDK" icon="fa-regular fa-robot" href="/agents-sdk">
          Create AI agents for voice, video, and text interactions.
        </Card>
        <Card title="Server SDK" icon="fa-regular fa-bolt" href="/realtime-sdk">
          Server-side SDK for managing real-time voice, video, messaging, and chat.
        </Card>
        <Card title="Browser SDK" icon="fa-regular fa-browser" href="/browser-sdk">
    ...
    <div class="products-section">
      ...
      <CardGroup cols={3}>
        <Card title="Call Flow Builder" icon="fa-regular fa-diagram-project" href="/call-flow-builder">
          Build drag-and-drop calling applications without writing code.
        </Card>
        <Card title="Platform & Dashboard" icon="fa-regular fa-gear" href="/platform">
          Manage your SignalWire space, phone numbers, and resources.
        </Card>
        <Card title="Wirestarter" icon="fa-regular fa-plug" href="/wirestarter">
          Scaffold a new SignalWire project in seconds.
        </Card>
        <Card title="SWSH" icon="fa-regular fa-terminal" href="/swsh">
