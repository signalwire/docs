...
<div class="lp-page-container">
  <div class="main-content">
    ...
    <div class="getting-started-callout">
      <Icon icon="circle-info" size="4" />
      <span class="getting-started-callout-text"><strong>New to SignalWire?</strong> Set up your account, grab API credentials, and start building.</span>
    ...
    <div class="pathways-section">
      <h2 class="section-heading">What are you building?</h2>
    ...
    <div class="products-section">
      <h2 class="section-heading">Interfaces & SDKs</h2>
