  ...
  <div class="main-content">
    ...
    <div class="products-section">
      ...
      <CardGroup cols={3}>
        ...
        <Card title="Server SDK" icon="fa-regular fa-bolt" href="/docs/realtime-sdk">
    ...
    <div class="products-section">
      ...
      <CardGroup cols={3}>
        ...
        <Card title="Wirestarter" icon="fa-regular fa-plug" href="/docs/wirestarter">
          Scaffold a new SignalWire project in seconds.
        </Card>
        <Card title="SWSH" icon="fa-regular fa-terminal" href="/docs/swsh">
