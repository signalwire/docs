...
| [Parameters](agents-sdk/python/guides/parameters) | Defining and validating function parameters |
| [Results & Actions](agents-sdk/python/guides/results-actions) | Returning results and triggering actions |
| [DataMap](agents-sdk/python/guides/datamap) | Serverless API integration |
| [Native Functions](agents-sdk/python/guides/native-functions) | Built-in SignalWire functions |
