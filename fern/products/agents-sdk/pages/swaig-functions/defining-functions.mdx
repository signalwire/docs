...
<Frame caption="SWAIG Function Flow" class="diagram">
  ![SWAIG Function Flow.](/assets/images/agents-sdk-manual/04_01_defining-functions_diagram1.webp)
</Frame>
...
| Section | Description |
|---------|-------------|
| [Defining Functions](/agents-sdk/swaig-functions/defining-functions) | Creating SWAIG functions with define_tool() |
| [Parameters](/agents-sdk/swaig-functions/parameters) | Defining and validating function parameters |
| [Results & Actions](/agents-sdk/swaig-functions/results-actions) | Returning results and triggering actions |
| [DataMap](/agents-sdk/swaig-functions/datamap) | Serverless API integration |
| [Native Functions](/agents-sdk/swaig-functions/native-functions) | Built-in SignalWire functions |
