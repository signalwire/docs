...
| Section | Description |
|---------|-------------|
| [Defining Functions](/agents-sdk/python/guides/defining-functions) | Creating SWAIG functions with define_tool() |
| [Parameters](/agents-sdk/swaig-functions/parameters) | Defining and validating function parameters |
| [Results & Actions](/agents-sdk/python/guides/result-actions) | Returning results and triggering actions |
| [DataMap](/agents-sdk/python/guides/data-map) | Serverless API integration |
