...
<Frame caption="SWAIG Function Flow">
  <img class="diagram" src="/docs/assets/images/agents-sdk-manual/04_01_defining-functions_diagram1.webp" alt="SWAIG Function Flow." />
</Frame>
...
| [Parameters](/docs/agents-sdk/swaig-functions/parameters) | Defining and validating function parameters |
...
| [Native Functions](/docs/agents-sdk/swaig-functions/native-functions) | Built-in SignalWire functions |
