...
| [Results & Actions](/docs/agents-sdk/python/guides/results-actions) | Returning results and triggering actions |
| [DataMap](/docs/agents-sdk/python/guides/datamap) | Serverless API integration |
