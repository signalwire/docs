...
<Frame caption="The Problem" class="diagram">
  ![The Problem.](/assets/images/agents-sdk-manual/01_05_exposing-agents_diagram1.webp)
</Frame>

<Frame caption="The Solution: ngrok" class="diagram">
  ![The Solution: ngrok.](/assets/images/agents-sdk-manual/01_05_exposing-agents_diagram2.webp)
</Frame>
...
See the [Deployment](/agents-sdk/deployment/local-development) chapter for production deployment guides.
...
**Next Chapter: [Core Concepts](/agents-sdk/core-concepts/architecture)** - Deep dive into SWML, SWAIG, and agent architecture

**Or jump to: [SignalWire Integration](/agents-sdk/signalwire-integration/account-setup)** - Connect your agent to phone numbers
