...
<Frame caption="The Problem">
  <img class="diagram" src="/docs/assets/images/agents-sdk-manual/01_05_exposing-agents_diagram1.webp" alt="The Problem." />
</Frame>

<Frame caption="The Solution: ngrok">
  <img class="diagram" src="/docs/assets/images/agents-sdk-manual/01_05_exposing-agents_diagram2.webp" alt="The Solution: ngrok." />
</Frame>
...
See the [Deployment](/docs/agents-sdk/deployment/local-development) chapter for production deployment guides.
...
**Next Chapter: [Core Concepts](/docs/agents-sdk/core-concepts/architecture)** - Deep dive into SWML, SWAIG, and agent architecture

**Or jump to: [SignalWire Integration](/docs/agents-sdk/signalwire-integration/account-setup)** - Connect your agent to phone numbers
