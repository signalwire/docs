...
<Frame caption="Agent Startup Output" class="diagram">
  ![Agent Startup Output.](/assets/images/agents-sdk-manual/01_03_quickstart_diagram1.webp)
</Frame>
...
1. **[Development Environment](/agents-sdk/dev-environment)** - Set up a professional project structure with environment variables and testing
2. **[Exposing Your Agent](/agents-sdk/exposing-agents)** - Make your agent accessible via ngrok so SignalWire can reach it

**Or jump ahead to:**

- **[Core Concepts](/agents-sdk/core-concepts/architecture)** - Understand SWML, SWAIG, and the request lifecycle
- **[Building Agents](/agents-sdk/building-agents/agent-base)** - Learn all agent configuration options
