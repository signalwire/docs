...
<Frame caption="SignalWire Integration">
  <img class="diagram" src="/docs/assets/images/agents-sdk-manual/08_01_account-setup_diagram1.webp" alt="SignalWire Integration." />
</Frame>
...
<Frame caption="Call Flow Architecture">
  <img class="diagram" src="/docs/assets/images/agents-sdk-manual/08_01_account-setup_diagram2.webp" alt="Call Flow Architecture." />
</Frame>
