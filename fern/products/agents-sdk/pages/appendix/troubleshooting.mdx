...
| Topic | Reference |
|-------|-----------|
| swaig-test CLI | [swaig-test Reference](/agents-sdk/api/cli/swaig-test) |
| AI parameters | [AI Parameters](/agents-sdk/appendix/ai-parameters-reference) |
| Security best practices | [Security](/agents-sdk/core-concepts/security) |
