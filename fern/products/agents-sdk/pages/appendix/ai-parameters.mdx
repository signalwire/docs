...
| Section | Description |
|---------|-------------|
| [AI Parameters](/agents-sdk/appendix/ai-parameters-reference) | Complete AI parameter reference |
| [Design Patterns](/agents-sdk/appendix/patterns) | Common architectural patterns |
| [Best Practices](/agents-sdk/appendix/best-practices) | Production guidelines |
| [Troubleshooting](/agents-sdk/appendix/troubleshooting) | Common issues and solutions |
| [Migration Guide](/agents-sdk/appendix/migration) | Version upgrade guide |
| [Changelog](/agents-sdk/appendix/changelog) | Version history |
