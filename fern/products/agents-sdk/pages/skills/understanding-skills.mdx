...
| [Adding Skills](/docs/agents-sdk/skills/adding-skills) | How to use skills in your agents |
| [Custom Skills](/docs/agents-sdk/skills/custom) | Creating your own skills |
| [Skill Configuration](/docs/agents-sdk/skills/skill-config) | Parameters and advanced options |
...
<Frame caption="Skill Loading Process">
  <img class="diagram" src="/docs/assets/images/agents-sdk-manual/05_01_understanding-skills_diagram1.webp" alt="Skill Loading Process." />
</Frame>
