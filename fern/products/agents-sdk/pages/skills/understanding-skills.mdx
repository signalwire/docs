...
| Section | Description |
|---------|-------------|
| [Understanding Skills](/docs/agents-sdk/python/guides/understanding-skills) | How skills work internally |
| [Built-in Skills](/docs/agents-sdk/python/guides/builtin-skills) | Reference for included skills |
| [Adding Skills](/docs/agents-sdk/python/guides/understanding-skills) | How to use skills in your agents |
| [Custom Skills](/docs/agents-sdk/python/guides/understanding-skills) | Creating your own skills |
| [Skill Configuration](/docs/agents-sdk/python/guides/understanding-skills) | Parameters and advanced options |
