...
| Section | Description |
|---------|-------------|
| [Understanding Skills](agents-sdk/python/guides/understanding-skills) | How skills work internally |
| [Built-in Skills](agents-sdk/python/guides/builtin-skills) | Reference for included skills |
| [Adding Skills](agents-sdk/python/guides/adding-skills) | How to use skills in your agents |
| [Custom Skills](agents-sdk/python/guides/custom) | Creating your own skills |
| [Skill Configuration](agents-sdk/python/guides/skill-config) | Parameters and advanced options |
...
<Frame caption="Skill Loading Process">
  <img class="diagram" src="/assets/images/agents-sdk-manual/05_01_understanding-skills_diagram1.webp" alt="Skill Loading Process." />
</Frame>
