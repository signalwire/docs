...
| Section | Description |
|---------|-------------|
| [Understanding Skills](/agents-sdk/skills/understanding-skills) | How skills work internally |
| [Built-in Skills](/agents-sdk/skills/builtin-skills) | Reference for included skills |
| [Adding Skills](/agents-sdk/skills/adding-skills) | How to use skills in your agents |
| [Custom Skills](/agents-sdk/skills/custom) | Creating your own skills |
| [Skill Configuration](/agents-sdk/skills/skill-config) | Parameters and advanced options |
...
<Frame caption="Skill Loading Process" class="diagram">
  ![Skill Loading Process.](/assets/images/agents-sdk-manual/05_01_understanding-skills_diagram1.webp)
</Frame>
