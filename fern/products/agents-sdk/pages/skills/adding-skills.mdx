---
id: e9515925-0a61-40d3-9054-ab850d665a55
title: "Adding Skills"
sidebar-title: "Adding Skills"
slug: /skills/adding-skills
max-toc-depth: 3
---
...
<Note>
Skills like `web_search` and `joke` require additional configuration or API keys. See the [Built-in Skills](/agents-sdk/skills/builtin-skills) section for details on each skill's requirements.
</Note>
