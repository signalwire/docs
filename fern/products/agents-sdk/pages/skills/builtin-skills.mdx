---
id: 6705ef95-02c0-4414-bd8b-de4b4f359e92
title: "Builtin Skills"
sidebar-title: "Builtin Skills"
...
- MCP Gateway service running (see [MCP Gateway](/docs/agents-sdk/advanced/mcp-gateway))
...
For detailed setup and configuration, see [MCP Gateway](/docs/agents-sdk/advanced/mcp-gateway).
