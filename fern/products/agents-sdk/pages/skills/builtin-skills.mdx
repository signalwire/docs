...
- MCP Gateway service running (see [MCP Gateway](/agents-sdk/advanced/mcp-gateway))
...
For detailed setup and configuration, see [MCP Gateway](/agents-sdk/advanced/mcp-gateway).
