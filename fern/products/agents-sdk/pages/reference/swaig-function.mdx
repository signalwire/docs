---
id: 5f78d171-a73e-47b7-a81d-a7c2561526c1
...
| Topic | Reference |
|-------|-----------|
| Function results and actions | [SwaigFunctionResult API](/agents-sdk/python/reference/function-result) |
| Serverless API integration | [DataMap API](/agents-sdk/python/reference/data-map) |
| Testing functions | [swaig-test CLI](/agents-sdk/python/reference/cli-swaig-test) |
| Defining functions guide | [Defining Functions](/agents-sdk/python/guides/defining-functions) |
