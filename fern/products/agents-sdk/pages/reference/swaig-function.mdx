...
| Topic | Reference |
|-------|-----------|
| Function results and actions | [SwaigFunctionResult API](/agents-sdk/api/function-result) |
| Serverless API integration | [DataMap API](/agents-sdk/api/data-map) |
| Testing functions | [swaig-test CLI](/agents-sdk/api/cli/swaig-test) |
| Defining functions guide | [Defining Functions](/agents-sdk/swaig-functions/defining-functions) |
