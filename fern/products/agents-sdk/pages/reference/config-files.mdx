...
<Tab title="With AgentBase class">
...
For [serverless deployment](/agents-sdk/python/guides/serverless),
...
For detailed security configuration options, see the [Security guide](/agents-sdk/python/guides/security).
