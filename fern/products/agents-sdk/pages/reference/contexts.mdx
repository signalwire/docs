...
| Topic | Reference |
|-------|-----------|
| Contexts guide | [Contexts [Contexts & Workflows](/agents-sdk/advanced/contexts-workflows) Workflows](/agents-sdk/advanced/contexts-workflows) |
| State management | [State Management](/agents-sdk/advanced/state-management) |
| Context switching in functions | [SwaigFunctionResult API](/agents-sdk/api/function-result) - `swml_change_step()`, `swml_change_context()` |
