---
id: bcdfa439-b2f4-4012-9d50-3a66bec48e5c
title: "Contexts"
sidebar-title: "Contexts"
...
<Frame caption="Step Navigation">
  <img class="diagram" src="/assets/images/agents-sdk-manual/10_07_api-contexts_diagram1.webp" alt="Step Navigation." />
</Frame>
...
| Topic | Reference |
|-------|-----------|
| Contexts guide | [Contexts [Contexts & Workflows](agents-sdk/python/guides/contexts-workflows) Workflows](agents-sdk/python/guides/contexts-workflows) |
| State management | [State Management](agents-sdk/python/guides/state-management) |
| Context switching in functions | [SwaigFunctionResult API](agents-sdk/python/reference/function-result) - `swml_change_step()`, `swml_change_context()` |
