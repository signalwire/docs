...
<Frame caption="Search Architecture">
  <img class="diagram" src="/assets/images/agents-sdk-manual/10_09_cli-sw-search_diagram1.webp" alt="Search Architecture." />
</Frame>
...
- [native_vector_search Skill](/agents-sdk/python/guides/builtin-skills#native_vector_search) - Using search indexes in agents
- [Skills Overview](/agents-sdk/python/guides/understanding-skills) - Adding skills to agents
- [DataSphere Integration](/agents-sdk/python/guides/builtin-skills#datasphere) - Cloud-based search alternative
