...
<Frame caption="Search Architecture" class="diagram">
  ![Search Architecture.](/assets/images/agents-sdk-manual/10_09_cli-sw-search_diagram1.webp)
</Frame>
...
- [native_vector_search Skill](/agents-sdk/skills/builtin-skills#native_vector_search) - Using search indexes in agents
- [Skills Overview](/agents-sdk/skills/understanding-skills) - Adding skills to agents
- [DataSphere Integration](/agents-sdk/skills/builtin-skills#datasphere) - Cloud-based search alternative
