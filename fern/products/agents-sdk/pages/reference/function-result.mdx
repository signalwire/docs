...
| Topic | Reference |
|-------|-----------|
| Defining SWAIG functions | [SWAIG Function API](/agents-sdk/python/reference/swaig-function) |
| Results and actions guide | [Results [Results & Actions](/agents-sdk/python/guides/result-actions) Actions](/agents-sdk/python/guides/result-actions) |
| Call transfer options | [Call Transfers](/agents-sdk/python/guides/call-transfer) |
