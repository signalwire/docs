---
id: f670923b-dff6-4cd1-ae75-15177c3a0fb0
title: "Function Result"
sidebar-title: "Function Result"
slug: /api/function-result
max-toc-depth: 3
---
...
| Topic | Reference |
|-------|-----------|
| Defining SWAIG functions | [SWAIG Function API](/agents-sdk/api/swaig-function) |
| Results and actions guide | [Results [Results & Actions](/agents-sdk/swaig-functions/results-actions) Actions](/agents-sdk/swaig-functions/results-actions) |
| Call transfer options | [Call Transfers](/agents-sdk/advanced/call-transfer) |
