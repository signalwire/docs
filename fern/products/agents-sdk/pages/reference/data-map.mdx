...
| Topic | Reference |
|-------|-----------|
| DataMap guide | [DataMap Functions](/agents-sdk/swaig-functions/datamap) |
| SWAIG functions | [SWAIG Function API](/agents-sdk/api/swaig-function) |
| Function results | [SwaigFunctionResult API](/agents-sdk/api/function-result) |
| Testing DataMap | [swaig-test CLI](/agents-sdk/api/cli/swaig-test) - DataMap functions make live HTTP calls |
