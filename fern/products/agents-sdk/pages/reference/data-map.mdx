---
id: 89b470e8-79ec-4695-8a02-510813ade919
title: "Data Map"
sidebar-title: "Data Map"
...
| Topic | Reference |
|-------|-----------|
| DataMap guide | [DataMap Functions](agents-sdk/python/guides/data-map) |
| SWAIG functions | [SWAIG Function API](agents-sdk/python/reference/swaig-function) |
| Function results | [SwaigFunctionResult API](agents-sdk/python/reference/function-result) |
| Testing DataMap | [swaig-test CLI](agents-sdk/python/reference/cli-swaig-test) - DataMap functions make live HTTP calls |
