...
| Section | Description |
|---------|-------------|
| [AgentBase API](/agents-sdk/api/agent-base) | Main agent class reference |
| [SWMLService API](/agents-sdk/api/swml-service) | Base service class reference |
| [SWAIG Function API](/agents-sdk/api/swaig-function) | Function definition reference |
| [SwaigFunctionResult API](/agents-sdk/api/function-result) | Return value and actions reference |
| [DataMap API](/agents-sdk/api/data-map) | Serverless API integration reference |
| [SkillBase API](/agents-sdk/api/skill-base) | Custom skill development reference |
| [ContextBuilder API](/agents-sdk/api/contexts) | Workflow system reference |
| [swaig-test CLI](/agents-sdk/api/cli/swaig-test) | Testing tool reference |
| [sw-search CLI](/agents-sdk/api/cli-sw-search) | Search tool reference |
| [Environment Variables](/agents-sdk/api/environment-variables) | Environment configuration |
| [Config Files](/agents-sdk/api/configuration) | File-based configuration |
| [SWML Schema](/agents-sdk/api/swml-schema) | Document structure reference |
...
| Topic | Reference |
|-------|-----------|
| Creating prompts | [Prompts [Prompts & POM](/agents-sdk/building-agents/prompts-pom) POM](/agents-sdk/building-agents/prompts-pom) |
| Voice configuration | [Voice [Voice & Language](/agents-sdk/building-agents/voice-language) Language](/agents-sdk/building-agents/voice-language) |
| Function definitions | [SWAIG Function API](/agents-sdk/api/swaig-function) |
| Function results | [SwaigFunctionResult API](/agents-sdk/api/function-result) |
| Multi-step workflows | [ContextBuilder API](/agents-sdk/api/contexts) |
| Testing agents | [swaig-test CLI](/agents-sdk/api/cli/swaig-test) |
