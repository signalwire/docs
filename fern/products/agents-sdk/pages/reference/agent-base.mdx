---
id: fec5bfdc-64dd-4799-9002-bda1aaa190d3
title: "Agent Base"
sidebar-title: "Agent Base"
...
| Section | Description |
|---------|-------------|
| [AgentBase API](/agents-sdk/python/reference/agent-base) | Main agent class reference |
| [SWMLService API](/agents-sdk/python/reference/swml-service) | Base service class reference |
| [SWAIG Function API](/agents-sdk/python/reference/swaig-function) | Function definition reference |
| [SwaigFunctionResult API](/agents-sdk/python/reference/function-result) | Return value and actions reference |
| [DataMap API](/agents-sdk/python/reference/data-map) | Serverless API integration reference |
| [SkillBase API](/agents-sdk/python/reference/skill-base) | Custom skill development reference |
| [ContextBuilder API](/agents-sdk/python/reference/contexts) | Workflow system reference |
| [swaig-test CLI](/agents-sdk/python/reference/cli-swaig-test) | Testing tool reference |
| [sw-search CLI](/agents-sdk/python/reference/cli-sw-search) | Search tool reference |
| [Environment Variables](/agents-sdk/python/reference/environment-variables) | Environment configuration |
| [Config Files](/agents-sdk/python/reference/configuration) | File-based configuration |
| [SWML Schema](/agents-sdk/python/reference/swml-schema) | Document structure reference |
...
| Topic | Reference |
|-------|-----------|
| Creating prompts | [Prompts [Prompts & POM](/agents-sdk/python/guides/prompts-pom) POM](/agents-sdk/python/guides/prompts-pom) |
| Voice configuration | [Voice [Voice & Language](/agents-sdk/python/guides/voice-language) Language](/agents-sdk/python/guides/voice-language) |
| Function definitions | [SWAIG Function API](/agents-sdk/python/reference/swaig-function) |
| Function results | [SwaigFunctionResult API](/agents-sdk/python/reference/function-result) |
| Multi-step workflows | [ContextBuilder API](/agents-sdk/python/reference/contexts) |
| Testing agents | [swaig-test CLI](/agents-sdk/python/reference/cli-swaig-test) |
