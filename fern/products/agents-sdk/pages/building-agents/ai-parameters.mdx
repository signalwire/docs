---
id: 1b66ede0-c70b-47bb-8223-cf226dde29ff
title: "AI Parameters"
sidebar-title: "AI Parameters"
position: 5
slug: /building-agents/ai-parameters
max-toc-depth: 3
---

## AI Parameters

Tune conversation behavior with parameters for speech detection, timeouts, barge control, and AI model settings. For a complete parameter reference, see [AI Parameters Reference](/agents-sdk/appendix/ai-parameters-reference).
...
See the **[AI Parameters Reference](/agents-sdk/appendix/ai-parameters-reference)** in the Appendix.
