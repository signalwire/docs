...
Tune conversation behavior with parameters for speech detection, timeouts, barge control, and AI model settings. For a complete parameter reference, see [AI Parameters Reference](agents-sdk/python/reference/ai-parameters-reference).
...
See the **[AI Parameters Reference](agents-sdk/python/reference/ai-parameters-reference)** in the Appendix.
