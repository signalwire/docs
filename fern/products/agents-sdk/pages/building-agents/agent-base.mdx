...
| Section | Description |
|---------|-------------|
| [AgentBase](/agents-sdk/python/guides/agent-base) | Core class and constructor options |
| [Static vs Dynamic](/agents-sdk/building-agents/static-vs-dynamic) | Choosing the right pattern |
| [Prompts & POM](/agents-sdk/python/guides/prompts-pom) | Prompt engineering for voice AI |
| [Voice & Language](/agents-sdk/python/guides/voice-language) | Voice selection and multi-language |
