...
<Frame caption="Agent Components">
  <img class="diagram" src="/docs/assets/images/agents-sdk-manual/03_01_agent-base_diagram1.webp" alt="Agent Components." />
</Frame>
...
| [Static vs Dynamic](/docs/agents-sdk/building-agents/static-vs-dynamic) | Choosing the right pattern |
...
| [AI Parameters](/docs/agents-sdk/building-agents/ai-parameters) | Behavior tuning |
| [Hints](/docs/agents-sdk/building-agents/hints) | Speech recognition improvement |
| [Call Flow](/docs/agents-sdk/building-agents/call-flow) | Customizing call answer behavior |
...
<Frame caption="AgentBase Inheritance">
  <img class="diagram" src="/docs/assets/images/agents-sdk-manual/03_01_agent-base_diagram2.webp" alt="AgentBase Inheritance." />
</Frame>
...
<Frame caption="Agent Lifecycle">
  <img class="diagram" src="/docs/assets/images/agents-sdk-manual/03_01_agent-base_diagram3.webp" alt="Agent Lifecycle." />
</Frame>
