...
| [Static vs Dynamic](agents-sdk/python/guides/static-vs-dynamic) | Choosing the right pattern |
...
| [AI Parameters](agents-sdk/python/guides/ai-parameters) | Behavior tuning |
| [Hints](agents-sdk/python/guides/hints) | Speech recognition improvement |
| [Call Flow](agents-sdk/python/guides/call-flow) | Customizing call answer behavior |
