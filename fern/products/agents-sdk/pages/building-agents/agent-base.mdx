---
id: a7dee78a-4e34-4284-8428-d28d8a41d547
title: "AgentBase"
sidebar-title: "AgentBase"
position: 1
slug: /building-agents/agent-base
subtitle: Learn how to build voice AI agents using AgentBase, from basic configuration to advanced prompt engineering and voice customization.
max-toc-depth: 3
---
...
<Frame caption="Agent Components">
  <img class="diagram" src="/assets/images/agents-sdk-manual/03_01_agent-base_diagram1.webp" alt="Agent Components." />
</Frame>
...
| Section | Description |
|---------|-------------|
| [AgentBase](/agents-sdk/building-agents/agent-base) | Core class and constructor options |
| [Static vs Dynamic](/agents-sdk/building-agents/static-vs-dynamic) | Choosing the right pattern |
| [Prompts & POM](/agents-sdk/building-agents/prompts-pom) | Prompt engineering for voice AI |
| [Voice & Language](/agents-sdk/building-agents/voice-language) | Voice selection and multi-language |
| [AI Parameters](/agents-sdk/building-agents/ai-parameters) | Behavior tuning |
| [Hints](/agents-sdk/building-agents/hints) | Speech recognition improvement |
| [Call Flow](/agents-sdk/building-agents/call-flow) | Customizing call answer behavior |
...
<Frame caption="AgentBase Inheritance">
  <img class="diagram" src="/assets/images/agents-sdk-manual/03_01_agent-base_diagram2.webp" alt="AgentBase Inheritance." />
</Frame>
...
<Frame caption="Agent Lifecycle">
  <img class="diagram" src="/assets/images/agents-sdk-manual/03_01_agent-base_diagram3.webp" alt="Agent Lifecycle." />
</Frame>
