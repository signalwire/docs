---
id: 149421db-4938-457c-8be7-5a0bffe6b730
title: "Hints"
sidebar-title: "Hints"
position: 6
slug: /python/guides/hints
max-toc-depth: 3
subtitle: Use speech hints to improve recognition accuracy for domain-specific vocabulary, brand names, technical terms, and other words the STT engine might misinterpret.
---

### Why Use Hints?

<Frame caption="Speech Hints">
  <img class="diagram" src="/docs/assets/images/agents-sdk-manual/03_06_hints_diagram1.webp" alt="Speech Hints." />
</Frame>
