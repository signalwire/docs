...
<Frame caption="PRE-ANSWER VERBS (call still ringing)" class="diagram">
  ![PRE-ANSWER VERBS (call still ringing).](/assets/images/agents-sdk-manual/03_07_call-flow_diagram1.webp)
</Frame>
