...
<Frame caption="PRE-ANSWER VERBS (call still ringing)">
  <img class="diagram" src="/docs/assets/images/agents-sdk-manual/03_07_call-flow_diagram1.webp" alt="PRE-ANSWER VERBS (call still ringing)." />
</Frame>
...
- [AI Parameters](/docs/agents-sdk/building-agents/ai-parameters) - Tuning AI behavior
