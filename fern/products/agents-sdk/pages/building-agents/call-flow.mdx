...
max-toc-depth: 3
subtitle: Control call flow with verb insertion points for pre-answer, post-answer, and post-AI actions.
---
...
<Frame caption="PRE-ANSWER VERBS (call still ringing)">
  <img class="diagram" src="/assets/images/agents-sdk-manual/03_07_call-flow_diagram1.webp" alt="PRE-ANSWER VERBS (call still ringing)." />
</Frame>
...
- [AgentBase API](/agents-sdk/python/reference/agent-base) - Full parameter reference
- [SWML Schema](/agents-sdk/python/reference/swml-schema) - All available verbs
- [AI Parameters](/agents-sdk/building-agents/ai-parameters) - Tuning AI behavior
