...
<Frame caption="Complete Call Lifecycle">
  <img class="diagram" src="/assets/images/agents-sdk-manual/02_04_lifecycle_diagram1.webp" alt="Complete Call Lifecycle." />
</Frame>
...
<Frame caption="Call Setup">
  <img class="diagram" src="/assets/images/agents-sdk-manual/02_04_lifecycle_diagram2.webp" alt="Call Setup." />
</Frame>
...
<Frame caption="AI Conversation Loop">
  <img class="diagram" src="/assets/images/agents-sdk-manual/02_04_lifecycle_diagram3.webp" alt="AI Conversation Loop." />
</Frame>
...
<Frame caption="SWAIG Function Call">
  <img class="diagram" src="/assets/images/agents-sdk-manual/02_04_lifecycle_diagram4.webp" alt="SWAIG Function Call." />
</Frame>
...
<Frame caption="Call Ending">
  <img class="diagram" src="/assets/images/agents-sdk-manual/02_04_lifecycle_diagram5.webp" alt="Call Ending." />
</Frame>
