...
Understand the fundamental architecture, protocols, and patterns that power the SignalWire Agents SDK.
...
- Completed the [Getting Started](/agents-sdk/) chapter
...
<Frame caption="SignalWire Agents SDK Architecture">
  <img class="diagram" src="/assets/images/agents-sdk-manual/02_01_architecture_diagram1.webp" alt="SignalWire Agents SDK Architecture." />
</Frame>
...
| Section | Description |
|---------|-------------|
| [Architecture](/agents-sdk/core-concepts/architecture) | AgentBase class and mixin composition |
| [SWML](/agents-sdk/api/agent-base) | Understanding SWML document structure |
| [SWAIG](/agents-sdk/swaig-functions/results-actions) | How AI calls your functions |
| [Lifecycle](/agents-sdk/core-concepts/lifecycle) | Request/response flow |
| [Security](/agents-sdk/core-concepts/security) | Authentication and token security |
...
<Frame caption="AgentBase Mixin Composition">
  <img class="diagram" src="/assets/images/agents-sdk-manual/02_01_architecture_diagram2.webp" alt="AgentBase." />
</Frame>
