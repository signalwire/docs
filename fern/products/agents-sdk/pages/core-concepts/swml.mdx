...
<Frame caption="SWML Flow">
  <img class="diagram" src="/assets/images/agents-sdk-manual/02_02_swml_diagram1.webp" alt="SWML Flow." />
</Frame>
...
<Frame caption="SWML Rendering Pipeline">
  <img class="diagram" src="/assets/images/agents-sdk-manual/02_02_swml_diagram2.webp" alt="SWML Rendering Pipeline." />
</Frame>
