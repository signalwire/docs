...
<Frame caption="MCP Gateway Flow" class="diagram">
  ![MCP Gateway Flow.](/assets/images/agents-sdk-manual/06_07_mcp-gateway_diagram1.webp)
</Frame>
...
| Topic | Reference |
|-------|-----------|
| Built-in Skills | [Built-in Skills](/agents-sdk/skills/builtin-skills) |
| SWAIG Functions | [Defining Functions](/agents-sdk/swaig-functions/defining-functions) |
| Testing | [swaig-test CLI](/agents-sdk/api/cli/swaig-test) |
