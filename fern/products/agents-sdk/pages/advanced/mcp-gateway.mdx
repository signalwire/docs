...
<Frame caption="MCP Gateway Flow">
  <img class="diagram" src="/assets/images/agents-sdk-manual/06_07_mcp-gateway_diagram1.webp" alt="MCP Gateway Flow." />
</Frame>
...
| Topic | Reference |
|-------|-----------|
| Built-in Skills | [Built-in Skills](agents-sdk/python/guides/builtin-skills) |
| SWAIG Functions | [Defining Functions](agents-sdk/python/guides/defining-functions) |
| Testing | [swaig-test CLI](agents-sdk/python/reference/cli-swaig-test) |
