...
| [Call Recording](/docs/agents-sdk/advanced/call-recording) | Record calls with various options |
...
| [Search & Knowledge](/docs/agents-sdk/advanced/search-knowledge) | Vector search integration |
...
<Frame caption="Context Structure">
  <img class="diagram" src="/docs/assets/images/agents-sdk-manual/06_01_contexts-workflows_diagram1.webp" alt="Context Structure." />
</Frame>
