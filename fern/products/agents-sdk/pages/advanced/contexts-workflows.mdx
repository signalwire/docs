---
id: 3836748c-8a44-440e-83e9-544d8abd821d
...
| Section | Description |
|---------|-------------|
| [Contexts & Workflows](agents-sdk/python/guides/contexts-workflows) | Build multi-step conversation flows |
| [State Management](agents-sdk/python/guides/state-management) | Manage session and call state |
| [Call Recording](agents-sdk/python/guides/call-recording) | Record calls with various options |
| [Call Transfer](agents-sdk/python/guides/call-transfer) | Transfer calls to destinations |
| [Multi-Agent](agents-sdk/python/guides/multi-agent) | Run multiple agents on one server |
| [Search & Knowledge](agents-sdk/python/guides/search-knowledge) | Vector search integration |
...
<Frame caption="Context Structure">
  <img class="diagram" src="/assets/images/agents-sdk-manual/06_01_contexts-workflows_diagram1.webp" alt="Context Structure." />
</Frame>
