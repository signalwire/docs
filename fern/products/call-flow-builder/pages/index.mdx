...
<Frame caption="A sample Call Flow showcasing input-gathering, recording, AI Agent, and TTS features.">
  ![A sample call flow created with Call Flow Builder, showing connections between nodes.](/images/call-flow/sample-flow.webp)
</Frame>
...
<Frame caption="Creating a new Call Flow." ogImage>
  ![Creating a new Call Flow in the SignalWire Dashboard.](/images/call-flow/create_flow.webp)
</Frame>
...
<Frame caption="Editing a Call Flow.">
  ![Clicking on the edit option for a Call Flow.](/images/call-flow/edit_flow.webp)
</Frame>
...
<Frame caption="Adding a new node to a Call Flow.">
  ![Adding a new node to a Call Flow.](/images/call-flow/add_node.webp)
</Frame>
...
<Frame caption="Configuring a node in a Call Flow.">
  ![Configuring a node in a Call Flow.](/images/call-flow/configure_node.webp)
</Frame>
...
<Frame caption="Deleting a node from a Call Flow.">
  ![Deleting a node from a Call Flow.](/images/call-flow/delete_node.webp)
</Frame>
