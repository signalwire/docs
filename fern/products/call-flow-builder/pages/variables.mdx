...
<Frame caption="Pass the caller phone number using a variable.">
  ![Using a phone number as a variable in a Call Flow.](/images/call-flow/to-variable.webp)
</Frame>
...
<Frame caption="Use the `slice()` method to alter a variable.">
  ![Using slice to alter a variable.](/images/call-flow/slice-variable.webp)
</Frame>
