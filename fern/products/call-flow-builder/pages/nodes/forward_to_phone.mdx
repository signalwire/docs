---
id: f2728d31-d160-4ab1-bac5-29b45028d683
...
[variables]: /call-flow-builder/reference/variables
...
![A Call Flow that uses the Forward to Phone node to forward the call while preserving the original caller ID.](/docs/assets/images/call-flow/nodes/forward-from-original-example.webp)
...
![A Call Flow that uses the Forward to Phone node to forward the call to a sip endpoint.](/docs/assets/images/call-flow/nodes/forward-sip.webp)
...
![Forward to multiple SIP endpoints and phone numbers sequentially using the Forward to Phone node.](/docs/assets/images/call-flow/nodes/forward-mix.webp)
