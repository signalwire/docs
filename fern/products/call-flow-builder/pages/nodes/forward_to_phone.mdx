...
<ParamField path="Enable Whisper" type="boolean">
  This executes [SWML](swml) when the call is answered. The SWML will be executed before connecting the call.<br /><br />**Handle Via:** `External URL` that is hosted off the SignalWire platform, or a [`SWML`](swml) script [resource](/docs/platform/resources).
</ParamField>
