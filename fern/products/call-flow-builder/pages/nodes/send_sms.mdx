---
id: d67de0e5-2ee8-4841-ac69-6a4462a87ee1
title: Send SMS
description: Call Flow Builder node to send an SMS
slug: /call-flow-builder/nodes/send_sms
---
...
![Sending an SMS with a variable in Call Flow Builder.](/assets/images/call-flow/nodes/send-sms.webp)
</Frame>
...
<Frame caption="Sending an SMS notification as a Call Whisper." ogImage>
    ![Sending an SMS notification as a Call Whisper.](/assets/images/call-flow/nodes/sms-whisper.webp)
</Frame>
