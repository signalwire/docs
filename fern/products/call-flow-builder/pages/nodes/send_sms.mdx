...
![Sending an SMS with a variable in Call Flow Builder.](/images/call-flow/nodes/send-sms.webp)
</Frame>
...
<Frame caption="Sending an SMS notification as a Call Whisper." ogImage>
    ![Sending an SMS notification as a Call Whisper.](/images/call-flow/nodes/sms-whisper.webp)
</Frame>
