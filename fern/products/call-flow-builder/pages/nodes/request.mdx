---
id: 6fd48151-b077-4f9d-9320-94d11fe1289f
title: Request
...
so either use them immediately or store them with a [Set Variables](call-flow-builder/reference/set-variables) node.

For a more in-depth explanation of using variables, see the
[Using Variables](call-flow-builder/reference/variables)
...
![Request node example with webhook.site.](/assets/images/call-flow/nodes/request-test.webp)
</Frame>
...
![Request node example with timeapi.io.](/assets/images/call-flow/nodes/request-time.webp)
</Frame>
