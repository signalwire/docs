...
![Request node example with webhook.site.](/images/call-flow/nodes/request-test.webp)
</Frame>
...
![Request node example with timeapi.io.](/images/call-flow/nodes/request-time.webp)
</Frame>
