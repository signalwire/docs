...
[Using Variables](/docs/call-flow-builder/reference/variables)
...
![Request node example with webhook.site.](/docs/assets/images/call-flow/nodes/request-test.webp)
</Frame>
...
![Request node example with timeapi.io.](/docs/assets/images/call-flow/nodes/request-time.webp)
</Frame>
