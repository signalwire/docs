...
max-toc-depth: 3
---
This node is used to connect to a SignalWire conversational [AI agent](/docs/platform/ai).
...
<Tip>
Learn more in the [SignalWire AI overview](/docs/platform/ai).
</Tip>

## **Node Settings**

<ParamField path="AI Agent Name" type="string" toc={true}>
  The name of the AI agent to connect to. The dropdown menu will populate with any [AI Agent Resource](/docs/platform/ai) that have been created in your SignalWire portal.
</ParamField>
