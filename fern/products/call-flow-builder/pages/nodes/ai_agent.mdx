...
<ParamField path="AI Agent Name" type="string">
  The name of the AI agent to connect to. The dropdown menu will populate with any [AI Agent Resource](/platform/ai/no-code-agents) that have been created in your SignalWire portal.
</ParamField>
