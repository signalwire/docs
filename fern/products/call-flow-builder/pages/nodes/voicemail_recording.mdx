---
id: 147c8b5b-55b6-4990-806e-be1c9b6df86b
...
[Play Audio or TTS](/call-flow-builder/reference/play-audio-or-tts) node and including a beep before recording. 
...
You can pair this node with a [Request](/call-flow-builder/reference/request) node to send the recording URL to the webhook of your choice. 
...
[Set Variables](/call-flow-builder/reference/set-variables) to save this URL for a later request.

<Frame caption="Record voicemail and send URL and call data as a POST request.">
![Record voicemail and send URL and call data as a POST request.](/assets/images/call-flow/nodes/post-voicemail.webp)
</Frame>
...
![Record voicemail and send URL and call data as an SMS.](/assets/images/call-flow/nodes/voicemail-sms.webp)
</Frame>
