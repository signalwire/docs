---
id: 8afaf859-a3b9-4551-a62b-dca41ac17dbc
title: Gather Input
...
![Gather Input node example that accepts both DTMF and speech input.](/docs/assets/images/call-flow/nodes/simple-input.webp)
...
![Call Flow that prevents an infinite loop with a count and condition check.](/docs/assets/images/call-flow/nodes/input-loop-protection.webp)
...
![Call Flow that accepts any speech and repeats it back to the caller.](/docs/assets/images/call-flow/nodes/unknown-speech-input.webp)
