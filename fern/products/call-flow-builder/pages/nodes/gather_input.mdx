...
You can do that with a combination of a [Set Variables](/call-flow-builder/reference/set-variables) node 
and a [Conditions](/call-flow-builder/reference/conditions) node.
