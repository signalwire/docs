...
![Gather Input node example that accepts both DTMF and speech input.](/images/call-flow/nodes/simple-input.webp)
...
![Call Flow that prevents an infinite loop with a count and condition check.](/images/call-flow/nodes/input-loop-protection.webp)
...
![Call Flow that accepts any speech and repeats it back to the caller.](/images/call-flow/nodes/unknown-speech-input.webp)
