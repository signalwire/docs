...
---
The Unset Variables is used to clear any variable that was set using [Set Variables](/call-flow-builder/reference/set-variables).
...
<ParamField path="Variables" type="array">
  The variables that you want to unset. Variables will show in the drop-down menu if they are set in the call flow. Variables are set by [Set Variables](/call-flow-builder/reference/set-variables) node.
</ParamField>
