...
Access these variables in other blocks with `%{<Key>}` and unset variables with the [Unset Variables](call-flow-builder/reference/unset-variables) node.
...
[Request](call-flow-builder/reference/request) 
