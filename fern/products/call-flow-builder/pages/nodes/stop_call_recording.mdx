...
slug: /call-flow-builder/nodes/stop-call-recording
...
<ParamField path="Recording Name" type="string">
  The name of the recording to stop. This should be connected to a [Start Call Recording](../start_call_recording/index.mdx) node and match the recording name.
</ParamField>
