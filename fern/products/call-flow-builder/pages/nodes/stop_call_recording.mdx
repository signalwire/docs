...
<ParamField path="Recording Name" type="string">
  The name of the recording to stop. This should be connected to a [Start Call Recording](/call-flow-builder/reference/start-call-recording) node and match the recording name.
</ParamField>
...
![Record a call and save the URL to a variable.](/assets/images/call-flow/nodes/record-call.webp)
</Frame>
