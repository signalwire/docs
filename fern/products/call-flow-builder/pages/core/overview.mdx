---
id: e2395aaf-51bc-4c9a-8ed4-0efe7163c968
title: Call Flow Builder
subtitle: A visual tool for creating and managing call flows
...
<Frame caption="A sample Call Flow showcasing input-gathering, recording, AI Agent, and TTS features.">
  ![A sample call flow created with Call Flow Builder, showing connections between nodes.](/docs/assets/images/call-flow/sample-flow.webp)
</Frame>
...
<Frame caption="Creating a new Call Flow." ogImage>
  ![Creating a new Call Flow in the SignalWire Dashboard.](/docs/assets/images/call-flow/create_flow.webp)
</Frame>
...
<Frame caption="Editing a Call Flow.">
  ![Clicking on the edit option for a Call Flow.](/docs/assets/images/call-flow/edit_flow.webp)
</Frame>


#### Add a node
When you first open a new Call Flow, you will see a canvas with a single [node](/docs/call-flow-builder/reference):
...
<Frame caption="Adding a new node to a Call Flow.">
  ![Adding a new node to a Call Flow.](/docs/assets/images/call-flow/add_node.webp)
</Frame>
...
<Frame caption="Configuring a node in a Call Flow.">
  ![Configuring a node in a Call Flow.](/docs/assets/images/call-flow/configure_node.webp)
</Frame>
...
<Frame caption="Deleting a node from a Call Flow.">
  ![Deleting a node from a Call Flow.](/docs/assets/images/call-flow/delete_node.webp)
</Frame>
