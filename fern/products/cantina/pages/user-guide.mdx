...
![A text box labeled Email.](/assets/images/cantina/0a4ca51-welcome.webp "A text box labeled Email.")

**Step - 2: On valid email address input, the system will redirect the user to the next page.**

![A login pane with a text box labeled Password.](/assets/images/cantina/c3cbeb5-Login2.webp "A login pane with a text box labeled Password.")
...
![The Reset Password pane with a text box labeled Email.](/assets/images/cantina/83f56c5-login3.webp "The Reset Password pane with a text box labeled Email.")
...
![The Guest Login page, with text fields labeled Name and Company.](/assets/images/cantina/f9718c8-Login4.webp "The Guest Login page, with text fields labeled Name and Company.")
...
![The YouTube interface showing the drop-down menu with an option labeled Go Live.](/assets/images/cantina/0d37470-pic25.webp "The YouTube interface showing the drop-down menu with an option labeled Go Live.")

In the YouTube Live Control Room select START for Right now or Later date.

![YouTube Live Control Room with options to select START for Right now or Later date.](/assets/images/cantina/89ecd45-pic26.webp "YouTube Live Control Room with options to select START for Right now or Later date.")

- Click GO for Built-in webcam to stream.

![The options to select a built-in webcam or streaming software.](/assets/images/cantina/b77a36d-pic27.webp "The options to select a built-in webcam or streaming software.")
...
![The Webcam Stream Info page with options.](/assets/images/cantina/48d5a19-pic28.webp "The Webcam Stream Info page with options.")
...
![The Stream Settings configuration tab with options for the stream keys, Stream URL, etc.](/assets/images/cantina/0038825-pic29.webp "The Stream Settings configuration tab with options for the stream keys, Stream URL, etc.")
...
![The Reset Password page, with a text box for the user's email address.](/assets/images/cantina/dad0d77-login3.webp "The Reset Password page, with a text box for the user's email address.")
...
![The Site Permissions tab of the Settings window for the Edge browser, with Camera access enabled for SignalWire.](/assets/images/cantina/8821195-Pic1.webp "The Site Permissions tab of the Settings window for the Edge browser, with Camera access enabled for SignalWire.")
...
![The Site Permissions tab of the Settings window for the Edge browser, with Microphone access enabled for SignalWire.](/assets/images/cantina/d7a2748-Pic2.webp "The Site Permissions tab of the Settings window for the Edge browser, with Microphone access enabled for SignalWire.")
...
![The Camera Settings tab for the Chrome browser, with Camera access enabled for sw.work.](/assets/images/cantina/792d10c-pic3.webp "The Camera Settings tab for the Chrome browser, with Camera access enabled for sw.work.")
...
![The Microphone Settings tab for the Chrome browser, with access enabled for sw.work.](/assets/images/cantina/3247f17-pic4.webp "The Microphone Settings tab for the Chrome browser, with access enabled for sw.work.")
...
![The Firefox Camera Permissions settings window.](/assets/images/cantina/9b00133-pic5.webp "The Firefox Camera Permissions settings window.")
...
![The Firefox Microphone Permissions settings window.](/assets/images/cantina/575fc5c-pic6.webp "The Firefox Microphone Permissions settings window.")
...
![The Safari Camera Permissions settings window.](/assets/images/cantina/f004755-pic7.webp "The Safari Camera Permissions settings window.")
...
![The Safari Microphone Permissions settings window.](/assets/images/cantina/5a327ae-pic8.webp "The Safari Microphone Permissions settings window.")
...
![The Safari Screen Sharing Permissions settings window.](/assets/images/cantina/b0ae3d3-pic9.webp "The Safari Screen Sharing Permissions settings window.")
...
![The Camera page within Safari Settings on iPhone with the Ask option selected.](/assets/images/cantina/ae27801-pic10.webp "The Camera page within Safari Settings on iPhone with the Ask option selected.")
...
![The Microphone page within Safari Settings on iPhone with the Ask option selected.](/assets/images/cantina/0288fc0-pic11.webp "The Microphone page within Safari Settings on iPhone with the Ask option selected.")
...
![The Opera Camera settings window.](/assets/images/cantina/2d9c3c8-pic12.webp "The Opera Camera settings window.")
...
![The Microphone Camera settings window.](/assets/images/cantina/ee897bb-pic13.webp "The Microphone Camera settings window.")
...
![The Camera page in the MacOS Security & Privacy settings page.](/assets/images/cantina/b872aa5-pic14.webp "The Camera page in the MacOS Security & Privacy settings page.")

**Microphone** - check the corresponding box for the browser to allow access to the microphone.

![The Microphone page in the MacOS Security & Privacy settings page.](/assets/images/cantina/1703384-pic15.webp "The Microphone page in the MacOS Security & Privacy settings page.")

**Screen Recording** - check the corresponding box for the browser to allow access for recording the contents of the screen.

![The Screen Recording page in the MacOS Security & Privacy settings page.](/assets/images/cantina/4ca756b-pic16.webp "The Screen Recording page in the MacOS Security & Privacy settings page.")
...
![The Camera page in the Windows Settings app.](/assets/images/cantina/727fc50-pic17.webp "The Camera page in the Windows Settings app.")

![The Camera page in the Windows Settings app.](/assets/images/cantina/2951569-pic18.webp "The Camera page in the Windows Settings app.")
...
![The Microphone page in the Windows Settings app.](/assets/images/cantina/2d55729-pic19.webp "The Microphone page in the Windows Settings app.")

![The Microphone page in the Windows Settings app.](/assets/images/cantina/3288b47-pic20.webp "The Microphone page in the Windows Settings app.")
...
![The Screen Recording pane within the Privacy section of the Security and Privacy MacOS System Preferences window.](/assets/images/cantina/eba4713-pic21.webp "The Screen Recording pane within the Privacy section of the Security and Privacy MacOS System Preferences window.")
...
![The screen sharing menu showing options to share your entire screen, application window, or a Chrome tab.](/assets/images/cantina/af217d9-pic22.webp "The screen sharing menu showing options to share your entire screen, application window, or a Chrome tab.")

![An infinite mirror effect caused by recursive screen sharing.](/assets/images/cantina/d100d71-pic23.webp "An infinite mirror effect caused by recursive screen sharing.")
...
![The screen sharing menu showing options to share your entire screen, application window, or a Chrome tab.](/assets/images/cantina/c1b3804-pic24.webp "The screen sharing menu showing options to share your entire screen, application window, or a Chrome tab.")
