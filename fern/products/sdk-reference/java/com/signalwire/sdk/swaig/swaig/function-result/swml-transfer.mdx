...
slug: "/sdk-reference/java/com/signalwire/sdk/swaig/swaig/function-result/swml-transfer"
...
```java
public com.signalwire.sdk.swaig.FunctionResult swmlTransfer(
    java.lang.String dest,
    java.lang.String aiResponse,
    boolean isFinal
)
```
...
<ParamField path="aiResponse" type="java.lang.String" required></ParamField>
