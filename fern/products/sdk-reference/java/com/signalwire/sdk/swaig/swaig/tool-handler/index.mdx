...
slug: "/sdk-reference/java/com/signalwire/sdk/swaig/swaig/tool-handler"
...
```java
public abstract interface ToolHandler
```
...
<CardGroup cols={2}>
  <Card title="handle" href="/sdk-reference/java/com/signalwire/sdk/swaig/swaig/tool-handler/handle">
