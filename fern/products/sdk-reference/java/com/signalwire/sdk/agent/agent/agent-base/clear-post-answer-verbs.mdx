---
slug: "/reference/java/com/signalwire/sdk/agent/agent/agent-base/clear-post-answer-verbs"
...
lustri:
  ...
  kind: "method"
  language: "java"
  qualified_name: "com.signalwire.sdk.agent.AgentBase.clearPostAnswerVerbs"
...
```java
public com.signalwire.sdk.agent.AgentBase clearPostAnswerVerbs()
```
