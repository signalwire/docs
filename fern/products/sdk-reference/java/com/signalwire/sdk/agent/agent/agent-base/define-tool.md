...
| ------------- | -------------------------------------------------- | -------- | ------- | --------------------------------------------------------------------------- |
| `name`        | `java.lang.String`                                 | yes      | —       | the function name (snake\_case verb recommended).                           |
| `description` | `java.lang.String`                                 | yes      | —       | LLM-facing description of when to call this tool.                           |
| `parameters`  | `java.util.Map<java.lang.String,java.lang.Object>` | yes      | —       | JSON-schema properties map with LLM-facing descriptions for each parameter. |
| `handler`     | `com.signalwire.sdk.swaig.ToolHandler`             | yes      | —       | the Java handler invoked when the model calls this tool.                    |
