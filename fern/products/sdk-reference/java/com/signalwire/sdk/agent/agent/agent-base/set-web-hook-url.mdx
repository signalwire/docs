...
kind: "method"
language: "java"
qualified_name: "com.signalwire.sdk.agent.AgentBase.setWebHookUrl"
parent: "com.signalwire.sdk.agent.AgentBase"
module: "com.signalwire.sdk.agent.AgentBase"
slug: "/sdk-reference/java/com/signalwire/sdk/agent/agent/agent-base/set-web-hook-url"
...
```java
public com.signalwire.sdk.agent.AgentBase setWebHookUrl(java.lang.String url)
```
