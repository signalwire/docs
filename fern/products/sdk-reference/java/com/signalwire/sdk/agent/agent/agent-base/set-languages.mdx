...
slug: "/sdk-reference/java/com/signalwire/sdk/agent/agent/agent-base/set-languages"
...
<ParamField path="langs" type="java.util.List<java.util.Map<java.lang.String,java.lang.Object>>" required></ParamField>
