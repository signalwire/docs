...
slug: "/sdk-reference/java/com/signalwire/sdk/agent/agent/agent-base/dynamic-config-callback"
...
<CardGroup cols={2}>
  <Card title="configure" href="/sdk-reference/java/com/signalwire/sdk/agent/agent/agent-base/dynamic-config-callback/configure"></Card>
</CardGroup>
