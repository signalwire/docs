...
slug: "/sdk-reference/java/com/signalwire/sdk/agent/agent/agent-base/set-native-functions"
...
```java
public com.signalwire.sdk.agent.AgentBase setNativeFunctions(
    java.util.List<java.lang.String> funcs
)
```

## Parameters

<ParamField path="funcs" type="java.util.List<java.lang.String>" required></ParamField>
