...
<ParamField path="SIGNALWIRE_SIGNATURE_HEADER" type="java.lang.String SIGNALWIRE_SIGNATURE_HEADER = X-SignalWire-Signature" required>
  Header name that carries the signature on every signed SignalWire request.
</ParamField>

<ParamField path="TWILIO_COMPAT_SIGNATURE_HEADER" type="java.lang.String TWILIO_COMPAT_SIGNATURE_HEADER = X-Twilio-Signature" required>
