...
slug: "/sdk-reference/java/com/signalwire/sdk/runtime/runtime/lambda-url-resolver"
...
<CardGroup cols={2}>
  <Card title="&lt;init&gt;" href="/sdk-reference/java/com/signalwire/sdk/runtime/runtime/lambda-url-resolver/init">
    Create a resolver backed by the real process environment.
  </Card>
  <Card title="&lt;init&gt;" href="/sdk-reference/java/com/signalwire/sdk/runtime/runtime/lambda-url-resolver/init">
    Create a resolver backed by the given `EnvProvider`.
  </Card>
  <Card title="resolveBaseUrl" href="/sdk-reference/java/com/signalwire/sdk/runtime/runtime/lambda-url-resolver/resolve-base-url">
