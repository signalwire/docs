...
| ------- | -------------------------------------------------- | -------- | ------- | ---------------------------------------------------------------------------------------------------------- |
| `event` | `java.util.Map<java.lang.String,java.lang.Object>` | yes      | —       | the raw Lambda event (API Gateway v1, v2, or Function URL payload). Null events are treated as a root GET. |
