...
<CardGroup cols={2}>
  <Card title="LambdaAgentHandler" href="/docs/sdk-reference/reference/java/com/signalwire/sdk/runtime/lambda/lambda/lambda-agent-handler">
  ...
  <Card title="LambdaResponse" href="/docs/sdk-reference/reference/java/com/signalwire/sdk/runtime/lambda/lambda/lambda-response">
