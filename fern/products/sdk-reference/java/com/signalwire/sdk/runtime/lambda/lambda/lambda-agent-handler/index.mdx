...
slug: "/sdk-reference/java/com/signalwire/sdk/runtime/lambda/lambda/lambda-agent-handler"
...
<CardGroup cols={2}>
  <Card title="&lt;init&gt;" href="/sdk-reference/java/com/signalwire/sdk/runtime/lambda/lambda/lambda-agent-handler/init">
  ...
  <Card title="handle" href="/sdk-reference/java/com/signalwire/sdk/runtime/lambda/lambda/lambda-agent-handler/handle">
    Handle a single invocation.
  </Card>
  <Card title="stripAgentPath" href="/sdk-reference/java/com/signalwire/sdk/runtime/lambda/lambda/lambda-agent-handler/strip-agent-path">
