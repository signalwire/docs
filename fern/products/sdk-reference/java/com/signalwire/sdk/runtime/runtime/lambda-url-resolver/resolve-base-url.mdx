...
slug: "/sdk-reference/java/com/signalwire/sdk/runtime/runtime/lambda-url-resolver/resolve-base-url"
...
`java.lang.String` — bare origin (e.g. `https://xyz.lambda-url.us-east-1.on.aws`),
     or `null`.
