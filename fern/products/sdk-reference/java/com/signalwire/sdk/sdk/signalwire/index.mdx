...
slug: "/sdk-reference/java/com/signalwire/sdk/sdk/signalwire"
...
<CardGroup cols={2}>
  <Card title="addSkillDirectory" href="/sdk-reference/java/com/signalwire/sdk/sdk/signalwire/add-skill-directory">
    Add a directory to search for skills.
  </Card>
  <Card title="listSkillsWithParams" href="/sdk-reference/java/com/signalwire/sdk/sdk/signalwire/list-skills-with-params">
    Get complete schema for all available skills.
  </Card>
  <Card title="registerSkill" href="/sdk-reference/java/com/signalwire/sdk/sdk/signalwire/register-skill">
    Register a custom skill class with the global `SkillRegistry`.
  </Card>
  <Card title="RestClient" href="/sdk-reference/java/com/signalwire/sdk/sdk/signalwire/rest-client">
