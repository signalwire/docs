...
slug: "/sdk-reference/java/com/signalwire/sdk/sdk/signalwire/rest-client"
...
<ParamField path="args" type="java.util.List<java.lang.String>" required>
  positional credentials \u2014 empty or
             token, space]
</ParamField>
<ParamField path="kwargs" type="java.util.Map<java.lang.String,java.lang.String>" required>
  keyword credentials \u2014 recognised keys are
               `project` / `project_id`,
               `token`, and `space` / `host`
</ParamField>
