...
<CardGroup cols={2}>
  <Card title="<init>" href="/reference/java/com/signalwire/sdk/rest/namespaces/namespaces/project-namespace/init" />
  ...
  <Card title="tokens" href="/reference/java/com/signalwire/sdk/rest/namespaces/namespaces/project-namespace/tokens" />
