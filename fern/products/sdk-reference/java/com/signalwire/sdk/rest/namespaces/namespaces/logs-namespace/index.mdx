...
<CardGroup cols={2}>
  <Card title="ConferenceLogs" href="/docs/sdk-reference/reference/java/com/signalwire/sdk/rest/namespaces/namespaces/logs-namespace/conference-logs">
    Conference logs — list-only.
  </Card>

  <Card title="FaxLogs" href="/docs/sdk-reference/reference/java/com/signalwire/sdk/rest/namespaces/namespaces/logs-namespace/fax-logs">
    Fax logs — list + per-id get.
  </Card>

  <Card title="MessageLogs" href="/docs/sdk-reference/reference/java/com/signalwire/sdk/rest/namespaces/namespaces/logs-namespace/message-logs">
    Read-only logs supporting list + per-id get.
  </Card>

  <Card title="VoiceLogs" href="/docs/sdk-reference/reference/java/com/signalwire/sdk/rest/namespaces/namespaces/logs-namespace/voice-logs">
