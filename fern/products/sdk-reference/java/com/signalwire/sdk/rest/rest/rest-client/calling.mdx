...
slug: "/sdk-reference/java/com/signalwire/sdk/rest/rest/rest-client/calling"
...
```java
public com.signalwire.sdk.rest.namespaces.CallingNamespace calling()
```

## Returns

`com.signalwire.sdk.rest.namespaces.CallingNamespace`
