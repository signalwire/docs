...
<CardGroup cols={2}>
  ...
  <Card title="valueOf" href="/reference/java/com/signalwire/sdk/rest/rest/phone-call-handler/value-of"></Card>
  <Card title="values" href="/reference/java/com/signalwire/sdk/rest/rest/phone-call-handler/values"></Card>
