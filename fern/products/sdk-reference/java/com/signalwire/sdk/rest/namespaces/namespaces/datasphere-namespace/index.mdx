...
<CardGroup cols={2}>
  <Card title="&lt;init&gt;" href="/reference/java/com/signalwire/sdk/rest/namespaces/namespaces/datasphere-namespace/init"></Card>
  <Card title="documents" href="/reference/java/com/signalwire/sdk/rest/namespaces/namespaces/datasphere-namespace/documents"></Card>
