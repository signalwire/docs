...
| ---------- | ------------------------------------- | -------- | ------- | ------------------------------------------------------------------------------------------------------------------------- |
| `exchange` | `com.sun.net.httpserver.HttpExchange` | yes      | —       | the HTTP exchange.                                                                                                        |
| `rawBody`  | `java.lang.String`                    | yes      | —       | the raw UTF-8 body string already read from the exchange. Pass through to `com.signalwire.sdk.security.WebhookValidator`. |
