...
unmodifiable. Used by introspection callers (CLI `--list-tools`
...
```java
public java.util.Map<java.lang.String,com.signalwire.sdk.swaig.ToolDefinition> getRegisteredTools()
```

## Returns

`java.util.Map<java.lang.String,com.signalwire.sdk.swaig.ToolDefinition>`
