...
<CardGroup cols={2}>
  ...
  <Card title="getErrors" href="/reference/java/com/signalwire/sdk/swml/swml/schema-validation-error/get-errors"></Card>
  <Card title="getVerbName" href="/reference/java/com/signalwire/sdk/swml/swml/schema-validation-error/get-verb-name"></Card>
</CardGroup>
