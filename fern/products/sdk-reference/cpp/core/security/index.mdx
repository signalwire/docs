...
<CardGroup cols={2}>
  <Card title="SessionManager" href="/docs/sdk-reference/reference/cpp/core/security/session-manager">
  ...
  <Card title="WebhookValidatorOptions" href="/docs/sdk-reference/reference/cpp/core/security/webhook-validator-options">
