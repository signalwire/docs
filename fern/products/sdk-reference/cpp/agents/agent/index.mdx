...
<CardGroup cols={2}>
  <Card title="AgentBase" href="/docs/sdk-reference/reference/cpp/agents/agent/agent-base" />

  <Card title="LanguageConfig" href="/docs/sdk-reference/reference/cpp/agents/agent/language-config">
    Language configuration.
  </Card>

  <Card title="Pronunciation" href="/docs/sdk-reference/reference/cpp/agents/agent/pronunciation">
    Pronunciation rule.
  </Card>

  <Card title="SwaigQueryParam" href="/docs/sdk-reference/reference/cpp/agents/agent/swaig-query-param">
