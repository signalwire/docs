...
<CardGroup cols={2}>
  <Card title="Candidate" href="/docs/sdk-reference/reference/cpp/agents/skills/web-search-core/candidate">
    One Google CSE hit: title / link / snippet, plus the page text once a scrape succeeds.
  </Card>

  <Card title="LatencyParams" href="/docs/sdk-reference/reference/cpp/agents/skills/web-search-core/latency-params">
