...
<CardGroup cols={2}>
  <Card title="Action" href="/docs/sdk-reference/reference/cpp/signalwire/relay/action">
  ...
  <Card title="Call" href="/docs/sdk-reference/reference/cpp/signalwire/relay/call">
  ...
  <Card title="CallEvent" href="/docs/sdk-reference/reference/cpp/signalwire/relay/call-event">
    Call-specific event parsed from calling.call.state and other call events.
  </Card>

  <Card title="ComponentEvent" href="/docs/sdk-reference/reference/cpp/signalwire/relay/component-event">
    Play/Record/Collect component event with control\_id for action routing.
  </Card>

  <Card title="Device" href="/docs/sdk-reference/reference/cpp/signalwire/relay/device" />

  <Card title="DialEvent" href="/docs/sdk-reference/reference/cpp/signalwire/relay/dial-event">
    Dial-specific event with nested call info and tag-based correlation.
  </Card>

  <Card title="Message" href="/docs/sdk-reference/reference/cpp/signalwire/relay/message">
  ...
  <Card title="MessageEvent" href="/docs/sdk-reference/reference/cpp/signalwire/relay/message-event">
    Messaging event for SMS/MMS state changes and inbound messages.
  </Card>

  <Card title="RelayClient" href="/docs/sdk-reference/reference/cpp/signalwire/relay/relay-client">
  ...
  <Card title="RelayConfig" href="/docs/sdk-reference/reference/cpp/signalwire/relay/relay-config">
    Configuration for the RELAY client.
  </Card>

  <Card title="RelayEvent" href="/docs/sdk-reference/reference/cpp/signalwire/relay/relay-event">
    Base class for all RELAY events parsed from signalwire.event JSON-RPC messages.
  </Card>

  <Card title="WebSocketClient" href="/docs/sdk-reference/reference/cpp/signalwire/relay/web-socket-client">
