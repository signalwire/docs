...
<CardGroup cols={2}>
  <Card title="json" href="/reference/cpp/signalwire/swaig/json"></Card>
  <Card title="ToolHandler" href="/reference/cpp/signalwire/swaig/tool-handler"></Card>
</CardGroup>
...
<CardGroup cols={2}>
  <Card title="FunctionResult" href="/reference/cpp/signalwire/swaig/function-result">
    Builder for SWAIG function results with 40+ action methods. Every method returns *this for chaining.
  </Card>
  <Card title="ToolDefinition" href="/reference/cpp/signalwire/swaig/tool-definition">
