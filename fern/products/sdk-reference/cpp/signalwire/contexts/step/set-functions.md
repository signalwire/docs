...
| ----------- | ----------------------------------------------------------------- | -------- | ------- | -------------------------------------------------------------------------------------------------------------------------------------------------------------- |
| `functions` | `const std::variant< std::string, std::vector< std::string > > &` | yes      | —       | One of: std::vector<std::string> — whitelist of allowed names empty std::vector — disable all user functions std::string "none" — synonym for the empty vector |
