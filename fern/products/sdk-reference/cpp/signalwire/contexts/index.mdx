...
<CardGroup cols={2}>
  <Card title="Context" href="/docs/sdk-reference/reference/cpp/signalwire/contexts/context" />

  <Card title="ContextBuilder" href="/docs/sdk-reference/reference/cpp/signalwire/contexts/context-builder">
  ...
  <Card title="GatherInfo" href="/docs/sdk-reference/reference/cpp/signalwire/contexts/gather-info" />

  <Card title="GatherQuestion" href="/docs/sdk-reference/reference/cpp/signalwire/contexts/gather-question" />

  <Card title="Step" href="/docs/sdk-reference/reference/cpp/signalwire/contexts/step" />
</CardGroup>
