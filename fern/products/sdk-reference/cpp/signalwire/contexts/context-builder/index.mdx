...
<CardGroup cols={2}>
  ...
  <Card title="ContextBuilder" href="/reference/cpp/signalwire/contexts/context-builder/context-builder" />

  <Card title="get_context" href="/reference/cpp/signalwire/contexts/context-builder/get-context">
    Get an existing context.
  </Card>

  <Card title="has_contexts" href="/reference/cpp/signalwire/contexts/context-builder/has-contexts" />
