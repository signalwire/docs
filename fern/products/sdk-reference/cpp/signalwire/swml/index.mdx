...
<CardGroup cols={2}>
  <Card title="Document" href="/docs/sdk-reference/reference/cpp/signalwire/swml/document">
    A complete SWML document with version and sections.
  </Card>

  <Card title="Schema" href="/docs/sdk-reference/reference/cpp/signalwire/swml/schema">
    Schema loader that extracts verb definitions from schema.json.
  </Card>

  <Card title="Section" href="/docs/sdk-reference/reference/cpp/signalwire/swml/section">
    A named section containing an ordered list of verbs.
  </Card>

  <Card title="Service" href="/docs/sdk-reference/reference/cpp/signalwire/swml/service">
  ...
  <Card title="Verb" href="/docs/sdk-reference/reference/cpp/signalwire/swml/verb">
    Represents a single SWML verb instance, e.g. \{"answer": \{"max\_duration": 3600\}\}.
  </Card>

  <Card title="VerbDefinition" href="/docs/sdk-reference/reference/cpp/signalwire/swml/verb-definition">
