...
module: "signalwire"
slug: "/sdk-reference/cpp/signalwire/security/validate-webhook-signature"
...
The customer's Signing Key. UTF-8 string. MUST NOT be empty — empty throws std::invalid_argument, that's a programming error not a validation failure. 
...
<ParamField path="raw_body" type="std::string_view" required></ParamField>
