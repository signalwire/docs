...
<CardGroup cols={2}>
  <Card title="errors" href="/reference/cpp/signalwire/utils/schema-validation-error/errors"></Card>
  <Card title="SchemaValidationError" href="/reference/cpp/signalwire/utils/schema-validation-error/schema-validation-error"></Card>
  <Card title="verb_name" href="/reference/cpp/signalwire/utils/schema-validation-error/verb-name"></Card>
</CardGroup>
