...
<CardGroup cols={2}>
  <Card title="SchemaUtils" href="/docs/sdk-reference/reference/cpp/signalwire/utils/schema-utils">
    SchemaUtils — C++ port of signalwire.utils.schema\_utils.SchemaUtils.
  </Card>

  <Card title="SchemaValidationError" href="/docs/sdk-reference/reference/cpp/signalwire/utils/schema-validation-error">
    SchemaValidationError — C++ port of signalwire.utils.schema\_utils.SchemaValidationError.
  </Card>

  <Card title="VerbInfo" href="/docs/sdk-reference/reference/cpp/signalwire/utils/verb-info">
...
<CardGroup cols={2}>
  <Card title="url_validator" href="/docs/sdk-reference/reference/cpp/signalwire/utils/url-validator" />
</CardGroup>
