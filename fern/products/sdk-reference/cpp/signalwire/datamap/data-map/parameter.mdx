...
slug: "/sdk-reference/cpp/signalwire/datamap/data-map/parameter"
...
<ParamField path="param_type" type="const std::string &" required></ParamField>
<ParamField path="desc" type="const std::string &" required></ParamField>
<ParamField path="required" type="bool" default="false"></ParamField>
<ParamField path="enum_values" type="const std::vector< std::string > &" default="{}"></ParamField>
