...
slug: "/sdk-reference/cpp/signalwire/datamap/data-map"
...
<CardGroup cols={2}>
  <Card title="body" href="/sdk-reference/cpp/signalwire/datamap/data-map/body">
    Set request body for the last added webhook.
  </Card>
  <Card title="DataMap" href="/sdk-reference/cpp/signalwire/datamap/data-map/data-map"></Card>
  <Card title="description" href="/sdk-reference/cpp/signalwire/datamap/data-map/description">
  ...
  <Card title="error_keys" href="/sdk-reference/cpp/signalwire/datamap/data-map/error-keys">
    Set error keys for the most recent webhook or top-level.
  </Card>
  <Card title="expression" href="/sdk-reference/cpp/signalwire/datamap/data-map/expression">
    Add an expression pattern for pattern-based responses.
  </Card>
  <Card title="fallback_output" href="/sdk-reference/cpp/signalwire/datamap/data-map/fallback-output">
    Set a fallback output at the top level.
  </Card>
  <Card title="foreach" href="/sdk-reference/cpp/signalwire/datamap/data-map/foreach">
    Set foreach configuration for the last webhook.
  </Card>
  <Card title="global_error_keys" href="/sdk-reference/cpp/signalwire/datamap/data-map/global-error-keys">
    Set top-level error keys.
  </Card>
  <Card title="output" href="/sdk-reference/cpp/signalwire/datamap/data-map/output">
    Set output for the most recent webhook.
  </Card>
  <Card title="parameter" href="/sdk-reference/cpp/signalwire/datamap/data-map/parameter">
  ...
  <Card title="params" href="/sdk-reference/cpp/signalwire/datamap/data-map/params">
    Set request params for the last added webhook (alias for body).
  </Card>
  <Card title="purpose" href="/sdk-reference/cpp/signalwire/datamap/data-map/purpose">
  ...
  <Card title="to_swaig_function" href="/sdk-reference/cpp/signalwire/datamap/data-map/to-swaig-function">
    Convert to a SWAIG function definition JSON.
  </Card>
  <Card title="webhook" href="/sdk-reference/cpp/signalwire/datamap/data-map/webhook">
    Add a webhook API call.
  </Card>
  <Card title="webhook_expressions" href="/sdk-reference/cpp/signalwire/datamap/data-map/webhook-expressions">
