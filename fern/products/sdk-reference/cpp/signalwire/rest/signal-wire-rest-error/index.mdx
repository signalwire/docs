...
<CardGroup cols={2}>
  <Card title="body" href="/reference/cpp/signalwire/rest/signal-wire-rest-error/body" />

  <Card title="SignalWireRestError" href="/reference/cpp/signalwire/rest/signal-wire-rest-error/signal-wire-rest-error" />

  <Card title="status" href="/reference/cpp/signalwire/rest/signal-wire-rest-error/status" />
</CardGroup>
