...
<CardGroup cols={2}>
  <Card title="list" href="/reference/cpp/signalwire/rest/rest-client/logs-conferences/list"></Card>
  <Card title="LogsConferences" href="/reference/cpp/signalwire/rest/rest-client/logs-conferences/logs-conferences"></Card>
</CardGroup>
