...
<CardGroup cols={2}>
  <Card title="get" href="/reference/cpp/signalwire/rest/rest-client/logs-messages/get"></Card>
  <Card title="list" href="/reference/cpp/signalwire/rest/rest-client/logs-messages/list"></Card>
  <Card title="LogsMessages" href="/reference/cpp/signalwire/rest/rest-client/logs-messages/logs-messages"></Card>
</CardGroup>
