...
<CardGroup cols={2}>
  <Card title="DatasphereNamespace" href="/reference/cpp/signalwire/rest/rest-client/datasphere-namespace/datasphere-namespace"></Card>
  <Card title="search" href="/reference/cpp/signalwire/rest/rest-client/datasphere-namespace/search"></Card>
</CardGroup>
