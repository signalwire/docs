...
<CardGroup cols={2}>
  <Card title="publish" href="/reference/cpp/signalwire/rest/rest-client/pub-sub-namespace/publish"></Card>
  <Card title="PubSubNamespace" href="/reference/cpp/signalwire/rest/rest-client/pub-sub-namespace/pub-sub-namespace"></Card>
</CardGroup>
