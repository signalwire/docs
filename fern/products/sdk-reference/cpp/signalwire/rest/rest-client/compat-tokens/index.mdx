...
<CardGroup cols={2}>
  <Card title="CompatTokens" href="/reference/cpp/signalwire/rest/rest-client/compat-tokens/compat-tokens"></Card>
  <Card title="create" href="/reference/cpp/signalwire/rest/rest-client/compat-tokens/create"></Card>
  <Card title="update" href="/reference/cpp/signalwire/rest/rest-client/compat-tokens/update"></Card>
</CardGroup>
