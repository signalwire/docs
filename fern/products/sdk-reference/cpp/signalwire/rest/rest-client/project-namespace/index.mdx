...
<CardGroup cols={2}>
  <Card title="get_project" href="/reference/cpp/signalwire/rest/rest-client/project-namespace/get-project"></Card>
  <Card title="ProjectNamespace" href="/reference/cpp/signalwire/rest/rest-client/project-namespace/project-namespace"></Card>
  <Card title="update_project" href="/reference/cpp/signalwire/rest/rest-client/project-namespace/update-project"></Card>
</CardGroup>
