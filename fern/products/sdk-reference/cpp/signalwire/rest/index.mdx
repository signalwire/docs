...
<CardGroup cols={2}>
  <Card title="CrudResource" href="/docs/sdk-reference/reference/cpp/signalwire/rest/crud-resource">
    Generic CRUD resource for REST API namespaces.
  </Card>

  <Card title="HttpClient" href="/docs/sdk-reference/reference/cpp/signalwire/rest/http-client">
    HTTP client with Basic Auth support using cpp-httplib.
  </Card>

  <Card title="PaginatedIterator" href="/docs/sdk-reference/reference/cpp/signalwire/rest/paginated-iterator">
  ...
  <Card title="RestClient" href="/docs/sdk-reference/reference/cpp/signalwire/rest/rest-client">
    Top-level SignalWire REST client with all API namespaces.
  </Card>

  <Card title="SignalWireRestError" href="/docs/sdk-reference/reference/cpp/signalwire/rest/signal-wire-rest-error">
