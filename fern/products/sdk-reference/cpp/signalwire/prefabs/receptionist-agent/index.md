...
- [`ReceptionistAgent`](/reference/cpp/signalwire/prefabs/receptionist-agent/receptionist-agent)
- [`set_departments`](/reference/cpp/signalwire/prefabs/receptionist-agent/set-departments)
- [`set_greeting`](/reference/cpp/signalwire/prefabs/receptionist-agent/set-greeting)
- [`set_transfer_message`](/reference/cpp/signalwire/prefabs/receptionist-agent/set-transfer-message)
