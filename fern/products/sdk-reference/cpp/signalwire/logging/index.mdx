...
<CardGroup cols={2}>
  <Card title="get_log_level" href="/reference/cpp/signalwire/logging/get-log-level"></Card>
  <Card title="get_logger" href="/reference/cpp/signalwire/logging/get-logger"></Card>
</CardGroup>
...
<CardGroup cols={2}>
  <Card title="Logger" href="/reference/cpp/signalwire/logging/logger"></Card>
</CardGroup>
...
<CardGroup cols={2}>
  <Card title="LogLevel" href="/reference/cpp/signalwire/logging/log-level"></Card>
</CardGroup>
