...
<CardGroup cols={2}>
  <Card title="debug" href="/reference/cpp/signalwire/logging/logger/debug"></Card>
  <Card title="error" href="/reference/cpp/signalwire/logging/logger/error"></Card>
  <Card title="info" href="/reference/cpp/signalwire/logging/logger/info"></Card>
  <Card title="Logger" href="/reference/cpp/signalwire/logging/logger/logger"></Card>
  <Card title="warn" href="/reference/cpp/signalwire/logging/logger/warn"></Card>
</CardGroup>
