...
<CardGroup cols={2}>
  <Card title="PromptObjectModel" href="/docs/sdk-reference/reference/cpp/signalwire/pom/prompt-object-model">
    Top-level container of an ordered list of sections.
  </Card>

  <Card title="Section" href="/docs/sdk-reference/reference/cpp/signalwire/pom/section">
