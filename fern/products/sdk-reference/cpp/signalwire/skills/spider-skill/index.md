...
- [`get_hints`](/reference/cpp/signalwire/skills/spider-skill/get-hints) — Get speech recognition hints to merge into agent.
- [`register_tools`](/reference/cpp/signalwire/skills/spider-skill/register-tools) — Register tools with the agent. Returns tool definitions.
- [`setup`](/reference/cpp/signalwire/skills/spider-skill/setup) — Initialize the skill with given params. Return true on success.
- [`skill_description`](/reference/cpp/signalwire/skills/spider-skill/skill-description)
- [`skill_name`](/reference/cpp/signalwire/skills/spider-skill/skill-name)
- [`supports_multiple_instances`](/reference/cpp/signalwire/skills/spider-skill/supports-multiple-instances)
