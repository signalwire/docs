...
<CardGroup cols={2}>
  <Card title="get_datamap_functions" href="/reference/cpp/signalwire/skills/play-background-file-skill/get-datamap-functions">
    Get SWAIG DataMap functions (for DataMap-based skills).
  </Card>
  <Card title="register_tools" href="/reference/cpp/signalwire/skills/play-background-file-skill/register-tools">
    Register tools with the agent. Returns tool definitions.
  </Card>
  <Card title="setup" href="/reference/cpp/signalwire/skills/play-background-file-skill/setup">
    Initialize the skill with given params. Return true on success.
  </Card>
  <Card title="skill_description" href="/reference/cpp/signalwire/skills/play-background-file-skill/skill-description"></Card>
  <Card title="skill_name" href="/reference/cpp/signalwire/skills/play-background-file-skill/skill-name"></Card>
  <Card title="supports_multiple_instances" href="/reference/cpp/signalwire/skills/play-background-file-skill/supports-multiple-instances"></Card>
</CardGroup>
