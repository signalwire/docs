...
<CardGroup cols={2}>
  ...
  <Card title="skill_description" href="/reference/cpp/signalwire/skills/wikipedia-search-skill-r/skill-description"></Card>
  <Card title="skill_name" href="/reference/cpp/signalwire/skills/wikipedia-search-skill-r/skill-name"></Card>
</CardGroup>
