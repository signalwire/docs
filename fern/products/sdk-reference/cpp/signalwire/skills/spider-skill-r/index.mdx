...
<CardGroup cols={2}>
  <Card title="get_hints" href="/reference/cpp/signalwire/skills/spider-skill-r/get-hints">
    Get speech recognition hints to merge into agent.
  </Card>
  <Card title="register_tools" href="/reference/cpp/signalwire/skills/spider-skill-r/register-tools">
    Register tools with the agent. Returns tool definitions.
  </Card>
  <Card title="setup" href="/reference/cpp/signalwire/skills/spider-skill-r/setup">
    Initialize the skill with given params. Return true on success.
  </Card>
  <Card title="skill_description" href="/reference/cpp/signalwire/skills/spider-skill-r/skill-description"></Card>
  <Card title="skill_name" href="/reference/cpp/signalwire/skills/spider-skill-r/skill-name"></Card>
  <Card title="supports_multiple_instances" href="/reference/cpp/signalwire/skills/spider-skill-r/supports-multiple-instances"></Card>
</CardGroup>
