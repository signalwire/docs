...
<CardGroup cols={2}>
  <Card title="get_datamap_functions" href="/reference/cpp/signalwire/skills/api-ninjas-trivia-skill-r/get-datamap-functions">
    Get SWAIG DataMap functions (for DataMap-based skills).
  </Card>
  <Card title="register_tools" href="/reference/cpp/signalwire/skills/api-ninjas-trivia-skill-r/register-tools">
    Register tools with the agent. Returns tool definitions.
  </Card>
  <Card title="setup" href="/reference/cpp/signalwire/skills/api-ninjas-trivia-skill-r/setup">
    Initialize the skill with given params. Return true on success.
  </Card>
  <Card title="skill_description" href="/reference/cpp/signalwire/skills/api-ninjas-trivia-skill-r/skill-description"></Card>
  <Card title="skill_name" href="/reference/cpp/signalwire/skills/api-ninjas-trivia-skill-r/skill-name"></Card>
  <Card title="supports_multiple_instances" href="/reference/cpp/signalwire/skills/api-ninjas-trivia-skill-r/supports-multiple-instances"></Card>
</CardGroup>
