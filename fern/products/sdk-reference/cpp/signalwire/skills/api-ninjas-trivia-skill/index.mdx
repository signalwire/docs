...
<CardGroup cols={2}>
  ...
  <Card title="skill_description" href="/reference/cpp/signalwire/skills/api-ninjas-trivia-skill/skill-description" />

  <Card title="skill_name" href="/reference/cpp/signalwire/skills/api-ninjas-trivia-skill/skill-name" />

  <Card title="supports_multiple_instances" href="/reference/cpp/signalwire/skills/api-ninjas-trivia-skill/supports-multiple-instances" />
</CardGroup>
