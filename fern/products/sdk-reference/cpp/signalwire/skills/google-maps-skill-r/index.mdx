...
<CardGroup cols={2}>
  ...
  <Card title="skill_description" href="/reference/cpp/signalwire/skills/google-maps-skill-r/skill-description" />

  <Card title="skill_name" href="/reference/cpp/signalwire/skills/google-maps-skill-r/skill-name" />
</CardGroup>
