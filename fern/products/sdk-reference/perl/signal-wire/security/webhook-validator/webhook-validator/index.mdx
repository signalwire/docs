...
<CardGroup cols={2}>
  <Card title="validate_request" href="/reference/perl/signal-wire/security/webhook-validator/webhook-validator/validate-request"></Card>
  <Card title="validate_webhook_signature" href="/reference/perl/signal-wire/security/webhook-validator/webhook-validator/validate-webhook-signature"></Card>
</CardGroup>
