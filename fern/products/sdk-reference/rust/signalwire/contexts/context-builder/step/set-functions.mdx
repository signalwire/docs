...
slug: "/sdk-reference/rust/signalwire/contexts/context-builder/step/set-functions"
...
```rust
fn set_functions(&mut self, functions: Value) -> &mut Self
```

## Parameters

<ParamField path="functions" type="Value" required></ParamField>
