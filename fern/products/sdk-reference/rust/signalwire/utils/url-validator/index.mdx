...
module: "utils"
slug: "/sdk-reference/rust/signalwire/utils/url-validator"
...
<ParamField path="BLOCKED_NETWORKS" type="const BLOCKED_NETWORKS: [&str; 9]">
...
<CardGroup cols={2}>
  <Card title="_set_resolver" href="/sdk-reference/rust/signalwire/utils/url-validator/set-resolver">
    Install a custom resolver (for tests). Pass `None` to clear.
  </Card>
  <Card title="validate_url" href="/sdk-reference/rust/signalwire/utils/url-validator/validate-url">
