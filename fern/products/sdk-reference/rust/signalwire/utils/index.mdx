...
<CardGroup cols={2}>
  <Card title="schema_utils" href="/docs/sdk-reference/reference/rust/signalwire/utils/schema-utils" />

  <Card title="url_validator" href="/docs/sdk-reference/reference/rust/signalwire/utils/url-validator">
