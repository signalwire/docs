...
slug: "/sdk-reference/rust/signalwire/agent/agent-base/agent-base/add-function-include"
...
```rust
fn add_function_include(&mut self, include: Value) -> &mut Self
```

## Parameters

<ParamField path="include" type="Value" required></ParamField>
