...
kind: "method"
language: "rust"
qualified_name: "signalwire::agent::agent_base::AgentBase::get_raw_prompt"
parent: "signalwire::agent::agent_base::AgentBase"
module: "agent.agent_base"
slug: "/sdk-reference/rust/signalwire/agent/agent-base/agent-base/get-raw-prompt"
...
```rust
fn get_raw_prompt(&self) -> Option<&str>
```
