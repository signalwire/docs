...
slug: "/sdk-reference/rust/signalwire/agent/agent-base/agent-base/define-tools"
...
```rust
fn define_tools(&mut self, tool_defs: Vec<Value>) -> &mut Self
```

## Parameters

<ParamField path="tool_defs" type="Vec<Value>" required></ParamField>
