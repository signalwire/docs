...
module: "agent"
slug: "/sdk-reference/rust/signalwire/agent/agent-base"
...
<CardGroup cols={2}>
  <Card title="AgentBase" href="/sdk-reference/rust/signalwire/agent/agent-base/agent-base">
    Core agent that extends `Service` with AI-specific capabilities.
  </Card>
  <Card title="AgentOptions" href="/sdk-reference/rust/signalwire/agent/agent-base/agent-options">
