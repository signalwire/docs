...
<CardGroup cols={2}>
  <Card title="AgentBase" href="/docs/sdk-reference/reference/rust/signalwire/agent/agent-base/agent-base">
    Core agent that extends `Service` with AI-specific capabilities.
  </Card>

  <Card title="AgentOptions" href="/docs/sdk-reference/reference/rust/signalwire/agent/agent-base/agent-options">
