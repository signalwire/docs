...
module: "security"
slug: "/sdk-reference/rust/signalwire/security/webhook-layer"
...
<CardGroup cols={2}>
  <Card title="WebhookLayer" href="/sdk-reference/rust/signalwire/security/webhook-layer/webhook-layer">
    Tower [`Layer`] that wraps any `Service<Request<Body>>` with SignalWire webhook signature validation.
  </Card>
  <Card title="WebhookValidate" href="/sdk-reference/rust/signalwire/security/webhook-layer/webhook-validate">
