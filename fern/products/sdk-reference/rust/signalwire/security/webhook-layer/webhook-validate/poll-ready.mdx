...
slug: "/sdk-reference/rust/signalwire/security/webhook-layer/webhook-validate/poll-ready"
...
fn poll_ready(
    &mut self,
    cx: &mut Context<'_>
) -> Poll<Result<(), <Self as >::Error>>
```

## Parameters

<ParamField path="cx" type="&mut Context<'_>" required></ParamField>
