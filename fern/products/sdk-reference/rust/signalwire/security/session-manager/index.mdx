...
module: "security"
slug: "/sdk-reference/rust/signalwire/security/session-manager"
...
<CardGroup cols={2}>
  <Card title="SessionManager" href="/sdk-reference/rust/signalwire/security/session-manager/session-manager">
