...
slug: "/sdk-reference/rust/signalwire/security/session-manager/session-manager/create-session"
...
```rust
fn create_session(&self, call_id: Option<&str>) -> String
```

## Parameters

<ParamField path="call_id" type="Option<&str>" required></ParamField>
