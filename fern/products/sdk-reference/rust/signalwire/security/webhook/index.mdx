...
module: "security"
slug: "/sdk-reference/rust/signalwire/security/webhook"
...
<CardGroup cols={2}>
  <Card title="validate_request" href="/sdk-reference/rust/signalwire/security/webhook/validate-request">
    Legacy `@signalwire/compatibility-api` drop-in entry point.
  </Card>
  <Card title="validate_webhook_signature" href="/sdk-reference/rust/signalwire/security/webhook/validate-webhook-signature">
...
<CardGroup cols={2}>
  <Card title="ParamsOrBody" href="/sdk-reference/rust/signalwire/security/webhook/params-or-body">
    Argument shape for [`validate_request`]. Either a raw body string (which will run Scheme A first, then Scheme B with the form-parsed body) or a pre-parsed form-param list (which goes straight to Scheme B).
  </Card>
  <Card title="WebhookError" href="/sdk-reference/rust/signalwire/security/webhook/webhook-error">
