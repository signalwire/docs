...
<CardGroup cols={2}>
  <Card title="validate_request" href="/reference/rust/signalwire/security/webhook/validate-request">
    Legacy `@signalwire/compatibility-api` drop-in entry point.
  </Card>

  <Card title="validate_webhook_signature" href="/reference/rust/signalwire/security/webhook/validate-webhook-signature">
...
<CardGroup cols={2}>
  <Card title="ParamsOrBody" href="/reference/rust/signalwire/security/webhook/params-or-body">
  ...
  <Card title="WebhookError" href="/reference/rust/signalwire/security/webhook/webhook-error">
