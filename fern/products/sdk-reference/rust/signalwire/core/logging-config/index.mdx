...
module: "core"
slug: "/sdk-reference/rust/signalwire/core/logging-config"
...
<CardGroup cols={2}>
  <Card title="get_execution_mode" href="/sdk-reference/rust/signalwire/core/logging-config/get-execution-mode">
