...
module: "relay"
slug: "/sdk-reference/rust/signalwire/relay/call"
...
<CardGroup cols={2}>
  <Card title="CallEventCallback" href="/sdk-reference/rust/signalwire/relay/call/call-event-callback">
...
<CardGroup cols={2}>
  <Card title="Call" href="/sdk-reference/rust/signalwire/relay/call/call">
