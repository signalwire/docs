...
- [`NativeVectorSearch`](/reference/rust/signalwire/skills/builtin/native-vector-search/native-vector-search) — Search document indexes using vector similarity and keyword search (handler-based).
