...
- [`pom`](/reference/rust/signalwire/pom/pom) — `PromptObjectModel` — root container for a POM document.
- [`section`](/reference/rust/signalwire/pom/section) — Section type for the Prompt Object Model.
