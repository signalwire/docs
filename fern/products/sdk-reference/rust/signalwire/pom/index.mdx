...
parent: "signalwire"
slug: "/sdk-reference/rust/signalwire/pom"
...
<CardGroup cols={2}>
  <Card title="pom" href="/sdk-reference/rust/signalwire/pom/pom">
    `PromptObjectModel` — root container for a POM document.
  </Card>
  <Card title="section" href="/sdk-reference/rust/signalwire/pom/section">
