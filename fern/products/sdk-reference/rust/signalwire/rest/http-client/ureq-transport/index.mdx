...
<CardGroup cols={2}>
  <Card title="default" href="/reference/rust/signalwire/rest/http-client/ureq-transport/default" />

  <Card title="execute" href="/reference/rust/signalwire/rest/http-client/ureq-transport/execute" />

  <Card title="new" href="/reference/rust/signalwire/rest/http-client/ureq-transport/new" />
</CardGroup>
