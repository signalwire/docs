...
<CardGroup cols={2}>
  <Card title="base_path" href="/reference/rust/signalwire/rest/namespaces/mfa/mfa/base-path" />
  ...
  <Card title="new" href="/reference/rust/signalwire/rest/namespaces/mfa/mfa/new" />
