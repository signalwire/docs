...
slug: "/sdk-reference/rust/signalwire/rest/namespaces/mfa/mfa"
...
<CardGroup cols={2}>
  <Card title="base_path" href="/sdk-reference/rust/signalwire/rest/namespaces/mfa/mfa/base-path"></Card>
  <Card title="call" href="/sdk-reference/rust/signalwire/rest/namespaces/mfa/mfa/call">
    POST /api/relay/rest/mfa/call — deliver a one-time code via voice.
  </Card>
  <Card title="new" href="/sdk-reference/rust/signalwire/rest/namespaces/mfa/mfa/new"></Card>
  <Card title="sms" href="/sdk-reference/rust/signalwire/rest/namespaces/mfa/mfa/sms">
    POST /api/relay/rest/mfa/sms — send a one-time code over SMS.
  </Card>
  <Card title="verify" href="/sdk-reference/rust/signalwire/rest/namespaces/mfa/mfa/verify">
