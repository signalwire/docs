---
slug: "/reference/rust/signalwire/swaig/params-builder"
...
<CardGroup cols={2}>
  <Card title="ParamsBuilder" href="/docs/sdk-reference/reference/rust/signalwire/swaig/params-builder/params-builder">
    Fluent, typed builder for a SWAIG tool's parameter schema.
  </Card>

  <Card title="PropertyBuilder" href="/docs/sdk-reference/reference/rust/signalwire/swaig/params-builder/property-builder">
