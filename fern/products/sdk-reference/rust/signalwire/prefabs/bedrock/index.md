...
- [`BedrockAgent`](/reference/rust/signalwire/prefabs/bedrock/bedrock-agent) — Voice-to-voice agent backed by Amazon Bedrock.
- [`BedrockOptions`](/reference/rust/signalwire/prefabs/bedrock/bedrock-options) — Construction options for \[`BedrockAgent`]. Mirrors the keyword arguments of Python's `BedrockAgent.__init__`.
