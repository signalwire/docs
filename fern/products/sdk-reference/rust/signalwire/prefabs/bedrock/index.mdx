...
<CardGroup cols={2}>
  <Card title="BedrockAgent" href="/reference/rust/signalwire/prefabs/bedrock/bedrock-agent">
    Voice-to-voice agent backed by Amazon Bedrock.
  </Card>

  <Card title="BedrockOptions" href="/reference/rust/signalwire/prefabs/bedrock/bedrock-options">
