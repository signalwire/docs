...
module: "prefabs"
slug: "/sdk-reference/rust/signalwire/prefabs/bedrock"
...
<CardGroup cols={2}>
  <Card title="BedrockAgent" href="/sdk-reference/rust/signalwire/prefabs/bedrock/bedrock-agent">
    Voice-to-voice agent backed by Amazon Bedrock.
  </Card>
  <Card title="BedrockOptions" href="/sdk-reference/rust/signalwire/prefabs/bedrock/bedrock-options">
