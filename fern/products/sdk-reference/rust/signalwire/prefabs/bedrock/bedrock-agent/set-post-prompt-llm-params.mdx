...
slug: "/sdk-reference/rust/signalwire/prefabs/bedrock/bedrock-agent/set-post-prompt-llm-params"
...
```rust
fn set_post_prompt_llm_params(&mut self, _params: Value) -> &mut Self
```
