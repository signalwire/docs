...
<CardGroup cols={2}>
  <Card title="ServiceOptions" href="/docs/sdk-reference/reference/rust/signalwire/swml/service/service-options">
    Options for constructing a `Service`.
  </Card>

  <Card title="ToolDef" href="/docs/sdk-reference/reference/rust/signalwire/swml/service/tool-def">
