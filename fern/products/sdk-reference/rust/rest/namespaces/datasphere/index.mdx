---
slug: "/reference/rust/rest/namespaces/datasphere"
title: "datasphere"
sdk_label: "Rust SDK"
icon: "rust"
lustri:
...
<CardGroup cols={2}>
  <Card title="DatasphereDocuments" href="/docs/sdk-reference/reference/rust/rest/namespaces/datasphere/datasphere-documents">
    Datasphere documents resource.
  </Card>

  <Card title="DatasphereNamespace" href="/docs/sdk-reference/reference/rust/rest/namespaces/datasphere/datasphere-namespace">
