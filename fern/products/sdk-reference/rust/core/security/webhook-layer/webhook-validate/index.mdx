---
slug: "/reference/rust/core/security/webhook-layer/webhook-validate"
...
**Implements:** `Clone`, [Service](/docs/sdk-reference/reference/rust/core/security/webhook-layer/webhook-layer#service)
