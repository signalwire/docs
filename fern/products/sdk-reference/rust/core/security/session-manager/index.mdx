---
slug: "/reference/rust/core/security/session-manager"
...
<CardGroup cols={2}>
  <Card title="SessionManager" href="/docs/sdk-reference/reference/rust/core/security/session-manager/session-manager">
