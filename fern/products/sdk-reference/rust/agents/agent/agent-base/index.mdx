---
slug: "/reference/rust/agents/agent/agent-base"
title: "agent_base"
sdk_label: "Rust SDK"
icon: "rust"
lustri:
...
<CardGroup cols={2}>
  <Card title="AgentBase" href="/docs/sdk-reference/reference/rust/agents/agent/agent-base/agent-base">
    Core agent that extends `Service` with AI-specific capabilities.
  </Card>

  <Card title="AgentOptions" href="/docs/sdk-reference/reference/rust/agents/agent/agent-base/agent-options">
