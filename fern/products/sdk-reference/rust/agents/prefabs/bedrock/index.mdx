---
slug: "/reference/rust/agents/prefabs/bedrock"
title: "bedrock"
sdk_label: "Rust SDK"
icon: "rust"
lustri:
...
<CardGroup cols={2}>
  <Card title="BedrockAgent" href="/docs/sdk-reference/reference/rust/agents/prefabs/bedrock/bedrock-agent">
    Voice-to-voice agent backed by Amazon Bedrock.
  </Card>

  <Card title="BedrockOptions" href="/docs/sdk-reference/reference/rust/agents/prefabs/bedrock/bedrock-options">
