---
slug: "/reference/rust/agents/skills/builtin/native-vector-search"
...
<CardGroup cols={2}>
  <Card title="NativeVectorSearch" href="/docs/sdk-reference/reference/rust/agents/skills/builtin/native-vector-search/native-vector-search">
