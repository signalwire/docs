...
slug: "/sdk-reference/php/signal-wire/relay/relay/web-socket"
...
<CardGroup cols={2}>
  <Card title="close" href="/sdk-reference/php/signal-wire/relay/relay/web-socket/close">
    Send a close frame and tear down the socket.
  </Card>
  <Card title="connect" href="/sdk-reference/php/signal-wire/relay/relay/web-socket/connect">
    Open a WebSocket connection to the given URI.
  </Card>
  <Card title="isConnected" href="/sdk-reference/php/signal-wire/relay/relay/web-socket/is-connected"></Card>
  <Card title="receive" href="/sdk-reference/php/signal-wire/relay/relay/web-socket/receive">
    Read one complete inbound frame, blocking up to $timeout seconds.
  </Card>
  <Card title="sendText" href="/sdk-reference/php/signal-wire/relay/relay/web-socket/send-text">
