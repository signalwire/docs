...
<CardGroup cols={2}>
  <Card title="PromptObjectModel" href="/reference/php/signal-wire/pom/pom/prompt-object-model">
    A structured data format for composing, organizing, and rendering prompt
  </Card>
  <Card title="Section" href="/reference/php/signal-wire/pom/pom/section">
