...
- [`__construct`](/reference/php/signal-wire/security/security/webhook-middleware/construct)
- [`process`](/reference/php/signal-wire/security/security/webhook-middleware/process) — Run the middleware. On valid signature delegates to $next; on
