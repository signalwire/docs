...
slug: "/sdk-reference/php/signal-wire/logging/logging/logging-config"
...
<CardGroup cols={2}>
  <Card title="getExecutionMode" href="/sdk-reference/php/signal-wire/logging/logging/logging-config/get-execution-mode">
    Detect the SDK's deployment environment based on well-known
  </Card>
  <Card title="isServerlessMode" href="/sdk-reference/php/signal-wire/logging/logging/logging-config/is-serverless-mode"></Card>
</CardGroup>
