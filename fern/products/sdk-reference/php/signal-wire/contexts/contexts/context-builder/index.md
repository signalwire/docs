...
- [`__construct`](/reference/php/signal-wire/contexts/contexts/context-builder/construct) — Construct a builder. The optional $agent reference mirrors Python's
- [`addContext`](/reference/php/signal-wire/contexts/contexts/context-builder/add-context) — Add a new context and return it for further configuration.
- [`attachToolNameSupplier`](/reference/php/signal-wire/contexts/contexts/context-builder/attach-tool-name-supplier) — Attach a callable that returns registered SWAIG tool names so
- [`createSimpleContext`](/reference/php/signal-wire/contexts/contexts/context-builder/create-simple-context) — Create a builder pre-populated with a single named context.
- [`getContext`](/reference/php/signal-wire/contexts/contexts/context-builder/get-context) — Get an existing context by name, or null if not found.
- [`hasContexts`](/reference/php/signal-wire/contexts/contexts/context-builder/has-contexts)
- [`reset`](/reference/php/signal-wire/contexts/contexts/context-builder/reset) — Remove all contexts, returning the builder to its initial state.
- [`toArray`](/reference/php/signal-wire/contexts/contexts/context-builder/to-array) — Serialize all contexts in order. Validates before converting.
- [`validate`](/reference/php/signal-wire/contexts/contexts/context-builder/validate) — Validate the contexts configuration.
