...
<CardGroup cols={2}>
  <Card title="FunctionResult" href="/docs/sdk-reference/reference/php/signal-wire/swaig/swaig/function-result" />

  <Card title="ParameterSchema" href="/docs/sdk-reference/reference/php/signal-wire/swaig/swaig/parameter-schema">
