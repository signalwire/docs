...
<CardGroup cols={2}>
  <Card title="GetAsync()" href="/reference/dotnet/signal-wire.rest.namespaces/sip-profile/get-async"></Card>
  <Card title="SipProfile(HttpClient)" href="/reference/dotnet/signal-wire.rest.namespaces/sip-profile/sip-profile-http-client"></Card>
  <Card title="UpdateAsync(Dictionary&lt;string, object?&gt;)" href="/reference/dotnet/signal-wire.rest.namespaces/sip-profile/update-async-dictionary-string-object"></Card>
</CardGroup>
