...
slug: "/sdk-reference/dotnet/signal-wire.agent/agent-base/set-function-includes-list-dictionary-string-object"
visibility: "public"
...
<ParamField path="includes" type="List<Dictionary<string,object>>" required></ParamField>
