...
slug: "/sdk-reference/dotnet/signal-wire.agent"
...
<CardGroup cols={2}>
  <Card title="AgentBase" href="/sdk-reference/dotnet/signal-wire.agent/agent-base">
  ...
  <Card title="AgentOptions" href="/sdk-reference/dotnet/signal-wire.agent/agent-options">
