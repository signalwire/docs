...
- [`GetHints()`](/reference/dotnet/signal-wire.skills.builtin/spider-skill/get-hints)
- [`RegisterTools(AgentBase)`](/reference/dotnet/signal-wire.skills.builtin/spider-skill/register-tools-agent-base)
- [`Setup(AgentBase, Dictionary<string, object>)`](/reference/dotnet/signal-wire.skills.builtin/spider-skill/setup-agent-base-dictionary-string-object)
