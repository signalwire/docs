...
<CardGroup cols={2}>
  <Card title="SessionManager" href="/reference/dotnet/signal-wire.security/session-manager">
  ...
  <Card title="WebhookValidationMiddleware" href="/reference/dotnet/signal-wire.security/webhook-validation-middleware">
  ...
  <Card title="WebhookValidator" href="/reference/dotnet/signal-wire.security/webhook-validator">
