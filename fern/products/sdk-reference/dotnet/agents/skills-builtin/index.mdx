---
slug: "/reference/dotnet/agents/skills-builtin"
title: "skills-builtin"
sdk_label: ".NET SDK"
icon: "dotnet"
lustri:
  auto_generated: true
...
<CardGroup cols={2}>
  <Card title="ApiNinjasTriviaSkill" href="/docs/sdk-reference/reference/dotnet/agents/skills-builtin/api-ninjas-trivia-skill">
    Get trivia questions from API Ninjas (DataMap).
  </Card>

  <Card title="ClaudeSkillsSkill" href="/docs/sdk-reference/reference/dotnet/agents/skills-builtin/claude-skills-skill">
  ...
  <Card title="CustomSkillsSkill" href="/docs/sdk-reference/reference/dotnet/agents/skills-builtin/custom-skills-skill">
    Register user-defined custom tools.
  </Card>

  <Card title="DatasphereServerlessSkill" href="/docs/sdk-reference/reference/dotnet/agents/skills-builtin/datasphere-serverless-skill">
    Search knowledge using SignalWire DataSphere with serverless DataMap execution.
  </Card>

  <Card title="DatasphereSkill" href="/docs/sdk-reference/reference/dotnet/agents/skills-builtin/datasphere-skill">
  ...
  <Card title="DatetimeSkill" href="/docs/sdk-reference/reference/dotnet/agents/skills-builtin/datetime-skill">
    Get current date, time, and timezone information.
  </Card>

  <Card title="GoogleMapsSkill" href="/docs/sdk-reference/reference/dotnet/agents/skills-builtin/google-maps-skill">
    Validate addresses and compute driving routes using Google Maps (DataMap).
  </Card>

  <Card title="InfoGathererSkill" href="/docs/sdk-reference/reference/dotnet/agents/skills-builtin/info-gatherer-skill">
    Gather answers to a configurable list of questions.
  </Card>

  <Card title="JokeSkill" href="/docs/sdk-reference/reference/dotnet/agents/skills-builtin/joke-skill">
    Tell jokes using the API Ninjas joke API (DataMap).
  </Card>

  <Card title="MathSkill" href="/docs/sdk-reference/reference/dotnet/agents/skills-builtin/math-skill">
    Perform basic mathematical calculations.
  </Card>

  <Card title="McpGatewaySkill" href="/docs/sdk-reference/reference/dotnet/agents/skills-builtin/mcp-gateway-skill">
  ...
  <Card title="NativeVectorSearchSkill" href="/docs/sdk-reference/reference/dotnet/agents/skills-builtin/native-vector-search-skill">
  ...
  <Card title="PlayBackgroundFileSkill" href="/docs/sdk-reference/reference/dotnet/agents/skills-builtin/play-background-file-skill">
    Control background file playback (DataMap).
  </Card>

  <Card title="SpiderSkill" href="/docs/sdk-reference/reference/dotnet/agents/skills-builtin/spider-skill">
  ...
  <Card title="SwmlTransferSkill" href="/docs/sdk-reference/reference/dotnet/agents/skills-builtin/swml-transfer-skill">
    Transfer calls between agents based on pattern matching (DataMap).
  </Card>

  <Card title="WeatherApiSkill" href="/docs/sdk-reference/reference/dotnet/agents/skills-builtin/weather-api-skill">
    Get current weather information from WeatherAPI.com (DataMap).
  </Card>

  <Card title="WebSearchSkill" href="/docs/sdk-reference/reference/dotnet/agents/skills-builtin/web-search-skill">
  ...
  <Card title="WikipediaSearchSkill" href="/docs/sdk-reference/reference/dotnet/agents/skills-builtin/wikipedia-search-skill">
