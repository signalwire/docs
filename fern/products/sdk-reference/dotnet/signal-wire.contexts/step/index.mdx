...
slug: "/sdk-reference/dotnet/signal-wire.contexts/step"
visibility: "public"
title: "Step"
sdk_label: ".NET SDK"
icon: "dotnet"
...
<ParamField path="GatherInfoData" type="public GatherInfo? GatherInfoData { get; }"></ParamField>
<ParamField path="Name" type="public string Name { get; }"></ParamField>
<ParamField path="ValidContexts" type="public List<string>? ValidContexts { get; }"></ParamField>
<ParamField path="ValidSteps" type="public List<string>? ValidSteps { get; }"></ParamField>

## Methods


<CardGroup cols={2}>
  <Card title="AddBullets(string, List&lt;string&gt;)" href="/sdk-reference/dotnet/signal-wire.contexts/step/add-bullets-string-list-string"></Card>
  <Card title="AddGatherQuestion(Dictionary&lt;string, object&gt;)" href="/sdk-reference/dotnet/signal-wire.contexts/step/add-gather-question-dictionary-string-object">
    Add a question to this step's gather_info. Initializes gather_info if not yet set. &lt;p>&lt;b>IMPORTANT — gather mode locks function access:&lt;/b> While the model is asking gather questions, the runtime forcibly deactivates ALL of the step's other functions. The only callable tools during a gather question are:&lt;/p> &lt;ul>&lt;li>&lt;code>gather_submit&lt;/code> (the native answer-submission tool)&lt;/li>&lt;li>Whatever names you pass in this question's &lt;code>"functions"&lt;/code> option&lt;/li>&lt;/ul> &lt;p>&lt;code>next_step&lt;/code> and &lt;code>change_context&lt;/code> are also filtered out — the model cannot navigate away until the gather completes. This is by design: it forces a tight ask → submit → next-question loop.&lt;/p> &lt;p>If a question needs to call out to a tool (e.g. validate an email, geocode a ZIP), list that tool name in this question's &lt;code>"functions"&lt;/code> option. Functions listed here are active ONLY for this question.&lt;/p>
  </Card>
  <Card title="AddSection(string, string)" href="/sdk-reference/dotnet/signal-wire.contexts/step/add-section-string-string"></Card>
  <Card title="ClearSections()" href="/sdk-reference/dotnet/signal-wire.contexts/step/clear-sections"></Card>
  <Card title="SetEnd(bool)" href="/sdk-reference/dotnet/signal-wire.contexts/step/set-end-bool">
  ...
  <Card title="SetFunctions(object)" href="/sdk-reference/dotnet/signal-wire.contexts/step/set-functions-object">
  ...
  <Card title="SetGatherInfo(Dictionary&lt;string, object&gt;)" href="/sdk-reference/dotnet/signal-wire.contexts/step/set-gather-info-dictionary-string-object"></Card>
  <Card title="SetResetConsolidate(bool)" href="/sdk-reference/dotnet/signal-wire.contexts/step/set-reset-consolidate-bool"></Card>
  <Card title="SetResetFullReset(bool)" href="/sdk-reference/dotnet/signal-wire.contexts/step/set-reset-full-reset-bool"></Card>
  <Card title="SetResetSystemPrompt(string)" href="/sdk-reference/dotnet/signal-wire.contexts/step/set-reset-system-prompt-string"></Card>
  <Card title="SetResetUserPrompt(string)" href="/sdk-reference/dotnet/signal-wire.contexts/step/set-reset-user-prompt-string"></Card>
  <Card title="SetSkipToNextStep(bool)" href="/sdk-reference/dotnet/signal-wire.contexts/step/set-skip-to-next-step-bool"></Card>
  <Card title="SetSkipUserTurn(bool)" href="/sdk-reference/dotnet/signal-wire.contexts/step/set-skip-user-turn-bool"></Card>
  <Card title="SetStepCriteria(string)" href="/sdk-reference/dotnet/signal-wire.contexts/step/set-step-criteria-string"></Card>
  <Card title="SetText(string)" href="/sdk-reference/dotnet/signal-wire.contexts/step/set-text-string"></Card>
  <Card title="SetValidContexts(List&lt;string&gt;)" href="/sdk-reference/dotnet/signal-wire.contexts/step/set-valid-contexts-list-string"></Card>
  <Card title="SetValidSteps(List&lt;string&gt;)" href="/sdk-reference/dotnet/signal-wire.contexts/step/set-valid-steps-list-string"></Card>
  <Card title="Step(string)" href="/sdk-reference/dotnet/signal-wire.contexts/step/step-string"></Card>
  <Card title="ToDict()" href="/sdk-reference/dotnet/signal-wire.contexts/step/to-dict"></Card>
</CardGroup>
