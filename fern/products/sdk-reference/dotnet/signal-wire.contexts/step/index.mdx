...
<CardGroup cols={2}>
  <Card title="AddBullets(string, List&lt;string&gt;)" href="/reference/dotnet/signal-wire.contexts/step/add-bullets-string-list-string"></Card>
  ...
  <Card title="AddSection(string, string)" href="/reference/dotnet/signal-wire.contexts/step/add-section-string-string"></Card>
  <Card title="ClearSections()" href="/reference/dotnet/signal-wire.contexts/step/clear-sections"></Card>
  ...
  <Card title="SetGatherInfo(Dictionary&lt;string, object&gt;)" href="/reference/dotnet/signal-wire.contexts/step/set-gather-info-dictionary-string-object"></Card>
  <Card title="SetResetConsolidate(bool)" href="/reference/dotnet/signal-wire.contexts/step/set-reset-consolidate-bool"></Card>
  <Card title="SetResetFullReset(bool)" href="/reference/dotnet/signal-wire.contexts/step/set-reset-full-reset-bool"></Card>
  <Card title="SetResetSystemPrompt(string)" href="/reference/dotnet/signal-wire.contexts/step/set-reset-system-prompt-string"></Card>
  <Card title="SetResetUserPrompt(string)" href="/reference/dotnet/signal-wire.contexts/step/set-reset-user-prompt-string"></Card>
  <Card title="SetSkipToNextStep(bool)" href="/reference/dotnet/signal-wire.contexts/step/set-skip-to-next-step-bool"></Card>
  <Card title="SetSkipUserTurn(bool)" href="/reference/dotnet/signal-wire.contexts/step/set-skip-user-turn-bool"></Card>
  <Card title="SetStepCriteria(string)" href="/reference/dotnet/signal-wire.contexts/step/set-step-criteria-string"></Card>
  <Card title="SetText(string)" href="/reference/dotnet/signal-wire.contexts/step/set-text-string"></Card>
  <Card title="SetValidContexts(List&lt;string&gt;)" href="/reference/dotnet/signal-wire.contexts/step/set-valid-contexts-list-string"></Card>
  <Card title="SetValidSteps(List&lt;string&gt;)" href="/reference/dotnet/signal-wire.contexts/step/set-valid-steps-list-string"></Card>
  <Card title="Step(string)" href="/reference/dotnet/signal-wire.contexts/step/step-string"></Card>
  <Card title="ToDict()" href="/reference/dotnet/signal-wire.contexts/step/to-dict"></Card>
</CardGroup>
