...
slug: "/sdk-reference/dotnet/signal-wire.contexts/step/set-functions-object"
visibility: "public"
...
```
 <ul><li><code>List<string></code> — whitelist of function names
 allowed in this step.</li><li>An empty list — explicit disable-all (no user functions
 callable).</li><li>The string <code>"none"</code> — synonym for the empty list.</li></ul>
```
</ParamField>
