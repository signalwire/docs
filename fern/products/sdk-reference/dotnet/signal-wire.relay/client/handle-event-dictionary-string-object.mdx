...
slug: "/sdk-reference/dotnet/signal-wire.relay/client/handle-event-dictionary-string-object"
visibility: "public"
...
<ParamField path="outerParams" type="Dictionary<string,object>" required></ParamField>
