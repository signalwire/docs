...
<CardGroup cols={2}>
  <Card title="BasicAuth" href="/docs/sdk-reference/reference/go/github.com/signalwire/signalwire-go/cmd/swaig-test/main/basic-auth">
    BasicAuth bundles a username/password pair for convenience.
  </Card>

  <Card title="LambdaSimResult" href="/docs/sdk-reference/reference/go/github.com/signalwire/signalwire-go/cmd/swaig-test/main/lambda-sim-result">
  ...
  <Card title="SimulateLambdaOptions" href="/docs/sdk-reference/reference/go/github.com/signalwire/signalwire-go/cmd/swaig-test/main/simulate-lambda-options">
