...
This mirrors the Python SDK's mock_env.py flow: env vars are set first, then the agent module is imported/loaded, then invocations run against that freshly-loaded agent.
