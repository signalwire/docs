...
<CardGroup cols={2}>
  <Card title="PromptObjectModel" href="/docs/sdk-reference/reference/go/github.com/signalwire/signalwire-go/pkg/pom/pom/prompt-object-model">
  ...
  <Card title="Section" href="/docs/sdk-reference/reference/go/github.com/signalwire/signalwire-go/pkg/pom/pom/section">
