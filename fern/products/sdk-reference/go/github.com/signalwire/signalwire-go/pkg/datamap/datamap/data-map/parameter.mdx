...
slug: "/sdk-reference/go/github.com/signalwire/signalwire-go/pkg/datamap/datamap/data-map/parameter"
...
<ParamField path="paramType" type="string" required></ParamField>
<ParamField path="desc" type="string" required></ParamField>
<ParamField path="required" type="bool" required></ParamField>
<ParamField path="enum" type="[]string" required></ParamField>
