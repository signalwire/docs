...
<CardGroup cols={2}>
  <Card title="Create" href="/reference/go/github.com/signalwire/signalwire-go/pkg/rest/namespaces/namespaces/cxml-applications-resource/create">
  ...
  <Card title="ListAddresses" href="/reference/go/github.com/signalwire/signalwire-go/pkg/rest/namespaces/namespaces/cxml-applications-resource/list-addresses">
