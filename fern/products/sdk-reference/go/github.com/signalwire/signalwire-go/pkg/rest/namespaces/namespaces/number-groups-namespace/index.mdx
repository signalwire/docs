...
<CardGroup cols={2}>
  <Card title="AddMembership" href="/reference/go/github.com/signalwire/signalwire-go/pkg/rest/namespaces/namespaces/number-groups-namespace/add-membership">
    AddMembership adds a number to a group.
  </Card>
  <Card title="DeleteMembership" href="/reference/go/github.com/signalwire/signalwire-go/pkg/rest/namespaces/namespaces/number-groups-namespace/delete-membership">
    DeleteMembership removes a membership by ID.
  </Card>
  <Card title="GetMembership" href="/reference/go/github.com/signalwire/signalwire-go/pkg/rest/namespaces/namespaces/number-groups-namespace/get-membership">
    GetMembership retrieves a specific membership by ID.
  </Card>
  <Card title="ListMemberships" href="/reference/go/github.com/signalwire/signalwire-go/pkg/rest/namespaces/namespaces/number-groups-namespace/list-memberships">
