...
slug: "/sdk-reference/go/github.com/signalwire/signalwire-go/pkg/rest/rest/crud-resource"
...
<CardGroup cols={2}>
  <Card title="Create" href="/sdk-reference/go/github.com/signalwire/signalwire-go/pkg/rest/rest/crud-resource/create">
    Create sends a POST request to create a new resource.
  </Card>
  <Card title="Delete" href="/sdk-reference/go/github.com/signalwire/signalwire-go/pkg/rest/rest/crud-resource/delete">
    Delete removes a resource by ID. It returns the parsed response body (or an empty map for 204 No Content) and any error.
  </Card>
  <Card title="Get" href="/sdk-reference/go/github.com/signalwire/signalwire-go/pkg/rest/rest/crud-resource/get">
    Get retrieves a single resource by ID.
  </Card>
  <Card title="List" href="/sdk-reference/go/github.com/signalwire/signalwire-go/pkg/rest/rest/crud-resource/list">
  ...
  <Card title="Update" href="/sdk-reference/go/github.com/signalwire/signalwire-go/pkg/rest/rest/crud-resource/update">
