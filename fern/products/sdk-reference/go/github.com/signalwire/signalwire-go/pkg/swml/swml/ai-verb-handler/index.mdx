...
It implements the VerbHandler interface and provides validation and configuration-building logic for the AI verb. This is the Go equivalent of the Python AIVerbHandler class in core/swml_handler.py.
...
<CardGroup cols={2}>
  <Card title="BuildConfig" href="/reference/go/github.com/signalwire/signalwire-go/pkg/swml/swml/ai-verb-handler/build-config">
    BuildConfig assembles an AI verb configuration map from the provided params.
  </Card>
  <Card title="GetVerbName" href="/reference/go/github.com/signalwire/signalwire-go/pkg/swml/swml/ai-verb-handler/get-verb-name">
    GetVerbName returns "ai", the name of the SWML verb this handler handles.
  </Card>
  <Card title="ValidateConfig" href="/reference/go/github.com/signalwire/signalwire-go/pkg/swml/swml/ai-verb-handler/validate-config">
