...
slug: "/sdk-reference/go/github.com/signalwire/signalwire-go/pkg/rest/namespaces/namespaces/set-deprecation-logger"
...
<ParamField path="l" type="*logging.Logger" required></ParamField>
