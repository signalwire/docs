...
slug: "/sdk-reference/go/github.com/signalwire/signalwire-go/pkg/swml/swml/service/ai"
...
<ParamField path="promptPOM" type="[]map[string]any" required></ParamField>
<ParamField path="postPrompt" type="*string" required></ParamField>
<ParamField path="postPromptURL" type="*string" required></ParamField>
<ParamField path="swaig" type="map[string]any" required></ParamField>
<ParamField path="extra" type="map[string]any" required></ParamField>
