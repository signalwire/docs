...
Callers typically extract the token from the "Authorization: Bearer &lt;token>" header before calling this method. Mirrors Python AuthHandler.verify_bearer_token(credentials) -> bool.
