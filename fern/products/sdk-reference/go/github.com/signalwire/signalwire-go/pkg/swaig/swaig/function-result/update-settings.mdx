...
slug: "/sdk-reference/go/github.com/signalwire/signalwire-go/pkg/swaig/swaig/function-result/update-settings"
...
<ParamField path="settings" type="map[string]any" required></ParamField>
