...
Python equivalent: auth_mixin.AuthMixin.validate_basic_auth (auth_mixin.py line 24) Python behavior: hmac.compare_digest(username, exp_user) and compare_digest(password, exp_pass)
