...
<CardGroup cols={2}>
  <Card title="RTCSession" href="/reference/go/github.com/signalwire/signalwire-go/pkg/livewire/livewire/live-server/rtc-session">
    RTCSession registers the session entrypoint function.
  </Card>

  <Card title="SetSetupFunc" href="/reference/go/github.com/signalwire/signalwire-go/pkg/livewire/livewire/live-server/set-setup-func">
