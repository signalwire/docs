...
slug: "/sdk-reference/go/github.com/signalwire/signalwire-go/pkg/skills/skills/base-skill/get-param-float"
...
<ParamField path="defaultVal" type="float64" required></ParamField>
