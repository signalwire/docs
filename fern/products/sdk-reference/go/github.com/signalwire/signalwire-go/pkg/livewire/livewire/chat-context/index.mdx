...
slug: "/sdk-reference/go/github.com/signalwire/signalwire-go/pkg/livewire/livewire/chat-context"
...
<ParamField path="Messages" type="Messages []ChatMessage"></ParamField>

## Methods


<CardGroup cols={2}>
  <Card title="Append" href="/sdk-reference/go/github.com/signalwire/signalwire-go/pkg/livewire/livewire/chat-context/append">
