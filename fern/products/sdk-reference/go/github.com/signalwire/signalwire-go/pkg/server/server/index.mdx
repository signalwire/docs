...
<CardGroup cols={2}>
  <Card title="AgentEntry" href="/docs/sdk-reference/reference/go/github.com/signalwire/signalwire-go/pkg/server/server/agent-entry">
    AgentEntry pairs a route with its agent for listing purposes.
  </Card>

  <Card title="AgentServer" href="/docs/sdk-reference/reference/go/github.com/signalwire/signalwire-go/pkg/server/server/agent-server">
