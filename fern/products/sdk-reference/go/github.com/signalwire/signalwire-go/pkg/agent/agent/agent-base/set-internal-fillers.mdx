...
slug: "/sdk-reference/go/github.com/signalwire/signalwire-go/pkg/agent/agent/agent-base/set-internal-fillers"
...
<ParamField path="fillers" type="map[string]map[string][]string" required></ParamField>
