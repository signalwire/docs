...
slug: "/sdk-reference/go/github.com/signalwire/signalwire-go/pkg/livewire/livewire/agent-session/start"
...
<ParamField path="ctx" type="*JobContext" required></ParamField>
<ParamField path="ag" type="*Agent" required></ParamField>
<ParamField path="...opts" type="StartOption"></ParamField>
