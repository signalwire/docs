...
Python equivalent: auth_mixin.AuthMixin.get_basic_auth_credentials (auth_mixin.py line 42) Python behavior: returns (username, password) tuple from self._basic_auth
