...
slug: "/sdk-reference/go/github.com/signalwire/signalwire-go/pkg/prefabs/prefabs/info-gatherer-agent/set-question-callback"
...
<ParamField path="cb" type="func(queryParams map[string]string, bodyParams map[string]any, headers map[string]string) []Question" required></ParamField>
