...
The return value is a pointer to allow subclasses (AgentBase) to signal "no override" by returning nil — matching Python's Optional[dict] return type for on_request. Callers should treat a nil return as "use the default document unchanged".
