...
slug: "/sdk-reference/go/github.com/signalwire/signalwire-go/pkg/agent/agent"
title: "agent"
sdk_label: "Go SDK"
icon: "golang"
---
...
<CardGroup cols={2}>
  <Card title="AgentOption" href="/sdk-reference/go/github.com/signalwire/signalwire-go/pkg/agent/agent/agent-option">
    AgentOption configures an AgentBase during construction.
  </Card>
  <Card title="DebugEventHandler" href="/sdk-reference/go/github.com/signalwire/signalwire-go/pkg/agent/agent/debug-event-handler">
    DebugEventHandler is called for debug events if enabled.
  </Card>
  <Card title="DynamicConfigCallback" href="/sdk-reference/go/github.com/signalwire/signalwire-go/pkg/agent/agent/dynamic-config-callback">
  ...
  <Card title="OnSwmlRequestHook" href="/sdk-reference/go/github.com/signalwire/signalwire-go/pkg/agent/agent/on-swml-request-hook">
  ...
  <Card title="PromptAddToSectionOption" href="/sdk-reference/go/github.com/signalwire/signalwire-go/pkg/agent/agent/prompt-add-to-section-option">
    PromptAddToSectionOption is a functional option for PromptAddToSection.
  </Card>
  <Card title="PromptSectionOption" href="/sdk-reference/go/github.com/signalwire/signalwire-go/pkg/agent/agent/prompt-section-option">
    PromptSectionOption is a functional option for PromptAddSection.
  </Card>
  <Card title="SummaryCallback" href="/sdk-reference/go/github.com/signalwire/signalwire-go/pkg/agent/agent/summary-callback">
    SummaryCallback is called when a post-prompt summary arrives.
  </Card>
  <Card title="ToolHandler" href="/sdk-reference/go/github.com/signalwire/signalwire-go/pkg/agent/agent/tool-handler">
...
<CardGroup cols={2}>
  <Card title="AgentBase" href="/sdk-reference/go/github.com/signalwire/signalwire-go/pkg/agent/agent/agent-base">
  ...
  <Card title="MCPServerConfig" href="/sdk-reference/go/github.com/signalwire/signalwire-go/pkg/agent/agent/mcp-server-config">
    MCPServerConfig holds configuration for an external MCP server connection.
  </Card>
  <Card title="ToolDefinition" href="/sdk-reference/go/github.com/signalwire/signalwire-go/pkg/agent/agent/tool-definition">
