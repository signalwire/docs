...
<CardGroup cols={2}>
  <Card title="AgentBase" href="/docs/sdk-reference/reference/go/github.com/signalwire/signalwire-go/pkg/agent/agent/agent-base">
  ...
  <Card title="MCPServerConfig" href="/docs/sdk-reference/reference/go/github.com/signalwire/signalwire-go/pkg/agent/agent/mcp-server-config">
    MCPServerConfig holds configuration for an external MCP server connection.
  </Card>

  <Card title="ToolDefinition" href="/docs/sdk-reference/reference/go/github.com/signalwire/signalwire-go/pkg/agent/agent/tool-definition">
