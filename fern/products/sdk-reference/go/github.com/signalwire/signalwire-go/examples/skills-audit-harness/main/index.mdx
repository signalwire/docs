...
lustri:
  ...
  source_url: "https://github.com/signalwire/signalwire-go/blob/main/examples/skills_audit_harness/main.go"
---
# `main`
...
[`examples/skills_audit_harness/main.go`](https://github.com/signalwire/signalwire-go/blob/main/examples/skills_audit_harness/main.go)
