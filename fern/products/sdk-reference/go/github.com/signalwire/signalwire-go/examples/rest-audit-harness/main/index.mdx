...
lustri:
  ...
  source_url: "https://github.com/signalwire/signalwire-go/blob/main/examples/rest_audit_harness/main.go"
---
# `main`
...
[`examples/rest_audit_harness/main.go`](https://github.com/signalwire/signalwire-go/blob/main/examples/rest_audit_harness/main.go)
