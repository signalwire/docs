...
slug: "/sdk-reference/typescript/connect-event"
...
<CardGroup cols={2}>
  <Card title="constructor" href="/sdk-reference/typescript/connect-event/constructor"></Card>
  <Card title="fromPayload" href="/sdk-reference/typescript/connect-event/from-payload">
