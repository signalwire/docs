...
kind: "class"
language: "typescript"
qualified_name: "ConnectEvent"
slug: "/reference/typescript/connect-event"
...
<ParamField path="connectState" type="string"></ParamField>
...
<ParamField path="peer" type="Record<string, any>"></ParamField>
...
<CardGroup cols={2}>
  <Card title="constructor" href="/reference/typescript/connect-event/constructor"></Card>
  <Card title="fromPayload" href="/reference/typescript/connect-event/from-payload">
