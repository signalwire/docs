---
slug: "/reference/typescript/rest/compat/compat-conferences"
...
<ParamField path="streamSid" type="string" required>
  Stream SID returned by [startStream](/docs/sdk-reference/reference/typescript/rest/compat/compat-conferences#start-stream).
</ParamField>
