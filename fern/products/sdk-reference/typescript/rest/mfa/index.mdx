...
`Promise<any>` — The MFA request record; its `id` is used by [verify](/docs/sdk-reference/reference/typescript/rest/mfa#verify).
...
<ParamField path="requestId" type="string" required>
  The `id` returned from [sms](/docs/sdk-reference/reference/typescript/rest/mfa#sms) or [call](/docs/sdk-reference/reference/typescript/rest/mfa#call).
</ParamField>
