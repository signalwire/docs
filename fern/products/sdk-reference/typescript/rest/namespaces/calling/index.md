...
- [`CallingNamespace`](/reference/typescript/rest/namespaces/calling/calling-namespace) — REST call control — all 37 commands dispatched via a single POST endpoint.
