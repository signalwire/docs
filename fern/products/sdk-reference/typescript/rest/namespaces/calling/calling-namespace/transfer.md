---
slug: "/reference/typescript/rest/namespaces/calling/calling-namespace/transfer"
title: "transfer"
...
lustri:
  ...
  kind: "method"
  language: "typescript"
  qualified_name: "rest.namespaces.calling.CallingNamespace.transfer"
...
| `params` | `any`    | yes      | `{}`    | Platform-shaped transfer parameters (`to`, `from`, etc.). Defaults to `{}`. |
