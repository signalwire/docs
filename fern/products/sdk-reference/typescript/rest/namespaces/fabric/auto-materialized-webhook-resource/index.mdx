...
<CardGroup cols={2}>
  <Card title="constructor" href="/reference/typescript/rest/namespaces/fabric/auto-materialized-webhook-resource/constructor" />

  <Card title="create" href="/reference/typescript/rest/namespaces/fabric/auto-materialized-webhook-resource/create" />

  <Card title="delete" href="/reference/typescript/rest/namespaces/fabric/auto-materialized-webhook-resource/delete">
    Delete a resource by ID.
  </Card>

  <Card title="get" href="/reference/typescript/rest/namespaces/fabric/auto-materialized-webhook-resource/get">
    Fetch a single resource by ID.
  </Card>

  <Card title="list" href="/reference/typescript/rest/namespaces/fabric/auto-materialized-webhook-resource/list">
    List resources with optional query parameters.
  </Card>

  <Card title="listAddresses" href="/reference/typescript/rest/namespaces/fabric/auto-materialized-webhook-resource/list-addresses">
    List addresses associated with a specific resource instance.
  </Card>

  <Card title="update" href="/reference/typescript/rest/namespaces/fabric/auto-materialized-webhook-resource/update">
