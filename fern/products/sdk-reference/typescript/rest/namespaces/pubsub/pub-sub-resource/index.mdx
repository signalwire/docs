...
<CardGroup cols={2}>
  <Card title="constructor" href="/reference/typescript/rest/namespaces/pubsub/pub-sub-resource/constructor" />

  <Card title="createToken" href="/reference/typescript/rest/namespaces/pubsub/pub-sub-resource/create-token">
