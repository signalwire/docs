...
<CardGroup cols={2}>
  <Card title="constructor" href="/reference/typescript/rest/namespaces/lookup/lookup-resource/constructor" />

  <Card title="phoneNumber" href="/reference/typescript/rest/namespaces/lookup/lookup-resource/phone-number">
