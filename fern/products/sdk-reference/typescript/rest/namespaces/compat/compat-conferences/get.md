---
slug: "/reference/typescript/rest/namespaces/compat/compat-conferences/get"
title: "get"
...
lustri:
  ...
  kind: "method"
  language: "typescript"
  qualified_name: "rest.namespaces.compat.CompatConferences.get"
...
| ----- | -------- | -------- | ------- | -------------------------------- |
| `sid` | `string` | yes      | —       | Conference SID (e.g. `"CF..."`). |
