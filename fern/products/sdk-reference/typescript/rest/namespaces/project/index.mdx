...
<CardGroup cols={2}>
  <Card title="ProjectNamespace" href="/reference/typescript/rest/namespaces/project/project-namespace">
    Project API namespace.
  </Card>

  <Card title="ProjectTokens" href="/reference/typescript/rest/namespaces/project/project-tokens">
