...
slug: "/sdk-reference/typescript/set-call-flow-params"
...
Parameters for [PhoneNumbersResource.setCallFlow](/sdk-reference/typescript/phone-numbers-resource/set-call-flow).
