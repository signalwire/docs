...
framework, use [validate](/docs/sdk-reference/reference/typescript/auth-handler#validate) directly.
...
Configuration for one or more authentication methods checked by [AuthHandler](/docs/sdk-reference/reference/typescript/auth-handler).
