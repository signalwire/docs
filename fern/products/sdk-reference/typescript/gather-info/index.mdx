...
slug: "/reference/typescript/gather-info"
...
<CardGroup cols={2}>
  <Card title="addQuestion" href="/reference/typescript/gather-info/add-question">
    Adds a question to this gather operation.
  </Card>
  <Card title="constructor" href="/reference/typescript/gather-info/constructor">
    Creates a new GatherInfo.
  </Card>
  <Card title="getQuestions" href="/reference/typescript/gather-info/get-questions">
    Returns all questions in this gather operation.
  </Card>
  <Card title="toDict" href="/reference/typescript/gather-info/to-dict">
