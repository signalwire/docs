...
kind: "function"
language: "typescript"
qualified_name: "inferSchema"
slug: "/sdk-reference/typescript/infer-schema"
...
<ParamField path="fn" type="Function" required>
  The function to inspect. Arrow functions, regular functions, and
method shorthand all work.
</ParamField>

## Returns

`InferredSchema | null` — An [InferredSchema](/sdk-reference/typescript/inferred-schema) describing the parameters, or `null` when
