...
slug: "/reference/typescript/infer-schema"
...
`InferredSchema | null` — An [InferredSchema](/reference/typescript/inferred-schema) describing the parameters, or `null` when
