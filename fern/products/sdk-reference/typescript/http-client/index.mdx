...
slug: "/sdk-reference/typescript/http-client"
...
([RestError](/sdk-reference/typescript/rest-error) on non-2xx). Normally you do not instantiate this
directly — construct a [RestClient](/sdk-reference/typescript/rest-client) instead.
...
<CardGroup cols={2}>
  <Card title="constructor" href="/sdk-reference/typescript/http-client/constructor">
    Build a new HTTP client.
  </Card>
  <Card title="delete" href="/sdk-reference/typescript/http-client/delete">
    Perform an authenticated HTTP DELETE and return the parsed JSON response.
  </Card>
  <Card title="get" href="/sdk-reference/typescript/http-client/get">
    Perform an authenticated HTTP GET and return the parsed JSON response.
  </Card>
  <Card title="patch" href="/sdk-reference/typescript/http-client/patch">
    Perform an authenticated HTTP PATCH and return the parsed JSON response.
  </Card>
  <Card title="post" href="/sdk-reference/typescript/http-client/post">
    Perform an authenticated HTTP POST and return the parsed JSON response.
  </Card>
  <Card title="put" href="/sdk-reference/typescript/http-client/put">
