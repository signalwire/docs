...
slug: "/sdk-reference/typescript/mfa-resource"
...
<CardGroup cols={2}>
  <Card title="call" href="/sdk-reference/typescript/mfa-resource/call">
    Initiate MFA by placing a phone call that reads out a one-time code.
  </Card>
  <Card title="constructor" href="/sdk-reference/typescript/mfa-resource/constructor"></Card>
  <Card title="sms" href="/sdk-reference/typescript/mfa-resource/sms">
    Initiate MFA by sending a one-time code to a phone number over SMS.
  </Card>
  <Card title="verify" href="/sdk-reference/typescript/mfa-resource/verify">
