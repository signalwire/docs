...
parent: "MfaResource"
slug: "/sdk-reference/typescript/mfa-resource/sms"
...
`Promise<any>` — The MFA request record; its `id` is used by [verify](/sdk-reference/typescript/mfa-resource/verify).
