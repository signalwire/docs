...
<CardGroup cols={2}>
  <Card title="constructor" href="/reference/typescript/swaig-function/swaig-function/constructor">
    Create a new SwaigFunction.
  </Card>

  <Card title="execute" href="/reference/typescript/swaig-function/swaig-function/execute">
    Invoke the handler with the given arguments and return a serialized result.
  </Card>

  <Card title="toSwaig" href="/reference/typescript/swaig-function/swaig-function/to-swaig">
    Serialize this function to the SWAIG wire format for inclusion in SWML.
  </Card>

  <Card title="validateArgs" href="/reference/typescript/swaig-function/swaig-function/validate-args">
    Validate arguments against the parameter JSON schema using full JSON Schema Draft-7 validation (via ajv).
  </Card>
</CardGroup>
