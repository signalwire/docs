...
kind: "method"
language: "typescript"
qualified_name: "SwaigFunction.validateArgs"
parent: "SwaigFunction"
slug: "/sdk-reference/typescript/swaig-function/validate-args"
...
`[boolean, string[]]` — A tuple of `[isValid, errors]`. When no validation is needed
