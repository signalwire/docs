...
- [`addContext`](/reference/typescript/context-builder/context-builder/add-context) — Adds a new named context to the builder.
- [`constructor`](/reference/typescript/context-builder/context-builder/constructor)
- [`getContext`](/reference/typescript/context-builder/context-builder/get-context) — Returns a context by name.
- [`reset`](/reference/typescript/context-builder/context-builder/reset) — Removes all contexts, returning the builder to its initial state. Use this in a dynamic config callback when you need to rebuild contexts from scratch for a specific request.
- [`toDict`](/reference/typescript/context-builder/context-builder/to-dict) — Validates and serializes all contexts to a plain object for SWML output.
- [`validate`](/reference/typescript/context-builder/context-builder/validate) — Validates that all contexts have steps, naming constraints are met, and cross-context references are valid.
