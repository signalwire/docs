...
**See:** - [Context](/reference/typescript/context)
- [Step](/reference/typescript/step)
- [GatherInfo](/reference/typescript/gather-info)
- [AgentBase.defineContexts](/reference/typescript/agent-base/define-contexts)
...
<CardGroup cols={2}>
  <Card title="addContext" href="/reference/typescript/context-builder/add-context">
    Adds a new named context to the builder.
  </Card>
  <Card title="constructor" href="/reference/typescript/context-builder/constructor"></Card>
  <Card title="getContext" href="/reference/typescript/context-builder/get-context">
    Returns a context by name.
  </Card>
  <Card title="reset" href="/reference/typescript/context-builder/reset">
  ...
  <Card title="toDict" href="/reference/typescript/context-builder/to-dict">
    Validates and serializes all contexts to a plain object for SWML output.
  </Card>
  <Card title="validate" href="/reference/typescript/context-builder/validate">
