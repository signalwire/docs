...
slug: "/sdk-reference/typescript/context-builder"
...
**See:** - [Context](/sdk-reference/typescript/context)
- [Step](/sdk-reference/typescript/step)
- [GatherInfo](/sdk-reference/typescript/gather-info)
- [AgentBase.defineContexts](/sdk-reference/typescript/agent-base/define-contexts)
...
<CardGroup cols={2}>
  <Card title="addContext" href="/sdk-reference/typescript/context-builder/add-context">
    Adds a new named context to the builder.
  </Card>
  <Card title="constructor" href="/sdk-reference/typescript/context-builder/constructor"></Card>
  <Card title="getContext" href="/sdk-reference/typescript/context-builder/get-context">
    Returns a context by name.
  </Card>
  <Card title="reset" href="/sdk-reference/typescript/context-builder/reset">
  ...
  <Card title="toDict" href="/sdk-reference/typescript/context-builder/to-dict">
    Validates and serializes all contexts to a plain object for SWML output.
  </Card>
  <Card title="validate" href="/sdk-reference/typescript/context-builder/validate">
