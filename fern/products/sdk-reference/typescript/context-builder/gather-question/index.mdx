...
<CardGroup cols={2}>
  <Card title="constructor" href="/reference/typescript/context-builder/gather-question/constructor">
    Creates a new GatherQuestion.
  </Card>

  <Card title="toDict" href="/reference/typescript/context-builder/gather-question/to-dict">
