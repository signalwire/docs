...
slug: "/sdk-reference/typescript/phone-numbers-resource/update"
...
[PhoneCallHandler](/sdk-reference/typescript/phone-call-handler)) on the phone number auto-materializes the
