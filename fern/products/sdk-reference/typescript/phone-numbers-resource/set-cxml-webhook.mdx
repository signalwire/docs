...
kind: "method"
language: "typescript"
qualified_name: "PhoneNumbersResource.setCxmlWebhook"
parent: "PhoneNumbersResource"
slug: "/sdk-reference/typescript/phone-numbers-resource/set-cxml-webhook"
...
<ParamField path="params" type="SetCxmlWebhookParams" required>
  URL and optional fallback/status URLs plus any extra
wire-level fields.
</ParamField>
