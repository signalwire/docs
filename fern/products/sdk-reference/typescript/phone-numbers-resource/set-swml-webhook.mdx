...
kind: "method"
language: "typescript"
qualified_name: "PhoneNumbersResource.setSwmlWebhook"
parent: "PhoneNumbersResource"
slug: "/sdk-reference/typescript/phone-numbers-resource/set-swml-webhook"
...
<ParamField path="extra" type="SetSwmlWebhookExtra" required default="{}">
  Additional wire-level fields (e.g. `name`) merged into
the PUT body.
</ParamField>
