...
kind: "method"
language: "typescript"
qualified_name: "PhoneNumbersResource.setCallFlow"
parent: "PhoneNumbersResource"
slug: "/sdk-reference/typescript/phone-numbers-resource/set-call-flow"
...
<ParamField path="params" type="SetCallFlowParams" required>
  Flow ID and optional pinned version plus any extra
wire-level fields.
</ParamField>
