...
slug: "/sdk-reference/typescript/compat-accounts"
...
<CardGroup cols={2}>
  <Card title="constructor" href="/sdk-reference/typescript/compat-accounts/constructor"></Card>
  <Card title="create" href="/sdk-reference/typescript/compat-accounts/create">
    Create a new sub-account under the authenticated parent account.
  </Card>
  <Card title="get" href="/sdk-reference/typescript/compat-accounts/get">
    Fetch an account by SID.
  </Card>
  <Card title="list" href="/sdk-reference/typescript/compat-accounts/list">
    List accounts visible to the authenticated project.
  </Card>
  <Card title="update" href="/sdk-reference/typescript/compat-accounts/update">
