...
kind: "class"
language: "typescript"
qualified_name: "CallingErrorEvent"
slug: "/reference/typescript/calling-error-event"
...
<ParamField path="code" type="string"></ParamField>
<ParamField path="eventType" type="string">
  Fully-qualified event type (e.g. `"calling.call.state"`).
</ParamField>
<ParamField path="message" type="string"></ParamField>
...
<CardGroup cols={2}>
  <Card title="constructor" href="/reference/typescript/calling-error-event/constructor"></Card>
  <Card title="fromPayload" href="/reference/typescript/calling-error-event/from-payload">
