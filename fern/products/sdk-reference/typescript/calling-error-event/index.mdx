...
slug: "/sdk-reference/typescript/calling-error-event"
...
<CardGroup cols={2}>
  <Card title="constructor" href="/sdk-reference/typescript/calling-error-event/constructor"></Card>
  <Card title="fromPayload" href="/sdk-reference/typescript/calling-error-event/from-payload">
