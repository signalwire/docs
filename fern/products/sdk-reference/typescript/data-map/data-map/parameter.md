---
slug: "/reference/typescript/data-map/data-map/parameter"
title: "parameter"
...
lustri:
  ...
  kind: "method"
  language: "typescript"
  qualified_name: "DataMap.DataMap.parameter"
...
| --------------- | ----------------------------------------- | -------- | ------- | ---------------------------------------------------------------------------------------------------------------------- |
| `name`          | `string`                                  | yes      | —       | The parameter name (JSON object key).                                                                                  |
| `paramType`     | `string`                                  | yes      | —       | The JSON Schema type (e.g., "string", "number").                                                                       |
| `description`   | `string`                                  | yes      | —       | Prompt-engineering description telling the model how to extract this value from the user's utterance. Read by the LLM. |
| `opts`          | `{ enum?: string[]; required?: boolean }` | no       | —       | Optional flags for required and enum constraints.                                                                      |
| `opts.enum`     | `string[]`                                | no       | —       | —                                                                                                                      |
| `opts.required` | `boolean`                                 | no       | —       | —                                                                                                                      |
