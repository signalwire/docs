...
slug: "/sdk-reference/typescript/send-digits-event"
...
<CardGroup cols={2}>
  <Card title="constructor" href="/sdk-reference/typescript/send-digits-event/constructor"></Card>
  <Card title="fromPayload" href="/sdk-reference/typescript/send-digits-event/from-payload">
