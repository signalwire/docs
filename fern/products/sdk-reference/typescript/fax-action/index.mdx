...
slug: "/reference/typescript/fax-action"
...
<CardGroup cols={2}>
  <Card title="constructor" href="/reference/typescript/fax-action/constructor"></Card>
  <Card title="stop" href="/reference/typescript/fax-action/stop">
    Stop the fax transfer mid-stream.
  </Card>
  <Card title="wait" href="/reference/typescript/fax-action/wait">
