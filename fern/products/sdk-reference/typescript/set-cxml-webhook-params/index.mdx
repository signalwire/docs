...
slug: "/sdk-reference/typescript/set-cxml-webhook-params"
...
Parameters for [PhoneNumbersResource.setCxmlWebhook](/sdk-reference/typescript/phone-numbers-resource/set-cxml-webhook).
