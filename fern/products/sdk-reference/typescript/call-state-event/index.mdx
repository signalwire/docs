...
slug: "/sdk-reference/typescript/call-state-event"
...
<CardGroup cols={2}>
  <Card title="constructor" href="/sdk-reference/typescript/call-state-event/constructor"></Card>
  <Card title="fromPayload" href="/sdk-reference/typescript/call-state-event/from-payload">
