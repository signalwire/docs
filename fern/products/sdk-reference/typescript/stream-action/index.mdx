...
slug: "/reference/typescript/stream-action"
...
<CardGroup cols={2}>
  <Card title="constructor" href="/reference/typescript/stream-action/constructor"></Card>
  <Card title="stop" href="/reference/typescript/stream-action/stop">
    Stop the outbound stream.
  </Card>
  <Card title="wait" href="/reference/typescript/stream-action/wait">
