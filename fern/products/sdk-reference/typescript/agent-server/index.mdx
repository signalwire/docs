...
- \[[AgentBase](/docs/sdk-reference/reference/typescript/agent-base)]\(xref://[AgentBase](/docs/sdk-reference/reference/typescript/agent-base))
...
[ServerlessAdapter](/docs/sdk-reference/reference/typescript/serverless-adapter) instead. When `SWAIG_CLI_MODE=true` is set in
