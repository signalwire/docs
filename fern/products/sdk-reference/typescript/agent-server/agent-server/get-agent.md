---
slug: "/reference/typescript/agent-server/agent-server/get-agent"
title: "getAgent"
...
lustri:
  ...
  kind: "method"
  language: "typescript"
  qualified_name: "AgentServer.AgentServer.getAgent"
...
| ------- | -------- | -------- | ------- | ---------------------------- |
| `route` | `string` | yes      | —       | The route prefix to look up. |
