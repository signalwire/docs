...
kind: "method"
language: "typescript"
qualified_name: "AgentServer.run"
parent: "AgentServer"
slug: "/sdk-reference/typescript/agent-server/run"
...
[ServerlessAdapter](/sdk-reference/typescript/serverless-adapter) instead. When `SWAIG_CLI_MODE=true` is set in
...
<ParamField path="host" type="string">
  Override the configured hostname. Defaults to the
constructor value.
</ParamField>
<ParamField path="port" type="number">
  Override the configured port. Defaults to the constructor
value.
</ParamField>
