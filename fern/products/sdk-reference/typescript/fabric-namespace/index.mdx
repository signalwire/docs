...
slug: "/sdk-reference/typescript/fabric-namespace"
...
[PhoneNumbersResource.setCxmlWebhook](/sdk-reference/typescript/phone-numbers-resource/set-cxml-webhook); direct `create` produces
...
[PhoneNumbersResource.setSwmlWebhook](/sdk-reference/typescript/phone-numbers-resource/set-swml-webhook); direct `create` produces
an orphan resource and emits a deprecation warning.
</ParamField>
...
<CardGroup cols={2}>
  <Card title="constructor" href="/sdk-reference/typescript/fabric-namespace/constructor"></Card>
</CardGroup>
