...
parent: "Call"
slug: "/sdk-reference/typescript/call/wait-for-ended"
...
`Promise<RelayEvent>` — The terminating `calling.call.state` [RelayEvent](/sdk-reference/typescript/relay-event).
