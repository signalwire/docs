...
slug: "/sdk-reference/typescript/ai-action"
...
<CardGroup cols={2}>
  <Card title="constructor" href="/sdk-reference/typescript/ai-action/constructor"></Card>
  <Card title="stop" href="/sdk-reference/typescript/ai-action/stop">
    Stop the AI agent session.
  </Card>
  <Card title="wait" href="/sdk-reference/typescript/ai-action/wait">
