...
slug: "/sdk-reference/typescript/swml-verb-handler"
...
<CardGroup cols={2}>
  <Card title="buildConfig" href="/sdk-reference/typescript/swml-verb-handler/build-config">
    Build a configuration object for this verb from the provided arguments.
  </Card>
  <Card title="constructor" href="/sdk-reference/typescript/swml-verb-handler/constructor"></Card>
  <Card title="getVerbName" href="/sdk-reference/typescript/swml-verb-handler/get-verb-name">
    Get the name of the SWML verb this handler handles.
  </Card>
  <Card title="validateConfig" href="/sdk-reference/typescript/swml-verb-handler/validate-config">
