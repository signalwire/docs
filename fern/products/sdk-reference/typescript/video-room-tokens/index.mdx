...
slug: "/reference/typescript/video-room-tokens"
...
<CardGroup cols={2}>
  <Card title="constructor" href="/reference/typescript/video-room-tokens/constructor"></Card>
  <Card title="create" href="/reference/typescript/video-room-tokens/create">
