...
kind: "function"
language: "typescript"
qualified_name: "validateRequest"
slug: "/sdk-reference/typescript/validate-request"
...
[validateWebhookSignature](/sdk-reference/typescript/validate-webhook-signature) (Scheme A then Scheme B with parsed form).
...
- TypeError when ``paramsOrRawBody`` is neither a string nor a
