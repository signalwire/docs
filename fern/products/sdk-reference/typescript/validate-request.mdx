...
slug: "/reference/typescript/validate-request"
...
[validateWebhookSignature](/reference/typescript/validate-webhook-signature) (Scheme A then Scheme B with parsed form).
