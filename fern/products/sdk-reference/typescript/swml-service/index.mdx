...
For AI-powered voice agents, use [AgentBase](/docs/sdk-reference/reference/typescript/agent-base) instead.
...
- \- \[SwmlBuilder]\(/docs/sdk-reference/reference/typescript/swml-builder) — the underlying SWML document builder
  \- \[AgentBase]\(/docs/sdk-reference/reference/typescript/agent-base) — AI-powered alternative
...
<CardGroup cols={2}>
  <Card title="SecurityConfig" href="/docs/sdk-reference/reference/typescript/swml-service/security-config">
    Unified security configuration. Mirrors Python SDK's `SecurityConfig` — reads from env vars and optional config file.
  </Card>

  <Card title="VerbHandlerRegistry" href="/docs/sdk-reference/reference/typescript/swml-service/verb-handler-registry">
...
Start the HTTP server. Alias for [run](/docs/sdk-reference/reference/typescript/swml-service#run) provided for cross-SDK
...
<ParamField path="...args" type="[hostOrOpts: string | { domain?: string; host?: string; port?: number; sslCert?: string; sslEnabled?: boolean; sslKey?: string }, port: number, opts: { domain?: string; sslCert?: string; sslEnabled?: boolean; sslKey?: string }]" required>
  Forwarded unchanged to [run](/docs/sdk-reference/reference/typescript/swml-service#run).
</ParamField>
