...
slug: "/reference/typescript/security-config"
...
<CardGroup cols={2}>
  <Card title="constructor" href="/reference/typescript/security-config/constructor"></Card>
  <Card title="getBasicAuth" href="/reference/typescript/security-config/get-basic-auth">
    Get basic auth credentials from security config, or null if not configured.
  </Card>
  <Card title="validateSslConfig" href="/reference/typescript/security-config/validate-ssl-config">
