...
<CardGroup cols={2}>
  <Card title="buildConfig" href="/reference/typescript/swml-handler/swml-verb-handler/build-config">
    Build a configuration object for this verb from the provided arguments.
  </Card>

  <Card title="constructor" href="/reference/typescript/swml-handler/swml-verb-handler/constructor" />

  <Card title="getVerbName" href="/reference/typescript/swml-handler/swml-verb-handler/get-verb-name">
    Get the name of the SWML verb this handler handles.
  </Card>

  <Card title="validateConfig" href="/reference/typescript/swml-handler/swml-verb-handler/validate-config">
