...
| ----------------- | ------------------------------------------------------------------------------- | -------- | ------- | -------------------------------------------------- |
| `signingKey`      | `string`                                                                        | yes      | —       | Customer's Signing Key. Empty / null throws Error. |
| `signature`       | `string`                                                                        | yes      | —       | Header value. Missing / empty returns false.       |
| `url`             | `string`                                                                        | yes      | —       | Full URL SignalWire POSTed to.                     |
| `paramsOrRawBody` | `string \| Record<string, unknown> \| [string, unknown][] \| null \| undefined` | yes      | —       | String raw body OR pre-parsed form params.         |
