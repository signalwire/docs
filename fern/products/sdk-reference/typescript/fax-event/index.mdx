...
slug: "/reference/typescript/fax-event"
...
<CardGroup cols={2}>
  <Card title="constructor" href="/reference/typescript/fax-event/constructor"></Card>
  <Card title="fromPayload" href="/reference/typescript/fax-event/from-payload">
