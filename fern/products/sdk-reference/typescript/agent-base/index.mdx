...
**Extends:** [SWMLService](/docs/sdk-reference/reference/typescript/swml-service)
...
- \- \[FunctionResult]\(/docs/sdk-reference/reference/typescript/function-result) — builder for tool handler responses
  \- \[ContextBuilder]\(/docs/sdk-reference/reference/typescript/context-builder) — multi-step conversation state machines
  \- \[DataMap]\(/docs/sdk-reference/reference/typescript/data-map) — server-side tools without webhooks
  \- \[AgentServer]\(/docs/sdk-reference/reference/typescript/agent-server) — host multiple agents on one HTTP server
...
See [setInternalFillers](/docs/sdk-reference/reference/typescript/agent-base#set-internal-fillers) for the complete list of supported
...
<ParamField path="code" type="string" required>
  Language code as previously passed to [addLanguage](/docs/sdk-reference/reference/typescript/agent-base#add-language).
</ParamField>
...
[onSwmlRequest](/docs/sdk-reference/reference/typescript/agent-base#on-swml-request) and returns its result. Subclasses typically
...
Alias for [serve](/docs/sdk-reference/reference/typescript/agent-base#serve). Starts the HTTP server.
...
language. Useful when language entries are built up via [addLanguage](/docs/sdk-reference/reference/typescript/agent-base#add-language)
...
<ParamField path="code" type="string" required>
  Language code as previously passed to [addLanguage](/docs/sdk-reference/reference/typescript/agent-base#add-language) (e.g. `"en-US"`).
</ParamField>
