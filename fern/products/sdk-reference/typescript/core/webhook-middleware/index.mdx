---
slug: "/reference/typescript/core/webhook-middleware"
...
4. Calls [validateWebhookSignature](/docs/sdk-reference/reference/typescript/core/webhook-validator#validate-webhook-signature).
...
Options for [webhookValidationMiddleware](/docs/sdk-reference/reference/typescript/core/webhook-middleware#webhook-validation-middleware).
