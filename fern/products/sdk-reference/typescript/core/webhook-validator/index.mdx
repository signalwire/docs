---
slug: "/reference/typescript/core/webhook-validator"
...
[validateWebhookSignature](/docs/sdk-reference/reference/typescript/core/webhook-validator#validate-webhook-signature) (Scheme A then Scheme B with parsed form).
