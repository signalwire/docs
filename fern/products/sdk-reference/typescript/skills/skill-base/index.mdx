...
Skills are modular, reusable capabilities that plug into an [AgentBase](/docs/sdk-reference/reference/typescript/agent-base).
...
[SkillManager](/docs/sdk-reference/reference/typescript/skills/skill-manager) calls `setAgent()` + `setup()` in sequence before the
...
- \- \[SkillManager]\(/docs/sdk-reference/reference/typescript/skills/skill-manager)
  \- \[SkillRegistry]\(/docs/sdk-reference/reference/typescript/skills/skill-registry)
  \- \[AgentBase.addSkill]\(/docs/sdk-reference/reference/typescript/agent-base#add-skill)
...
return shape; [hasAllEnvVars](/docs/sdk-reference/reference/typescript/skills/skill-base#has-all-env-vars) is the boolean equivalent.
