---
slug: "/reference/typescript/skills/skill-base/skill-base/validate-env-vars"
...
lustri:
  ...
  kind: "method"
  language: "typescript"
  qualified_name: "skills.SkillBase.SkillBase.validateEnvVars"
...
return shape; [hasAllEnvVars](/reference/typescript/skills/skill-base/skill-base/has-all-env-vars) is the boolean equivalent.
