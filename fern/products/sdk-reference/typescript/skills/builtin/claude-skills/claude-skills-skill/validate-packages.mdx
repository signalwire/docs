---
slug: "/reference/typescript/skills/builtin/claude-skills/claude-skills-skill/validate-packages"
...
lustri:
  ...
  kind: "method"
  language: "typescript"
  qualified_name: "skills.builtin.claude_skills.ClaudeSkillsSkill.validatePackages"
