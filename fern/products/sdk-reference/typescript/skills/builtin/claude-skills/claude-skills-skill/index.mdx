...
return shape; [hasAllEnvVars](/docs/sdk-reference/reference/typescript/skills/builtin/claude-skills/claude-skills-skill#has-all-env-vars) is the boolean equivalent.
