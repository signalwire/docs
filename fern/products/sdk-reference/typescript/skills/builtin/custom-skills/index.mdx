...
<CardGroup cols={2}>
  <Card title="createSkill" href="/reference/typescript/skills/builtin/custom-skills/create-skill">
...
<CardGroup cols={2}>
  <Card title="CustomSkillsSkill" href="/reference/typescript/skills/builtin/custom-skills/custom-skills-skill">
