...
return shape; [hasAllEnvVars](/docs/sdk-reference/reference/typescript/skills/builtin/custom-skills/custom-skills-skill#has-all-env-vars) is the boolean equivalent.
