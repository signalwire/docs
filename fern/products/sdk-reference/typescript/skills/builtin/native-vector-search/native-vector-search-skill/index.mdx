...
return shape; [hasAllEnvVars](/docs/sdk-reference/reference/typescript/skills/builtin/native-vector-search/native-vector-search-skill#has-all-env-vars) is the boolean equivalent.
