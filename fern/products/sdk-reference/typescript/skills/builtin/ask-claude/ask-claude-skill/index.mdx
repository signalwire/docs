...
return shape; [hasAllEnvVars](/docs/sdk-reference/reference/typescript/skills/builtin/ask-claude/ask-claude-skill#has-all-env-vars) is the boolean equivalent.
