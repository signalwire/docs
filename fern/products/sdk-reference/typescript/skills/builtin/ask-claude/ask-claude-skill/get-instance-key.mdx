---
slug: "/reference/typescript/skills/builtin/ask-claude/ask-claude-skill/get-instance-key"
...
lustri:
  ...
  kind: "method"
  language: "typescript"
  qualified_name: "skills.builtin.ask_claude.AskClaudeSkill.getInstanceKey"
