---
slug: "/reference/typescript/skills/builtin/ask-claude/ask-claude-skill/get-skill-namespace"
...
lustri:
  ...
  kind: "method"
  language: "typescript"
  qualified_name: "skills.builtin.ask_claude.AskClaudeSkill.getSkillNamespace"
