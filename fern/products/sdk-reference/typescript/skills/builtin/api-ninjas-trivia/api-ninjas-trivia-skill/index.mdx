...
**Extends:** [SkillBase](/docs/sdk-reference/reference/typescript/skills/skill-base)
...
return shape; [hasAllEnvVars](/docs/sdk-reference/reference/typescript/skills/builtin/api-ninjas-trivia/api-ninjas-trivia-skill#has-all-env-vars) is the boolean equivalent.
