---
slug: "/reference/typescript/skills/builtin/datetime/date-time-skill/get-parameter-schema"
...
lustri:
  ...
  kind: "method"
  language: "typescript"
  qualified_name: "skills.builtin.datetime.DateTimeSkill.getParameterSchema"
