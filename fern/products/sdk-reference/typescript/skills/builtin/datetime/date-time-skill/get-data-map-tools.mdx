---
slug: "/reference/typescript/skills/builtin/datetime/date-time-skill/get-data-map-tools"
...
lustri:
  ...
  kind: "method"
  language: "typescript"
  qualified_name: "skills.builtin.datetime.DateTimeSkill.getDataMapTools"
