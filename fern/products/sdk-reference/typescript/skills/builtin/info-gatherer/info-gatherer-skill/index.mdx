...
return shape; [hasAllEnvVars](/docs/sdk-reference/reference/typescript/skills/builtin/info-gatherer/info-gatherer-skill#has-all-env-vars) is the boolean equivalent.
