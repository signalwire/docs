---
slug: "/reference/typescript/skills/builtin/info-gatherer/info-gatherer-skill/validate-env-vars"
...
lustri:
  ...
  kind: "method"
  language: "typescript"
  qualified_name: "skills.builtin.info_gatherer.InfoGathererSkill.validateEnvVars"
...
return shape; [hasAllEnvVars](/reference/typescript/skills/builtin/info-gatherer/info-gatherer-skill/has-all-env-vars) is the boolean equivalent.
