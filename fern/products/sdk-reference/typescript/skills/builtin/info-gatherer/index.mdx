...
<CardGroup cols={2}>
  <Card title="createSkill" href="/reference/typescript/skills/builtin/info-gatherer/create-skill">
...
<CardGroup cols={2}>
  <Card title="InfoGathererSkill" href="/reference/typescript/skills/builtin/info-gatherer/info-gatherer-skill">
