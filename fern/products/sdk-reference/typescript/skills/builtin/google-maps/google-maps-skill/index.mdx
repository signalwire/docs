...
return shape; [hasAllEnvVars](/docs/sdk-reference/reference/typescript/skills/builtin/google-maps/google-maps-skill#has-all-env-vars) is the boolean equivalent.
