...
<CardGroup cols={2}>
  <Card title="createSkill" href="/reference/typescript/skills/builtin/swml-transfer/create-skill">
...
<CardGroup cols={2}>
  <Card title="SwmlTransferSkill" href="/reference/typescript/skills/builtin/swml-transfer/swml-transfer-skill">
