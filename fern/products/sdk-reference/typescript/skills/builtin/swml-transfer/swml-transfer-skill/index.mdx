...
return shape; [hasAllEnvVars](/docs/sdk-reference/reference/typescript/skills/builtin/swml-transfer/swml-transfer-skill#has-all-env-vars) is the boolean equivalent.
