---
slug: "/reference/typescript/skills/builtin/swml-transfer/swml-transfer-skill/has-all-packages"
...
lustri:
  ...
  kind: "method"
  language: "typescript"
  qualified_name: "skills.builtin.swml_transfer.SwmlTransferSkill.hasAllPackages"
