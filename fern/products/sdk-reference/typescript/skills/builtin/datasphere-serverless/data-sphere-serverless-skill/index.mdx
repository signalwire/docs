...
return shape; [hasAllEnvVars](/docs/sdk-reference/reference/typescript/skills/builtin/datasphere-serverless/data-sphere-serverless-skill#has-all-env-vars) is the boolean equivalent.
