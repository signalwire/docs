...
<CardGroup cols={2}>
  <Card title="createSkill" href="/reference/typescript/skills/builtin/datasphere-serverless/create-skill">
...
<CardGroup cols={2}>
  <Card title="DataSphereServerlessSkill" href="/reference/typescript/skills/builtin/datasphere-serverless/data-sphere-serverless-skill">
