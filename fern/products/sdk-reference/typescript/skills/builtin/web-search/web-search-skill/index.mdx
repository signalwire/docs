...
return shape; [hasAllEnvVars](/docs/sdk-reference/reference/typescript/skills/builtin/web-search/web-search-skill#has-all-env-vars) is the boolean equivalent.
