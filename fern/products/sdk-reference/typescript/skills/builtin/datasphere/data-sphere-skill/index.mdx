...
return shape; [hasAllEnvVars](/docs/sdk-reference/reference/typescript/skills/builtin/datasphere/data-sphere-skill#has-all-env-vars) is the boolean equivalent.
