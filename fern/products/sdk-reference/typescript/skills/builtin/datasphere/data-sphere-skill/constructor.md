---
slug: "/reference/typescript/skills/builtin/datasphere/data-sphere-skill/constructor"
title: "constructor"
...
lustri:
  ...
  kind: "method"
  language: "typescript"
  qualified_name: "skills.builtin.datasphere.DataSphereSkill.constructor"
...
```typescript
constructor(config?: SkillConfig): DataSphereSkill
```
