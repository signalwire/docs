...
return shape; [hasAllEnvVars](/docs/sdk-reference/reference/typescript/skills/builtin/weather-api/weather-api-skill#has-all-env-vars) is the boolean equivalent.
