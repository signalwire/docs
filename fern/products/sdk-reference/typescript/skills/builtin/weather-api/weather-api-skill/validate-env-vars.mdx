---
slug: "/reference/typescript/skills/builtin/weather-api/weather-api-skill/validate-env-vars"
...
lustri:
  ...
  kind: "method"
  language: "typescript"
  qualified_name: "skills.builtin.weather_api.WeatherApiSkill.validateEnvVars"
...
return shape; [hasAllEnvVars](/reference/typescript/skills/builtin/weather-api/weather-api-skill/has-all-env-vars) is the boolean equivalent.
