---
slug: "/reference/typescript/skills/builtin/weather-api/weather-api-skill/validate-packages"
...
lustri:
  ...
  kind: "method"
  language: "typescript"
  qualified_name: "skills.builtin.weather_api.WeatherApiSkill.validatePackages"
