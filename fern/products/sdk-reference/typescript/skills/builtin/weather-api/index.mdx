...
<CardGroup cols={2}>
  <Card title="createSkill" href="/reference/typescript/skills/builtin/weather-api/create-skill">
...
<CardGroup cols={2}>
  <Card title="WeatherApiSkill" href="/reference/typescript/skills/builtin/weather-api/weather-api-skill">
