---
slug: "/reference/typescript/skills/builtin/mcp-gateway/mcp-gateway-skill/get-skill-namespace"
...
lustri:
  ...
  kind: "method"
  language: "typescript"
  qualified_name: "skills.builtin.mcp_gateway.McpGatewaySkill.getSkillNamespace"
