---
slug: "/reference/typescript/skills/builtin/mcp-gateway/mcp-gateway-skill/validate-env-vars"
...
lustri:
  ...
  kind: "method"
  language: "typescript"
  qualified_name: "skills.builtin.mcp_gateway.McpGatewaySkill.validateEnvVars"
...
return shape; [hasAllEnvVars](/reference/typescript/skills/builtin/mcp-gateway/mcp-gateway-skill/has-all-env-vars) is the boolean equivalent.
