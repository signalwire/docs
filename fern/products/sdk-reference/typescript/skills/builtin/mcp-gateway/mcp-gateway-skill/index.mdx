...
return shape; [hasAllEnvVars](/docs/sdk-reference/reference/typescript/skills/builtin/mcp-gateway/mcp-gateway-skill#has-all-env-vars) is the boolean equivalent.
