---
slug: "/reference/typescript/skills/builtin/math/math-skill/validate-env-vars"
...
lustri:
  ...
  kind: "method"
  language: "typescript"
  qualified_name: "skills.builtin.math.MathSkill.validateEnvVars"
...
return shape; [hasAllEnvVars](/reference/typescript/skills/builtin/math/math-skill/has-all-env-vars) is the boolean equivalent.
