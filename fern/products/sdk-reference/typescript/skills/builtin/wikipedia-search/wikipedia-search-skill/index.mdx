...
return shape; [hasAllEnvVars](/docs/sdk-reference/reference/typescript/skills/builtin/wikipedia-search/wikipedia-search-skill#has-all-env-vars) is the boolean equivalent.
