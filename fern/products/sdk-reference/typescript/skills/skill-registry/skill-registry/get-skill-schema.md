---
slug: "/reference/typescript/skills/skill-registry/skill-registry/get-skill-schema"
...
lustri:
  ...
  kind: "method"
  language: "typescript"
  qualified_name: "skills.SkillRegistry.SkillRegistry.getSkillSchema"
...
| ------ | -------- | -------- | ------- | ----------------------------------- |
| `name` | `string` | yes      | —       | The registered skill name to query. |
