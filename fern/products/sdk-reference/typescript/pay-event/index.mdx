...
slug: "/reference/typescript/pay-event"
...
<CardGroup cols={2}>
  <Card title="constructor" href="/reference/typescript/pay-event/constructor"></Card>
  <Card title="fromPayload" href="/reference/typescript/pay-event/from-payload">
