...
slug: "/sdk-reference/typescript/tap-event"
...
<CardGroup cols={2}>
  <Card title="constructor" href="/sdk-reference/typescript/tap-event/constructor"></Card>
  <Card title="fromPayload" href="/sdk-reference/typescript/tap-event/from-payload">
