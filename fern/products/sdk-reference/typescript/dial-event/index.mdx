...
slug: "/sdk-reference/typescript/dial-event"
...
<CardGroup cols={2}>
  <Card title="constructor" href="/sdk-reference/typescript/dial-event/constructor"></Card>
  <Card title="fromPayload" href="/sdk-reference/typescript/dial-event/from-payload">
