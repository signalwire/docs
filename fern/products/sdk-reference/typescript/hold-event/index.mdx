...
slug: "/reference/typescript/hold-event"
...
<CardGroup cols={2}>
  <Card title="constructor" href="/reference/typescript/hold-event/constructor"></Card>
  <Card title="fromPayload" href="/reference/typescript/hold-event/from-payload">
