...
slug: "/sdk-reference/typescript/chat-resource"
...
<CardGroup cols={2}>
  <Card title="constructor" href="/sdk-reference/typescript/chat-resource/constructor"></Card>
  <Card title="createToken" href="/sdk-reference/typescript/chat-resource/create-token">
