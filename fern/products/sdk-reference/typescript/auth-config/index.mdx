...
slug: "/sdk-reference/typescript/auth-config"
...
Configuration for one or more authentication methods checked by [AuthHandler](/sdk-reference/typescript/auth-handler).
