...
slug: "/sdk-reference/typescript/play-event"
...
<CardGroup cols={2}>
  <Card title="constructor" href="/sdk-reference/typescript/play-event/constructor"></Card>
  <Card title="fromPayload" href="/sdk-reference/typescript/play-event/from-payload">
