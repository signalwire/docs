...
slug: "/sdk-reference/typescript/pom-section"
...
<CardGroup cols={2}>
  <Card title="addSubsection" href="/sdk-reference/typescript/pom-section/add-subsection">
    Adds a nested subsection to this section.
  </Card>
  <Card title="constructor" href="/sdk-reference/typescript/pom-section/constructor">
    Creates a new PomSection.
  </Card>
  <Card title="renderMarkdown" href="/sdk-reference/typescript/pom-section/render-markdown">
    Renders this section and its subsections as a Markdown string.
  </Card>
  <Card title="renderXml" href="/sdk-reference/typescript/pom-section/render-xml">
    Renders this section and its subsections as an XML string.
  </Card>
  <Card title="toDict" href="/sdk-reference/typescript/pom-section/to-dict">
