...
kind: "class"
language: "typescript"
qualified_name: "DenoiseEvent"
slug: "/reference/typescript/denoise-event"
...
<ParamField path="denoised" type="boolean"></ParamField>
...
<CardGroup cols={2}>
  <Card title="constructor" href="/reference/typescript/denoise-event/constructor"></Card>
  <Card title="fromPayload" href="/reference/typescript/denoise-event/from-payload">
