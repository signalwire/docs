...
<CardGroup cols={2}>
  <Card title="constructor" href="/reference/typescript/ssl-config/constructor">
    Create an SslConfig, falling back to environment variables for any unset options.
  </Card>
  <Card title="getCert" href="/reference/typescript/ssl-config/get-cert">
    Read the PEM certificate file from disk.
  </Card>
  <Card title="getHstsHeader" href="/reference/typescript/ssl-config/get-hsts-header">
    Build the Strict-Transport-Security header value.
  </Card>
  <Card title="getKey" href="/reference/typescript/ssl-config/get-key">
    Read the PEM private key file from disk.
  </Card>
  <Card title="getServerOptions" href="/reference/typescript/ssl-config/get-server-options">
    Create the options object needed by Node.js `https.createServer()`.
  </Card>
  <Card title="hstsMiddleware" href="/reference/typescript/ssl-config/hsts-middleware">
    Return a Hono middleware that appends the HSTS header to every response.
  </Card>
  <Card title="isConfigured" href="/reference/typescript/ssl-config/is-configured">
