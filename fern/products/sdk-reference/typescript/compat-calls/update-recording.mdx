...
parent: "CompatCalls"
slug: "/sdk-reference/typescript/compat-calls/update-recording"
...
<ParamField path="recordingSid" type="string" required>
  Recording SID returned by [startRecording](/sdk-reference/typescript/compat-calls/start-recording).
</ParamField>
