...
slug: "/sdk-reference/typescript/detect-action"
...
<CardGroup cols={2}>
  <Card title="_checkEvent" href="/sdk-reference/typescript/detect-action/check-event">
    Resolve on first meaningful result OR terminal state.
  </Card>
  <Card title="constructor" href="/sdk-reference/typescript/detect-action/constructor"></Card>
  <Card title="stop" href="/sdk-reference/typescript/detect-action/stop">
    Stop detection before the timeout elapses.
  </Card>
  <Card title="wait" href="/sdk-reference/typescript/detect-action/wait">
