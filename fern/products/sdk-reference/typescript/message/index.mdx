...
slug: "/sdk-reference/typescript/message"
...
Call [Message.wait](/sdk-reference/typescript/message/wait) to await a terminal state.
...
<CardGroup cols={2}>
  <Card title="constructor" href="/sdk-reference/typescript/message/constructor"></Card>
  <Card title="on" href="/sdk-reference/typescript/message/on">
    Register an event listener for state changes on this message.
  </Card>
  <Card title="toString" href="/sdk-reference/typescript/message/to-string">
    Return a human-readable diagnostic string.
  </Card>
  <Card title="wait" href="/sdk-reference/typescript/message/wait">
