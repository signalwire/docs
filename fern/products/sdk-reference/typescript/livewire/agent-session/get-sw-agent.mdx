...
module: "livewire"
slug: "/sdk-reference/typescript/livewire/agent-session/get-sw-agent"
...
Return the underlying SignalWire [AgentBase](/sdk-reference/typescript/agent-base). Useful for tests and
