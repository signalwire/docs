...
parent: "livewire"
module: "livewire"
slug: "/sdk-reference/typescript/livewire/run-context"
...
<ParamField path="session" type="AgentSession<UserData>">
  The owning [AgentSession](/sdk-reference/typescript/livewire/agent-session), when one is bound.
</ParamField>
...
<CardGroup cols={2}>
  <Card title="constructor" href="/sdk-reference/typescript/livewire/run-context/constructor"></Card>
</CardGroup>
