...
<CardGroup cols={2}>
  <Card title="constructor" href="/reference/typescript/livewire/noop-tracker/constructor"></Card>
  <Card title="hasLogged" href="/reference/typescript/livewire/noop-tracker/has-logged">
    Expose whether a key has been logged (for testing).
  </Card>
  <Card title="once" href="/reference/typescript/livewire/noop-tracker/once">
    Log the given message the first time this key is seen.
  </Card>
  <Card title="reset" href="/reference/typescript/livewire/noop-tracker/reset">
