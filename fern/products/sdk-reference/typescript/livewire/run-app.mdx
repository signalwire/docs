...
parent: "livewire"
module: "livewire"
slug: "/sdk-reference/typescript/livewire/run-app"
...
2. Runs the registered prewarm callback (if any) with a fresh [JobProcess](/sdk-reference/typescript/livewire/job-process)
3. Creates a fresh [JobContext](/sdk-reference/typescript/livewire/job-context)
...
an [AgentServer](/sdk-reference/typescript/agent-server) instance.
