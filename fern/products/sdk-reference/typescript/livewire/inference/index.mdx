...
parent: "livewire"
module: "livewire"
slug: "/sdk-reference/typescript/livewire/inference"
...
<CardGroup cols={2}>
  <Card title="LLM" href="/sdk-reference/typescript/livewire/inference/llm">
    LiveKit inference-LLM stub. Captures the model name; runs no inference locally.
  </Card>
  <Card title="STT" href="/sdk-reference/typescript/livewire/inference/stt">
    LiveKit inference-STT stub. Captures the model name; runs no inference locally.
  </Card>
  <Card title="TTS" href="/sdk-reference/typescript/livewire/inference/tts">
