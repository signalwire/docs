...
<CardGroup cols={2}>
  <Card title="LLM" href="/docs/sdk-reference/reference/typescript/livewire/inference/llm">
    LiveKit inference-LLM stub. Captures the model name; runs no inference locally.
  </Card>

  <Card title="STT" href="/docs/sdk-reference/reference/typescript/livewire/inference/stt">
    LiveKit inference-STT stub. Captures the model name; runs no inference locally.
  </Card>

  <Card title="TTS" href="/docs/sdk-reference/reference/typescript/livewire/inference/tts">
