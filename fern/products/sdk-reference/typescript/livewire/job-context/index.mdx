...
entry-point callback registered via [defineAgent](/docs/sdk-reference/reference/typescript/livewire#define-agent).
...
<ParamField path="proc" type="JobProcess" required>
  Shared [JobProcess](/docs/sdk-reference/reference/typescript/livewire/job-process) instance for prewarm-to-entry data passing.
</ParamField>

<ParamField path="room" type="Room" required>
  Placeholder [Room](/docs/sdk-reference/reference/typescript/livewire/room) (see class docs).
</ParamField>
