...
<ParamField path="session" type="get/set session: AgentSession<UserData> | undefined" required>
  The currently-bound [AgentSession](/docs/sdk-reference/reference/typescript/livewire/agent-session), or `undefined` until [AgentSession.start](/docs/sdk-reference/reference/typescript/livewire/agent-session#start) is called.
</ParamField>

<ParamField path="tools" type="Record<string, FunctionTool>" required>
  Registered tools keyed by name. Mutated by [updateTools](/docs/sdk-reference/reference/typescript/livewire/agent#update-tools).
</ParamField>

<ParamField path="userData" type="UserData">
  Arbitrary per-session user data passed to tool handlers via [RunContext.userData](/docs/sdk-reference/reference/typescript/livewire/run-context#user-data).
</ParamField>
...
<ParamField path="tools" type="FunctionTool[]" required>
  Ordered array of [FunctionTool](/docs/sdk-reference/reference/typescript/livewire#function-tool) definitions. Each tool's `name` is used as its map key.
</ParamField>
