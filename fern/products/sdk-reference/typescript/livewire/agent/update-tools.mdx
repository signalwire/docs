...
module: "livewire"
slug: "/sdk-reference/typescript/livewire/agent/update-tools"
...
<ParamField path="tools" type="FunctionTool[]" required>
  Ordered array of [FunctionTool](/sdk-reference/typescript/livewire/function-tool) definitions. Each
