...
<CardGroup cols={2}>
  <Card title="CartesiaTTS" href="/reference/typescript/livewire/plugins/cartesia-tts">
    LiveKit Cartesia-TTS plugin stub. No-op on SignalWire.
  </Card>

  <Card title="DeepgramSTT" href="/reference/typescript/livewire/plugins/deepgram-stt">
    LiveKit Deepgram-STT plugin stub. No-op on SignalWire.
  </Card>

  <Card title="ElevenLabsTTS" href="/reference/typescript/livewire/plugins/eleven-labs-tts">
    LiveKit ElevenLabs-TTS plugin stub. No-op on SignalWire.
  </Card>

  <Card title="OpenAILLM" href="/reference/typescript/livewire/plugins/open-aillm">
    LiveKit OpenAI-LLM plugin stub.
  </Card>

  <Card title="SileroVAD" href="/reference/typescript/livewire/plugins/silero-vad">
