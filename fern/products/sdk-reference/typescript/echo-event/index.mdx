...
slug: "/sdk-reference/typescript/echo-event"
...
<CardGroup cols={2}>
  <Card title="constructor" href="/sdk-reference/typescript/echo-event/constructor"></Card>
  <Card title="fromPayload" href="/sdk-reference/typescript/echo-event/from-payload">
