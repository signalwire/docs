---
slug: "/reference/typescript/agents/auth-handler/index__2"
title: "AuthHandler"
...
lustri:
  ...
  kind: "module"
  language: "typescript"
  qualified_name: "agents.AuthHandler"
  parent: "agents"
  module: "agents"
---
# `AuthHandler`
...
Configuration for one or more authentication methods checked by [AuthHandler](/docs/sdk-reference/reference/typescript/agents/auth-handler).
