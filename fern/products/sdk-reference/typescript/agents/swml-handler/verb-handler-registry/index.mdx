---
slug: "/reference/typescript/agents/swml-handler/verb-handler-registry"
...
([AIVerbHandler](/docs/sdk-reference/reference/typescript/agents/swml-handler/ai-verb-handler)) is registered automatically on construction.
