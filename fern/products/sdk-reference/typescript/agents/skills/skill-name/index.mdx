---
slug: "/reference/typescript/agents/skills/skill-name"
title: "SkillName"
...
[registerBuiltinSkills](/docs/sdk-reference/reference/typescript/agents/skills/builtin#register-builtin-skills) locks into the global `SkillRegistry`).

[AgentBase.addSkillByName](/docs/sdk-reference/reference/typescript/agents/agent-base#add-skill-by-name) and [AgentBase.hasSkill](/docs/sdk-reference/reference/typescript/agents/agent-base#has-skill) accept this
...
A skill-name parameter: one of the typed built-in [SkillName](/docs/sdk-reference/reference/typescript/agents/skills/skill-name#skill-name) values
