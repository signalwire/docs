...
return shape; [hasAllEnvVars](/docs/sdk-reference/reference/typescript/agents/skills/builtin/native-vector-search#has-all-env-vars) is the boolean equivalent.
