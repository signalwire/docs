---
slug: "/reference/typescript/agents/skills/builtin/play-background-file/play-background-file-skill"
...
lustri:
  ...
  module: "agents.skills.builtin.play_background_file"
...
return shape; [hasAllEnvVars](/docs/sdk-reference/reference/typescript/agents/skills/builtin/play-background-file/play-background-file-skill#has-all-env-vars) is the boolean equivalent.
