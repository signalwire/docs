---
slug: "/reference/typescript/agents/skills/builtin/datasphere-serverless"
...
These are registered directly in the SWML output as data\_map functions
...
return shape; [hasAllEnvVars](/docs/sdk-reference/reference/typescript/agents/skills/builtin/datasphere-serverless#has-all-env-vars) is the boolean equivalent.
