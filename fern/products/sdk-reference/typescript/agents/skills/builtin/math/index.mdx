---
slug: "/reference/typescript/agents/skills/builtin/math"
title: "math"
...
return shape; [hasAllEnvVars](/docs/sdk-reference/reference/typescript/agents/skills/builtin/math#has-all-env-vars) is the boolean equivalent.
