...
`SkillToolDefinition[]` — Two tools: `get_current_time` and `get_current_date`, each accepting an optional IANA timezone and defaulting to UTC.
...
return shape; [hasAllEnvVars](/docs/sdk-reference/reference/typescript/agents/skills/builtin/datetime#has-all-env-vars) is the boolean equivalent.
