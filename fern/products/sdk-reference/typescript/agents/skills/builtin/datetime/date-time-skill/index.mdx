---
slug: "/reference/typescript/agents/skills/builtin/datetime/date-time-skill"
title: "DateTimeSkill"
...
return shape; [hasAllEnvVars](/docs/sdk-reference/reference/typescript/agents/skills/builtin/datetime/date-time-skill#has-all-env-vars) is the boolean equivalent.
