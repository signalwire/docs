---
slug: "/reference/typescript/agents/skills/builtin/ask-claude/ask-claude-skill"
...
lustri:
  ...
  module: "agents.skills.builtin.ask_claude"
...
return shape; [hasAllEnvVars](/docs/sdk-reference/reference/typescript/agents/skills/builtin/ask-claude/ask-claude-skill#has-all-env-vars) is the boolean equivalent.
