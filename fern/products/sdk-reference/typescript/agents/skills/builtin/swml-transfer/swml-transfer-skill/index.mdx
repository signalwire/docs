---
slug: "/reference/typescript/agents/skills/builtin/swml-transfer/swml-transfer-skill"
...
return shape; [hasAllEnvVars](/docs/sdk-reference/reference/typescript/agents/skills/builtin/swml-transfer/swml-transfer-skill#has-all-env-vars) is the boolean equivalent.
