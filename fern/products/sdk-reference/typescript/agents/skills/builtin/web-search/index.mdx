---
slug: "/reference/typescript/agents/skills/builtin/web-search"
title: "web_search"
...
`SkillToolDefinition[]` — A single tool (named via `tool_name`) that performs a Google Custom Search and returns formatted results.
...
return shape; [hasAllEnvVars](/docs/sdk-reference/reference/typescript/agents/skills/builtin/web-search#has-all-env-vars) is the boolean equivalent.
