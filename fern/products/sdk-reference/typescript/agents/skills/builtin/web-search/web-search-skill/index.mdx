---
slug: "/reference/typescript/agents/skills/builtin/web-search/web-search-skill"
...
return shape; [hasAllEnvVars](/docs/sdk-reference/reference/typescript/agents/skills/builtin/web-search/web-search-skill#has-all-env-vars) is the boolean equivalent.
