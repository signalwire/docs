---
slug: "/reference/typescript/agents/skills/builtin/api-ninjas-trivia/api-ninjas-trivia-skill"
...
return shape; [hasAllEnvVars](/docs/sdk-reference/reference/typescript/agents/skills/builtin/api-ninjas-trivia/api-ninjas-trivia-skill#has-all-env-vars) is the boolean equivalent.
