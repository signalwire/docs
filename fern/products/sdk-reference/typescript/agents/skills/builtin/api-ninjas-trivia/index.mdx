---
slug: "/reference/typescript/agents/skills/builtin/api-ninjas-trivia"
...
return shape; [hasAllEnvVars](/docs/sdk-reference/reference/typescript/agents/skills/builtin/api-ninjas-trivia#has-all-env-vars) is the boolean equivalent.
