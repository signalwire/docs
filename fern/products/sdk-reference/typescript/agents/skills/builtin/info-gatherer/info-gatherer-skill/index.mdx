---
slug: "/reference/typescript/agents/skills/builtin/info-gatherer/info-gatherer-skill"
...
return shape; [hasAllEnvVars](/docs/sdk-reference/reference/typescript/agents/skills/builtin/info-gatherer/info-gatherer-skill#has-all-env-vars) is the boolean equivalent.
