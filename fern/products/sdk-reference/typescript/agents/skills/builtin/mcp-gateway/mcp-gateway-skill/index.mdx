---
slug: "/reference/typescript/agents/skills/builtin/mcp-gateway/mcp-gateway-skill"
...
lustri:
  ...
  module: "agents.skills.builtin.mcp_gateway"
...
return shape; [hasAllEnvVars](/docs/sdk-reference/reference/typescript/agents/skills/builtin/mcp-gateway/mcp-gateway-skill#has-all-env-vars) is the boolean equivalent.
