---
slug: "/reference/typescript/agents/config-loader"
title: "ConfigLoader"
...
Alias for [getAll](/docs/sdk-reference/reference/typescript/agents/config-loader#get-all) — matches the Python SDK's `get_config()` method name.
...
Alias for [getFilePath](/docs/sdk-reference/reference/typescript/agents/config-loader#get-file-path) — matches the Python SDK's `get_config_file()` method name.
...
[loadFromObject](/docs/sdk-reference/reference/typescript/agents/config-loader#load-from-object), because `loadFromObject` is an extra TS-only method
