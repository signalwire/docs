...
- \- \[SWMLService]\(/docs/sdk-reference/reference/typescript/agents/swml-service) — HTTP service that serves a built SWML document
  \- \[AgentBase]\(/docs/sdk-reference/reference/typescript/agents/agent-base) — for AI-driven call flows
...
Alias for [getDocument](/docs/sdk-reference/reference/typescript/agents/swml-builder#get-document). Matches the Python SDK's `build()` method.
...
Alias for [renderDocument](/docs/sdk-reference/reference/typescript/agents/swml-builder#render-document). Matches the Python SDK's `render()` method.
