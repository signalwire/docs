...
- \- \[Context]\(/docs/sdk-reference/reference/typescript/agents/context-builder/context)
  \- \[Step]\(/docs/sdk-reference/reference/typescript/agents/context-builder/step)
  \- \[GatherInfo]\(/docs/sdk-reference/reference/typescript/agents/context-builder/gather-info)
  \- \[AgentBase.defineContexts]\(/docs/sdk-reference/reference/typescript/agents/agent-base#define-contexts)
...
`Context` — The newly created [Context](/docs/sdk-reference/reference/typescript/agents/context-builder/context) for further configuration.
