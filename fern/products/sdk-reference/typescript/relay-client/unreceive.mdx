...
parent: "RelayClient"
slug: "/sdk-reference/typescript/relay-client/unreceive"
...
Unsubscribe from contexts previously passed to [receive](/sdk-reference/typescript/relay-client/receive) (or the
