...
Most users want [onCall](/reference/typescript/relay-client/on-call) / [onMessage](/reference/typescript/relay-client/on-message) — those deliver
...
AND on any matching [Call](/reference/typescript/call) / [Message](/reference/typescript/message).
