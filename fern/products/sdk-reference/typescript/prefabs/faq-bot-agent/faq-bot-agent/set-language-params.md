---
slug: "/reference/typescript/prefabs/faq-bot-agent/faq-bot-agent/set-language-params"
...
lustri:
  ...
  kind: "method"
  language: "typescript"
  qualified_name: "prefabs.FAQBotAgent.FAQBotAgent.setLanguageParams"
...
language. Useful when language entries are built up via [addLanguage](/reference/typescript/prefabs/faq-bot-agent/faq-bot-agent/add-language)
...
| -------- | ------------------------- | -------- | ------- | --------------------------------------------------------------------------------------------------------------------------------------------- |
| `code`   | `string`                  | yes      | —       | Language code as previously passed to [addLanguage](/reference/typescript/prefabs/faq-bot-agent/faq-bot-agent/add-language) (e.g. `"en-US"`). |
