---
slug: "/reference/typescript/prefabs/faq-bot-agent/faq-bot-agent/add-skill-by-name"
...
lustri:
  ...
  kind: "method"
  language: "typescript"
  qualified_name: "prefabs.FAQBotAgent.FAQBotAgent.addSkillByName"
...
```typescript
addSkillByName(skillName: string, params?: SkillConfig): Promise<FAQBotAgent>
```
