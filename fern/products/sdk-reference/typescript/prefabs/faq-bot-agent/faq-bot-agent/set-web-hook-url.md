---
slug: "/reference/typescript/prefabs/faq-bot-agent/faq-bot-agent/set-web-hook-url"
title: "setWebHookUrl"
...
lustri:
  ...
  kind: "method"
  language: "typescript"
  qualified_name: "prefabs.FAQBotAgent.FAQBotAgent.setWebHookUrl"
...
| ----- | -------- | -------- | ------- | ----------------------- |
| `url` | `string` | yes      | —       | The custom webhook URL. |
