...
<CardGroup cols={2}>
  <Card title="createFAQBotAgent" href="/reference/typescript/prefabs/faq-bot-agent/create-faq-bot-agent">
...
<CardGroup cols={2}>
  <Card title="FAQBotAgent" href="/reference/typescript/prefabs/faq-bot-agent/faq-bot-agent">
...
<CardGroup cols={2}>
  <Card title="FAQBotConfig" href="/reference/typescript/prefabs/faq-bot-agent/faq-bot-config">
    Configuration for the [FAQBotAgent](/reference/typescript/prefabs/faq-bot-agent/faq-bot-agent).
  </Card>

  <Card title="FAQEntry" href="/reference/typescript/prefabs/faq-bot-agent/faq-entry">
