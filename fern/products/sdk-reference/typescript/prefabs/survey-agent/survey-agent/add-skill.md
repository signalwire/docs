---
slug: "/reference/typescript/prefabs/survey-agent/survey-agent/add-skill"
title: "addSkill"
...
lustri:
  ...
  kind: "method"
  language: "typescript"
  qualified_name: "prefabs.SurveyAgent.SurveyAgent.addSkill"
...
```typescript
addSkill(skill: SkillBase): Promise<SurveyAgent>
```
