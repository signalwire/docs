---
slug: "/reference/typescript/prefabs/survey-agent/survey-agent/set-language-params"
...
lustri:
  ...
  kind: "method"
  language: "typescript"
  qualified_name: "prefabs.SurveyAgent.SurveyAgent.setLanguageParams"
...
language. Useful when language entries are built up via [addLanguage](/reference/typescript/prefabs/survey-agent/survey-agent/add-language)
...
| -------- | ------------------------- | -------- | ------- | ------------------------------------------------------------------------------------------------------------------------------------------- |
| `code`   | `string`                  | yes      | —       | Language code as previously passed to [addLanguage](/reference/typescript/prefabs/survey-agent/survey-agent/add-language) (e.g. `"en-US"`). |
