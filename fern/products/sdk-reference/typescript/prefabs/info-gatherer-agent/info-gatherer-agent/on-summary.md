---
slug: "/reference/typescript/prefabs/info-gatherer-agent/info-gatherer-agent/on-summary"
title: "onSummary"
...
lustri:
  ...
  kind: "method"
  language: "typescript"
  qualified_name: "prefabs.InfoGathererAgent.InfoGathererAgent.onSummary"
...
| ---------- | --------------------------------- | -------- | ------- | ----------------------------------------------------------------------------------------------------------------------------- |
| `_summary` | `Record<string, unknown> \| null` | yes      | —       | Parsed summary object (JSON when the post-prompt requests structured output), or `null` if extraction/parsing failed.         |
| `_rawData` | `Record<string, unknown>`         | yes      | —       | Full raw post-prompt payload received from the platform, including call metadata, conversation history, and the summary text. |
