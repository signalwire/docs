---
slug: "/reference/typescript/prefabs/info-gatherer-agent/info-gatherer-agent/register-routing-callback"
...
lustri:
  ...
  kind: "method"
  language: "typescript"
  qualified_name: "prefabs.InfoGathererAgent.InfoGathererAgent.registerRoutingCallback"
...
| ---------- | ----------------- | -------- | -------- | ----------------------------------------------------------------------------------------------------------------------------- |
| `callback` | `RoutingCallback` | yes      | —        | Function receiving the parsed request body and returning a route string to redirect, or null/undefined for normal processing. |
| `path`     | `string`          | yes      | `'/sip'` | HTTP path where this callback endpoint is registered (default: '/sip').                                                       |
