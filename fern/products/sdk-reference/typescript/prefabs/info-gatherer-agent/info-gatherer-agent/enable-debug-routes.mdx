---
slug: "/reference/typescript/prefabs/info-gatherer-agent/info-gatherer-agent/enable-debug-routes"
...
lustri:
  ...
  kind: "method"
  language: "typescript"
  qualified_name: "prefabs.InfoGathererAgent.InfoGathererAgent.enableDebugRoutes"
