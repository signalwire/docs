---
slug: "/reference/typescript/prefabs/info-gatherer-agent/info-gatherer-agent/set-pronunciations"
...
lustri:
  ...
  kind: "method"
  language: "typescript"
  qualified_name: "prefabs.InfoGathererAgent.InfoGathererAgent.setPronunciations"
...
| ------- | --------------------- | -------- | ------- | ------------------------------------ |
| `rules` | `PronunciationRule[]` | yes      | —       | Array of pronunciation rule objects. |
