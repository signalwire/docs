---
slug: "/reference/typescript/prefabs/info-gatherer-agent/info-gatherer-agent/register-sip-username"
...
lustri:
  ...
  kind: "method"
  language: "typescript"
  qualified_name: "prefabs.InfoGathererAgent.InfoGathererAgent.registerSipUsername"
...
| ---------- | -------- | -------- | ------- | ----------------------------- |
| `username` | `string` | yes      | —       | The SIP username to register. |
