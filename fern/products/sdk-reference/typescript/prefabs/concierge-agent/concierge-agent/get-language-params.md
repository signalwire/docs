---
slug: "/reference/typescript/prefabs/concierge-agent/concierge-agent/get-language-params"
...
lustri:
  ...
  kind: "method"
  language: "typescript"
  qualified_name: "prefabs.ConciergeAgent.ConciergeAgent.getLanguageParams"
...
| ------ | -------- | -------- | ------- | -------------------------------------------------------------------------------------------------------------------------------- |
| `code` | `string` | yes      | —       | Language code as previously passed to [addLanguage](/reference/typescript/prefabs/concierge-agent/concierge-agent/add-language). |
