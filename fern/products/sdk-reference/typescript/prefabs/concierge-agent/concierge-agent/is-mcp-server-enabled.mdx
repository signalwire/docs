---
slug: "/reference/typescript/prefabs/concierge-agent/concierge-agent/is-mcp-server-enabled"
...
lustri:
  ...
  kind: "method"
  language: "typescript"
  qualified_name: "prefabs.ConciergeAgent.ConciergeAgent.isMcpServerEnabled"
