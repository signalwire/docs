---
slug: "/reference/typescript/prefabs/concierge-agent/concierge-agent/get-all-functions"
...
lustri:
  ...
  kind: "method"
  language: "typescript"
  qualified_name: "prefabs.ConciergeAgent.ConciergeAgent.getAllFunctions"
