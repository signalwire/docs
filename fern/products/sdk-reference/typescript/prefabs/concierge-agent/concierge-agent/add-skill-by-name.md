---
slug: "/reference/typescript/prefabs/concierge-agent/concierge-agent/add-skill-by-name"
...
lustri:
  ...
  kind: "method"
  language: "typescript"
  qualified_name: "prefabs.ConciergeAgent.ConciergeAgent.addSkillByName"
...
```typescript
addSkillByName(skillName: string, params?: SkillConfig): Promise<ConciergeAgent>
```
