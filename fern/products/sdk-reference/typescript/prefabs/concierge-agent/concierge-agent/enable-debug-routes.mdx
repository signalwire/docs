---
slug: "/reference/typescript/prefabs/concierge-agent/concierge-agent/enable-debug-routes"
...
lustri:
  ...
  kind: "method"
  language: "typescript"
  qualified_name: "prefabs.ConciergeAgent.ConciergeAgent.enableDebugRoutes"
