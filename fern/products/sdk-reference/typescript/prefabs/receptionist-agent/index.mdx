...
See [setInternalFillers](/docs/sdk-reference/reference/typescript/prefabs/receptionist-agent#set-internal-fillers) for the complete list of supported
...
<ParamField path="code" type="string" required>
  Language code as previously passed to [addLanguage](/docs/sdk-reference/reference/typescript/prefabs/receptionist-agent#add-language).
</ParamField>
...
[onSwmlRequest](/docs/sdk-reference/reference/typescript/prefabs/receptionist-agent#on-swml-request) and returns its result. Subclasses typically
...
Alias for [serve](/docs/sdk-reference/reference/typescript/prefabs/receptionist-agent#serve). Starts the HTTP server.
...
language. Useful when language entries are built up via [addLanguage](/docs/sdk-reference/reference/typescript/prefabs/receptionist-agent#add-language)
...
<ParamField path="code" type="string" required>
  Language code as previously passed to [addLanguage](/docs/sdk-reference/reference/typescript/prefabs/receptionist-agent#add-language) (e.g. `"en-US"`).
</ParamField>
...
Configuration for the [ReceptionistAgent](/docs/sdk-reference/reference/typescript/prefabs/receptionist-agent).
