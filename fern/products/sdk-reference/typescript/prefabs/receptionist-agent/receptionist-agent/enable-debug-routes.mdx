---
slug: "/reference/typescript/prefabs/receptionist-agent/receptionist-agent/enable-debug-routes"
...
lustri:
  ...
  kind: "method"
  language: "typescript"
  qualified_name: "prefabs.ReceptionistAgent.ReceptionistAgent.enableDebugRoutes"
