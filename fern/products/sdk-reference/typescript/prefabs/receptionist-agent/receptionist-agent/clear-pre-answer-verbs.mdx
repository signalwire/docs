---
slug: "/reference/typescript/prefabs/receptionist-agent/receptionist-agent/clear-pre-answer-verbs"
...
lustri:
  ...
  kind: "method"
  language: "typescript"
  qualified_name: "prefabs.ReceptionistAgent.ReceptionistAgent.clearPreAnswerVerbs"
