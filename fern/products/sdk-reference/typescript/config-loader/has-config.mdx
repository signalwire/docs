...
parent: "ConfigLoader"
slug: "/reference/typescript/config-loader/has-config"
...
[loadFromObject](/reference/typescript/config-loader/load-from-object), because `loadFromObject` is an extra TS-only method
