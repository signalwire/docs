...
kind: "method"
language: "typescript"
qualified_name: "ConfigLoader.hasConfig"
parent: "ConfigLoader"
slug: "/sdk-reference/typescript/config-loader/has-config"
...
[loadFromObject](/sdk-reference/typescript/config-loader/load-from-object), because `loadFromObject` is an extra TS-only method
