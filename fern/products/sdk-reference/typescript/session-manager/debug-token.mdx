...
slug: "/sdk-reference/typescript/session-manager/debug-token"
...
Requires [debugMode](/sdk-reference/typescript/session-manager#debug-mode) to be `true`. When disabled, returns
