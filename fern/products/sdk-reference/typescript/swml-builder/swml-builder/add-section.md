---
slug: "/reference/typescript/swml-builder/swml-builder/add-section"
title: "addSection"
...
lustri:
  ...
  kind: "method"
  language: "typescript"
  qualified_name: "SwmlBuilder.SwmlBuilder.addSection"
...
| ------------- | -------- | -------- | ------- | ---------------------------------- |
| `sectionName` | `string` | yes      | —       | The name of the section to create. |
