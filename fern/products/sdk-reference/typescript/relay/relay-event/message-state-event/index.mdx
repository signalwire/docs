...
<CardGroup cols={2}>
  <Card title="constructor" href="/reference/typescript/relay/relay-event/message-state-event/constructor" />

  <Card title="fromPayload" href="/reference/typescript/relay/relay-event/message-state-event/from-payload">
