---
slug: "/reference/typescript/relay/relay-event/stream-event/from-payload"
title: "fromPayload"
...
lustri:
  ...
  kind: "method"
  language: "typescript"
  qualified_name: "relay.RelayEvent.StreamEvent.fromPayload"
  parent: "relay.RelayEvent.StreamEvent"
...
```typescript
fromPayload(payload: Record<string, any>): StreamEvent
```
