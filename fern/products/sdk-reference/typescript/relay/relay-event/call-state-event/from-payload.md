---
slug: "/reference/typescript/relay/relay-event/call-state-event/from-payload"
title: "fromPayload"
...
lustri:
  ...
  kind: "method"
  language: "typescript"
  qualified_name: "relay.RelayEvent.CallStateEvent.fromPayload"
...
```typescript
fromPayload(payload: Record<string, any>): CallStateEvent
```
