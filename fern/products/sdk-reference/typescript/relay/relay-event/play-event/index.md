---
slug: "/reference/typescript/relay/relay-event/play-event"
title: "PlayEvent"
...
lustri:
  ...
  kind: "class"
  language: "typescript"
  qualified_name: "relay.RelayEvent.PlayEvent"
...
- [`constructor`](/reference/typescript/relay/relay-event/play-event/constructor)
- [`fromPayload`](/reference/typescript/relay/relay-event/play-event/from-payload) — Factory that builds a typed event from a raw `signalwire.event` payload. Subclasses override this to populate their specialised fields; the base implementation returns a minimal `RelayEvent` used as the fallback for unrecognised event types.
