...
<CardGroup cols={2}>
  <Card title="constructor" href="/reference/typescript/relay/relay-event/queue-event/constructor" />

  <Card title="fromPayload" href="/reference/typescript/relay/relay-event/queue-event/from-payload">
