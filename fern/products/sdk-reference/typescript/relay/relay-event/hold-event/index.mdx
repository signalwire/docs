...
<CardGroup cols={2}>
  <Card title="constructor" href="/reference/typescript/relay/relay-event/hold-event/constructor" />

  <Card title="fromPayload" href="/reference/typescript/relay/relay-event/hold-event/from-payload">
