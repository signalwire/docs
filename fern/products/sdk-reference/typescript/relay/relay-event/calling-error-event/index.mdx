...
<CardGroup cols={2}>
  <Card title="constructor" href="/reference/typescript/relay/relay-event/calling-error-event/constructor" />

  <Card title="fromPayload" href="/reference/typescript/relay/relay-event/calling-error-event/from-payload">
