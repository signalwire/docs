---
slug: "/reference/typescript/relay/relay-event/send-digits-event/from-payload"
title: "fromPayload"
...
lustri:
  ...
  kind: "method"
  language: "typescript"
  qualified_name: "relay.RelayEvent.SendDigitsEvent.fromPayload"
...
```typescript
fromPayload(payload: Record<string, any>): SendDigitsEvent
```
