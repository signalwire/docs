...
<CardGroup cols={2}>
  <Card title="constructor" href="/reference/typescript/relay/relay-event/record-event/constructor" />

  <Card title="fromPayload" href="/reference/typescript/relay/relay-event/record-event/from-payload">
