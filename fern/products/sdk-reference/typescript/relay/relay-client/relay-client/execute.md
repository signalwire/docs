---
slug: "/reference/typescript/relay/relay-client/relay-client/execute"
title: "execute"
...
lustri:
  ...
  kind: "method"
  language: "typescript"
  qualified_name: "relay.RelayClient.RelayClient.execute"
...
| -------- | ------------------------- | -------- | ------- | ------------------------------------------------------------- |
| `method` | `string`                  | yes      | —       | Fully-qualified JSON-RPC method name (e.g. `"calling.play"`). |
| `params` | `Record<string, unknown>` | yes      | —       | Method-specific params object.                                |
