...
- \- \[Call]\(/docs/sdk-reference/reference/typescript/relay/call)
...
`Promise<Call>` — A [Call](/docs/sdk-reference/reference/typescript/relay/call) representing the answered leg.
...
[Call](/docs/sdk-reference/reference/typescript/relay/call) already in state `"created"`. Answer, reject, or forward
...
AND on any matching [Call](/docs/sdk-reference/reference/typescript/relay/call) / [Message](/docs/sdk-reference/reference/typescript/relay/message).
