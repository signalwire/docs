...
<CardGroup cols={2}>
  <Card title="constructor" href="/reference/typescript/relay/action/tap-action/constructor" />

  <Card title="stop" href="/reference/typescript/relay/action/tap-action/stop">
    Stop the media tap.
  </Card>

  <Card title="wait" href="/reference/typescript/relay/action/tap-action/wait">
