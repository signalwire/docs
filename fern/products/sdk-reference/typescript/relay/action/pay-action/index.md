...
- [`constructor`](/reference/typescript/relay/action/pay-action/constructor)
- [`stop`](/reference/typescript/relay/action/pay-action/stop) — Cancel the payment collection before it completes.
- [`wait`](/reference/typescript/relay/action/pay-action/wait) — Wait for the action to complete.
