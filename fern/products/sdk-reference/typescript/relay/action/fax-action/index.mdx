...
<CardGroup cols={2}>
  <Card title="constructor" href="/reference/typescript/relay/action/fax-action/constructor" />

  <Card title="stop" href="/reference/typescript/relay/action/fax-action/stop">
    Stop the fax transfer mid-stream.
  </Card>

  <Card title="wait" href="/reference/typescript/relay/action/fax-action/wait">
