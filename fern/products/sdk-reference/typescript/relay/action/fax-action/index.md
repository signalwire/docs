---
slug: "/reference/typescript/relay/action/fax-action"
title: "FaxAction"
...
lustri:
  ...
  kind: "class"
  language: "typescript"
  qualified_name: "relay.Action.FaxAction"
  parent: "relay.Action"
  module: "relay.Action"
...
- [`constructor`](/reference/typescript/relay/action/fax-action/constructor)
- [`stop`](/reference/typescript/relay/action/fax-action/stop) — Stop the fax transfer mid-stream.
- [`wait`](/reference/typescript/relay/action/fax-action/wait) — Wait for the action to complete.
