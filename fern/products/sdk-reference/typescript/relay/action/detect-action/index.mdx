...
<CardGroup cols={2}>
  <Card title="_checkEvent" href="/reference/typescript/relay/action/detect-action/check-event">
    Resolve on first meaningful result OR terminal state.
  </Card>

  <Card title="constructor" href="/reference/typescript/relay/action/detect-action/constructor" />

  <Card title="stop" href="/reference/typescript/relay/action/detect-action/stop">
    Stop detection before the timeout elapses.
  </Card>

  <Card title="wait" href="/reference/typescript/relay/action/detect-action/wait">
