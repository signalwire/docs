...
<CardGroup cols={2}>
  <Card title="addDirectory" href="/reference/typescript/web-service/web-service/add-directory">
    Add a new directory to serve at a URL route prefix.
  </Card>

  <Card title="constructor" href="/reference/typescript/web-service/web-service/constructor">
    Create a WebService.
  </Card>

  <Card title="getApp" href="/reference/typescript/web-service/web-service/get-app">
    Get the Hono application for mounting or testing.
  </Card>

  <Card title="removeDirectory" href="/reference/typescript/web-service/web-service/remove-directory">
    Remove a previously added directory route from the bookkeeping map.
  </Card>

  <Card title="start" href="/reference/typescript/web-service/web-service/start">
    Start the HTTP(S) service.
  </Card>

  <Card title="stop" href="/reference/typescript/web-service/web-service/stop">
