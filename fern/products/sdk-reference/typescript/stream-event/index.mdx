...
slug: "/reference/typescript/stream-event"
...
<CardGroup cols={2}>
  <Card title="constructor" href="/reference/typescript/stream-event/constructor"></Card>
  <Card title="fromPayload" href="/reference/typescript/stream-event/from-payload">
