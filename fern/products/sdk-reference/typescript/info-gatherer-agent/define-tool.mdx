...
kind: "method"
language: "typescript"
qualified_name: "InfoGathererAgent.defineTool"
parent: "InfoGathererAgent"
slug: "/sdk-reference/typescript/info-gatherer-agent/define-tool"
...
<ParamField path="opts" type="object" required>
  Tool definition including name, description, parameter
...
<Indent>
  ...
  <ParamField path="opts.handler" type="SwaigHandler" required></ParamField>
