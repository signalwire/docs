...
slug: "/reference/typescript/relay-event"
...
looks up the correct subclass in [EVENT_CLASS_MAP](/reference/typescript/event-class-map) and invokes
[RelayEvent.fromPayload](/reference/typescript/relay-event/from-payload) to build a typed wrapper. Handlers receive
...
<CardGroup cols={2}>
  <Card title="constructor" href="/reference/typescript/relay-event/constructor"></Card>
  <Card title="fromPayload" href="/reference/typescript/relay-event/from-payload">
