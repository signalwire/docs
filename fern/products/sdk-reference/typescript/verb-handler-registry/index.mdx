...
slug: "/reference/typescript/verb-handler-registry"
...
([AIVerbHandler](/reference/typescript/ai-verb-handler)) is registered automatically on construction.
...
<CardGroup cols={2}>
  <Card title="constructor" href="/reference/typescript/verb-handler-registry/constructor">
    Initialize the registry with default handlers.
  </Card>
  <Card title="getHandler" href="/reference/typescript/verb-handler-registry/get-handler">
    Get the handler for a specific verb.
  </Card>
  <Card title="hasHandler" href="/reference/typescript/verb-handler-registry/has-handler">
    Check if a handler exists for a specific verb.
  </Card>
  <Card title="registerHandler" href="/reference/typescript/verb-handler-registry/register-handler">
