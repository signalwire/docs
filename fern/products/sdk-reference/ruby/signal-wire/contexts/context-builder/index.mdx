...
<CardGroup cols={2}>
  <Card title="add_context" href="/reference/ruby/signal-wire/contexts/context-builder/add-context">
    Add a new context. Returns the Context object.
  </Card>

  <Card title="attach_agent" href="/reference/ruby/signal-wire/contexts/context-builder/attach-agent">
    Attach an agent reference so +validate!+ can check user-defined tool names against RESERVED\_NATIVE\_TOOL\_NAMES. Called internally by AgentBase#define\_contexts.
  </Card>

  <Card title="get_context" href="/reference/ruby/signal-wire/contexts/context-builder/get-context">
    Get an existing context by name. Returns Context or nil.
  </Card>

  <Card title="initialize" href="/reference/ruby/signal-wire/contexts/context-builder/initialize">
  ...
  <Card title="reset" href="/reference/ruby/signal-wire/contexts/context-builder/reset">
  ...
  <Card title="to_h" href="/reference/ruby/signal-wire/contexts/context-builder/to-h" />

  <Card title="validate!" href="/reference/ruby/signal-wire/contexts/context-builder/validate">
