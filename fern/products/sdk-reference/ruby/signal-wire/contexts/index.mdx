...
<CardGroup cols={2}>
  <Card title="Context" href="/docs/sdk-reference/reference/ruby/signal-wire/contexts/context">
    Represents a single context containing multiple steps.
  </Card>

  <Card title="ContextBuilder" href="/docs/sdk-reference/reference/ruby/signal-wire/contexts/context-builder">
    Builder for multi-step, multi-context AI agent workflows.
  </Card>

  <Card title="GatherInfo" href="/docs/sdk-reference/reference/ruby/signal-wire/contexts/gather-info">
    Configuration for gathering information in a step via the C-side gather\_info system.
  </Card>

  <Card title="GatherQuestion" href="/docs/sdk-reference/reference/ruby/signal-wire/contexts/gather-question">
    Represents a single question in a gather\_info configuration.
  </Card>

  <Card title="Step" href="/docs/sdk-reference/reference/ruby/signal-wire/contexts/step">
