...
<CardGroup cols={2}>
  ...
  <Card title="loaded_keys" href="/reference/ruby/signal-wire/skills/skill-manager/loaded-keys"></Card>
  <Card title="loaded?" href="/reference/ruby/signal-wire/skills/skill-manager/loaded"></Card>
  <Card title="logger" href="/reference/ruby/signal-wire/skills/skill-manager/logger">
    Python parity: - ``agent`` — owning AgentBase instance (or nil) - ``logger`` — namespaced logger
  </Card>
  <Card title="size" href="/reference/ruby/signal-wire/skills/skill-manager/size"></Card>
