...
slug: "/sdk-reference/ruby/signal-wire/skills/skill-registry"
...
<CardGroup cols={2}>
  <Card title="_list_skills_full" href="/sdk-reference/ruby/signal-wire/skills/skill-registry/list-skills-full">
  ...
  <Card title="add_skill_directory" href="/sdk-reference/ruby/signal-wire/skills/skill-registry/add-skill-directory">
    Add a directory to search for skills.
  </Card>
  <Card title="external_paths" href="/sdk-reference/ruby/signal-wire/skills/skill-registry/external-paths">
    External skill directories registered via #add_skill_directory. Mirrors Python's `_external_paths` accessor surface.
  </Card>
  <Card title="get_all_skills_schema" href="/sdk-reference/ruby/signal-wire/skills/skill-registry/get-all-skills-schema">
    Get complete schema for all registered skills (instance form).
  </Card>
  <Card title="get_all_skills_schema" href="/sdk-reference/ruby/signal-wire/skills/skill-registry/get-all-skills-schema">
    Get complete schema for all registered skills.
  </Card>
  <Card title="get_factory" href="/sdk-reference/ruby/signal-wire/skills/skill-registry/get-factory">
    Get the factory for a skill.
  </Card>
  <Card title="initialize" href="/sdk-reference/ruby/signal-wire/skills/skill-registry/initialize">
  ...
  <Card title="last_registered" href="/sdk-reference/ruby/signal-wire/skills/skill-registry/last-registered">
    The most recently registered skill name (instance form).
  </Card>
  <Card title="list_skills" href="/sdk-reference/ruby/signal-wire/skills/skill-registry/list-skills">
    List all registered skill names (instance form).
  </Card>
  <Card title="list_skills" href="/sdk-reference/ruby/signal-wire/skills/skill-registry/list-skills">
    List all registered skill names.
  </Card>
  <Card title="logger" href="/sdk-reference/ruby/signal-wire/skills/skill-registry/logger">
    Python parity: ``self.logger = get_logger("skill_registry")``. Per-instance logger; the class-level API uses the same name.
  </Card>
  <Card title="register" href="/sdk-reference/ruby/signal-wire/skills/skill-registry/register">
    Register a skill factory.
  </Card>
  <Card title="register_builtins!" href="/sdk-reference/ruby/signal-wire/skills/skill-registry/register-builtins">
    Register all built-in skills. Called at load time.
  </Card>
  <Card title="register_skill" href="/sdk-reference/ruby/signal-wire/skills/skill-registry/register-skill">
    Register a skill class or factory (instance form).
  </Card>
  <Card title="register_skill" href="/sdk-reference/ruby/signal-wire/skills/skill-registry/register-skill">
    Register with an explicit lambda / proc instead of a block.
  </Card>
  <Card title="registered?" href="/sdk-reference/ruby/signal-wire/skills/skill-registry/registered">
    Check if a skill is registered.
  </Card>
  <Card title="reset!" href="/sdk-reference/ruby/signal-wire/skills/skill-registry/reset">
