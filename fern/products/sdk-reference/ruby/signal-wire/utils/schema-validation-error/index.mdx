...
slug: "/sdk-reference/ruby/signal-wire/utils/schema-validation-error"
...
<CardGroup cols={2}>
  <Card title="errors" href="/sdk-reference/ruby/signal-wire/utils/schema-validation-error/errors">
    Returns the value of attribute errors.
  </Card>
  <Card title="initialize" href="/sdk-reference/ruby/signal-wire/utils/schema-validation-error/initialize">
    Construct a SchemaValidationError. Mirrors Python's SchemaValidationError(verb_name, errors).
  </Card>
  <Card title="verb_name" href="/sdk-reference/ruby/signal-wire/utils/schema-validation-error/verb-name">
