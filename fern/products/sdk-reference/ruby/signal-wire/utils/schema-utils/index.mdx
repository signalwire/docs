...
<CardGroup cols={2}>
  ...
  <Card title="schema" href="/reference/ruby/signal-wire/utils/schema-utils/schema"></Card>
  <Card title="schema_path" href="/reference/ruby/signal-wire/utils/schema-utils/schema-path"></Card>
