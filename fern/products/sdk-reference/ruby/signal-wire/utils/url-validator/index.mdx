...
<ParamField path="LOG" type="LOG = SignalWire::Logging.logger('signalwire.url_validator')" required />
...
<CardGroup cols={2}>
  ...
  <Card title="_resolver=" href="/reference/ruby/signal-wire/utils/url-validator/resolver__2" />
