...
<CardGroup cols={2}>
  <Card title="get" href="/reference/ruby/signal-wire/rest/namespaces/message-logs/get" />

  <Card title="list" href="/reference/ruby/signal-wire/rest/namespaces/message-logs/list" />
</CardGroup>
