...
slug: "/sdk-reference/ruby/signal-wire/rest/namespaces/fabric-resource"
...
<CardGroup cols={2}>
  <Card title="list_addresses" href="/sdk-reference/ruby/signal-wire/rest/namespaces/fabric-resource/list-addresses"></Card>
</CardGroup>
