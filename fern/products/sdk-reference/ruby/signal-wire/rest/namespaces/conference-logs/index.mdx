...
slug: "/sdk-reference/ruby/signal-wire/rest/namespaces/conference-logs"
...
<CardGroup cols={2}>
  <Card title="list" href="/sdk-reference/ruby/signal-wire/rest/namespaces/conference-logs/list"></Card>
</CardGroup>
