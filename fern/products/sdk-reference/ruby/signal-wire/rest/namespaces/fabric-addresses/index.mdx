...
<CardGroup cols={2}>
  <Card title="get" href="/reference/ruby/signal-wire/rest/namespaces/fabric-addresses/get"></Card>
  <Card title="list" href="/reference/ruby/signal-wire/rest/namespaces/fabric-addresses/list"></Card>
</CardGroup>
