...
<CardGroup cols={2}>
  <Card title="call" href="/reference/ruby/signal-wire/agent-base/agent-security-headers-middleware/call" />

  <Card title="initialize" href="/reference/ruby/signal-wire/agent-base/agent-security-headers-middleware/initialize" />
</CardGroup>
