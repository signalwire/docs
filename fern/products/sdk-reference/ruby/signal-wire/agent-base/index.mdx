...
**Extends:** [SignalWire::SWML::Service](/docs/sdk-reference/reference/ruby/signal-wire/swml/service)
...
<CardGroup cols={2}>
  <Card title="AgentBodyLimitMiddleware" href="/docs/sdk-reference/reference/ruby/signal-wire/agent-base/agent-body-limit-middleware" />

  <Card title="AgentSecurityHeadersMiddleware" href="/docs/sdk-reference/reference/ruby/signal-wire/agent-base/agent-security-headers-middleware">
    \================================================================== Rack Middleware ==================================================================
  </Card>

  <Card title="AgentTimingSafeBasicAuth" href="/docs/sdk-reference/reference/ruby/signal-wire/agent-base/agent-timing-safe-basic-auth" />
</CardGroup>
