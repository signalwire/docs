---
slug: "/reference/ruby/signal-wire/pom"
title: "POM"
sdk_label: "Ruby SDK"
icon: "ruby"
lustri:
...
<CardGroup cols={2}>
  <Card title="PromptObjectModel" href="/docs/sdk-reference/reference/ruby/signal-wire/pom/prompt-object-model">
    A structured data format for composing, organising, and rendering prompt instructions for large language models.
  </Card>

  <Card title="Section" href="/docs/sdk-reference/reference/ruby/signal-wire/pom/section">
