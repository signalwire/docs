...
<CardGroup cols={2}>
  <Card title="SecurityHeadersMiddleware" href="/docs/sdk-reference/reference/ruby/signal-wire/swml/service/security-headers-middleware">
    \------------------------------------------------------------------ Middleware: security headers ------------------------------------------------------------------
  </Card>

  <Card title="TimingSafeBasicAuth" href="/docs/sdk-reference/reference/ruby/signal-wire/swml/service/timing-safe-basic-auth">
