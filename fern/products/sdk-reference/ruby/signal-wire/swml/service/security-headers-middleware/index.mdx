...
<CardGroup cols={2}>
  <Card title="call" href="/reference/ruby/signal-wire/swml/service/security-headers-middleware/call" />

  <Card title="initialize" href="/reference/ruby/signal-wire/swml/service/security-headers-middleware/initialize" />
</CardGroup>
