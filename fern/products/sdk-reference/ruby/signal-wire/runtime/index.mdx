...
parent: "SignalWire"
module: "SignalWire"
slug: "/sdk-reference/ruby/signal-wire/runtime"
...
<CardGroup cols={2}>
  <Card title="execution_mode" href="/sdk-reference/ruby/signal-wire/runtime/execution-mode">
    Determine the current execution mode.
  </Card>
  <Card title="lambda_base_url" href="/sdk-reference/ruby/signal-wire/runtime/lambda-base-url">
    Construct the base URL for the current Lambda function.
  </Card>
  <Card title="lambda?" href="/sdk-reference/ruby/signal-wire/runtime/lambda">
    True when the SDK is running inside AWS Lambda.
  </Card>
  <Card title="serverless?" href="/sdk-reference/ruby/signal-wire/runtime/serverless">
