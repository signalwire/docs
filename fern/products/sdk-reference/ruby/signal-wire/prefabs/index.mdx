...
<CardGroup cols={2}>
  <Card title="Concierge" href="/docs/sdk-reference/reference/ruby/signal-wire/prefabs/concierge">
    Prefab agent for providing virtual concierge services.
  </Card>

  <Card title="FaqBot" href="/docs/sdk-reference/reference/ruby/signal-wire/prefabs/faq-bot">
    Prefab agent for answering frequently asked questions.
  </Card>

  <Card title="InfoGatherer" href="/docs/sdk-reference/reference/ruby/signal-wire/prefabs/info-gatherer">
    Prefab agent for collecting answers to a series of questions.
  </Card>

  <Card title="Receptionist" href="/docs/sdk-reference/reference/ruby/signal-wire/prefabs/receptionist">
    Prefab agent for greeting callers and transferring them to departments.
  </Card>

  <Card title="Survey" href="/docs/sdk-reference/reference/ruby/signal-wire/prefabs/survey">
