...
slug: "/sdk-reference/ruby/signal-wire/security/webhook-validator"
...
<CardGroup cols={2}>
  <Card title="_b64_hmac_sha1" href="/sdk-reference/ruby/signal-wire/security/webhook-validator/b64-hmac-sha1"></Card>
  <Card title="_build_url_with_port" href="/sdk-reference/ruby/signal-wire/security/webhook-validator/build-url-with-port"></Card>
  <Card title="_build_url_without_port" href="/sdk-reference/ruby/signal-wire/security/webhook-validator/build-url-without-port"></Card>
  <Card title="_candidate_urls" href="/sdk-reference/ruby/signal-wire/security/webhook-validator/candidate-urls">
    Return the URL variants to try for Scheme B port normalization.
  </Card>
  <Card title="_check_body_sha256" href="/sdk-reference/ruby/signal-wire/security/webhook-validator/check-body-sha256">
  ...
  <Card title="_explicit_port?" href="/sdk-reference/ruby/signal-wire/security/webhook-validator/explicit-port">
  ...
  <Card title="_hex_hmac_sha1" href="/sdk-reference/ruby/signal-wire/security/webhook-validator/hex-hmac-sha1"></Card>
  <Card title="_parse_form_body" href="/sdk-reference/ruby/signal-wire/security/webhook-validator/parse-form-body">
  ...
  <Card title="_safe_eq" href="/sdk-reference/ruby/signal-wire/security/webhook-validator/safe-eq">
    Constant-time string compare. Returns false on any error so malformed inputs never raise.
  </Card>
  <Card title="_sorted_concat_params" href="/sdk-reference/ruby/signal-wire/security/webhook-validator/sorted-concat-params">
  ...
  <Card title="validate_request" href="/sdk-reference/ruby/signal-wire/security/webhook-validator/validate-request">
    Legacy ``@signalwire/compatibility-api`` drop-in entry point.
  </Card>
  <Card title="validate_webhook_signature" href="/sdk-reference/ruby/signal-wire/security/webhook-validator/validate-webhook-signature">
