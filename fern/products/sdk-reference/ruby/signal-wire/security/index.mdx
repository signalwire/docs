...
<CardGroup cols={2}>
  <Card title="SessionManager" href="/docs/sdk-reference/reference/ruby/signal-wire/security/session-manager">
    Stateless HMAC-SHA256 session manager for secure SWAIG tool tokens.
  </Card>

  <Card title="WebhookMiddleware" href="/docs/sdk-reference/reference/ruby/signal-wire/security/webhook-middleware">
...
<CardGroup cols={2}>
  <Card title="WebhookValidator" href="/docs/sdk-reference/reference/ruby/signal-wire/security/webhook-validator">
