...
slug: "/sdk-reference/ruby/signal-wire/relay/fax-action"
...
<CardGroup cols={2}>
  <Card title="initialize" href="/sdk-reference/ruby/signal-wire/relay/fax-action/initialize"></Card>
  <Card title="stop" href="/sdk-reference/ruby/signal-wire/relay/fax-action/stop"></Card>
</CardGroup>
