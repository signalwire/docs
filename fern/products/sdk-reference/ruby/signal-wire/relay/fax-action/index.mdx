...
<CardGroup cols={2}>
  <Card title="initialize" href="/reference/ruby/signal-wire/relay/fax-action/initialize" />

  <Card title="stop" href="/reference/ruby/signal-wire/relay/fax-action/stop" />
</CardGroup>
