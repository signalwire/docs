...
slug: "/sdk-reference/ruby/signal-wire/relay/client"
...
<CardGroup cols={2}>
  <Card title="_authorization_state" href="/sdk-reference/ruby/signal-wire/relay/client/authorization-state">
  ...
  <Card title="_calls_snapshot" href="/sdk-reference/ruby/signal-wire/relay/client/calls-snapshot">
  ...
  <Card title="_connected?" href="/sdk-reference/ruby/signal-wire/relay/client/connected">
  ...
  <Card title="_set_protocol" href="/sdk-reference/ruby/signal-wire/relay/client/set-protocol">
  ...
  <Card title="dial" href="/sdk-reference/ruby/signal-wire/relay/client/dial">
    Dial outbound call(s). Returns a Call object.
  </Card>
  <Card title="execute" href="/sdk-reference/ruby/signal-wire/relay/client/execute">
    Send a JSON-RPC request and wait for the response. Returns the result hash. Raises RelayError on error.
  </Card>
  <Card title="host" href="/sdk-reference/ruby/signal-wire/relay/client/host">
    Returns the value of attribute host.
  </Card>
  <Card title="initialize" href="/sdk-reference/ruby/signal-wire/relay/client/initialize">
  ...
  <Card title="max_active_calls" href="/sdk-reference/ruby/signal-wire/relay/client/max-active-calls">
    Returns the value of attribute max_active_calls.
  </Card>
  <Card title="on_call" href="/sdk-reference/ruby/signal-wire/relay/client/on-call">
    Register inbound call handler.
  </Card>
  <Card title="on_event" href="/sdk-reference/ruby/signal-wire/relay/client/on-event">
  ...
  <Card title="on_message" href="/sdk-reference/ruby/signal-wire/relay/client/on-message">
    Register inbound message handler.
  </Card>
  <Card title="project_id" href="/sdk-reference/ruby/signal-wire/relay/client/project-id">
    Returns the value of attribute project_id.
  </Card>
  <Card title="protocol" href="/sdk-reference/ruby/signal-wire/relay/client/protocol">
    Returns the value of attribute protocol.
  </Card>
  <Card title="receive" href="/sdk-reference/ruby/signal-wire/relay/client/receive">
    ------------------------------------------------------------------ Dynamic context subscription ------------------------------------------------------------------
  </Card>
  <Card title="run" href="/sdk-reference/ruby/signal-wire/relay/client/run">
    Connect, authenticate, subscribe, and enter the read loop. Blocks until stop is called.
  </Card>
  <Card title="send_json" href="/sdk-reference/ruby/signal-wire/relay/client/send-json">
  ...
  <Card title="send_message" href="/sdk-reference/ruby/signal-wire/relay/client/send-message">
    Send an SMS/MMS message. Returns a Message object.
  </Card>
  <Card title="stop" href="/sdk-reference/ruby/signal-wire/relay/client/stop">
    Graceful shutdown.
  </Card>
  <Card title="unreceive" href="/sdk-reference/ruby/signal-wire/relay/client/unreceive"></Card>
</CardGroup>
