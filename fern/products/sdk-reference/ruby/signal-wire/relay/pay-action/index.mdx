...
<CardGroup cols={2}>
  <Card title="initialize" href="/reference/ruby/signal-wire/relay/pay-action/initialize" />

  <Card title="stop" href="/reference/ruby/signal-wire/relay/pay-action/stop" />
</CardGroup>
