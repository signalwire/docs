...
<CardGroup cols={2}>
  <Card title="initialize" href="/reference/ruby/signal-wire/relay/transcribe-action/initialize"></Card>
  <Card title="stop" href="/reference/ruby/signal-wire/relay/transcribe-action/stop"></Card>
</CardGroup>
