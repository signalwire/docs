...
<CardGroup cols={2}>
  <Card title="initialize" href="/reference/ruby/signal-wire/relay/stream-action/initialize" />

  <Card title="stop" href="/reference/ruby/signal-wire/relay/stream-action/stop" />
</CardGroup>
