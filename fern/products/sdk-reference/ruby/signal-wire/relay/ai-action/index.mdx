...
<CardGroup cols={2}>
  <Card title="initialize" href="/reference/ruby/signal-wire/relay/ai-action/initialize"></Card>
  <Card title="stop" href="/reference/ruby/signal-wire/relay/ai-action/stop"></Card>
</CardGroup>
