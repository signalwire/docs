...
<CardGroup cols={2}>
  ...
  <Card title="initialize" href="/reference/ruby/signal-wire/data-map/initialize" />
  ...
  <Card title="purpose" href="/reference/ruby/signal-wire/data-map/purpose">
    Set the LLM-facing tool description (a.k.a. "purpose"). _PROMPT ENGINEERING_, not developer documentation.
  </Card>
