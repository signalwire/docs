...
parent: "SignalWire"
module: "SignalWire"
slug: "/sdk-reference/ruby/signal-wire/data-map"
...
<CardGroup cols={2}>
  <Card title="body" href="/sdk-reference/ruby/signal-wire/data-map/body">
    Set the request body for the most-recently-added webhook (POST / PUT).
  </Card>
  <Card title="create_expression_tool" href="/sdk-reference/ruby/signal-wire/data-map/create-expression-tool">
    Build an expression-only tool (no HTTP calls).
  </Card>
  <Card title="create_simple_api_tool" href="/sdk-reference/ruby/signal-wire/data-map/create-simple-api-tool">
    Build a simple API-calling tool in one shot.
  </Card>
  <Card title="description" href="/sdk-reference/ruby/signal-wire/data-map/description">
  ...
  <Card title="error_keys" href="/sdk-reference/ruby/signal-wire/data-map/error-keys">
    Set error keys on the most-recently-added webhook, or at the top level if no webhook has been added yet.
  </Card>
  <Card title="expression" href="/sdk-reference/ruby/signal-wire/data-map/expression">
    Add an expression (pattern-matching rule).
  </Card>
  <Card title="fallback_output" href="/sdk-reference/ruby/signal-wire/data-map/fallback-output">
    Set a fallback output used when all webhooks fail.
  </Card>
  <Card title="foreach" href="/sdk-reference/ruby/signal-wire/data-map/foreach">
    Configure array processing on the most-recently-added webhook response.
  </Card>
  <Card title="function_name" href="/sdk-reference/ruby/signal-wire/data-map/function-name">
    Returns the value of attribute function_name.
  </Card>
  <Card title="global_error_keys" href="/sdk-reference/ruby/signal-wire/data-map/global-error-keys">
    Set top-level error keys (applies to all webhooks).
  </Card>
  <Card title="initialize" href="/sdk-reference/ruby/signal-wire/data-map/initialize"></Card>
  <Card title="output" href="/sdk-reference/ruby/signal-wire/data-map/output">
    Set the output result for the most-recently-added webhook.
  </Card>
  <Card title="parameter" href="/sdk-reference/ruby/signal-wire/data-map/parameter">
    Add a typed parameter to the function signature — the +desc+ is LLM-FACING.
  </Card>
  <Card title="params" href="/sdk-reference/ruby/signal-wire/data-map/params">
    Set request params for the most-recently-added webhook.
  </Card>
  <Card title="purpose" href="/sdk-reference/ruby/signal-wire/data-map/purpose">
    Set the LLM-facing tool description (a.k.a. "purpose"). *PROMPT ENGINEERING*, not developer documentation.
  </Card>
  <Card title="to_swaig_function" href="/sdk-reference/ruby/signal-wire/data-map/to-swaig-function">
    Serialize this DataMap into a complete SWAIG function definition Hash.
  </Card>
  <Card title="webhook" href="/sdk-reference/ruby/signal-wire/data-map/webhook">
    Add a webhook (HTTP call) to the data_map pipeline.
  </Card>
  <Card title="webhook_expressions" href="/sdk-reference/ruby/signal-wire/data-map/webhook-expressions">
