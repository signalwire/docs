---
slug: "/reference/python/signalwire/cli/simulation/mock-env/mock-query-params/items"
title: "items"
...
lustri:
  ...
  kind: "method"
  language: "python"
  qualified_name: "signalwire.cli.simulation.mock_env.MockQueryParams.items"
