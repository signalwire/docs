...
| ------------------- | --------------- | -------- | ------- | --------------------------------------------------------- |
| `token_expiry_secs` | `int`           | no       | `900`   | Seconds until tokens expire (default: 15 minutes)         |
| `secret_key`        | `Optional[str]` | no       | `None`  | Secret key for signing tokens (generated if not provided) |
