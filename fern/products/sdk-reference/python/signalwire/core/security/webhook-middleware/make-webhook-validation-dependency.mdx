...
slug: "/sdk-reference/python/signalwire/core/security/webhook-middleware/make-webhook-validation-dependency"
...
<ParamField path="trust_proxy" type="bool" default="False"></ParamField>
