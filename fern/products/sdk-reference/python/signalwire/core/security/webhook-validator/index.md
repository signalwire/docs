...
- [`validate_request`](/reference/python/signalwire/core/security/webhook-validator/validate-request) — Legacy `@signalwire/compatibility-api` drop-in entry point.
- [`validate_webhook_signature`](/reference/python/signalwire/core/security/webhook-validator/validate-webhook-signature) — Validate a SignalWire webhook signature against both schemes.
