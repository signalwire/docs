...
| ----------------------- | ----------------------- | -------- | ------- | ----------- |
| `MAX_REQUEST_BODY_SIZE` | `MAX_REQUEST_BODY_SIZE` | yes      | —       | —           |

## Classes

- [`WebMixin`](/reference/python/signalwire/core/mixins/web-mixin/web-mixin) — Mixin class containing all web server and routing-related methods for AgentBase
