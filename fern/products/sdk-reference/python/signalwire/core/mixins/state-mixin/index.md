---
slug: "/reference/python/signalwire/core/mixins/state-mixin"
title: "state_mixin"
...
- [`StateMixin`](/reference/python/signalwire/core/mixins/state-mixin/state-mixin) — Mixin class containing all state and session management methods for AgentBase
