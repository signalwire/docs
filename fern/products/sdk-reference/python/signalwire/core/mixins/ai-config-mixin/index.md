...
- [`AIConfigMixin`](/reference/python/signalwire/core/mixins/ai-config-mixin/ai-config-mixin) — Mixin class containing all AI configuration methods for AgentBase
