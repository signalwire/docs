...
| ------------------ | --------------------------------- | -------- | ------- | ---------------------------------------------------------------------------------------------------------------------------------------------- |
| `internal_fillers` | `Dict[str, Dict[str, List[str]]]` | yes      | —       | Dictionary mapping function names to language-specific filler phrases. Format: {"function\_name": {"language\_code": \["phrase1", "phrase2"]}} |
