...
slug: "/sdk-reference/python/signalwire/core/mixins/ai-config-mixin/ai-config-mixin/set-internal-fillers"
...
<ParamField path="internal_fillers" type="Dict[str, Dict[str, List[str]]]" required></ParamField>
