...
| -------- | ---------------- | -------- | ------- | ---------------------------------------------------------------------- |
| `code`   | `str`            | yes      | —       | Language code as previously passed to `add_language` (e.g. `"en-US"`). |
| `params` | `Dict[str, Any]` | yes      | —       | Engine-specific params dict to attach. Empty dict removes the key.     |
