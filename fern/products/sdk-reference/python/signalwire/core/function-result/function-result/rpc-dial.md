...
| ------------- | ----- | -------- | --------- | ------------------------------------------------- |
| `to_number`   | `str` | yes      | —         | Phone number to dial (E.164 format)               |
| `from_number` | `str` | yes      | —         | Caller ID to use (E.164 format)                   |
| `dest_swml`   | `str` | yes      | —         | URL to the SWML that handles the outbound call    |
| `device_type` | `str` | no       | `'phone'` | Device type, typically "phone" (default: "phone") |
