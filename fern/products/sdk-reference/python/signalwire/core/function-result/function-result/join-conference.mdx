...
slug: "/sdk-reference/python/signalwire/core/function-result/function-result/join-conference"
...
<ParamField path="beep" type="str" default="'true'"></ParamField>
<ParamField path="start_on_enter" type="bool" default="True"></ParamField>
<ParamField path="end_on_exit" type="bool" default="False"></ParamField>
<ParamField path="wait_url" type="Optional[str]" default="None"></ParamField>
<ParamField path="max_participants" type="int" default="250"></ParamField>
<ParamField path="record" type="str" default="'do-not-record'"></ParamField>
<ParamField path="region" type="Optional[str]" default="None"></ParamField>
<ParamField path="trim" type="str" default="'trim-silence'"></ParamField>
...
<ParamField path="status_callback_method" type="str" default="'POST'"></ParamField>
<ParamField path="recording_status_callback" type="Optional[str]" default="None"></ParamField>
<ParamField path="recording_status_callback_method" type="str" default="'POST'"></ParamField>
<ParamField path="recording_status_callback_event" type="str" default="'completed'"></ParamField>
<ParamField path="result" type="Optional[Any]" default="None"></ParamField>
