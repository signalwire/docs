...
<CardGroup cols={2}>
  <Card title="__init__" href="/reference/python/signalwire/core/contexts/context-builder/init" />

  <Card title="add_context" href="/reference/python/signalwire/core/contexts/context-builder/add-context">
    Add a new context
  </Card>

  <Card title="get_context" href="/reference/python/signalwire/core/contexts/context-builder/get-context">
    Get an existing context by name for inspection or modification.
  </Card>

  <Card title="reset" href="/reference/python/signalwire/core/contexts/context-builder/reset">
    Remove all contexts, returning the builder to its initial state.
  </Card>

  <Card title="to_dict" href="/reference/python/signalwire/core/contexts/context-builder/to-dict">
    Convert all contexts to dictionary for SWML generation
  </Card>

  <Card title="validate" href="/reference/python/signalwire/core/contexts/context-builder/validate">
