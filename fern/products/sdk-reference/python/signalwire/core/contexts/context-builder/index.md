...
- [`__init__`](/reference/python/signalwire/core/contexts/context-builder/init)
- [`add_context`](/reference/python/signalwire/core/contexts/context-builder/add-context) — Add a new context
- [`get_context`](/reference/python/signalwire/core/contexts/context-builder/get-context) — Get an existing context by name for inspection or modification.
- [`reset`](/reference/python/signalwire/core/contexts/context-builder/reset) — Remove all contexts, returning the builder to its initial state.
- [`to_dict`](/reference/python/signalwire/core/contexts/context-builder/to-dict) — Convert all contexts to dictionary for SWML generation
- [`validate`](/reference/python/signalwire/core/contexts/context-builder/validate) — Validate the contexts configuration
