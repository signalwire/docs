...
- [`render_function_response_swml`](/reference/python/signalwire/core/swml-renderer/swml-renderer/render-function-response-swml) — Generate a SWML document for a function response
- [`render_swml`](/reference/python/signalwire/core/swml-renderer/swml-renderer/render-swml) — Generate a complete SWML document with AI configuration
