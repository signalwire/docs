...
- [`ConciergeAgent`](/reference/python/signalwire/prefabs/concierge/concierge-agent) — A prefab agent designed to act as a virtual concierge, providing information and services to users.
