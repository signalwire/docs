...
- [`__init__`](/reference/python/signalwire/prefabs/receptionist/receptionist-agent/init) — Initialize a receptionist agent
- [`on_summary`](/reference/python/signalwire/prefabs/receptionist/receptionist-agent/on-summary) — Process the conversation summary
