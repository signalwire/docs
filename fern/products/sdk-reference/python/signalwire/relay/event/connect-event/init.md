---
slug: "/reference/python/signalwire/relay/event/connect-event/init"
title: "__init__"
...
lustri:
  ...
  kind: "method"
  language: "python"
  qualified_name: "signalwire.relay.event.ConnectEvent.__init__"
...
| `connect_state` | `str`            | no       | `''`              | —           |
| `peer`          | `dict[str, Any]` | no       | `[object Object]` | —           |
