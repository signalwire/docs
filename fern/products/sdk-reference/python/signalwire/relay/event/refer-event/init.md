---
slug: "/reference/python/signalwire/relay/event/refer-event/init"
title: "__init__"
...
lustri:
  ...
  kind: "method"
  language: "python"
  qualified_name: "signalwire.relay.event.ReferEvent.__init__"
...
| `state`                    | `str`            | no       | `''`    | —           |
| `sip_refer_to`             | `str`            | no       | `''`    | —           |
| `sip_refer_response_code`  | `str`            | no       | `''`    | —           |
| `sip_notify_response_code` | `str`            | no       | `''`    | —           |
