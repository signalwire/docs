...
slug: "/sdk-reference/python/signalwire/relay/client"
...
<CardGroup cols={2}>
  <Card title="RelayClient" href="/sdk-reference/python/signalwire/relay/client/relay-client">
    Manages a WebSocket connection to SignalWire RELAY.
  </Card>
  <Card title="RelayError" href="/sdk-reference/python/signalwire/relay/client/relay-error">
