...
<CardGroup cols={2}>
  <Card title="RelayClient" href="/docs/sdk-reference/reference/python/relay/client/relay-client">
    Manages a WebSocket connection to SignalWire RELAY.
  </Card>

  <Card title="RelayError" href="/docs/sdk-reference/reference/python/relay/client/relay-error">
