...
In the **New SWML Application** form, enter a name, set **Handle Calls Using** to **External URL**, put the public application URL in **Primary Script URL**, and create the Resource.
