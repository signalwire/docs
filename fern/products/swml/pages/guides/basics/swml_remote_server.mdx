---
id: 4694ab58-dc99-4c45-bb98-f218cf69daf9
slug: /guides/remote-server
title: Handle incoming calls from code
description: Learn how to handle incoming calls from a remote server using SWML.
---

In the [Quickstart](swml/guides) guide, we learned how to use SWML Scripts in the Dashboard to handle incoming calls serverlessly.
...
<Frame>
  ![SWML external URL.](/assets/images/dashboard/resources/external-swml-script.webp)
</Frame>
...
You can [`execute`](swml/reference/execute) or [`transfer`](swml/reference/transfer) the control flow out of one SWML to another. In such case, in addition to the `Call` object,
