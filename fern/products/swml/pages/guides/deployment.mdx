...
<Callout type="info" title="For complete information about variables, the Call Object, and all variable scopes, see the [**Variables and Expressions**](/swml/variables) reference.">

</Callout>

## From a web server

<Callout type="tip" title="This use case is described in detail in the [Handling Incoming Calls from Code](/swml/guides/remote_server) guide.">
