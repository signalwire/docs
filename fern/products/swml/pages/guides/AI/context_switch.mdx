...
<Callout type="warning" title="Providing too much information in the initial prompt can cause the AI agent to get confused">
...
<Callout type="warning" title="It's important to remember the boundaries of the AI agent that you have set in the initial prompt, and in the new context.">
