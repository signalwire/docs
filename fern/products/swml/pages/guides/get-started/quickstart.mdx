---
id: d6565266-8eef-4539-a1c1-3772fbdbd7d3
title: Quickstart
...
![The redesigned main menu.](/assets/images/dashboard/home/new-dashboard-tall.webp)

</llms-ignore>

<llms-only>

The new Dashboard has a unified **My Resources** entry in its left sidebar.
...
![The legacy main menu.](/assets/images/dashboard/legacy/sidebar.webp)

</llms-ignore>

<llms-only>

The legacy Dashboard has no **My Resources** entry; resource types such as **Relay/SWML**, **SIP**, and **cXML/LaML** appear separately in its left sidebar.
...
Now that you've deployed your first SWML script, explore these resources:
  ...
  <Cards>
    ...
    <Card title="Server SDK quickstart" href="/docs/server-sdks/guides/quickstart">
