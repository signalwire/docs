...
[Expressions](/docs/swml/reference/ai/swaig/functions/data-map#data_mapexpressions)
...
Multiple expressions can be stated inside the [`data_map.expressions`](/docs/swml/reference/ai/swaig/functions/data-map#data_mapexpressions) field.
...
[Webhooks](/docs/swml/reference/ai/swaig/functions/data-map#data_mapwebhooks)
...
[Outputs](/docs/swml/reference/ai/swaig/functions/data-map#data_mapoutput) define the responses and actions that should be taken when an expression matches or a webhook request completes.
...
[Actions](/docs/swml/reference/ai/swaig/functions/data-map#outputaction) in `data_map` define what should happen when the `swaig.function` executes and
