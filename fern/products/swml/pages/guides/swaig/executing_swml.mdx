---
id: abf5f549-da83-4d9f-b459-ebd14637441a
title: Execute SWML from a function
slug: /guides/executing-swml
...
In the [`ai.params`](/swml/reference/ai/params), you will need to set the parameter `swaig_allow_swml` to `true`, to allow SWML execution:
...
[`send_sms`](/swml/reference/send-sms) method 
and then connect the call to the destination number using the 
[`connect`](/swml/reference/connect) method.
