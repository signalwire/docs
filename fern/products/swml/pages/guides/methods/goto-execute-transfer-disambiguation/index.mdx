...
<Callout type="warning" title="you can not jump to sections using goto.">
...
<Callout type="info" title="Notice how we aren't going back to the calling section at all.">
