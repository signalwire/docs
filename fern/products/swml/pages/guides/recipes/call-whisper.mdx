...
<Note>
Looking for a supervisor who whispers to an agent during a live call? That is conference coaching, covered in [Supervisor call monitoring](/docs/platform/voice/supervisor-call-monitoring).
</Note>
