...
Outbound calls can be made via the SignalWire REST API's [Create a Call endpoint](/apis/calling/calls/call-commands).
...
[make and receive calls in Node.js](/server-sdk/node/guides/get-started-with-voice).
