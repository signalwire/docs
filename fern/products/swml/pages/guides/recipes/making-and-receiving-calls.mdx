...
<Markdown src="/docs/snippets/common/dashboard/create-swml-script.mdx" />
...
Outbound calls can be made via the SignalWire REST API's [Create a Call endpoint](/docs/apis/calling/calls/call-commands).
