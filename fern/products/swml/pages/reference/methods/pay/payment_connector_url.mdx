...
<ParamField toc={true} path="pay.payment_connector_url" type="string">
...
<ParamField toc={true} path="transaction_id" type="string">
  The unique identifier for the transaction.
</ParamField>


<ParamField toc={true} path="method" type="string">
  The payment method.
</ParamField>


<ParamField toc={true} path="cardnumber" type="string">
  The card number.
</ParamField>


<ParamField toc={true} path="cvv" type="string">
  The CVV.
</ParamField>


<ParamField toc={true} path="postal_code" type="string">
  The postal code.
</ParamField>


<ParamField toc={true} path="description" type="string">
  The description.
</ParamField>


<ParamField toc={true} path="chargeAmount" type="string">
  The charge amount.
</ParamField>


<ParamField toc={true} path="token_type" type="string">
  The token type.
</ParamField>


<ParamField toc={true} path="expiry_month" type="string">
  The expiry month.
</ParamField>


<ParamField toc={true} path="expiry_year" type="string">
  The expiry year.
</ParamField>


<ParamField toc={true} path="currency_code" type="string">
  The currency code.
</ParamField>
...
<ParamField toc={true} path="charge_id" type="string">
  A unique identifier for the successful transaction.
</ParamField>


<ParamField toc={true} path="error_code" type="null">
  Must be null for successful transactions.
</ParamField>


<ParamField toc={true} path="error_message" type="null">
  Must be null for successful transactions.
</ParamField>
...
<ParamField toc={true} path="token_id" type="string">
...
<ParamField toc={true} path="charge_id" type="null">
  Must be null for failed transactions.
</ParamField>


<ParamField toc={true} path="error_code" type="string">
  An error code identifying the type of failure.
</ParamField>


<ParamField toc={true} path="error_message" type="string">
...
<ParamField toc={true} path="token_id" type="null">
  Must be null for failed transactions.
</ParamField>
