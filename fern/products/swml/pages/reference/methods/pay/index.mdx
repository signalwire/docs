...
<ParamField toc={true} path="pay" type="object" required={true}>
...
<ParamField toc={true} path="pay.payment_connector_url" type="string" required={true}>
...
<ParamField toc={true} path="pay.timeout" type="integer" default="5">
...
<ParamField toc={true} path="pay.token_type" type="string" default="reusable">
  Whether the payment is a one off payment or re-occurring.
</ParamField>

**Allowed values:** `one-time`, `reusable`.

<ParamField toc={true} path="pay.valid_card_types" type="string" default="visa mastercard amex">
...
<ParamField toc={true} path="pay.voice" type="string" default="woman">
