...
[supported-languages-voice]: /platform/voice/tts
...
When the payment process completes, the following [variables](/swml/reference/variables) are set in the `vars` scope.
