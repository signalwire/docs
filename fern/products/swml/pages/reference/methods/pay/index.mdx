...
<Callout type="note" title="The token is provided and stored by your payment processor and can be used for future transactions without requiring customers">
