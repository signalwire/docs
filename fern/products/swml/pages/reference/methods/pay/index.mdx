...
<APIField
  name="pay.min_postal_code_length"
  type="integer"
  default="0"
>
...
<APIField
  name="pay.valid_card_types"
  type="string"
  default="visa mastercard amex"
>
  List of payment cards allowed to use in the requested payment process, separated by a space.<br/>**Allowed values:** `visa`, `mastercard`, `amex`, `maestro`, `discover`, `jcb`, `diners-club`.
