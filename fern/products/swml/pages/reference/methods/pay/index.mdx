...
**pay.payment_connector_url** (type: string) *required*
...
**pay.timeout** (type: integer) Default: `5`
...
**pay.token_type** (type: string) Default: `reusable`
  Whether the payment is a one off payment or re-occurring.
**Allowed values:** `one-time`, `reusable`.

**pay.valid_card_types** (type: string) Default: `visa mastercard amex`
...
**pay.voice** (type: string) Default: `woman`
...
**pay_payment_results** (type: object)
...
**payment_confirmation_code** (type: string)
...
**payment_card_expiration_date** (type: string)
  Card expiration date

**payment_card_security_code** (type: string)
  Redacted security code

**payment_card_postal_code** (type: string)
  Postal code used

**payment_error** (type: string)
  Error description if payment failed

**payment_error_code** (type: string)
  Error code if payment failed

**connector_error** (type: object)
  Connector-specific error object

**connector_error.code** (type: string)
  Connector-specific error code

**connector_error.message** (type: string)
