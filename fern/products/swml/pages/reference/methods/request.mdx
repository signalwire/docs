...
<ParamField toc={true} path="request" type="object" required={true}>
...
<ParamField toc={true} path="request.url" type="string" required={true}>
  URL to send the HTTPS request to. Authentication can also be set in the url in the format of `username:password@url`.
</ParamField>


<ParamField toc={true} path="request.method" type="string" required={true}>
  Request type. `GET`\|`POST`\|`PUT`\|`DELETE`
</ParamField>


<ParamField toc={true} path="request.headers" type="object">
...
<ParamField toc={true} path="request.body" type="string | object">
...
<ParamField toc={true} path="request.connect_timeout" type="number" default="0">
  Maximum time in seconds to wait for a connection. Default is `0` (no timeout).
</ParamField>


<ParamField toc={true} path="request.timeout" type="number" default="0">
  Maximum time in seconds to wait for a response. Default is `0` (no timeout).
</ParamField>


<ParamField toc={true} path="request.save_variables" type="boolean" default="false">
