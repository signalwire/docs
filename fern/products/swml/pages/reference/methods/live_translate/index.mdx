...
<ParamField path="start.from_lang" type="string" required={true}>
  ...
  See [supported voices & languages](/voice/getting-started/voice-and-languages).
</ParamField>
...
**Live call:** Actions sent to active calls via the [Call Commands REST API](/rest/signalwire-rest/endpoints/calling/call-commands) or SWML sections executed via [`transfer`](/swml/methods/transfer) or [`execute`](/swml/methods/execute) during a call.
