...
To stop call recordings started with `record_call`, use the [`stop_record_call`](/docs/swml/reference/calling/stop-record-call) method.
...
<ParamField path="params.pause_behavior" type="string" toc={true}>
