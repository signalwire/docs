...
<ParamField path="record.url" type="string" toc={true}>
  URL to download the recording.
</ParamField>


<ParamField path="record.duration" type="number" toc={true}>
  Recording duration in seconds.
</ParamField>


<ParamField path="record.size" type="number" toc={true}>
  Recording file size in bytes.
</ParamField>


<ParamField path="record.format" type="string" toc={true}>
