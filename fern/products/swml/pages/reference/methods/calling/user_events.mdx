...
slug: /reference/calling/user-event
title: user_event
...
<ParamField path="user_event" type="object" required={true} toc={true}>
...
<ParamField path="user_event.event" type="any" required={true} toc={true}>
