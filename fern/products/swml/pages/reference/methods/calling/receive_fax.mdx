...
title: receive_fax
slug: /reference/calling/receive-fax
...
Refer to the [`execute`](/docs/swml/reference/calling/execute) statement's documentation for more details on this behavior.
