...
<ParamField path="params.enable_turn_detection" type="boolean" default="true" toc={true}>
...
<ParamField path="params.turn_detection_timeout" type="integer" default="250" toc={true}>
