...
<Info> If a different STT model was selected using the [`openai_asr_engine` parameter](/docs/swml/reference/ai/params#paramsopenai_asr_engine), you must select a code supported by that engine.</Info>
</ParamField>
