...
<ParamField path="ai.prompt" type="object" toc={true}>
...
<ParamField path="prompt.temperature" type="number" default="1.0" toc={true}>
  Randomness setting. Float value between 0.0 and 1.5. Closer to 0 will make the output less random.
</ParamField>

<ParamField path="prompt.top_p" type="number" default="1.0" toc={true}>
...
<ParamField path="prompt.confidence" type="number" default="0.6" toc={true}>
...
<ParamField path="prompt.presence_penalty" type="number" default="0" toc={true}>
...
<ParamField path="prompt.frequency_penalty" type="number" default="0" toc={true}>
...
<ParamField path="prompt.max_tokens" type="integer" default="256" toc={true}>
...
<ParamField path="prompt.contexts" type="object" toc={true}>
...
<ParamField path="contexts.default" type="object" required={true} toc={true}>
  The default context used at the beginning of the conversation.
</ParamField>

<ParamField path="contexts.*" type="object" toc={true}>
  Additional contexts for specialized conversation flows. The key is user-defined (e.g., `support`, `sales`, `billing`).
</ParamField>

<Indent>

<ParamField path="*.steps" type="object[]" required={true} toc={true}>
...
<ParamField path="*.isolated" type="boolean" default="false" toc={true}>
...
<ParamField path="enter_fillers.*" type="string[]" toc={true}>
  An array of filler phrases for one language code. See [filler language codes](/docs/swml/reference/calling/ai/swaig#filler-language-codes) for the codes in common use. Two keys are not language codes: `auto` has the phrases translated into whichever language is being spoken, and `default` covers every language you have not listed.
</ParamField>

</Indent>

<ParamField path="*.exit_fillers" type="object" toc={true}>
  Filler phrases played when leaving this context. Same format as `enter_fillers`.
</ParamField>
          ...
          contexts:
            ...
            support:
              ...
              enter_fillers:
                ...
                es: ["Cambiando a soporte técnico", "Permítame conectarlo con soporte"]
              exit_fillers:
                en-US: ["Leaving support mode", "Returning to main menu"]
                es: ["Saliendo del modo de soporte", "Volviendo al menú principal"]
              steps:
                - name: troubleshoot
...
<ParamField path="${call_direction}" type="string" toc={true}>
  Inbound or outbound.
</ParamField>
...
<ParamField path="${spoken_date}" type="string" toc={true}>
  The spoken date.
</ParamField>
...
<ParamField path="${time_of_day}" type="string" toc={true}>
  The time of day.
</ParamField>


<ParamField path="${supported_languages}" type="string" toc={true}>
  A list of supported languages.
</ParamField>


<ParamField path="${default_language}" type="string" toc={true}>
