...
slug: /reference/calling/ai/swaig/functions/data-map
title: data_map
description: Defines how a SWAIG function should process and respond to the user's input data.
max-toc-depth: 3
---

`functions[].data_map` defines how a [`SWAIG function`](/docs/swml/reference/calling/ai/swaig/functions) should process and respond to the user's input data.
...
<ParamField path="webhooks[].input_args_as_params" type="boolean" default="false" toc={true}>
  A boolean to determine if the input [parameters](/docs/swml/reference/calling/ai/swaig/functions/parameters) should be passed as parameters.
</ParamField>

<ParamField path="webhooks[].required_args" type="string | string[]" toc={true}>
  A string or array of strings that represent the [parameters](/docs/swml/reference/calling/ai/swaig/functions/parameters) that are required to make the webhook request.
</ParamField>
...
<ParamField path="args.*" type="any" toc={true}>
  Individual argument value. The key matches an argument name from the function's [`parameters`](/docs/swml/reference/calling/ai/swaig/functions/parameters) schema.
</ParamField>
