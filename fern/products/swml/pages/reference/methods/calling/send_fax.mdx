---
id: 5642bba0-2854-46ab-8567-71aba5090774
slug: /reference/calling/send-fax
title: send_fax
...
<ParamField path="send_fax" type="object" required={true} toc={true}>
  An object that accepts the following properties.
</ParamField>

<Indent>

<ParamField path="send_fax.document" type="string" required={true} toc={true}>
  URL to the PDF document to fax
</ParamField>


<ParamField path="send_fax.header_info" type="string" toc={true}>
  Text to add to the fax header
</ParamField>


<ParamField path="send_fax.identity" type="string" default="Calling party's caller ID number" toc={true}>
  Station identity to report
</ParamField>


<ParamField path="send_fax.status_url" type="string" toc={true}>
