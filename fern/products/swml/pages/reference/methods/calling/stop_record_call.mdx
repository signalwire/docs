...
slug: /reference/calling/stop-record-call
...
<ParamField path="stop_record_call" type="object" required={true} toc={true}>
...
<ParamField path="stop_record_call.control_id" type="string" default="The last started recording will be stopped" toc={true}>
