...
<CardGroup cols={2}>
  ...
  <Card title="ai_sidecar" href="/docs/swml/reference/calling/ai-sidecar">
    Attach a real-time AI observer that coaches a human agent without speaking on the call.
  </Card>
</CardGroup>
