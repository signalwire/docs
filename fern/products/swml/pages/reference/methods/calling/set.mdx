...
using [`unset`](/docs/swml/reference/calling/unset).

<ParamField path="set" type="object" required={true} toc={true}>
...
- **[unset](/docs/swml/reference/calling/unset)**: Remove variables from the script
