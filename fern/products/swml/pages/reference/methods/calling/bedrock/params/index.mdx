---
id: da1dbe72-ad4f-4f79-b50a-66f4b131295b
unlisted: false
hide_title: false
title: params
slug: /reference/calling/amazon-bedrock/params
...
<ParamField path="params.attention_timeout" type="integer" default="5000 ms" toc={true}>
  Amount of time, in ms, to wait before prompting the user to respond. Allowed values: `0` (to disable) or `10,000`-`600,000`.
</ParamField>


<ParamField path="params.inactivity_timeout" type="integer" default="600000 ms" toc={true}>
