...
slug: /reference/calling/amazon-bedrock/swaig/functions/data-map
title: data_map
description: Defines how a SWAIG function should process and respond to the user's input data.
max-toc-depth: 3
---

`functions[].data_map` defines how a [`SWAIG function`](/docs/swml/reference/calling/amazon-bedrock/swaig/functions) should process and respond to the user's input data.
...
<ParamField path="data_map.expressions" type="object[]" toc={true}>
...
<ParamField path="expressions[].string" type="string" required={true} toc={true}>
  The actual input or value from the user or system.
</ParamField>

<ParamField path="expressions[].pattern" type="string" required={true} toc={true}>
  A regular expression pattern to validate or match the string.
</ParamField>

<ParamField path="expressions[].output" type="object" required={true} toc={true}>
...
<ParamField path="data_map.webhooks" type="object[]" toc={true}>
...
<ParamField path="webhooks[].url" type="string" required={true} toc={true}>
...
<ParamField path="webhooks[].method" type="string" required={true} toc={true}>
  The HTTP method (GET, POST, etc.) for the API call.
</ParamField>

<ParamField path="webhooks[].headers" type="object" toc={true}>
  Any necessary headers for the API call.
</ParamField>

<ParamField path="webhooks[].params" type="object" toc={true}>
...
<ParamField path="webhooks[].input_args_as_params" type="boolean" default="false" toc={true}>
  A boolean to determine if the input [parameters](/docs/swml/reference/calling/amazon-bedrock/swaig/functions/parameters) should be passed as parameters.
</ParamField>

<ParamField path="webhooks[].required_args" type="string | string[]" toc={true}>
  A string or array of strings that represent the [parameters](/docs/swml/reference/calling/amazon-bedrock/swaig/functions/parameters) that are required to make the webhook request.
</ParamField>

<ParamField path="webhooks[].error_keys" type="string | string[]" toc={true}>
  A string or array of strings that represent the keys to be used for error handling.
</ParamField>

<ParamField path="webhooks[].expressions" type="object" toc={true}>
  A list of expressions to be evaluated upon matching.
  See [`expressions`](#expressions) for details.
</ParamField>

<ParamField path="webhooks[].foreach" type="object" toc={true}>
...
<ParamField path="foreach.input_key" type="string" required={true} toc={true}>
  The key to be used to access the current element in the array.
</ParamField>

<ParamField path="foreach.output_key" type="string" required={true} toc={true}>
...
<ParamField path="foreach.append" type="string" required={true} toc={true}>
...
<ParamField path="foreach.max" type="number" toc={true}>
  The max amount of elements that are iterated over in the array. This will start at the beginning of the array.
</ParamField>

</Indent>

<ParamField path="webhooks[].output" type="object" required={true} toc={true}>
...
<ParamField path="data_map.output" type="object" toc={true}>
...
<ParamField path="output.response" type="string" required={true} toc={true}>
  Static text that will be added to the AI agent's context.
</ParamField>

<ParamField path="output.action" type="object[]" toc={true}>
...
<ParamField path="args" type="object" toc={true}>
  Function argument values extracted by the AI, keyed by argument name.
</ParamField>

<Indent>

<ParamField path="args.*" type="any" toc={true}>
  Individual argument value. The key matches an argument name from the function's [`parameters`](/docs/swml/reference/calling/amazon-bedrock/swaig/functions/parameters) schema.
</ParamField>
...
<ParamField path="global_data.*" type="any" toc={true}>
...
<ParamField path="meta_data.*" type="any" toc={true}>
  User-defined property.
</ParamField>
