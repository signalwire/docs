...
Functions can trigger various behaviors: speaking text, sending SMS, playing audio, transferring calls, and more. See the [actions documentation](/docs/swml/reference/calling/amazon-bedrock/swaig/functions#list-of-valid-actions) for all available options.
</Tip>
