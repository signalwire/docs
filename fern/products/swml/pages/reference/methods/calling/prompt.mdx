...
The [`play` method](/docs/swml/reference/calling/play) also has examples related to playing sounds from URLs. The
...
more details on this behavior, refer to [`transfer`](/docs/swml/reference/calling/transfer)
