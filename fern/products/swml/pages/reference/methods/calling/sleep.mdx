...
<ParamField path="sleep" type="object | integer" required={true} toc={true}>
...
<ParamField path="sleep.duration" type="integer" required={true} toc={true}>
