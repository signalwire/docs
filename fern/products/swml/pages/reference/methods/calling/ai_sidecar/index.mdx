...
| `history_pruned` | The conversation history was trimmed to fit the token budget | `dropped_count`, `tokens_before`, `tokens_after` |
...
| `ask_answer` | The answer to an `ai_sidecar.ask` | `raw`, `ask_id`, `triggered_by` |
