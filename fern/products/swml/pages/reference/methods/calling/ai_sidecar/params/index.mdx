...
hide_title: false
title: params
slug: /reference/calling/ai_sidecar/params
description: Tuning knobs for the ai_sidecar method that control how it reacts, summarization, transcription, and debugging.
max-toc-depth: 3
---

Tuning options that can be passed in `ai_sidecar.params` of the [`ai_sidecar` method](/docs/swml/reference/calling/ai_sidecar).
