...
hide_title: false
slug: /reference/calling/ai_sidecar/swaig
title: SWAIG
...
<Warning>
The function name `sidecar_skip` is reserved. It is auto-registered as a built-in tool — do not declare a function with that name. See [Built-in `sidecar_skip` tool](/docs/swml/reference/calling/ai_sidecar#built-in-sidecar_skip-tool).
</Warning>
