...
title: request
slug: /reference/calling/request
...
<ParamField path="request.method" type="string" required={true} toc={true}>
...
<ParamField path="request.connect_timeout" type="number" default="0" toc={true}>
  Maximum time in seconds to wait for a connection. Default is `0` (no timeout).
</ParamField>


<ParamField path="request.timeout" type="number" default="0" toc={true}>
