...
<ParamField path="cond" type="object[]" required={true} toc={true}>
...
<ParamField path="cond[].when" type="string" required={true} toc={true}>
  The JavaScript condition to act on
</ParamField>


<ParamField path="cond[].then" type="object[]" required={true} toc={true}>
...
<ParamField path="cond[].else" type="object[]" toc={true}>
