...
title: send_sms
slug: /reference/calling/send-sms
...
<ParamField path="send_sms" type="object" required={true} toc={true}>
...
<ParamField path="send_sms.to_number" type="string" required={true} toc={true}>
  Phone number to send SMS message to in e.164 format
</ParamField>


<ParamField path="send_sms.from_number" type="string" required={true} toc={true}>
  Phone number SMS message will be sent from
</ParamField>


<ParamField path="send_sms.body" type="string" required={true} toc={true}>
  Body of the text message
</ParamField>


<ParamField path="send_sms.region" type="string" default="Chosen based on account preferences or device location" toc={true}>
  Region of the world to originate the message from
</ParamField>


<ParamField path="send_sms.tags" type="string[]" toc={true}>
...
<ParamField path="send_sms.media" type="string[]" required={true} toc={true}>
  Array of media URLs to include in the message
</ParamField>


<ParamField path="send_sms.body" type="string" toc={true}>
