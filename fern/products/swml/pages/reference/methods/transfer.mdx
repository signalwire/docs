...
The `params` object is passed, along with the variables and the [`Call`](/swml/reference/variables#variables-list) object.
...
The `call` object is described in detail in the [introduction](/swml/reference/variables#variables-list).
