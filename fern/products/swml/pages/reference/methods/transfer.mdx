...
<ParamField toc={true} path="transfer" type="object" required={true}>
...
<ParamField toc={true} path="transfer.dest" type="string" required={true}>
...
<ParamField toc={true} path="transfer.params" type="object">
  Named parameters to send to a section, URL, or application.
</ParamField>


<ParamField toc={true} path="transfer.meta" type="object">
...
The `params` object is passed, along with the variables and the [`Call`](/swml/variables#variables-list) object.
...
The `call` object is described in detail in the [introduction](/swml/variables#variables-list). 
