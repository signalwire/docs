...
<ParamField toc={true} path="prompt" type="object" required={true}>
...
<ParamField toc={true} path="prompt.play" type="string | string[]" required={true}>
  Either a [playable sound](#playable-sounds) or an array of [playable sounds](#playable-sounds)
</ParamField>


<ParamField toc={true} path="prompt.volume" type="number" default="0">
  Volume gain to apply to played URLs. Allowed values from `-40.0` to `40.0`.
</ParamField>


<ParamField toc={true} path="prompt.say_voice" type="string" default="Polly.Salli">
  Voice to use with `say:` for text to speech
</ParamField>


<ParamField toc={true} path="prompt.say_language" type="string" default="en-US">
  Language to use with `say:` for text to speech
</ParamField>


<ParamField toc={true} path="prompt.say_gender" type="string" default="female">
  Gender to use with `say:` for text to speech
</ParamField>


<ParamField toc={true} path="prompt.max_digits" type="integer" default="1">
  Number of digits to collect
</ParamField>


<ParamField toc={true} path="prompt.terminators" type="string">
  Digits that terminate digit collection
</ParamField>


<ParamField toc={true} path="prompt.digit_timeout" type="number" default="5.0 seconds">
  Time in seconds to wait for next digit
</ParamField>


<ParamField toc={true} path="prompt.initial_timeout" type="number" default="5.0 seconds">
  Time in seconds to wait for start of input
</ParamField>


<ParamField toc={true} path="prompt.speech_timeout" type="number">
  Max time in seconds to wait for speech result
</ParamField>


<ParamField toc={true} path="prompt.speech_end_timeout" type="number">
  Time in seconds to wait for end of speech utterance
</ParamField>


<ParamField toc={true} path="prompt.speech_language" type="string">
  Language to detect speech in
</ParamField>


<ParamField toc={true} path="prompt.speech_hints" type="string[]">
  Expected words to match
</ParamField>


<ParamField toc={true} path="prompt.speech_engine" type="string">
...
<ParamField toc={true} path="prompt.status_url" type="string">
...
<ParamField path="params.result.type" type="string">
  The type of input collected. **Valid values:** `digit`, `speech`, `no_input`, `error`.
</ParamField>


<ParamField path="params.result.params.digits" type="string">
  The DTMF digits collected (when `type` is `digit`).
</ParamField>


<ParamField path="params.result.params.terminator" type="string">
  The terminator digit that ended collection (when `type` is `digit`).
</ParamField>


<ParamField path="params.result.params.text" type="string">
  The recognized speech text (when `type` is `speech`).
</ParamField>


<ParamField path="params.result.params.confidence" type="number">
