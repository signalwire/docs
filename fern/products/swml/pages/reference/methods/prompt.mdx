...
The [`play` method](/swml/reference/play) also has examples related to playing sounds from URLs. The
...
more details on this behavior, refer to [`transfer`](/swml/reference/transfer)
