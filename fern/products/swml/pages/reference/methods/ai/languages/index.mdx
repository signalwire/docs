...
<ParamField toc={true} path="ai.languages" type="object[]">
  An array of objects that accept the following properties.
</ParamField>

## Properties

<ParamField toc={true} path="languages[].name" type="string" required={true}>
...
<ParamField toc={true} path="languages[].code" type="string" required={true}>
...
<Info> If a different STT model was selected using the [`openai_asr_engine` parameter](/swml/methods/ai/params), you must select a code supported by that engine.</Info>
</ParamField>

<ParamField toc={true} path="languages[].voice" type="string" required={true}>
...
<ParamField toc={true} path="languages[].emotion" type="string" default="None">
...
<ParamField toc={true} path="languages[].function_fillers" type="string[]" default="None">
...
<ParamField toc={true} path="languages[].model" type="string" default="None">
...
<ParamField toc={true} path="languages[].speech_fillers" type="string[]" default="None">
...
<ParamField toc={true} path="languages[].speed" type="string" default="None">
...
*Valid values:* `auto`
<Warning>Only works with [`Cartesia`](/voice/tts/cartesia) TTS engine.</Warning>
</ParamField>

<ParamField toc={true} path="languages[].params" type="object" default="None">
...
<ParamField toc={true} path="languages[].fillers" type="string[]" deprecated={true} default="None">
...
<ParamField toc={true} path="languages[].engine" type="string" deprecated={true} default="gcloud">
