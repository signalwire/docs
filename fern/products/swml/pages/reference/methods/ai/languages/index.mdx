...
[tts-providers]: /platform/voice/tts#providers
[voices-and-languages]: /platform/voice/tts
[swaig-functions]: /swml/reference/ai/swaig/functions
[deepgram-codes]: https://developers.deepgram.com/docs/models-languages-overview#nova-3
[ai-params]: /swml/reference/ai/params
...
<Info> If a different STT model was selected using the [`openai_asr_engine` parameter](/swml/reference/ai/params), you must select a code supported by that engine.</Info>
</ParamField>
...
*Valid values:* `auto`
<Warning>Only works with [`Cartesia`](/platform/voice/tts/cartesia) TTS engine.</Warning>
</ParamField>
