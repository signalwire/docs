...
[functions-fillers]: /swml/reference/ai/swaig/functions
[hold-music]: ./hold_music.mdx
[interrupt-prompt]: ./interrupt_prompt.mdx
[ai-languages]: /swml/reference/ai/languages
[ai-languages-params]: /swml/reference/ai/languages#properties
[ai-params]: ./index.mdx
[post-prompt-url]: /swml/reference/ai#post_prompt_url
[get-visual-input]: /swml/reference/ai/swaig#properties
...
Parameters for AI that can be passed in `ai.params` at the top level of the [`ai` method](swml/reference/ai).
