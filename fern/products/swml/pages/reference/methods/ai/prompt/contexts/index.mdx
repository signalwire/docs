---
id: 881f166c-7508-4d3e-a07f-39367227d698
...
<ParamField path="ai.prompt.contexts" type="object">
...
<ParamField path="contexts.{context_name}" type="object">
...
<ParamField path="{context_name}.isolated" type="boolean" default="false">
