...
**SWAIG.internal_fillers** (type: object)
...
**internal_fillers.get_ideal_strategy** (type: object)
...
**internal_fillers.{function_name}.{language_code}** (type: string[])
