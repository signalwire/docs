...
<ParamField toc={true} path="functions[].description" type="string" required={true}>
  A description of the context and purpose of the function, to explain to the agent when to use it.
</ParamField>


<ParamField toc={true} path="functions[].function" type="string" required={true}>
...
<ParamField toc={true} path="functions[].active" type="boolean" default="true">
  Whether the function is active.
</ParamField>


<ParamField toc={true} path="functions[].data_map" type="object">
  ...
  See [`data_map`](/swml/methods/ai/swaig/functions/data_map) for additional details.
</ParamField>
...
<ParamField toc={true} path="functions[].parameters" type="object">
  ...
  See [`parameters`](/swml/methods/ai/swaig/functions/parameters) for additional details.
</ParamField>
...
<ParamField toc={true} path="functions[].fillers" type="object">
  ...
  See [`fillers`](/swml/methods/ai/swaig/functions/fillers) for additional details.
</ParamField>


<ParamField toc={true} path="functions[].skip_fillers" type="boolean" default="false">
...
<ParamField toc={true} path="functions[].meta_data" type="object">
...
<ParamField toc={true} path="functions[].meta_data_token" type="string" default="Set by SignalWire">
  Scoping token for `meta_data`. If not supplied, metadata will be scoped to function's `web_hook_url`.
</ParamField>


<ParamField toc={true} path="functions[].wait_file" type="string">
...
<ParamField toc={true} path="functions[].wait_file_loops" type="string | integer">
  The amount of times that `wait_file` should continuously play/loop.
</ParamField>


<ParamField toc={true} path="functions[].wait_for_fillers" type="boolean" default="false">
  Whether to wait for fillers to finish playing before continuing with the function.
</ParamField>


<ParamField toc={true} path="functions[].web_hook_url" type="string">
  ...
  See [Callback Parameters](./functions.web_hook_url.mdx) for details on the request body.
</ParamField>


<ParamField toc={true} path="functions[].purpose" type="string" deprecated={true}>
  Deprecated. Use `description` instead.
</ParamField>


<ParamField toc={true} path="functions[].argument" type="object" deprecated={true}>
