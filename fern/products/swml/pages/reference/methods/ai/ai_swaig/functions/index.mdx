---
id: 4404df45-0dcf-4200-a473-a509377f8511
hide_title: false
slug: /reference/ai/swaig/functions
title: functions
...
[post-prompt]: /swml/reference/ai#post_prompt
...
<ParamField path="functions[].data_map" type="object">
  ...
  See [`data_map`](/swml/reference/ai/swaig/functions/data-map) for additional details.
</ParamField>
...
<ParamField path="functions[].parameters" type="object">
  ...
  See [`parameters`](/swml/reference/ai/swaig/functions/parameters) for additional details.
</ParamField>


<ParamField path="functions[].fillers" type="object">
  An object containing language-specific arrays of filler phrases that are played when calling a SWAIG function. These fillers help break silence between responses and are played asynchronously during the function call. Each key is a [language code](/swml/reference/ai/swaig#filler-language-codes) and each value is an array of filler phrases selected from randomly.
</ParamField>


<ParamField path="functions[].skip_fillers" type="boolean" default="false">
  Skips the top-level fillers specified in [`ai.languages`](/swml/reference/ai/languages) (which includes `speech_fillers` and `function_fillers`). When set to `true`, only function-specific fillers defined directly on [`SWAIG.functions.fillers`](/swml/reference/ai/swaig/functions) will play.
</ParamField>


<ParamField path="functions[].meta_data" type="object">
  A powerful and flexible environmental variable which can accept arbitrary data that is set initially in the SWML script or from the SWML [`set_meta_data` action](/swml/reference/ai/swaig/functions/data-map#actions). This data can be referenced **locally** to the function. All contained information can be accessed and expanded within the prompt - for example, by using a template string.
</ParamField>
...
<ParamField path="functions[].wait_file" type="string">
...
<ParamField path="functions[].wait_file_loops" type="string | integer">
  The amount of times that `wait_file` should continuously play/loop.
</ParamField>


<ParamField path="functions[].wait_for_fillers" type="boolean" default="false">
...
<ParamField path="functions[].purpose" type="string" deprecated={true}>
  Deprecated. Use `description` instead.
</ParamField>


<ParamField path="functions[].argument" type="object" deprecated={true}>
