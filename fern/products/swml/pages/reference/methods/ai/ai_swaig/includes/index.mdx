...
[swaig-functions]: /swml/methods/ai/swaig/functions#properties
[webhook-response]: /swml/methods/ai/swaig/functions#webhook-response
[webhook-request]: /swml/methods/ai/swaig/functions#callback-request-for-web_hook_url
...
Functions can trigger various behaviors: speaking text, sending SMS, playing audio, transferring calls, and more. See the [actions documentation](/swml/methods/ai/swaig/functions#list-of-valid-actions) for all available options.
</Tip>
