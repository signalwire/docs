...
[swaig-functions]: /swml/reference/ai/swaig/functions#properties
[webhook-response]: /swml/reference/ai/swaig/functions#webhook-response
[webhook-request]: /swml/reference/ai/swaig/functions#callback-request-for-web_hook_url
