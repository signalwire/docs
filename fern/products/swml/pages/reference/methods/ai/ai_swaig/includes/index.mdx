...
slug: /reference/ai/swaig/includes
...
[swaig-functions]: /docs/swml/reference/ai/swaig/functions#properties
[webhook-response]: /docs/swml/reference/ai/swaig/functions#webhook-response
[webhook-request]: /docs/swml/reference/ai/swaig/functions#callback-request-for-web_hook_url
...
<ParamField path="includes[].function" type="string[]" required={true} toc={true}>
...
Functions can trigger various behaviors: speaking text, sending SMS, playing audio, transferring calls, and more. See the [actions documentation](/docs/swml/reference/ai/swaig/functions#list-of-valid-actions) for all available options.
</Tip>
