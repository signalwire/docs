...
<ParamField toc={true} path="ai" type="object" required={true}>
...
<ParamField toc={true} path="ai.prompt" type="object" required={true}>
...
<ParamField toc={true} path="ai.global_data" type="object">
...
<ParamField toc={true} path="ai.pronounce" type="object[]">
