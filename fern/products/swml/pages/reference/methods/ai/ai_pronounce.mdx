...
<ParamField toc={true} path="pronounce[].replace" type="string" required={true}>
  The expression to replace.
</ParamField>


<ParamField toc={true} path="pronounce[].with" type="string" required={true}>
  The phonetic spelling of the expression.
</ParamField>


<ParamField toc={true} path="pronounce[].ignore_case" type="boolean" default="true">
