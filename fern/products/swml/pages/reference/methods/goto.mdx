...
<ParamField toc={true} path="goto" type="object" required={true}>
...
<ParamField toc={true} path="goto.label" type="string" required={true}>
  The label in section to jump to.
</ParamField>


<ParamField toc={true} path="goto.when" type="string">
...
<ParamField toc={true} path="goto.max" type="integer" default="100">
