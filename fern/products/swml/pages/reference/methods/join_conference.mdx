...
<ParamField path="join_conference.coach" type="string">
  Coach accepts a [call SID](/platform/what-is-a-sid) of a call that is currently connected to an in-progress conference. Specifying a call SID that does not exist or is no longer connected will result in a failure.
</ParamField>
