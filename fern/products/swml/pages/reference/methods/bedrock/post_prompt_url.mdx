...
**amazon_bedrock.post_prompt_url** (type: string)
...
**SWMLVars** (type: object)
  A collection of variables related to SWML.

**swaig_log** (type: object)
