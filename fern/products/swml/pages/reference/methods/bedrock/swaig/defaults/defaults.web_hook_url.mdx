---
id: 95aaa1e2-77ec-4115-9998-ee015a6f30ab
...
[SWML Function parameters]: /swml/methods/amazon_bedrock/swaig/functions#parameters
...
<ParamField path="action" type="object[]">
  ...
  See [list of valid actions](/swml/methods/amazon_bedrock/swaig/functions#list-of-valid-actions) for additional details.
</ParamField>
