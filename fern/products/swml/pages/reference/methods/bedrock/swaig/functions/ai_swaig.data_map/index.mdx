...
For more on [variables](/swml/variables) and scopes, see the [Variables reference](/swml/variables).
...
<ParamField path="args.*" type="any">
  Individual argument value. The key matches an argument name from the function's [`parameters`](/swml/methods/amazon_bedrock/swaig/functions/parameters) schema.
</ParamField>
