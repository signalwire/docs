...
slug: /reference/amazon-bedrock/swaig/functions/data-map
title: data_map
description: Defines how a SWAIG function should process and respond to the user's input data.
max-toc-depth: 3
---

`functions[].data_map` defines how a [`SWAIG function`](swml/reference/amazon-bedrock/swaig/functions) should process and respond to the user's input data.
...
<ParamField path="webhooks[].input_args_as_params" type="boolean" default="false">
  A boolean to determine if the input [parameters](swml/reference/amazon-bedrock/swaig/functions/parameters) should be passed as parameters.
</ParamField>

<ParamField path="webhooks[].required_args" type="string | string[]">
  A string or array of strings that represent the [parameters](swml/reference/amazon-bedrock/swaig/functions/parameters) that are required to make the webhook request.
</ParamField>
...
For more on [variables](swml/reference/variables) and scopes, see the [Variables reference](swml/reference/variables).
...
<ParamField path="args.*" type="any">
  Individual argument value. The key matches an argument name from the function's [`parameters`](swml/reference/amazon-bedrock/swaig/functions/parameters) schema.
</ParamField>
