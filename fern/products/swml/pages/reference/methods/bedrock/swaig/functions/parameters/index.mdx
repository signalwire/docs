...
**parameters.type** (type: string) *required*
...
**properties.{property_name}** (type: object) *required*
...
**{property_name}.type** (type: string) *required*
...
**{property_name}.nullable** (type: boolean) Default: `false`
...
**{property_name}.items** (type: object) *required*
...
**{property_name}.oneOf** (type: array) *required*
...
**{property_name}.allOf** (type: array) *required*
...
**{property_name}.anyOf** (type: array) *required*
...
**{property_name}.const** (type: any) *required*
