---
hide_title: false
slug: /swml/methods/amazon_bedrock/swaig/functions
title: functions
...
[post-prompt]: /swml/methods/amazon_bedrock/post_prompt
...
<ParamField toc={true} path="functions[].data_map" type="object">
  ...
  See [`data_map`](./ai_swaig.data_map/index.mdx) for additional details.
</ParamField>
...
<ParamField toc={true} path="functions[].parameters" type="object">
  ...
  See [`parameters`](./parameters/index.mdx) for additional details.
</ParamField>
...
<ParamField toc={true} path="functions[].web_hook_url" type="string">
  ...
  See [`web_hook_url`](./functions.web_hook_url.mdx) for details on the request body.
</ParamField>
