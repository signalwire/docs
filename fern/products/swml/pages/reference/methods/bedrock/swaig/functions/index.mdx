...
hide_title: false
slug: /reference/amazon-bedrock/swaig/functions
title: functions
...
[post-prompt]: /swml/reference/amazon-bedrock#post_prompt-properties
...
<ParamField path="functions[].data_map" type="object">
  ...
  See [`data_map`](/swml/reference/amazon-bedrock/swaig/functions/data-map) for additional details.
</ParamField>
...
<ParamField path="functions[].parameters" type="object">
  ...
  See [`parameters`](/swml/reference/amazon-bedrock/swaig/functions/parameters) for additional details.
</ParamField>


<ParamField path="functions[].meta_data" type="object">
  A powerful and flexible environmental variable which can accept arbitrary data that is set initially in the SWML script or from the SWML [`set_meta_data` action](/swml/reference/amazon-bedrock/swaig/functions/data-map#actions). This data can be referenced **locally** to the function. All contained information can be accessed and expanded within the prompt - for example, by using a template string.
</ParamField>
