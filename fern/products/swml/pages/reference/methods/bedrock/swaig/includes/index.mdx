...
slug: /reference/amazon-bedrock/swaig/includes
title: Includes
...
[swaig-functions]: /swml/reference/amazon-bedrock/swaig/functions#properties
[webhook-response]: /swml/reference/amazon-bedrock/swaig/functions#webhook-response
[webhook-request]: /swml/reference/amazon-bedrock/swaig/functions#callback-request-for-web_hook_url
...
Functions can trigger various behaviors: speaking text, sending SMS, playing audio, transferring calls, and more. See the [actions documentation](/docs/swml/reference/amazon-bedrock/swaig/functions#list-of-valid-actions) for all available options.
</Tip>
