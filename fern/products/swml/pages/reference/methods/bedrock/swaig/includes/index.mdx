...
slug: /swml/methods/amazon_bedrock/swaig/includes
title: Includes
sidebar-title: includes
description: Remote function signatures to include in SWAIG functions.
---

[swaig-functions]: /swml/methods/amazon_bedrock/swaig/functions#properties
[webhook-response]: /swml/methods/amazon_bedrock/swaig/functions#webhook-response
[webhook-request]: /swml/methods/amazon_bedrock/swaig/functions#callback-request-for-web_hook_url
...
Functions can trigger various behaviors: speaking text, sending SMS, playing audio, transferring calls, and more. See the [actions documentation](/swml/methods/amazon_bedrock/swaig/functions#list-of-valid-actions) for all available options.
</Tip>
