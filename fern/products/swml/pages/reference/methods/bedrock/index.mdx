...
<ParamField toc={true} path="amazon_bedrock" type="object" required={true}>
  An object that contains the [`Amazon Bedrock properties`](#amazon-bedrock-properties).
</ParamField>


## **Amazon Bedrock properties**

<ParamField toc={true} path="amazon_bedrock.global_data" type="object">
