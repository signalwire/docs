...
slug: /reference/amazon-bedrock
title: amazon_bedrock
description: Create an Amazon Bedrock agent interaction.
max-toc-depth: 3
---

[params]: /swml/reference/amazon-bedrock/params
[prompt]: /swml/reference/amazon-bedrock/prompt
[SWAIG]: /swml/reference/amazon-bedrock/swaig
[set_global_data action]: /swml/reference/amazon-bedrock/swaig/functions/data-map#actions
[Prompting Best Practices]: /platform/ai/best-practices#crafting-the-initial-prompt-for-the-ai
...
The following example selects Bedrock's **Tiffany** voice using the [voice_id](/swml/reference/amazon-bedrock/prompt) parameter in the prompt.
It includes scaffolding for a [post_prompt_url](#amazon-bedrock-properties)
