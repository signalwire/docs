...
**pom[].numbered** (type: boolean) Default: `false`
  If `true`, the section will be numbered in the rendered prompt.

**pom[].numberedBullets** (type: boolean) Default: `false`
