---
slug: /swml/methods/amazon_bedrock/prompt/pom
title: prompt.pom
description: The prompt object model (POM) is a structured data format for organizing, and rendering prompt instructions for Amazon Bedrock agents.
---
...
<Callout type="warning" title="Want a library for working with the POM?">
...
<ParamField path="pom[].bullets" type="string[]">
  An array of strings that represent the bullets of the section. This will be a list of short statements/rules in the rendered prompt.
</ParamField>
