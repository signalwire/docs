...
<ParamField path="params.fax.params.result" type="number">
...
<ParamField path="params.fax.params.format" type="string">
...
<ParamField path="params.fax.params.number" type="number">
