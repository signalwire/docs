...
<ParamField toc={true} path="record_call" type="object" required={true}>
...
<ParamField toc={true} path="record_call.control_id" type="string" default="Auto-generated, saved to record_control_id variable">
  Identifier for this recording, to use with [`stop_record_call`](./stop_record_call.mdx)
</ParamField>


<ParamField toc={true} path="record_call.stereo" type="boolean" default="false">
  Whether to record in stereo mode
</ParamField>


<ParamField toc={true} path="record_call.format" type="string" default="wav">
  Format (`"wav"`, `"mp3"`, or `"mp4"`)
</ParamField>


<ParamField toc={true} path="record_call.direction" type="string" default="both">
...
<ParamField toc={true} path="record_call.terminators" type="string">
  String of digits that will stop the recording when pressed. Default is empty (no terminators).
</ParamField>


<ParamField toc={true} path="record_call.beep" type="boolean" default="false">
  Whether to play a beep before recording
</ParamField>


<ParamField toc={true} path="record_call.input_sensitivity" type="number" default="44.0">
...
<ParamField toc={true} path="record_call.initial_timeout" type="number" default="0">
  How long, in seconds, to wait for speech to start?
</ParamField>


<ParamField toc={true} path="record_call.end_silence_timeout" type="number" default="0">
  How much silence, in seconds, will end the recording?
</ParamField>


<ParamField toc={true} path="record_call.max_length" type="number">
  Maximum length of the recording in seconds.
</ParamField>


<ParamField toc={true} path="record_call.status_url" type="string">
...
<ParamField path="params.record.url" type="string">
  URL to download the recording.
</ParamField>


<ParamField path="params.record.duration" type="number">
  Recording duration in seconds.
</ParamField>


<ParamField path="params.record.size" type="number">
  Recording file size in bytes.
</ParamField>


<ParamField path="params.record.format" type="string">
