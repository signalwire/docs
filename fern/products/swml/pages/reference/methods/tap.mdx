...
<ParamField toc={true} path="tap" type="object" required={true}>
...
<ParamField toc={true} path="tap.uri" type="string" required={true}>
  Destination of the tap media stream: `rtp://IP:port`, `ws://example.com`, or `wss://example.com`
</ParamField>


<ParamField toc={true} path="tap.control_id" type="string" default="Auto-generated, stored in the tap_control_id variable">
  Identifier for this tap to use with `stop_tap`
</ParamField>


<ParamField toc={true} path="tap.direction" type="string">
  speak``
  Direction of the audio to tap: `speak` for what party says, `listen` for what party hears, `both` for what party hears and says
</ParamField>


<ParamField toc={true} path="tap.codec" type="string">
  PCMU``
  `PCMU` or `PCMA`
</ParamField>


<ParamField toc={true} path="tap.rtp_ptime" type="integer" default="20 ms">
...
<ParamField toc={true} path="tap.status_url" type="string">
...
<ParamField path="params.tap.type" type="string">
  The type of media being tapped (e.g., `audio`).
</ParamField>


<ParamField path="params.tap.params.direction" type="string">
  The direction of audio being tapped.
</ParamField>


<ParamField path="params.tap.params.codec" type="string">
  The codec used for the tap stream.
</ParamField>


<ParamField path="params.tap.params.rate" type="number">
  The sample rate of the tap stream.
</ParamField>


<ParamField path="params.tap.params.ptime" type="number">
  The packetization time of the tap stream in milliseconds.
</ParamField>
...
<ParamField path="params.device.params.addr" type="string">
  The destination address for the tap stream.
</ParamField>


<ParamField path="params.device.params.port" type="number">
