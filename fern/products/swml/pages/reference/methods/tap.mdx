...
<ParamField path="params.device.params.codec" type="string">
  The audio codec used for the tap stream (e.g., `PCMU`, `PCMA`).
</ParamField>


<ParamField path="params.device.params.ptime" type="number">
  The packetization time in milliseconds. Present for RTP taps only.
</ParamField>


<ParamField path="params.device.params.uri" type="string">
