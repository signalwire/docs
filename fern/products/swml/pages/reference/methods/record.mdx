...
<ParamField path="params.record.audio.format" type="string">
  Recording format. **Valid values:** `wav`, `mp3`.
</ParamField>


<ParamField path="params.record.audio.direction" type="string">
  Direction of the audio recorded: `speak` or `listen`.
</ParamField>


<ParamField path="params.record.audio.stereo" type="boolean">
