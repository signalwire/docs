...
<ParamField toc={true} path="stop_record_call" type="object" required={true}>
...
<ParamField toc={true} path="stop_record_call.control_id" type="string" default="The last started recording will be stopped">
