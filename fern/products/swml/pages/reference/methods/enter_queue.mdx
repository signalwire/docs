...
<ParamField toc={true} path="enter_queue" type="object" required={true}>
...
<ParamField toc={true} path="enter_queue.queue_name" type="string" required={true}>
  Name of the queue to enter. If a queue with this name does not exist, it will be automatically created.
</ParamField>


<ParamField toc={true} path="enter_queue.transfer_after_bridge" type="string" required={true}>
...
<ParamField toc={true} path="enter_queue.status_url" type="string">
...
<ParamField toc={true} path="enter_queue.wait_url" type="string">
...
<ParamField toc={true} path="enter_queue.wait_time" type="integer" default="3600">
...
<ParamField toc={true} path="params.status" type="string">
...
<ParamField toc={true} path="params.id" type="string">
  Unique queue entry identifier (UUID format).
</ParamField>


<ParamField toc={true} path="params.name" type="string">
  The name of the queue.
</ParamField>


<ParamField toc={true} path="params.position" type="integer">
  The caller's position in the queue. Set to `0` when dequeued.
</ParamField>


<ParamField toc={true} path="params.size" type="integer">
  The total number of callers in the queue. Set to `0` when dequeued.
</ParamField>


<ParamField toc={true} path="params.avg_time" type="integer">
  Average wait time in the queue (in seconds).
</ParamField>


<ParamField toc={true} path="params.enqueue_ts" type="integer">
  Unix timestamp in microseconds when the caller entered the queue. Set to `0` in `dequeue` events.
</ParamField>


<ParamField toc={true} path="params.dequeue_ts" type="integer">
...
<ParamField toc={true} path="params.leave_ts" type="integer">
