...
<ParamField path="cond[].then" type="object[]" required={true}>
  Sequence of [`SWML Methods`](swml/reference) to execute when the condition evaluates to `true`
</ParamField>
...
<ParamField path="cond[].else" type="object[]">
  Sequence of [`SWML Methods`](swml/reference) to execute when none of the other conditions evaluate to `true`
</ParamField>
...
- **[switch](swml/reference/switch)**: Alternative conditional logic method
