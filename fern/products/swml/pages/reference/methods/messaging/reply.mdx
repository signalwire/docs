...
Branch the reply body on a variable's value — for keyword-driven replies in a light-mode document.
...
inbound `message.body`. Light-mode documents do not require a `sections` wrapper.
