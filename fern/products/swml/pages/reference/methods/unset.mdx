...
Unset specified variables. The variables have been set either using the [`set`](swml/reference/set) command
or as a byproduct of some other statements or methods (like [`record`](swml/reference/record#variables))
...
- **[Variables and Expressions](swml/reference/variables)**: Complete reference for SWML variables, scopes, and syntax
- **[set](swml/reference/set)**: Set variables in the script
