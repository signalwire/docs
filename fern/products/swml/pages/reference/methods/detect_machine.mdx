...
<ParamField path="params.detect.type" type="string">
  The type of detection. **Valid values:** `machine` or `fax`.
</ParamField>


<ParamField path="params.detect.params.event" type="string">
  The detection result. **Valid values:** `HUMAN`, `MACHINE`, `READY`, `NOT_READY`, `UNKNOWN`, `finished`.
</ParamField>


<ParamField path="params.detect.params.beep" type="boolean">
