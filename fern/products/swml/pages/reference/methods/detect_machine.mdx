...
**detect_result** (type: human | machine | fax | unknown)
  The result of detection.

**detect_machine_beep** (type: true | false)
  Whether a beep was detected. `true` if detected.

**detect_ms** (type: integer)
...
**params.detect** (type: object)
  Detection result details (see subfields below).

**params.detect.type** (type: string)
  The type of detection. **Valid values:** `machine` or `fax`.

**params.detect.params.event** (type: string)
