...
Will use the [`switch`](./switch#properties) method when the `return_value` is a object, and will use the [`cond`](./cond#properties) method when the `return_value` is an array.
