...
For information about variable scopes, see the [Variables Reference](/swml/reference/variables).
For JavaScript expressions and data manipulation, see the [Expressions Reference](/swml/reference/expressions).

<Warning>
Template functions are **only** available in [SWAIG (SignalWire AI Gateway)](/swml/reference/ai/swaig) contexts, specifically within:
