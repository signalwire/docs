...
<Warning>
Template functions are **only** available in [SWAIG (SignalWire AI Gateway)](/swml/methods/ai/swaig) contexts, specifically within:
...
<ParamField toc={true} path="lc" type="string">
...
<ParamField toc={true} path="enc:url" type="string">
...
<ParamField toc={true} path="strftime_tz" type="string">
...
<ParamField toc={true} path="fmt_ph" type="string">
...
<ParamField toc={true} path="expr" type="string">
...
<ParamField toc={true} path="echo" type="string">
...
<ParamField toc={true} path="separate" type="string">
...
<ParamField toc={true} path="sleep" type="string">
