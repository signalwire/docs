...
<Callout type="warning" title="Template functions are **only** available in [SWAIG (SignalWire AI Gateway)](/swml/methods/ai/swaig) contexts, specifically within:">
...
<ParamField path="sleep" type="string">
  ...
  **Syntax:** `@{sleep <seconds>}`
  ...
  <Callout type="warning" title="Use sparingly in production environments. Excessive delays can cause timeouts, impact call quality, and degrade user experience. Best suited for development, testing, or specific rate-limiting scenarios.">
