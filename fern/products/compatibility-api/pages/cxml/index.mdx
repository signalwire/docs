...
sidebar_title: cXML Specification
...
<Tip title="Comparing the Compatibility SDKs and Libraries">
...
| Verb                               | Action                                                                        |
|:-----------------------------------|:------------------------------------------------------------------------------|
| [`<Denoise>`](/compatibility-api/voice/denoise) | Enables or disables noise reduction.                                          |
| [`<Dial>`](/compatibility-api/voice/dial)       | Initiates a call to another phone number.                                     |
| [`<Echo>`](/compatibility-api/voice/echo)       | Echoes audio back to the call.                                                |
| [`<Gather>`](/compatibility-api/voice/gather)   | Collects input from the remote number, either as pressed digits or as speech. |
| [`<Play>`](/compatibility-api/voice/play)       | Plays an audio file in the call.                                              |
| [`<Record>`](/compatibility-api/voice/record)   | Records and saves the audio in the call.                                      |
| [`<Say>`](/compatibility-api/voice/say)         | Reads the supplied text into the call.                                        |
| [`<Sms>`](/compatibility-api/voice/sms)         | Sends an SMS message during a call.                                           |
| [`<Stream>`](/compatibility-api/voice/stream)   | Streams a call to a websocket.                                                |

The following verbs control what happens to the call itself:

| Verb                                 | Action                                                                                                         |
|:-------------------------------------|:---------------------------------------------------------------------------------------------------------------|
| [`<Enqueue>`](/compatibility-api/voice/enqueue)   | Place the call into a queue.                                                                                   |
| [`<Hangup>`](/compatibility-api/voice/hangup)     | Disconnect the call.                                                                                           |
| [`<Leave>`](/compatibility-api/voice/leave)       | Remove the call from the queue it is currently in.                                                             |
| [`<Pause>`](/compatibility-api/voice/pause)       | Wait before continuing to execute further instructions.                                                        |
| [`<Redirect>`](/compatibility-api/voice/redirect) | Stop executing the instructions in this XML document, and start executing those in another specified document. |
| [`<Refer>`](/compatibility-api/voice/refer)       | Send SIP REFER to transfer the call from SignalWire control.                                                   |
| [`<Reject>`](/compatibility-api/voice/reject)     | Decline an incoming call.                                                                                      |
...
| Verb                                     | Action                                                                                                         |
|:-----------------------------------------|:---------------------------------------------------------------------------------------------------------------|
| [`<Message>`](/compatibility-api/messaging/message)   | Sends a message to another phone number.                                                                       |
| [`<Redirect>`](/compatibility-api/messaging/redirect) | Stop executing the instructions in this XML document, and start executing those in another specified document. |
...
| Verb                             | Action                    |
|:---------------------------------|:--------------------------|
| [`<Receive>`](/compatibility-api/fax/receive) | Receives an incoming fax. |
| [`<Reject>`](/compatibility-api/fax/reject)   | Rejects an incoming fax.  |
