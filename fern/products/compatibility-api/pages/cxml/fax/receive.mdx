---
id: 7e1edf2f-d8ba-4240-8625-3280a3daf2f1
title: Receive
sidebar-title: Receive
excerpt: ''
slug: /cxml/reference/fax/receive
position: 1
max-toc-depth: 3
---
...
Faxes remain stored indefinitely. To delete a fax, use the appropriate API call from the [Compatibility API](/docs/compatibility-api/rest/faxes/delete-fax).
...
<ParamField path="mediaType" type="string" default="application/pdf" toc={true}>
...
<ParamField path="pageSize" type="string" default="letter" toc={true}>
