...
Faxes remain stored indefinitely. To delete a fax, use the appropriate API call from the [Compatibility API](/compatibility-api/rest/faxes/delete-fax).
...
If the verb attribute `action` is specified, the action callback will include the [Standard Fax Request Parameters](/compatibility-api/cxml/reference/fax#request-parameters) plus the following optional parameters:
