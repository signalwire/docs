---
id: f11f096f-c4b8-450c-8345-55996f8d0930
title: Fax Overview
sidebar-title: Overview
excerpt: ''
slug: /cxml/reference/fax
position: 0
max-toc-depth: 3
---
...
<ParamField path="ApiVersion" type="string" toc={true}>
  The version of the SignalWire API.
</ParamField>

<ParamField path="FaxSid" type="string" toc={true}>
...
<ParamField path="ErrorCode" type="string" toc={true}>
  The error code provides more information on a failed fax.
</ParamField>

<ParamField path="ErrorMessage" type="string" toc={true}>
  The message explaining the reason for fax failure.
</ParamField>

<ParamField path="FaxStatus" type="string" toc={true}>
  The status of the fax.
</ParamField>

<ParamField path="MediaSid" type="string" toc={true}>
...
<ParamField path="NumPages" type="integer" toc={true}>
  The number of pages received from a successful fax.
</ParamField>

<ParamField path="OriginalMediaUrl" type="string" toc={true}>
  The original URL passed when a fax is sent.
</ParamField>

<ParamField path="RemoteStationId" type="string" toc={true}>
