...
<ParamField path="MediaSid" type="string">
  The [SID](/platform/what-is-a-sid) that uniquely identifies the fax media.
</ParamField>
...
<CardGroup cols={2}>
  <Card title="Receive" icon="inbox" href="/compatibility-api/cxml/reference/fax/receive">
    Receive an incoming fax.
  </Card>
  <Card title="Reject" icon="ban" href="/compatibility-api/cxml/reference/fax/reject">
