---
id: b6eb8d6c-0817-4144-a2b1-880ea0e41a20
title: Receiving your first SMS
sidebar-title: Receive SMS
slug: /guides/receive-sms
position: 1
...
To [send your first SMS](/docs/cxml/guides/sending-your-first-sms), you needed a
...
<Frame>
  ![Create a new cXML script.](/docs/assets/images/dashboard/resources/new-cxml-bin.webp)
</Frame>
...
<Frame>
  ![Open the settings for the number.](/docs/assets/images/dashboard/phone-numbers/assign-resource-full.webp)
</Frame>
...
<Markdown src="/docs/snippets/common/dashboard/legacy-instructions.mdx" />
...
<Frame>
  ![Create a new cXML script.](/docs/assets/images/dashboard/legacy/xml-bins.webp)
</Frame>
