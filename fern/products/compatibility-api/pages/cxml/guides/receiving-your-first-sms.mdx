...
To [send your first SMS](cxml/guides/sending-your-first-sms), you needed a
...
[buy one](platform/phone-numbers).
...
and in particular [cXML](compatibility-api/cxml) Scripts,
to receive a message.
For more advanced, real-time applications, you'll want to check out our
[Realtime SDK](server-sdk/node).
...
Please see [**Campaign Registry - Everything You Need To Know**](platform/messaging/campaign-registry) for more information.
