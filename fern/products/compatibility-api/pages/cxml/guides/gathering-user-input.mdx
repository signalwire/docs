---
id: 6c7dbafe-cfe0-4c95-8f78-ada2fa8f07c7
title: Gathering user input
slug: /guides/gather-user-input
x-custom:
  author: danieleds
...
<Markdown src="/snippets/common/dashboard/create-cxml-script.mdx" />
...
We used the [`<Gather>`](/compatibility-api/cxml/reference/voice/gather) verb to gather input as soon as the call starts. We set five attributes:
...
Within the `<Gather>` verb, we nested [`<Say>`](/compatibility-api/cxml/reference/voice/say) in order to play some instructions.
