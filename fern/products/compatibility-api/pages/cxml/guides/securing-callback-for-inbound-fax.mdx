---
id: fb99eb00-15dc-4394-9774-0b09473666f4
title: Callback for inbound fax
sidebar-title: Inbound Fax Callback
slug: /guides/callback-for-inbound-fax
position: 3
...
The below code is taken from the [Receive a Fax in Compatibility XML example](/compatibility-api/cxml/reference/fax/receive#examples).
...
Please follow the [Handling Calls from Code](/compatibility-api/guides/voice/general/handling-calls-from-code#configuring-the-number) guide for detailed instructions on how to configure your phone number to handle incoming calls.
...
It is time to test your phone number by [Sending a Fax](/compatibility-api/rest/faxes/send-fax) to your fax-receiving phone number.

Once your fax has been received, you should receive a payload to your actionURL that looks similar to the one below.
Feel free to read up more on [Request Parameters](/compatibility-api/cxml/reference/fax#request-parameters)
and [Additional Callback Parameters](/compatibility-api/cxml/reference/fax/receive#action-callback)
...
You can also [view and allow SignalWire IPs in real-time by running a specific script](/platform/allow-signalwire-ips-through-your-firewall).
...
- [Receive a Fax in Compatibility XML example](/compatibility-api/cxml/reference/fax/receive#examples)
- [Fax Request Parameters](/compatibility-api/cxml/reference/fax#request-parameters)
