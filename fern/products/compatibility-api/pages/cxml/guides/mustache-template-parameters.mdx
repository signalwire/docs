...
slug: /guides/mustache-templates
...
Please follow this knowledge base article for more information on [forwarding an incoming message](compatibility-api/guides/send-sms) to another number.
...
For more information about SignalWire cXML and Mustache templates, please review the [cXML overview](compatibility-api/cxml).
