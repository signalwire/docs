---
id: 810d5ec2-d0ca-48d5-add8-8a31f693e257
title: Enqueue
sidebar-title: Enqueue
slug: /cxml/reference/voice/enqueue
position: 1
max-toc-depth: 3
---
...
<ParamField path="waitUrlMethod" type="string" default="POST" toc={true}>
...
<ParamField path="QueueResult" type="string" toc={true}>
...
<ParamField path="AvgQueueTime" type="integer" toc={true}>
  The average time, in seconds, that callers have been waiting in a queue.
</ParamField>

<ParamField path="CurrentQueueSize" type="integer" toc={true}>
  The current number of callers in a queue.
</ParamField>

<ParamField path="QueuePosition" type="integer" toc={true}>
...
<ParamField path="QueueTime" type="integer" toc={true}>
