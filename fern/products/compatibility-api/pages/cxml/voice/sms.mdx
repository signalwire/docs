---
id: d0694589-b087-418f-bf6d-021bcaa7422e
title: Sms
sidebar-title: Sms
slug: /cxml/reference/voice/sms
position: 1
max-toc-depth: 3
---
...
The `action` URL request contains the [Standard Request Parameters](compatibility-api/cxml/reference/voice#request-parameters) as well as:

<ParamField path="SmsSid" type="string">
  The [SID](platform/what-is-a-sid) for the Sms message.
</ParamField>
...
The `statusCallback` request contains the [Standard Request Parameters](compatibility-api/cxml/reference/voice#request-parameters) as well as:
