...
title: Conference
sidebar-title: Conference
slug: /cxml/reference/voice/conference
position: 1
max-toc-depth: 3
---
...
<ParamField path="recordingStatusCallbackEvent" type="string" default="completed failed" toc={true}>
...
<ParamField path="startConferenceOnEnter" type="boolean" default="true" toc={true}>
...
<ParamField path="Duration" type="integer" toc={true}>
  The time, in seconds, of the conference call.
</ParamField>

<ParamField path="EndConferenceOnExit" type="string" toc={true}>
  When a participant has this set on **true** and they leave a call, conference ends.
</ParamField>

<ParamField path="EventName" type="string" toc={true}>
...
<ParamField path="Hold" type="string" toc={true}>
  Whether a participant is on hold or not.
</ParamField>

<ParamField path="Muted" type="string" toc={true}>
  Whether a participant is muted or not.
</ParamField>

<ParamField path="RecordingFileSize" type="string" toc={true}>
...
<ParamField path="StartConferenceOnEnter" type="string" toc={true}>
