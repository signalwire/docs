---
id: adf23a22-83ee-4439-a1b1-711315c16b11
title: Say
sidebar-title: Say
slug: /cxml/reference/voice/say
position: 1
max-toc-depth: 3
---
...
<ParamField path="loop" type="integer" default="1" toc={true}>
...
Below are the supported SSML tags. When using an Amazon Polly voice, please refer to  [Amazon Polly SSML Documentation](https://docs.aws.amazon.com/polly/latest/dg/supportedtags.html) instead.
