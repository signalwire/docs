...
<ParamField path="codecs" type="string" default="PCMU,PCMA" toc={true}>
...
<ParamField path="sessionTimeout" type="integer" toc={true}>
...
<ParamField path="SipCallId" type="string" toc={true}>
  The SIP call ID header of the request made to the remote SIP infrastructure.
</ParamField>

<ParamField path="SipHeader" type="string" toc={true}>
  The name or value of any X-headers returned in the 200 response to the SIP INVITE request.
</ParamField>
