---
id: 6b7c11a6-bf0e-49c0-b52a-3b7f97382eac
title: Prompt
sidebar-title: Prompt
position: 1
slug: /cxml/reference/voice/pay/prompt
max-toc-depth: 3
---
...
<ParamField path="for" type="string" required={true} toc={true}>
...
<ParamField path="cardType" type="string" toc={true}>
