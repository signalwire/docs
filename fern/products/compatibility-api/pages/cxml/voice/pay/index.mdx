...
<Note title="You can customize prompt messages in any language using the [`<Prompt>`](/compatibility-api/cxml/voice/pay/prompt) noun, regardless of the selected `language` attribute."/>
