...
You can expect several parameters to be present in the request associated to the `action` URL. First, you have the [Standard Request Parameters](compatibility-api/cxml/reference/voice#request-parameters). Then, you also have the following specific parameters:
