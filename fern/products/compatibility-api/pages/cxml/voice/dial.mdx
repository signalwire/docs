...
| Noun                                    |                                                                                                          |
|:----------------------------------------|:---------------------------------------------------------------------------------------------------------|
| [`<Conference>`](/docs/compatibility-api/conference-noun) | A conference call between two or more callers.                                                           |
| [`<Number>`](/docs/compatibility-api/number-noun)         | A phone number with additional attributes.                                                               |
| [`<Sip>`](/docs/compatibility-api/sip-noun)               | A SIP endpoint.                                                                                          |
| [`<Verto>`](/docs/compatibility-api/verto-noun)           | A Verto client.                                                                                          |
| [`<Queue>`](/docs/compatibility-api/queue-noun)           | A line for callers to wait in. The current call will be connected to the call at the front of the queue. |
