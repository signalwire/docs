...
| Verb                                                 | Action                                                                        |
|:-----------------------------------------------------|:------------------------------------------------------------------------------|
| [`<Denoise>`](/compatibility-api/cxml/voice/denoise) | Enables or disables noise reduction.                                          |
| [`<Dial>`](/compatibility-api/cxml/voice/dial)       | Initiates a call to another phone number.                                     |
| [`<Echo>`](/compatibility-api/cxml/voice/echo)       | Echoes audio back to the call.                                                |
| [`<Gather>`](/compatibility-api/cxml/voice/gather)   | Collects input from the remote number, either as pressed digits or as speech. |
| [`<Play>`](/compatibility-api/cxml/voice/play)       | Plays an audio file in the call.                                              |
| [`<Record>`](/compatibility-api/cxml/voice/record)   | Records and saves the audio in the call.                                      |
| [`<Say>`](/compatibility-api/cxml/voice/say)         | Reads the supplied text into the call.                                        |
| [`<Sms>`](/compatibility-api/cxml/voice/sms)         | Sends an SMS message during a call.                                           |
| [`<Stream>`](/compatibility-api/cxml/voice/stream)   | Streams a call to a websocket.                                                |

The following verbs control what happens to the call itself:

| Verb                                                     | Action                                                                                                         |
|:---------------------------------------------------------|:---------------------------------------------------------------------------------------------------------------|
| [`<Enqueue>`](/compatibility-api/cxml/voice/enqueue)     | Place the call into a queue.                                                                                   |
| [`<Hangup>`](/compatibility-api/cxml/voice/hangup)       | Disconnect the call.                                                                                           |
| [`<Leave>`](/compatibility-api/cxml/voice/leave)         | Remove the call from the queue it is currently in.                                                             |
| [`<Pause>`](/compatibility-api/cxml/voice/pause)         | Wait before continuing to execute further instructions.                                                        |
| [`<Redirect>`](/compatibility-api/cxml/voice/redirect)   | Stop executing the instructions in this XML document, and start executing those in another specified document. |
| [`<Refer>`](/compatibility-api/cxml/voice/refer)         | Send SIP REFER to transfer the call from SignalWire control.                                                   |
| [`<Reject>`](/compatibility-api/cxml/voice/reject)       | Decline an incoming call.                                                                                      |
