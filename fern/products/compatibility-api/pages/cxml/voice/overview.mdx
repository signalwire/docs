...
<CardGroup cols={3}>
  <Card title="Connect" icon="plug" href="/compatibility-api/cxml/voice/connect">
    Connect a call to another resource like a video room or stream.
  </Card>
  <Card title="Denoise" icon="waveform-lines" href="/compatibility-api/cxml/voice/denoise">
    Enable or disable noise reduction.
  </Card>
  <Card title="Dial" icon="phone-arrow-up-right" href="/compatibility-api/cxml/voice/dial">
    Initiate a call to another phone number.
  </Card>
  <Card title="Echo" icon="repeat" href="/compatibility-api/cxml/voice/echo">
    Echo audio back to the call.
  </Card>
  <Card title="Gather" icon="keyboard" href="/compatibility-api/cxml/voice/gather">
    Collect input from the caller as pressed digits or speech.
  </Card>
  <Card title="Pay" icon="credit-card" href="/compatibility-api/cxml/voice/pay">
    Securely collect payment information during a call.
  </Card>
  <Card title="Play" icon="circle-play" href="/compatibility-api/cxml/voice/play">
    Play an audio file in the call.
  </Card>
  <Card title="Record" icon="circle-dot" href="/compatibility-api/cxml/voice/record">
    Record and save the audio in the call.
  </Card>
  <Card title="Say" icon="comment" href="/compatibility-api/cxml/voice/say">
    Read the supplied text into the call.
  </Card>
  <Card title="Sms" icon="message" href="/compatibility-api/cxml/voice/sms">
    Send an SMS message during a call.
  </Card>
  <Card title="Stream" icon="tower-broadcast" href="/compatibility-api/cxml/voice/stream">
...
<CardGroup cols={3}>
  <Card title="Enqueue" icon="bars-staggered" href="/compatibility-api/cxml/voice/enqueue">
    Place the call into a queue.
  </Card>
  <Card title="Hangup" icon="phone-slash" href="/compatibility-api/cxml/voice/hangup">
    Disconnect the call.
  </Card>
  <Card title="Leave" icon="right-from-bracket" href="/compatibility-api/cxml/voice/leave">
    Remove the call from the queue it is currently in.
  </Card>
  <Card title="Pause" icon="circle-pause" href="/compatibility-api/cxml/voice/pause">
    Wait before continuing to execute further instructions.
  </Card>
  <Card title="Redirect" icon="arrows-turn-right" href="/compatibility-api/cxml/voice/redirect">
    Stop executing the current document and start executing another.
  </Card>
  <Card title="Refer" icon="share" href="/compatibility-api/cxml/voice/refer">
    Send SIP REFER to transfer the call from SignalWire control.
  </Card>
  <Card title="Reject" icon="ban" href="/compatibility-api/cxml/voice/reject">
