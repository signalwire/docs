...
<ParamField path="CallStatus" type="string" toc={true}>
...
<ParamField path="ForwardedFrom" type="string" toc={true}>
  The number this call was forwarded from.
</ParamField>

<ParamField path="HangupBy" type="string" toc={true}>
  An indicator of which number ended the call.
</ParamField>

<ParamField path="HangupDirection" type="string" toc={true}>
  An indicator of which direction ended the call.
</ParamField>

<ParamField path="RecordingDuration" type="integer" toc={true}>
  The duration, in seconds, of the recording.
</ParamField>

<ParamField path="RecordingSid" type="string" toc={true}>
...
<ParamField path="SequenceNumber" type="integer" toc={true}>
