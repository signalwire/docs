...
Recordings remain stored indefinitely. To delete a recording, use the appropriate API call from the [Compatibility API](/compatibility-api/rest/recordings/delete-recording).
