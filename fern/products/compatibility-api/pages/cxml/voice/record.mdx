...
| `RecordingChannels` <span className="optional-arg">integer</span> | The number of channels in the recording. `<Record>` will exclusively accept one channel                                                 |
