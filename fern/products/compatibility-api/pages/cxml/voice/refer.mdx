---
id: ffb73fb7-0e6f-4f3c-8784-27d5494022c1
title: Refer
sidebar-title: Refer
slug: /cxml/reference/voice/refer
position: 1
max-toc-depth: 3
---
...
<ParamField path="NotifySipResponseCode" type="string" toc={true}>
...
<ParamField path="ReferCallStatus" type="string" toc={true}>
...
<ParamField path="ReferSipResponseCode" type="string" toc={true}>
