...
You can find a list of our supported languages [here](/platform/voice/tts).

#### Request parameters for `action` URL  [#gather_action]

The `action` request contains the [Standard Request Parameters](/compatibility-api/cxml/reference/voice#request-parameters) as well as:
