...
SignalWire executes instructions in order from top to bottom. Outbound calls and messages work the same wayâ€”you provide a URL to a cXML document when initiating the call or message via the REST API.
