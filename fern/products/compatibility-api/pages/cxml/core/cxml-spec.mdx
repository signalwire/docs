...
Each channel type has its own set of available verbs. See the [Voice](/docs/compatibility-api/cxml/reference/voice#verbs), [Messaging](/docs/compatibility-api/cxml/reference/messaging#verbs), and [Fax](/docs/compatibility-api/cxml/reference/fax#verbs) overview pages for the complete list of verbs for each channel.
