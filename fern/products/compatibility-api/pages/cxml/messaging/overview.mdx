...
<CardGroup cols={2}>
  <Card title="Message" icon="message" href="/compatibility-api/cxml/reference/messaging/message">
    Send a message to another phone number.
  </Card>
  <Card title="Redirect" icon="arrows-turn-right" href="/compatibility-api/cxml/reference/messaging/redirect">
