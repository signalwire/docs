...
<Info title="Not sending SMS or MMS? SignalWire cXML allows you to control calls as well. Check out [Voice XML](/compatibility-api/voice/index) for more details."/>
...
| Verb                                                       | Action                                                                                                         |
|:-----------------------------------------------------------|:---------------------------------------------------------------------------------------------------------------|
| [`<Message>`](/compatibility-api/cxml/messaging/message)   | Sends a message to another phone number.                                                                       |
| [`<Redirect>`](/compatibility-api/cxml/messaging/redirect) | Stop executing the instructions in this XML document, and start executing those in another specified document. |
