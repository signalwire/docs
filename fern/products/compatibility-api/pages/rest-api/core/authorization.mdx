...
[SignalWire Dashboard](platform/your-signalwire-api-space).
...
Manage scopes in the [SignalWire Dashboard](platform/your-signalwire-api-space).
...
**How to obtain:** Call the [Create Subscriber Token](apis/fabric/subscribers/create-subscriber-token) endpoint using Basic Auth.
...
**Use case:** Client apps connecting to Fabric services, such as listing [Fabric Addresses](apis/fabric/fabric-address/list-fabric-addresses).
...
**How to obtain:** Call the [Create Subscriber Guest Token](apis/fabric/subscribers-tokens/create-subscriber-guest-token) endpoint using a SAT.
...
To keep a session alive without re-authenticating, call the [Refresh Subscriber Token](apis/fabric/subscribers-tokens/refresh-subscriber-token) endpoint before expiration.
