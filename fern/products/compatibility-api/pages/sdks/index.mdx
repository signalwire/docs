...
sidebar-title: Compatibility Libraries and SDKs
...
The Compatibility SDK has two primary namespaces:
 ...
 - **cXML namespace:** The cXML namespace of the Compatibility SDK does not directly make API calls. Instead, these SDKs or libraries work as simple XML builders that enable you to easily generate cXML within your language of choice. This XML is generated in a single string which SignalWire's servers parse. Learn more by reading our guide to the [cXML Specification](/compatibility-api/cxml/index).
