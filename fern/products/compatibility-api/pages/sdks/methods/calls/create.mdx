---
id: 8e96e4f7-9df0-415a-b392-e1ee63872469
slug: /sdks/reference/calls/create
title: Create
sidebar-title: Create
max-toc-depth: 3
---

Use this endpoint for the [Calls](docs/compatibility-api/index) method to create a new call.
