...
Use this endpoint for the [Queue Members](docs/compatibility-api/index) method to modify the properties of a queue member that is actively waiting in a call queue.
