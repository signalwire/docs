...
<ParamField path="AnnounceMethod" type="string" default="POST">
  Whether the request to `AnnounceUrl` is a `GET` or a `POST`. Default is `POST`.
</ParamField>

<ParamField path="AnnounceUrl" type="string">
  The URL to send participant announcements to.
</ParamField>

<ParamField path="CallSidToCoach" type="string">
...
<ParamField path="HoldMethod" type="string" default="POST">
  Whether the request to `HoldUrl` is a `GET` or a `POST`. Default is `POST`.
</ParamField>

<ParamField path="HoldUrl" type="string">
