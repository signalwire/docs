...
slug: /sdks/reference/conference-participants/update
title: Update
sidebar-title: Update
max-toc-depth: 3
---

Use this endpoint for the [Conference Participants](/docs/compatibility-api/index) method to modify the properties of participant in an active conference call.
