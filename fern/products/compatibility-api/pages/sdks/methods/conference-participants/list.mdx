...
Use this endpoint for the [Conference Participants](docs/compatibility-api/index) method to read all of the active participants that are associated with this conference call.
