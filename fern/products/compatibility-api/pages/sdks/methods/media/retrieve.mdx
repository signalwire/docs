---
id: 060f3bc2-5d1f-4389-b82e-94e8f7662463
slug: /sdks/reference/media/retrieve
title: Retrieve
sidebar-title: Retrieve
max-toc-depth: 3
---

Use this endpoint for the [Media](/docs/compatibility-api/index) method to retrieve a single media record.
