...
<ParamField path="MediaUrl" type="string" required>
...
<ParamField path="Quality" type="string" default="fine">
  The quality of the fax. Default is `fine`.
</ParamField>

<ParamField path="StatusCallback" type="string">
  The URL to send a `POST` request when the status of a fax changes. See [StatusCallback Parameters](#statuscallback-parameters) for parameters.
</ParamField>
