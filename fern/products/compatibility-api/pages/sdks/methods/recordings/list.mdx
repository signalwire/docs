...
slug: /sdks/reference/recordings/list
title: List
sidebar-title: List
max-toc-depth: 3
---

Use this endpoint for the [Recordings](/docs/compatibility-api/index) method to fetch all the recordings that are associated with your SignalWire account.
