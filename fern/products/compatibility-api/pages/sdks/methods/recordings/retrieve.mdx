---
id: 7886c844-91fc-4222-aa78-c619cea31031
slug: /sdks/reference/recordings/retrieve
title: Retrieve
sidebar-title: Retrieve
max-toc-depth: 3
---

Use this endpoint for the [Recordings](docs/compatibility-api/index) method to retrieve a single recording media or its metadata.
