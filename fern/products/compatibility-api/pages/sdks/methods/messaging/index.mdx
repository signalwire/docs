...
These Media files are managed separately from the Messages themselves, and are stored in **[Media](/compatibility-api/media/index)** subresource objects.
...
<ParamField path="date_sent" type="datetime">
...
<ParamField path="direction" type="string">
  The direction of the message: `inbound` for incoming messages, `outbound-api` for messages created via the REST API, `outbound-call` for messages created during a call, or `outbound-reply` for messages created in response to an inbound message.
</ParamField>
...
<ParamField path="num_media" type="integer">
  The number of media files that were included with the message.
</ParamField>

<ParamField path="num_segments" type="integer">
...
<ParamField path="status" type="string">
  Current status of the message. See [Message Status](#message-status) for a detailed description of each status.
</ParamField>
...
<ParamField path="MessageStatus" type="string">
  The [current status](#message-status) of the message at the time of the callback.
</ParamField>
