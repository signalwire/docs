...
Use this endpoint for the [Media](docs/compatibility-api/index) method to delete a message from your Project so it no longer appears in the Dashboard or on the API.
