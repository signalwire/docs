...
slug: /sdks/reference/messaging/create
title: Create
sidebar-title: Create
max-toc-depth: 3
---

Use this endpoint for the [Media](/docs/compatibility-api/index) method to send an outbound message from one of your SignalWire phone numbers.
