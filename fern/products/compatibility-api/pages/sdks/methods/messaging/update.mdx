...
slug: /sdks/reference/messaging/update
title: Update
sidebar-title: Update
max-toc-depth: 3
---

Use this endpoint for the [Media](docs/compatibility-api/index) method to update a message body after it has been sent.
