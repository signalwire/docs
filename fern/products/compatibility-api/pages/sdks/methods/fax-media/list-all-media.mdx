...
slug: /sdks/reference/fax-media/list-all
title: List all Fax Media
sidebar-title: List all Fax Media
max-toc-depth: 3
---

Use this endpoint for the [Fax Media](/docs/compatibility-api/index) method to return a paged list of media belonging to this fax.
