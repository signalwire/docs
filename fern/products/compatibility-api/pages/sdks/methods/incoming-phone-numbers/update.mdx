...
Use this endpoint for the [IncomingPhoneNumber](/compatibility-api/index) method to modify the properties of an incoming phone number.
...
<ParamField path="EmergencyAddressSid" type="string">
