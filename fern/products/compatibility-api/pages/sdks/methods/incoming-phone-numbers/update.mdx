---
id: 7ef034c7-78ee-4b8d-be55-b87336c6117b
slug: /sdks/reference/incoming-phone-numbers/update
title: Update
sidebar-title: Update
max-toc-depth: 3
---

Use this endpoint for the [IncomingPhoneNumber](docs/compatibility-api/index) method to modify the properties of an incoming phone number.
