...
Use this endpoint for the [IncomingPhoneNumber](/docs/compatibility-api/index) method to read all of the IncomingPhoneNumbers that are associated with your SignalWire account.
