...
Use this endpoint for the [Conference](docs/compatibility-api/index) method to read all of the conferences that are associated with your SignalWire account.
