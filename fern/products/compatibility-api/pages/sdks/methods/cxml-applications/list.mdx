...
<ParamField path="Name" type="string">
  The name given to the cXML Application to distinguish different Applications within your project. Will return all cXML Applications containing this value as a substring.
</ParamField>
