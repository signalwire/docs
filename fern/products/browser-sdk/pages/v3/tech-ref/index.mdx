...
<CardGroup cols={2}>
<Card title="Video" icon="regular video" href="/browser-sdk/v3/reference/video">
Build video conferencing experiences with rooms, screen sharing, and recording capabilities.
</Card>

<Card title="Chat" icon="regular comments" href="/browser-sdk/v3/reference/chat">
Implement real-time messaging with channels, members, and message history.
</Card>

<Card title="PubSub" icon="regular tower-broadcast" href="/browser-sdk/v3/reference/pubsub">
Enable publish-subscribe messaging patterns for real-time data distribution.
</Card>

<Card title="Call Fabric" icon="regular phone" href="/browser-sdk/v3/reference/signalwire-client">
Access SignalWire's unified communication platform for calls, messaging, and notifications.
</Card>

<Card title="WebRTC" icon="regular network-wired" href="/browser-sdk/v3/reference/webrtc">
Low-level WebRTC utilities and helpers for advanced use cases.
</Card>
</CardGroup>

## Classes

- [SignalWire Client](/browser-sdk/reference/call-fabric/call-fabric-overview)
