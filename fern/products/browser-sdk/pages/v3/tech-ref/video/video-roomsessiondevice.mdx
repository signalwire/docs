...
A RoomSessionDevice represents a device (such as a microphone or a camera) that is at some point in its lifetime part of a [RoomSession](/browser-sdk/v-3/reference/video/room-session). You can obtain a RoomSessionDevice from the [RoomSession](/browser-sdk/v-3/reference/video/room-session) methods [RoomSession.addCamera](/browser-sdk/v-3/reference/video/room-session#addcamera), [RoomSession.addMicrophone](/browser-sdk/v-3/reference/video/room-session#addmicrophone), and [RoomSession.addDevice](/browser-sdk/v-3/reference/video/room-session#adddevice).
