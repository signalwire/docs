...
- `Readonly` **deviceList**: [`RoomSessionDevice`](/browser-sdk/reference/video/roomsessiondevice)[]

Contains any additional devices added via [addCamera](/browser-sdk/reference/video/roomsession#addcamera), [addMicrophone](/browser-sdk/reference/video/roomsession#addmicrophone), or [addDevice](/browser-sdk/reference/video/roomsession#adddevice).
...
- `Readonly` **localOverlay**: [`LocalOverlay`](/browser-sdk/reference/video/localoverlay)
...
- `Readonly` **screenShareList**: [`RoomSessionScreenShare`](/browser-sdk/reference/video/roomsessionscreenshare)[]

Contains any local screen shares added to the room via [startScreenShare](/browser-sdk/reference/video/roomsession#startscreenshare).
...
- **addCamera**(`opts`): `Promise<RoomSessionDevice>` - See [RoomSessionDevice documentation](/browser-sdk/reference/video/roomsessiondevice) for more details.
...
`Promise<RoomSessionDevice>` - See [RoomSessionDevice documentation](/browser-sdk/reference/video/roomsessiondevice) for more details.
...
- **addDevice**(`opts`): `Promise<RoomSessionDevice>` - See [RoomSessionDevice documentation](/browser-sdk/reference/video/roomsessiondevice) for more details.

Adds a device to the room. Using this method, a user can stream multiple sources at the same time. If you need to add a camera device or a microphone device, you can alternatively use the more specific methods [addCamera](/browser-sdk/reference/video/roomsession#addcamera) and [addMicrophone](/browser-sdk/reference/video/roomsession#addmicrophone).
...
- **addMicrophone**(`opts`): `Promise<RoomSessionDevice>` - See [RoomSessionDevice documentation](/browser-sdk/reference/video/roomsessiondevice) for more details.
...
- **createScreenShareObject**(`opts`): `Promise<RoomSessionScreenShare>` - See [RoomSessionScreenShare documentation](/browser-sdk/reference/video/roomsessionscreenshare) for more details.


> ⚠️ Deprecated.
> Use [startScreenShare](/browser-sdk/reference/video/roomsession#startscreenshare) instead.
...
`Promise<RoomSessionScreenShare>` - See [RoomSessionScreenShare documentation](/browser-sdk/reference/video/roomsessionscreenshare) for more details.
...
Note that in addition to making a participant deaf, this will also automatically mute the microphone of the target participant (even if there is no `audio_mute` permission). If you want, you can then manually unmute it by calling [audioUnmute](/browser-sdk/reference/video/roomsession#audiounmute).
...
- **getPlaybacks**(): `Promise<{ playbacks: RoomSessionPlayback }>` - See [RoomSessionPlayback documentation](/browser-sdk/reference/video/roomsession-playback) for more details.
...
`Promise<{ playbacks: RoomSessionPlayback }>` - See [RoomSessionPlayback documentation](/browser-sdk/reference/video/roomsession-playback) for more details.
...
- **getRecordings**(): `Promise<{ recordings: RoomSessionRecording}>` - See [RoomSessionRecording documentation](/browser-sdk/reference/video/roomsession-recording) for more details.

Obtains a list of recordings for the current room session. To download the actual mp4 file, please use the [REST API](/rest).

#### Returns

`Promise<{ recordings: RoomSessionRecording}>` - See [RoomSessionRecording documentation](/browser-sdk/reference/video/roomsession-recording) for more details.
...
- **getStreams**(): `Promise<{ streams: RoomSessionStream}>` - See [RoomSessionStream documentation](/browser-sdk/reference/video/roomsession-stream) for more details.
...
`Promise<{ streams: RoomSessionStream}>` - See [RoomSessionStream documentation](/browser-sdk/reference/video/roomsession-stream) for more details.
...
> ⚠️ Deprecated.
> Use [setHideVideoMuted](/browser-sdk/reference/video/roomsession#sethidevideomuted) instead.
...
- **play**(`params`): `Promise<RoomSessionPlayback>` - See [RoomSessionPlayback documentation](/browser-sdk/reference/video/roomsession-playback) for more details.

Starts a playback in the room. You can use the returned [RoomSessionPlayback](/browser-sdk/reference/video/roomsession-playback) object to control the playback (e.g., pause, resume, setVolume and stop).
...
`Promise<RoomSessionPlayback>` - See [RoomSessionPlayback documentation](/browser-sdk/reference/video/roomsession-playback) for more details.
...
Show or hide muted videos in the room layout. Members that have been muted via [videoMute](/browser-sdk/reference/video/roomsession#videomute) will not appear in the video stream, instead of appearing as a mute image, if this setting is enabled.
...
Sets a layout for the room. You can obtain a list of available layouts with [getLayouts](/browser-sdk/reference/video/roomsession#getlayouts).
...
Show muted videos in the room layout in addition to the unmuted ones. Members that have been muted via [videoMute](/browser-sdk/reference/video/roomsession#videomute) will display a mute image instead of the video.
...
- **startRecording**(): `Promise<RoomSessionRecording>` - See [RoomSessionRecording documentation](/browser-sdk/reference/video/roomsession-recording) for more details.

Starts the recording of the room. You can use the returned [RoomSessionRecording](/browser-sdk/reference/video/roomsession-recording) object to control the recording (e.g., pause, resume, stop).

#### Returns

`Promise<RoomSessionRecording>` - See [RoomSessionRecording documentation](/browser-sdk/reference/video/roomsession-recording) for more details.
...
- **startScreenShare**(`opts`): `Promise<RoomSessionScreenShare>` - See [RoomSessionScreenShare documentation](/browser-sdk/reference/video/roomsessionscreenshare) for more details.
...
- **startStream**(): `Promise<RoomSessionStream>` - See [RoomSessionStream documentation](/browser-sdk/reference/video/roomsession-stream) for more details.

Starts streaming the audio/video of this room to an external service. You can
use the returned [RoomSessionStream](/browser-sdk/reference/video/roomsession-stream) object to
...
`Promise<RoomSessionStream>` - See [RoomSessionStream documentation](/browser-sdk/reference/video/roomsession-stream) for more details.
...
Note that in addition to allowing a participants to hear the others, this will also automatically unmute the microphone of the target participant (even if there is no `audio_unmute` permission). If you want, you can then manually mute it by calling [audioMute](/browser-sdk/reference/video/roomsession#audiomute).
...
> 📘
> Some browsers do not support output device selection. You can check by calling [WebRTC.supportsMediaOutput](/browser-sdk/webrtc#supportsmediaoutput).
...
A playback has ended. You only receive this event if your token has the `room.playback` permission. The event handler receives a [RoomSessionPlayback](/browser-sdk/reference/video/roomsession-playback) object.
...
A playback has been started. You only receive this event if your token has the `room.playback` permission. The event handler receives a [RoomSessionPlayback](/browser-sdk/reference/video/roomsession-playback) object.
...
An active recording has been stopped. You only receive this event if your token has the `room.recording` permission. The event handler receives a [RoomSessionRecording](/browser-sdk/reference/video/roomsession-recording) object.
...
A recording has been started in the room. You only receive this event if your token has the `room.recording` permission. The event handler receives a [RoomSessionRecording](/browser-sdk/reference/video/roomsession-recording) object.
...
An active recording has been updated. You only receive this event if your token has the `room.recording` permission. The event handler receives a [RoomSessionRecording](/browser-sdk/reference/video/roomsession-recording) object.
...
| Name     | Type                                                 |
|:---------|:-----------------------------------------------------|
| `stream` | [`RoomSessionStream`](/browser-sdk/reference/video/roomsession-stream) |
