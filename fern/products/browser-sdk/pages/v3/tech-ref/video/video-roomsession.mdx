...
<ParamField path="opts" type="Object" required={true}/>

<Indent>
<ParamField path="opts.token" type="string" required={true}>
  SignalWire video room token (get one from the [REST APIs](/rest/signalwire-rest/endpoints/video/create-room-token))
</ParamField>

<ParamField path="opts.applyLocalVideoOverlay" type="boolean" default="true">
  Whether to apply the local-overlay on top of your video.
</ParamField>

<ParamField path="opts.audio" type="boolean | MediaTrackConstraints" default="true" deprecated={true}>
  Audio constraints to use when joining the room. _Deprecated: please use the equivalent parameter in [join](#join)._
</ParamField>

<ParamField path="opts.iceServers" type="RTCIceServer[]">
  List of ICE servers.
</ParamField>

<ParamField path="opts.localStream" type="MediaStream">
  A custom media stream to use in place of a camera.
</ParamField>

<ParamField path="opts.logLevel" type="'trace' | 'debug' | 'info' | 'warn' | 'error' | 'silent'">
  Logging level.
</ParamField>

<ParamField path="opts.rootElement" type="HTMLElement">
  HTML element in which to display the video stream.
</ParamField>

<ParamField path="opts.speakerId" type="string">
  Id of the speaker device to use for audio output. If undefined, picks a default speaker.
</ParamField>

<ParamField path="opts.stopCameraWhileMuted" type="boolean" default="true">
  Whether to stop the camera when the member is muted.
</ParamField>

<ParamField path="opts.stopMicrophoneWhileMuted" type="boolean" default="true">
  Whether to stop the microphone when the member is muted.
</ParamField>

<ParamField path="opts.video" type="boolean | MediaTrackConstraints" default="true" deprecated={true}>
  Video constraints to use when joining the room. _Deprecated: please use the equivalent parameter in [join](#join)._
</ParamField>
</Indent>
...
- `Readonly` **deviceList**: [`RoomSessionDevice`](/browser-sdk/v-3/reference/video/room-session-device)[]

Contains any additional devices added via [addCamera](/browser-sdk/v-3/reference/video/room-session#addcamera), [addMicrophone](/browser-sdk/v-3/reference/video/room-session#addmicrophone), or [addDevice](/browser-sdk/v-3/reference/video/room-session#adddevice).
...
- `Readonly` **localOverlay**: [`LocalOverlay`](/browser-sdk/v-3/reference/video/local-overlay)
...
- `Readonly` **screenShareList**: [`RoomSessionScreenShare`](/browser-sdk/v-3/reference/video/room-session-screenshare)[]

Contains any local screen shares added to the room via [startScreenShare](/browser-sdk/v-3/reference/video/room-session#startscreenshare).
...
- **addCamera**(`opts`): `Promise<RoomSessionDevice>` - See [RoomSessionDevice documentation](/browser-sdk/v-3/reference/video/room-session-device) for more details.
...
<ParamField path="opts" type="MediaTrackConstraints & { autoJoin?: boolean }" required={true}>
...
`Promise<RoomSessionDevice>` - See [RoomSessionDevice documentation](/browser-sdk/v-3/reference/video/room-session-device) for more details.
...
- **addDevice**(`opts`): `Promise<RoomSessionDevice>` - See [RoomSessionDevice documentation](/browser-sdk/v-3/reference/video/room-session-device) for more details.

Adds a device to the room. Using this method, a user can stream multiple sources at the same time. If you need to add a camera device or a microphone device, you can alternatively use the more specific methods [addCamera](/browser-sdk/v-3/reference/video/room-session#addcamera) and [addMicrophone](/browser-sdk/v-3/reference/video/room-session#addmicrophone).
...
<Indent>
<ParamField path="opts.audio" type="boolean | MediaTrackConstraints">
  Audio constraints.
</ParamField>

<ParamField path="opts.autoJoin" type="boolean" default="true">
  Whether the device should automatically join the room.
</ParamField>

<ParamField path="opts.video" type="boolean | MediaTrackConstraints">
  Video constraints.
</ParamField>
</Indent>
...
- **addMicrophone**(`opts`): `Promise<RoomSessionDevice>` - See [RoomSessionDevice documentation](/browser-sdk/v-3/reference/video/room-session-device) for more details.
...
- **createScreenShareObject**(`opts`): `Promise<RoomSessionScreenShare>` - See [RoomSessionScreenShare documentation](/browser-sdk/v-3/reference/video/room-session-screenshare) for more details.


> ⚠️ Deprecated.
> Use [startScreenShare](/browser-sdk/v-3/reference/video/room-session#startscreenshare) instead.
...
<Indent>
<ParamField path="opts.audio" type="boolean | MediaTrackConstraints" default="true">
  Audio constraints to use when joining the room.
</ParamField>

<ParamField path="opts.autoJoin" type="boolean">
  Whether the screen share object should automatically join the room.
</ParamField>

<ParamField path="opts.video" type="boolean | MediaTrackConstraints" default="true">
...
`Promise<RoomSessionScreenShare>` - See [RoomSessionScreenShare documentation](/browser-sdk/v-3/reference/video/room-session-screenshare) for more details.
...
Note that in addition to making a participant deaf, this will also automatically mute the microphone of the target participant (even if there is no `audio_mute` permission). If you want, you can then manually unmute it by calling [audioUnmute](/browser-sdk/v-3/reference/video/room-session#audiounmute).
...
<Indent>
<ParamField path="params.keys" type="string[]" required={true}>
  The keys to remove.
</ParamField>
...
<ParamField path="keys" type="string[]" required={true}>
  The keys to remove.
</ParamField>
...
<Indent>
<ParamField path="params.mediaAllowed" type="'all' | 'audio-only' | 'video-only'">
...
- **getPlaybacks**(): `Promise<{ playbacks: RoomSessionPlayback }>` - See [RoomSessionPlayback documentation](/browser-sdk/v-3/reference/video/room-session-playback) for more details.
...
`Promise<{ playbacks: RoomSessionPlayback }>` - See [RoomSessionPlayback documentation](/browser-sdk/v-3/reference/video/room-session-playback) for more details.
...
- **getRecordings**(): `Promise<{ recordings: RoomSessionRecording}>` - See [RoomSessionRecording documentation](/browser-sdk/v-3/reference/video/room-session-recording) for more details.

Obtains a list of recordings for the current room session. To download the actual mp4 file, please use the [REST API](/rest).

#### Returns

`Promise<{ recordings: RoomSessionRecording}>` - See [RoomSessionRecording documentation](/browser-sdk/v-3/reference/video/room-session-recording) for more details.
...
- **getStreams**(): `Promise<{ streams: RoomSessionStream}>` - See [RoomSessionStream documentation](/browser-sdk/v-3/reference/video/room-session-stream) for more details.
...
`Promise<{ streams: RoomSessionStream}>` - See [RoomSessionStream documentation](/browser-sdk/v-3/reference/video/room-session-stream) for more details.
...
> ⚠️ Deprecated.
> Use [setHideVideoMuted](/browser-sdk/v-3/reference/video/room-session#sethidevideomuted) instead.
...
<Indent>
<ParamField path="params.audio" type="MediaStreamConstraints['audio']" default="true">
  Audio constraints to use when joining the room.
</ParamField>

<ParamField path="params.receiveAudio" type="boolean" default="true">
  Whether to receive audio.
</ParamField>

<ParamField path="params.receiveVideo" type="boolean" default="true">
  Whether to receive video.
</ParamField>

<ParamField path="params.sendAudio" type="boolean" default="true">
  Whether to send audio. This is ignored if the token belongs to an audience member, since they cannot send audio.
</ParamField>

<ParamField path="params.sendVideo" type="boolean" default="true">
  Whether to send video. This is ignored if the token belongs to an audience member, since they cannot send video.
</ParamField>

<ParamField path="params.video" type="MediaStreamConstraints['video']" default="true">
  Video constraints to use when joining the room.
</ParamField>
</Indent>
...
<Markdown src="../../_common/_method_off.mdx" />

---

### on

<Markdown src="../../_common/_method_on.mdx" />

---

### once

<Markdown src="../../_common/_method_once.mdx" />

---

### play

- **play**(`params`): `Promise<RoomSessionPlayback>` - See [RoomSessionPlayback documentation](/browser-sdk/v-3/reference/video/room-session-playback) for more details.

Starts a playback in the room. You can use the returned [RoomSessionPlayback](/browser-sdk/v-3/reference/video/room-session-playback) object to control the playback (e.g., pause, resume, setVolume and stop).
...
<Indent>
<ParamField path="params.url" type="string" required={true}>
  The url (http, https, rtmp, rtmps) of the stream to reproduce.
</ParamField>

<ParamField path="params.layout" type="string">
  Layout to change to when the playback starts.
</ParamField>

<ParamField path="params.positions" type="VideoPositions">
...
<ParamField path="params.seekPosition" type="number" default="0">
  The starting timecode in milliseconds for playback.
</ParamField>

<ParamField path="params.volume" type="number" default="0">
  The audio volume at which to play the stream. Values range from -50 to 50.
</ParamField>
</Indent>

#### Returns

`Promise<RoomSessionPlayback>` - See [RoomSessionPlayback documentation](/browser-sdk/v-3/reference/video/room-session-playback) for more details.
...
<ParamField path="params.joinAudioMuted" type="boolean">
  Force the member's audio to be muted right after the promotion.
</ParamField>

<ParamField path="params.joinVideoMuted" type="boolean">
...
<ParamField path="params.meta" type="Record<string, unknown>">
  Metadata to assign to the member.
</ParamField>

<ParamField path="params.permissions" type="string[]">
...
<Markdown src="../../_common/_method_removealllisteners.mdx" />
...
<ParamField path="dtmf" type="string" required={true}>
...
Show or hide muted videos in the room layout. Members that have been muted via [videoMute](/browser-sdk/v-3/reference/video/room-session#videomute) will not appear in the video stream, instead of appearing as a mute image, if this setting is enabled.
...
Sets a layout for the room. You can obtain a list of available layouts with [getLayouts](/browser-sdk/v-3/reference/video/room-session#getlayouts).
...
<Indent>
<ParamField path="params.name" type="string" required={true}>
  Name of the layout.
</ParamField>
...
<ParamField path="stream" type="MediaStream" required={true}>
...
<Indent>
<ParamField path="params.meta" type="Record<string, unknown>" required={true}>
...
<Indent>
<ParamField path="params.position" type="VideoPosition" required={true}>
...
<ParamField path="meta" type="Record<string, unknown>" required={true}>
...
<Indent>
<ParamField path="params.positions" type="VideoPositions" required={true}>
...
<ParamField path="param" type="boolean" default="true">
...
<ParamField path="params.raised" type="boolean" default="true">
  Whether to raise or lower the hand. If omitted, the hand status is toggled to the opposite of the current status.
</ParamField>
</Indent>
...
Show muted videos in the room layout in addition to the unmuted ones. Members that have been muted via [videoMute](/browser-sdk/v-3/reference/video/room-session#videomute) will display a mute image instead of the video.
...
- **startRecording**(): `Promise<RoomSessionRecording>` - See [RoomSessionRecording documentation](/browser-sdk/v-3/reference/video/room-session-recording) for more details.

Starts the recording of the room. You can use the returned [RoomSessionRecording](/browser-sdk/v-3/reference/video/room-session-recording) object to control the recording (e.g., pause, resume, stop).

#### Returns

`Promise<RoomSessionRecording>` - See [RoomSessionRecording documentation](/browser-sdk/v-3/reference/video/room-session-recording) for more details.
...
- **startScreenShare**(`opts`): `Promise<RoomSessionScreenShare>` - See [RoomSessionScreenShare documentation](/browser-sdk/v-3/reference/video/room-session-screenshare) for more details.
...
<Indent>
<ParamField path="opts.audio" type="boolean | MediaTrackConstraints" default="false">
  Audio constraints to use when joining the room.
</ParamField>
...
<ParamField path="opts.layout" type="string">
  Layout to switch to as soon as the screen share joins the room.
</ParamField>

<ParamField path="opts.positions" type="VideoPositions">
...
- **startStream**(): `Promise<RoomSessionStream>` - See [RoomSessionStream documentation](/browser-sdk/v-3/reference/video/room-session-stream) for more details.

Starts streaming the audio/video of this room to an external service. You can
use the returned [RoomSessionStream](/browser-sdk/v-3/reference/video/room-session-stream) object to
...
`Promise<RoomSessionStream>` - See [RoomSessionStream documentation](/browser-sdk/v-3/reference/video/room-session-stream) for more details.
...
Note that in addition to allowing a participants to hear the others, this will also automatically unmute the microphone of the target participant (even if there is no `audio_unmute` permission). If you want, you can then manually mute it by calling [audioMute](/browser-sdk/v-3/reference/video/room-session#audiomute).
...
> 📘
> Some browsers do not support output device selection. You can check by calling [WebRTC.supportsMediaOutput](/browser-sdk/v-3/reference/webrtc#supportsmediaoutput).
...
<Indent>
<ParamField path="opts.deviceId" type="string" required={true}>
...
<ParamField path="e" type="object" required={true}>
</ParamField>

<Indent>
<ParamField path="e.deviceId" type="string" required={true}>
  Device Id for the camera that was disconnected.
</ParamField>

<ParamField path="e.label" type="string" required={true}>
...
<Indent>
<ParamField path="e.current" type="object" required={true}>
  Incoming information on the camera that was updated.
</ParamField>

<Indent>
<ParamField path="e.current.deviceId" type="string" required={true}>
  Current device Id for the camera.
</ParamField>

<ParamField path="e.current.label" type="string" required={true}>
  Current label for the camera.
</ParamField>
</Indent>

<ParamField path="e.previous" type="object" required={true}>
  Previous information on the camera that was updated.
</ParamField>

<Indent>
<ParamField path="e.previous.deviceId" type="string" required={true}>
  Previous device Id for the camera.
</ParamField>

<ParamField path="e.previous.label" type="string" required={true}>
...
A playback has ended. You only receive this event if your token has the `room.playback` permission. The event handler receives a [RoomSessionPlayback](/browser-sdk/v-3/reference/video/room-session-playback) object.
...
A playback has been started. You only receive this event if your token has the `room.playback` permission. The event handler receives a [RoomSessionPlayback](/browser-sdk/v-3/reference/video/room-session-playback) object.
...
An active recording has been stopped. You only receive this event if your token has the `room.recording` permission. The event handler receives a [RoomSessionRecording](/browser-sdk/v-3/reference/video/room-session-recording) object.
...
A recording has been started in the room. You only receive this event if your token has the `room.recording` permission. The event handler receives a [RoomSessionRecording](/browser-sdk/v-3/reference/video/room-session-recording) object.
...
An active recording has been updated. You only receive this event if your token has the `room.recording` permission. The event handler receives a [RoomSessionRecording](/browser-sdk/v-3/reference/video/room-session-recording) object.
...
| Name     | Type                                                 |
|:---------|:-----------------------------------------------------|
| `stream` | [`RoomSessionStream`](/browser-sdk/v-3/reference/video/room-session-stream) |
