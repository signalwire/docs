...
- `Readonly` **deviceList**: [`RoomSessionDevice`](/browser-sdk/video/room-session-device)[]

Contains any additional devices added via [addCamera](/browser-sdk/video/room-session#addcamera), [addMicrophone](/browser-sdk/video/room-session#addmicrophone), or [addDevice](/browser-sdk/video/room-session#adddevice).
...
- `Readonly` **localOverlay**: [`LocalOverlay`](/browser-sdk/video/local-overlay)
...
- `Readonly` **screenShareList**: [`RoomSessionScreenShare`](/browser-sdk/video/room-session-screenshare)[]

Contains any local screen shares added to the room via [startScreenShare](/browser-sdk/video/room-session#startscreenshare).
...
- **addCamera**(`opts`): `Promise<RoomSessionDevice>` - See [RoomSessionDevice documentation](/browser-sdk/video/room-session-device) for more details.
...
`Promise<RoomSessionDevice>` - See [RoomSessionDevice documentation](/browser-sdk/video/room-session-device) for more details.
...
- **addDevice**(`opts`): `Promise<RoomSessionDevice>` - See [RoomSessionDevice documentation](/browser-sdk/video/room-session-device) for more details.

Adds a device to the room. Using this method, a user can stream multiple sources at the same time. If you need to add a camera device or a microphone device, you can alternatively use the more specific methods [addCamera](/browser-sdk/video/room-session#addcamera) and [addMicrophone](/browser-sdk/video/room-session#addmicrophone).
...
- **addMicrophone**(`opts`): `Promise<RoomSessionDevice>` - See [RoomSessionDevice documentation](/browser-sdk/video/room-session-device) for more details.
...
> ⚠️ Deprecated.
> Use [startScreenShare](/browser-sdk/video/room-session#startscreenshare) instead.
...
Note that in addition to making a participant deaf, this will also automatically mute the microphone of the target participant (even if there is no `audio_mute` permission). If you want, you can then manually unmute it by calling [audioUnmute](/browser-sdk/video/room-session#audiounmute).
...
- **play**(`params`): `Promise<RoomSessionPlayback>` - See [RoomSessionPlayback documentation](/browser-sdk/video/room-session-playback) for more details.

Starts a playback in the room. You can use the returned [RoomSessionPlayback](/browser-sdk/video/room-session-playback) object to control the playback (e.g., pause, resume, setVolume and stop).
...
`Promise<RoomSessionPlayback>` - See [RoomSessionPlayback documentation](/browser-sdk/video/room-session-playback) for more details.
...
Sets a layout for the room. You can obtain a list of available layouts with [getLayouts](/browser-sdk/video/room-session#getlayouts).
...
- **startScreenShare**(`opts`): `Promise<RoomSessionScreenShare>` - See [RoomSessionScreenShare documentation](/browser-sdk/video/room-session-screenshare) for more details.
...
Note that in addition to allowing a participants to hear the others, this will also automatically unmute the microphone of the target participant (even if there is no `audio_unmute` permission). If you want, you can then manually mute it by calling [audioMute](/browser-sdk/video/room-session#audiomute).
...
A playback has ended. You only receive this event if your token has the `room.playback` permission. The event handler receives a [RoomSessionPlayback](/browser-sdk/video/room-session-playback) object.
...
A playback has been started. You only receive this event if your token has the `room.playback` permission. The event handler receives a [RoomSessionPlayback](/browser-sdk/video/room-session-playback) object.
...
An active recording has been stopped. You only receive this event if your token has the `room.recording` permission. The event handler receives a [RoomSessionRecording](/browser-sdk/video/room-session-recording) object.
...
A recording has been started in the room. You only receive this event if your token has the `room.recording` permission. The event handler receives a [RoomSessionRecording](/browser-sdk/video/room-session-recording) object.
...
An active recording has been updated. You only receive this event if your token has the `room.recording` permission. The event handler receives a [RoomSessionRecording](/browser-sdk/video/room-session-recording) object.
...
| Name     | Type                                                 |
|:---------|:-----------------------------------------------------|
| `stream` | [`RoomSessionStream`](/browser-sdk/video/room-session-stream) |
