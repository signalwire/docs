...
If you have passed a `rootElement` when [instantiating the SignalWire client](/browser-sdk/v-3/reference/signalwire-client/client#instantiation), or
when [`dial`](/browser-sdk/v-3/reference/signalwire-client/client#dial)ing a call, the SDK will manage the DOM automatically; injecting the resulting video stream
...
| `options.room`                   | [`CallFabricRoomSession`](/browser-sdk/v-3/reference/signalwire-client/client#callfabricroomsession) | Required  | The Call Fabric Room Session to build the video element for                                                                                                                                          |
...
After the [SignalWire Client](/browser-sdk/v-3/reference/signalwire-client/client) has been [instantiated](/browser-sdk/v-3/reference/signalwire-client/client#instantiation), you can
