...
[access token]: /browser-sdk/reference/call-fabric/call-fabric-overview#authentication
...
You can manage the DOM yourself by not specifying a `rootElement` here and using the [`buildVideoElement`](/browser-sdk/reference/call-fabric/utils#buildvideoelement) function instead.
...
[`Address`]: /browser-sdk/reference/call-fabric/address
[`Chat`]: /browser-sdk/reference/call-fabric/chat
[`Conversation`]: /browser-sdk/reference/call-fabric/conversation


<CardGroup cols={3}>
  <Card title="Address" href="/browser-sdk/reference/call-fabric/address">
    Methods for working with addresses
  </Card>
  <Card title="Chat" href="/browser-sdk/reference/call-fabric/chat">
    Methods for chat functionality
  </Card>
  <Card title="Conversation" href="/browser-sdk/reference/call-fabric/conversation">
