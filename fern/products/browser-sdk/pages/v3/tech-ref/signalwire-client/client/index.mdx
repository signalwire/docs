...
[access token]: /browser-sdk/v-3/reference/signalwire-client#authentication
...
You can manage the DOM yourself by not specifying a `rootElement` here and using the [`buildVideoElement`](/browser-sdk/v-3/reference/signalwire-client/utils#buildvideoelement) function instead.
...
[`Address`]: /browser-sdk/v-3/reference/signalwire-client/client/address
[`Chat`]: /browser-sdk/v-3/reference/signalwire-client/client/chat
[`Conversation`]: /browser-sdk/v-3/reference/signalwire-client/client/conversation


<CardGroup cols={3}>
  <Card title="Address" href="/browser-sdk/v-3/reference/signalwire-client/client/address">
    Methods for working with addresses
  </Card>
  <Card title="Chat" href="/browser-sdk/v-3/reference/signalwire-client/client/chat">
    Methods for chat functionality
  </Card>
  <Card title="Conversation" href="/browser-sdk/v-3/reference/signalwire-client/client/conversation">
