...
This is the same function as [`conversation.sendMessage`](/browser-sdk/reference/call-fabric/conversation#sendmessage).
...
were already joined to the conversation. This is the same function as [`conversation.join`](/browser-sdk/reference/call-fabric/conversation#join).
