...
This is the same function as [`conversation.sendMessage`](/browser-sdk/v-3/reference/signalwire-client/client/conversation#sendmessage).
...
were already joined to the conversation. This is the same function as [`conversation.join`](/browser-sdk/v-3/reference/signalwire-client/client/conversation#join).
