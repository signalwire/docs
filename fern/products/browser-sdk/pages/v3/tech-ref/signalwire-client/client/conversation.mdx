...
Sends a Chat Message to the Conversation. This is the same function as [`chat.sendMessage`](/browser-sdk/v-3/reference/signalwire-client/client/chat#sendmessage).
...
were already joined to the conversation. This is the same function as [`chat.join`](/browser-sdk/v-3/reference/signalwire-client/client/chat#join).
