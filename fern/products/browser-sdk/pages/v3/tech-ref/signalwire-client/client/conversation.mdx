...
Sends a Chat Message to the Conversation. This is the same function as [`chat.sendMessage`](/browser-sdk/reference/call-fabric/chat#sendmessage).
...
were already joined to the conversation. This is the same function as [`chat.join`](/browser-sdk/reference/call-fabric/chat#join).
