...
An object representing a Chat Message with only the state properties of [`ChatMessage`](/browser-sdk/v-3/reference/chat/chat-message).
...
- `Readonly` **member**: [`ChatMember`](/browser-sdk/v-3/reference/chat/chat-member)
