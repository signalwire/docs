...
An object representing a Chat Message with only the state properties of [`ChatMessage`](/browser-sdk/reference/chat/chat-message).
...
- `Readonly` **member**: [`ChatMember`](/browser-sdk/reference/chat/chat-member)
