...
- **getMembers**(`params`): `Promise<{ members: ChatMemberEntity[] }>` - See [ChatMemberEntity documentation](/browser-sdk/v-3/reference/chat/chat-member-entity) for more details.
...
`Promise<{ members: ChatMemberEntity[] }>` - See [ChatMemberEntity documentation](/browser-sdk/v-3/reference/chat/chat-member-entity) for more details.
...
See [PagingCursor documentation](#paginationcursor) and [ChatMessageEntity documentation](/browser-sdk/v-3/reference/chat/chat-message-entity) for more details.
...
| Name     | Type                                 |
|:---------|:-------------------------------------|
| `member` | [`ChatMember`](/browser-sdk/v-3/reference/chat/chat-member) |
...
| Name      | Type                                   |
|:----------|:---------------------------------------|
| `message` | [`ChatMessage`](/browser-sdk/v-3/reference/chat/chat-message) |
