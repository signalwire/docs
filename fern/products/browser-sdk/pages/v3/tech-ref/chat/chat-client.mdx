...
- **getMembers**(`params`): `Promise<{ members: ChatMemberEntity[] }>` - See [ChatMemberEntity documentation](/browser-sdk/reference/chat/chatmemberentity) for more details.
...
`Promise<{ members: ChatMemberEntity[] }>` - See [ChatMemberEntity documentation](/browser-sdk/reference/chat/chatmemberentity) for more details.
...
See [PagingCursor documentation](#paginationcursor) and [ChatMessageEntity documentation](/browser-sdk/reference/chat/chatmessageentity) for more details.
...
| Name     | Type                                 |
|:---------|:-------------------------------------|
| `member` | [`ChatMember`](/browser-sdk/reference/chat/chat-member) |
...
| Name      | Type                                   |
|:----------|:---------------------------------------|
| `message` | [`ChatMessage`](/browser-sdk/reference/chat/chat-message) |
