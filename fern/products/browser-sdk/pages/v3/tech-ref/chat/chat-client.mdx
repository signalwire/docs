...
- **getMembers**(`params`): `Promise<{ members: ChatMemberEntity[] }>` - See [ChatMemberEntity documentation](/browser-sdk/chat/member-entity) for more details.
...
`Promise<{ members: ChatMemberEntity[] }>` - See [ChatMemberEntity documentation](/browser-sdk/chat/member-entity) for more details.
...
See [PagingCursor documentation](#paginationcursor) and [ChatMessageEntity documentation](/browser-sdk/chat/message-entity) for more details.
...
| Name     | Type                                 |
|:---------|:-------------------------------------|
| `member` | [`ChatMember`](/browser-sdk/chat/member) |
...
| Name      | Type                                   |
|:----------|:---------------------------------------|
| `message` | [`ChatMessage`](/browser-sdk/chat/message) |
