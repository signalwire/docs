...
<Card title="RoomSession" href="/docs/browser-sdk/v3/js/reference/video/room-session" icon="fa-regular fa-star">
...
<CardGroup cols={2}>
  ...
  <Card title="~~RoomDevice~~" href="/docs/browser-sdk/v3/js/reference/video/room-session-device" icon="fa-regular fa-warning" iconSize={4} >
    *Use [RoomSessionDevice](/docs/browser-sdk/v3/js/reference/video/room-session-device) instead.*
  </Card>
  <Card title="~~RoomScreenShare~~" href="/docs/browser-sdk/v3/js/reference/video/room-session-screen-share" icon="fa-regular fa-warning" iconSize={4} >
