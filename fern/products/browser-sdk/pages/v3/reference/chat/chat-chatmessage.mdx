---
id: e1cee217-fd55-4a2e-ba09-adba892bd96f
title: "ChatMessage"
...
<ParamField path="payload" type="ChatMessage" required={true} toc={true}>
...
**Returns:** [`ChatMember`](/docs/browser-sdk/v3/js/reference/chat/chat-member)
