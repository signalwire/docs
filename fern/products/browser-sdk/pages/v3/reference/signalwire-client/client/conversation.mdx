---
id: ca333ef7-ccfe-47c7-ba4b-dd5dfc15f0b8
...
Conversation objects represent interaction pairs between [Subscribers](/docs/platform/subscribers) and Addresses. Each Conversation object has the following properties:
...
Sends a Chat Message to the Conversation. This is the same function as [`chat.sendMessage`](/docs/browser-sdk/v3/js/reference/signalwire/client/chat#sendmessage).
...
were already joined to the conversation. This is the same function as [`chat.join`](/docs/browser-sdk/v3/js/reference/signalwire/client/chat#join).
