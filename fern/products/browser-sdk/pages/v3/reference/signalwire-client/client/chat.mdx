---
id: 4d247641-7d1b-4fc4-89e8-134e9f65f21c
...
- `user_id`: A unique identifier for the [subscriber](/docs/platform/subscribers).
...
This is the same function as [`conversation.sendMessage`](/docs/browser-sdk/v3/js/reference/signalwire/client/conversation#sendmessage).
...
were already joined to the conversation. This is the same function as [`conversation.join`](/docs/browser-sdk/v3/js/reference/signalwire/client/conversation#join).
