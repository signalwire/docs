...
If you haven't yet set up a video conference project using the Video SDK, you can check out the [build a video application](/docs/browser-sdk/v3/js/guides/build-a-video-app) guide first. After you have a video application set up, you can continue with this guide.
