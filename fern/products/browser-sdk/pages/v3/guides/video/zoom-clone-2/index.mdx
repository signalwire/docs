...
3. We perform an HTTP POST request using Axios to the [room_tokens](/docs/apis/rest/video/room-tokens/create-room-token) endpoint.
...
[RoomSession](/docs/apis/rest/video/rooms/create-room) object
...
We can query for the list of active room sessions via the REST API at the [room_sessions](/docs/apis/rest/video/room-sessions/list-room-sessions) endpoint. Sending a GET request to this endpoint with a query parameter `status` set to `in-progress` will get us the list of active room sessions.
