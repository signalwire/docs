...
As a first option, you can use [RTMP Streaming](/browser-sdk/v-3/guides/video/streaming-to-youtube-and-other-platforms).
...
[promote](/browser-sdk/v-3/reference/video/room-session#promote)
method:
...
[demote](/browser-sdk/v-3/reference/video/room-session#demote)
method:
...
generation communication platforms. Make sure to check out our [technical documentation](/browser-sdk/v-3/reference/video/room-session#promote).
