...
To start sharing the screen, you need to call the [RoomSession.startScreenShare()](/browser-sdk/reference/video/roomsession#startscreenshare) method. This will make the browser prompt your user with the browser's screen share dialog.
...
[RoomSession.startScreenShare()](/browser-sdk/reference/video/roomsession#startscreenshare) asynchronously returns a [RoomSessionScreenShare](/browser-sdk/reference/video/roomsessionscreenshare) object.  
To stop the video feed, simply call the [RoomSessionScreenShare.leave()](/browser-sdk/reference/video/roomsessionscreenshare#leave) method.
