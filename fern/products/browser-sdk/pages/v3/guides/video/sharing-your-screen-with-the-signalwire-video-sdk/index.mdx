...
To start sharing the screen, you need to call the [RoomSession.startScreenShare()](/browser-sdk/v-3/reference/video/room-session#startscreenshare) method. This will make the browser prompt your user with the browser's screen share dialog.
...
[RoomSession.startScreenShare()](/browser-sdk/v-3/reference/video/room-session#startscreenshare) asynchronously returns a [RoomSessionScreenShare](/browser-sdk/v-3/reference/video/room-session-screenshare) object.  
To stop the video feed, simply call the [RoomSessionScreenShare.leave()](/browser-sdk/v-3/reference/video/room-session-screenshare#leave) method.
