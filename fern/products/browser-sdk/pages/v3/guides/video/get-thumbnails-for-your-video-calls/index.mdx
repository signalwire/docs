...
For the Video Client SDK running in the browser, the `previewUrl` is available in the same [RoomSession](/browser-sdk/reference/video/roomsession) object you create to start the video call.
