...
<CardGroup cols={2}>
  ...
  <Card title="PubSub" icon="fa-solid fa-tower-broadcast" href="/docs/browser-sdk/js/reference/pub-sub">
    Publish and subscribe to real-time message channels
  </Card>
  <Card title="SignalWire Client" icon="fa-solid fa-server" href="/docs/browser-sdk/js/reference/call-fabric">
    The client for making and receiving calls, playing audio, and recording.
  </Card>
  <Card title="WebRTC" icon="fa-solid fa-globe" href="/docs/browser-sdk/js/reference/web-rtc">
