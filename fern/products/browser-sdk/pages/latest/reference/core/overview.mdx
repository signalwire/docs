...
<Note>
You are currently reading the technical reference for the SignalWire Browser SDK v3. For helpful tutorials and easy getting started guides, 
please refer to the [Guides](/browser-sdk/guides) section.
</Note>
...
<CardGroup cols={2}>
  <Card title="Video" icon="fa-solid fa-video" href="/browser-sdk/reference/video">
    Create and display video rooms, members, recordings, and streams
  </Card>
  <Card title="Chat" icon="fa-solid fa-comments" href="/browser-sdk/reference/chat">
    Build chat applications with members and messages
  </Card>
  <Card title="PubSub" icon="fa-solid fa-tower-broadcast" href="/browser-sdk/reference/pub-sub">
    Publish and subscribe to real-time message channels
  </Card>
  <Card title="SignalWire Client" icon="fa-solid fa-server" href="/browser-sdk/reference/call-fabric">
    The client for making and receiving calls, playing audio, and recording.
  </Card>
  <Card title="WebRTC" icon="fa-solid fa-globe" href="/browser-sdk/reference/web-rtc">
