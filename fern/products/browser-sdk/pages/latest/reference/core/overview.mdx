...
<CardGroup cols={2}>
  <Card title="Video" icon="fa-solid fa-video" href="/docs/browser-sdk/v3/js/reference/video">
    Create and display video rooms, members, recordings, and streams
  </Card>
  <Card title="Chat" icon="fa-solid fa-comments" href="/docs/browser-sdk/v3/js/reference/chat">
    Build chat applications with members and messages
  </Card>
  <Card title="PubSub" icon="fa-solid fa-tower-broadcast" href="/docs/browser-sdk/v3/js/reference/pubsub">
    Publish and subscribe to real-time message channels
  </Card>
  <Card title="SignalWire Client" icon="fa-solid fa-server" href="/docs/browser-sdk/v3/js/reference/signalwire">
    The client for making and receiving calls, playing audio, and recording.
  </Card>
  <Card title="WebRTC" icon="fa-solid fa-globe" href="/docs/browser-sdk/v3/js/reference/webrtc">
