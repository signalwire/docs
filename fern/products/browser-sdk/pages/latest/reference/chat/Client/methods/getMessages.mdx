...
title: getMessages
slug: /reference/chat/client/get-messages
max-toc-depth: 3
---
...
See [PagingCursor documentation](/browser-sdk/chat/client#paginationcursor) and [ChatMessageEntity documentation](/browser-sdk/chat/message-entity) for more details.
...
<Indent>
  ...
  <ParamField path="params.cursor" type="PagingCursor">
    Cursor for pagination. See [PagingCursor](/browser-sdk/chat/client#paginationcursor) for more details.
  </ParamField>
</Indent>
