...
See [PagingCursor documentation](/browser-sdk/js/reference/chat/client#paginationcursor) and [ChatMessageEntity documentation](/browser-sdk/js/reference/chat/chat-message-entity) for more details.
...
<Indent>
  ...
  <ParamField path="params.cursor" type="PagingCursor">
    Cursor for pagination. See [PagingCursor](/browser-sdk/js/reference/chat/client#paginationcursor) for more details.
  </ParamField>
</Indent>
