...
For device-specific helpers, see [createCameraDeviceWatcher](docs/browser-sdk/reference/webrtc/functions/create-camera-device-watcher), [createMicrophoneDeviceWatcher](docs/browser-sdk/reference/webrtc/functions/create-microphone-device-watcher), and [createSpeakerDeviceWatcher](docs/browser-sdk/reference/webrtc/functions/create-speaker-device-watcher).
