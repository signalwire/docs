...
slug: /reference/webrtc/create-device-watcher
...
For device-specific helpers, see [createCameraDeviceWatcher](/browser-sdk/reference/webrtc/functions/create-camera-device-watcher), [createMicrophoneDeviceWatcher](/browser-sdk/reference/webrtc/functions/create-microphone-device-watcher), and [createSpeakerDeviceWatcher](/browser-sdk/reference/webrtc/functions/create-speaker-device-watcher).
