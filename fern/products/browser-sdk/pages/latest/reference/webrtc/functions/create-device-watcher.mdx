...
For device-specific helpers, see [createCameraDeviceWatcher](/browser-sdk/js/reference/webrtc/create-camera-device-watcher), [createMicrophoneDeviceWatcher](/browser-sdk/js/reference/webrtc/create-microphone-device-watcher), and [createSpeakerDeviceWatcher](/browser-sdk/js/reference/webrtc/create-speaker-device-watcher).
