...
slug: /reference/signalwire-client/utils
max-toc-depth: 3
---
...
If you have passed a `rootElement` when [instantiating the SignalWire client](/browser-sdk/signalwire-client/client#instantiation), or
when [`dial`](/browser-sdk/signalwire-client/client#dial)ing a call, the SDK will manage the DOM automatically; injecting the resulting video stream
...
| `options.room`                   | [`CallFabricRoomSession`](/browser-sdk/signalwire-client/client#callfabricroomsession) | Required  | The Call Fabric Room Session to build the video element for                                                                                                                                          |
...
After the [SignalWire Client](/browser-sdk/signalwire-client/client) has been [instantiated](/browser-sdk/signalwire-client/client#instantiation), you can
