...
If you have passed a `rootElement` when [instantiating the SignalWire client](/docs/browser-sdk/signalwire-client/client#instantiation), or
when [`dial`](/docs/browser-sdk/signalwire-client/client#dial)ing a call, the SDK will manage the DOM automatically; injecting the resulting video stream
...
| `options.room`                   | [`CallFabricRoomSession`](/docs/browser-sdk/signalwire-client/client#callfabricroomsession) | Required  | The Call Fabric Room Session to build the video element for                                                                                                                                          |
...
After the [SignalWire Client](/docs/browser-sdk/signalwire-client/client) has been [instantiated](/docs/browser-sdk/signalwire-client/client#instantiation), you can
