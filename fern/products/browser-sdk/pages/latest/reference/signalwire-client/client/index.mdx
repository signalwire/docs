...
<CardGroup cols={3}>
  <Card title="dial" href="/docs/browser-sdk/js/reference/signalwire/client/methods/dial">
    Dial to an address
  </Card>
  <Card title="online" href="/docs/browser-sdk/js/reference/signalwire/client/methods/online">
    Go online to receive call invites
  </Card>
  <Card title="offline" href="/docs/browser-sdk/js/reference/signalwire/client/methods/offline">
    Go offline to stop receiving call invites
  </Card>
  <Card title="getSubscriberInfo" href="/docs/browser-sdk/js/reference/signalwire/client/methods/get-subscriber-info">
    Get info about the current subscriber
  </Card>
  <Card title="connect" href="/docs/browser-sdk/js/reference/signalwire/client/methods/connect">
    Connect the WebSocket client
  </Card>
  <Card title="disconnect" href="/docs/browser-sdk/js/reference/signalwire/client/methods/disconnect">
    Disconnect the WebSocket client
  </Card>
  <Card title="updateToken" href="/docs/browser-sdk/js/reference/signalwire/client/methods/update-token">
