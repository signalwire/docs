...
Sends a Chat Message to the Conversation. This is the same function as [`chat.sendMessage`](docs/browser-sdk/signalwire-client/client/chat#sendmessage).
...
were already joined to the conversation. This is the same function as [`chat.join`](docs/browser-sdk/signalwire-client/client/chat#join).
