...
slug: /reference/signalwire-client/client/conversation
max-toc-depth: 3
---
...
Sends a Chat Message to the Conversation. This is the same function as [`chat.sendMessage`](/browser-sdk/signalwire-client/client/chat#sendmessage).
...
were already joined to the conversation. This is the same function as [`chat.join`](/browser-sdk/signalwire-client/client/chat#join).
