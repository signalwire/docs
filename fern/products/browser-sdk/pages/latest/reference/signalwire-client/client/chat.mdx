...
slug: /reference/signalwire-client/client/chat
---
...
This is the same function as [`conversation.sendMessage`](/browser-sdk/signalwire-client/client/conversation#sendmessage).
...
were already joined to the conversation. This is the same function as [`conversation.join`](/browser-sdk/signalwire-client/client/conversation#join).
