...
This is the same function as [`conversation.sendMessage`](docs/browser-sdk/signalwire-client/client/conversation#sendmessage).
...
were already joined to the conversation. This is the same function as [`conversation.join`](docs/browser-sdk/signalwire-client/client/conversation#join).
