...
Note that the `subscribe` function is idempotent, and calling it again with a different set of channels _will not_ unsubscribe you from the old ones. To unsubscribe, use [unsubscribe](/browser-sdk/js/reference/pubsub/client/unsubscribe).
