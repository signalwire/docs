...
Instances of this class allow you to control (e.g., pause, resume, stop) the playback inside a room session. You can obtain instances of this class by starting a playback from the desired [RoomSession](/browser-sdk/js/reference/video/room-session) (see [RoomSession.play](/browser-sdk/js/reference/video/room-session/play)).
