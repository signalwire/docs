...
slug: /reference/video/room-session-stream
---
...
You can start a stream with [RoomSession.startStream](/browser-sdk/reference/video/room-session/methods/start-stream).
