...
- **addMicrophone**(`opts`): `Promise<RoomSessionDevice>` - See [RoomSessionDevice documentation](/docs/browser-sdk/video/room-session-device) for more details.
...
`Promise<RoomSessionDevice>` - See [RoomSessionDevice documentation](/docs/browser-sdk/video/room-session-device) for more details.
