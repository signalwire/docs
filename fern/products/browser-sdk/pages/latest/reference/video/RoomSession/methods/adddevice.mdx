...
- **addDevice**(`opts`): `Promise<RoomSessionDevice>` - See [RoomSessionDevice documentation](docs/browser-sdk/reference/video/room-session-device) for more details.

Adds a device to the room. Using this method, a user can stream multiple sources at the same time. If you need to add a camera device or a microphone device, you can alternatively use the more specific methods [addCamera](docs/browser-sdk/reference/video/room-session/methods/add-camera) and [addMicrophone](docs/browser-sdk/reference/video/room-session/methods/add-microphone).
...
`Promise<RoomSessionDevice>` - See [RoomSessionDevice documentation](docs/browser-sdk/reference/video/room-session-device) for more details.
