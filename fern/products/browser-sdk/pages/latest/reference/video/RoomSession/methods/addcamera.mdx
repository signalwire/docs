...
- **addCamera**(`opts`): `Promise<RoomSessionDevice>` - See [RoomSessionDevice documentation](/docs/browser-sdk/v3/js/reference/video/room-session-device) for more details.
