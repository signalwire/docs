...
- **startScreenShare**(`opts`): `Promise<RoomSessionScreenShare>` - See [RoomSessionScreenShare documentation](/docs/browser-sdk/v3/js/reference/video/room-session/create-screen-share-object) for more details.
