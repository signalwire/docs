...
Note that in addition to making a participant deaf, this will also automatically mute the microphone of the target participant (even if there is no `audio_mute` permission). If you want, you can then manually unmute it by calling [audioUnmute](/docs/browser-sdk/reference/video/room-session/methods/audio-unmute).
