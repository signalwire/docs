...
<CardGroup cols={2}>
  <Card title="Getting Started with the SignalWire Video SDK" href="/docs/browser-sdk/v3/js/guides/build-a-video-app" icon="fa-solid fa-star">
...
<Card title="Get Started with a Chat Application" href="/docs/browser-sdk/v3/js/guides/chat/build-a-react-application" icon="fa-solid fa-star">
