...
sidebar_custom_props:
  platform: javascript
slug: /guides/streaming-to-youtube-and-other-platforms
---
...
While this demo used a PVC, you can use the same methods on a video room without the prebuilt UI. For a complete guide on building video rooms without a prebuilt UI, see [Simple Video Demo](/browser-sdk/guides/building-a-video-calling-application-with-the-browser-sdk). From there, you can add start and stop stream buttons and hook them up in the same way as above.
