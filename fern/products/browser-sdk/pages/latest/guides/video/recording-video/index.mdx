...
[`record_on_start`](/docs/apis/rest/video/rooms/create-room) option while creating the room. Further, you have to make
...
precisely from your server, use the [SDK's Video API](/docs/server-sdks/reference/python/rest/video/room-sessions). The SDK
exposes room session management similar to the [Browser SDK](/docs/browser-sdk/v3/js/reference/video/room-session), so you
...
[`https://<space_name>.signalwire.com/api/video/room_recordings`](/docs/apis/rest/video/room-recordings/list-room-recordings).
