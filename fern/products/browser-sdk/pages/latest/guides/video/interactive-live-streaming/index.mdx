...
[promote](/browser-sdk/video/room-session#promote)
method:
...
[demote](/browser-sdk/video/room-session#demote)
method:
...
generation communication platforms. Make sure to check out our [technical documentation](/browser-sdk/video/room-session#promote).
