...
As a first option, you can use [RTMP Streaming](/docs/browser-sdk/guides/video/streaming-to-youtube-and-other-platforms).
...
[RoomSession](/docs/browser-sdk/video/room-session).
...
our [Simple Video Demo](/docs/browser-sdk/guides/build-a-video-calling-application-with-the-browser-sdk).
...
[promote](/docs/browser-sdk/reference/video/room-session/methods/promote)
method:
...
[demote](/docs/browser-sdk/video/room-session/methods/demote)
method:
...
generation communication platforms. Make sure to check out our [technical documentation](/docs/browser-sdk/reference/video/room-session/methods/promote).
