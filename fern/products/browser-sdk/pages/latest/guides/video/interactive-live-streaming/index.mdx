...
As a first option, you can use [RTMP Streaming](/browser-sdk/guides/video/streaming-to-youtube-and-other-platforms).
...
When using the [Browser SDK](/browser-sdk), the kind of
[Video Room Token](/apis/video/room-tokens/create-room-token) that you
...
our [Simple Video Demo](/browser-sdk/guides/build-a-video-calling-application-with-the-browser-sdk).
...
[promote](/browser-sdk/reference/video/room-session/methods/promote)
method:
...
[demote](/browser-sdk/video/room-session/methods/demote)
method:
...
generation communication platforms. Make sure to check out our [technical documentation](/browser-sdk/reference/video/room-session/methods/promote).
If, instead, you are just starting out, then we suggest reading our guide on
[how to get started with the Video APIs](/browser-sdk/js/guides/build-a-video-app).
