...
[promote](/browser-sdk/js/reference/video/room-session/promote)
method:
...
generation communication platforms. Make sure to check out our [technical documentation](/browser-sdk/js/reference/video/room-session/promote).
