...
As a first option, you can use [RTMP Streaming](/docs/browser-sdk/v3/js/guides/interactive-live-streaming).
...
our [Simple Video Demo](/docs/browser-sdk/v3/js/guides/build-a-video-app).
...
[demote](/docs/browser-sdk/v3/js/reference/video/room-session/methods/demote)
method:
