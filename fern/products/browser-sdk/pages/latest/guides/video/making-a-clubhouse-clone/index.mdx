...
<Frame>
  ...
  <video height={400} controls>
    <source
      src="/docs/assets/images/project/clubhouse-like-video.mp4"
      type="video/mp4"
    />
...
- [JavaScript SDK Technical Reference](/docs/browser-sdk) — find here all technical details about the JavaScript SDK.
