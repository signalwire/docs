...
- [The Browser SDK Technical Reference](/docs/browser-sdk) — find here all technical details about the JavaScript SDK.
...
![The API page shows the active Project ID and Space URL, and a list of API tokens organized by Name, Token, and Last Used.](/assets/images/dashboard/credentials/api-credentials.webp)
  ...
  <Folder name="frontend" defaultOpen>
    <Folder name="src" defaultOpen>
      <Folder name="pages" defaultOpen>
        <File name="LoginPage.js" href="https://github.com/signalwire/browser-audioconf-example/blob/master/frontend/src/pages/LoginPage.js" comment="Login screen" />
        <File name="RoomListPage.js" href="https://github.com/signalwire/browser-audioconf-example/blob/master/frontend/src/pages/RoomListPage.js" comment="Browse, join, or create rooms" />
        <File name="RoomPage.js" href="https://github.com/signalwire/browser-audioconf-example/blob/master/frontend/src/pages/RoomPage.js" comment="Active room with participant list" />
      </Folder>
      <Folder name="components" defaultOpen>
        <File name="Audio.js" href="https://github.com/signalwire/browser-audioconf-example/blob/master/frontend/src/components/Audio.js" comment="SignalWire JS SDK integration" />
        <File name="Server.js" href="https://github.com/signalwire/browser-audioconf-example/blob/master/frontend/src/components/Server.js" comment="Server API calls; Room Token retrieval" />
      </Folder>
    </Folder>
  </Folder>
</Files>
