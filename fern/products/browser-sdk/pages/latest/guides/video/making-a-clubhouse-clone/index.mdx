---
title: Making a Clubhouse like application 
description: Learn how to make a Clubhouse clone using the SignalWire Video API.
slug: /guides/making-a-clubhouse-like-application
x-custom:
...
- [JavaScript SDK Technical Reference](/browser-sdk) — find here all technical details about the JavaScript SDK.
