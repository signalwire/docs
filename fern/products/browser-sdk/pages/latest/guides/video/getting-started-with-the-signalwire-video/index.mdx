...
and [video token parameters](/docs/apis/rest/video/room-tokens/create-room-token) in our documentation.
...
please browse the [SDK documentation](/docs/browser-sdk).
...
Find the complete list in our [API reference](/docs/browser-sdk/v3/js/reference/video/room-session/events).
...
[Zoom like application Guide](/docs/browser-sdk/v3/js/guides/zoom-like-application).
