...
![a video call with two participants and a button labeled 'Hang up' beneath the video.](/assets/images/project/simple-video-demo/video-room.webp)
</Frame>
...
You can see a complete list of possible [permissions](/apis/permissions)
and [video token parameters](/apis/video/room-tokens/create-room-token) in our documentation.
...
please browse the [SDK documentation](/browser-sdk).
...
Find the complete list in our [API reference](/browser-sdk/js/reference/video/room-session/events).
...
![SignalWire video call with controls for screen share, layout, audio, and video.](/assets/images/project/simple-video-demo/video-room-final.webp)
</Frame>
...
[Zoom like application Guide](/browser-sdk/guides/making-a-zoom-like-application).
