...
Find the complete list in our [API reference](/docs/browser-sdk/reference/video/room-session/events).
...
[Zoom like application Guide](/docs/browser-sdk/guides/making-a-zoom-like-application).
