---
title: Highlighting the speaker in calls
slug: /guides/highlighing-the-speaker
x-custom:
  tags:
    - product:video
    - language:javascript
...
- [Video Overlays](/browser-sdk/guides/video/video-overlays)
...
- [Simple Video Demo](/browser-sdk/guides/building-a-video-calling-application-with-the-browser-sdk)
- [Video RoomSession Technical Reference](/browser-sdk/reference/video/room-session)
