...
2. [The SignalWire REST APIs for Video](/docs/apis/video/rooms/create-room)
...
3. [The React library from SignalWire Community](https://github.com/signalwire-community/react) to handle the integration between the SDK and React.
...
The `useWebRTC()` hook is the React wrapper for the [`WebRTC`](/docs/browser-sdk/v3/js/reference/webrtc) namespace in the SDK.
...
with a `<RoomPreview/>` component ([described in detail here](/docs/browser-sdk/v3/js/guides/display-call-thumbnails)).
