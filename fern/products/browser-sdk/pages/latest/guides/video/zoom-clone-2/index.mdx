...
The `useWebRTC()` hook is the React wrapper for the [`WebRTC`](/sdks/browser-sdk/v-3/reference/webrtc) namespace in the SDK.
...
with a [`<RoomPreview/>`](https://signalwire-community.github.io/docs/react/components/roompreview) component ([described in detail here](/sdks/browser-sdk/v-3/guides/video/get-thumbnails-for-your-video-calls#react)).
