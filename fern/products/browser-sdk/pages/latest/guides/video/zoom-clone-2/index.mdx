...
1. [The SignalWire Video SDK](browser-sdk/reference/video) will run in the client's browser.
...
The `useWebRTC()` hook is the React wrapper for the [`WebRTC`](browser-sdk/reference/webrtc) namespace in the SDK.
