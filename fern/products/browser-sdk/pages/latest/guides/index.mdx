...
<CardGroup cols={2}>
  <Card title="Getting Started with the SignalWire Video SDK" href="/browser-sdk/guides/build-a-video-calling-application-with-the-browser-sdk" icon="fa-solid fa-star">
...
<Card title="Get Started with a Chat Application" href="/browser-sdk/guides/build-a-chat-application-with-the-browser-sdk" icon="fa-solid fa-star">
