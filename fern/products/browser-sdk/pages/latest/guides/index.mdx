---
title: "Browser SDK Guides Overview"
slug: guides
---
...
<CardGroup cols={2}>
  <Card title="Getting Started with the SignalWire Video SDK" href="/browser-sdk/guides/building-a-video-calling-application-with-the-browser-sdk" icon="fa-solid fa-star">
    Learn how to build a video conferencing application using the SignalWire Browser SDK.
  </Card>
  <Card title="Zoom like application" href="/browser-sdk/guides/making-a-zoom-like-application">
...
<Card title="Get Started with a Chat Application" href="/browser-sdk/guides/building-a-chat-application-with-the-browser-sdk" icon="fa-solid fa-star">
