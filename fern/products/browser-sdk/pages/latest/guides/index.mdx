...
<CardGroup cols={2}>
  <Card title="Getting Started with the SignalWire Video SDK" href="/browser-sdk/guides/getting-started-with-the-signalwire-video-sdk" icon="fa-solid fa-star">
    Learn how to build a video conferencing application using the SignalWire Browser SDK.
  </Card>
  <Card title="Zoom Clone" href="/browser-sdk/guides/zoom-clone">
...
<Card title="Get Started with a Chat Application" href="/browser-sdk/guides/get-started-with-a-chat-application" icon="fa-solid fa-star">
