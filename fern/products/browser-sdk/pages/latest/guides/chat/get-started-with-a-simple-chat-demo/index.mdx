---
title: Building a chat application with the Browser SDK
slug: /guides/building-a-chat-application-with-the-browser-sdk
x-custom:
...
Then you can interact with the SDK using the global variable `SignalWire`. We'll mainly be interested in the `SignalWire.Chat.Client` class for this guide, but if you'd like to explore this API, feel free to browse the [SDK documentation](/guides).
