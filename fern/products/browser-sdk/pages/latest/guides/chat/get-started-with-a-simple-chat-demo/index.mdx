...
![Chat application demo screenshot showing multiple users and messages](/docs/assets/images/project/get-started-with-a-simple-chat-demo/chat-demo.webp)
</Frame>
...
- [Technical Reference](/docs/guides/chat)
