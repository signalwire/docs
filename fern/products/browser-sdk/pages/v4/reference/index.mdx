...
<CardGroup cols={2}>
  ...
  <Card title="User" href="/docs/browser-sdk/v4/reference/user">
...
<CardGroup cols={2}>
  <Card title="AuxiliaryLegCancelledError" href="/docs/browser-sdk/v4/reference/errors/auxiliary-leg-cancelled-error">
    Thrown when an auxiliary leg is removed before it finishes connecting.
  </Card>
  <Card title="AuxiliaryLegTimeoutError" href="/docs/browser-sdk/v4/reference/errors/auxiliary-leg-timeout-error">
  ...
  <Card title="CallNotReadyError" href="/docs/browser-sdk/v4/reference/errors/call-not-ready-error">
  ...
  <Card title="MediaAccessError" href="/docs/browser-sdk/v4/reference/errors/media-access-error">
  ...
  <Card title="ParticipantNotReadyError" href="/docs/browser-sdk/v4/reference/errors/participant-not-ready-error">
  ...
  <Card title="ScreenShareAlreadyActiveError" href="/docs/browser-sdk/v4/reference/errors/screen-share-already-active-error">
