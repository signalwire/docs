...
slug: /reference/interfaces/authenticate-context
description: "Context provided by the SDK when calling CredentialProvider.authenticate."
max-toc-depth: 3
---
Context provided by the SDK when calling [CredentialProvider.authenticate](/docs/browser-sdk/v4/reference/interfaces/credential-provider#authenticate).
...
<ParamField path="fingerprint" type="string" toc={true}>
...
[Go to Code](https://github.com/signalwire/browser-sdk/blob/main/packages/main/src/dependencies/interfaces.ts#L20)
