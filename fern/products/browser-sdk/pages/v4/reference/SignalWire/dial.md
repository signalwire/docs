...
Defined in: [clients/SignalWire.ts:1053](https://github.com/signalwire/browser-sdk/blob/29c1f6cf3278bb4128a214178e02793719436b60/packages/main/src/clients/SignalWire.ts#L1053)
...
| ------ | ------ | ------ |
| `destination` | `string` \| [`Address`](../Address/index.md) | Address URI string (e.g. `'/public/my-room'`) or [Address](../Address/index.md) instance. |
