...
1. **[Call from the browser](/docs/platform/voice/make-and-receive-calls#make-an-outbound-call)**
   — the simplest thing that works: `client.dial()`, attach streams,
   listen for status, hang up. This lives in the platform calling
   guide; open the **Browser SDK** tab in its first call.
