...
<ParamField path="screenShareBusy" type="boolean" default="false" toc={true}>
  A screen-share start or stop is in flight — the screen-share control is rendered disabled and ignores clicks until it settles.
</ParamField>
...
| `screen-share-busy` | screenShareBusy  |                |
