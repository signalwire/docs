...
- [RELAY Browser SDK v3](/browser-sdk)
- [RELAY Browser SDK v2](/browser-sdk/v2)
...
For getting started with the **RELAY Browser SDK v3**, take a look at our [API reference](/browser-sdk).
...
For getting started with the **RELAY Browser SDK v2**, take a look at our [documentation](/browser-sdk/v2) and [API reference](/browser-sdk/v2/client).
