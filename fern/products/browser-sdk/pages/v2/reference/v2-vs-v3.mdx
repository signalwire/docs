...
- [RELAY Browser SDK v3](/docs/browser-sdk)
...
For getting started with the **RELAY Browser SDK v3**, take a look at our [API reference](/docs/browser-sdk).
...
For getting started with the **RELAY Browser SDK v2**, take a look at our [documentation](/docs/browser-sdk/v2) and [API reference](/docs/browser-sdk/v2/js/reference/relay-client).
