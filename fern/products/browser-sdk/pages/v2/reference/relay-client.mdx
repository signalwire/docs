...
| `token` | `string` | <span class="required-arg">required</span> | Json Web Token retrieved using Rest API. See [Generate a JWT](docs/browser-sdk/v2#generate-a-jwt) for more information. |
