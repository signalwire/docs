...
For more information about automatically refreshing JWT as they're about to expire, see [`refreshToken` Event Documentation](browser-sdk/v2/client#refreshtoken)
