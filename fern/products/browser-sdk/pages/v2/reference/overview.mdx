...
The SDKs that run on the client side, like the [JS SDK](browser-sdk) or [React Native SDK](https://docs.signalwire.com/reference/relay-sdk-react-native/v1/#relay-sdk-for-react-native), cannot safely use the **Project Token** to authenticate your users as you do in the other, server-side SDKs.
