...
<ParamField path="componentName" type="string" required={true} toc={true}>
  The component to initialize. Currently only `'C2CButton'` is supported.
</ParamField>

<ParamField path="options" type="object" required={true} toc={true}>
...
<ParamField path="buttonParentSelector" type="string" required={true} default="#click2call" toc={true}>
...
<ParamField path="callParentSelector" type="string" required={true} default="#call" toc={true}>
...
<ParamField path="innerHTML" type="string" toc={true}>
...
<ParamField path="beforeCallStartFn" type="function" toc={true}>
...
<ParamField path="afterCallStartFn" type="function" toc={true}>
...
<ParamField path="beforeCallLeaveFn" type="function" toc={true}>
...
<ParamField path="afterCallLeaveFn" type="function" toc={true}>
...
<ParamField path="onCallError" type="function" toc={true}>
