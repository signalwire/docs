---
title: "pay"
slug: /reference/go/relay/call/pay
description: "Collect payment information on a call."
max-toc-depth: 3
---

[payaction]: /docs/sdks/reference/go/relay/actions
[calling-call-pay]: /docs/sdks/reference/go/relay/call#events
...
<ParamField path="prompts" type="*[]dict" toc={true}>
...
func main() {
    ...
    async def handle_call(call):
        ...
        state := event.params[]string{"state"}
        if state == "finished":
