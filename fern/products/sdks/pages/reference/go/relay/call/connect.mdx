---
title: "connect"
slug: /reference/go/relay/call/connect
description: "Bridge a call to one or more destinations."
max-toc-depth: 3
---

[calling-call-connect]: /docs/sdks/reference/go/relay/call#events
...
<ParamField path="devices" type="[][]dict" required={true} toc={true}>
...
<ParamField path="ringback" type="*[]dict" toc={true}>
...
<ParamField path="max_price_per_minute" type="*float64" toc={true}>
...
func main() {
    ...
    async def handle_call(call):
        ...
        fmt.Println(fmt.Sprintf("Connect result: %v", result))
