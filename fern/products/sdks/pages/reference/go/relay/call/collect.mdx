...
<ParamField path="digits.digit_timeout" type="float64" toc={true}>
...
<Indent>
<ParamField path="speech.end_silence_timeout" type="float64" toc={true}>
  Seconds of silence to wait before finalizing speech input.
</ParamField>

<ParamField path="speech.speech_timeout" type="float64" toc={true}>
...
func main() {
    ...
    async def handle_call(call):
        ...
        extension := result[]string{"digits"}
        fmt.Println(fmt.Sprintf("Extension entered: %v", extension))
