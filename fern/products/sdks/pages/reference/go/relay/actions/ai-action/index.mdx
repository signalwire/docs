---
title: "AIAction"
slug: /reference/go/relay/actions/ai-action
description: Action handle for an active AI agent session.
max-toc-depth: 3
---

[call-ai]: /docs/sdks/reference/go/relay/call/ai
[base-action-interface]: /docs/sdks/reference/go/relay/actions
[stop]: /docs/sdks/reference/go/relay/actions/ai-action/stop
...
<CardGroup cols={2}>
  <Card title="stop" href="/docs/sdks/reference/go/relay/actions/ai-action/stop">
