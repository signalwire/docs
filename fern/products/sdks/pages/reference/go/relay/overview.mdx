...
[agents]: /docs/sdks/reference/go/agents
[client]: /docs/sdks/reference/go/relay/client
[call]: /docs/sdks/reference/go/relay/call
[message]: /docs/sdks/reference/go/relay/message
[actions]: /docs/sdks/reference/go/relay/actions
[events]: /docs/sdks/reference/go/relay/events
[constants]: /docs/sdks/reference/go/relay/constants
[relay-error]: /docs/sdks/reference/go/relay/relay-error
...
func main() {
    ...
    async def handle_call(call):
        ...
        // await client.receive([]string{"billing"})     # Add a context
        // await client.unreceive([]string{"sales"})     # Remove a context
...
func main() {
    ...
    async def handle_call(call):
        ...
        digit := event.params[]string{"result"}.get("digits", "")
