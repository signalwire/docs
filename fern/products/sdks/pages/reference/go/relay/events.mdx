---
title: "Events"
slug: /reference/go/relay/events
description: "Typed event classes for all RELAY events."
max-toc-depth: 3
---

[call-on]: /docs/sdks/reference/go/relay/call/on
[message-on]: /docs/sdks/reference/go/relay/message
[constants]: /docs/sdks/reference/go/relay/constants
...
func main() {
    ...
    async def on_call(call):
        func HandleState(event: CallStateEvent any) *swaig.FunctionResult {
            fmt.Println(fmt.Sprintf("Call state: %v", event.call_state))
...
<ParamField path="timestamp" type="float64" default="0.0" toc={true}>
...
<ParamField path="payload" type="map[string]interface{}" required={true} toc={true}>
...
<ParamField path="payload.params" type="map[string]interface{}" required={true} toc={true}>
...
<ParamField path="device" type="map[string]interface{}" toc={true}>
...
func main() {
    ...
    async def handle_call(call):
        func HandleState(event: CallStateEvent any) *swaig.FunctionResult {
            fmt.Println(fmt.Sprintf("State: %v, reason: %v", event.call_state, event.end_reason))
...
func main() {
    ...
    async def handle_call(call):
        func HandlePlay(event: PlayEvent any) *swaig.FunctionResult {
            fmt.Println(fmt.Sprintf("Playback: %v", event.state))
...
<ParamField path="duration" type="float64" default="0.0" toc={true}>
...
<ParamField path="record" type="map[string]interface{}" toc={true}>
...
func main() {
    ...
    async def handle_call(call):
        func HandleRecord(event: RecordEvent any) *swaig.FunctionResult {
            fmt.Println(fmt.Sprintf("Recording %v: %v", event.state, event.url))
...
<ParamField path="result" type="map[string]interface{}" toc={true}>
...
<ParamField path="final" type="*bool" toc={true}>
  Whether this is the final result. May be `nil` for non-continuous collect operations.
</ParamField>
...
func main() {
    ...
    async def handle_call(call):
        func HandleCollect(event: CollectEvent any) *swaig.FunctionResult {
            fmt.Println(fmt.Sprintf("Collected: %v", event.result))
...
<ParamField path="peer" type="map[string]interface{}" toc={true}>
...
func main() {
    ...
    async def handle_call(call):
        func HandleConnect(event: ConnectEvent any) *swaig.FunctionResult {
            fmt.Println(fmt.Sprintf("Connection: %v", event.connect_state))
...
<ParamField path="detect" type="map[string]interface{}" toc={true}>
...
func main() {
    ...
    async def handle_call(call):
        func HandleDetect(event: DetectEvent any) *swaig.FunctionResult {
            fmt.Println(fmt.Sprintf("Detected: %v", event.detect))
...
<ParamField path="fax" type="map[string]interface{}" toc={true}>
...
func main() {
    ...
    async def handle_call(call):
        func HandleFax(event: FaxEvent any) *swaig.FunctionResult {
            fmt.Println(fmt.Sprintf("Fax: %v", event.fax))
...
<ParamField path="tap" type="map[string]interface{}" toc={true}>
...
func main() {
    ...
    async def handle_call(call):
        func HandleTap(event: TapEvent any) *swaig.FunctionResult {
            fmt.Println(fmt.Sprintf("Tap %v: %v", event.state, event.tap))
...
func main() {
    ...
    async def handle_call(call):
        func HandleStream(event: StreamEvent any) *swaig.FunctionResult {
            fmt.Println(fmt.Sprintf("Stream %v: %v", event.state, event.url))
...
func main() {
    ...
    async def handle_call(call):
        func HandleDigits(event: SendDigitsEvent any) *swaig.FunctionResult {
            fmt.Println(fmt.Sprintf("Send digits: %v", event.state))
...
<ParamField path="call" type="map[string]interface{}" toc={true}>
...
func main() {
    ...
    async def handle_call(call):
        func HandleRefer(event: ReferEvent any) *swaig.FunctionResult {
            fmt.Println(fmt.Sprintf("Refer to %v: %v", event.sip_refer_to, event.state))
...
func main() {
    ...
    async def handle_call(call):
        func HandleHold(event: HoldEvent any) *swaig.FunctionResult {
            fmt.Println(fmt.Sprintf("Hold: %v", event.state))
...
func main() {
    ...
    async def handle_call(call):
        func HandleDenoise(event: DenoiseEvent any) *swaig.FunctionResult {
            fmt.Println(fmt.Sprintf("Denoise active: %v", event.denoised))
...
func main() {
    ...
    async def handle_call(call):
        func HandlePay(event: PayEvent any) *swaig.FunctionResult {
            fmt.Println(fmt.Sprintf("Payment: %v", event.state))
...
func main() {
    ...
    async def handle_call(call):
        func HandleEcho(event: EchoEvent any) *swaig.FunctionResult {
            fmt.Println(fmt.Sprintf("Echo: %v", event.state))
...
func main() {
    ...
    async def handle_call(call):
        func HandleQueue(event: QueueEvent any) *swaig.FunctionResult {
            fmt.Println(fmt.Sprintf("Queue %v: position %v/%v", event.queue_name, event.position, event.size))
...
func main() {
    ...
    async def handle_call(call):
        func HandleConference(event: ConferenceEvent any) *swaig.FunctionResult {
            fmt.Println(fmt.Sprintf("Conference %v: %v", event.name, event.status))
...
func main() {
    ...
    async def handle_call(call):
        func HandleTranscribe(event: TranscribeEvent any) *swaig.FunctionResult {
            fmt.Println(fmt.Sprintf("Transcription %v: %v", event.state, event.url))
...
func main() {
    ...
    async def handle_call(call):
        func HandleError(event: CallingErrorEvent any) *swaig.FunctionResult {
            fmt.Println(fmt.Sprintf("Error %v: %v", event.code, event.message))
...
func main() {
    ...
    async def handle_message(message):
        func HandleState(event: MessageStateEvent any) *swaig.FunctionResult {
            fmt.Println(fmt.Sprintf("Message %v: %v", event.message_id, event.message_state))
