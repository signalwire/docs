...
[relayclient-send-message]: /docs/sdks/reference/go/relay/client/send-message
[message-constants]: /docs/sdks/reference/go/relay/constants
[relayevent]: /docs/sdks/reference/go/relay/events
[message-on]: /docs/sdks/reference/go/relay/message/on
[events]: /docs/sdks/reference/go/relay/events#messaging-events
[on]: /docs/sdks/reference/go/relay/message/on
[wait]: /docs/sdks/reference/go/relay/message/wait
...
<CardGroup cols={2}>
  <Card title="on" href="/docs/sdks/reference/go/relay/message/on">
    Register an event listener for state changes on this message.
  </Card>
  <Card title="wait" href="/docs/sdks/reference/go/relay/message/wait">
