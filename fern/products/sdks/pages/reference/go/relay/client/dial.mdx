---
title: "dial"
slug: /reference/go/relay/client/dial
...
<ParamField path="devices" type="[][]map[string]interface{}" required={true} toc={true}>
...
<ParamField path="dial_timeout" type="*float64" default="120.0" toc={true}>
