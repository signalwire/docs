...
[add-function-include]: /docs/sdks/reference/go/agents/agent-base/add-function-include
...
<ParamField path="includes" type="[]map[string]interface{}" required={true} toc={true}>
...
func main() {
    ...
    agent.set_function_includes([
        {"url": "https://tools.example.com/swaig", "functions": []string{"lookup_order"}},
        {"url": "https://billing.example.com/swaig", "functions": []string{"get_invoice", "process_refund"}},
    ])
    agent.Serve()
}
```
