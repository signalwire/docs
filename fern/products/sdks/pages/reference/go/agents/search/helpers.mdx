...
slug: /reference/go/agents/search/helpers
description: "Query preprocessing, document preprocessing, model alias resolution, and constants."
max-toc-depth: 3
---

[searchservice]: /docs/sdks/reference/go/agents/search/search-service
[searchengine]: /docs/sdks/reference/go/agents/search/search-engine
[searchengine-search]: /docs/sdks/reference/go/agents/search/search-engine/search
[indexbuilder]: /docs/sdks/reference/go/agents/search/index-builder
...
func main() {
    ...
    fmt.Println(result[]string{"enhanced_text"})
    ...
    query_vector := result[]string{"vector"}
    enhanced_text := result[]string{"enhanced_text"}
}
```
...
func main() {
    ...
    fmt.Println(result[]string{"keywords"})
...
func main() {
    fmt.Println(resolve_model_alias("mini"))
    // "sentence-transformers/all-MiniLM-L6-v2"

    fmt.Println(resolve_model_alias("sentence-transformers/all-mpnet-base-v2"))
