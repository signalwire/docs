...
slug: /reference/go/agents/search
description: "Build, query, and manage vector search indexes for agent knowledge bases."
max-toc-depth: 3
---

[sw-search-cli-reference]: /docs/sdks/reference/go/agents/cli/sw-search
[search-engine]: /docs/sdks/reference/go/agents/search/search-engine
[document-processor]: /docs/sdks/reference/go/agents/search/document-processor
[index-builder]: /docs/sdks/reference/go/agents/search/index-builder
[search-service]: /docs/sdks/reference/go/agents/search/search-service
[migrator]: /docs/sdks/reference/go/agents/search/migrator
[helpers]: /docs/sdks/reference/go/agents/search/helpers
...
```bash
go get github.com/signalwire/signalwire-go[search]           # Basic search (~500MB)
go get github.com/signalwire/signalwire-go[search-full]      # + Document processing (~600MB)
go get github.com/signalwire/signalwire-go[search-nlp]       # + Advanced NLP features (~600MB)
go get github.com/signalwire/signalwire-go[search-all]       # All search features (~700MB)
```

For querying pre-built `.swsearch` indexes only (smallest footprint):

```bash
go get github.com/signalwire/signalwire-go[search-queryonly]  # ~400MB
```
</Warning>
