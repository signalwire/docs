---
title: "PomBuilder"
slug: /reference/go/agents/pom-builder
...
[addsection]: /docs/sdks/reference/go/agents/pom-builder/add-section
[addsubsection]: /docs/sdks/reference/go/agents/pom-builder/add-subsection
[addtosection]: /docs/sdks/reference/go/agents/pom-builder/add-to-section
[fromsections]: /docs/sdks/reference/go/agents/pom-builder/from-sections
[getsection]: /docs/sdks/reference/go/agents/pom-builder/has-section
[hassection]: /docs/sdks/reference/go/agents/pom-builder/has-section
[render]: /docs/sdks/reference/go/agents/pom-builder/render
[todict]: /docs/sdks/reference/go/agents/pom-builder/to-dict
[tojson]: /docs/sdks/reference/go/agents/pom-builder/to-json
...
`go get github.com/signalwire/signalwire-go-pom`
</Note>

## **Methods**

<CardGroup cols={4}>
  <Card title="add_section" href="/docs/sdks/reference/go/agents/pom-builder/add-section">
    Add a new top-level section to the POM.
  </Card>
  <Card title="add_subsection" href="/docs/sdks/reference/go/agents/pom-builder/add-subsection">
    Add a subsection to an existing section.
  </Card>
  <Card title="add_to_section" href="/docs/sdks/reference/go/agents/pom-builder/add-to-section">
    Add content to an existing section.
  </Card>
  <Card title="from_sections" href="/docs/sdks/reference/go/agents/pom-builder/from-sections">
    Create a PomBuilder from a list of section dictionaries.
  </Card>
  <Card title="get_section" href="/docs/sdks/reference/go/agents/pom-builder/has-section">
    Get a section by title for direct manipulation.
  </Card>
  <Card title="has_section" href="/docs/sdks/reference/go/agents/pom-builder/has-section">
    Check if a section with a given title exists.
  </Card>
  <Card title="render" href="/docs/sdks/reference/go/agents/pom-builder/render">
    Render the POM as Markdown or XML.
  </Card>
  <Card title="to_dict" href="/docs/sdks/reference/go/agents/pom-builder/to-dict">
    Convert the POM to a list of section dictionaries.
  </Card>
  <Card title="to_json" href="/docs/sdks/reference/go/agents/pom-builder/to-json">
