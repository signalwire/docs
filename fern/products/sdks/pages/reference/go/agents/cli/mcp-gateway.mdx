---
title: "mcp-gateway"
slug: /reference/go/agents/cli/mcp-gateway
...
<ParamField path="services.<name>.command" type="[]string" required={true} toc={true}>
...
<ParamField path="rate_limiting.default_limits" type="[]string" default='["200 per day", "50 per hour"]' toc={true}>
