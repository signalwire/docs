---
title: "ai"
slug: /reference/go/agents/swml-builder/ai
...
<ParamField path="prompt_pom" type="*[]map[string]interface{}" toc={true}>
...
<ParamField path="swaig" type="*map[string]interface{}" toc={true}>
