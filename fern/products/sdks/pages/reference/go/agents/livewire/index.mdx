...
[agent-session]: /docs/sdks/reference/go/agents/livewire/agent-session
[run-context]: /docs/sdks/reference/go/agents/livewire/run-context
[function-tool]: /docs/sdks/reference/go/agents/livewire/function-tool
[run-app]: /docs/sdks/reference/go/agents/livewire/run-app
[agent-server]: /docs/sdks/reference/go/agents/livewire/agent-server
[job-context]: /docs/sdks/reference/go/agents/livewire/job-context
[signals]: /docs/sdks/reference/go/agents/livewire/signals
[plugins]: /docs/sdks/reference/go/agents/livewire/plugins
[ref-agentsession]: /docs/sdks/reference/go/agents/livewire/agent-session
...
<CardGroup cols={2}>
  <Card
    title="Agent"
    href="/docs/sdks/reference/go/agents/livewire/agent"
  >
    LiveKit-compatible agent class. Holds instructions, tools, and lifecycle hooks.
  </Card>
  <Card
    title="AgentSession"
    href="/docs/sdks/reference/go/agents/livewire/agent-session"
  >
    Session orchestrator that binds an Agent to the SignalWire platform.
  </Card>
  <Card
    title="RunContext"
    href="/docs/sdks/reference/go/agents/livewire/run-context"
  >
    Context object available inside tool handler functions.
  </Card>
  <Card
    title="function_tool"
    href="/docs/sdks/reference/go/agents/livewire/function-tool"
  >
    Decorator for wrapping plain Go functions as agent tools.
  </Card>
  <Card
    title="run_app"
    href="/docs/sdks/reference/go/agents/livewire/run-app"
  >
    Main entry point that prints the banner, runs setup, and starts the agent.
  </Card>
  <Card
    title="AgentServer"
    href="/docs/sdks/reference/go/agents/livewire/agent-server"
  >
    Server registration and session entrypoint decorator.
  </Card>
  <Card
    title="Infrastructure"
    href="/docs/sdks/reference/go/agents/livewire/job-context"
  >
    JobContext, JobProcess, and Room stubs for connection lifecycle.
  </Card>
  <Card
    title="Signals"
    href="/docs/sdks/reference/go/agents/livewire/signals"
  >
    StopResponse, ToolError, AgentHandoff, and ChatContext.
  </Card>
  <Card
    title="Plugins"
    href="/docs/sdks/reference/go/agents/livewire/plugins"
  >
