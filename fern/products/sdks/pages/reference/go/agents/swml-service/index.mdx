---
title: "SWMLService"
slug: /reference/go/agents/swml-service
description: "SWML document generation and HTTP service base."
max-toc-depth: 3
---
...
[addsection]: /docs/sdks/reference/go/agents/swml-service/add-section
[addverb]: /docs/sdks/reference/go/agents/swml-service/add-verb
[addverbtosection]: /docs/sdks/reference/go/agents/swml-service/add-verb-to-section
[asrouter]: /docs/sdks/reference/go/agents/swml-service/as-router
[getbasicauthcredentials]: /docs/sdks/reference/go/agents/swml-service/get-basic-auth-credentials
[getdocument]: /docs/sdks/reference/go/agents/swml-service/get-document
[manualsetproxyurl]: /docs/sdks/reference/go/agents/swml-service/manual-set-proxy-url
[onrequest]: /docs/sdks/reference/go/agents/swml-service/on-request
[extractsipusername]: /docs/sdks/reference/go/agents/swml-service/register-routing-callback
[registerroutingcallback]: /docs/sdks/reference/go/agents/swml-service/register-routing-callback
[registerverbhandler]: /docs/sdks/reference/go/agents/swml-service/register-verb-handler
[renderdocument]: /docs/sdks/reference/go/agents/swml-service/render-document
[resetdocument]: /docs/sdks/reference/go/agents/swml-service/reset-document
[serve]: /docs/sdks/reference/go/agents/swml-service/serve
[stop]: /docs/sdks/reference/go/agents/swml-service/stop
...
<CardGroup cols={4}>
  <Card title="add_section" href="/docs/sdks/reference/go/agents/swml-service/add-section">
    Add a new empty section to the SWML document.
  </Card>
  <Card title="add_verb" href="/docs/sdks/reference/go/agents/swml-service/add-verb">
    Add a SWML verb to the main section of the document.
  </Card>
  <Card title="add_verb_to_section" href="/docs/sdks/reference/go/agents/swml-service/add-verb-to-section">
    Add a SWML verb to a specific named section of the document.
  </Card>
  <Card title="as_router" href="/docs/sdks/reference/go/agents/swml-service/as-router">
    Create a HTTP APIRouter for mounting the service into an existing application.
  </Card>
  <Card title="get_basic_auth_credentials" href="/docs/sdks/reference/go/agents/swml-service/get-basic-auth-credentials">
    Retrieve the HTTP Basic Auth credentials for the service.
  </Card>
  <Card title="get_document" href="/docs/sdks/reference/go/agents/swml-service/get-document">
    Get the current SWML document as a Python dictionary.
  </Card>
  <Card title="manual_set_proxy_url" href="/docs/sdks/reference/go/agents/swml-service/manual-set-proxy-url">
    Manually set the proxy URL base for webhook callback generation.
  </Card>
  <Card title="on_request" href="/docs/sdks/reference/go/agents/swml-service/on-request">
    Request handling hook for customizing SWML output per request.
  </Card>
  <Card title="extract_sip_username" href="/docs/sdks/reference/go/agents/swml-service/register-routing-callback">
    Static utility to extract the SIP username from request body data.
  </Card>
  <Card title="register_routing_callback" href="/docs/sdks/reference/go/agents/swml-service/register-routing-callback">
    Register routing callbacks for dynamic request handling and SIP routing.
  </Card>
  <Card title="register_verb_handler" href="/docs/sdks/reference/go/agents/swml-service/register-verb-handler">
    Register custom verb handlers for specialized SWML verb processing.
  </Card>
  <Card title="render_document" href="/docs/sdks/reference/go/agents/swml-service/render-document">
    Render the current SWML document as a JSON string.
  </Card>
  <Card title="reset_document" href="/docs/sdks/reference/go/agents/swml-service/reset-document">
    Reset the SWML document to an empty state.
  </Card>
  <Card title="serve" href="/docs/sdks/reference/go/agents/swml-service/serve">
    Start the HTTP/Uvicorn web server for the SWML service.
  </Card>
  <Card title="stop" href="/docs/sdks/reference/go/agents/swml-service/stop">
