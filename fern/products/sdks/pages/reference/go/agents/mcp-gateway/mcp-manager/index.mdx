...
slug: /reference/go/agents/mcp-gateway/mcp-manager
description: Spawn, communicate with, and manage MCP server processes.
max-toc-depth: 3
---

[mcpclient-reference]: /docs/sdks/reference/go/agents/mcp-gateway/mcp-client
[createclient]: /docs/sdks/reference/go/agents/mcp-gateway/mcp-manager/create-client
[getservicetools]: /docs/sdks/reference/go/agents/mcp-gateway/mcp-manager/get-service-tools
[validateservices]: /docs/sdks/reference/go/agents/mcp-gateway/mcp-manager/validate-services
[shutdown]: /docs/sdks/reference/go/agents/mcp-gateway/mcp-manager/shutdown
...
<ParamField path="command" type="[]string" toc={true}>
...
<ParamField path="sandbox_config" type="map[string]interface{}" toc={true}>
...
<CardGroup cols={2}>
  <Card title="create_client" href="/docs/sdks/reference/go/agents/mcp-gateway/mcp-manager/create-client">
    Create and start a new MCP client for a service.
  </Card>
  <Card title="get_service_tools" href="/docs/sdks/reference/go/agents/mcp-gateway/mcp-manager/get-service-tools">
    Discover a service's available tools.
  </Card>
  <Card title="validate_services" href="/docs/sdks/reference/go/agents/mcp-gateway/mcp-manager/validate-services">
    Validate that all configured services can start.
  </Card>
  <Card title="shutdown" href="/docs/sdks/reference/go/agents/mcp-gateway/mcp-manager/shutdown">
