...
slug: /reference/go/agents/mcp-gateway
description: Bridge MCP servers with SignalWire SWAIG functions via an HTTP gateway.
max-toc-depth: 3
---

[agentbase-addmcpserver]: /docs/sdks/reference/go/agents/agent-base/add-mcp-server
[mcp-gateway-cli-command]: /docs/sdks/reference/go/agents/cli/mcp-gateway
[mcp-gateway]: /docs/sdks/reference/go/agents/mcp-gateway/mcp-gateway
[session-manager]: /docs/sdks/reference/go/agents/mcp-gateway/session-manager
[mcp-manager]: /docs/sdks/reference/go/agents/mcp-gateway/mcp-manager
[mcp-client]: /docs/sdks/reference/go/agents/mcp-gateway/mcp-client
