...
slug: /reference/go/agents/mcp-gateway/session-manager
...
[sessionmanager-createsession]: /docs/sdks/reference/go/agents/mcp-gateway/session-manager/create-session
[getsession]: /docs/sdks/reference/go/agents/mcp-gateway/session-manager/get-session
[createsession]: /docs/sdks/reference/go/agents/mcp-gateway/session-manager/create-session
[closesession]: /docs/sdks/reference/go/agents/mcp-gateway/session-manager/close-session
[listsessions]: /docs/sdks/reference/go/agents/mcp-gateway/session-manager/list-sessions
[shutdown]: /docs/sdks/reference/go/agents/mcp-gateway/session-manager/shutdown
...
<ParamField path="metadata" type="map[string]interface{}" default="{}" toc={true}>
...
<CardGroup cols={2}>
  <Card title="create_session" href="/docs/sdks/reference/go/agents/mcp-gateway/session-manager/create-session">
    Create and register a new MCP session.
  </Card>
  <Card title="get_session" href="/docs/sdks/reference/go/agents/mcp-gateway/session-manager/get-session">
    Retrieve an active session by ID.
  </Card>
  <Card title="close_session" href="/docs/sdks/reference/go/agents/mcp-gateway/session-manager/close-session">
    Close and remove a session.
  </Card>
  <Card title="list_sessions" href="/docs/sdks/reference/go/agents/mcp-gateway/session-manager/list-sessions">
    List all active sessions with metadata.
  </Card>
  <Card title="shutdown" href="/docs/sdks/reference/go/agents/mcp-gateway/session-manager/shutdown">
