...
slug: /reference/go/agents/configuration/environment-variables
...
<ParamField path="LAMBDA_TASK_ROOT" type="string" toc={true}>
  Lambda environment detection variable. Set automatically by the Lambda runtime.
</ParamField>

### Google Cloud Functions

<ParamField path="GOOGLE_CLOUD_PROJECT" type="string" toc={true}>
  Google Cloud project ID.
</ParamField>

<ParamField path="GCP_PROJECT" type="string" toc={true}>
  Alternative to `GOOGLE_CLOUD_PROJECT`.
</ParamField>

<ParamField path="GOOGLE_CLOUD_REGION" type="string" default="us-central1" toc={true}>
  Google Cloud region.
</ParamField>
...
<ParamField path="WEBSITE_SITE_NAME" type="string" toc={true}>
  Azure App Service site name. Used to construct function URLs.
</ParamField>

<ParamField path="AZURE_FUNCTION_NAME" type="string" default="unknown" toc={true}>
  Azure Function name.
</ParamField>
...
<ParamField path="HTTP_HOST" type="string" toc={true}>
  HTTP Host header value. Falls back to `SERVER_NAME`.
</ParamField>

<ParamField path="SERVER_NAME" type="string" default="localhost" toc={true}>
  Server hostname.
</ParamField>

<ParamField path="SCRIPT_NAME" type="string" default="" toc={true}>
  CGI script path.
</ParamField>
...
func main() {
    ...
    fmt.Println(fmt.Sprintf("Auth: %v:%v (source: %v)", username, password, source))
}
```
