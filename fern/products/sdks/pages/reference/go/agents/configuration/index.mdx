---
title: "Configuration"
slug: /reference/go/agents/configuration
...
[environment-variables]: /docs/sdks/reference/go/agents/configuration/environment-variables
[authhandler]: /docs/sdks/reference/go/agents/configuration/auth-handler
[securityconfig]: /docs/sdks/reference/go/agents/configuration/security-config
[config-loader]: /docs/sdks/reference/go/agents/configuration/config-loader
[security-config]: /docs/sdks/reference/go/agents/configuration/security-config
[auth-handler]: /docs/sdks/reference/go/agents/configuration/auth-handler
...
<CardGroup cols={2}>
  <Card
    ...
    href="/docs/sdks/reference/go/agents/configuration/environment-variables"
  >
    Complete reference for all environment variables used by the SDK.
  </Card>
  <Card
    title="ConfigLoader"
    href="/docs/sdks/reference/go/agents/configuration/config-loader"
  >
    JSON config file loading with environment variable substitution.
  </Card>
  <Card
    title="SecurityConfig"
    href="/docs/sdks/reference/go/agents/configuration/security-config"
  >
    SSL, CORS, host allowlists, rate limiting, and HSTS configuration.
  </Card>
  <Card
    title="AuthHandler"
    href="/docs/sdks/reference/go/agents/configuration/auth-handler"
  >
    HTTP Basic Auth, Bearer tokens, and API key authentication for HTTP and Flask.
  </Card>
</CardGroup>
