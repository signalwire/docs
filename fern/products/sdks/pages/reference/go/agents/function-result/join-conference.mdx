...
slug: /reference/go/agents/function-result/join-conference
...
<ParamField path="result" type="*interface{}" default="None" toc={true}>
...
func main() {
    ...
    agent.DefineTool(agent.ToolDefinition{
        Name:        "join_team_call",
        Description: "Join the team standup call",
...
func main() {
    ...
    agent.DefineTool(agent.ToolDefinition{
        Name:        "join_moderated_conference",
        Description: "Join a moderated conference",
        Handler: func(args map[string]any, rawData map[string]any) *swaig.FunctionResult {
        return (
