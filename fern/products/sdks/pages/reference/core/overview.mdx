...
|-------|----------------|---------|
| `search` | `pip install "signalwire-agents[search]"` | Vector search index building |
| `search-full` | `pip install "signalwire-agents[search-full]"` | PDF and DOCX document processing |
| `pgvector` | `pip install "signalwire-agents[pgvector]"` | PostgreSQL vector storage backend |
