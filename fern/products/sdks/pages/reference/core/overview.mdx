...
<Note>
See the **Agents**, **RELAY**, and **REST Client** sections in the sidebar for
language-specific API details, imports, and code examples.
</Note>
...
| **Pattern** | Declarative -- return a SWML document describing the call flow | Imperative -- issue commands and react to events | Request/response -- standard CRUD operations |
...
arrives, you react with commands -- answering, playing audio, collecting
...
Or pass credentials explicitly to each client constructor.

See each namespace's overview page for language-specific authentication examples.
...
Refer to the namespace pages for language-specific installation instructions.
