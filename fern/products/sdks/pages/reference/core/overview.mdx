...
Or pass credentials explicitly when constructing a client. See the reference page
for each namespace for language-specific examples.
...
See the installation instructions in each namespace's overview page for your
selected SDK language variant.
