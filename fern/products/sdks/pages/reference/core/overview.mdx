...
[agents]: /docs/sdks/reference/python/agents
[relay]: /docs/sdks/reference/python/relay
[rest]: /docs/sdks/reference/python/rest
[ref-agentbase]: /docs/sdks/reference/python/agents/agent-base
[ref-restclient]: /docs/sdks/reference/python/rest/client
[ts-agents]: /docs/sdks/reference/typescript/agents
[ts-relay]: /docs/sdks/reference/typescript/relay
[ts-rest]: /docs/sdks/reference/typescript/rest
...
<Tabs>
  ...
  ```typescript
  import { AgentBase } from "@signalwire/sdk";    // AI voice agents (SWML)
  import { RelayClient } from "@signalwire/sdk";  // Real-time call control (WebSocket)
  import { RestClient } from "@signalwire/sdk";   // Resource management (HTTP)
  ```
  </Tab>
</Tabs>
...
| **Protocol** | HTTP/HTTPS (server) | WebSocket (JSON-RPC 2.0 over `wss://`) | HTTP/HTTPS (synchronous) |
...
<Tabs>
  ...
  const relay = new RelayClient({ contexts: ["default"] });
...
use [AgentBase][ref-agentbase] for AI conversations, RELAY for call routing logic, and [RestClient][ref-restclient]
...
{/* TypeScript variant links */}
{/*
<CardGroup cols={3}>
  <Card title="Agents" href="/docs/sdks/reference/typescript/agents">AI voice agents with SWML, SWAIG tools, skills, and multi-step workflows.</Card>
  <Card title="RELAY" href="/docs/sdks/reference/typescript/relay">Real-time WebSocket client for call and message control.</Card>
  <Card title="REST" href="/docs/sdks/reference/typescript/rest">HTTP client for phone numbers, fabric, video, logs, and more.</Card>
</CardGroup>
*/}
