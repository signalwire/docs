...
<Note>
Use the language switcher above to view API reference for your SDK language.
Each namespace page includes language-specific imports, types, and code examples.
</Note>
...
Set these environment variables and all three clients can authenticate without
explicit arguments.
...
See the getting started guide for your language to install the SDK.
...
use Agents for AI conversations, RELAY for call routing logic, and REST
