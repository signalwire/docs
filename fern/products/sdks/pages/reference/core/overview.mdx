...
[agents-py]: /docs/sdks/reference/python/agents
[relay-py]: /docs/sdks/reference/python/relay
[rest-py]: /docs/sdks/reference/python/rest
[agents-java]: /docs/sdks/reference/java/agents
[relay-java]: /docs/sdks/reference/java/relay
[rest-java]: /docs/sdks/reference/java/rest
...
<Info>
See the namespace pages for your active SDK variant for language-specific import
and usage details.
</Info>
...
See the namespace overview pages for language-specific constructor examples.
...
<CardGroup cols={3}>
  ...
  <Card
    title="Agents (Java)"
    href="/docs/sdks/reference/java/agents"
  >
    AI voice agents with SWML, SWAIG tools, skills, and multi-step workflows.
  </Card>
  <Card
  ...
  <Card
    title="RELAY (Java)"
    href="/docs/sdks/reference/java/relay"
  >
    Real-time WebSocket client for call and message control.
  </Card>
  <Card
  ...
  <Card
    title="REST (Java)"
    href="/docs/sdks/reference/java/rest"
  >
    HTTP client for phone numbers, fabric, video, logs, and more.
  </Card>
</CardGroup>
