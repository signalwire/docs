...
[go-agents]: /docs/sdks/reference/go/agents
[go-relay]: /docs/sdks/reference/go/relay
[go-rest]: /docs/sdks/reference/go/rest
[go-ref-agentbase]: /docs/sdks/reference/go/agents/agent-base
[go-ref-restclient]: /docs/sdks/reference/go/rest/client
...
<Info>
See the namespace pages for your active language variant for import paths and
...
See the namespace pages for your active language variant for constructor examples.
...
See the getting started guide for your language variant for installation instructions.
...
<Note>
The card links above navigate to the Python variant. Use the variant switcher
at the top of the Reference tab to switch to Go or another language.
</Note>
