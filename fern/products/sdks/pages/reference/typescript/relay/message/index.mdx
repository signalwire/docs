...
[relayclient-send-message]: /docs/sdks/reference/typescript/relay/client/send-message
[message-constants]: /docs/sdks/reference/typescript/relay/constants
[relayevent]: /docs/sdks/reference/typescript/relay/events
[message-on]: /docs/sdks/reference/typescript/relay/message/on
[events]: /docs/sdks/reference/typescript/relay/events#messaging-events
[on]: /docs/sdks/reference/typescript/relay/message/on
[wait]: /docs/sdks/reference/typescript/relay/message/wait
...
<ParamField path="result" type="RelayEvent | undefined" toc={true}>
  ...
  or `undefined` if the message has not yet completed.
</ParamField>
...
<CardGroup cols={2}>
  <Card title="on" href="/docs/sdks/reference/typescript/relay/message/on">
    Register an event listener for state changes on this message.
  </Card>
  <Card title="wait" href="/docs/sdks/reference/typescript/relay/message/wait">
