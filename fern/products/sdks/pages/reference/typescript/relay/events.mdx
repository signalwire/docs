...
```typescript
import { RelayClient, CallStateEvent } from 'signalwire-agents/relay';
...
**fromPayload**(`payload`) -> `RelayEvent`
...
```typescript
import { RelayEvent } from 'signalwire-agents/relay';
...
```typescript
import { parseEvent } from 'signalwire-agents/relay';
...
```typescript
import { RelayClient, MessageStateEvent } from 'signalwire-agents/relay';
