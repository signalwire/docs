...
[message-on]: /docs/sdks/reference/typescript/relay/message
[constants]: /docs/sdks/reference/typescript/relay/constants
...
async def on_call(call):
    function handleState(event: CallStateEvent) {
...
console.log(event.event_type)  # "calling.call.state"
```
...
async def handle_call(call):
    function handleState(event: CallStateEvent) {
        console.log(`State: ${event.call_state}, reason: ${event.end_reason}`)
...
@client.on_call
async def handle_call(call):
    function handlePlay(event: PlayEvent) {
...
@client.on_call
async def handle_call(call):
    function handleRecord(event: RecordEvent) {
...
@client.on_call
async def handle_call(call):
    function handleCollect(event: CollectEvent) {
        console.log(`Collected: ${event.result}`)
...
async def handle_call(call):
    function handleConnect(event: ConnectEvent) {
        console.log(`Connection: ${event.connect_state}`)
...
@client.on_call
async def handle_call(call):
    function handleDetect(event: DetectEvent) {
        console.log(`Detected: ${event.detect}`)
...
@client.on_call
async def handle_call(call):
    function handleFax(event: FaxEvent) {
        console.log(`Fax: ${event.fax}`)

    call.on("calling.call.fax", handle_fax)
    await call.answer()
    await call.sendFax(document="https://example.com/invoice.pdf")
...
async def handle_call(call):
    function handleTap(event: TapEvent) {
        console.log(`Tap ${event.state}: ${event.tap}`)
...
@client.on_call
async def handle_call(call):
    function handleDigits(event: SendDigitsEvent) {
...
@client.on_call
async def handle_call(call):
    function handleRefer(event: ReferEvent) {
        console.log(`Refer to ${event.sip_refer_to}: ${event.state}`)
...
@client.on_call
async def handle_call(call):
    function handleHold(event: HoldEvent) {
...
@client.on_call
async def handle_call(call):
    function handleDenoise(event: DenoiseEvent) {
...
@client.on_call
async def handle_call(call):
    function handlePay(event: PayEvent) {
...
@client.on_call
async def handle_call(call):
    function handleEcho(event: EchoEvent) {
...
@client.on_call
async def handle_call(call):
    function handleQueue(event: QueueEvent) {
        console.log(`Queue ${event.queue_name}: position ${event.position}/${event.size}`)
...
@client.on_call
async def handle_call(call):
    function handleConference(event: ConferenceEvent) {
...
@client.on_call
async def handle_call(call):
    function handleTranscribe(event: TranscribeEvent) {
...
@client.on_call
async def handle_call(call):
    function handleError(event: CallingErrorEvent) {
...
async def handle_message(message):
    function handleState(event: MessageStateEvent) {
        console.log(`Message ${event.message_id}: ${event.message_state}`)
