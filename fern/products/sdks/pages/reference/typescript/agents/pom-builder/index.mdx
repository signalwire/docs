...
[findsection]: /docs/sdks/reference/typescript/agents/pom-builder/find-section
[getsection]: /docs/sdks/reference/typescript/agents/pom-builder/get-section
[hassection]: /docs/sdks/reference/typescript/agents/pom-builder/has-section
[rendermarkdown]: /docs/sdks/reference/typescript/agents/pom-builder/render-markdown
...
<CardGroup cols={4}>
  ...
  <Card title="findSection" href="/docs/sdks/reference/typescript/agents/pom-builder/find-section">
    Find a section by title for direct manipulation.
  </Card>
  <Card title="getSection" href="/docs/sdks/reference/typescript/agents/pom-builder/get-section">
  ...
  <Card title="renderMarkdown" href="/docs/sdks/reference/typescript/agents/pom-builder/render-markdown">
