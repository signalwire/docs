...
<CardGroup cols={2}>
  ...
  <Card
    title="SkillManager"
    href="/docs/sdks/reference/typescript/agents/skill-manager"
  >
    Manages the lifecycle of skills loaded on an agent.
  </Card>
  <Card
    title="SkillRegistry"
    href="/docs/sdks/reference/typescript/agents/skill-registry"
  >
    Global singleton for registering and discovering skills by name.
  </Card>
  <Card
    title="Utilities"
    href="/docs/sdks/reference/typescript/agents/utilities"
  >
    Security utilities, type inference, PomSection, and standalone functions.
  </Card>
</CardGroup>
