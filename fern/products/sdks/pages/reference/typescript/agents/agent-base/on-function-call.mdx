...
calls for logging, metrics, pre/post-processing, or custom dispatch logic.

<Note>
Most agents do not need to override this method. The default implementation
handles function lookup and execution automatically. Override only when you need
cross-cutting behavior across all tool calls.
</Note>
