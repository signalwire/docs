...
<ParamField path="opts" type="object" toc={true}>
  ...
  <ParamField path="opts.numbered" type="boolean" default="false">
    Whether the section itself should be numbered.
  </ParamField>

  <ParamField path="opts.numberedBullets" type="boolean" default="false">
    Whether bullet points should be numbered instead of bulleted.
  </ParamField>

  <ParamField path="opts.subsections" type="object[]">
