...
<ParamField path="max_tokens" type="number" default="256" toc={true}>
...
<ParamField path="end_of_speech_timeout" type="number" default="700" toc={true}>
  Silence duration in milliseconds to detect end of speech. Range: `250` -- `10000`.
</ParamField>

<ParamField path="attention_timeout" type="number" default="5000" toc={true}>
  Idle delay in milliseconds before the AI re-prompts the caller. Range: `0` -- `600000`.
</ParamField>

<ParamField path="inactivity_timeout" type="number" default="600000" toc={true}>
  Inactivity delay in milliseconds before the call is automatically disconnected. Range: `10000` -- `3600000`.
</ParamField>

<ParamField path="speech_timeout" type="number" default="60000" toc={true}>
...
<ParamField path="ai_volume" type="number" default="0" toc={true}>
