...
[add-function-include]: /docs/sdks/reference/typescript/agents/agent-base/add-function-include
...
<ParamField path="includes" type={"Record<string, unknown>[]"} required={true} toc={true}>
