...
slug: /reference/typescript/agents/configuration/security-config/get-ssl-context-kwargs
...
`Record<string, unknown>` -- A dictionary with `ssl_certfile` and `ssl_keyfile` keys when
