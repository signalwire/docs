...
[environment-variables]: /docs/sdks/reference/typescript/agents/configuration/environment-variables
[authhandler]: /docs/sdks/reference/typescript/agents/configuration/auth-handler
[promptmanager]: /docs/sdks/reference/typescript/agents/configuration/prompt-manager
[schemautils]: /docs/sdks/reference/typescript/agents/configuration/schema-utils
[serverlessadapter]: /docs/sdks/reference/typescript/agents/configuration/serverless-adapter
[sessionmanager]: /docs/sdks/reference/typescript/agents/configuration/session-manager
...
<CardGroup cols={2}>
  <Card
    ...
    href="/docs/sdks/reference/typescript/agents/configuration/environment-variables"
  >
    Complete reference for all environment variables used by the SDK.
  </Card>
  <Card
    title="ConfigLoader"
    href="/docs/sdks/reference/typescript/agents/configuration/config-loader"
  >
    JSON config file loading with environment variable substitution.
  </Card>
  <Card
    title="AuthHandler"
    href="/docs/sdks/reference/typescript/agents/configuration/auth-handler"
  >
    HTTP Basic Auth, Bearer tokens, and API key authentication for Hono middleware.
  </Card>
  <Card
    title="PromptManager"
    href="/docs/sdks/reference/typescript/agents/configuration/prompt-manager"
  >
    Manages agent prompt text with raw text and structured POM-based prompts.
  </Card>
  <Card
    title="SchemaUtils"
    href="/docs/sdks/reference/typescript/agents/configuration/schema-utils"
  >
    SWML document validation against structural rules with result caching.
  </Card>
  <Card
    title="ServerlessAdapter"
    href="/docs/sdks/reference/typescript/agents/configuration/serverless-adapter"
  >
    Adapts Hono apps for AWS Lambda, Google Cloud Functions, and Azure Functions.
  </Card>
  <Card
    title="SessionManager"
    href="/docs/sdks/reference/typescript/agents/configuration/session-manager"
  >
    Stateless HMAC-SHA256 token generation and validation for SWAIG function calls.
  </Card>
  <Card
    title="SslConfig"
    href="/docs/sdks/reference/typescript/agents/configuration/ssl-config"
  >
    SSL/TLS configuration for HTTPS serving with HSTS support.
  </Card>
  <Card
    title="Logging"
    href="/docs/sdks/reference/typescript/agents/configuration/logging"
  >
