...
[config-loader]: /docs/sdks/reference/typescript/agents/configuration/config-loader
[security-config]: /docs/sdks/reference/typescript/agents/configuration/security-config
[auth-handler]: /docs/sdks/reference/typescript/agents/configuration/auth-handler
...
<CardGroup cols={2}>
  ...
  <Card
    ...
    href="/docs/sdks/reference/typescript/agents/configuration/security-config"
  >
  ...
  >
    HTTP Basic Auth, Bearer tokens, and API key authentication for Hono and Flask.
  </Card>
</CardGroup>
