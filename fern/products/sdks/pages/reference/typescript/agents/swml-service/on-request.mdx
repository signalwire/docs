...
[register-routing-callback]: /docs/sdks/reference/typescript/agents/swml-service/register-routing-callback
...
The default implementation returns `undefined` (no modifications). When you return a
...
<ParamField path="requestData" type="dict | undefined" default="None" toc={true}>
...
<ParamField path="callbackPath" type="string | undefined" default="None" toc={true}>
  ...
  `undefined` for requests to the main route.
</ParamField>

## **Returns**

`Record<string, unknown> | undefined` — Return `undefined` to serve the document unchanged. Return a dictionary
...
class DynamicService extends SWMLService {
    Init() {
        ...
        self.addVerb("answer", {})
        self.addVerb("play", {"url": "https://example.com/default.mp3"})

    onRequest(requestData = undefined, callbackPath = undefined) {
        ...
        return undefined  # Use default document
