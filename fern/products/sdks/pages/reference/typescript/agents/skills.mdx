...
class MyAgent extends AgentBase {
    Init() {
        ...
        # No-config skill
        self.addSkill("datetime")

        # Skill with parameters
        self.addSkill("web_search", {
            "api_key": "YOUR_KEY",
...
self.addSkill("web_search", {"api_key": "KEY", "search_engine_id": "ID"})
...
class MyAgent extends AgentBase {
    Init() {
        super().__init__(name="assistant", route="/assistant")
        self.setPromptText("You are a helpful assistant.")
        self.addSkill("native_vector_search", {
...
class MyAgent extends AgentBase {
    Init() {
        super().__init__(name="assistant", route="/assistant")
        self.setPromptText("You are a helpful assistant.")
        self.addSkill("wikipedia_search", {"sentences": 5})
...
class MyAgent extends AgentBase {
    Init() {
        super().__init__(name="assistant", route="/assistant")
        self.setPromptText("You are a helpful assistant.")
        self.addSkill("weather_api", {"api_key": "YOUR_WEATHER_API_KEY"})
...
class MyAgent extends AgentBase {
    Init() {
        super().__init__(name="assistant", route="/assistant")
        self.setPromptText("You are a helpful assistant.")
        self.addSkill("play_background_file", {
...
<ParamField path="requiredFields" type="dict" default="{}" toc={true}>
...
class MyAgent extends AgentBase {
    Init() {
        super().__init__(name="assistant", route="/assistant")
        self.setPromptText("You are a helpful assistant.")
        self.addSkill("datasphere_serverless", {
            "space_name": "your-space",
            "project_id": "YOUR_PROJECT_ID",
...
class MyAgent extends AgentBase {
    Init() {
        super().__init__(name="assistant", route="/assistant")
        self.setPromptText("You are a helpful assistant.")
        self.addSkill("google_maps", {"api_key": "YOUR_GOOGLE_MAPS_API_KEY"})
...
class MyAgent extends AgentBase {
    Init() {
        super().__init__(name="assistant", route="/assistant")
        self.setPromptText("You are a helpful assistant.")
        self.addSkill("api_ninjas_trivia", {
