...
description: "Set the top-level fallback output used when all webhooks fail."
max-toc-depth: 3
---
...
Set a top-level fallback output used when all webhooks fail or no expressions
match.
