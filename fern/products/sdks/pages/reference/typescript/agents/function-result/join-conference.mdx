...
<ParamField path="waitUrl" type="string | undefined" default="undefined" toc={true}>
  SWML URL for hold music played while waiting for the conference to start.
  When `undefined`, default hold music is used.
</ParamField>

<ParamField path="maxParticipants" type="number" default="250" toc={true}>
...
<ParamField path="coach" type="string | undefined" default="undefined" toc={true}>
...
<ParamField path="statusCallbackEvent" type="string | undefined" default="undefined" toc={true}>
...
<ParamField path="statusCallback" type="string | undefined" default="undefined" toc={true}>
...
<ParamField path="recordingStatusCallback" type="string | undefined" default="undefined" toc={true}>
...
<ParamField path="result" type="unknown | undefined" default="undefined" toc={true}>
