...
<CardGroup cols={4}>
  <Card title="add_context" href="/docs/sdks/reference/typescript/agents/context-builder/add-context">
    Create a new named context and add it to the builder.
  </Card>
  <Card title="get_context" href="/docs/sdks/reference/typescript/agents/context-builder/get-context">
    Retrieve an existing context by name.
  </Card>
  <Card title="to_dict" href="/docs/sdks/reference/typescript/agents/context-builder/to-dict">
