...
[`RestClient`](/docs/sdks/reference/python/rest/client). It organizes 16 sub-resources
...
Access via `client.fabric` on a [`RestClient`](/docs/sdks/reference/python/rest/client) instance.
