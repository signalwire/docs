...
[`@tool` decorator](/docs/sdks/reference/python/agents/agent-base/tool-decorator).

<Tip>
For most cases, the [`@tool` decorator](/docs/sdks/reference/python/agents/agent-base/tool-decorator)
...
def get_weather(args, raw_data=None):
    ...
    return SwaigFunctionResult(f"The weather in {city} is 72F and sunny.")
