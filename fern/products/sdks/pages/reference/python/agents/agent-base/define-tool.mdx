...
<Info>
Tool definitions map to SWML [SWAIG function](/docs/swml/reference/ai/swaig/functions)
entries. See the [SWML SWAIG functions reference](/docs/swml/reference/ai/swaig/functions)
for the full specification.
</Info>

<Tip>
For most cases, the [`@tool` decorator](/docs/sdks/reference/python/agents/agent-base#tool)
...
<ParamField path="handler" type="Callable" required={true} toc={true}>
  ...
  and should return a [`FunctionResult`](/docs/sdks/reference/python/agents/function-result).
</ParamField>
