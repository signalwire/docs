...
<Info>
Language configurations map to the SWML [`ai.languages`](/docs/swml/reference/ai/languages) array.
See the [SWML languages reference](/docs/swml/reference/ai/languages) for the full specification.
</Info>
