...
<Info>
This sets the SWML [`ai.prompt`](/docs/swml/reference/ai/prompt) field. See the
[SWML prompt reference](/docs/swml/reference/ai/prompt) for details on prompt behavior.
</Info>
