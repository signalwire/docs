...
<Info>
This maps to the SWML [`ai.swaig.includes`](/docs/swml/reference/ai/swaig/includes) array.
See the [SWML SWAIG includes reference](/docs/swml/reference/ai/swaig/includes) for details.
</Info>

<Tip>
Use [`add_function_include()`](/docs/sdks/reference/python/agents/agent-base/add-function-include)
