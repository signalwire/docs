...
<Info>
This is the AgentBase-specific override of the lower-level
[`SWMLService.on_request()`][on-request-swml]. It adds
support for dynamic configuration and ephemeral agent copies.
</Info>
