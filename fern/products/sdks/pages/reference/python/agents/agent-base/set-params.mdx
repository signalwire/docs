...
<Info>
These parameters map to the SWML [`ai.params`](/docs/swml/reference/ai/params) object.
See the [SWML AI params reference](/docs/swml/reference/ai/params) for the full list of
supported fields.
</Info>
