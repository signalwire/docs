...
[`set_prompt_llm_params()`](/docs/sdks/reference/python/agents/agent-base/set-prompt-llm-params) except `barge_confidence`, which does not apply to post-prompts.

## **Parameters**

Same keyword arguments as [`set_prompt_llm_params()`](/docs/sdks/reference/python/agents/agent-base/set-prompt-llm-params) (excluding `barge_confidence`).
