...
and [`define_tool()`](/docs/sdks/reference/python/agents/agent-base/define-tool) method
on [`AgentBase`](/docs/sdks/reference/python/agents/agent-base) handle construction
...
[`DataMap`](/docs/sdks/reference/python/agents/data-map). For building the
response returned from a handler, see
[`FunctionResult`](/docs/sdks/reference/python/agents/function-result).
</Info>

<Info>
SWAIGFunction serializes to a SWML [SWAIG function definition](/docs/swml/reference/ai/swaig/functions).
