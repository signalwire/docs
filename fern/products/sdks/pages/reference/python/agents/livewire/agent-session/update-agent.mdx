...
Swap in a new [`Agent`](/docs/sdks/reference/python/agents/livewire/agent) mid-session.
...
<ParamField path="agent" type="Agent" required={true} toc={true}>
  The new [`Agent`](/docs/sdks/reference/python/agents/livewire/agent) to bind to this session.
</ParamField>
