...
[`Agent(tools=[...])`](/docs/sdks/reference/python/agents/livewire/agent). The decorator
...
[`define_tool()`](/docs/sdks/reference/python/agents/agent-base/define-tool).

<Note>
Parameters annotated with [`RunContext`](/docs/sdks/reference/python/agents/livewire/run-context)
