...
[`run_app()`](/docs/sdks/reference/python/agents/livewire/run-app) and passed to the
entrypoint function.
...
[`AgentServer.setup_fnc`](/docs/sdks/reference/python/agents/livewire/agent-server)
