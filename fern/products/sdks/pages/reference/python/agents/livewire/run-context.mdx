...
[`AgentSession`](/docs/sdks/reference/python/agents/livewire/agent-session) and its
...
[`@function_tool`](/docs/sdks/reference/python/agents/livewire/function-tool) via its
...
<ParamField path="session" type="Optional[AgentSession]" toc={true}>
  The [`AgentSession`](/docs/sdks/reference/python/agents/livewire/agent-session)
