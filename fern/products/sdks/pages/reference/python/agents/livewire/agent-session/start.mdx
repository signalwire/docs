...
Bind an [`Agent`](/docs/sdks/reference/python/agents/livewire/agent) to this session
...
<ParamField path="agent" type="Agent" required={true} toc={true}>
  The [`Agent`](/docs/sdks/reference/python/agents/livewire/agent) instance to bind
  to this session.
</ParamField>

<ParamField path="room" type="Any" default="None" toc={true}>
  A [`Room`](/docs/sdks/reference/python/agents/livewire/job-context) instance.
