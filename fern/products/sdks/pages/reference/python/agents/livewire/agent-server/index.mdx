...
[jobprocess]: /docs/sdks/reference/python/agents/livewire/job-context
[rtcsession]: /docs/sdks/reference/python/agents/livewire/agent-server/rtc-session
...
```python
from signalwire.livewire import AgentServer

server = AgentServer()
```

The constructor accepts arbitrary keyword arguments for API compatibility. No
arguments are required or used by SignalWire.

## **Methods**

<CardGroup cols={2}>
  <Card title="rtc_session" href="/docs/sdks/reference/python/agents/livewire/agent-server/rtc-session">
