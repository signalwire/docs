...
[`run_app()`](/docs/sdks/reference/python/agents/livewire/run-app) to start the agent.

<Note>
This is the **LiveWire** `AgentServer`, not the SignalWire
[`AgentServer`](/docs/sdks/reference/python/agents/agent-server) used for multi-agent
