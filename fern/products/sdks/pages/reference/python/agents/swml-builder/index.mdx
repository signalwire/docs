...
<Info>
SWMLBuilder constructs [SWML](/docs/swml/reference/ai) documents programmatically. See the
[SWML reference](/docs/swml/reference/ai) for the full specification of all supported verbs.
</Info>
