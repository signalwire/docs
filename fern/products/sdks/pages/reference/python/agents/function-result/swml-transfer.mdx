...
<Tip>
For simple phone-number or SIP transfers, use [`connect()`](/docs/sdks/reference/python/agents/function-result/connect) instead.
...
def transfer_to_support(args, raw_data):
    ...
    return (
        SwaigFunctionResult("Let me connect you.", post_process=True)
        .swml_transfer(
