...
<ParamField path="parameters" type="Optional[list[dict[str, str]]]" default="None" toc={true}>
  ...
  Use [`create_payment_parameter()`](/docs/sdks/reference/python/agents/function-result/create-payment-parameter) to build entries.
</ParamField>
...
<ParamField path="prompts" type="Optional[list[dict[str, Any]]]" default="None" toc={true}>
  ...
  Use [`create_payment_prompt()`](/docs/sdks/reference/python/agents/function-result/create-payment-prompt) to build entries.
</ParamField>
