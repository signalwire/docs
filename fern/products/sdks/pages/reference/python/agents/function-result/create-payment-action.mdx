...
def collect_card(args, raw_data):
    say_action = SwaigFunctionResult.create_payment_action("Say", "Please enter your card number.")
    play_action = SwaigFunctionResult.create_payment_action("Play", "https://example.com/card-prompt.mp3")
