...
silence. Use [`stop_record_call()`](/docs/sdks/reference/python/agents/function-result/stop-record-call) to end continuous recordings.
</Note>
...
def record_voicemail(args, raw_data):
    return (
        SwaigFunctionResult("Please leave your message after the beep.")
        .record_call(
