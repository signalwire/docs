...
<Info>
BedrockAgent generates SWML with the [`amazon_bedrock`](/docs/swml/reference/bedrock) verb
instead of `ai`. See the [SWML bedrock reference](/docs/swml/reference/bedrock) for the
full specification.
</Info>
