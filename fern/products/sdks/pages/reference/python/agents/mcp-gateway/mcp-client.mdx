...
[`MCPManager.create_client()`](/docs/sdks/reference/python/agents/mcp-gateway/mcp-manager/create-client).
...
<ParamField path="service" type="MCPService" required={true} toc={true}>
  The [`MCPService`](/docs/sdks/reference/python/agents/mcp-gateway/mcp-manager) configuration
  for this client.
</ParamField>
