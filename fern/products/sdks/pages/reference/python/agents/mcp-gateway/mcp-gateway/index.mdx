...
[`MCPManager`](/docs/sdks/reference/python/agents/mcp-gateway/mcp-manager) and
...
<ParamField path="mcp_manager" type="MCPManager" toc={true}>
  The [`MCPManager`](/docs/sdks/reference/python/agents/mcp-gateway/mcp-manager) instance
  that manages MCP service definitions and client lifecycles.
</ParamField>

<ParamField path="session_manager" type="SessionManager" toc={true}>
  The [`SessionManager`](/docs/sdks/reference/python/agents/mcp-gateway/session-manager) instance
...
<Tip>
Use the [`mcp-gateway` CLI command](/docs/sdks/reference/python/agents/cli/mcp-gateway)
