...
IDs. Each session wraps an [`MCPClient`](/docs/sdks/reference/python/agents/mcp-gateway/mcp-client)
...
[`SessionManager.create_session()`](/docs/sdks/reference/python/agents/mcp-gateway/session-manager/create-session)
...
<ParamField path="process" type="MCPClient" toc={true}>
  The [`MCPClient`](/docs/sdks/reference/python/agents/mcp-gateway/mcp-client) instance
...
<ParamField path="last_accessed" type="datetime" toc={true}>
  ...
  [`get_session()`](/docs/sdks/reference/python/agents/mcp-gateway/session-manager/get-session).
</ParamField>
