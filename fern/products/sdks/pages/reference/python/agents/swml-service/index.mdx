...
<Info>
SWMLService generates and serves [SWML](/docs/swml/reference/ai) documents over HTTP.
See the [SWML reference](/docs/swml/reference/ai) for the full document specification.
</Info>
...
<ParamField path="config_file" type="Optional[str]" toc={true}>
  Path to a JSON config file. See [`ConfigLoader`](/docs/sdks/reference/python/agents/configuration/config-loader).
</ParamField>
