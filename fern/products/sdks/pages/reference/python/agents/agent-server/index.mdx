...
[getagent]: /docs/sdks/reference/python/agents/agent-server/get-agent
[getagents]: /docs/sdks/reference/python/agents/agent-server/get-agents
[register]: /docs/sdks/reference/python/agents/agent-server/register
[registerglobalroutingcallback]: /docs/sdks/reference/python/agents/agent-server/routing-callback
[run]: /docs/sdks/reference/python/agents/agent-server/run
[servestaticfiles]: /docs/sdks/reference/python/agents/agent-server/static-files
[setupsiprouting]: /docs/sdks/reference/python/agents/agent-server/sip-routing
[unregister]: /docs/sdks/reference/python/agents/agent-server/unregister
