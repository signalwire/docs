...
<ParamField path="security" type="SecurityConfig" toc={true}>
  The [`SecurityConfig`](/docs/sdks/reference/python/agents/configuration/security-config) instance
...
<ParamField path="directories" type="dict[str, str]" toc={true}>
  ...
  initially -- use
  [`add_directory()`](/docs/sdks/reference/python/agents/web-service/add-directory) later.
</ParamField>
