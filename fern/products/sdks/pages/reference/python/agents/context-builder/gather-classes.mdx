...
[`Step.set_gather_info()`](/docs/sdks/reference/python/agents/context-builder/step/set-gather-info) and
[`Step.add_gather_question()`](/docs/sdks/reference/python/agents/context-builder/step/add-gather-question)
