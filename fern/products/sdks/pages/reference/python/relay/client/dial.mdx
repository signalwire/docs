...
server to return a `calling.call.dial` event confirming the call was answered.
Returns a fully-initialized [`Call`](/docs/sdks/reference/python/relay/call) object
...
[`Call`](/docs/sdks/reference/python/relay/call) -- A call object with all properties populated and ready for call control operations.
