...
services. It calls [`connect()`](/docs/sdks/reference/python/relay/client/connect)
...
use [`connect()`](/docs/sdks/reference/python/relay/client/connect) and
[`disconnect()`](/docs/sdks/reference/python/relay/client/disconnect) directly.
</Note>
