...
```python
from signalwire.relay import RelayClient, CallStateEvent
...
event = RelayEvent.from_payload({"event_type": "calling.call.state", "params": {"call_state": "answered"}})
...
event = parse_event({"event_type": "calling.call.play", "params": {...}})
