...
[play-action]: /docs/sdks/reference/python/relay/actions/play-action
[record-action]: /docs/sdks/reference/python/relay/actions/record-action
[collect-action]: /docs/sdks/reference/python/relay/actions/collect-action
[detect-action]: /docs/sdks/reference/python/relay/actions/detect-action
[standalone-collect-action]: /docs/sdks/reference/python/relay/actions/standalone-collect-action
[fax-action]: /docs/sdks/reference/python/relay/actions/fax-action
[tap-action]: /docs/sdks/reference/python/relay/actions/tap-action
[stream-action]: /docs/sdks/reference/python/relay/actions/stream-action
[pay-action]: /docs/sdks/reference/python/relay/actions/pay-action
[transcribe-action]: /docs/sdks/reference/python/relay/actions/transcribe-action
[ai-action]: /docs/sdks/reference/python/relay/actions/ai-action
