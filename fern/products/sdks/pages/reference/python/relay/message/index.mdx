...
[`message.on()`](/docs/sdks/reference/python/relay/message/on) to react to state changes on outbound messages.
...
<CardGroup cols={2}>
  <Card title="on" href="/docs/sdks/reference/python/relay/message/on">
    Register an event listener for state changes on this message.
  </Card>
  <Card title="wait" href="/docs/sdks/reference/python/relay/message/wait">
