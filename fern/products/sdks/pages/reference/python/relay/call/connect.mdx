...
<Info>
This method emits [`calling.call.connect`](/docs/sdks/reference/python/relay/call#events) events. See [Call Events](/docs/sdks/reference/python/relay/call#events) for payload details.
</Info>

<Info>
This method corresponds to the SWML [`connect`](/docs/swml/reference/connect) verb. See the
[SWML connect reference](/docs/swml/reference/connect) for the full specification.
</Info>
...
<ParamField path="ringback" type="Optional[list[dict]]" toc={true}>
  ...
  format as [`play()`](/docs/sdks/reference/python/relay/call/methods/play) media items.
</ParamField>
