...
<Info>
This method executes the SWML [`ai`](/docs/swml/reference/ai) verb on the call. See the
[SWML AI reference](/docs/swml/reference/ai) for the full specification of all supported
