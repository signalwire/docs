...
<Info>
This method corresponds to the SWML [`record`](/docs/swml/reference/record) verb. See the
[SWML record reference](/docs/swml/reference/record) for the full specification.
</Info>
