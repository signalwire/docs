...
<Info>
This method corresponds to the SWML [`join_conference`](/docs/swml/reference/join-conference)
verb. See the [SWML join_conference reference](/docs/swml/reference/join-conference) for the
full specification.
</Info>
