...
slug: /reference/cpp/agents/agent-base/set-internal-fillers
...
<ParamField path="internal_fillers" type="std::map<str, dict[str, std::vector<str]>>" required={true} toc={true}>
