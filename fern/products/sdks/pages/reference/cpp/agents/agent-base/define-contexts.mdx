...
slug: /reference/cpp/agents/agent-base/define-contexts
...
<ParamField path="contexts" type="std::optional<std::variant<nlohmann::json, contexts::ContextBuilder>>" toc={true}>
...
agent::AgentBase agent("intake", "/intake");
