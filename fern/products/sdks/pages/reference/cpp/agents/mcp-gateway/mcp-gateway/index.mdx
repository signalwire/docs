---
title: "MCPGateway"
slug: /reference/cpp/agents/mcp-gateway/mcp-gateway
description: The main HTTP gateway service bridging MCP servers with SignalWire SWAIG functions.
max-toc-depth: 3
---

[mcpmanager]: /docs/sdks/reference/cpp/agents/mcp-gateway/mcp-manager
[sessionmanager]: /docs/sdks/reference/cpp/agents/mcp-gateway/session-manager
[run]: /docs/sdks/reference/cpp/agents/mcp-gateway/mcp-gateway/run
[shutdown]: /docs/sdks/reference/cpp/agents/mcp-gateway/mcp-gateway/shutdown
...
sets up authenticated HTTP routes, and runs a HTTP server that translates
...
<ParamField path="app" type="httplib::Server" toc={true}>
  The underlying HTTP server application instance.
</ParamField>

<ParamField path="config" type="std::map<std::string, nlohmann::json>" toc={true}>
...
<ParamField path="session_manager" type="security::SessionManager" toc={true}>
...
to run the gateway from the command line without writing any C++ code.
</Tip>

## **Methods**

<CardGroup cols={2}>
  <Card title="run" href="/docs/sdks/reference/cpp/agents/mcp-gateway/mcp-gateway/run">
    Start the gateway HTTP server, blocking until shutdown.
  </Card>
  <Card title="shutdown" href="/docs/sdks/reference/cpp/agents/mcp-gateway/mcp-gateway/shutdown">
