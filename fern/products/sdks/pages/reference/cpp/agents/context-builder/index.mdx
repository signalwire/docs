...
slug: /reference/cpp/agents/context-builder
...
[addcontext]: /docs/sdks/reference/cpp/agents/context-builder/add-context
[getcontext]: /docs/sdks/reference/cpp/agents/context-builder/get-context
[todict]: /docs/sdks/reference/cpp/agents/context-builder/to-json
[validate]: /docs/sdks/reference/cpp/agents/context-builder/validate
...
<CardGroup cols={4}>
  <Card title="add_context" href="/docs/sdks/reference/cpp/agents/context-builder/add-context">
    Create a new named context and add it to the builder.
  </Card>
  <Card title="get_context" href="/docs/sdks/reference/cpp/agents/context-builder/get-context">
    Retrieve an existing context by name.
  </Card>
  <Card title="to_dict" href="/docs/sdks/reference/cpp/agents/context-builder/to-json">
    Convert all contexts to a dictionary for SWML generation.
  </Card>
  <Card title="validate" href="/docs/sdks/reference/cpp/agents/context-builder/validate">
...
class OrderAgent : public signalwire::agent::AgentBase {
public:
    // Constructor
    explicit AgentBase() {
        super().constructor("order-agent");
        add_language("English", "en-US", "rime.spore");
        prompt_add_section("Role", "You help customers place orders.");
...
public:
    // Constructor
    explicit AgentBase() {
        super().constructor("support-agent");
        add_language("English", "en-US", "rime.spore");
        prompt_add_section("Role", "You are a customer support assistant.");
