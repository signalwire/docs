...
slug: /reference/cpp/agents/context-builder/step/add-gather-question
description: Add a question to this step's gather_info configuration.
max-toc-depth: 3
---

[set-gather-info]: /docs/sdks/reference/cpp/agents/context-builder/step/set-gather-info
...
<ParamField path="question" type="std::string" required={true} toc={true}>
  The question text to present to the caller.
</ParamField>

<ParamField path="type" type="std::string" default="string" toc={true}>
...
<ParamField path="functions" type="std::vector<std::string>" toc={true}>
