...
slug: /reference/cpp/agents/context-builder/context/set-exit-fillers
...
<ParamField path="exit_fillers" type="std::map<std::string, std::vector<std::string>>" required={true} toc={true}>
