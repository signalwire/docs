...
[infogathereragent]: /docs/sdks/reference/cpp/agents/prefabs#infogathereragent
[skillbase]: /docs/sdks/reference/cpp/agents/skill-base
...
public:
    // Constructor
    explicit AgentBase() {
        super().constructor("assistant", "/assistant");
        set_prompt_text("You are a helpful assistant.");
        add_skill("datetime", {
            "swaig_fields": {
...
<ParamField path="tool_name" type="std::string" default="calculate" toc={true}>
  Custom function name.
</ParamField>

<ParamField path="tool_description" type="std::string" default="Perform calculations" toc={true}>
...
<ParamField path="api_key" type="std::string" required={true} toc={true}>
  Google API key with Custom Search JSON API enabled.
</ParamField>

<ParamField path="search_engine_id" type="std::string" required={true} toc={true}>
...
<ParamField path="oversample_factor" type="double" default="2.5" toc={true}>
  How many extra results to fetch for quality filtering (e.g., `2.5` fetches 2.5x the
  requested number). Range: 1.0-3.5.
</ParamField>

<ParamField path="min_quality_score" type="double" default="0.3" toc={true}>
  Quality threshold for filtering results (0.0-1.0).
</ParamField>

<ParamField path="no_results_message" type="std::string" toc={true}>
  Message to show when no quality results are found. Use `{query}` as a placeholder
  for the search query.
</ParamField>

<ParamField path="tool_name" type="std::string" default="web_search" toc={true}>
  Custom function name.
</ParamField>
...
<ParamField path="language" type="std::string" default="en" toc={true}>
...
<ParamField path="tool_name" type="std::string" default="search_wikipedia" toc={true}>
  Custom function name.
</ParamField>
...
public:
    ...
    explicit AgentBase() {
        super().constructor("assistant", "/assistant");
        set_prompt_text("You are a helpful assistant.");
        add_skill("wikipedia_search", {"sentences": 5});
...
<ParamField path="tool_name" type="std::string" default="get_weather" toc={true}>
  Custom function name.
</ParamField>

<ParamField path="tool_description" type="std::string" default="Get weather" toc={true}>
  Custom function description.
</ParamField>
...
public:
    ...
    explicit AgentBase() {
        super().constructor("assistant", "/assistant");
        set_prompt_text("You are a helpful assistant.");
        add_skill("weather_api", {{"api_key", "YOUR_WEATHER_API_KEY"}});
...
<ParamField path="tool_name" type="std::string" default="get_joke" toc={true}>
  Custom function name.
</ParamField>
...
<ParamField path="files" type="std::vector<nlohmann::json>" required={true} toc={true}>
...
<ParamField path="transfers" type="nlohmann::json" required={true} toc={true}>
...
<ParamField path="description" type="std::string" default="Transfer call based on pattern matching" toc={true}>
  Description for the transfer tool.
</ParamField>

<ParamField path="parameter_name" type="std::string" default="transfer_type" toc={true}>
  Name of the parameter that accepts the transfer type.
</ParamField>

<ParamField path="parameter_description" type="std::string" default="The type of transfer to perform" toc={true}>
  Description for the transfer type parameter.
</ParamField>

<ParamField path="default_message" type="std::string" default="Please specify a valid transfer type." toc={true}>
...
<ParamField path="required_fields" type="nlohmann::json" default="{}" toc={true}>
...
<ParamField path="space_name" type="std::string" required={true} toc={true}>
  SignalWire space name (e.g., `"mycompany"` from `mycompany.signalwire.com`).
</ParamField>

<ParamField path="project_id" type="std::string" required={true} toc={true}>
  SignalWire project ID.
</ParamField>

<ParamField path="api_token" type="std::string" required={true} toc={true}>
...
**Requirements:** Search extras installed (`install signalwire-cpp with search support`)

**Multi-instance:** Yes

<ParamField path="index_file" type="std::string" required={true} toc={true}>
  Path to the `.swsearch` index file.
</ParamField>

<ParamField path="tool_name" type="std::string" default="search_knowledge" toc={true}>
...
<ParamField path="gateway_url" type="std::string" required={true} toc={true}>
  MCP Gateway service URL.
</ParamField>

<ParamField path="auth_user" type="std::string" toc={true}>
  Basic auth username for the gateway.
</ParamField>

<ParamField path="auth_password" type="std::string" toc={true}>
  Basic auth password for the gateway.
</ParamField>

<ParamField path="auth_token" type="std::string" toc={true}>
  Bearer token (alternative to basic auth).
</ParamField>

<ParamField path="services" type="std::vector<nlohmann::json>" toc={true}>
...
<ParamField path="tool_prefix" type="std::string" default="mcp_" toc={true}>
...
<ParamField path="lookup_tool_name" type="std::string" default="lookup_address" toc={true}>
  Custom name for the address lookup function.
</ParamField>

<ParamField path="route_tool_name" type="std::string" default="compute_route" toc={true}>
...
public:
    ...
    explicit AgentBase() {
        super().constructor("assistant", "/assistant");
        set_prompt_text("You are a helpful assistant.");
        add_skill("google_maps", {{"api_key", "YOUR_GOOGLE_MAPS_API_KEY"}});
...
<ParamField path="prefix" type="std::string" toc={true}>
...
<ParamField path="skills_path" type="std::string" required={true} toc={true}>
  Path to the directory containing SKILL.md files.
</ParamField>

<ParamField path="tool_prefix" type="std::string" default="claude_" toc={true}>
...
<ParamField path="tool_name" type="std::string" toc={true}>
  Custom name for the trivia function.
</ParamField>

<ParamField path="categories" type="std::vector<std::string>" toc={true}>
...
for (const auto& skill : skills) {
    std::cout << std::string(skill['name']) + ": " + std::string(skill['description']) << std::endl;
