---
title: "add_verb"
slug: /reference/cpp/agents/swml-service/add-verb
description: "Add a SWML verb to the main section of the document."
max-toc-depth: 3
---

[ref-swmlservice]: /docs/sdks/reference/cpp/agents/swml-service
...
<ParamField path="config" type="std::variant<std::map<std::string, nlohmann::json>, int>" required={true} toc={true}>
...
std::cout << service.render_document() << std::endl;
