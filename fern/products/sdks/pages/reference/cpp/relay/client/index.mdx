---
title: "RelayClient"
slug: /reference/cpp/relay/client
...
[connect]: /docs/sdks/reference/cpp/relay/client/connect
[disconnect]: /docs/sdks/reference/cpp/relay/client/disconnect
[run]: /docs/sdks/reference/cpp/relay/client/run
[dial]: /docs/sdks/reference/cpp/relay/client/dial
[sendmessage]: /docs/sdks/reference/cpp/relay/client/send-message
[receive]: /docs/sdks/reference/cpp/relay/client/receive
[unreceive]: /docs/sdks/reference/cpp/relay/client/unreceive
[execute]: /docs/sdks/reference/cpp/relay/client/execute
...
<ParamField path="jwt_token" type="std::string" toc={true}>
...
<ParamField path="contexts" type="std::vector<std::string>" toc={true}>
  List of contexts to subscribe to for inbound call and message events.
</ParamField>

<ParamField path="max_active_calls" type="std::optional<int>" default="1000" toc={true}>
...
<ParamField path="relay_protocol" type="std::string" toc={true}>
...
// @client.on_call
void handle_call(const relay::Call& call) {
    call.answer();
    std::cout << "Received call: " + std::string(call.call_id) << std::endl;
...
// @client.on_message
void handle_message(const relay::Message& message) {
    std::cout << "Received message: " + std::string(message.body) << std::endl;
...
<CardGroup cols={4}>
  <Card title="connect" href="/docs/sdks/reference/cpp/relay/client/connect">
    Establish the WebSocket connection and authenticate.
  </Card>
  <Card title="disconnect" href="/docs/sdks/reference/cpp/relay/client/disconnect">
    Close the WebSocket connection cleanly.
  </Card>
  <Card title="run" href="/docs/sdks/reference/cpp/relay/client/run">
    Start the client with automatic reconnection.
  </Card>
  <Card title="dial" href="/docs/sdks/reference/cpp/relay/client/dial">
    Initiate an outbound call.
  </Card>
  <Card title="send_message" href="/docs/sdks/reference/cpp/relay/client/send-message">
    Send an outbound SMS or MMS message.
  </Card>
  <Card title="receive" href="/docs/sdks/reference/cpp/relay/client/receive">
    Subscribe to additional contexts for inbound events.
  </Card>
  <Card title="unreceive" href="/docs/sdks/reference/cpp/relay/client/unreceive">
    Unsubscribe from inbound event contexts.
  </Card>
  <Card title="execute" href="/docs/sdks/reference/cpp/relay/client/execute">
...
void handle_message(const auto& message) {
    std::cout << "SMS from " + std::string(message.from_number) + ": " + std::string(message.body) << std::endl;
