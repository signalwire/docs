---
title: "stream"
slug: /reference/cpp/relay/call/stream
description: "Stream call audio to a WebSocket endpoint."
max-toc-depth: 3
---

[streamaction]: /docs/sdks/reference/cpp/relay/actions
[calling-call-stream]: /docs/sdks/reference/cpp/relay/call#events
...
<ParamField path="codec" type="std::optional<std::string>" toc={true}>
...
<ParamField path="track" type="std::optional<std::string>" toc={true}>
...
<ParamField path="status_url_method" type="std::optional<std::string>" toc={true}>
...
<ParamField path="authorization_bearer_token" type="std::optional<std::string>" toc={true}>
  Bearer token for authenticating with the WebSocket server.
</ParamField>

<ParamField path="custom_parameters" type="std::optional<nlohmann::json>" toc={true}>
