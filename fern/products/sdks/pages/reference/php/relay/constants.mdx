...
[callstateevent-endreason]: /docs/sdks/reference/php/relay/events
[connectevent-connectstate]: /docs/sdks/reference/php/relay/events
[call-on]: /docs/sdks/reference/php/relay/call
[relayevent-eventtype]: /docs/sdks/reference/php/relay/events
[message-wait]: /docs/sdks/reference/php/relay/message
[playevent-state]: /docs/sdks/reference/php/relay/events
[recordevent-state]: /docs/sdks/reference/php/relay/events
...
function handleCallState($event)
{
    ...
    } elseif ($event->call_state == $CALL_STATE_ENDED) {
        echo "Call ended: {$event->end_reason}";
    }
...
function handleMessageState($message)
{
    if ($message->state $in $MESSAGE_TERMINAL_STATES) {
        echo "Message delivery complete";
    }
}
