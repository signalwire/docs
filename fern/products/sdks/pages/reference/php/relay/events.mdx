...
{
    function handleState(CallStateEvent $event)
    {
        echo "Call state: {$event->call_state}";
    }
...
<ParamField path="payload" type="array" required={true} toc={true}>
...
<ParamField path="payload.params" type="array" required={true} toc={true}>
...
```php
<?php
use SignalWire\Relay\Event\parse_event;
...
<ParamField path="device" type="array" toc={true}>
...
function handleCall($call)
{
    function handleState(CallStateEvent $event)
    {
        echo "State: {$event->call_state}, reason: {$event->end_reason}";
    }
...
dispatched at the client level via the `@client.onCall` decorator rather than
through `call.on()`.
...
function handleCall($call)
{
    function handlePlay(PlayEvent $event)
    {
        echo "Playback: {$event->state}";
    }
...
<ParamField path="record" type="array" toc={true}>
...
function handleCall($call)
{
    function handleRecord(RecordEvent $event)
    {
        echo "Recording {$event->state}: {$event->url}";
    }
...
<ParamField path="result" type="array" toc={true}>
...
function handleCall($call)
{
    function handleCollect(CollectEvent $event)
    {
        echo "Collected: {$event->result}";
    }
...
<ParamField path="peer" type="array" toc={true}>
...
function handleCall($call)
{
    function handleConnect(ConnectEvent $event)
    {
        echo "Connection: {$event->connect_state}";
    }
...
<ParamField path="detect" type="array" toc={true}>
...
function handleCall($call)
{
    function handleDetect(DetectEvent $event)
    {
        echo "Detected: {$event->detect}";
    }
...
<ParamField path="fax" type="array" toc={true}>
...
function handleCall($call)
{
    function handleFax(FaxEvent $event)
    {
        echo "Fax: {$event->fax}";
    }
...
<ParamField path="tap" type="array" toc={true}>
...
function handleCall($call)
{
    function handleTap(TapEvent $event)
    {
        echo "Tap {$event->state}: {$event->tap}";
    }
...
function handleCall($call)
{
    function handleStream(StreamEvent $event)
    {
        echo "Stream {$event->state}: {$event->url}";
    }
...
function handleCall($call)
{
    function handleDigits(SendDigitsEvent $event)
    {
        echo "Send digits: {$event->state}";
    }
...
<ParamField path="call" type="array" toc={true}>
...
function handleCall($call)
{
    function handleRefer(ReferEvent $event)
    {
        echo "Refer to {$event->sip_refer_to}: {$event->state}";
    }
...
function handleCall($call)
{
    function handleHold(HoldEvent $event)
    {
        echo "Hold: {$event->state}";
    }
...
function handleCall($call)
{
    function handleDenoise(DenoiseEvent $event)
    {
        echo "Denoise active: {$event->denoised}";
    }
...
function handleCall($call)
{
    function handlePay(PayEvent $event)
    {
        echo "Payment: {$event->state}";
    }
...
function handleCall($call)
{
    function handleEcho(EchoEvent $event)
    {
        echo "Echo: {$event->state}";
    }
...
function handleCall($call)
{
    function handleQueue(QueueEvent $event)
    {
        echo "Queue {$event->queue_name}: position {$event->position}/{$event->size}";
    }
...
function handleCall($call)
{
    function handleConference(ConferenceEvent $event)
    {
        echo "Conference {$event->name}: {$event->status}";
    }
...
function handleCall($call)
{
    function handleTranscribe(TranscribeEvent $event)
    {
        echo "Transcription {$event->state}: {$event->url}";
    }
...
function handleCall($call)
{
    function handleError(CallingErrorEvent $event)
    {
...
This event is dispatched at the client level via the `@client.onMessage`
decorator.
...
{
    function handleState(MessageStateEvent $event)
    {
        echo "Message {$event->message_id}: {$event->message_state}";
    }
