...
<ParamField path="audio" type="mixed" default="None" toc={true}>
  Audio input. Accepted for API compatibility.
</ParamField>

<ParamField path="model_settings" type="mixed" default="None" toc={true}>
...
<ParamField path="chat_ctx" type="mixed" default="None" toc={true}>
  Chat context. Accepted for API compatibility.
</ParamField>

<ParamField path="tools" type="mixed" default="None" toc={true}>
...
<ParamField path="text" type="mixed" default="None" toc={true}>
