---
title: "searchDirect"
slug: /reference/php/agents/search/search-service/search-direct
...
<ParamField path="language" type="?string" toc={true}>
  Language code for query processing, or `null` for auto-detection.
</ParamField>
...
foreach ($response["results"] as $result) {
    echo "[{$result['score']:.3f}] {$result['content'][:100]}";
}
