...
slug: /reference/php/agents/search/migrator/migrate-sqlite-to-pgvector
...
`dict[string, mixed]` -- Migration statistics containing:
...
echo "Migrated {$stats['chunks_migrated']} chunks with {$stats['errors']} errors";
