---
title: "MCPGateway"
slug: /reference/php/agents/mcp-gateway/mcp-gateway
description: The main HTTP gateway service bridging MCP servers with SignalWire SWAIG functions.
max-toc-depth: 3
---

[mcpmanager]: /docs/sdks/reference/php/agents/mcp-gateway/mcp-manager
[sessionmanager]: /docs/sdks/reference/php/agents/mcp-gateway/session-manager
...
[run]: /docs/sdks/reference/php/agents/mcp-gateway/mcp-gateway/run
[shutdown]: /docs/sdks/reference/php/agents/mcp-gateway/mcp-gateway/shutdown
...
```php
<?php
use SignalWire\McpGateway\main;
...
<CardGroup cols={2}>
  <Card title="run" href="/docs/sdks/reference/php/agents/mcp-gateway/mcp-gateway/run">
    Start the gateway HTTP server, blocking until shutdown.
  </Card>
  <Card title="shutdown" href="/docs/sdks/reference/php/agents/mcp-gateway/mcp-gateway/shutdown">
