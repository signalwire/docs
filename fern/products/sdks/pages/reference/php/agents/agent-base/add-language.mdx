---
title: "addLanguage"
slug: /reference/php/agents/agent-base/add-language
...
<ParamField path="speech_fillers" type="?array" toc={true}>
  Filler phrases used during natural speech pauses (e.g., `["Um...", "Let me see..."]`).
</ParamField>

<ParamField path="function_fillers" type="?array" toc={true}>
