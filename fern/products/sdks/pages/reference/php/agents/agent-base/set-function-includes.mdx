...
slug: /reference/php/agents/agent-base/set-function-includes
...
[add-function-include]: /docs/sdks/reference/php/agents/agent-base/add-function-include
...
<ParamField path="includes" type="array" required={true} toc={true}>
