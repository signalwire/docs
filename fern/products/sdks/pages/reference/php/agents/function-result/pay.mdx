---
title: "pay"
slug: /reference/php/agents/function-result/pay
description: Collect and process a credit card payment during a call.
max-toc-depth: 3
---

[create-payment-parameter]: /docs/sdks/reference/php/agents/function-result/create-payment-parameter
...
<ParamField path="postal_code" type="bool|string" default="True" toc={true}>
...
<ParamField path="parameters" type="?array" default="None" toc={true}>
...
<ParamField path="prompts" type="?array" default="None" toc={true}>
...
// Tool decorator: @agent.tool(name="collect_payment", description="Collect a credit card payment")
function collectPayment($args, $raw_data)
{
    $amount = $args["amount"] ?? null;
    return (;
        new FunctionResult("I'll collect your payment information now.")
        .$pay(
