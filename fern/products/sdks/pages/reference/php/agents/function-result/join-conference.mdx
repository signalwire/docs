...
slug: /reference/php/agents/function-result/join-conference
...
<ParamField path="result" type="?mixed" default="None" toc={true}>
...
// Tool decorator: @agent.tool(name="join_team_call", description="Join the team standup call")
function joinTeamCall($args, $raw_data)
{
    return (;
        new FunctionResult("Joining the team call.")
...
// Tool decorator: @agent.tool(name="join_moderated_conference", description="Join a moderated conference")
function joinModeratedConference($args, $raw_data)
{
    return (;
        new FunctionResult("Joining the conference.")
        .joinConference(
