---
title: "setGatherInfo"
slug: /reference/php/agents/context-builder/step/set-gather-info
description: Enable structured info gathering for this step.
max-toc-depth: 3
---

[add-gather-question]: /docs/sdks/reference/php/agents/context-builder/step/add-gather-question
...
<ParamField path="output_key" type="string" toc={true}>
  Key in `global_data` to store collected answers under. When `null`, answers are
