...
slug: /reference/php/agents/skill-base/get-parameter-schema
...
`dict[string, dict[string, mixed]]` -- Parameter schema where keys are parameter names
...
// Inspect the schema
echo $WeatherSkill->get_parameter_schema();
