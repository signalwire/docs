---
title: "get"
slug: /reference/java/rest/fabric/ai-agents/get
...
`Map<String, Object>` -- The AI agent resource.
...
var agent = client.fabric.ai_agents.get("agent-id");
System.out.println("AI Agent: " + agent['name'] + ", ID: " + agent['id']);
