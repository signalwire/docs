...
slug: /reference/java/agents/function-result/join-conference
...
<ParamField path="startOnEnter" type="boolean" default="true" toc={true}>
...
<ParamField path="endOnExit" type="boolean" default="false" toc={true}>
  Whether the conference ends for all participants when this participant leaves.
</ParamField>

<ParamField path="waitUrl" type="@Nullable String" default="null" toc={true}>
  SWML URL for hold music played while waiting for the conference to start.
  When `null`, default hold music is used.
</ParamField>

<ParamField path="maxParticipants" type="int" default="250" toc={true}>
...
<ParamField path="coach" type="@Nullable String" default="null" toc={true}>
...
<ParamField path="statusCallbackEvent" type="@Nullable String" default="null" toc={true}>
...
<ParamField path="statusCallback" type="@Nullable String" default="null" toc={true}>
...
<ParamField path="recordingStatusCallback" type="@Nullable String" default="null" toc={true}>
...
<ParamField path="result" type="@Nullable Object" default="null" toc={true}>
  Result handling configuration. Pass an object `{}` for `returnValue`-based
...
agent.defineTool("joinTeamCall",
    "Join the team standup call",
    (args, rawData) -> {
        return ( FunctionResult("Joining the team call.") .join_conference("team-standup") );
    });
agent.serve();
...
agent.defineTool("joinModeratedConference",
    "Join a moderated conference",
    (args, rawData) -> {
        return ( FunctionResult("Joining the conference.") .join_conference( "quarterly-review", true, false, "record-from-start", 50 ) );
    });
agent.serve();
