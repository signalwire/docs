...
[callstateevent-endreason]: /docs/sdks/reference/java/relay/events
[connectevent-connectstate]: /docs/sdks/reference/java/relay/events
[call-on]: /docs/sdks/reference/java/relay/call
[relayevent-eventtype]: /docs/sdks/reference/java/relay/events
[message-wait]: /docs/sdks/reference/java/relay/message
[playevent-state]: /docs/sdks/reference/java/relay/events
[recordevent-state]: /docs/sdks/reference/java/relay/events
...
<ParamField path="PROTOCOL_VERSION" type="Map<String, Object>" toc={true}>
...
<ParamField path="CALL_STATES" type="Tuple<String, ...>" toc={true}>
...
<ParamField path="MESSAGE_TERMINAL_STATES" type="Tuple<String, ...>" toc={true}>
