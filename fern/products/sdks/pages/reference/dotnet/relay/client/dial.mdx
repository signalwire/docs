---
title: "dial"
slug: /reference/dotnet/relay/client/dial
...
<ParamField path="devices" type="List<List<Dictionary<string, object>>>" required={true} toc={true}>
...
<ParamField path="dial_timeout" type="double?" default="120.0" toc={true}>
