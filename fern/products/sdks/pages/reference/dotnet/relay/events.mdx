...
async Task OnCall(call)
{
    FunctionResult HandleState(Dictionary<string, object> args, Dictionary<string, object?> rawData)
        Console.WriteLine($"Call state: {event.call_state}");
...
<ParamField path="call_id" type="string" default="" toc={true}>
...
<ParamField path="payload" type="Dictionary<string, object>" required={true} toc={true}>
...
<ParamField path="payload.params" type="Dictionary<string, object>" required={true} toc={true}>
...
Console.WriteLine(event.event_type)  # "calling.call.state";
...
Console.WriteLine(event.state)  # "playing";
...
<ParamField path="call_state" type="string" default="" toc={true}>
  The new call state.
...
<ParamField path="end_reason" type="string" default="" toc={true}>
...
<ParamField path="device" type="Dictionary<string, object>" toc={true}>
...
{
    FunctionResult HandleState(Dictionary<string, object> args, Dictionary<string, object?> rawData)
        Console.WriteLine($"State: {event.call_state}, reason: {event.end_reason}");
...
<ParamField path="node_id" type="string" default="" toc={true}>
  RELAY node handling this call.
</ParamField>

<ParamField path="project_id" type="string" default="" toc={true}>
...
<ParamField path="segment_id" type="string" default="" toc={true}>
...
<ParamField path="control_id" type="string" default="" toc={true}>
...
async Task HandleCall(call)
{
    FunctionResult HandlePlay(Dictionary<string, object> args, Dictionary<string, object?> rawData)
        Console.WriteLine($"Playback: {event.state}");
...
<ParamField path="record" type="Dictionary<string, object>" toc={true}>
...
async Task HandleCall(call)
{
    FunctionResult HandleRecord(Dictionary<string, object> args, Dictionary<string, object?> rawData)
        Console.WriteLine($"Recording {event.state}: {event.url}");
...
<ParamField path="result" type="Dictionary<string, object>" toc={true}>
...
<ParamField path="final" type="bool?" toc={true}>
...
async Task HandleCall(call)
{
    FunctionResult HandleCollect(Dictionary<string, object> args, Dictionary<string, object?> rawData)
        Console.WriteLine($"Collected: {event.result}");
...
<ParamField path="connect_state" type="string" default="" toc={true}>
  Connection state.
...
<ParamField path="peer" type="Dictionary<string, object>" toc={true}>
...
async Task HandleCall(call)
{
    FunctionResult HandleConnect(Dictionary<string, object> args, Dictionary<string, object?> rawData)
        Console.WriteLine($"Connection: {event.connect_state}");
...
<ParamField path="detect" type="Dictionary<string, object>" toc={true}>
...
async Task HandleCall(call)
{
    FunctionResult HandleDetect(Dictionary<string, object> args, Dictionary<string, object?> rawData)
        Console.WriteLine($"Detected: {event.detect}");
...
<ParamField path="fax" type="Dictionary<string, object>" toc={true}>
...
async Task HandleCall(call)
{
    FunctionResult HandleFax(Dictionary<string, object> args, Dictionary<string, object?> rawData)
        Console.WriteLine($"Fax: {event.fax}");
...
<ParamField path="tap" type="Dictionary<string, object>" toc={true}>
...
async Task HandleCall(call)
{
    FunctionResult HandleTap(Dictionary<string, object> args, Dictionary<string, object?> rawData)
        Console.WriteLine($"Tap {event.state}: {event.tap}");
...
async Task HandleCall(call)
{
    FunctionResult HandleStream(Dictionary<string, object> args, Dictionary<string, object?> rawData)
        Console.WriteLine($"Stream {event.state}: {event.url}");
...
async Task HandleCall(call)
{
    FunctionResult HandleDigits(Dictionary<string, object> args, Dictionary<string, object?> rawData)
        Console.WriteLine($"Send digits: {event.state}");
...
<ParamField path="dial_state" type="string" default="" toc={true}>
  Dial state.
...
<ParamField path="call" type="Dictionary<string, object>" toc={true}>
...
<ParamField path="sip_refer_to" type="string" default="" toc={true}>
  The SIP URI the call was referred to.
</ParamField>

<ParamField path="sip_refer_response_code" type="string" default="" toc={true}>
  SIP response code from the REFER request.
</ParamField>

<ParamField path="sip_notify_response_code" type="string" default="" toc={true}>
...
async Task HandleCall(call)
{
    FunctionResult HandleRefer(Dictionary<string, object> args, Dictionary<string, object?> rawData)
        Console.WriteLine($"Refer to {event.sip_refer_to}: {event.state}");
...
async Task HandleCall(call)
{
    FunctionResult HandleHold(Dictionary<string, object> args, Dictionary<string, object?> rawData)
        Console.WriteLine($"Hold: {event.state}");
...
async Task HandleCall(call)
{
    FunctionResult HandleDenoise(Dictionary<string, object> args, Dictionary<string, object?> rawData)
        Console.WriteLine($"Denoise active: {event.denoised}");
...
async Task HandleCall(call)
{
    FunctionResult HandlePay(Dictionary<string, object> args, Dictionary<string, object?> rawData)
        Console.WriteLine($"Payment: {event.state}");
...
async Task HandleCall(call)
{
    FunctionResult HandleEcho(Dictionary<string, object> args, Dictionary<string, object?> rawData)
        Console.WriteLine($"Echo: {event.state}");
...
<ParamField path="queue_id" type="string" default="" toc={true}>
  The queue identifier.
</ParamField>

<ParamField path="queue_name" type="string" default="" toc={true}>
  The queue name.
</ParamField>
...
async Task HandleCall(call)
{
    FunctionResult HandleQueue(Dictionary<string, object> args, Dictionary<string, object?> rawData)
        Console.WriteLine($"Queue {event.queue_name}: position {event.position}/{event.size}");
...
<ParamField path="conference_id" type="string" default="" toc={true}>
...
async Task HandleCall(call)
{
    FunctionResult HandleConference(Dictionary<string, object> args, Dictionary<string, object?> rawData)
        Console.WriteLine($"Conference {event.name}: {event.status}");
...
<ParamField path="recording_id" type="string" default="" toc={true}>
...
async Task HandleCall(call)
{
    FunctionResult HandleTranscribe(Dictionary<string, object> args, Dictionary<string, object?> rawData)
        Console.WriteLine($"Transcription {event.state}: {event.url}");
...
async Task HandleCall(call)
{
    FunctionResult HandleError(Dictionary<string, object> args, Dictionary<string, object?> rawData)
        Console.WriteLine($"Error {event.code}: {event.message}");
...
<ParamField path="message_id" type="string" default="" toc={true}>
...
<ParamField path="from_number" type="string" default="" toc={true}>
  Sender phone number in E.164 format.
</ParamField>

<ParamField path="to_number" type="string" default="" toc={true}>
...
<ParamField path="message_state" type="string" default="" toc={true}>
...
{
    FunctionResult HandleState(Dictionary<string, object> args, Dictionary<string, object?> rawData)
        Console.WriteLine($"Message {event.message_id}: {event.message_state}");
