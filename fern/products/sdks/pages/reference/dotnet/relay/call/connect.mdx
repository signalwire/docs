---
title: "connect"
slug: /reference/dotnet/relay/call/connect
description: "Bridge a call to one or more destinations."
max-toc-depth: 3
---

[calling-call-connect]: /docs/sdks/reference/dotnet/relay/call#events
...
<ParamField path="ringback" type="List<dict>?" toc={true}>
...
<ParamField path="max_price_per_minute" type="double?" toc={true}>
