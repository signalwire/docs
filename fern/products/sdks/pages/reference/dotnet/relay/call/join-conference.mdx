...
slug: /reference/dotnet/relay/call/join-conference
description: Join an ad-hoc audio conference.
max-toc-depth: 3
---

[leave-conference]: /docs/sdks/reference/dotnet/relay/call/leave-conference
[calling-conference]: /docs/sdks/reference/dotnet/relay/call#events
