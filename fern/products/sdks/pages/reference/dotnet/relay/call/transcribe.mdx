---
title: "transcribe"
slug: /reference/dotnet/relay/call/transcribe
description: "Start transcribing call audio."
max-toc-depth: 3
---

[transcribeaction]: /docs/sdks/reference/dotnet/relay/actions
[live-transcribe]: /docs/sdks/reference/dotnet/relay/call/live-transcribe
[calling-call-transcribe]: /docs/sdks/reference/dotnet/relay/call#events
...
async Task HandleCall(call)
{
    ...
    if action.result:
        ...
        Console.WriteLine($"Transcription available at: {url}");
