---
title: "Signals"
slug: /reference/dotnet/agents/livewire/signals
...
public string EndCall(reason: str)
{
...
public string TransferFunds(amount: float, to_account: str)
{
...
public AgentHandoff TransferToBilling()
{
...
<ParamField path="returns" type="object" toc={true}>
...
<ParamField path="messages" type="List<Dictionary<string, string>>" toc={true}>
