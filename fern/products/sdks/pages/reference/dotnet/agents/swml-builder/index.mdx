---
title: "SWMLBuilder"
slug: /reference/dotnet/agents/swml-builder
...
[addsection]: /docs/sdks/reference/dotnet/agents/swml-builder/add-section
[ai]: /docs/sdks/reference/dotnet/agents/swml-builder/ai
[answer]: /docs/sdks/reference/dotnet/agents/swml-builder/answer
[build]: /docs/sdks/reference/dotnet/agents/swml-builder/build
[hangup]: /docs/sdks/reference/dotnet/agents/swml-builder/hangup
[play]: /docs/sdks/reference/dotnet/agents/swml-builder/play
[render]: /docs/sdks/reference/dotnet/agents/swml-builder/render
[reset]: /docs/sdks/reference/dotnet/agents/swml-builder/reset
[say]: /docs/sdks/reference/dotnet/agents/swml-builder/say
...
<CardGroup cols={4}>
  <Card title="add_section" href="/docs/sdks/reference/dotnet/agents/swml-builder/add-section">
    Add a new named section to the SWML document.
  </Card>
  <Card title="ai" href="/docs/sdks/reference/dotnet/agents/swml-builder/ai">
    Add an AI verb to start an AI-powered conversation.
  </Card>
  <Card title="answer" href="/docs/sdks/reference/dotnet/agents/swml-builder/answer">
    Add an answer verb to the SWML document.
  </Card>
  <Card title="build" href="/docs/sdks/reference/dotnet/agents/swml-builder/build">
    Build and return the complete SWML document as a dictionary.
  </Card>
  <Card title="hangup" href="/docs/sdks/reference/dotnet/agents/swml-builder/hangup">
    Add a hangup verb to end the current call.
  </Card>
  <Card title="play" href="/docs/sdks/reference/dotnet/agents/swml-builder/play">
    Add a play verb to play audio or text-to-speech.
  </Card>
  <Card title="render" href="/docs/sdks/reference/dotnet/agents/swml-builder/render">
    Build and render the complete SWML document as a JSON string.
  </Card>
  <Card title="reset" href="/docs/sdks/reference/dotnet/agents/swml-builder/reset">
    Reset the SWML document to an empty state.
  </Card>
  <Card title="say" href="/docs/sdks/reference/dotnet/agents/swml-builder/say">
