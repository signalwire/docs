---
title: "SearchService"
slug: /reference/dotnet/agents/search/search-service
...
[start]: /docs/sdks/reference/dotnet/agents/search/search-service/start
[searchdirect]: /docs/sdks/reference/dotnet/agents/search/search-service/search-direct
[stop]: /docs/sdks/reference/dotnet/agents/search/search-service/stop
...
<ParamField path="indexes" type="Dictionary<string, string>" toc={true}>
  Mapping of index names to file paths (SQLite) or collection names (pgvector).
</ParamField>

<ParamField path="search_engines" type="Dictionary<string, SearchEngine>" toc={true}>
...
<CardGroup cols={2}>
  <Card title="start" href="/docs/sdks/reference/dotnet/agents/search/search-service/start">
    Start the HTTP service. Blocks until the server is shut down.
  </Card>
  <Card title="search_direct" href="/docs/sdks/reference/dotnet/agents/search/search-service/search-direct">
    Perform a search programmatically without going through the HTTP API.
  </Card>
  <Card title="stop" href="/docs/sdks/reference/dotnet/agents/search/search-service/stop">
