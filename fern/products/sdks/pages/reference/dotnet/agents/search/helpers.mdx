...
slug: /reference/dotnet/agents/search/helpers
description: "Query preprocessing, document preprocessing, model alias resolution, and constants."
max-toc-depth: 3
---

[searchservice]: /docs/sdks/reference/dotnet/agents/search/search-service
[searchengine]: /docs/sdks/reference/dotnet/agents/search/search-engine
[searchengine-search]: /docs/sdks/reference/dotnet/agents/search/search-engine/search
[indexbuilder]: /docs/sdks/reference/dotnet/agents/search/index-builder
...
`dotnet add package SignalWire.Sdk[search]`.
</Warning>
...
**preprocess_query**(`query`, `language: "en"`, `posToExpand: null`, `maxSynonyms: 5`, `debug: false`, `vector: false`, `queryNlpBackend: "nltk"`, `modelName: null`, `preserveOriginal: true`) -> `dict[str, Any]`
...
<ParamField path="pos_to_expand" type="List<string>?" toc={true}>
...
<ParamField path="query_nlp_backend" type="string" default="nltk" toc={true}>
...
Console.WriteLine(result["enhanced_text"]);
...
<ParamField path="index_nlp_backend" type="string" default="nltk" toc={true}>
...
<ParamField path="model_name" type="string" required={true} toc={true}>
...
Console.WriteLine(resolve_model_alias("mini"));
// "sentence-transformers/all-MiniLM-L6-v2"

Console.WriteLine(resolve_model_alias("sentence-transformers/all-mpnet-base-v2"));
...
Console.WriteLine(MODEL_ALIASES)  # dict[str, str];
...
Console.WriteLine(DEFAULT_MODEL)  # "sentence-transformers/all-MiniLM-L6-v2";
