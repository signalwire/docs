...
slug: /reference/dotnet/agents/search/migrator/migrate-sqlite-to-pgvector
...
Console.WriteLine($"Migrated {stats['chunks_migrated']} chunks with {stats['errors']} errors");
