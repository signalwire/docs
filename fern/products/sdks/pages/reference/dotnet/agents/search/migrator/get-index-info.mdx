---
title: "GetIndexInfo"
slug: /reference/dotnet/agents/search/migrator/get-index-info
...
Console.WriteLine($"Chunks: {info.get('total_chunks', 'N/A')}");
Console.WriteLine($"Files: {info.get('total_files', 'N/A')}");
