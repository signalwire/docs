---
title: "pay"
slug: /reference/dotnet/agents/function-result/pay
description: Collect and process a credit card payment during a call.
max-toc-depth: 3
---

[create-payment-parameter]: /docs/sdks/reference/dotnet/agents/function-result/create-payment-parameter
...
<ParamField path="parameters" type="List<Dictionary<string, string>>?" default="None" toc={true}>
...
<ParamField path="prompts" type="List<Dictionary<string, object>>?" default="None" toc={true}>
...
FunctionResult CollectPayment(Dictionary<string, object> args, Dictionary<string, object?> rawData)
    amount = args["amount"];
    return (;
