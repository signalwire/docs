...
slug: /reference/dotnet/agents/agent-base/set-internal-fillers
...
<ParamField path="internal_fillers" type="Dictionary<str, dict[str, List<str]>>" required={true} toc={true}>
