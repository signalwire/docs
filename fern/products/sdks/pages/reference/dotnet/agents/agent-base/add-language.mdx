---
title: "AddLanguage"
slug: /reference/dotnet/agents/agent-base/add-language
...
<ParamField path="speech_fillers" type="List<string>?" toc={true}>
  Filler phrases used during natural speech pauses (e.g., `["Um...", "Let me see..."]`).
</ParamField>

<ParamField path="function_fillers" type="List<string>?" toc={true}>
