---
title: "CreateSession"
slug: /reference/dotnet/agents/mcp-gateway/session-manager/create-session
...
<ParamField path="metadata" type="Dictionary<string, object>?" toc={true}>
...
Console.WriteLine(session.session_id)  # "call-abc-123";
