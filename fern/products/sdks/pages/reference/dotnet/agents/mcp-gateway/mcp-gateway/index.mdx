---
title: "MCPGateway"
slug: /reference/dotnet/agents/mcp-gateway/mcp-gateway
description: The main HTTP gateway service bridging MCP servers with SignalWire SWAIG functions.
max-toc-depth: 3
---

[mcpmanager]: /docs/sdks/reference/dotnet/agents/mcp-gateway/mcp-manager
[sessionmanager]: /docs/sdks/reference/dotnet/agents/mcp-gateway/session-manager
[securityconfig]: /docs/sdks/reference/dotnet/agents/configuration/security-config
[mcp-gateway-cli-command]: /docs/sdks/reference/dotnet/agents/cli/mcp-gateway
[run]: /docs/sdks/reference/dotnet/agents/mcp-gateway/mcp-gateway/run
[shutdown]: /docs/sdks/reference/dotnet/agents/mcp-gateway/mcp-gateway/shutdown
...
<CardGroup cols={2}>
  <Card title="run" href="/docs/sdks/reference/dotnet/agents/mcp-gateway/mcp-gateway/run">
    Start the gateway HTTP server, blocking until shutdown.
  </Card>
  <Card title="shutdown" href="/docs/sdks/reference/dotnet/agents/mcp-gateway/mcp-gateway/shutdown">
