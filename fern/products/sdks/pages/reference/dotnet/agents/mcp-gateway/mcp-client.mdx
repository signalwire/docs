---
title: "MCPClient"
slug: /reference/dotnet/agents/mcp-gateway/mcp-client
description: Manage a single MCP server subprocess with JSON-RPC communication.
max-toc-depth: 3
---

[mcpmanager-create-client]: /docs/sdks/reference/dotnet/agents/mcp-gateway/mcp-manager/create-client
[mcpservice]: /docs/sdks/reference/dotnet/agents/mcp-gateway/mcp-manager
...
<ParamField path="tools" type="List<Dictionary<string, object>>" toc={true}>
...
<ParamField path="arguments" type="Dictionary<string, object>" required={true} toc={true}>
...
Console.WriteLine($"Tools: {[t['name'] for t in tools]}");
