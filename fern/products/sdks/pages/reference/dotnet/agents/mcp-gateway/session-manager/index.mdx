...
slug: /reference/dotnet/agents/mcp-gateway/session-manager
description: Manage MCP session lifecycles with automatic timeout and cleanup.
max-toc-depth: 3
---

[mcpclient]: /docs/sdks/reference/dotnet/agents/mcp-gateway/mcp-client
[sessionmanager-createsession]: /docs/sdks/reference/dotnet/agents/mcp-gateway/session-manager/create-session
[getsession]: /docs/sdks/reference/dotnet/agents/mcp-gateway/session-manager/get-session
[createsession]: /docs/sdks/reference/dotnet/agents/mcp-gateway/session-manager/create-session
[closesession]: /docs/sdks/reference/dotnet/agents/mcp-gateway/session-manager/close-session
[listsessions]: /docs/sdks/reference/dotnet/agents/mcp-gateway/session-manager/list-sessions
[shutdown]: /docs/sdks/reference/dotnet/agents/mcp-gateway/session-manager/shutdown
...
<ParamField path="metadata" type="Dictionary<string, object>" default="{}" toc={true}>
...
<CardGroup cols={2}>
  <Card title="create_session" href="/docs/sdks/reference/dotnet/agents/mcp-gateway/session-manager/create-session">
    Create and register a new MCP session.
  </Card>
  <Card title="get_session" href="/docs/sdks/reference/dotnet/agents/mcp-gateway/session-manager/get-session">
    Retrieve an active session by ID.
  </Card>
  <Card title="close_session" href="/docs/sdks/reference/dotnet/agents/mcp-gateway/session-manager/close-session">
    Close and remove a session.
  </Card>
  <Card title="list_sessions" href="/docs/sdks/reference/dotnet/agents/mcp-gateway/session-manager/list-sessions">
    List all active sessions with metadata.
  </Card>
  <Card title="shutdown" href="/docs/sdks/reference/dotnet/agents/mcp-gateway/session-manager/shutdown">
