---
title: "CLI Tools"
slug: /reference/dotnet/agents/cli
description: "Command-line tools for testing, searching, and scaffolding."
max-toc-depth: 3
---

[swaig-test]: /docs/sdks/reference/dotnet/agents/cli/swaig-test
[sw-search]: /docs/sdks/reference/dotnet/agents/cli/sw-search
[sw-agent-init]: /docs/sdks/reference/dotnet/agents/cli/sw-agent-init
[sw-agent-dokku]: /docs/sdks/reference/dotnet/agents/cli/sw-agent-dokku
...
|-------|-----------------|--------------|
| `search` | `dotnet add package SignalWire.Sdk"[search]"` | `sw-search` build and query |
| `search-full` | `dotnet add package SignalWire.Sdk"[search-full]"` | PDF and DOCX processing |
| `search-nlp` | `dotnet add package SignalWire.Sdk"[search-nlp]"` | Advanced NLP features (spaCy) |
| `search-queryonly` | `dotnet add package SignalWire.Sdk"[search-queryonly]"` | Query-only mode (smaller install) |
| `pgvector` | `dotnet add package SignalWire.Sdk"[pgvector]"` | PostgreSQL vector storage |

<CardGroup cols={2}>
  <Card
    title="swaig-test"
    href="/docs/sdks/reference/dotnet/agents/cli/swaig-test"
  >
    Test SWAIG functions, generate SWML, and simulate serverless environments.
  </Card>
  <Card
    title="sw-search"
    href="/docs/sdks/reference/dotnet/agents/cli/sw-search"
  >
    Build, search, and validate vector search indexes for agent knowledge bases.
  </Card>
  <Card
    title="sw-agent-init"
    href="/docs/sdks/reference/dotnet/agents/cli/sw-agent-init"
  >
    Scaffold new agent projects with configurable templates and platform targets.
  </Card>
  <Card
    title="sw-agent-dokku"
    href="/docs/sdks/reference/dotnet/agents/cli/sw-agent-dokku"
  >
    Deploy and manage agents on Dokku with CI/CD support.
  </Card>
  <Card
    title="mcp-gateway"
    href="/docs/sdks/reference/dotnet/agents/cli/mcp-gateway"
  >
