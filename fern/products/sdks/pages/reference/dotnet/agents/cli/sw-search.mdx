---
title: "sw-search"
slug: /reference/dotnet/agents/cli/sw-search
...
<Note>
Requires the search extras: `dotnet add package SignalWire.Sdk"[search]"`.
...
var agent = new AgentBase(name: "search-agent", route: "/");
