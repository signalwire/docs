...
slug: /reference/dotnet/agents/swml-service/register-routing-callback
...
<ParamField path="request_body" type="Dictionary<string, object>" required={true} toc={true}>
...
FunctionResult RouteSipCall(Dictionary<string, object> args, Dictionary<string, object?> rawData)
