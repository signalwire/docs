---
title: "Skills"
slug: /reference/dotnet/agents/skills
...
[sw-search]: /docs/sdks/reference/dotnet/agents/cli/sw-search
[infogathereragent]: /docs/sdks/reference/dotnet/agents/prefabs#infogathereragent
...
class MyAgent(AgentBase):
    FunctionResult Init(Dictionary<string, object> args, Dictionary<string, object?> rawData)
        super().constructor(name: "my-agent");
...
class MyAgent(AgentBase):
    FunctionResult Init(Dictionary<string, object> args, Dictionary<string, object?> rawData)
        super().constructor(name: "assistant", route: "/assistant");
        this.SetPromptText("You are a helpful assistant.")
        this.AddSkill("datetime", {
            "swaig_fields": {
...
**Requirements:** Search extras installed (`dotnet add package SignalWire.Sdk"[search]"`)
