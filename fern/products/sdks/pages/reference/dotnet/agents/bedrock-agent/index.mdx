---
title: "BedrockAgent"
slug: /reference/dotnet/agents/bedrock-agent
...
[setvoice]: /docs/sdks/reference/dotnet/agents/bedrock-agent/set-voice
[setinferenceparams]: /docs/sdks/reference/dotnet/agents/bedrock-agent/set-inference-params
...
<ParamField path="temperature" type="double" default="0.7" toc={true}>
  Generation temperature. Range: 0 to 1.
</ParamField>

<ParamField path="top_p" type="double" default="0.9" toc={true}>
...
<CardGroup cols={2}>
  <Card title="set_voice" href="/docs/sdks/reference/dotnet/agents/bedrock-agent/set-voice">
    Set the Bedrock voice ID after construction.
  </Card>
  <Card title="set_inference_params" href="/docs/sdks/reference/dotnet/agents/bedrock-agent/set-inference-params">
...
var standard_agent = new AgentBase(name: "standard", route: "/standard");
