...
slug: /reference/ruby/rest/calling/receive-fax-stop
description: Stop an in-progress fax receive operation on a call via REST.
max-toc-depth: 3
---

[receive-fax]: /docs/sdks/reference/ruby/relay/call/receive-fax
...
`Hash` — The API response confirming the fax receive was stopped.
