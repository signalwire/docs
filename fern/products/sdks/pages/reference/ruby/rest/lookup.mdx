---
title: "Lookup"
slug: /reference/ruby/rest/lookup
...
`Hash` -- Lookup result containing carrier, CNAM, and number format details.
...
puts("Carrier:", info.fetch("carrier", {})["name"])
puts("Type:", info.fetch("carrier", {})["type"])
```
