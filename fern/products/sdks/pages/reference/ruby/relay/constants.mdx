---
title: "Constants"
slug: /reference/ruby/relay/constants
description: "RELAY constants for call states, events, and message states."
max-toc-depth: 3
---

[callstateevent-endreason]: /docs/sdks/reference/ruby/relay/events
[connectevent-connectstate]: /docs/sdks/reference/ruby/relay/events
[call-on]: /docs/sdks/reference/ruby/relay/call
[relayevent-eventtype]: /docs/sdks/reference/ruby/relay/events
[message-wait]: /docs/sdks/reference/ruby/relay/message
[playevent-state]: /docs/sdks/reference/ruby/relay/events
[recordevent-state]: /docs/sdks/reference/ruby/relay/events
...
<ParamField path="AGENT_STRING" type="String" toc={true}>
  User agent string sent during connection. Value: `"signalwire-agents-ruby/1.0"`.
</ParamField>
...
<ParamField path="CALL_STATES" type="Array" toc={true}>
...
<ParamField path="MESSAGE_TERMINAL_STATES" type="Array" toc={true}>
...
def handle_call_state(event)
    if event.call_state == CALL_STATE_ANSWERED
        ...
        puts("Call ended: #{event.end_reason}")

# Check terminal message states
def handle_message_state(message)
    if MESSAGE_TERMINAL_STATES.include?(message.state)
        puts("Message delivery complete")
```
