---
title: "queue_enter"
slug: /reference/ruby/relay/call/queue-enter
description: Place a call into a named queue.
max-toc-depth: 3
---

[queue-leave]: /docs/sdks/reference/ruby/relay/call/queue-leave
...
`Hash` -- Server response confirming the call entered the queue.
