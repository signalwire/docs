---
title: "transcribe"
slug: /reference/ruby/relay/call/transcribe
description: "Start transcribing call audio."
max-toc-depth: 3
---

[transcribeaction]: /docs/sdks/reference/ruby/relay/actions
[live-transcribe]: /docs/sdks/reference/ruby/relay/call/live-transcribe
[calling-call-transcribe]: /docs/sdks/reference/ruby/relay/call#events
...
def handle_call(call)
    ...
    if action.result
        url = action.result.params.fetch("url", "")
        puts("Transcription available at: #{url}")
