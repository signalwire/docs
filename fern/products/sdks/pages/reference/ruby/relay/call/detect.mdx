---
title: "detect"
slug: /reference/ruby/relay/call/detect
description: "Detect answering machines, fax tones, or digits on a call."
max-toc-depth: 3
---

[detectaction]: /docs/sdks/reference/ruby/relay/actions
[calling-call-detect]: /docs/sdks/reference/ruby/relay/call#events
...
def handle_call(call)
    ...
    if detect_result["type"] == "machine"
        puts("Answering machine detected")
        call.hangup()
    else
        puts("Human answered")
