...
slug: /reference/ruby/relay/call/play-and-collect
description: "Play audio and collect DTMF or speech input."
max-toc-depth: 3
---

[collectaction]: /docs/sdks/reference/ruby/relay/actions
...
<ParamField path="collect.speech.hints" type="Array\<String\>" toc={true}>
