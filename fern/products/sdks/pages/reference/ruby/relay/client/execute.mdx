---
title: "execute"
slug: /reference/ruby/relay/client/execute
description: "Send a raw JSON-RPC request to RELAY."
max-toc-depth: 3
---

[dial]: /docs/sdks/reference/ruby/relay/client/dial
[send-message]: /docs/sdks/reference/ruby/relay/client/send-message
...
`Hash` -- The `result` object from the JSON-RPC response. Structure depends on the method called.
