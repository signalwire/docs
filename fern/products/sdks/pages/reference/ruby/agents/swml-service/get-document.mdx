---
title: "get_document"
slug: /reference/ruby/agents/swml-service/get-document
description: "Get the current SWML document as a Python dictionary."
max-toc-depth: 3
---

Get the current SWML document as a Ruby hash. The returned structure follows
...
puts(doc["version"])       # "1.0.0"
puts(len(doc["sections"]["main"]))  # 2
```
