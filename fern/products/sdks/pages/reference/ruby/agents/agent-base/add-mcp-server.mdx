...
slug: /reference/ruby/agents/agent-base/add-mcp-server
description: Add an external MCP server for tool discovery and invocation.
max-toc-depth: 3
---

[enable-mcp-server]: /docs/sdks/reference/ruby/agents/agent-base/enable-mcp-server
...
<ParamField path="headers" type="Hash, nil" toc={true}>
...
<ParamField path="resource_vars" type="Hash, nil" toc={true}>
