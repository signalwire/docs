...
slug: /reference/ruby/agents/agent-base/set-prompt-pom
...
<ParamField path="pom" type="Array\<Hash\>" required={true} toc={true}>
  POM dictionary structure. Each item in the list is a section with keys:
  - `title` (str) -- Section heading
  - `body` (str) -- Section body text
  - `bullets` (Array\<String\>) -- Optional bullet points
  - `numbered` (bool) -- Whether the section is numbered
  - `subsections` (Array\<Hash\>) -- Optional nested sections with the same keys
</ParamField>
