...
slug: /reference/ruby/agents/agent-base/define-contexts
...
<ParamField path="contexts" type="dict | ContextBuilder, nil" toc={true}>
...
agent = SignalWire::AgentBase.new(name: "intake", route: "/intake")
