...
slug: /reference/ruby/agents/agent-base/prompt-add-section
...
<ParamField path="bullets" type="Array\<String\>, nil" toc={true}>
...
<ParamField path="subsections" type="Array\<Hash\>, nil" toc={true}>
  List of subsection hashes, each with `title`, `body`, and optional `bullets`.
</ParamField>
