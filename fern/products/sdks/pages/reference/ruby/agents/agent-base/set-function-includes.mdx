...
slug: /reference/ruby/agents/agent-base/set-function-includes
...
[add-function-include]: /docs/sdks/reference/ruby/agents/agent-base/add-function-include
...
<ParamField path="includes" type="Array\<Hash\>" required={true} toc={true}>
  List of include objects. Each object must have:
  - `url` (`str`) -- Remote SWAIG server URL
  - `functions` (`Array\<String\>`) -- Function names to include
