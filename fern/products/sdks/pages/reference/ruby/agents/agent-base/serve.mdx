---
title: "serve"
slug: /reference/ruby/agents/agent-base/serve
description: Start a WEBrick web server to serve this agent's SWML and SWAIG endpoints.
max-toc-depth: 3
---

[run]: /docs/sdks/reference/ruby/agents/agent-base/run

Start a Rack web server powered by uvicorn to serve this agent. The server
...
agent = SignalWire::AgentBase.new(name: "my-agent", host: "0.0.0.0", port: 3000)
