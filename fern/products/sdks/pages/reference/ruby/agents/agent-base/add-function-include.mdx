...
slug: /reference/ruby/agents/agent-base/add-function-include
...
<ParamField path="functions" type="Array\<String\>" required={true} toc={true}>
  List of function names to include from the remote server.
</ParamField>

<ParamField path="meta_data" type="Hash, nil" toc={true}>
