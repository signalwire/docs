---
title: "add_step"
slug: /reference/ruby/agents/context-builder/context/add-step
...
<ParamField path="bullets" type="Array\<String\>" toc={true}>
...
<ParamField path="functions" type="str | Array\<String\>" toc={true}>
  Tool names the step may call, or `"none"` to disable all tools.
  Equivalent to calling `step.set_functions(functions)`.
</ParamField>

<ParamField path="valid_steps" type="Array\<String\>" toc={true}>
