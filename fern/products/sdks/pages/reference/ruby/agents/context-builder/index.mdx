...
slug: /reference/ruby/agents/context-builder
...
[addcontext]: /docs/sdks/reference/ruby/agents/context-builder/add-context
[getcontext]: /docs/sdks/reference/ruby/agents/context-builder/get-context
[todict]: /docs/sdks/reference/ruby/agents/context-builder/to-dict
[validate]: /docs/sdks/reference/ruby/agents/context-builder/validate
...
<CardGroup cols={4}>
  <Card title="add_context" href="/docs/sdks/reference/ruby/agents/context-builder/add-context">
    Create a new named context and add it to the builder.
  </Card>
  <Card title="get_context" href="/docs/sdks/reference/ruby/agents/context-builder/get-context">
    Retrieve an existing context by name.
  </Card>
  <Card title="to_dict" href="/docs/sdks/reference/ruby/agents/context-builder/to-dict">
    Convert all contexts to a dictionary for SWML generation.
  </Card>
  <Card title="validate" href="/docs/sdks/reference/ruby/agents/context-builder/validate">
...
class OrderAgent < SignalWire::AgentBase
    def __init__
