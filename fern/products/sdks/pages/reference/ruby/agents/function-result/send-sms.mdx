---
title: "send_sms"
slug: /reference/ruby/agents/function-result/send-sms
...
<ParamField path="body" type="String, nil" default="nil" toc={true}>
  Text body of the message.
</ParamField>

<ParamField path="media" type="Array\<String\>, nil" default="nil" toc={true}>
  List of media URLs to include as MMS attachments.
</ParamField>

<ParamField path="tags" type="Array\<String\>, nil" default="nil" toc={true}>
