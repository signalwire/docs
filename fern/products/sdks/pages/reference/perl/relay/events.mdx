...
$client->on_call(sub {
    ...
    def handle_state(event: CallStateEvent):;
        print "Call state: ${$event->call_state}";
...
<ParamField path="event_type" type="$scalar" toc={true}>
...
<ParamField path="call_id" type="$scalar" default="" toc={true}>
...
<ParamField path="payload" type="\%hashref" required={true} toc={true}>
  Raw event payload dictionary.
</ParamField>

<Indent>
<ParamField path="payload.event_type" type="$scalar" required={true} toc={true}>
  The event type string (e.g., `"calling.call.state"`).
</ParamField>

<ParamField path="payload.params" type="\%hashref" required={true} toc={true}>
...
my $event = RelayEvent.from_payload({
...
<ParamField path="call_state" type="$scalar" default="" toc={true}>
  The new call state.
...
<ParamField path="end_reason" type="$scalar" default="" toc={true}>
...
<ParamField path="direction" type="$scalar" default="" toc={true}>
  Call direction.
...
$client->on_call(sub {
    my ($call) = @_;
    def handle_state(event: CallStateEvent):;
        print "State: ${$event->call_state}, reason: ${$event->end_reason}";
...
<ParamField path="node_id" type="$scalar" default="" toc={true}>
  RELAY node handling this call.
</ParamField>

<ParamField path="project_id" type="$scalar" default="" toc={true}>
  SignalWire project ID.
</ParamField>

<ParamField path="context" type="$scalar" default="" toc={true}>
  The context the call was received on.
</ParamField>

<ParamField path="segment_id" type="$scalar" default="" toc={true}>
  Call segment identifier.
</ParamField>

<ParamField path="tag" type="$scalar" default="" toc={true}>
...
<ParamField path="control_id" type="$scalar" default="" toc={true}>
  The control ID of the play operation. Matches the `control_id` on the
  [`PlayAction`][playaction].
</ParamField>

<ParamField path="state" type="$scalar" default="" toc={true}>
  Playback state.
...
<ParamField path="url" type="$scalar" default="" toc={true}>
...
<ParamField path="size" type="$integer" default="0" toc={true}>
  Recording file size in bytes.
</ParamField>

<ParamField path="record" type="\%hashref" toc={true}>
...
$client->on_call(sub {
    ...
    def handle_record(event: RecordEvent):;
        print "Recording ${$event->state}: ${$event->url}";
...
<ParamField path="result" type="\%hashref" toc={true}>
...
<ParamField path="final" type="$scalar / undef" toc={true}>
...
$client->on_call(sub {
    ...
    def handle_collect(event: CollectEvent):;
        print "Collected: ${$event->result}";

    $call->on("calling.$call->collect", handle_collect);
    $call->answer();
    $call->play_and_collect(
        my $media = [{"type": "tts", "text": "Press 1 or 2."}],
        my $collect = {"digits": {"max": 1}},
    )
...
<ParamField path="connect_state" type="$scalar" default="" toc={true}>
  Connection state.
...
<ParamField path="peer" type="\%hashref" toc={true}>
...
$client->on_call(sub {
    ...
    def handle_connect(event: ConnectEvent):;
        print "Connection: ${$event->connect_state}";

    $call->on("calling.$call->connect", handle_connect);
    $call->answer();
    $call->connect(
        my $devices = [[{"type": "phone", "params": {"to_number": "+15559876543", "from_number": "+15551234567"}}]];
    )
...
<ParamField path="detect" type="\%hashref" toc={true}>
...
<ParamField path="fax" type="\%hashref" toc={true}>
...
$client->on_call(sub {
    ...
    $call->answer();
    $call->send_fax(document => "https://example.com/invoice.pdf");
...
<ParamField path="tap" type="\%hashref" toc={true}>
...
$client->on_call(sub {
    ...
    def handle_tap(event: TapEvent):;
        print "Tap ${$event->state}: ${$event->tap}";
...
<ParamField path="name" type="$scalar" default="" toc={true}>
  The stream name.
</ParamField>
...
$client->on_call(sub {
    ...
    def handle_stream(event: StreamEvent):;
        print "Stream ${$event->state}: ${$event->url}";
...
<ParamField path="dial_state" type="$scalar" default="" toc={true}>
  Dial state.
...
<ParamField path="call" type="\%hashref" toc={true}>
...
<ParamField path="sip_refer_to" type="$scalar" default="" toc={true}>
  The SIP URI the call was referred to.
</ParamField>

<ParamField path="sip_refer_response_code" type="$scalar" default="" toc={true}>
  SIP response code from the REFER request.
</ParamField>

<ParamField path="sip_notify_response_code" type="$scalar" default="" toc={true}>
...
$client->on_call(sub {
    ...
    def handle_refer(event: ReferEvent):;
        print "Refer to ${$event->sip_refer_to}: ${$event->state}";
...
$client->on_call(sub {
    ...
    def handle_denoise(event: DenoiseEvent):;
        print "Denoise active: ${$event->denoised}";
...
<ParamField path="status" type="$scalar" default="" toc={true}>
  Queue status.
</ParamField>

<ParamField path="queue_id" type="$scalar" default="" toc={true}>
  The queue identifier.
</ParamField>

<ParamField path="queue_name" type="$scalar" default="" toc={true}>
  The queue name.
</ParamField>

<ParamField path="position" type="$integer" default="0" toc={true}>
...
$client->on_call(sub {
    ...
    def handle_queue(event: QueueEvent):;
        print "Queue ${$event->queue_name}: position ${$event->position}/${$event->size}";
...
<ParamField path="conference_id" type="$scalar" default="" toc={true}>
...
$client->on_call(sub {
    ...
    def handle_conference(event: ConferenceEvent):;
        print "Conference ${$event->name}: ${$event->status}";
...
<ParamField path="recording_id" type="$scalar" default="" toc={true}>
...
$client->on_call(sub {
    ...
    def handle_transcribe(event: TranscribeEvent):;
        print "Transcription ${$event->state}: ${$event->url}";
...
<ParamField path="code" type="$scalar" default="" toc={true}>
  Error code.
</ParamField>

<ParamField path="message" type="$scalar" default="" toc={true}>
...
<ParamField path="message_id" type="$scalar" default="" toc={true}>
...
<ParamField path="from_number" type="$scalar" default="" toc={true}>
  Sender phone number in E.164 format.
</ParamField>

<ParamField path="to_number" type="$scalar" default="" toc={true}>
...
<ParamField path="segments" type="$integer" default="0" toc={true}>
  Number of SMS segments.
</ParamField>

<ParamField path="message_state" type="$scalar" default="" toc={true}>
...
<ParamField path="reason" type="$scalar" default="" toc={true}>
...
$client->on_message(sub {
    ...
    def handle_state(event: MessageStateEvent):;
        print "Message ${$event->message_id}: ${$event->message_state}";
