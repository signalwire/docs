---
title: "connect"
slug: /reference/perl/relay/call/connect
description: "Bridge a call to one or more destinations."
max-toc-depth: 3
---

[calling-call-connect]: /docs/sdks/reference/perl/relay/call#events
...
<ParamField path="ringback" type="\@arrayref / undef" toc={true}>
...
<ParamField path="max_price_per_minute" type="$scalar / undef" toc={true}>
