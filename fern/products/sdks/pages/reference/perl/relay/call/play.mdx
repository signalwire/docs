---
title: "play"
slug: /reference/perl/relay/call/play
description: "Play audio content on a call."
max-toc-depth: 3
---

[playaction]: /docs/sdks/reference/perl/relay/actions
[calling-call-play]: /docs/sdks/reference/perl/relay/call#events
...
<ParamField path="direction" type="$scalar / undef" toc={true}>
...
<ParamField path="loop" type="$scalar / undef" toc={true}>
...
$client->on_call(sub {
    my ($call) = @_;
    $call->answer();
    my $action = $call->play([{"type": "tts", "text": "Welcome to SignalWire!"}]);
    $action->wait();
