...
[callstateevent-endreason]: /docs/sdks/reference/perl/relay/events
[connectevent-connectstate]: /docs/sdks/reference/perl/relay/events
[call-on]: /docs/sdks/reference/perl/relay/call
[relayevent-eventtype]: /docs/sdks/reference/perl/relay/events
[message-wait]: /docs/sdks/reference/perl/relay/message
[playevent-state]: /docs/sdks/reference/perl/relay/events
[recordevent-state]: /docs/sdks/reference/perl/relay/events
...
<ParamField path="PROTOCOL_VERSION" type="\%hashref" toc={true}>
  RELAY protocol version. Value: `{"major": 2, "minor": 0, "revision": 0}`.
</ParamField>

<ParamField path="AGENT_STRING" type="$scalar" toc={true}>
  User agent string sent during connection. Value: `"signalwire-agents-python/1.0"`.
</ParamField>

<ParamField path="DEFAULT_RELAY_HOST" type="$scalar" toc={true}>
...
<ParamField path="CALL_STATES" type="\@arrayref" toc={true}>
...
<ParamField path="MESSAGE_TERMINAL_STATES" type="\@arrayref" toc={true}>
