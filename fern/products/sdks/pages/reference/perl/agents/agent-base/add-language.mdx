---
title: "add_language"
slug: /reference/perl/agents/agent-base/add-language
...
<ParamField path="code" type="$scalar" required={true} toc={true}>
  Language code (e.g., `"en-US"`, `"fr-FR"`, `"es-MX"`).
</ParamField>

<ParamField path="voice" type="$scalar" required={true} toc={true}>
