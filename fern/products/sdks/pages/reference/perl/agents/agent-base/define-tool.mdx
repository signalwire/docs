---
title: "define_tool"
slug: /reference/perl/agents/agent-base/define-tool
description: Programmatically define a SWAIG tool that the AI can invoke during conversations.
max-toc-depth: 3
---

[tool-decorator]: /docs/sdks/reference/perl/agents/agent-base#tool
...
[`define_tool()` method][tool-decorator].
...
<Tip>
For most cases, the [`define_tool()` method][tool-decorator]
...
<ParamField path="parameters" type="\%hashref" required={true} toc={true}>
...
<ParamField path="handler" type="\&coderef" required={true} toc={true}>
  Perl subroutine to call when the AI invokes this tool. Receives `($args, $raw_data)`
  and should return a [`SignalWire::SWAIG::FunctionResult`][functionresult].
</ParamField>
...
<ParamField path="is_typed_handler" type="$boolean" default="False" toc={true}>
