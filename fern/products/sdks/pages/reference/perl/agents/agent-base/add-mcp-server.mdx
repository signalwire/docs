...
slug: /reference/perl/agents/agent-base/add-mcp-server
description: Add an external MCP server for tool discovery and invocation.
max-toc-depth: 3
---

[enable-mcp-server]: /docs/sdks/reference/perl/agents/agent-base/enable-mcp-server
...
<ParamField path="headers" type="\%hashref / undef" toc={true}>
...
<ParamField path="resource_vars" type="\%hashref / undef" toc={true}>
