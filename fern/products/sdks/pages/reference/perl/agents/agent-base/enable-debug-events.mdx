...
slug: /reference/perl/agents/agent-base/enable-debug-events
description: Enable real-time debug event webhooks from the AI module during calls.
max-toc-depth: 3
---

[on-debug-event]: /docs/sdks/reference/perl/agents/agent-base/on-debug-event
...
<ParamField path="level" type="$integer" default="1" toc={true}>
