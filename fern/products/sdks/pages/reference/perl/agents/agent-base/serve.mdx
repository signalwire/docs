---
title: "serve"
slug: /reference/perl/agents/agent-base/serve
description: Start a Plack/uvicorn web server to serve this agent's SWML and SWAIG endpoints.
max-toc-depth: 3
---

[run]: /docs/sdks/reference/perl/agents/agent-base/run

Start a Plack web server powered by uvicorn to serve this agent. The server
...
my $agent = SignalWire::Agent::AgentBase->new(name => "my-agent", host => "0.0.0.0", port => 3000);
