...
slug: /reference/perl/agents/agent-base/add-function-include
...
<ParamField path="functions" type="\@arrayref" required={true} toc={true}>
  List of function names to include from the remote server.
</ParamField>

<ParamField path="meta_data" type="\%hashref / undef" toc={true}>
