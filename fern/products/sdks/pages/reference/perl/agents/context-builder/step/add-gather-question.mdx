...
slug: /reference/perl/agents/context-builder/step/add-gather-question
description: Add a question to this step's gather_info configuration.
max-toc-depth: 3
---

[set-gather-info]: /docs/sdks/reference/perl/agents/context-builder/step/set-gather-info
...
[`Step`][ref-step] -- Self for method chaining. Raises `croak` if `set_gather_info()`
