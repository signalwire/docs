...
| Section | Description |
|---------|-------------|
| [Account Setup](/docs/sdks/guides/account-setup) | Create SignalWire account and project |
| [Phone Numbers](/docs/sdks/guides/phone-numbers) | Purchase and manage numbers |
| [Mapping Numbers](/docs/sdks/guides/mapping-numbers) | Connect numbers to agents |
| [Testing](/docs/sdks/guides/testing) | Test calls and debugging |
| [Troubleshooting](/docs/sdks/guides/troubleshooting) | Common issues and fixes |
