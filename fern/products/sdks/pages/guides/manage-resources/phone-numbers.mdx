...
| Go | `calledNumber := rawData["called_id_num"].(string)` |
| Ruby | `called_number = raw_data["called_id_num"]` |
| Java | `String calledNumber = rawData.get("called_id_num").toString();` |
| Perl | `my $called_number = $raw_data->{called_id_num};` |
| C++ | `auto calledNumber = rawData["called_id_num"].get<std::string>();` |
| PHP | `$calledNumber = $rawData['called_id_num'];` |
