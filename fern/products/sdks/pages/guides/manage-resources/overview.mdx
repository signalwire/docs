...
int main() {
    SignalWireClient client("your-project-id", "your-api-token", "your-space.signalwire.com");
...
| C++ | `rest::SignalWireClient client("project_id", "api_token", "space_name")` |
...
|-----------|--------|------------|-----|
| List | `client.phone_numbers.list()` | `client.phoneNumbers.list()` | `client.PhoneNumbers.List()` |
| Create | `client.fabric.ai_agents.create(name="x")` | `client.fabric.aiAgents.create({ name: 'x' })` | `client.Fabric.AIAgents.Create("x")` |
| Get | `client.fabric.ai_agents.get("id")` | `client.fabric.aiAgents.get('id')` | `client.Fabric.AIAgents.Get("id")` |
| Update | `client.fabric.ai_agents.update("id", name="y")` | `client.fabric.aiAgents.update('id', { name: 'y' })` | `client.Fabric.AIAgents.Update("id", "y")` |
| Delete | `client.fabric.ai_agents.delete("id")` | `client.fabric.aiAgents.delete('id')` | `client.Fabric.AIAgents.Delete("id")` |
...
```python
from signalwire_agents.rest._pagination import PaginatedIterator
