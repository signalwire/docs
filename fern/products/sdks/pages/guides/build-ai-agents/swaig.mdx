...
Now that you understand how SWAIG connects AI to your code, let's trace the complete [lifecycle](/docs/sdks/guides/lifecycle) of a request through the system.
