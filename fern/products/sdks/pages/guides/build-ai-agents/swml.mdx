...
The above examples all produce identical SWML output. See the [Architecture](/docs/sdks/guides/architecture) section for the full API comparison table.
...
Now that you understand SWML structure, let's look at [SWAIG](/docs/sdks/guides/swaig) -- how AI calls your functions.
