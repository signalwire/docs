...
| Section | Description |
|---------|-------------|
| [Understanding Skills](/docs/sdks/guides/understanding-skills) | How skills work internally |
| [Built-in Skills](/docs/sdks/guides/builtin-skills) | Reference for included skills |
| [Adding Skills](/docs/sdks/guides/adding-skills) | How to use skills in your agents |
| [Custom Skills](/docs/sdks/guides/custom) | Creating your own skills |
| [Skill Configuration](/docs/sdks/guides/skill-config) | Parameters and advanced options |
