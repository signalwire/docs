...
| Section | Description |
|---------|-------------|
| [Local Development](/docs/sdks/guides/local-development) | Development server and testing |
| [Production](/docs/sdks/guides/production) | Production server deployment |
| [Serverless](/docs/sdks/guides/serverless) | Lambda, Cloud Functions, Azure |
| [Docker & Kubernetes](/docs/sdks/guides/docker-kubernetes) | Container deployment |
| [CGI Mode](/docs/sdks/guides/cgi-mode) | Traditional CGI deployment |
