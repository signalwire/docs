...
1. **[Development Environment](/docs/sdks/guides/dev-environment)** - Set up a professional project structure with environment variables and testing
2. **[Exposing Your Agent](/docs/sdks/guides/exposing-agents)** - Make your agent accessible via ngrok so SignalWire can reach it

**Or jump ahead to:**

- **[Core Concepts](/docs/sdks/guides/architecture)** - Understand SWML, SWAIG, and the request lifecycle
- **[Building Agents](/docs/sdks/guides/agent-basics)** - Learn all agent configuration options
