...
**Next Chapter: [Core Concepts](/docs/sdks/guides/core-concepts)** - Deep dive into SWML, SWAIG, and agent architecture

**Or jump to: [SignalWire Integration](/docs/sdks/guides/signalwire-integration)** - Connect your agent to phone numbers
