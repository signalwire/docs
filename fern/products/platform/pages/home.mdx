...
title: Build on SignalWire
headline: SignalWire Documentation
subtitle: Voice, video, messaging, and AI — one programmable platform, every interface you need.
slug: /
  ...
  <div class="main-content">
    ...
    <div class="products-section">
      ...
      <CardGroup cols={3}>
        ...
        <Card title="Platform & Dashboard" icon="fa-regular fa-planet-ringed" href="/docs/platform/getting-started#your-signalwire-space">
    ...
    <div class="products-section sigmond-band">
      <span class="sigmond-band-eyebrow">Try it now</span>
      <h2>Sigmond runs on SignalWire</h2>
      <p class="sigmond-band-desc">
      ...
      <div class="sigmond-band-media">
        <img src="/assets/images/sigmond-thumbnail.jpg" alt="Sigmond, the SignalWire AI agent" loading="eager" decoding="async" />
      </div>
      <div class="sigmond-band-actions">
        <span class="sigmond-band-cta" data-sigmond-launcher="true" role="button" tabindex="0" aria-label="Call Sigmond — start a live video call">
          <Icon icon="video" />
          <span>Call Sigmond</span>
        </span>
        <span class="sigmond-band-sep" aria-hidden="true"></span>
        <a class="sigmond-band-link" href="/docs/platform/ai">Build an agent like this <Icon icon="arrow-right" /></a>
      </div>
    </div>
    <SigmondWidget />
...
{/* Twilio Migration */}
    ...
    <p style={{fontSize: '0.65rem', color: 'var(--grayscale-a9)', fontStyle: 'italic', margin: '-1rem 0 0'}}>*Twilio and TwiML are trademarks of Twilio, Inc. SignalWire, Inc. and its products are not affiliated with or endorsed by Twilio, Inc.</p>
