...
<Info>
Your SignalWire Dashboard lists a connection's templates on its **WhatsApp Templates** tab, under
**Integrations**. Creating and editing templates is done through the API or directly in the Meta
Business dashboard. A template you create in Meta appears in your Space only after you open the
connection and select **Sync with Meta**.
</Info>
