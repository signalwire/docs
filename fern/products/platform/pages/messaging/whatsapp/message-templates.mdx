...
<Info>
Your SignalWire Dashboard lists the templates on a WhatsApp Business Account under
**Integrations → WhatsApp Templates**. Creating and editing templates is done through the API or
directly in the Meta Business dashboard.
</Info>
