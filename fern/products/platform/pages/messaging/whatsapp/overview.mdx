...
The same business number can also take [WhatsApp calls](/docs/platform/voice/whatsapp).
...
To use WhatsApp messaging, you need a **Meta Business Account**.
...
<Card title="WhatsApp calling" href="/docs/platform/voice/whatsapp">
  Take calls placed from WhatsApp on the same business number.
</Card>
</CardGroup>
