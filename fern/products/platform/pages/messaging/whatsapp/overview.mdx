...
feature is not yet generally available — see [Request access](#request-access) below to join the alpha.
</Info>
...
WhatsApp access is gated at the Space level. To join the alpha, [request early access through this
form](https://signalwire.typeform.com/to/EyPVZ1St) and the SignalWire team will enable the feature
for your Space. General availability is anticipated within 60 days, pending validation from early
adopters.
