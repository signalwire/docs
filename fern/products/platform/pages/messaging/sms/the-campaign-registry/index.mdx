...
You can start the process by accessing the "Messaging Campaigns" tab within your SignalWire Space or by using our [API](/docs/apis/relay-rest/campaign-registry/create-campaign)!
</Accordion>
