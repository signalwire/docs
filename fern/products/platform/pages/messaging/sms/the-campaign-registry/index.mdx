...
For testing purposes, your first purchased number is automatically enabled for [Platform Free Trial](/messaging/getting-started/platform-free-trial) when paired with a verified mobile number.
</Accordion>
