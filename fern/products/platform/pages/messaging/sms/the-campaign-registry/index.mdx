---
id: b0978f81-f400-4a46-b78e-3e3d9c7f8db0
title: The Campaign Registry
sidebar-title: The Campaign Registry
...
slug: /messaging/campaign-registry
x-custom:
...
If you need **inbound-only messaging** (receiving messages without sending), you can contact [Support](https://signalwire.com/support) to request enablement without a full campaign registration.

For testing purposes, your first purchased number is automatically enabled for [Platform Free Trial](/platform/messaging/platform-free-trial) when paired with a verified mobile number.
</Accordion>
...
[verification process](/platform/messaging/toll-free-number).
</Accordion>
...
There are added costs (see our [pricing guide](/platform/messaging/pricing)) associated with that process and added vetting does not guarantee a better outcome.
</Accordion>

<Accordion title="What exactly is a campaign?">
The simplest way to describe a campaign is a unique use case. For example, if you send marketing messages and also send alert messages, that would represent two different use cases. However, mixed use case campaigns are possible for lower traffic cases. See the [use case table](/platform/messaging/campaign-registry#registration-best-practices) for more details.
</Accordion>
...
[Campaign Service Providers](/platform/messaging/campaign-registry/campaign-service-providers).
</Accordion>
...
[best practices guide](/platform/messaging/sms-best-practices).
</Accordion>
...
You can start the process by accessing the "Messaging Campaigns" tab within your SignalWire Space or by using our [API](/apis/relay-rest/campaign-registry/create-campaign)!
</Accordion>
