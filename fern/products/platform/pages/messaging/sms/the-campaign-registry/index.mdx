...
Brands registering with The Campaign Registry will have their legal company name, legal company address, and EIN/Tax ID checked against multiple databases, resulting in either a **Verified** or **Unverified** Identity Status. Campaigns cannot be registered against an Unverified Brand. Depending on why verification failed, you can correct the details and resubmit, appeal the identity status with supporting documentation, or request external vetting — see [Brand Identity Verification](/docs/platform/messaging/campaign-registry/registration#brand-identity-verification). Each submission incurs a registration fee.
...
You can start the process by accessing the "Messaging Campaigns" tab within your SignalWire Space or by using our [API](/docs/apis/rest/campaign-registry/campaigns/create-campaign)!
</Accordion>
