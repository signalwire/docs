...
To learn more about what a CSP is, and how to get a `self-registered` CSP ID, see the [CSP Registration Guide](/platform/messaging/campaign-registry).
...
<Tip>
Existing Brand details can also be viewed by using the [Retrieve a Brand Campaign Registry API](/apis/relay-rest/campaign-registry/retrieve-brand) endpoint.
</Tip>
...
<Tip>
New Brands can also be created by using the [Create a Brand Campaign Registry API](/apis/relay-rest/campaign-registry/create-brand) endpoint.
</Tip>
...
[Campaign Registry](/platform/messaging/campaign-registry#registration-best-practices) guide.

### Details of an existing campaign

<Tip>
Existing Campaign details can also be viewed by using the [Retrieve a Campaign Campaign Registry API](/apis/relay-rest/campaign-registry/retrieve-campaign) endpoint.
</Tip>
...
<Tip>
New Campaigns can also be created by using the [Create a Campaign Campaign Registry API](/apis/relay-rest/campaign-registry/create-campaign) endpoint.
</Tip>
...
<Tip>
Phone Numbers can also be assigned to a Campaign by using the [Assign a Phone Number to a Campaign Campaign Registry API](/apis/relay-rest/campaign-registry/create-order) endpoint.
</Tip>
