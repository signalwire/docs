...
<Tip>
Existing Brand details can also be viewed by using the [Retrieve a Brand Campaign Registry API](/docs/apis/relay-rest/campaign-registry/retrieve-brand) endpoint.
</Tip>
...
![Brand details page](/docs/assets/images/dashboard/campaign-registry/sms/brand-details.webp)

### Creating a new brand

<Tip>
New Brands can also be created by using the [Create a Brand Campaign Registry API](/docs/apis/relay-rest/campaign-registry/create-brand) endpoint.
</Tip>
...
![Brand creation page](/docs/assets/images/dashboard/campaign-registry/sms/TCR-wizard-1.webp)
...
![Brand creation success page](/docs/assets/images/dashboard/campaign-registry/sms/TCR-wizard-2.webp)
...
![Messaging Campaigns page](/docs/assets/images/dashboard/campaign-registry/sms/campaigns.webp)
...
<Tip>
Existing Campaign details can also be viewed by using the [Retrieve a Campaign Campaign Registry API](/docs/apis/relay-rest/campaign-registry/retrieve-campaign) endpoint.
</Tip>
...
![Campaign details page](/docs/assets/images/dashboard/campaign-registry/sms/existing-campaign-details.webp)


### Creating a Campaign

<Tip>
New Campaigns can also be created by using the [Create a Campaign Campaign Registry API](/docs/apis/relay-rest/campaign-registry/create-campaign) endpoint.
</Tip>
...
![Campaign registration form](/docs/assets/images/dashboard/campaign-registry/sms/TCR-wizard-new-campaign.webp)
...
![Campaign details page](/docs/assets/images/dashboard/campaign-registry/sms/campaign-details.webp)
...
For inbound-only use cases (receiving messages without sending), contact [Support](https://signalwire.com/support) to request messaging enablement without a TCR campaign.

</Info>

![Campaign phone numbers page](/docs/assets/images/dashboard/campaign-registry/sms/campaign-numbers.webp)
...
<Tip>
Phone Numbers can also be assigned to a Campaign by using the [Assign a Phone Number to a Campaign Campaign Registry API](/docs/apis/relay-rest/campaign-registry/create-order) endpoint.
</Tip>
...
![Assign phone numbers page](/docs/assets/images/dashboard/campaign-registry/sms/TCR-wizard-phone-assignment.webp)
