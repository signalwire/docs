...
Full details are explained in our [Registration](/platform/messaging/campaign-registry/registration) guide.
...
**To enable messaging:**
- **Outbound/mixed use**: Assign your number to an approved [TCR campaign](/platform/messaging/campaign-registry/registration). Messaging is automatically enabled once the number is assigned.
...
You can find more information about the Campaign Registry in-depth [here](/platform/messaging/campaign-registry).

</Accordion>

<Accordion title="Can we programmatically create campaigns and brands?">

Yes! You can do this through the SignalWire REST APIs. Check out the [documentation](/apis/relay-rest/campaign-registry/list-brands).
...
this, feel free to read [Campaign Registry - All you need to know](/platform/messaging/campaign-registry).
...
You can see this list in full detail [here](/platform/messaging/sms-best-practices).
...
[here](/platform/rate-limits#queue-and-backlog-system)! The default
message backlog is 10,000 for the entire Space. These limits can be increased based on
the use case and individual approval following an [account verification request](/platform/rate-limits).
...
Visit our [error code explanation page](/compatibility-api/error-codes) for details.
...
{/* Links */}
[chat]: /platform/chat
[tcr]: /platform/messaging/campaign-registry
