...
<CardGroup cols={2}>
  <Card
    ...
    href="/docs/messaging/sms/messaging-character-limits"
  >
  ...
  <Card
    ...
    href="/docs/messaging/sms/messaging-mime-types"
  >
...
Visit our [error code explanation page](/docs/compatibility-api/error-codes) for details.
