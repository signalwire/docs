...
<Frame>
  ![Create a new cXML script.](/images/dashboard/resources/new-cxml-bin.webp)
</Frame>
...
<Frame>
  ![Open the settings for the number.](/images/dashboard/phone-numbers/assign-resource-full.webp)
</Frame>
...
<Frame>
  ![Create a new cXML script.](/images/dashboard/legacy/xml-bins.webp)
</Frame>
