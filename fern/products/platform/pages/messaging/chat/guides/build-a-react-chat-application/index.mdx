---
id: eb0d1d08-528e-4156-8b74-e1f87563c232
...
![a chat application using the SignalWire Chat JS SDK and React. The application has three chat channels: Office, Book Club, and Workshop. Several sample messages from different users are shown. There is a text box and a Send button](/assets/images/project/react-chat-application/chat-demo.webp)
</Frame>
...
With either alternative, you can now `import {Chat} from "@signalwire/js"` and access it in your components. We'll mainly be interested in the `Chat.Client` class for this guide, but if you'd like to explore this API, please browse the [SDK documentation](/browser-sdk).
...
- [Technical Reference](/browser-sdk/reference/chat)
