---
id: a53d6472-9997-4bb4-9459-d3ce369c6158
...
Then you can interact with the SDK using the global variable `SignalWire`. We'll mainly be interested in the `SignalWire.Chat.Client` class for this guide, but if you'd like to explore this API, feel free to browse the [SDK documentation](/browser-sdk).
