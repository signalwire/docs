...
<CardGroup cols={3}>
  <Card
    title="REST API"
    href="/docs/apis/rest/pubsub/create-token"
    icon="regular code"
  >
  ...
  <Card
    title="SDK PubSub Reference"
    href="/docs/sdks/reference/python/rest/pubsub"
    icon="regular cloud"
  >
...
<CardGroup cols={3}>
  <Card
    title="REST API"
    href="/docs/apis/rest/chat-tokens/create-chat-token"
    icon="regular code"
  >
    Create Chat Tokens
  </Card>
  ...
  <Card
    title="SDK Chat Reference"
    href="/docs/sdks/reference/python/rest/chat"
    icon="regular cloud"
  >
...
<AccordionGroup>
  ...
  <Accordion title="Can Chat messages be logged?">
    Using the [SDK's Chat API](/docs/sdks/reference/python/rest/chat) you can listen for the "message" event and log each message accordingly.
  </Accordion>
</AccordionGroup>
