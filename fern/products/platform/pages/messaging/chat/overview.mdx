...
<CardGroup cols={3}>
  <Card
    title="REST API"
    href="/docs/apis/pubsub/tokens/create-token"
    icon="solid code"
  >
  ...
  <Card
    title="Browser SDK"
    href="/docs/browser-sdk/reference/pub-sub"
    icon="solid globe"
  >
...
<CardGroup cols={3}>
  <Card
    title="REST API"
    href="/docs/apis/chat/tokens/create-chat-token"
    icon="solid code"
  >
    Create Chat Tokens
  </Card>
  <Card
    title="Browser SDK"
    href="/docs/browser-sdk/reference/chat"
    icon="solid globe"
  >
