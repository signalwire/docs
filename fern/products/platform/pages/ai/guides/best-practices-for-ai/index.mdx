...
<Tip>
For deeper prompt-writing techniques and how to fine-tune model behavior with configuration
parameters, see the [Prompt engineering best practices](/docs/platform/ai/prompt-engineering/best-practices) guide.
</Tip>
