...
[post-prompt-callback]: /docs/swml/reference/calling/ai#post_prompt_url-callback
...
SDKs, [`enable_debug_events()`][enable-debug-events] wires the URL and endpoint for you.
...
[`post_prompt_url` callback reference][post-prompt-callback] lists every field.
...
<Card title="post_prompt_url reference" href="/docs/swml/reference/calling/ai#post_prompt_url-callback" icon="regular book">
