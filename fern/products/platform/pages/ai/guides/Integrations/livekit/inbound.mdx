...
subtitle: Send inbound PSTN calls to LiveKit with SWML `connect`
description: Route calls to LiveKit via SIP and SWML's Connect method.
slug: /ai/livekit/inbound
---
...
The script uses the SWML [`connect`](swml/reference/connect) method
...
or using the 
[Recordings List API endpoint](apis/relay-rest/recordings/list-recordings).
...
[buy-phone]: /platform/phone-numbers "Buy a phone number in the SignalWire dashboard."
