...
[sw-firewall-guide]: /platform/allow-signalwire-ips-through-your-firewall
[resources]: https://my.signalwire.com?page=resources
[swml-guide]: /swml/
[outbound-calls]: /platform/ai/vapi/outbound
[swml-guides]: /swml/guides
[ai-best-practices]: /platform/ai/best-practices
...
<CardGroup cols={3}>
  <Card
    ...
    href="/platform/ai/vapi/outbound"
    icon="solid phone"
  >
