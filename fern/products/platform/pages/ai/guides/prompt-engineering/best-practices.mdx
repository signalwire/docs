...
The biggest source of over-prompting in production agents is business data — menus, prices, policies —
that belongs behind a [tool call](/docs/platform/ai/tool-calling), not in the prompt.
...
- **[Where to apply prompt engineering](/docs/platform/ai/prompt-engineering/where-to-apply)** — the five surfaces that accept prompts, from the main prompt to function descriptions.
- **[Tool calling](/docs/platform/ai/tool-calling)** — move the business logic these techniques keep gesturing at into your code, where it belongs.
