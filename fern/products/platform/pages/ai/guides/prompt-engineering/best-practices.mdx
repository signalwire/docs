...
<PreviewCardGroup columns={2}>
<PreviewCard title="❌ Over-prompting" description="Including unnecessary common knowledge dilutes the important specific requirements." expandable={false}>
```markdown
# Role definition
...
<PreviewCard title="✅ Balanced prompting" description="Focuses on specific requirements while trusting the AI's baseline capabilities." expandable={false}>
```markdown
# Role definition
You are the receptionist at Bright Smile Dental.
