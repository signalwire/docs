...
The biggest source of over-prompting in production agents is business data.
Menus, prices, and policies belong behind a [tool call](/docs/platform/ai/tool-calling), not in the prompt.
...
- **[Tool calling](/docs/platform/ai/tool-calling)** — move business logic out of the prompt and into your code, where it belongs.
