...
- **[Best practices](/docs/platform/ai/prompt-engineering/best-practices)** — core techniques for clear, reliable prompts.
- **[Where to apply prompt engineering](/docs/platform/ai/prompt-engineering/where-to-apply)** — the five surfaces that accept prompts.
- **[Tool calling](/docs/platform/ai/tool-calling)** — the other half of a reliable agent.
