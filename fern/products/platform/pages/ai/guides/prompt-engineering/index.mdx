...
[swml-docs]: /swml
[ai-agents-docs]: /platform/call-fabric/ai-agents
[where-to-apply]: /platform/ai/prompt-engineering/where-to-apply
[context-steps]: /platform/ai/prompt-engineering/where-to-apply#context-steps
[swaig]: /platform/ai/prompt-engineering/where-to-apply#swaig
[conscience]: /platform/ai/prompt-engineering/where-to-apply#conscience
[post-prompt]: /platform/ai/prompt-engineering/where-to-apply#post-prompt
...
[function calling](/swml/reference/ai/swaig),
...
[Prompts](/platform/ai/prompt-engineering/where-to-apply) are used to design and configure an AI Agent. 
...
Now that you've got the basics down, you're ready to dive deeper into advanced prompt engineering techniques. Explore our guides on [best practices](/platform/ai/prompt-engineering/best-practices), [where to apply prompts](/platform/ai/prompt-engineering/where-to-apply), and [advanced techniques](/ai/get-started/prompt-engineering/advanced-techniques).
