...
Now that you've got the basics down, you're ready to dive deeper into advanced prompt engineering techniques. Explore our guides on [best practices](/docs/platform/ai/prompt-engineering/best-practices), [where to apply prompts](/docs/platform/ai/prompt-engineering/where-to-apply), and [advanced techniques](/docs/ai/get-started/prompt-engineering/advanced-techniques).
