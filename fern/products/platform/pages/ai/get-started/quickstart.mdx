...
<Note>
  This quickstart uses Python, but the SignalWire Server SDK is also available for TypeScript. See
  the [Server SDK documentation](/docs/server-sdks) to choose the language that fits your
  application.
</Note>
