...
Build the agent in code with the Server SDK's Agents namespace (`AgentBase`): it generates the SWML,
hosts your SWAIG functions, and serves the whole agent as a production web service in Python or TypeScript.
