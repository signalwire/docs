...
<Frame caption="Nine menu selections to book one appointment">
  <img src="/assets/images/img/ivr-menu-flow-themed.svg" alt="Scheduling an appointment through a traditional IVR: nine menu selections, each question requiring a new menu, along a single linear path." />
</Frame>
...
<Frame caption="The same booking in five exchanges, with a mid-flow question answered in place">
  <img src="/assets/images/img/ai-conversation-flow-themed.svg" alt="Scheduling the same appointment with an AI agent: five natural exchanges, several details handled per turn, and a mid-flow question about the cancellation policy answered without losing the booking." />
</Frame>
