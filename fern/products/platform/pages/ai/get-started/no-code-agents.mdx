...
Create your agent in the Dashboard without writing code, assign a phone number, and SignalWire's platform takes care of the rest.

<Steps>

### Sign up for a new SignalWire account

To begin, [sign up for a SignalWire account](https://signalwire.com/signup). If you already have an account, log in.

Once logged in, create a Space or select an existing Space.

### Create an AI Agent Resource

- Open the [Resources][1] tab in your SignalWire Space.
...
[Resources](/docs/platform/resources) are the building blocks of every SignalWire communication application. Resources include AI Agents, [Subscribers](/docs/platform/subscribers), RELAY applications, FreeSWITCH connectors, and more.
</Info>
