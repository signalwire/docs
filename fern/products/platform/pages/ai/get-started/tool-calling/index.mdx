...
The [dispatch agent](#a-dispatch-agent) at the end of this guide is a complete, runnable version of
this in both forms.
...
Here is a complete agent that fetches it instead, declared inline as covered above.
