...
description: Build programmable, realtime voice AI agents with SWML, the SignalWire Dashboard, Call Flow Builder, or the Agents SDK.
max-toc-depth: 3
---
...
<Card
  title="Quick Start"
  href="/docs/server-sdks/guides/quickstart"
  icon="regular code"
>
...
<Card
  title="Prefab Agents"
  href="/docs/server-sdks/guides/faq-bot"
  icon="regular robot"
>
...
[Agents SDK docs](/docs/server-sdks) | [Quickstart guide](/docs/server-sdks/guides/quickstart)
...
[Agents SDK docs](/docs/server-sdks) | [FAQ Bot prefab](/docs/server-sdks/guides/faq-bot)
...
[Agents SDK docs](/docs/server-sdks) | [Custom functions guide](/docs/server-sdks/guides/prompts-pom)
...
[Agents SDK docs](/docs/server-sdks) | [Concierge prefab](/docs/server-sdks/guides/concierge)
...
[Agents SDK docs](/docs/server-sdks) | [InfoGatherer prefab](/docs/server-sdks/guides/info-gatherer)
...
[Agents SDK docs](/docs/server-sdks) | [Survey prefab](/docs/server-sdks/guides/survey)
...
[Agents SDK docs](/docs/server-sdks) | [Receptionist prefab](/docs/server-sdks/guides/receptionist)
...
[Agents SDK docs](/docs/server-sdks) | [Call recording guide](/docs/server-sdks/guides/call-recording)
...
Think of the AI agent as the **front end** of the call, and your backend as — still — the backend.
The agent's prompt and voice handle the conversation: understanding the caller, collecting details, and speaking naturally.
Your code keeps owning the business logic: prices, lookups, bookings, and rules.

Connecting the two is **SWAIG** (the SignalWire AI Gateway), which orchestrates the LLM,
TTS (Text-To-Speech) providers, and the tool calls that reach your backend —
all inside SignalWire's realtime media stack.

<Frame>

![AI Agent diagram.](/assets/images/img/ai-agent.svg)
