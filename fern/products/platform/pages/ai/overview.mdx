...
<ThemedSvg src="/assets/images/img/ai-agent-flow-themed.svg" alt="How a call flows: a caller converses with an AI agent on the SignalWire platform; SWAIG delivers function calls to your backend over HTTP and returns the JSON reply to the conversation." />
