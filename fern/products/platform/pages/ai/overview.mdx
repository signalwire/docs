...
<Card title="SWML" href="/docs/platform/ai/quickstart" icon="regular brackets-curly">
...
| Goal | Capabilities |
|---|---|
| Connect knowledge and services | Add prebuilt [Skills][skills], retrieve from [DataSphere][datasphere], call REST APIs with [DataMap][datamap], or expose tools through the [MCP gateway][mcp-gateway] |
