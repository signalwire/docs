...
[chat-gateway]: /docs/server-sdks/reference/python/agents/ai-chat/chat-gateway
[chat-client]: /docs/server-sdks/reference/python/agents/ai-chat/ai-chat-client
...
<Card title="Python ai_chat module" href="/docs/server-sdks/reference/python/agents/ai-chat" icon="brands python">
