---
id: be660e26-71af-4a30-a221-4319284b921d
title: Introduction to WireStarter
sidebar-title: WireStarter
slug: /wirestarter
...
{/* Learn more by reading our [introduction to SWSH](/docs/tools/swsh/). */}
...
![The WireStarter interface. The user is prompted to enter their SignalWire Space domain.](/assets/images/tools/wirestarter/wirestarter-space.webp)
...
![The SWSH terminal.](/assets/images/tools/swsh/swsh.webp)
...
![Purchased phone numbers](/assets/images/dashboard/phone-numbers/purchased-phone-numbers.webp)
...
In the Dashboard, open **Phone Numbers** > **Purchased** to search existing numbers or select **+ New** to purchase one.
...
![The setup script.](/assets/images/tools/wirestarter/swsh-to-setup.webp)
...
A successful `setup.sh` run prints the public ngrok tunnel and its local `/workdir/public` mapping, confirms that `/workdir` is persistent, and then opens the SWSH prompt.
