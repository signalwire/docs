...
After entering the SignalWire and ngrok information in the previous step, you will enter the [SWSH CLI](platform/swsh). 
...
Learn more by reading our [Introduction to SWSH](platform/swsh).
