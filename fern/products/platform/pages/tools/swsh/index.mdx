...
![The SWSH command prompt.](/docs/assets/images/tools/swsh/swsh-warp.webp)
...
[Domain Applications](/docs/platform/voice/sip/domain-applications)
...
[Number Groups](/docs/platform/phone-numbers/guides/number-groups/)
...
Manage [cXML Application](/docs/compatibility-api/guides/general/creating-and-using-cxml-scripts/)
...
Manage the SignalWire [Phone Numbers](/docs/platform/phone-numbers) 
within a SignalWire Project with these commands:
...
Manage [SIP Endpoints](/docs/platform/voice) 
within a SignalWire Project with these commands:
