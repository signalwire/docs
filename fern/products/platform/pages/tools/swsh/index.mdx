...
[Domain Applications](platform/voice/sip/domain-applications)
...
Manage the SignalWire [Phone Numbers](platform/phone-numbers) 
within a SignalWire Project with these commands:
...
Manage [SIP Endpoints](platform/voice) 
within a SignalWire Project with these commands:
...
| `get_call --id <SID of call>` | Retrieves call information. <br/> Replace `<SID of call>` with the [SID (SignalWire ID)](platform/what-is-a-sid) of the desired call. |
