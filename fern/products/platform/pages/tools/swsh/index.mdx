---
id: 6dab02c5-d2ed-4f97-a256-2f5ba078a91b
...
![The SWSH command prompt.](/assets/images/tools/swsh/swsh-warp.webp)
...
- **A free <a href="https://signalwire.com/signup" target="_blank">SignalWire Account</a>**
...
[Domain Applications](/docs/apis/relay-rest/domain-applications/create-domain-application)
...
[Number Groups](/docs/apis/relay-rest/number-groups/create-number-group)
...
Manage [cXML Applications](/docs/compatibility-api/rest/applications/create-application)
...
Manage the SignalWire [Phone Numbers](/docs/apis/relay-rest/phone-numbers/purchase-phone-number) 
within a SignalWire Project with these commands:
...
Manage [SIP Endpoints](/docs/apis/relay-rest/sip-endpoints/list-sip-endpoints) 
within a SignalWire Project with these commands:
