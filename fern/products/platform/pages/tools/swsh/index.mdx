...
[Domain Applications](/docs/apis/rest/domain-applications/create-domain-application)
...
[Number Groups](/docs/apis/rest/number-groups/create-number-group)
...
Manage the SignalWire [Phone Numbers](/docs/apis/rest/phone-numbers/purchase-phone-number) 
within a SignalWire Project with these commands:
...
Manage [SIP Endpoints](/docs/apis/rest/sip-credentials/list-sip-credentials) 
within a SignalWire Project with these commands:
