...
Manage LaML/cXML bins within a SignalWire Project with these commands:
...
| `get_call --id <SID of call>` | Retrieves call information. <br/> Replace `<SID of call>` with the [SID (SignalWire ID)](/platform/dashboard/guides/what-is-a-sid) of the desired call. |
