...
**[SignalWire AI](/docs/platform/ai)** - Build a voice AI agent in the Dashboard, in SWML, or with a Server SDK.
...
<CardGroup cols={3}>
  ...
  <Card title="SignalWire AI" href="/docs/platform/ai">
    Dashboard, SWML, or SDK
  </Card>
</CardGroup>
...
**[SignalWire AI](/docs/platform/ai)** - Build a voice AI agent in the Dashboard, in SWML, or with a Server SDK. Set up prompts, choose a voice, and connect it to a phone number.
