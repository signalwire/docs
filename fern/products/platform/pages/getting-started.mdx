...
**[Server SDKs](/docs/server-sdks)** - Build AI voice agents in the language of your choice,
with full control over prompts, SWAIG functions, and conversation flow.
Best for agents that need to perform actions like booking appointments, looking up data, or integrating with your systems.
...
**[SWML with AI](/docs/swml/reference/calling/ai)** - Add AI capabilities to your SWML scripts using the `ai` method.
