...
A Subproject is a full Project with its own Project ID, API tokens, and Resources, which makes it a
clean way to isolate a customer, a tenant, or a staging environment.
