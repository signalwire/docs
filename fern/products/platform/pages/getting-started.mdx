...
**[Agents SDK](/docs/sdks)** - A Python framework for building sophisticated AI voice agents.
...
<CardGroup cols={3}>
  <Card title="Agents SDK" href="/docs/sdks">
    Python, full control
  </Card>
...
<Card title="Agents SDK Quickstart" href="/docs/sdks/guides/quickstart" horizontal>
...
**If you need real-time control** (live call monitoring, mid-call transfers, complex orchestration), use the **[Realtime SDK](/docs/sdks)**.
...
**If you're building AI voice agents**, use the **[Agents SDK](/docs/sdks)**.
...
<CardGroup cols={3}>
  ...
  <Card title="Realtime SDK" href="/docs/sdks">
    WebSocket, Node.js
  </Card>
</CardGroup>
