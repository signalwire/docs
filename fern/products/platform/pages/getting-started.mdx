...
**[Server SDKs](/docs/server-sdks)** - Build sophisticated AI voice agents in the language of your choice.
You get full control over prompts, custom functions (SWAIG) dedicated to AI, customizable conversation flow, and seamless LLM integration.
...
**If you need real-time control** (live call monitoring, mid-call transfers, complex orchestration), use the **[Realtime SDK](/docs/server-sdks)**.
...
They handle the complexity of integrating with LLMs and managing conversations.
...
<CardGroup cols={3}>
  ...
  <Card title="Realtime SDK" href="/docs/server-sdks">
    WebSocket, Node.js
  </Card>
</CardGroup>
