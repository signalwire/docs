...
**[Agents SDK](/docs/server-sdks)** - A Python framework for building sophisticated AI voice agents.
...
<CardGroup cols={3}>
  <Card title="Agents SDK" href="/docs/server-sdks">
    Python, full control
  </Card>
...
<Card title="Agents SDK Quickstart" href="/docs/server-sdks/guides/quickstart" horizontal>
...
**If you're building AI voice agents**, use the **[Agents SDK](/docs/server-sdks)**.
