...
**[Server SDK](/docs/server-sdks)** - A Python framework for building sophisticated AI voice agents.
...
<CardGroup cols={3}>
  <Card title="Server SDK" href="/docs/server-sdks">
    Python, full control
  </Card>
...
**If you're building AI voice agents**, use the **[Server SDK](/docs/server-sdks)**.
