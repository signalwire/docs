...
- **Video Room Tokens**: Generated via the 
  ...
  See our [Simple Video Demo](/docs/browser-sdk/v3/js/guides/build-a-video-app).
- **Chat Tokens**: Generated for chat applications. 
  See our [Simple Chat Demo](/docs/browser-sdk/v3/js/guides/chat/build-a-react-application).
