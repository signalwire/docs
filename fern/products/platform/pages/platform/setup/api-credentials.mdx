...
- **Video Room Tokens**: Generated via the 
  [Create Room Token](apis/video/room-tokens/create-room-token) endpoint. 
  See our [Simple Video Demo](browser-sdk/guides/build-a-video-calling-application-with-the-browser-sdk).
- **Chat Tokens**: Generated for chat applications. 
  See our [Simple Chat Demo](browser-sdk/v3/js/guides/chat/build-a-react-application).
- **Subscriber Access Tokens (SAT)**: Generated via the 
  [Create Subscriber Token](apis/fabric/subscribers/create-subscriber-token) endpoint for Fabric applications.

For more details on authentication methods, see the [REST API Authorization guide](apis/authorization).
...
Find the correct credentials structure for each specific call in the [SDK Reference](server-sdk/node), 
[REST API Reference](rest),
or in a specific [Guide](browser-sdk/js/guides) you may wish to follow.
