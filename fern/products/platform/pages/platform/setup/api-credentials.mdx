...
<Frame caption="The API Credentials page on the SignalWire Dashboard.">
  ![The API Credentials page on the SignalWire Dashboard.](/docs/assets/images/dashboard/credentials/api-credentials.webp)
</Frame>
...
- **Video Room Tokens**: Generated via the 
  [Create Room Token](/docs/apis/video/room-tokens/create-room-token) endpoint. 
  See our [Simple Video Demo](/docs/browser-sdk/guides/build-a-video-calling-application-with-the-browser-sdk).
...
- **Subscriber Access Tokens (SAT)**: Generated via the 
  [Create Subscriber Token](/docs/apis/fabric/subscribers/create-subscriber-token) endpoint for Fabric applications.
