---
id: fb736fad-270a-47d5-a44f-8d81f515d364
title: Port phone numbers to SignalWire
slug: /porting-into-signalwire
x-custom:
...
See our [guide to Hosted Messaging](platform/messaging/hosted-messaging).
...
**Failure to [configure your number](platform/webhooks) to a webhook will result in your number not working correctly.**
