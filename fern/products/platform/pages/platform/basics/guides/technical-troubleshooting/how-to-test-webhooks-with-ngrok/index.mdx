---
id: a1c382ef-352d-4b14-9d38-bce2e43bc92b
...
SignalWire offers SWML scripts as a way to host simple call handling logic without the use of a server. However, what if you want to use more complex code or integrate with other applications/databases? In that case, you would need to write a script using the SignalWire SDK, host it on a server, and use that as the webhook for handling calls or messages.
...
![ngrok cli interface](/assets/images/external/ngrok.webp)
