...
![The phone number purchase page](/images/dashboard/phone-numbers/choose.webp)
...
![Image of SignalWire Call Flow Builder, show-casing a series of nodes being connected visually to make a call-flow.](/images/call-flow/sample-flow.webp)
...
![The phone number settings page](/images/dashboard/phone-numbers/assign-resource-voice.webp)
...
![legacy settings for phone number](/images/dashboard/legacy/external-cxml-webhook.webp)
...
![The Logs page of the SignalWire Space](/images/dashboard/logs.webp)
...
![A Image showing the embeddable video for web-pages](/images/video/embed-pvc.webp)
...
![SignalWire Dashboard that shows the sidebar option 'AI Agent' selected, and is displaying the AI Agent page](/images/dashboard/resources/ai-agent/ai-agent-resource-page.webp)
...
![SignalWire Dashboard that shows the sidebar option 'Phone Numbers' selected](/images/dashboard/legacy/external-cxml-webhook.webp)
...
![The SIP endpoint settings with all default options selected.](/images/dashboard/legacy/sip/edit-endpoint.webp)
