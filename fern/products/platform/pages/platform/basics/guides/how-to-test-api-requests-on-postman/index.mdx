...
![Postman Environments](/images/external/postman/environments.webp)
...
![Postman Collections](/images/external/postman/collections.webp)
...
![A screenshot of a request in Postman using the URL from the Number Search API documentation article.](/images/external/postman/search_number.webp)
...
![A screenshot of a GET request in Postman using the URL described in the Listing Calls documentation article.](/images/external/postman/query_example.webp)
