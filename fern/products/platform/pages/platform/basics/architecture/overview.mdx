...
slug: /platform/basics/architecture
Author: Devon White
x-custom:
  tags:
...
[Resources](/platform/basics/architecture/resources) are the primary entities for communication within the Call Fabric ecosystem.
...
Consult the [Resources](/platform/basics/architecture/resources)
...
View examples for calling the same [Resource](/platform/basics/architecture/resources):
