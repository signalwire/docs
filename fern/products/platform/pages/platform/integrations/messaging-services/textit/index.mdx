...
![The user's account name on top right on Textit](/images/external/textit/account.webp)

Now you should see your account’s overview page. At the top, you will see a button labeled “Add Channel.” Press this button.

![Button to Add Channel selected in Textit](/images/external/textit/add_channel.webp)
...
![API Credentials.](/images/dashboard/credentials/api-credentials.webp)
</Frame>
...
![API Credentials.](/images/external/textit/configuration.webp)
</Frame>
