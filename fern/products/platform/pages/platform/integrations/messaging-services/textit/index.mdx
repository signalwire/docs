---
id: 5e69f7c2-629c-4c62-a1df-3463c2f1d9e7
title: TextIt
...
![The user's account name on top right on Textit](/assets/images/external/textit/account.webp)

Now you should see your account’s overview page. At the top, you will see a button labeled “Add Channel.” Press this button.

![Button to Add Channel selected in Textit](/assets/images/external/textit/add_channel.webp)
...
<Frame caption="The list of API tokens in your SignalWire Space">
![API Credentials.](/assets/images/dashboard/credentials/api-credentials.webp)
</Frame>
...
![API Credentials.](/assets/images/external/textit/configuration.webp)
</Frame>
