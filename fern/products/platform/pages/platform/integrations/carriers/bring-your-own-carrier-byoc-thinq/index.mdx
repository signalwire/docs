---
id: bf4654a7-56d0-43ee-8162-6e779570b6bb
title: ThinQ
...
![The Add Routing Profile popup in the thinQ interface](/assets/images/external/thinq/routing_profile.webp)
...
![The Trunks pane of the Outbound tab of the thinQ interface, with a red arrow pointing to the button labeled 'Add New'](/assets/images/external/thinq/add_new_trunk.webp)
...
![The Create Outbound Trunk page, with a red arrow pointing to the SignalWire logo](/assets/images/external/thinq/signalwire_trunk.webp)
...
![The Token popup, allowing the user to copy the trunk token](/assets/images/external/thinq/get_trunk_token.webp)

Making Outbound Calls via the API
-----------------------------------------------
