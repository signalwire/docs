...
![The Add Routing Profile popup in the thinQ interface](/images/external/thinq/routing_profile.webp)
...
![The Trunks pane of the Outbound tab of the thinQ interface, with a red arrow pointing to the button labeled 'Add New'](/images/external/thinq/add_new_trunk.webp)
...
![The Create Outbound Trunk page, with a red arrow pointing to the SignalWire logo](/images/external/thinq/signalwire_trunk.webp)
...
![The Token popup, allowing the user to copy the trunk token](/images/external/thinq/get_trunk_token.webp)
