---
id: 06b699ed-0f2b-411b-9983-af03f04eec0c
title: Linphone
...
![The options menu, with the Preferences item selected](/assets/images/external/linphone/preferences-button.webp)
...
![Linphone settings pane. Registration duration is set to 120, and Transport is set to TLS](/assets/images/external/linphone/sip-settings.webp)

![The settings pane additional settings. AVPF regular RTCP interval is set to 1 second. Register and publish presence information are enabled](/assets/images/external/linphone/ice-setting.webp)

If you get the error **Unable to Authenticate. Please verify your password.**, enter your SIP endpoint password and click **Login**.

![Entering the SIP endpoint password](/assets/images/external/linphone/password.webp)
