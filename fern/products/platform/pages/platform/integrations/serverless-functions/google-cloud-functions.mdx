---
id: da035caa-39a9-41d1-8132-0ad205d30cdf
...
The example application sets up a webhook to handle a phone call. In this case we will check the day of the week, and return a different greeting depending on the day. This is simple logic that you might not want to set up a full web server just to host.
