---
id: 26acce14-7ee9-47ed-b5e6-4df839ed36eb
...
3. Softphone client of your choosing. For this guide, we will use [MicroSIP](https://www.microsip.org/). See [Using a softphone with SignalWire](/platform/basics/general/what-is-sip#softphone-configuration) for configuration details.
...
If you do not wish to use MicroSIP, any SIP-compatible softphone will work. See [Using a softphone with SignalWire](/platform/basics/general/what-is-sip#softphone-configuration) for the required configuration settings.
...
For example, in the case it shows `virginia @ 2u3092302v2390.sip.signalwire.com` the `2u3092302v2390.sip.signalwire.com` is the 
domain part. 

For general softphone configuration details, see [Using a softphone with SignalWire](/platform/basics/general/what-is-sip#softphone-configuration).
