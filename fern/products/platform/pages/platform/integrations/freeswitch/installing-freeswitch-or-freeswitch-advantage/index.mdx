...
![The top right menu of the SignalWire Space](/images/dashboard/toolbar-right-open.webp)

</Frame>

<Frame caption="The top-right menu">

![The personal access token page on the SignalWire space](/images/dashboard/credentials/personal-access-tokens.webp)
