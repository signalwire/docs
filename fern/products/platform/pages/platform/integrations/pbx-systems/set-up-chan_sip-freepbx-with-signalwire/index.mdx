...
![A screenshot of the Outgoing tab of the sip Settings tab of the Edit Trunk page.The indicated text has been entered within the PEER details field.](/images/external/fusionpbx/chan_sip/rtaImage_3.webp)
...
![In the Incoming sub-tab of the SIP Settings tab, the Register string has been entered in the field labeled Register String.](/images/external/fusionpbx/chan_sip/rtaImage_4.webp)
...
![A screenshot showing the indicated settings changes.](/images/external/fusionpbx/chan_sip/Asterisk-SIP-security.webp)
...
![A screenshot of the SIP Legacy Settings tab in the Advanced General Settings sections, showing the indicated changes.](/images/external/fusionpbx/chan_sip/rtaImage_5.webp)
...
![A screenshot of the Configuration File Editor, with the extensions_custom.conf file selected. The provided code has been pasted in the conf file.](/images/external/fusionpbx/chan_sip/rtaImage_6.webp)
...
![A screenshot of the Asterisk Info page within the Reports section. Registries has been selected, and in the SIP section, the Refresh State value reads 105 Registered. This value is circled in red.](/images/external/fusionpbx/chan_sip/rtaImage_7.webp)
