---
id: efee60e7-7cec-4062-925c-a7b9d46d286d
title: FusionPBX
slug: /fusionpbx
x-custom:
...
If you don't have a SIP endpoint set up already, the first step is to [create a SIP Endpoint](platform/voice) and connect it to a phone number.
...
![The Gateways item under Accounts.](/assets/images/external/fusionpbx/01_gateways.webp)
...
![Selecting the Add button in the Gateways section.](/assets/images/external/fusionpbx/02_add_gateways.webp)
...
![Selecting the SIP Settings pane of the SIP tab.](/assets/images/external/fusionpbx/03_signalwire_sip_address.webp)
...
![A screenshot of the Gateway form. The Gateway name is set to signalwire. Username, password, and proxy are filled in with appropriate values. Expire seconds is set to 800. Register is set to True. Retry Seconds is set to 30. Under Advanced, the Context is set to Public and the Profile is set to Internal.](/assets/images/external/fusionpbx/04_gateway_form.webp)
...
![A screenshot of a table with gateways. The example gateway reads 'REGED' in the State column.](/assets/images/external/fusionpbx/05_gateway_reged.webp)
...
![A screenshot of the Dialplan menu, with Outbound Routes selected.](/assets/images/external/fusionpbx/06_outbound_routes.webp)

</Frame>

<Frame caption="Selecting the Add button.">

![Selecting the Add button.](/assets/images/external/fusionpbx/07_outbound_routes_add.webp)
...
![Settings in the Outbound Routes form.](/assets/images/external/fusionpbx/08_outbound_routes_form.webp)
...
![Selecting the Extensions item in the Accounts menu.](/assets/images/external/fusionpbx/09_extensions.webp)
...
![Selecting the Destinations item in the Dialplan menu.](/assets/images/external/fusionpbx/10_destinations.webp)
...
![Selecting the Add button.](/assets/images/external/fusionpbx/11_destinations_add.webp)
...
![Form settings.](/assets/images/external/fusionpbx/image.webp)
...
![Selecting the Add button under Default Settings.](/assets/images/external/fusionpbx/13_sip_default_setting.webp)
...
![Selecting the Save button.](/assets/images/external/fusionpbx/14_sip_user_setting.webp)
...
![A screenshot of the Access Control page, with a list of nodes.](/assets/images/external/fusionpbx/signalwire_allow_ips.webp)
...
If you are using [fail2ban](https://docs.fusionpbx.com/en/latest/firewall/fail2ban.html) to protect FreeSWITCH, you can add SignalWire IPs directly to iptables via the linux command line!
 ...
 Check out our article on [how to allow SignalWire IPs through your firewall](platform/allow-signalwire-ips-through-your-firewall)  to learn more.
