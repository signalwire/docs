...
![The Gateways item under Accounts.](/docs/assets/images/external/fusionpbx/01_gateways.webp)
...
![Selecting the Add button in the Gateways section.](/docs/assets/images/external/fusionpbx/02_add_gateways.webp)
...
![Selecting the SIP Settings pane of the SIP tab.](/docs/assets/images/external/fusionpbx/03_signalwire_sip_address.webp)
...
![A screenshot of the Gateway form. The Gateway name is set to signalwire. Username, password, and proxy are filled in with appropriate values. Expire seconds is set to 800. Register is set to True. Retry Seconds is set to 30. Under Advanced, the Context is set to Public and the Profile is set to Internal.](/docs/assets/images/external/fusionpbx/04_gateway_form.webp)
...
![A screenshot of a table with gateways. The example gateway reads 'REGED' in the State column.](/docs/assets/images/external/fusionpbx/05_gateway_reged.webp)
...
![A screenshot of the Dialplan menu, with Outbound Routes selected.](/docs/assets/images/external/fusionpbx/06_outbound_routes.webp)

</Frame>

<Frame caption="Selecting the Add button.">

![Selecting the Add button.](/docs/assets/images/external/fusionpbx/07_outbound_routes_add.webp)
...
![Settings in the Outbound Routes form.](/docs/assets/images/external/fusionpbx/08_outbound_routes_form.webp)
...
![Selecting the Extensions item in the Accounts menu.](/docs/assets/images/external/fusionpbx/09_extensions.webp)
...
![Selecting the Destinations item in the Dialplan menu.](/docs/assets/images/external/fusionpbx/10_destinations.webp)
...
![Selecting the Add button.](/docs/assets/images/external/fusionpbx/11_destinations_add.webp)
...
![Form settings.](/docs/assets/images/external/fusionpbx/image.webp)
...
![Selecting the Add button under Default Settings.](/docs/assets/images/external/fusionpbx/13_sip_default_setting.webp)
...
![Selecting the Save button.](/docs/assets/images/external/fusionpbx/14_sip_user_setting.webp)
...
![A screenshot of the Access Control page, with a list of nodes.](/docs/assets/images/external/fusionpbx/signalwire_allow_ips.webp)
