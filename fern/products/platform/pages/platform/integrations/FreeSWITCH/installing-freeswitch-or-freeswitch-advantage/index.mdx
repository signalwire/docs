...
![The top right menu of the SignalWire Space](/docs/assets/images/dashboard/toolbar-right-open.webp)

</Frame>

<Frame caption="The top-right menu">

![The personal access token page on the SignalWire space](/docs/assets/images/dashboard/credentials/personal-access-tokens.webp)
