---
id: ff31b958-b555-45c7-aaff-b63f69d4c42f
...
slug: /freeswitch/installing-freeswitch
x-custom:
  tags:
  - product:freeswitch
  - getting-started
...
A SignalWire account is now required to download the pre-build FreeSWITCH binaries. First [create a SignalWire Space](/docs/platform/signing-up-for-a-space), then open the user menu in the
Dashboard's top-right corner, select **Personal Access Tokens**, and create a token. [Click here to learn more](https://freeswitch.org/confluence/display/FREESWITCH/Debian).

<llms-ignore>

<Frame caption="The top-right menu">

![The top right menu of the SignalWire Space](/assets/images/dashboard/toolbar-right-open.webp)

</Frame>

<Frame caption="The top-right menu">

![The personal access token page on the SignalWire space](/assets/images/dashboard/credentials/personal-access-tokens.webp)
...
Open the user menu in the Dashboard's top-right corner, select **Personal Access Tokens**, then select **+ Add New** to create a token.
