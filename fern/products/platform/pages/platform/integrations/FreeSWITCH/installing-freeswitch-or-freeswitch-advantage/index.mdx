...
A SignalWire account is now required to download the pre-build FreeSWITCH binaries. First [create a SignalWire Space](/platform/signing-up-for-a-space), then go to the `Personal Access Tokens`
