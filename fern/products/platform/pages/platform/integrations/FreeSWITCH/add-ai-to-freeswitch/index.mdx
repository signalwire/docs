...
SIP domain applications can be created from your space dashboard. Please follow our [SIP domain applications introduction](/platform/voice/sip/domain-applications)
