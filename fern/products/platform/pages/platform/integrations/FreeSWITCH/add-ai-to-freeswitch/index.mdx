...
![The Domain Applications page of the SignalWire dashboard with "Handle Incoming Calls" section selecting AI Agent](/docs/assets/images/dashboard/sip/sip-domain-apps-ai-agent.webp)
