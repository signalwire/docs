...
slug: /integrations/add-ai-to-freeswitch
x-custom:
  tags:
    - product:freeswitch
    - favorite
...
SIP domain applications can be created from your space dashboard. Please follow our [SIP domain applications introduction](/voice/getting-started/sip/sip-domain-applications)
