...
SIP domain applications can be created from your space dashboard, where they appear as SIP
Addresses. For a detailed guide on creating them, see [SIP credentials and addresses](/docs/platform/voice/sip/sip-credentials).
