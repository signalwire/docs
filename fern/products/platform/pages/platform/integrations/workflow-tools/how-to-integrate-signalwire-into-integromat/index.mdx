...
![SignalWire Space API Credentials page](/images/dashboard/credentials/api-credentials.webp)
...
![The Integromat web application with the 'Scenarios' tab circled in green](/images/external/integromat/dashboard-scenarios-selected.webp)
...
![The 'Create a connection' dialog. The 'Add' button under the Connection heading has been clicked. The dialog includes text fields labeled Connection Name, Space Name, Project ID, and Auth Token](/images/external/integromat/signalwire-config.webp)
