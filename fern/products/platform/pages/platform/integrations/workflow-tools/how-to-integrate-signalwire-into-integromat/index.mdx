---
id: a0ce48b5-e11a-48db-929e-7c50522111fa
title: Integromat
...
![SignalWire Space API Credentials page](/assets/images/dashboard/credentials/api-credentials.webp)
...
![The Integromat web application with the 'Scenarios' tab circled in green](/assets/images/external/integromat/dashboard-scenarios-selected.webp)
...
![The 'Create a connection' dialog. The 'Add' button under the Connection heading has been clicked. The dialog includes text fields labeled Connection Name, Space Name, Project ID, and Auth Token](/assets/images/external/integromat/signalwire-config.webp)
