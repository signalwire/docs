...
![The Set Up Action pane](/images/external/zapier/phone-call/set-up-trigger.webp)
...
![SignalWire space API Credentials](/images/dashboard/credentials/api-credentials.webp)
...
![Successfully tested trigger. A dialog reads, 'We found a phone call!' The text of the dialog includes the JSON response](/images/external/zapier/phone-call/test-trigger.webp)
...
![The Set Up Action pane](/images/external/zapier/phone-call/set-up-action.webp)
...
![The Set Up Action pane with messages](/images/external/zapier/phone-call/set-up-message-action.webp)
