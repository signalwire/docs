---
id: 5cfb029a-ec1e-4583-b365-7db4953d6518
...
![Successfully tested trigger. A dialog reads, 'We found a phone call!' The text of the dialog includes the JSON response](/assets/images/external/zapier/phone-call/test-trigger.webp)
...
![The Set Up Action pane](/assets/images/external/zapier/phone-call/set-up-action.webp)
...
![The Set Up Action pane with messages](/assets/images/external/zapier/phone-call/set-up-message-action.webp)
