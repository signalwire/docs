...
<Frame>
    ![the reference app.](/assets/images/dashboard/reference-app.webp)
</Frame>
...
<Frame caption="Add a new Resource, select Subscriber, configure, and deploy.">
    ...
    ![Deploy a new subscriber.](/assets/images/dashboard/resources/add-new-resource.webp)
    ![Add a new Resource from the menu.](/assets/images/dashboard/resources/subscriber.webp)
...
<Frame>
    ...
    ![The Marketplace button on the Dashboard.](/assets/images/dashboard/marketplace-button.webp)
...
<Frame>
    ...
    ![The menu to launch the Reference App.](/assets/images/dashboard/marketplace.webp)
