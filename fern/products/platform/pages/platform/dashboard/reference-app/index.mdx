...
<Frame>
    ![the reference app.](/images/dashboard/reference-app.webp)
</Frame>
...
<Frame caption="Add a new Resource, select Subscriber, configure, and deploy.">
    ...
    ![Deploy a new subscriber.](/images/dashboard/resources/add-new-resource.webp)
    ![Add a new Resource from the menu.](/images/dashboard/resources/subscriber.webp)
...
<Frame>
    ...
    ![The Marketplace button on the Dashboard.](/images/dashboard/marketplace-button.webp)
...
<Frame>
    ...
    ![The menu to launch the Reference App.](/images/dashboard/marketplace.webp)
