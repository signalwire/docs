...
For example, you might use a webhook to handle an inbound call by reading the instructions in your webhook to play an IVR, route the customer to the right department, and connect them with an agent, all by replying with appropriate SWML instructions. 
...
<Card
  ...
  href="/docs/compatibility-api/rest/messages/webhooks/message-status-callback"
>
  Learn how to receive message status updates via webhooks.
</Card>
<Card
  title="SMS status callback"
  href="/docs/compatibility-api/rest/messages/webhooks/sms-status-callback"
>
  Learn how to receive SMS delivery status updates via webhooks.
</Card>
<Card
  title="Transcription status callback"
  href="/docs/compatibility-api/rest/recording-transcriptions/webhooks/transcription-status-callback"
>
  Learn how to receive transcription status updates via webhooks.
</Card>
<Card
