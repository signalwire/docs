...
Read in-depth about voice status callbacks [here](/docs/platform/phone-numbers/guides/signalwire-status-callbacks/voice-status-callbacks) to see all of the possible parameters & statuses as well as a working code example!
...
Read in-depth about [recording status callbacks](/docs/platform/phone-numbers/guides/signalwire-status-callbacks/recording-status-callbacks) to see all of the possible parameters and statuses as well as a working code example!
...
You can do this by setting the `StatusCallback` parameter when [sending an outbound message](/docs/compatibility-api/rest/messages/create-message) through the API.

Read in-depth about SMS status callbacks [here](/docs/platform/phone-numbers/guides/signalwire-status-callbacks/sms-status-callbacks) to learn all of their possible parameters and statuses and see a working code example!
...
![The Phone Numbers tab of a SignalWire Space showing a list of phone numbers](/docs/assets/images/dashboard/phone-numbers/purchased-phone-numbers.webp)
