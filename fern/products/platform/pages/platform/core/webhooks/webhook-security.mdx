---
id: ebb3ddad-8e67-4d1a-a947-816da507ce1e
title: Webhook security
slug: /webhooks/webhook-security
author: rsowald
x-custom:
  tags:
    - product:messaging
...
![The SignalWire Space showing API credentials, including Signing Key](/docs/assets/images/dashboard/credentials/api-credentials-with-signing-key.webp)
