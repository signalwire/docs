...
| US long code (10DLC)                 | `4` MPS <br/><span class="optional-arg">Actual throughput may be lower or higher depending on carrier and [TCR](/platform/messaging/campaign-registry) limits</span> |
...
Consult the guide to [Messaging Character Limits](/platform/messaging/character-limits) for more information.
</Warning>
