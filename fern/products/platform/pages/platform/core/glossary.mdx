...
A container object representing one communication entity. Every Resource has a **Type** and one or more [addresses][addresses] that make it reachable. The Dashboard lists Subscriber, AI Agent, Remote AI Agent, SWML Script, SWML Webhook, cXML Script, cXML Application, cXML Webhook, Call Flow, Relay Application, FreeSWITCH Connector, SIP Credential, SIP Gateway, Dialogflow Agent, and Video Room. All types share the same addressing and management model.
