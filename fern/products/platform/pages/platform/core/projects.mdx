...
[Personal access token](/docs/apis/authorization#personal-access-tokens), which carries your owner or admin
role in the Space rather than a Project's scopes and can create and delete root Projects too.
