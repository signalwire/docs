...
<CardGroup cols={2}>
  <Card title="Agents SDK" href="/sdks/agents-sdk">
    Utilize the SignalWire Agents SDK to build AI-powered applications.
  </Card>
  <Card title="Browser SDK" href="/sdks/browser-sdk">
    Utilize the SignalWire Browser SDK to build WebRTC-based applications.
  </Card>
  <Card title="Realtime SDK" href="/sdks/realtime-sdk">
    Utilize the SignalWire Realtime SDK to build real-time applications from your backend.
  </Card>
  <Card title="Compatibility SDKs" href="/compatibility-api/sdks">
    The compatibility SDKs help developers migrate their existing XML based applications to the SignalWire platform.
  </Card>
</CardGroup>
...
### Alpha Releases <span class="badge badge--danger">ALPHA</span>
...
### Beta Releases <span class="badge badge--warning">BETA</span>
