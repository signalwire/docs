...
In the Dashboard, open **Phone Numbers**, choose **Local**, **Toll Free**, or **Shortcode**, then use the search filters to find and buy a number.
...
- [Answer an inbound call](/docs/platform/voice/make-and-receive-calls#give-the-resource-an-address)
