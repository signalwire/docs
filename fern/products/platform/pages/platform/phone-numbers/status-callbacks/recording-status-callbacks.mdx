---
id: 6f1523f4-f047-42ab-ba81-73d31c1d2001
title: Recording status callbacks
slug: /platform/phone-numbers/guides/signalwire-status-callbacks/recording-status-callbacks
---
...
You can set up recording status callbacks in your API request for an [outgoing call](/rest/signalwire-rest/endpoints/calling/call-commands) or by using the recording feature in your SWML script.
