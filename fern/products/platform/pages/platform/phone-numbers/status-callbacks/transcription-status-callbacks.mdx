---
id: 9c9ca292-6ed4-40b5-a21b-a250814e7da4
title: Transcription status callbacks
slug: /platform/phone-numbers/guides/signalwire-status-callbacks/transcription-status-callbacks
---

If you are already using recordings, you may also want to transcribe them as well. 
Transcription callbacks will allow SignalWire to make an HTTP request to your specified callback URL with the transcription text as well as some other additional parameters. 
Your app can use these parameters to handle the transcription by uploading to your CRM, sending via email, 
or maybe even using SignalWire SMS to forward the body of the transcription.

### Transcription Status Callback Parameters

The following parameters will be posted via an HTTP request to your webhook - 
you can use one or all of them depending on what type of information you are looking for.
...
You can set up transcription status callbacks by using the recording feature in your call handling script and configuring the transcription callback URL.
