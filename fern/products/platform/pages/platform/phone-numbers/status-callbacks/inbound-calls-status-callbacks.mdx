---
id: 34708ec3-5b24-4c5c-bcb4-f9e972a56cd4
title: Inbound call status callbacks
slug: /platform/phone-numbers/guides/signalwire-status-callbacks/inbound-calls-status-callbacks
---
...
Ensure that the phone number has been assigned a script resource under "Inbound Call Settings". You can configure status callbacks through your SWML script or webhook handler.
