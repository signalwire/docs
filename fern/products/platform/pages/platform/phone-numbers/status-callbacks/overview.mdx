---
id: a23699bb-3d5d-41df-8fe4-6ac5f0042aac
...
description: SignalWire allows for a variety of different types of callbacks
  ...
  incoming events.
slug: /platform/phone-numbers/guides/signalwire-status-callbacks
x-custom:
...
<CardGroup cols={1}>
  <Card
    ...
    href="/platform/phone-numbers/guides/signalwire-status-callbacks/inbound-calls-status-callbacks"
  ...
  <Card
    ...
    href="/platform/phone-numbers/guides/signalwire-status-callbacks/voice-status-callbacks"
    icon="solid phone"
  >
  ...
  <Card
    ...
    href="/platform/phone-numbers/guides/signalwire-status-callbacks/sms-status-callbacks"
    icon="solid comment-sms"
  >
    Observe message delivery, failures, and errors across your SMS and MMS traffic.
  </Card>
  <Card
    title="10DLC status callbacks"
    href="/platform/phone-numbers/guides/signalwire-status-callbacks/10dlc-tcr-status-callbacks"
    icon="solid bullhorn"
  >
  ...
  <Card
    ...
    href="/platform/phone-numbers/guides/signalwire-status-callbacks/recording-status-callbacks"
    icon="solid wave-square"
  >
    Handle call recordings automatically when they are created and ready for use.
  </Card>
  <Card
    title="Transcription status callbacks"
    href="/platform/phone-numbers/guides/signalwire-status-callbacks/transcription-status-callbacks"
    icon="solid language"
  >
...
To run these exact examples, you will need the Flask framework and [Python SignalWire SDK](/sdks) downloaded. However, you could recreate them or write your own example using any of the [SignalWire SDKs](/sdks) and a web framework.
