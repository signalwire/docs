---
id: e9a4e8f4-6032-4e29-95f4-84daa860780d
title: Voice status callbacks
slug: /platform/phone-numbers/guides/signalwire-status-callbacks/voice-status-callbacks
---
...
You can use the `StatusCallback` parameter while [creating a call via the Calling API](/rest/signalwire-rest/endpoints/calling/call-commands) to get notifications with these parameters when the call status changes.
