...
Calling 911 from a number with no E911 address still connects, but the call routes to the
national emergency call center, where operators must determine your location before help can be
dispatched — delaying response. Each of these calls also incurs a $100 fee. Register an address
before an emergency, and always dial 933, not 911, to
[test your configuration](#test-your-e911-configuration).
</Warning>
