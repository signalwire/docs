...
[create-subscribers]: /platform/resources#create
[subscriber-tokens]: /apis/fabric/subscribers/create-subscriber-token
[guest-tokens]: /apis/fabric/subscribers-tokens/create-subscriber-guest-token
[invite-tokens]: /apis/fabric/subscribers-tokens/create-subscriber-invite-token
[refresh-tokens]: /apis/fabric/subscribers-tokens/refresh-subscriber-token
[create-subscriber]: /apis/fabric/subscribers/create-subscriber
[get-subscriber]: /apis/fabric/subscribers/get-subscriber
[update-subscriber]: /apis/fabric/subscribers/update-subscriber
[delete-subscriber]: /apis/fabric/subscribers/delete-subscriber
[resource-addresses]: /platform/addresses
[browser-sdk]: /browser-sdk/js/reference/call-fabric
...
<CardGroup cols={2}>
  <Card
    ...
    icon="solid key"
    href="/docs/apis/fabric/subscribers/create-subscriber-token"
  >
  ...
  <Card
    ...
    href="/docs/apis/fabric/subscribers-tokens/create-subscriber-guest-token"
  >
  ...
  <Card
    ...
    href="/docs/apis/fabric/subscribers-tokens/create-subscriber-invite-token"
  >
  ...
  <Card
    ...
    href="/docs/apis/fabric/subscribers-tokens/refresh-subscriber-token"
  >
    **Session management**
...
<CardGroup cols={2}>
  <Card
    ...
    href="/docs/apis/fabric/subscribers/create-subscriber"
  >
  ...
  <Card
    ...
    icon="solid user"
    href="/docs/apis/fabric/subscribers/get-subscriber"
  >
  ...
  <Card
    ...
    icon="solid user-pen"
    href="/docs/apis/fabric/subscribers/update-subscriber"
  >
  ...
  <Card
    ...
    href="/docs/apis/fabric/subscribers/delete-subscriber"
  >
    **Delete subscribers**
