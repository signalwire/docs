...
<CardGroup cols={2}>
  <Card
    ...
    icon="solid key"
    href="/docs/apis/rest/subscribers/subscriber-tokens/create-subscriber-token"
  >
  ...
  <Card
    ...
    href="/docs/apis/rest/subscribers/subscriber-tokens/create-subscriber-guest-token"
  >
  ...
  <Card
    ...
    href="/docs/apis/rest/subscribers/subscriber-tokens/create-subscriber-invite-token"
  >
  ...
  <Card
    ...
    href="/docs/apis/rest/subscribers/subscriber-tokens/refresh-subscriber-token"
  >
    **Session management**
