...
title: Subscribers
subtitle: The foundation of user management on SignalWire
description: Comprehensive overview of SignalWire Subscribers - the building blocks of Programmable Unified Communications for user management and onboarding.
slug: subscribers
---
...
Subscribers are the core [Resources][resources] on SignalWire that represent users 
...
<CardGroup cols={3}>
  <Card title="Identity & authentication" icon="regular shield-halved">
  ...
  <Card title="Communication endpoints" icon="regular phone-volume">
    Multi-channel connectivity with private resource address for internal communication plus public phone numbers for external calls.
    Full SIP, WebRTC, and PSTN support.
  </Card>
  <Card title="Flexible configuration" icon="regular gear">
...
Subscribers use SignalWire's unified addressing system for consistent identification across all platform 
[Resources][resources]. Each Subscriber is uniquely identified by an address in the format `/<Context>/<Name>`.

**Addresses make Subscribers directly callable.** When a call is placed to a Subscriber's address, SignalWire 
...
- SignalWire handles device registration, presence, and simultaneous ring automatically
...
<CardGroup cols={2}>
  <Card
    ...
    icon="regular key"
    href="/docs/apis/rest/subscribers/tokens/create-subscriber-token"
  >
  ...
  <Card
    title="Guest Tokens"
    icon="regular user-clock"
    href="/docs/apis/rest/subscribers/tokens/create-subscriber-guest-token"
  >
  ...
  <Card
    ...
    href="/docs/apis/rest/subscribers/tokens/create-subscriber-invite-token"
  >
  ...
  <Card
    ...
    href="/docs/apis/rest/subscribers/tokens/refresh-subscriber-token"
  >
    **Session management**
...
<CardGroup cols={2}>
  <Card
    ...
    href="/docs/apis/rest/subscribers/create-subscriber"
  >
  ...
  <Card
    ...
    icon="regular user"
    href="/docs/apis/rest/subscribers/get-subscriber"
  >
  ...
  <Card
    ...
    href="/docs/apis/rest/subscribers/update-subscriber"
  >
  ...
  <Card
    ...
    href="/docs/apis/rest/subscribers/delete-subscriber"
  >
    **Delete subscribers**
...
<CardGroup cols={2}>
  <Card title="Complete infrastructure" icon="regular gauge-high">
  ...
  <Card title="Enterprise-grade security" icon="regular lock">
