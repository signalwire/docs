...
lowercase letters, numbers, underscores, and dashes. Most types, including AI Agents, SWML
Scripts, Call Flows, Relay Applications, and Subscribers, get their first alias in the `private`
context; Video Rooms, SIP Credentials, SIP Gateways, cXML Scripts, and FreeSWITCH Connectors get a
`public` one. Add a `public` alias yourself when unauthenticated callers need to reach a Resource
that started out `private`.
