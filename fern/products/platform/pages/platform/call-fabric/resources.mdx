...
<Steps>
  ...
  <Step title="Configure the Resource">
    <Markdown src="/docs/snippets/common/dashboard/_resource-admonition.mdx" />
  </Step>
</Steps>
...
<Frame 
  ...
  ![Create a new Resource from the Dashboard.](/docs/assets/images/dashboard/home/home-resources-marked.webp)
...
<Frame caption="The Resource selection menu">
  ![Select a Resource in the Signalwire Dashboard.](/docs/assets/images/dashboard/resources/add-new-resource.webp)
</Frame>
...
<Frame caption="The list of Resources in a SignalWire Space">
  ![The list of Resources in a SignalWire Space.](/docs/assets/images/dashboard/resources/resource-list.webp)
</Frame>
