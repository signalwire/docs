...
ones only to authenticated users. Addresses are mutable, so you can point a phone number or an
alias at a different Resource later without changing the code that dials it.
