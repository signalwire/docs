...
[Connect a WhatsApp business number](/docs/platform/messaging/whatsapp/onboarding).
</Note>
...
SignalWire keeps the number registered for calling with Meta. If Meta stops accepting that
registration — because the number or WhatsApp Business Account was removed or suspended on Meta's
side — `voice_enabled` returns to false and calls stop arriving. Check this field if calls stop
unexpectedly.
</Warning>
