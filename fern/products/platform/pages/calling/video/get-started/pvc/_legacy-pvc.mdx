...
![](/images/dashboard/legacy/pvc/97db962-sw-space-video-page.webp)
...
<Frame caption="Guest Embed Code Snippet">
  ![the Guest Embed Code dialog. Users can copy the provided embed code.](/images/video/guest-embed-code.webp)
</Frame>
...
![](/images/dashboard/legacy/pvc/f2927e5-sw-space-video-logs.webp)
...
<img
  src={require("/images/dashboard/legacy/pvc/1a1898d-sw-space-video-conferences.jpg").default}
  className="img-800"
/>
...
![Video Conference overview showing room description, participant count, and moderator controls.](/images/video/conference-overview.webp)
</Frame>
...
![Video Conference settings tab with Availability, Quality, Layout, Size, and Record options.](/images/video/conference-settings.webp)
</Frame>
...
<Frame caption="Video Conference Appearance Tab">
  ![Video Conference Appearance tab for customizing Light and Dark color schemes.](/images/video/conference-appearance.webp)
</Frame>
...
<img
  src={require("/images/dashboard/legacy/pvc/e9f0676-sw-space-video-recordings.webp").default}
  className="img-800"
/>
