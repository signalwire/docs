...
<Frame caption="Create and manage all Resources from the SignalWire Dashboard.">
  ![The Resources tab of the SignalWire Dashboard.](/images/dashboard/home/home-resources-marked.webp)
</Frame>
...
From within the Resources tab, select **Add New**.
    ...
    <Frame>
    ![A list of Resources in a SignalWire Space.](/images/dashboard/resources/resource-list.webp)
    </Frame>
...
![The Resource picker menu.](/images/dashboard/resources/add-new-resource-video-marked.webp)
</Frame>
...
<AccordionGroup>
  ...
  <Accordion title="WordPress">
    ...
    <Frame caption="How to add a Custom HTML Block to a page or post.">
      ![An animated Gif showing a user adding a Custom HTML block with the Video Conference guest code to a WordPress page.](/images/external/wp-custom-html.gif)
    </Frame>
    ...
    <Frame caption="How to make a page private.">
      ![An animated Gif showing a private WordPress page with the Moderator Video Conference code in an HTML block.](/images/external/wp-private-page.gif)
    </Frame>
    ...
    <Frame caption="How to password-protect a page.">
      ![An animated Gif showing a password-protected WordPress page with the Guest Video Conference code in an HTML block.](/images/external/wp-password-protected.gif)
    </Frame>
  ...
  <Accordion title="Ghost">
    ...
    <Frame caption="How to add the code snippet to a post using the HTML card.">
      ![Adding Video Conference Guest embed code to a Ghost CMS HTML block.](/images/external/ghost-html.gif)
    </Frame>
  </Accordion>
