---
id: 0b3a225d-2ee5-4a70-915e-405af0037348
title: First steps with video
...
![a video room in a Safari browser window. There are two participants, one with video muted.](/assets/images/project/video-first-steps-example.webp)
</Frame>
...
In the above file, we are using the [Browser SDK](/browser-sdk) to establish a video connection to a video room and to display its video stream into a `div`.
...
<Card title="Get Started With a Simple Video Demo" href="/browser-sdk/guides/build-a-video-calling-application-with-the-browser-sdk" icon="solid video">
