...
![a video call with two participants and a button labeled 'Hang up' beneath the video.](/images/project/simple-video-demo/video-room.webp)
</Frame>
...
![The API page shows the active Project ID and Space URL, and a list of API tokens organized by Name, Token, and Last Used.](/images/dashboard/credentials/api-credentials.webp)
...
![SignalWire video call with controls for screen share, layout, audio, and video.](/images/project/simple-video-demo/video-room-final.webp)
</Frame>
