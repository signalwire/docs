---
id: a9409f91-22a8-4f32-aedd-f8090a3e11be
title: Extending rooms with custom code
...
subscribe to the
[`room.joined`](/browser-sdk/reference/video/room-session/events#roomjoined)
event, which will trigger right after the room has been joined. Then, we would
invoke the
[`videoMute`](/browser-sdk/reference/video/room-session/methods/video-mute)
...
[roomsession]: /browser-sdk/reference/video/room-session
