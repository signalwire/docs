---
title: Using Hooks to Track Call State in React and React Native
slug: /guides/video/using-hooks-to-track-ui
sidebar-title: Using Hooks to Track Call State
---
...
is true when the user is sharing their screen.
  ...
  <video class="img-600" autoPlay muted style={{ maxWidth: 600 }} loop>
