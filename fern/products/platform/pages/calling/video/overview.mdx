...
The Video API supports inbound RTMP via the [`play`](/browser-sdk/js/reference/video/room-session/play) method, and outbound RTMP via the [`startStream`](/browser-sdk/js/reference/video/room-session/start-stream) method.
</Accordion>
