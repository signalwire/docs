...
There is no native support for this at the moment, but you can certainly implement it yourself using the concept of [video overlays](/sdks/browser-sdk/guides/video/video-overlays).
</Accordion>
...
The Video API supports inbound RTMP via the [`play`](/sdks/browser-sdk/video/room-session#play) method, and outbound RTMP via the [`startStream`](/sdks/browser-sdk/video/room-session#startstream) method.
</Accordion>
