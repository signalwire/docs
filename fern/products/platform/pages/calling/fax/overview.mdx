...
<Frame caption="Navigating to and creating a new SWML resource for handling faxes.">
  ...
  creation.](/docs/assets/images/dashboard/resources/swml-resource-vid.webp)
</Frame>
...
<Markdown src="/docs/snippets/common/dashboard/_ui-accordion.mdx" />
...
<Frame caption="Assign the script to your phone number's inbound call settings.">
  ...
  calls.](/docs/assets/images/dashboard/phone-numbers/assign-resource-full.webp)
</Frame>
...
<Frame caption="View your received faxes in the dashboard logs.">
  ![The logs page showing voice logs where inbound faxes will be received.](/docs/assets/images/dashboard/sidebar/voice-logs.webp)
</Frame>
...
You can also utilize SWML to send faxes via a POST request to the SignalWire REST API [Create a Call endpoint](/docs/apis/calling/calls/call-commands). 
