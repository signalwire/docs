...
<Frame caption="Navigating to and creating a new SWML resource for handling faxes.">
  ...
  creation.](/images/dashboard/resources/swml-resource-vid.webp)
</Frame>
...
<Frame caption="Creating a new cXML script resource for handling faxes.">
  ![The new resource dialog showing cXML script
  creation.](/images/dashboard/resources/new-cxml-bin.webp)
</Frame>
...
<Frame caption="cXML script configuration with Faxing selected.">
  ...
  selected.](/images/dashboard/resources/fax-cxml-script-example.webp)
</Frame>
...
<Frame caption="Assign the script to your phone number's inbound call settings.">
  ...
  calls.](/images/dashboard/phone-numbers/assign-resource-full.webp)
</Frame>
...
<Frame caption="View your received faxes in the dashboard logs.">
  ![The logs page showing voice logs where inbound faxes will be received.](/images/dashboard/sidebar/voice-logs.webp)
</Frame>
