...
sidebar-title: AI Agents in the Dashboard
author: Devon White
x-custom:
  tags:
    - getting-started
...
<Frame caption="The AI Agent creation dialog.">
![A screenshot of the New AI Agent page within the AI Agents tab of a SignalWire Space.](/assets/images/dashboard/_unpublished/create-swaig.webp)
</Frame>

You should now see your newly created AI Agent show up in the AI Agents list.

<Frame caption="">
![A screenshot of a successfully created AI Agent page within the AI Agents tab.](/assets/images/dashboard/_unpublished/swaig-created.webp)
</Frame>
...
<Frame caption="">
![A screenshot of the Edit page for the new AI Agent.](/assets/images/dashboard/_unpublished/swaig-settings.webp)
</Frame>
...
<Frame caption="">
![A screenshot of the advanced configurations, showing values for Prompt Confidence, Top P, and Temperature.](/assets/images/dashboard/_unpublished/swaig-prompt-config.webp)
</Frame>
...
<Frame caption="">
![A screenshot of the Post Prompt panel, including a text box, advanced config section, and Post Prompt Url text box.](/assets/images/dashboard/_unpublished/swaig-post-prompt-advanced-config.webp)
</Frame>
...
<Frame caption="">
![A screenshot of the Add Language panel, with drop-down selectors for Language, Gender, and Voice.](/assets/images/dashboard/_unpublished/swaig-language-settings.webp)
</Frame>
...
<Frame caption="">
![A screenshot of the Functions tab, showing text boxes labeled Default Web Hook URL, Default Web Hook Auth User, and Default Web Hook Auth Password.](/assets/images/dashboard/_unpublished/swaig-default-url-function.webp)
</Frame>
...
<Frame caption="">
![A screenshot of the Edit page for the AI Agent, showing the Add Function button.](/assets/images/dashboard/_unpublished/swaig-functions.webp)
</Frame>
...
<Frame caption="">
![A screenshot of the New Function menu.](/assets/images/dashboard/_unpublished/swaig-function-settings.webp)
</Frame>
...
<Frame caption="">
![A screenshot of the Advanced Configuration section.](/assets/images/dashboard/_unpublished/swaig-function-webhook-advanced.webp)
</Frame>
