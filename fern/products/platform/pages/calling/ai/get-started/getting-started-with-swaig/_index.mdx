...
![A screenshot of the New AI Agent page within the AI Agents tab of a SignalWire Space.](/images/dashboard/_unpublished/create-swaig.webp)
</Frame>

You should now see your newly created AI Agent show up in the AI Agents list.

<Frame caption="">
![A screenshot of a successfully created AI Agent page within the AI Agents tab.](/images/dashboard/_unpublished/swaig-created.webp)
</Frame>
...
<Frame caption="">
![A screenshot of the Edit page for the new AI Agent.](/images/dashboard/_unpublished/swaig-settings.webp)
</Frame>
...
<Frame caption="">
![A screenshot of the advanced configurations, showing values for Prompt Confidence, Top P, and Temperature.](/images/dashboard/_unpublished/swaig-prompt-config.webp)
</Frame>
...
<Frame caption="">
![A screenshot of the Post Prompt panel, including a text box, advanced config section, and Post Prompt Url text box.](/images/dashboard/_unpublished/swaig-post-prompt-advanced-config.webp)
</Frame>
...
<Frame caption="">
![A screenshot of the Add Language panel, with drop-down selectors for Language, Gender, and Voice.](/images/dashboard/_unpublished/swaig-language-settings.webp)
</Frame>
...
<Frame caption="">
![A screenshot of the Functions tab, showing text boxes labeled Default Web Hook URL, Default Web Hook Auth User, and Default Web Hook Auth Password.](/images/dashboard/_unpublished/swaig-default-url-function.webp)
</Frame>
...
<Frame caption="">
![A screenshot of the Edit page for the AI Agent, showing the Add Function button.](/images/dashboard/_unpublished/swaig-functions.webp)
</Frame>
...
<Frame caption="">
![A screenshot of the New Function menu.](/images/dashboard/_unpublished/swaig-function-settings.webp)
</Frame>
...
<Frame caption="">
![A screenshot of the Advanced Configuration section.](/images/dashboard/_unpublished/swaig-function-webhook-advanced.webp)
</Frame>
