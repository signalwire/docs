---
id: 30ba32c2-dd75-4e9d-a36f-b9e845c208d6
slug: /ai/get-started
title: Get started with AI on the SignalWire platform
position: 0
sidebar-title: Get started
subtitle: Deploy and test a no-code AI Agent in your SignalWire Space
...
![A new SignalWire AI Agent.](/assets/images/dashboard/resources/ai-agent/new-agent.webp) 
...
<Info title="What's a Resource?"><a href="/platform/basics/architecture/resources">Resources</a> are the building blocks of every SignalWire communication application. Resources include AI Agents, Subscribers, RELAY applications, FreeSWITCH connectors, and more.</Info>
  


<Frame>
  ![Resources selection.](/assets/images/dashboard/resources/add-new-resource.webp)
</Frame>
...
![The left drop-down menu for your SignalWire Space.](/assets/images/dashboard/left-menu/menu.webp)
...
<Frame>
  ![Add a new Address to your AI Agent.](/assets/images/dashboard/resources/ai-agent/addresses/add-address.webp)
</Frame>
...
<Card
    ...
    href="/platform/phone-numbers/getting-started/buying-a-phone-number"
    icon="solid phone"
>
