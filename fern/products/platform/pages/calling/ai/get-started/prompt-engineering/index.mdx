...
subtitle: Master the craft of writing effective prompts for SignalWire AI agents
...
[swml-docs]: /swml
[ai-agents-docs]: /platform/call-fabric/resources/ai-agents
[where-to-apply]: /ai/get-started/prompt-engineering/where-to-apply
[context-steps]: /ai/get-started/prompt-engineering/where-to-apply#context-steps
[swaig]: /ai/get-started/prompt-engineering/where-to-apply#swaig
[conscience]: /ai/get-started/prompt-engineering/where-to-apply#conscience
[post-prompt]: /ai/get-started/prompt-engineering/where-to-apply#post-prompt
...
[function calling](/swml/methods/ai/swaig),
...
[Prompts](/ai/get-started/prompt-engineering/where-to-apply) are used to design and configure an AI Agent. 
...
Now that you've got the basics down, you're ready to dive deeper into advanced prompt engineering techniques. Explore our guides on [best practices](/ai/get-started/prompt-engineering/best-practices), [where to apply prompts](/ai/get-started/prompt-engineering/where-to-apply), and [advanced techniques](/ai/get-started/prompt-engineering/advanced-techniques).
