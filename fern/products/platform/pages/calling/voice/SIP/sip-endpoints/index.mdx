---
id: aefb9969-31b8-4ec6-8c36-fa6d223f938c
...
like a RELAY Application, SWML Script, or even calling a video room to manage incoming requests.
...
You may choose RELAY, SWML, or a video room.
...
Explore what you can do with RELAY in our [RELAY Realtime SDK reference](pathname:///sdks/realtime-sdk).
  - If using a SWML Script, you will need to specify the path to your SWML script.
Find more information in our [SWML reference](/swml).
