...
- [**RELAY Browser Applications**](/browser-sdk/) - A JavaScript SDK for creating SignalWire applications in the browser utilizing SignalWires WebSocket APIs.
- Use the [`dial` method](/browser-sdk/reference/call-fabric/methods/dial) to dial a resource address that's linked to a SIP endpoint.
