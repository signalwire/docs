...
Alternatively, you can create the endpoint programmatically with an [API call](/docs/apis/rest/sip-credentials/create-sip-credential).
...
Manage your SIP Profile on your Dashboard or via [API](/docs/apis/rest/sip-profile/update-sip-profile).
...
[Purchase a Phone Number](/docs/apis/rest/phone-numbers/purchase-phone-number), and
[Update a Phone Number](/docs/apis/rest/phone-numbers/update-phone-number) endpoints.
...
If you want to explore SIP options that take advantage of SignalWire's services and features, check out our guide to [SIP Credentials](/docs/platform/voice/sip/sip-credentials).
