...
If you follow our [guide to creating a SIP endpoint in your SignalWire Space](/platform/voice), 
...
Alternatively, you can create the endpoint programmatically with an [API call](/apis/fabric/sip-endpoints/create-sip-endpoint).
...
[complete guide to your SIP Space](/platform/voice).

<Info>

Note that the endpoint URL depends on the SIP URI that you name in your SIP Profile. 
Manage your SIP Profile on your Dashboard or via [API](/apis/relay-rest/sip-profile/update-sip-profile).
...
See [Buying a Phone Number](/platform/phone-numbers) for step-by-step instructions on searching for and purchasing a number, then open its settings by clicking on your new number in your Dashboard's Phone Numbers Space.
...
If you prefer to use API calls, you will need the [Search for Available Phone Numbers](/apis/relay-rest/phone-numbers/search-available-phone-numbers),
[Purchase a Phone Number](/apis/relay-rest/phone-numbers/purchase-phone-number), and
[Update a Phone Number](/apis/relay-rest/phone-numbers/update-phone-number) endpoints.
...
If you want to explore SIP options that take advantage of SignalWire's services and features, check out our guide to [SIP Domain Applications](/platform/voice/sip/domain-applications).
