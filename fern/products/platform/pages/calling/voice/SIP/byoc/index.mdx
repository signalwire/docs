...
![A Call Flow that answers the call and plays a TTS message](/docs/assets/images/call-flow/nodes/handle_call.webp)
</Frame>
...
To create an outbound call using the Calling API with curl, you can use the [Create a Call endpoint](/docs/apis/calling/calls/call-commands) with the following format:
...
![A Call Flow that forwards a call to a SIP endpoint](/docs/assets/images/call-flow/nodes/forward-from-original-example.webp)
</Frame>
