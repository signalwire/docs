...
To learn more about what you can do with RELAY, have a look at our [SDK documentation](/docs/sdks).
...
The [RELAY SDK](/docs/sdks/reference/python/relay) makes dialing out to a SIP endpoint simple:
