...
<CardGroup cols={2}>
	<Card title="Inworld TTS 1.5 Mini" icon="regular bolt">
		`inworld-tts-1.5-mini` — the faster, lower-cost model, suited for high-volume, latency-sensitive applications.
	</Card>
	<Card title="Inworld TTS 1.5 Max" icon="regular wand-magic-sparkles">
		`inworld-tts-1.5-max` — the higher-quality model, suited for expressive, character-driven, and premium reads.
	</Card>
</CardGroup>
