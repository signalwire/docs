...
Pick `inworld-tts-1.5-mini` for speed and cost, or `inworld-tts-1.5-max` for the highest quality.
...
<CardGroup cols={2}>
	...
	<Card title="Inworld TTS 1.5 Max" icon="regular wand-magic-sparkles">
