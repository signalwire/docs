...
<VoiceWidget
  ...
  voiceIds={[
    "polly/Nicole",
    "azure/en-AU-AnnetteNeural",
    "cartesia/3264ada2-4a79-4666-badc-49e2267be692",
    "deepgram/aura-2-amalthea-en",
    "elevenlabs/NNl6r8mD7vthiJatiJt1",
    "gcloud/en-AU-News-E",
    "openai/alloy",
    "rime/abbie:mist",
    "inworld/Abby",
    "minimax/Spanish_Arnold",
    "playai-turbo/austin",
    "grok/ara",
  ]}
  filters={false}
...
Choose a provider to browse and audition its full voice catalog.

<VoiceWidget requireProvider={true} groupBy="none" />
