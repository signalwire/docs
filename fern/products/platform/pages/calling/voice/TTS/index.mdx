...
[polly]: /platform/voice/tts/amazon-polly
[azure]: /platform/voice/tts/azure
[cartesia]: /platform/voice/tts/cartesia
[deepgram]: /platform/voice/tts/deepgram
[elevenlabs]: /platform/voice/tts/elevenlabs
[gcloud]: /platform/voice/tts/gcloud
[openai]: /platform/voice/tts/openai
[rime]: /platform/voice/tts/rime
...
| :-------------- | :----------- | :---------------------------------------------- | ---------------------------------------------- |
| Amazon Polly    | `amazon`     | `amazon.Joanna-Neural`                          | [Reference](platform/voice/tts/amazon-polly#usage)     |
| Azure           | `azure`      | `en-US-AvaNeural`                               | [Reference](platform/voice/tts/azure#usage)            |
| Cartesia        | `cartesia`   | `cartesia.a167e0f3-df7e-4d52-a9c3-f949145efdab` | [Reference](platform/voice/tts/cartesia#usage)         |
| Deepgram        | `deepgram`   | `deepgram.aura-asteria-en`                      | [Reference](platform/voice/tts/deepgram#usage)         |
| ElevenLabs      | `elevenlabs` | `elevenlabs.thomas`                             | [Reference](platform/voice/tts/elevenlabs#usage)       |
| Google Cloud    | `gcloud`     | `gcloud.en-US-Casual-K`                         | [Reference](platform/voice/tts/gcloud#usage)           |
| OpenAI          | `openai`     | `openai.alloy`                                  | [Reference](platform/voice/tts/openai#usage)           |
| Rime            | `rime`       | `rime.luna:arcana`                              | [Reference](platform/voice/tts/rime#voices)            |
