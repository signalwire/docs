...
<Markdown src="/docs/snippets/common/dashboard/add-resource.mdx" />
...
<Frame caption="Assigning a phone number to the SWML Script">
    ![A purchased phone number showing assignment to a specified Resource.](/docs/assets/images/dashboard/phone-numbers/assign-resource-voice.webp)
</Frame>
