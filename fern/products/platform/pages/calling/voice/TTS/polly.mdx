...
```
Alternatively, use the [**`say_voice`** parameter](/docs/swml/reference/play#parameters) 
...
![The Call Flow Builder interface. A voice is selected in the drop-down menu.](/docs/assets/images/call-flow/tts/polly-cfb-voice.webp)
</Tab>
</Tabs>
