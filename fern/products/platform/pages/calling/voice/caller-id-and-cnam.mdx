...
![A screenshot of the New Sip Endpoint page, showing username, password, caller ID, and Send As fields](/docs/assets/images/dashboard/legacy/sip/new-endpoint.webp)
