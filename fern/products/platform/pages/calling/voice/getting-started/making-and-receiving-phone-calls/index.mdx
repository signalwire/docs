...
<TabItem value="newui" label="New Dashboard">
    ...
    <Frame>
    ![Attach Phone Number.](/images/dashboard/resources/new-cxml-bin.webp)
    </Frame>
    ...
    **Assign Resource** button for incoming calls, and select the newly created cXML script to connect.
    ...
    <Frame>
    ![Attach Resource.](/images/dashboard/phone-numbers/assign-resource-voice.webp)
    </Frame>
...
<TabItem value="legacyui" label="Legacy Dashboard">
    ...
    <Frame>
    ![Attach Phone Number.](/images/dashboard/legacy/attach-phone-number-vid.webp)
    </Frame>
