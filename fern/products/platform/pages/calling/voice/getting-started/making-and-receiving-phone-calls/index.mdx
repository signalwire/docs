...
sidebar-title: Making and receiving phone calls
...
<Tab title="New Dashboard">
    ...
    <Frame>
    ![Attach Phone Number.](/assets/images/dashboard/resources/new-cxml-bin.webp)
    </Frame>
    ...
    **Assign Resource** button for incoming calls, and select the newly created cXML script to connect.
    ...
    <Frame>
    ![Attach Resource.](/assets/images/dashboard/phone-numbers/assign-resource-voice.webp)
    </Frame>
...
<Tab title="Legacy Dashboard">
    ...
    <Frame>
    ![Attach Phone Number.](/assets/images/dashboard/legacy/attach-phone-number-vid.webp)
    </Frame>
