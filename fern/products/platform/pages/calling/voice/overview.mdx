...
<CardGroup cols={3}>
  ...
  <Card title="Make your first phone calls" icon="solid phone" href="/docs/swml/guides/recipes/making-and-receiving-calls">
...
<CardGroup cols={2}>
  ...
  <Card title="RELAY Browser SDK" icon="solid mobile-screen" href="/docs/browser-sdk/">
