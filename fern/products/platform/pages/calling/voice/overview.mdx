...
<CardGroup cols={2}>
  ...
  <Card title="Build an Interactive Voice Response (IVR) System" icon="solid code-branch" href="/server-sdk/node/guides/weather-phone-ivr">
...
Check out our guide on [Gathering Keypad Input with cXML](/cxml/guides/gathering-user-input) or build an [IVR with the Realtime SDK](/server-sdk/node/guides/weather-phone-ivr).
</Accordion>
...
Yes, call recording is possible through the [Realtime SDK](/server-sdk/node/reference/voice/call#voice_call_record_audio) or [SWML](/swml/reference/record-call). Check out our guide on [Recording Calls](/swml/guides/recipes/recording-calls).
</Accordion>
...
Yes, phishing and scam calls or calls to numbers that have been listed on a "Do Not Call" registry will be flagged as fraudulent. See our guide on [Fraud](/platform/basics/fraud) or the [SignalWire Cloud Agreement](https://signalwire.com/legal/signalwire-cloud-agreement) for more details.
</Accordion>
</AccordionGroup>
