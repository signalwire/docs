...
<CardGroup cols={3}>
  ...
  <Card title="Route and control calls" icon="regular phone" href="/docs/platform/voice/route-and-control-calls">
    Write a call flow that answers, listens, and branches on what the caller says
  </Card>
