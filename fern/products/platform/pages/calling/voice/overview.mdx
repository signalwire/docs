...
<CardGroup cols={2}>
  <Card title="SignalWire API" icon="solid rectangle-api" href="/docs/apis">
  ...
  <Card title="RELAY Realtime Server SDK" icon="regular server" href="/docs/server-sdk/node/reference/voice">
