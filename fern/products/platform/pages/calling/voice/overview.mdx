...
<CardGroup cols={3}>
  ...
  <Card title="Place an outbound call" icon="regular phone-arrow-up-right" href="/docs/platform/voice/make-and-receive-calls#make-an-outbound-call">
    Dial from your backend or the browser, and choose what runs when someone answers
  </Card>
  <Card title="Answer an inbound call" icon="regular phone-arrow-down-left" href="/docs/platform/voice/make-and-receive-calls#answer-an-inbound-call">
...
<CardGroup cols={2}>
  ...
  <Card title="Answer calls with SWML" icon="regular comments" href="/docs/platform/voice/make-and-receive-calls#create-your-call-handler">
