...
<CardGroup cols={3}>
  ...
  <Card title="Answer an inbound call" icon="regular phone-arrow-down-left" href="/docs/platform/voice/inbound-calling">
...
<CardGroup cols={2}>
  ...
  <Card title="Answer calls with SWML" icon="regular comments" href="/docs/platform/voice/inbound-calling#create-your-call-handler">
