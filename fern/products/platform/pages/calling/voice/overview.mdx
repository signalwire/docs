...
<CardGroup cols={3}>
  ...
  <Card title="Make your first phone calls" icon="solid phone" href="/voice/getting-started/making-and-receiving-phone-calls">
...
<CardGroup cols={2}>
  ...
  <Card title="RELAY Browser SDK" icon="solid mobile-screen" href="/sdks/browser-sdk/">
...
<CardGroup cols={2}>
  ...
  <Card title="Setting Up a SIP Endpoint" icon="solid phone-arrow-right" href="/voice/sip/get-started">
