...
<CardGroup cols={3}>
  ...
  <Card title="Stream call audio" icon="regular waveform-lines" href="/docs/platform/voice/call-streaming">
    Send live call audio to your WebSocket server, and send audio back
  </Card>
