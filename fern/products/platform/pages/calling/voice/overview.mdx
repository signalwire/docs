...
Yes, call recording is possible through the [Realtime SDK](/docs/server-sdks/reference/python/relay/call/record) or [SWML](/docs/swml/reference/calling/record-call). Check out our guide on [recording calls](/docs/platform/calling/record-calls).
</Accordion>
