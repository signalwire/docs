...
Yes, SignalWire has all the components to build a very powerful IVR! You could use [SWML](/docs/swml), the [RELAY SDK](/docs/compatibility-api/sdks), or even build a video/voice solution using our [Javascript SDKs](/docs/browser-sdk).
</Accordion>
...
Yes, call recording is possible through the [Realtime SDK](/docs/server-sdk/node/reference/voice/call#voice_call_record_audio) or [SWML](/docs/swml/reference/record-call). Check out our guide on [Recording Calls](/docs/swml/guides/record-calls).
</Accordion>
