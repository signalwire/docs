...
<CardGroup cols={3}>
  ...
  <Card title="Call routing" icon="regular phone" href="/docs/platform/voice/call-routing">
    Answer a call, collect what the caller says, and branch on it with SWML, Relay, or Call Flow Builder
  </Card>
