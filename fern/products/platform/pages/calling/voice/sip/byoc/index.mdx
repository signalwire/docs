...
![A Call Flow that answers the call and plays a TTS message](/images/call-flow/nodes/handle_call.webp)
</Frame>
...
![A Call Flow that forwards a call to a SIP endpoint](/images/call-flow/nodes/forward-from-original-example.webp)
</Frame>
