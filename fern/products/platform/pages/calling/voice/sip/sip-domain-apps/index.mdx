...
![Domain App page with the option to create a new Domain App](/images/dashboard/sip/sip-domain-apps.webp)
...
![Inbound call settings for SIP apps](/images/dashboard/sip/sip-domain-apps-config.webp)
...
![Apps tab under LaML sidebar](/images/dashboard/sip/laml-apps.webp)
