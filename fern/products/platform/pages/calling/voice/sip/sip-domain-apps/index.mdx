...
![Domain App page with the option to create a new Domain App](/assets/images/dashboard/sip/sip-domain-apps.webp)
...
Under the "Inbound Call Settings" section or the "Call Handler" section, pick "a LaML Webhook" and paste the Request URL of your cXML application.

<Frame caption="Inbound call settings for SIP apps">

![Inbound call settings for SIP apps](/assets/images/dashboard/sip/sip-domain-apps-config.webp)

</Frame>

The cXML bins do not support conditional or complex logic, but in the Domain Application settings, you can assign a backup webhook and a status change webhook. You can also set these fallback webhooks with a cXML Application discussed below.
...
<Frame caption="Apps tab under cXML/LaML sidebar">

![Apps tab under LaML sidebar](/assets/images/dashboard/sip/laml-apps.webp)
