...
image: "/images/call-flow/rime-preview.webp"
---
...
<CardGroup cols="2">
	<Card title="Mist v2" icon={<PiWaveformBold/>} 
...
<Frame caption="Assigning a phone number to the SWML Script">
    ![A purchased phone number showing assignment to a specified Resource.](/images/dashboard/phone-numbers/assign-resource-voice.webp)
</Frame>
