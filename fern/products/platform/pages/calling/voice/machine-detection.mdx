...
- For the inbound examples, a phone number in your Space that requests SWML from your server's
  URL or routes calls to your Relay client's topic. The [SWML deployment guide][swml-deployment]
  covers both setups.
...
3000 at that public HTTPS host; the [SWML deployment guide][swml-deployment] covers pointing your
