...
- For the inbound examples, a phone number in your Space whose calls reach your SWML server or
  Relay client. The [make and receive calls guide][make-and-receive-calls] sets up both.
...
start with the [make and receive calls guide][make-and-receive-calls].
...
pointing your number at the URL, and [webhook security][swml-webhook-security] covers verifying
