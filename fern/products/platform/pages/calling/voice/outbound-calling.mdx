...
The [Server SDK][server-sdks] supports both APIs. The [Browser SDK][browser-sdk] uses the real-time
API for calls from a web page.
...
Start with an example to [call from your server](#place-a-call-from-a-server),
[call from your web app](#place-a-call-with-the-browser-sdk), or
[run an AI agent](#run-an-ai-agent). The next section explains how to track the call's progress.
