...
SWML isn't a fourth column because it doesn't place calls. It's the script a call runs once it
connects, so you place the call with REST or Relay and hand it SWML, as every REST example on this
page does with the `swml` field.
