...
To receive status webhooks, see [Track the call's progress](#track-the-calls-progress).
...
[`ai` method][swml-ai] and the Relay `ai` references for
[Python](/docs/server-sdks/reference/python/relay/call/ai) and
[TypeScript](/docs/server-sdks/reference/typescript/relay/call/ai) cover every parameter.
