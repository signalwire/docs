...
- If calling from a Web Client, a [Subscriber Access Token][subscriber-token] for a known subscriber
  or a restricted [guest token][guest-token], minted by your server using your project API credentials
  and then supplied to the Browser SDK client.
