...
Subscribers, applications such as AI agents,
...
swml = (
    ...
    .say("Hi, this is Bayview Taxi. Your driver is on the way and will arrive in about five minutes.")
    .build()
)
...
<SchemaSnippet type="Calling.CallResponse" title="Call response" />
...
swml = (
    ...
    .ai(
        prompt_text="You are calling to tell the rider their driver is about five minutes away. Answer questions using that estimate. You cannot change bookings or contact preferences. If asked, explain that the rider needs to contact Bayview Taxi to make those changes. Do not claim to have made a change.",
        params={
            "static_greeting": "Hello, this is an automated assistant calling from Bayview Taxi about your pickup. This call uses an artificial voice.",
            "static_greeting_no_barge": True,
        },
...
const swml = new SwmlBuilder()
  .ai({
    prompt: "You are calling to tell the rider their driver is about five minutes away. Answer questions using that estimate. You cannot change bookings or contact preferences. If asked, explain that the rider needs to contact Bayview Taxi to make those changes. Do not claim to have made a change.",
    params: {
      static_greeting: "Hello, this is an automated assistant calling from Bayview Taxi about your pickup. This call uses an artificial voice.",
      static_greeting_no_barge: true,
    },
...
swml = (
    ...
    .switch(
        ...
        default=[{
            "play": {
                "url": "say:Hi, this is Bayview Taxi. Your driver will arrive in about five minutes."
            }
        }],
    )
    .hangup()
...
Play pickup details privately to `<YOUR_DRIVER_DESTINATION>`, then connect that call to
`<YOUR_DESTINATION>`.
...
swml = (
    ...
    .say("Bayview Taxi here. Connecting you to your driver now.")
    .connect(**{
        "from": "<YOUR_CALLER_ID>",
        "to": "<YOUR_DRIVER_DESTINATION>",
    ...
    async with client:
        ...
        call = await client.dial(
            devices=[[{
                ...
                "params": {
                    "from_number": "<YOUR_CALLER_ID>",
                    "to_number": "<YOUR_DRIVER_DESTINATION>",
                    "timeout": 30,
                },
            }]],
        )
