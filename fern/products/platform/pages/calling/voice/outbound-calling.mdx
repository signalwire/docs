...
| Application or room | Resource address, such as `/public/dispatch-agent` | An AI agent, SWML application, or room in your Space. |
| Subscriber | Resource address, such as `/private/dispatcher` | A registered user in your Space. |

Applications, rooms, and Subscribers are [Resources][resources]. Dial their configured
[resource address][resource-addresses], including the `public` or `private` context, to reach them
directly.
