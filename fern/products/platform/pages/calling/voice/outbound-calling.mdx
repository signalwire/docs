...
| A SIP endpoint | An E.164 number, a SIP URI, or a short token of up to 11 letters, digits, or underscores |
| A Resource | Not checked — any value is accepted, though a number in your project is still the safe choice |
