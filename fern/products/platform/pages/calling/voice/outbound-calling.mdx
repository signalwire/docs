...
or `private`. The Relay Server SDK supports phone numbers and SIP endpoints, but not resource
addresses.
...
For your first call, open the **REST** tab and run the **cURL — Calling API** request.
