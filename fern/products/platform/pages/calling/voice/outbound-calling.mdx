...
<Tab title="TypeScript — REST client">
```typescript
...
<Tab title="API snippet (comparison)">

This generated snippet is included for comparison. It currently adds an example `url` alongside
the inline `swml`; use the manual samples for this walkthrough.

<EndpointRequestSnippet
  endpoint="POST /api/calling/calls"
  example="Outbound announcement"
/>
</Tab>
</Tabs>
