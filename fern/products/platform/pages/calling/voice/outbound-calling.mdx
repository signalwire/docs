...
For an AI conversation, host the following SWML and replace `swml` in the
[REST example](#place-a-call-with-rest) with the document's `url`.
The [`ai` method][swml-ai] supplies the agent's greeting and instructions:
