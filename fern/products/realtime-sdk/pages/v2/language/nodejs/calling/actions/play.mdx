---
id: 1292b975-03fd-4cad-b5a7-c7d98f9c3ff8
title: Relay.Calling.PlayAction
slug: nodejs/reference/calling/actions/play
description: The Play Action is used to play audio files on a call.
max-toc-depth: 3
---

[relay-calling-playpauseresult]: /realtime-sdk/v2/language/nodejs/calling/results/play-pause-result
[relay-calling-playresult]: /realtime-sdk/v2/language/nodejs/calling/results/play-result
[relay-calling-playresumeresult]: /realtime-sdk/v2/language/nodejs/calling/results/play-resume-result
[relay-calling-playvolumeresult]: /realtime-sdk/v2/language/nodejs/calling/results/play-volume-result
[relay-calling-stopresult]: /realtime-sdk/v2/language/nodejs/calling/results/stop-result
