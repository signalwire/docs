...
[link-9]: #events
[link]: #state-events
[relay-calling-answerresult]: /docs/server-sdk/v2/python/reference/calling/results/answer-result
[relay-calling-connectaction]: /docs/server-sdk/v2/python/reference/calling/actions/connect
[relay-calling-connectresult]: /docs/server-sdk/v2/python/reference/calling/results/connect-result
[relay-calling-detectaction]: /docs/server-sdk/v2/python/reference/calling/actions/detect
[relay-calling-detectresult]: /docs/server-sdk/v2/python/reference/calling/results/detect-result
[relay-calling-dialresult]: /docs/server-sdk/v2/python/reference/calling/results/dial-result
[relay-calling-faxaction]: /docs/server-sdk/v2/python/reference/calling/actions/fax
[relay-calling-faxresult]: /docs/server-sdk/v2/python/reference/calling/results/fax-result
[relay-calling-hangupresult]: /docs/server-sdk/v2/python/reference/calling/results/hangup-result
[relay-calling-playaction]: /docs/server-sdk/v2/python/reference/calling/actions/play
[relay-calling-playpauseresult]: /docs/server-sdk/v2/python/reference/calling/results/play-pause-result
[relay-calling-playresult]: /docs/server-sdk/v2/python/reference/calling/results/play-result
[relay-calling-playresumeresult]: /docs/server-sdk/v2/python/reference/calling/results/play-resume-result
[relay-calling-playvolumeresult]: /docs/server-sdk/v2/python/reference/calling/results/play-volume-result
[relay-calling-promptaction]: /docs/server-sdk/v2/python/reference/calling/actions/prompt
[relay-calling-promptresult]: /docs/server-sdk/v2/python/reference/calling/results/prompt-result
[relay-calling-promptvolumeresult]: /docs/server-sdk/v2/python/reference/calling/results/prompt-volume-result
[relay-calling-recordaction]: /docs/server-sdk/v2/python/reference/calling/actions/record
[relay-calling-recordresult]: /docs/server-sdk/v2/python/reference/calling/results/record-result
[relay-calling-senddigitsaction]: /docs/server-sdk/v2/python/reference/calling/actions/send-digits
[relay-calling-senddigitsresult]: /docs/server-sdk/v2/python/reference/calling/results/send-digits-result
[relay-calling-stopresult]: /docs/server-sdk/v2/python/reference/calling/results/stop-result
[relay-calling-tapaction]: /docs/server-sdk/v2/python/reference/calling/actions/tap
[relay-calling-tapresult]: /docs/server-sdk/v2/python/reference/calling/results/tap-result
