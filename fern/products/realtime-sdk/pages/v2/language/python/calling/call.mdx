...
slug: reference/python/calling/call
max-toc-depth: 3
---

[relay-calling-answerresult]: /realtime-sdk/v2/language/python/calling/results/answer-result
[relay-calling-connectaction]: /realtime-sdk/v2/language/python/calling/actions/connect
[relay-calling-connectresult]: /realtime-sdk/v2/language/python/calling/results/connect-result
[relay-calling-detectaction]: /realtime-sdk/v2/language/python/calling/actions/detect
[relay-calling-detectresult]: /realtime-sdk/v2/language/python/calling/results/detect-result
[relay-calling-dialresult]: /realtime-sdk/v2/language/python/calling/results/dial-result
[relay-calling-faxaction]: /realtime-sdk/v2/language/python/calling/actions/fax
[relay-calling-faxresult]: /realtime-sdk/v2/language/python/calling/results/fax-result
[relay-calling-hangupresult]: /realtime-sdk/v2/language/python/calling/results/hangup-result
[relay-calling-playaction]: /realtime-sdk/v2/language/python/calling/actions/play
[relay-calling-playresult]: /realtime-sdk/v2/language/python/calling/results/play-result
[relay-calling-playpauseresult]: /realtime-sdk/v2/language/python/calling/results/play-pause-result
[relay-calling-playresumeresult]: /realtime-sdk/v2/language/python/calling/results/play-resume-result
[relay-calling-playvolumeresult]: /realtime-sdk/v2/language/python/calling/results/play-volume-result
[relay-calling-promptaction]: /realtime-sdk/v2/language/python/calling/actions/prompt
[relay-calling-promptresult]: /realtime-sdk/v2/language/python/calling/results/prompt-result
[relay-calling-promptvolumeresult]: /realtime-sdk/v2/language/python/calling/results/prompt-volume-result
[relay-calling-recordaction]: /realtime-sdk/v2/language/python/calling/actions/record
[relay-calling-recordresult]: /realtime-sdk/v2/language/python/calling/results/record-result
[relay-calling-senddigitsaction]: /realtime-sdk/v2/language/python/calling/actions/send-digits
[relay-calling-senddigitsresult]: /realtime-sdk/v2/language/python/calling/results/send-digits-result
[relay-calling-stopresult]: /realtime-sdk/v2/language/python/calling/results/stop-result
[relay-calling-tapaction]: /realtime-sdk/v2/language/python/calling/actions/tap
[relay-calling-tapresult]: /realtime-sdk/v2/language/python/calling/results/tap-result
