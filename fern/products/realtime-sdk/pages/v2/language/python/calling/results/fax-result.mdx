---
id: 3499f069-4454-4c1e-a1a9-f92c94972ab4
title: "Relay.Calling.FaxResult"
slug: reference/python/calling/results/fax
description: The result object that is returned when sending or receiving a fax.
max-toc-depth: 3
---

[fax-receive]: /realtime-sdk/v2/language/python/calling/call#fax_receive
[fax-send]: /realtime-sdk/v2/language/python/calling/call#fax_send
