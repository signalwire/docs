---
id: 944b317d-ea5b-4e1e-ab81-ec40d6679b92
title: Task API
slug: reference/dotnet/task
max-toc-depth: 3
---
...
| `message` | JObject | <span class="required-arg">required</span> | The message to deliver. |
...
| Parameter | Type | Required | Description |
| --------- | ---- | -------- | ----------- |
| `host` | string | <span class="required-arg">required</span> | The host to post the message to. |
| `project` | string | <span class="required-arg">required</span> | The SignalWire project ID. |
| `token` | string | <span class="required-arg">required</span> | The authentication token. |
| `context` | string | <span class="required-arg">required</span> | The context to receive inbound events. |
| `message` | JObject | <span class="required-arg">required</span> | The message to send. |
