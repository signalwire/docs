...
| --------- | ---- | -------- | ----------- |
| `T` | Type | <span class="required-arg">required</span> | This is the data type for the conversion, see [`SignalWire.Relay.Calling.CallDetect.DetectType`][call-detect-detect-type] for more information. |
