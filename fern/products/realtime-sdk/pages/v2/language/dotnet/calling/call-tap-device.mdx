---
id: 8e13429e-e4d6-4970-ae5c-4de95c7faf4b
title: "CallTapDevice"
slug: reference/dotnet/calling/call-tap-device
max-toc-depth: 3
---
...
| --------- | ---- | -------- | ----------- |
| `T` | Type | <span class="required-arg">required</span> | This is the data type for the conversion, see [`SignalWire.Relay.Calling.CallMedia.MediaType`] for more information. |
