---
id: 143f7dd4-83f3-4f1a-8554-7fdf72a0f2cd
title: "CallTap"
slug: reference/dotnet/calling/call-tap
max-toc-depth: 3
---
...
| --------- | ---- | -------- | ----------- |
| `T` | Type | <span class="required-arg">required</span> | This is the data type for the conversion, see [`SignalWire.Relay.Calling.CallTap.TapType`] for more information. |
