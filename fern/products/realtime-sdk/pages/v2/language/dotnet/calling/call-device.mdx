---
id: f5fa93b9-9956-4b2f-a51a-0f0aae80073a
title: "CallDevice"
slug: reference/dotnet/calling/call-device
max-toc-depth: 3
---
...
| --------- | ---- | -------- | ----------- |
| `T` | Type | <span class="required-arg">required</span> | This is the data type for the conversion, see [`SignalWire.Relay.Calling.CallDevice.DeviceType`] for more information. |
