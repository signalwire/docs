...
| --------- | ---- | -------- | ----------- |
| `T` | Type | <span class="required-arg">required</span> | This is the data type for the conversion, see [`SignalWire.Relay.Calling.CallRingback.RingbackType`][call-ringback-ringback-type] for more information. |
