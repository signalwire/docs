...
[relay-messaging-message]: /docs/server-sdk/v2/go/reference/messaging/message
[relay-messaging-sendresult]: /docs/server-sdk/v2/go/reference/messaging/send-result
