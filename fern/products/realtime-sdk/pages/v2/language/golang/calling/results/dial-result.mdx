---
id: edffd3a9-adbe-499d-bdc4-e1417a8599f2
title: Relay.Calling.DialResult
slug: reference/go/calling/results/dial
description: The result object that is returned when dialing a call.
max-toc-depth: 3
---

[link-1]: /realtime-sdk/v2/language/golang/calling/call#dial
[link]: /realtime-sdk/v2/language/golang/calling#dial
