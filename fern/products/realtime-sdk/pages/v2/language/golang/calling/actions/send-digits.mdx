---
id: 1be8855f-1e87-4aea-a7de-f99a08263c6f
title: Relay.Calling.SendDigitsAction
slug: reference/go/calling/actions/send-digits
description: The Send Digits Action is used to send DTMF digits on a call.
max-toc-depth: 3
---

[link-1]: /realtime-sdk/v2/language/golang/calling/results/send-digits-result
[link]: /realtime-sdk/v2/language/golang/calling/call#senddigitsasync
