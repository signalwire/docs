...
[link-2]: /docs/server-sdk/v2/go/reference/calling/results/fax-result
[link]: /docs/server-sdk/v2/go/reference/calling/call#receivefaxasync
[receivefaxasync]: /docs/server-sdk/v2/go/reference/calling/call#receivefaxasync
[relay-calling-faxresult]: /docs/server-sdk/v2/go/reference/calling/results/fax-result
[sendfaxasync]: /docs/server-sdk/v2/go/reference/calling/call#sendfaxasync
