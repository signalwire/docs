...
[relay-calling-answerresult]: /docs/server-sdk/v2/go/reference/calling/results/answer-result
[relay-calling-detectaction]: /docs/server-sdk/v2/go/reference/calling/actions/detect
[relay-calling-detectresult]: /docs/server-sdk/v2/go/reference/calling/results/detect-result
[relay-calling-dialresult]: /docs/server-sdk/v2/go/reference/calling/results/dial-result
[relay-calling-faxaction]: /docs/server-sdk/v2/go/reference/calling/actions/fax
[relay-calling-faxresult]: /docs/server-sdk/v2/go/reference/calling/results/fax-result
[relay-calling-hangupresult]: /docs/server-sdk/v2/go/reference/calling/results/hangup-result
[relay-calling-playaction]: /docs/server-sdk/v2/go/reference/calling/actions/play
[relay-calling-playresult]: /docs/server-sdk/v2/go/reference/calling/results/play-result
[relay-calling-promptaction]: /docs/server-sdk/v2/go/reference/calling/actions/prompt
[relay-calling-promptresult]: /docs/server-sdk/v2/go/reference/calling/results/prompt-result
[relay-calling-recordaction]: /docs/server-sdk/v2/go/reference/calling/actions/record
[relay-calling-recordresult]: /docs/server-sdk/v2/go/reference/calling/results/record-result
[relay-calling-senddigitsaction]: /docs/server-sdk/v2/go/reference/calling/actions/send-digits
[relay-calling-senddigitsresult]: /docs/server-sdk/v2/go/reference/calling/results/send-digits-result
[relay-calling-tapaction]: /docs/server-sdk/v2/go/reference/calling/actions/tap
[relay-calling-tapresult]: /docs/server-sdk/v2/go/reference/calling/results/tap-result
