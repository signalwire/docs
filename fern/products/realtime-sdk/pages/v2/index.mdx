...
description: RELAY Realtime SDK v2 for Node.js, Python, PHP, Ruby, Go, and .NET. Build voice and messaging applications. Deprecated - upgrade to v4 for the latest features.
max-toc-depth: 3
---
