...
[call]: /docs/server-sdk/v3/node/reference/voice/call
[client]: /docs/server-sdk/v3/node/reference/voice/client
[devicebuilder]: /docs/server-sdk/v3/node/reference/voice/device-builder
[playlist]: /docs/server-sdk/v3/node/reference/voice/playlist
