...
Your `project` ID and `token` are available in the [SignalWire Dashboard](/platform/dashboard/getting-started/your-signalwire-api-space). These authenticate your WebSocket connection and establish your access permissions.
...
<CardGroup cols={3}>
  ...
  <Card
    title="Messaging"
    href="/realtime-sdk/v3/messaging"
