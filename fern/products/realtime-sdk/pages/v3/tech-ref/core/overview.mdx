...
<Warning>
The [RELAY v4](/server-sdk) is the most up-to-date version of the Realtime RELAY SDK.
Consider reading the [Upgrading to RELAY v4](/server-sdk/v3/node/guides/realtime-relay-v4-vs-v3) page to understand the benefits of
[RELAY v4](/server-sdk) and how to upgrade.
</Warning>
...
<CardGroup cols={2}>
  <Card title="RealtimeClient" href="/server-sdk/v3/node/reference/realtime-client">
...
- `Const` **createClient**(`userOptions`): `Promise<RealtimeClient>` - **Deprecated** — See [RealtimeClient](/server-sdk/v3/node/reference/realtime-client) for more details.

> **Deprecated**
> You no longer need to create the client manually. You can use the product constructors, like [Video.Client](/server-sdk/v3/node/reference/video-room-session), to access the same functionality.
...
`Promise<RealtimeClient>` - **Deprecated** — See [RealtimeClient](/server-sdk/v3/node/reference/realtime-client) for more details.
