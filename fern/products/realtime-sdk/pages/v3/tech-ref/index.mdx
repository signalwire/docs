...
- `Const` **createClient**(`userOptions`): `Promise<RealtimeClient>` ⚠️ **Deprecated** — See [RealtimeClient](/realtime-sdk/v3/realtime-client) for more details.
...
`Promise<RealtimeClient>` ⚠️ **Deprecated** — See [RealtimeClient](/realtime-sdk/v3/realtime-client) for more details.
