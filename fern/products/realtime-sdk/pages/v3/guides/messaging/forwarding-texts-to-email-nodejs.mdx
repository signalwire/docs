...
![RELAY Application resource selector with cXML highlighted.](/images/dashboard/resources/add-new-relay-application.webp)
...
![Assign Resource.](/images/dashboard/phone-numbers/assign-resource-full.webp)
...
![legacy UI RELAY application configuration.](/images/dashboard/legacy/number-message-config-relay.webp)
