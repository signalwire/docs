---
id: b9ff9d38-6a88-4041-a836-0c29772995d8
title: Forwarding Texts to Email
slug: guides/messaging/forwarding-texts-to-email-nodejs
max-toc-depth: 3
x-custom:
...
[relay-realtime-sdk-1]: /realtime-sdk/
...
![RELAY Application resource selector with cXML highlighted.](/assets/images/dashboard/resources/add-new-relay-application.webp)

When configuring the RELAY Application, set the context to "office" (to match what we have in the code).

<Markdown src="/snippets/dashboard/ui-accordion.mdx" />
...
![Assign Resource.](/assets/images/dashboard/phone-numbers/assign-resource-full.webp)
...
![legacy UI RELAY application configuration.](/assets/images/dashboard/legacy/number-message-config-relay.webp)

</Accordion>

<Info title="Note on Email Delivery Service">
