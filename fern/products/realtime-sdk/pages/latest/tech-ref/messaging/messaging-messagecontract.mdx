---
id: 54563035-b295-479d-89eb-c03edf74fca1
title: "MessageContract"
keywords: SignalWire, Realtime SDK, Node.js, message object, message format
slug: /node/reference/messaging/message-contract
sidebar-title: MessageContract
...
<ParamField path="body" type="string" required toc={true}>
  Body of the message.
</ParamField>

<ParamField path="context" type="string" required toc={true}>
  The topic the message-object is associated with. Topic was previously called `context`.
</ParamField>

<ParamField path="direction" type="string" required toc={true}>
...
<ParamField path="segments" type="number" required toc={true}>
  Number of segments of the message.
</ParamField>

<ParamField path="state" type="MessagingMessageState" required toc={true}>
  The current state of the message. See [`MessagingMessageState`][link].
</ParamField>

<ParamField path="tags" type="string[]" required toc={true}>
