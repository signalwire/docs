...
<ParamField path="params.keys" type="string[]" required>
  The keys to remove.
</ParamField>
</Indent>
...
<Indent>
<ParamField path="params.memberId" type="string" required>
  ID of the member to affect.
</ParamField>
...
<Indent>
<ParamField path="params.topics" type="object[]">
  List of topics to listen to.
</ParamField>

<ParamField path="params.EVENT" type="Callback" required>
...
<ParamField path="params.value" type="number" required default="30">
...
<ParamField path="params.volume" type="number" required default="0">
...
<Indent>
<ParamField path="params.positions" type="VideoPositions" required>
...
<Indent>
<ParamField path="params.room_session_id" type="string" required>
  ID of the room session.
</ParamField>

<ParamField path="params.room_id" type="string" required>
  ID of the room.
</ParamField>

<ParamField path="params.total" type="number" required>
...
<ParamField path="params.layout" type="string" required>
