...
<ParamField path="roomSession" type="RoomSession" required toc={true}>
...
<Indent>
<ParamField path="room_session_id" type="string" required toc={true}>
  ID of the room session.
</ParamField>

<ParamField path="room_id" type="string" required toc={true}>
  ID of the room.
</ParamField>

<ParamField path="total" type="number" required toc={true}>
...
<ParamField path="member" type="RoomSessionMember" required toc={true}>
...
<ParamField path="recording" type="RoomSessionRecording" required toc={true}>
...
<ParamField path="stream" type="RoomSessionStream" required toc={true}>
...
<ParamField path="auto" type="string" toc={true}>
  The position of the member in the layout is determined automatically.
</ParamField>

<ParamField path="reserved-positionNumber" type="string" toc={true}>
  The reserved position in the layout (e.g. `reserved-3`).
</ParamField>

<ParamField path="standard-positionNumber" type="string" toc={true}>
  The standard position in the layout (e.g. `standard-3`).
</ParamField>

<ParamField path="off-canvas" type="string" toc={true}>
