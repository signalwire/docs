...
- **getMembers**(): `Promise`\<\{ `members:` [`RoomSessionMember[]`](/server-sdk/node/reference/video/room-session-member) }>

Returns a list of members currently in the room.

#### Returns

`Promise`\<\{ `members:` [`RoomSessionMemberEntity[]`](/server-sdk/node/reference/video/room-session-member) }>
