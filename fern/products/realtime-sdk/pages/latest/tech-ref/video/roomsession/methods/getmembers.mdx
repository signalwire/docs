...
[roomsessionmembers]: /docs/server-sdk/v4/node/reference/video/room-session-member

### getMembers

- **getMembers**(): `Promise`\<\{ `members:` [`RoomSessionMember[]`](/docs/server-sdk/v4/node/reference/video/room-session-member) }>

Returns a list of members currently in the room.

#### Returns

`Promise`\<\{ `members:` [`RoomSessionMemberEntity[]`](/docs/server-sdk/v4/node/reference/video/room-session-member) }>
