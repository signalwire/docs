...
- **getMembers**(): `Promise`\<\{ `members:` [`RoomSessionMember[]`](/realtime-sdk/node/reference/video/room-session-member) }>

Returns a list of members currently in the room.

#### Returns

`Promise`\<\{ `members:` [`RoomSessionMemberEntity[]`](/realtime-sdk/node/reference/video/room-session-member) }>
