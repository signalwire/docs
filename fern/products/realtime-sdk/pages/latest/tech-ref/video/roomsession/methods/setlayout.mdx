...
[link-4]: /docs/server-sdk/v4/node/reference/video/room-session/events#videopositions
[roomsession-41]: /docs/server-sdk/v4/node/reference/video/room-session
[video-roomsession-4]: /docs/server-sdk/v4/node/reference/video/room-session/get-layouts
...
<ParamField path="positions" type="VideoPositions" toc={true}>
