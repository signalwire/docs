...
<CardGroup cols={2}>
  <Card title="Voice" icon="fa-solid fa-phone" href="/docs/realtime-sdk/node/reference/voice/client">
    Make and receive phone calls, play audio, gather input, and build IVR systems.
  </Card>
  <Card title="Video" icon="fa-solid fa-video" href="/docs/realtime-sdk/node/reference/video/client">
    Monitor video rooms, track participants, and manage recordings.
  </Card>
  <Card title="Chat" icon="fa-solid fa-comments" href="/docs/realtime-sdk/node/reference/chat/client">
    Real-time chat messaging between users across channels.
  </Card>
  <Card title="Task" icon="fa-solid fa-list-check" href="/docs/realtime-sdk/node/reference/task/client">
    Distribute tasks to workers for server-side processing.
  </Card>
  <Card title="PubSub" icon="fa-solid fa-tower-broadcast" href="/docs/realtime-sdk/node/reference/pubsub/client">
