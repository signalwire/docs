...
<ParamField path="options" type="object" required toc={true}>
  Configuration options for the client.
</ParamField>

<Indent>
<ParamField path="project" type="string" required toc={true}>
  SignalWire project id, e.g. `a10d8a9f-2166-4e82-56ff-118bc3a4840f`
</ParamField>

<ParamField path="token" type="string" required toc={true}>
...
<ParamField path="debug" type="object" toc={true}>
  Debug configuration object.
</ParamField>

<Indent>
<ParamField path="logWsTraffic" type="boolean" default="false" toc={true}>
...
<CardGroup cols={2}>
  <Card title="Voice" icon="fa-regular fa-phone" href="/docs/server-sdk/v4/node/reference/voice/client">
    Make and receive phone calls, play audio, gather input, and build IVR systems.
  </Card>
  <Card title="Video" icon="fa-regular fa-video" href="/docs/server-sdk/v4/node/reference/video/client">
    Monitor video rooms, track participants, and manage recordings.
  </Card>
  <Card title="Chat" icon="fa-regular fa-comments" href="/docs/server-sdk/v4/node/reference/chat/client">
    Real-time chat messaging between users across channels.
  </Card>
  <Card title="Task" icon="fa-regular fa-list-check" href="/docs/server-sdk/v4/node/reference/task/client">
    Distribute tasks to workers for server-side processing.
  </Card>
  <Card title="PubSub" icon="fa-regular fa-tower-broadcast" href="/docs/server-sdk/v4/node/reference/pubsub/client">
