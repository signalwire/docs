...
title: "Playlist"
keywords: SignalWire, Realtime SDK, Node.js, audio playlist, media queue, play multiple audio
...
[link]: #add
[types]: /docs/server-sdk/v4/node/reference/voice/types#ringtonename
[voice-and-languages]: /docs/platform/voice/tts
[voice-call]: /docs/server-sdk/v4/node/reference/voice/call/play
[voice-playlist]: /docs/server-sdk/v4/node/reference/voice/playlist
...
<ParamField path="media" type="NestedArray<Object toc={true}>" toc={true}>
...
<ParamField path="gender" type='"female" | "male"' default='"female"' toc={true}>
  Gender of the voice.
</ParamField>
