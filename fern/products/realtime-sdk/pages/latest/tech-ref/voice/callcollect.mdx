...
slug: reference/voice/callcollect
...
<Indent>
<ParamField path="params.digits" type="string">
  The digits that have been collected.
</ParamField>

<ParamField path="params.terminator" type="string">
...
<Indent>
<ParamField path="params.text" type="string">
  The text that has been collected.
</ParamField>

<ParamField path="params.confidence" type="number">
