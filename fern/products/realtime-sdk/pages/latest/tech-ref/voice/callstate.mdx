...
[connectPhone]: /docs/server-sdk/node/reference/voice/call#connectphone
[connectSip]: /docs/server-sdk/node/reference/voice/call#connectsip
[dial]: /docs/server-sdk/node/reference/voice/client#dial
[dialPhone]: /docs/server-sdk/node/reference/voice/client#dialphone
[dialSip]: /docs/server-sdk/node/reference/voice/client#dialsip
...
<Tip>
For real-time call state changes within your SDK application without webhooks, use the [`onStateChanged`](/docs/server-sdk/node/reference/voice/call#onstatechanged) event on the Call object instead.
</Tip>
