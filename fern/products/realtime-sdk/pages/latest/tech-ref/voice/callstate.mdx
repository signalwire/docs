...
slug: reference/voice/callstate
...
<Indent>
<ParamField path="params.node_id" type="string" required>
  ID for the node this call is on.
</ParamField>

<ParamField path="params.call_id" type="string" required>
  ID for the call.
</ParamField>
...
<ParamField path="params.call_state" type="string" required>
...
<ParamField path="params.answer_time" type="number">
...
<ParamField path="params.created_by" type="string">
