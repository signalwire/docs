...
<Tip>
For real-time call state changes within your SDK application without webhooks, use the [`onStateChanged`](/server-sdk/node/reference/voice/call#onstatechanged) event on the Call object instead.
</Tip>
