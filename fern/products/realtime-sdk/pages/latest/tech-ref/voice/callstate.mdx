...
<Tip>
For real-time call state changes within your SDK application without webhooks, use the [`onStateChanged`](/docs/server-sdk/v4/node/reference/voice/call#onstatechanged) event on the Call object instead.
</Tip>
