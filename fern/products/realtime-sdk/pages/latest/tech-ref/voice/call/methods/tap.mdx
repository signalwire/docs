...
[calltap-events]: /docs/server-sdk/v4/node/reference/voice/call-tap#events
...
<Info>
See [`tapAudio`][tapaudio] for a more specific method.
</Info>
...
<Indent>
<ParamField path="device" type="TapDevice" required toc={true}>
...
<Indent>
<ParamField path="direction" type='"listen" | "speak" | "both"' required toc={true}>
...
<ParamField path="listen" type="object" toc={true}>
  Callback to listen for events. List of tap events can be found [here][calltap-events]. Example event: [`onStarted`][calltap-onstarted].
</ParamField>
</Indent>
