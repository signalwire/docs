...
<Info>
See [`amd`][amd], [`detectAnsweringMachine`][detectansweringmachine], [`detectFax`][detectfax], and [`detectDigit`][detectdigit] for more specific methods.
</Info>
...
<Indent>
<ParamField path="type" type='"fax" | "machine" | "digit" | "beep"' required toc={true}>
