...
[callcollect-events]: /docs/server-sdk/v4/node/reference/voice/call-collect#events
[callcollect-onstarted]: /docs/server-sdk/v4/node/reference/voice/call-collect#onstarted
[callcollect]: /docs/server-sdk/v4/node/reference/voice/call-collect
[startinputtimers]: /docs/server-sdk/v4/node/reference/voice/call-collect#startinputtimers
...
[startinput]: /docs/server-sdk/v4/node/reference/voice/call/events#voice_call_oncollectinputstarted
...
<ParamField path="continuous" type="boolean" default="false" toc={true}>
  Detect utterances and digits until stopped.
</ParamField>

<ParamField path="initialTimeout" type="number" default="4" toc={true}>
  Number of seconds to wait for initial input before giving up. Will be used only when `startInputTimers` is true or when the timer is started manually via the [`startInputTimers`][startinputtimers] method.
</ParamField>

<ParamField path="partialResults" type="boolean" default="false" toc={true}>
  If true, partial result events are fired.
</ParamField>

<ParamField path="sendStartOfInput" type="boolean" default="false" toc={true}>
  If true, the [`startOfInput`][startinput] event is fired when input is detected.
</ParamField>

<ParamField path="startInputTimers" type="boolean" default="false" toc={true}>
