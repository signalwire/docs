...
[voice-client]: /docs/server-sdk/v4/node/reference/voice/client
...
<ParamField path="device" type="any" toc={true}>
...
<ParamField path="headers" type="SipHeader[]" optional toc={true}>
...
<ParamField path="state" type='"created" | "ringing" | "answered" | "ending" | "ended"' toc={true}>
...
<ParamField path="type" type='"phone" | "sip"' toc={true}>
