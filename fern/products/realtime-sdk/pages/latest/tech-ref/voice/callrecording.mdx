...
title: "CallRecording"
keywords: SignalWire, Realtime SDK, Node.js, call recording, record call, audio recording
...
<ParamField path="state" type='"recording" | "paused" | "finished" | "no_input"' toc={true}>
...
<ParamField path="size" type="number | undefined" toc={true}>
  The size of the recording file in bytes. Available after the recording has ended.
</ParamField>

<ParamField path="duration" type="number | undefined" toc={true}>
...
<ParamField path="behavior" type='"skip" | "silence"' default='"silence"' toc={true}>
...
<ParamField path="recording" type="CallRecording" required toc={true}>
