...
<ParamField path="digits" type="object" required toc={true}>
  Object containing the digit collection configuration.
</ParamField>

<Indent>
<ParamField path="max" type="number" required toc={true}>
  Max number of digits to collect.
</ParamField>

<ParamField path="digitTimeout" type="number" default="5.0" toc={true}>
...
<ParamField path="speech" type="object" required toc={true}>
  Object containing the speech collection configuration.
</ParamField>

<Indent>
<ParamField path="endSilenceTimeout" type="number" default="1.0" toc={true}>
  How much silence to wait for end of speech in seconds.
</ParamField>

<ParamField path="speechTimeout" type="number" default="60" toc={true}>
...
<ParamField path="name" type="string" required toc={true}>
  Name of the header.
</ParamField>

<ParamField path="value" type="string" required toc={true}>
  Value of the header.
</ParamField>
...
<ParamField path="type" type='"phone"' required toc={true}>
...
<ParamField path="callStateUrl" type="string" toc={true}>
  Webhook URL to which SignalWire will send call status change notifications. See [`CallState`][callstate].
</ParamField>

<ParamField path="callStateEvents" type="string[]" default='["ended"]' toc={true}>
...
<ParamField path="type" type='"sip"' required toc={true}>
...
<ParamField path="type" type='"rtp" | "ws"' required toc={true}>
...
<ParamField path="addr" type="string" required toc={true}>
  RTP IPv4 address.
</ParamField>

<ParamField path="port" type="string" required toc={true}>
  RTP port.
</ParamField>

<ParamField path="codec" type='"OPUS" | "PCMA" | "PCMU"' toc={true}>
  Optional codec to use. It will be the same as the tapped audio if not set.
</ParamField>

<ParamField path="rate" type="number" toc={true}>
  Optional sample rate in Hz. It will be the same as the tapped audio if not set.
</ParamField>

<ParamField path="ptime" type="number" toc={true}>
...
<ParamField path="uri" type="string" required toc={true}>
  Destination URI.
</ParamField>
