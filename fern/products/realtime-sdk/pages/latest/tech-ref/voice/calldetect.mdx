---
id: 524cd0e5-c05c-4f35-8c09-8196255cf38b
title: "CallDetect"
keywords: SignalWire, Realtime SDK, Node.js, answering machine detection, AMD, fax detection, call screening
slug: /node/reference/voice/call-detect
sidebar-title: CallDetect
...
[detect]: /docs/server-sdk/v4/node/reference/voice/call/detect
...
<ParamField path="type" type='"machine" | "digit" | "fax" | "beep"' toc={true}>
...
<ParamField path="detect" type="CallDetect" required toc={true}>
