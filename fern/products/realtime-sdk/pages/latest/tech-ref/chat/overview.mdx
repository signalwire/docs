...
<CardGroup cols={2}>
  <Card title="Client" icon="fa-solid fa-server" href="/docs/server-sdk/v4/node/reference/chat/client">
    The main Chat client for sending messages, managing members, and subscribing to chat events.
  </Card>
  <Card title="ChatMember" icon="fa-solid fa-user" href="/docs/server-sdk/v4/node/reference/chat/chat-member">
    Represents a member in a chat channel with properties for identity and state.
  </Card>
  <Card title="ChatMessage" icon="fa-solid fa-message" href="/docs/server-sdk/v4/node/reference/chat/chat-message">
