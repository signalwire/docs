---
title: "Client"
keywords: SignalWire, Realtime SDK, Node.js, chat client, chat rooms, subscribe channel
slug: reference/chat/client
description: Chat Client reference for real-time chat functionality. Subscribe to channels, publish messages, get message history, and manage channel members.
max-toc-depth: 3
---
...
<ParamField path="params.cursor" type="PaginationCursor">
...
<Indent>
<ParamField path="params.channels" type="string[]" required>
...
<Indent>
<ParamField path="params.channels" type="string | string[]" required>
...
<ParamField path="params.state" type="Record<any, any>" required>
