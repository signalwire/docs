---
id: 6bfaa051-dc10-4891-baaa-4c87af299069
title: Make a Weather Phone IVR with the Realtime SDK
slug: /guides/make-a-weather-phone-ivr-with-the-realtime-sdk
max-toc-depth: 3
x-custom:
...
keywords: SignalWire, Realtime SDK, Node.js, weather phone, voice application example, API integration
...
[call-1]: /realtime-sdk/voice/call
[call-playtts-1]: /realtime-sdk/voice/call#playtts
[call-prompt-1]: /realtime-sdk/voice/call#prompt
[community-discord]: https://discord.com/invite/F2WNYTNjuF
[connectphone-1]: /realtime-sdk/voice/call#connectphone
[connectsip-1]: /realtime-sdk/voice/call#connectsip
[create-a-signalwire-account-and-space]: https://m.signalwire.com/signups/new?s=1
[device-builder]: /realtime-sdk/voice/device-builder
...
[signalwire-realtime-api-1]: /realtime-sdk/
[signalwire-realtime-sdk-reference-2]: /realtime-sdk/
[signalwire-realtime-sdk-reference]: /realtime-sdk/voice/
...
[voice-client-s-1]: /realtime-sdk/voice/client
...
![the Edit Settings page of a phone number in SignalWire.](/assets/images/dashboard/relay/app_voice_handler.webp)
