---
id: 21d04025-bcf4-49e7-af28-57c144530f75
title: Make a voice mail responder with the Realtime SDK
slug: /guides/make-a-voicemail-responder-with-the-realtime-sdk
max-toc-depth: 3
x-custom:
  tags:
    - sdk:relayrealtime
...
keywords: SignalWire, Realtime SDK, Node.js, voicemail, voicemail setup, record voicemail
sidebar_custom_props:
  platform: javascript
---

[buy-one]: /platform/phone-numbers/getting-started/buying-a-phone-number
[realtime-sdk-documentation]: /realtime-sdk/
