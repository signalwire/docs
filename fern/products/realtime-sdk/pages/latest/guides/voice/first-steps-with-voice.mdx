...
![The Voice and Fax Settings pane.](/images/dashboard/relay/app_voice_handler.webp)
...
![the API tab, showing the Project ID, Space URL, and API Token.](/images/dashboard/credentials/api-credentials.webp)
</Frame>
