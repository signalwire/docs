---
id: 7a1538e3-fa4e-4377-8791-3b248bb6f768
...
keywords: SignalWire, Realtime SDK, Node.js, voice tutorial, getting started voice, first voice app
...
![The Voice and Fax Settings pane.](/docs/assets/images/dashboard/relay/app_voice_handler.webp)
...
![the API tab, showing the Project ID, Space URL, and API Token.](/docs/assets/images/dashboard/credentials/api-credentials.webp)
</Frame>
