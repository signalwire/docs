---
id: a52cb141-604d-4ab9-b16a-3cca735cc1df
...
keywords: SignalWire, Realtime SDK, Node.js, SMS to email, forward text, SMS forwarding
...
- You will need your [SignalWire credentials][project-id-and-api-token] (i.e., Space URL, Project ID, and API token).
