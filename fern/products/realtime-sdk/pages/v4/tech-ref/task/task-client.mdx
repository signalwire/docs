...
<ParamField name="params.topic" type="string | string[]" required>
  Topic to send the task to. Previously known as `"context"` or `"contexts"`. Can also use `params.topics`.
</ParamField>

<ParamField name="params.message" type="Record<string, unknown>" required>
  Message to send.
</ParamField>

<ParamField name="params.project" type="string">
  SignalWire project id, e.g. `a10d8a9f-2166-4e82-56ff-118bc3a4840f`.
</ParamField>

<ParamField name="params.token" type="string">
...
<ParamField name="payload" type="Record<string, unknown>" required>
  The message payload.
</ParamField>
