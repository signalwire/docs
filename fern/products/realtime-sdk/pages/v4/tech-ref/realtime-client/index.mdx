...
<ParamField name="options.project" type="string" required>
  SignalWire project id, e.g. `a10d8a9f-2166-4e82-56ff-118bc3a4840f`
</ParamField>

<ParamField name="options.token" type="string" required>
  SignalWire project token, e.g. `PT9e5660c101cd140a1c93a0197640a369cf5f16975a0079c9`
</ParamField>

<ParamField name="options.host" type="string">
  SignalWire host URL. Default is the standard SignalWire host.
</ParamField>

<ParamField name="options.logLevel" type="string">
  Log level: `'trace'`, `'debug'`, `'info'`, `'warn'`, `'error'`, or `'silent'`.
</ParamField>

<ParamField name="options.debug" type="object">
  Debug configuration object.
</ParamField>

<ParamField name="debug.logWsTraffic" type="boolean" default="false">
