...
<ParamField name="layoutName" type="string" required>
  Current layout name used in the room.
</ParamField>

<ParamField name="hideVideoMuted" type="boolean" required>
  Whether muted videos are shown in the room layout. See [setHideVideoMuted][video-roomsession].
</ParamField>

<ParamField name="recording" type="boolean" required>
  Whether recording is active.
</ParamField>

<ParamField name="members" type="RoomSessionMember[]">
...
<ParamField name="previewUrl" type="string">
  URL to the room preview.
</ParamField>

<ParamField name="recordings" type="any[]">
