...
<ParamField name="params.topics" type="string[]" required>
...
<ParamField name="params.tags" type="string[]">
...
<ParamField name="message" type="MessageContract" required>
