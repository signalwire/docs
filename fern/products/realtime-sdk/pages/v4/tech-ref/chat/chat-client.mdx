...
<ParamField name="params.channels" type="string | string[]">
...
<ParamField name="params.cursor" type="PaginationCursor">
...
<ParamField name="params.channels" type="string | string[]" required>
...
<ParamField name="params.state" type="Record<any, any>" required>
...
<ParamField name="message" type="ChatMessage" required>
