...
<ParamField name="media" type="NestedArray<Object>">
  The list of media items that have been added to this Playlist.
</ParamField>

<ParamField name="volume" type="number | undefined">
...
<ParamField name="params.name" type="RingtoneName" required>
  Name of the ringtone to play. See [`RingtoneName`][types].
</ParamField>

<ParamField name="params.duration" type="number">
...
<ParamField name="params.duration" type="number" required>
...
<ParamField name="params.text" type="string" required>
...
<ParamField name="params.language" type="string" default='"en-US"'>
  Language of the text in `ISO 639-1` (language name) + `ISO 3166` (country code). Supported languages can be found [here][link-5].
</ParamField>

<ParamField name="params.gender" type='"female" | "male"' default='"female"'>
  Gender of the voice.
</ParamField>

<ParamField name="params.voice" type="string">
