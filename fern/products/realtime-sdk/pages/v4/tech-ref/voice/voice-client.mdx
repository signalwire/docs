...
<ParamField name="params" type="VoiceDeviceBuilder" required>
...
<ParamField name="listenOptions" type="object" required>
  Object containing the parameters of the method.
</ParamField>

<ParamField name="listenOptions.topics" type="string[]" required>
  Topics to listen on. Previously known as `"contexts"`.
</ParamField>

<ParamField name="listenOptions.EVENT" type="Callback">
...
<ParamField name="call" type="Call" required>
