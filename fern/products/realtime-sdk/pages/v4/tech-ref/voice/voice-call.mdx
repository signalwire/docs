...
<ParamField name="device" type="any">
  The device configuration for this call.
</ParamField>

<ParamField name="direction" type='"inbound" | "outbound"'>
...
<ParamField name="headers" type="SipHeader[]" optional>
...
<ParamField name="state" type='"created" | "ringing" | "answered" | "ending" | "ended"'>
...
<ParamField name="type" type='"phone" | "sip"'>
...
<ParamField name="params.partialResults" type="boolean" default="false">
  If true, partial result events are fired.
</ParamField>

<ParamField name="params.sendStartOfInput" type="boolean" default="false">
  If true, the [`startOfInput`][startinput] event is fired when input is detected.
</ParamField>

<ParamField name="params.startInputTimers" type="boolean" default="false">
...
<ParamField name="params.devices" type="VoiceDeviceBuilder" required>
  A device builder specifying the devices to call. See [`VoiceDeviceBuilder`][voicedevicebuilder].
</ParamField>

<ParamField name="params.ringback" type="VoicePlaylist">
...
<ParamField name="params.webrtcMedia" type="boolean">
  If `true`, WebRTC media is negotiated. Default is parent leg setting.
</ParamField>

<ParamField name="params.sessionTimeout" type="number">
...
<ParamField name="params.type" type='"fax" | "machine" | "digit" | "beep"' required>
...
<ParamField name="params.timeout" type="number" default="30.0">
  Number of seconds to run the detector for.
</ParamField>

<ParamField name="params.waitForBeep" type="boolean" default="false">
  Whether to wait until the device is ready for voicemail delivery.
</ParamField>

<ParamField name="params.initialTimeout" type="number" default="4.5">
  Number of seconds to wait for initial voice before giving up.
</ParamField>

<ParamField name="params.endSilenceTimeout" type="number" default="1.0">
  Number of seconds to wait for voice to finish.
</ParamField>

<ParamField name="params.machineReadyTimeout" type="number">
  Number of seconds to wait for voice to finish before firing the `READY` event. Default is the value of `endSilenceTimeout`.
</ParamField>

<ParamField name="params.machineVoiceThreshold" type="number" default="1.25">
  How many seconds of voice to decide it is a machine.
</ParamField>

<ParamField name="params.machineWordsThreshold" type="number" default="6">
  How many words to count to decide it is a machine.
</ParamField>

<ParamField name="params.detectInterruptions" type="boolean" default="false">
...
<ParamField name="params.digits" type="string" default="0123456789#*">
...
<ParamField name="params.tone" type='"CED" | "CNG"' default="CED">
...
<ParamField name="reason" type='"error" | "hangup" | "cancel" | "busy" | "noAnswer" | "decline"' default="hangup">
...
<ParamField name="listeners" type="object" required>
  Object containing event listener callbacks.
</ParamField>

<ParamField name="listeners.EVENT" type="Callback">
...
<ParamField name="params.playlist" type="VoicePlaylist" required>
...
<ParamField name="params.gender" type='"male" | "female"' default="female">
  Gender of the voice.
</ParamField>
...
<ParamField name="params.audio" type="object" required>
...
<ParamField name="params.beep" type="boolean" default="false">
  Whether to play a beep before recording.
</ParamField>

<ParamField name="params.format" type='"mp3" | "wav"' default="mp3">
  Format of the recording.
</ParamField>

<ParamField name="params.stereo" type="boolean" default="false">
  Whether to record in stereo mode.
</ParamField>

<ParamField name="params.direction" type='"listen" | "speak" | "both"' default="speak">
  Direction to record. Can be `listen` (what the caller hears), `speak` (what the caller says), or `both`.
</ParamField>

<ParamField name="params.initialTimeout" type="number" default="5.0">
...
<ParamField name="params.terminators" type="string" default="#*">
  DTMF digits that, when dialed, will end the recording.
</ParamField>

<ParamField name="params.inputSensitivity" type="number" default="44">
...
<ParamField name="digits" type="string" required>
...
<ParamField name="params.device" type="TapDevice" required>
...
<ParamField name="audio.direction" type='"listen" | "speak" | "both"' required>
...
<ParamField name="params.direction" type='"listen" | "speak" | "both"' required>
  Direction to tap. Can be `"listen"` (what the caller hears), `"speak"` (what the caller says), or `"both"`.
</ParamField>
...
<ParamField name="params" type='"ended" | "ending" | ("ended" | "ending")[]' required>
...
<ParamField name="call" type="CallState" required>
...
<ParamField name="collect" type="CallCollect" required>
...
<ParamField name="detect" type="CallDetect" required>
...
<ParamField name="playback" type="CallPlayback" required>
...
<ParamField name="prompt" type="CallPrompt" required>
...
<ParamField name="recording" type="CallRecording" required>
...
<ParamField name="tap" type="CallTap" required>
