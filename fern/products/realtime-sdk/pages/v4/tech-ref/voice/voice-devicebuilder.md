...
<ParamField name="devices" type="NestedArray<Object>">
...
<ParamField name="device" type="object | object[]" required>
...
<ParamField name="params.to" type="string" required>
  Number to call, in E.164 format.
</ParamField>

<ParamField name="params.from" type="string" required>
  SignalWire number to use to initiate the call, in E.164 format.
</ParamField>

<ParamField name="params.timeout" type="number" default="30">
  Time to wait for the call to be answered, in seconds.
</ParamField>

<ParamField name="params.callStateUrl" type="string">
...
<ParamField name="params.callStateEvents" type="string[]" default='["ended"]'>
  An optional array of event names to be notified about. Allowed values are `created`, `ringing`, `answered`, and `ended`.
</ParamField>

<ParamField name="params.maxPricePerMinute" type="number">
...
<ParamField name="params.codecs" type="SipCodec[]">
  Optional array of desired codecs in order of preference. See [`SipCodec`][types].
</ParamField>

<ParamField name="params.headers" type="SipHeader[]">
