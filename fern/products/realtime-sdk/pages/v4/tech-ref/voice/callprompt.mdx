...
<ParamField name="type" type='"error" | "no_input" | "no_match" | "digit" | "speech"'>
  The type of this prompt.
</ParamField>

<ParamField name="result" type="object">
  The raw result object from the prompt operation.
</ParamField>

<ParamField name="speech" type="string">
...
<ParamField name="volume" type="number" required>
