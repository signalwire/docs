...
Consider reading the [Upgrading to Relay v4](/sdks/realtime-sdk/v3/guides/realtime-relay-v4-vs-v3) page to understand the benefits of [RELAY v4](/sdks/realtime-sdk) and how to upgrade.
</Warning>
