...
|:------|:---------------|:----------------------|
| `tap`<span className="required-arg">Required</span> | [`CallTap`][calltap-9] | The tap that started. |
...
| Name  | Type           | Description         |
|:------|:---------------|:--------------------|
| `tap`<span className="required-arg">Required</span> | [`CallTap`][calltap-9] | The tap that ended. |
