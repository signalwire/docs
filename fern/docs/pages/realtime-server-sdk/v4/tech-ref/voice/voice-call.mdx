...
| `params.listen`?| `Callback`                                               | Callback to listen for events.<br />List of collect events can be found [here][callcollect-1].<br />Example event: [`onStarted`][callcollect-3]                                              |
...
|:----------------------------|:-------------------------------------------------|:------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------|
| `params`| `Object`                                         | -                                                                                                                                                                                         |
| `params.devices`| [`VoiceDeviceBuilder`][voicedevicebuilder] | Pass only the Dialer specifying the devices to call.                                                                                                                                      |
| `params.ringback`?| [`VoicePlaylist`][voiceplaylist-4]           | Ringback audio to play to the first call leg. You can play audio, TTS, silence or ringtone.                                                                                               |
...
| `params.callStateUrl`?| `string`                               | Optional webhook URL to which SignalWire will send call status change notifications. See the payload specifications under [`CallState`][callstate-3].                                                                                               |
...
| `params.listen`?| `Object`  | Callback to listen for events.<br />List of detect events can be found [here][calldetect].<br />Example event: [`onStarted`][calldetect-1] |
...
| `params.EVENT`| `Callback` | The event to listen to. List of events can be found [here][callcollect-1].<br />Example event: [`onStateChanged`][link-7] |
...
| :---------------- | :------------------------------------- | :------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- |
| `params`| `Object`                               | -                                                                                                                                                                                                        |
| `params.playlist`| [`VoicePlaylist`][voiceplaylist-4] | A media playlist.                                                                                                                                                                                        |
| `params.listen`?| `Object`                               | Callback to listen for events.<br />List of playback events can be found [here][callplayback].<br />Example event: [`onStarted`][callplayback-1] |
...
| `params.language`?| `string`               | Language of the text in `ISO 639-1` (language name) + `ISO 3166` (country code). Defaults to `en-US`.<br /> Supported languages can be found [here][here-15].                        |
...
| `params.voice`?| `string`               | Voice to use (takes precedence on `gender`).<br /> Supported voices can be found [here][here-15].                                                                                    |
| `params.volume`?| `number`               | Volume value between -40dB and +40dB where 0 is unchanged. Default is 0.                                                                                                                                  |
| `params.listen`?| `Object`               | Callback to listen for events.<br />List of playbook events can be found [here][callplayback].<br />Example event: [`onStarted`][callplayback-1] |
...
| `params.listen`?| `Object`                                                 | Callback to listen for events.<br />List of prompt events can be found [here][callprompt]. <br />Example event: [`onStarted`][callprompt-1] |
...
| :----------------------- | :------------------------------------------------------- | :------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------ |
| `params`| `Object`                                                 | -                                                                                                                                                                                                                                     |
| `params.text`| `string`                                                 | Text to play. `SSML` (Speech Synthesis Markup Language) may be entered as a string wrapped in `<speak>` tags.<br /> See our [supported voices and languages][supported-voices-and-languages-1] documentation for usage and supported tags. |
| `params.digits`?| [`CollectDigitsConfig`][types-1] | Configuration for collecting digits. You must either set this, or `speech`.                                                                                                                                                           |
| `params.speech`?| [`CollectSpeechConfig`][types-2] | Configuration for collecting speech. You must either set this, or `digits`. Pass an empty object to use the default configuration.                                                                                                    |
...
| :--------------- | :------- | :--------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- |
| `params`| `Object` | -                                                                                                                                                                                                          |
| `params.audio`| `Object` | See the parameters for [recordAudio][link-12].                                                                                                                                                        |
| `params.listen`?| `Object` | Callback to listen for events.<br />List of recording events can be found [here][callrecording].<br />Example event: [`onStarted`][callrecording-1] |
...
| `params.listen`?| `Object`                             | Callback to listen for events.<br />List of tap events can be found [here][calltap].<br />Example event: [`onStarted`][calltap-1] |
...
| Name   | Type                           | Description                                |
|:-------|:-------------------------------|:-------------------------------------------|
| `call`| [`CallState`][callstate-3] | A `Call` object containing the call state. |
...
| Name      | Type                               | Description             |
|:----------|:-----------------------------------|:------------------------|
| `collect`| [`CallCollect`][callcollect-12] | A `CallCollect` object. |
...
| Name     | Type                             | Description            |
|:---------|:---------------------------------|:-----------------------|
| `detect`| [`CallDetect`][calldetect-18] | A `CallDetect` object. |
...
| Name       | Type                                 | Description              |
|:-----------|:-------------------------------------|:-------------------------|
| `playback`| [`CallPlayback`][callplayback-20] | A `CallPlayback` object. |
...
| Name     | Type                             | Description            |
|:---------|:---------------------------------|:-----------------------|
| `prompt`| [`CallPrompt`][callprompt-19] | A `CallPrompt` object. |
...
| Name        | Type                                   | Description               |
|:------------|:---------------------------------------|:--------------------------|
| `recording`| [`CallRecording`][callrecording-13] | A `CallRecording` object. |
...
| Name  | Type                       | Description         |
|:------|:---------------------------|:--------------------|
| `tap`| [`CallTap`][calltap-9] | A `CallTap` object. |
