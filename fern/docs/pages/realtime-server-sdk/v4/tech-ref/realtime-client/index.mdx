...
| :------------------------ | :-------- | :------------------------------------ | :---------------------------------------------------------------------------------- |
| `opts`                    | `Object`  | <span class="required-yes">Yes</span> | -                                                                                   |
| `opts.project`            | `string`  | <span class="required-yes">Yes</span> | SignalWire project id, e.g. `a10d8a9f-2166-4e82-56ff-118bc3a4840f`                  |
| `opts.token`              | `string`  | <span class="required-yes">Yes</span> | SignalWire project token, e.g. `PT9e5660c101cd140a1c93a0197640a369cf5f16975a0079c9` |
| `opts.host`               | `string`  | <span class="required-no">No</span>   | SignalWire host URL. Default is the standard SignalWire host.                       |
| `opts.logLevel`           | `string`  | <span class="required-no">No</span>   | Log level: `'trace'`, `'debug'`, `'info'`, `'warn'`, `'error'`, or `'silent'`.      |
| `opts.debug`              | `Object`  | <span class="required-no">No</span>   | -                                                                                   |
| `opts.debug.logWsTraffic` | `boolean` | <span class="required-no">No</span>   | If `true`, logs all WebSocket traffic. Default is `false`.                          |
