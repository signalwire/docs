...
**Package:** [@signalwire/realtime-api](https://www.npmjs.com/package/@signalwire/realtime-api)
**GitHub:** [signalwire/signalwire-js](https://github.com/signalwire/signalwire-js)
**Status:** Stable

# Overview

Check out the EndpointRequestSnippet component 👀

<EndpointRequestSnippet endpoint="POST /api/fabric/calls" />
...
<Cards>
  <Card
    ...
    href='/sdks/realtime-sdk/technical-reference'
  >
    Complete API documentation for all namespaces, classes, and methods
  </Card>
  <Card title='Guides & Examples' href='/sdks/realtime-sdk/guides'>
