...
Your `project` ID and `token` are available in the [SignalWire Dashboard](/platform/dashboard/getting-started/your-signalwire-api-space.md). These authenticate your WebSocket connection and establish your access permissions.
