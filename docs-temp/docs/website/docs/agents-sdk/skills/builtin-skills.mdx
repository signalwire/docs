...
- MCP Gateway service running (see [MCP Gateway](/sdks/agents-sdk/advanced/mcp-gateway))
...
For detailed setup and configuration, see [MCP Gateway](/sdks/agents-sdk/advanced/mcp-gateway).
