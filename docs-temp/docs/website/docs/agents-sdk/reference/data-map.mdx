...
| Topic | Reference |
|-------|-----------|
| DataMap guide | [DataMap Functions](/sdks/agents-sdk/swaig-functions/datamap) |
| SWAIG functions | [SWAIG Function API](/sdks/agents-sdk/api/swaig-function) |
| Function results | [SwaigFunctionResult API](/sdks/agents-sdk/api/function-result) |
| Testing DataMap | [swaig-test CLI](/sdks/agents-sdk/api/cli/swaig-test) - DataMap functions make live HTTP calls |
