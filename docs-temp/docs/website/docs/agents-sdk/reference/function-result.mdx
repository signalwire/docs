...
| Topic | Reference |
|-------|-----------|
| Defining SWAIG functions | [SWAIG Function API](/sdks/agents-sdk/api/swaig-function) |
| Results and actions guide | [Results [Results & Actions](/sdks/agents-sdk/swaig-functions/results-actions) Actions](/sdks/agents-sdk/swaig-functions/results-actions) |
| Call transfer options | [Call Transfers](/sdks/agents-sdk/advanced/call-transfer) |
