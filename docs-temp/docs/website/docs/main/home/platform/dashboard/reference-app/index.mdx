...
<Frame>
    ![the reference app.](@image/dashboard/reference-app.png)
</Frame>
...
<Frame caption="Add a new Resource, select Subscriber, configure, and deploy.">
    ...
    ![Deploy a new subscriber.](@image/dashboard/resources/add-new-resource.png)
...
<Frame>
    ...
    ![The Marketplace button on the Dashboard.](@image/dashboard/marketplace-button.png)
...
<Frame>
    ...
    ![The menu to launch the Reference App.](@image/dashboard/marketplace.png)
