...
![Domain App page with the option to create a new Domain App](@image/dashboard/sip/sip-domain-apps.png)
...
![Inbound call settings for SIP apps](@image/dashboard/sip/sip-domain-apps-config.png)
...
![Apps tab under LaML sidebar](@image/dashboard/sip/laml-apps.png)
