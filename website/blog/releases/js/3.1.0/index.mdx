...
We provide two new functions, [`supportsGetUserMedia`](/sdks/browser-sdk/webrtc#supportsgetusermedia) and [`supportsGetDisplayMedia`](/sdks/browser-sdk/webrtc#supportsgetdisplaymedia), that you can use to check whether the corresponding media methods are available in the current environment.
