...
![Relay Application resource selector with cXML highlighted.](@image/dashboard/resources/add-new-relay-application.webp)
...
![legacy UI relay application configuration](@image/dashboard/legacy/number-message-config-relay.webp)
