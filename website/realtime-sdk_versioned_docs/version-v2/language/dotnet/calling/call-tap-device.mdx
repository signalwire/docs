...
| --------- | ---- | -------- | ----------- |
| `T` | Type | <span className="required-arg">required</span> | This is the data type for the conversion, see [`SignalWire.Relay.Calling.CallMedia.MediaType`] for more information. |
