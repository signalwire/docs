...
- [RELAY Browser SDK v3](/sdks/browser-sdk)
- [RELAY Browser SDK v2](/sdks/browser-sdk/v2)
...
For getting started with the **RELAY Browser SDK v3**, take a look at our [API reference](/sdks/browser-sdk).
...
For getting started with the **RELAY Browser SDK v2**, take a look at our [documentation](/sdks/browser-sdk/v2) and [API reference](/sdks/browser-sdk/v2/client).
