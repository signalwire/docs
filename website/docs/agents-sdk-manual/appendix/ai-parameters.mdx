...
| Section | Description |
|---------|-------------|
| [AI Parameters](ai-parameters) | Complete AI parameter reference |
| [Design Patterns](patterns) | Common architectural patterns |
| [Best Practices](best-practices) | Production guidelines |
| [Troubleshooting](troubleshooting) | Common issues and solutions |
| [Migration Guide](migration) | Version upgrade guide |
...
- **barge_confidence**: How certain before allowing interruption of AI speech

Lower values = more sensitive (may pick up noise), higher values = more strict.
