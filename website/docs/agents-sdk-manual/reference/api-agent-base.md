...
| Section | Description |
|---------|-------------|
| [AgentBase API](api-agent-base) | Main agent class reference |
| [SWMLService API](api-swml-service) | Base service class reference |
| [SWAIG Function API](api-swaig-function) | Function definition reference |
| [SwaigFunctionResult API](api-function-result) | Return value and actions reference |
| [DataMap API](api-data-map) | Serverless API integration reference |
| [SkillBase API](api-skill-base) | Custom skill development reference |
| [ContextBuilder API](api-contexts) | Workflow system reference |
| [swaig-test CLI](cli-swaig-test) | Testing tool reference |
| [sw-search CLI](cli-sw-search) | Search tool reference |
| [Environment Variables](environment-variables) | Environment configuration |
| [Config Files](config-files) | File-based configuration |
| [SWML Schema](swml-schema) | Document structure reference |
