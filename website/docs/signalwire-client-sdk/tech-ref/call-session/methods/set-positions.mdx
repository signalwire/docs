---
title: setPositions
slug: /call-session/methods/setpositions
...
<APIField name="params.positions" type="Record<string, [VideoPosition](/sdks/signalwire-client-sdk/types#videoposition)>" required>
