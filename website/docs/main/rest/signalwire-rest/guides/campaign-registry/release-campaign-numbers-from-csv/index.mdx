...
slug: >-
  /rest/signalwire-rest/guides/campaign-registry/release-campaign-numbers-from-csv
sidebar_position: 9
x-custom:
  ...
  tags:
    ...
    - 'product:messaging'
description: >-
  Use our REST APIs to easily remove specific phone number assignments from a
  campaign
