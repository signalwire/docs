...
slug: >-
  /rest/signalwire-rest/guides/campaign-registry/delete-all-number-assignments-from-multiple-campaigns
x-custom:
  ...
  tags:
    ...
    - 'language:python'
description: >-
  Use our REST API to easily remove all of the phone numbers from multiple
  messaging campaigns at once
