...
description: >-
  Using SignalWire's Campaign Registry APIs, this snippet will find all of your
  phone number assignments, format a data table, and compile details to help you
  manage all of your numbers.
slug: >-
  /rest/signalwire-rest/guides/campaign-registry/list-all-campaign-number-assignments-to-csv
x-custom:
