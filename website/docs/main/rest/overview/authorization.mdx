...
To keep a session alive without re-authenticating, call the [Refresh Subscriber Token](/rest/signalwire-rest/endpoints/fabric/refresh-tokens-create) endpoint before expiration.
