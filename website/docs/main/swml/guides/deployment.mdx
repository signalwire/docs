...
For complete information about variables, the Call Object, and all variable scopes, see the [**Variables and Expressions**](/swml/guides/variables-and-expressions) reference.
...
| --------: | --------------------------------- | ---------------------------------------------------------------------------------------------------------- |
|    `call` | [`Call`](/swml/guides/variables-and-expressions#call-object) object | Contains properties describing the call. See the [Variables and Expressions](/swml/guides/variables-and-expressions) reference for all properties. |
...
- **[Variables and Expressions](/swml/guides/variables-and-expressions)**: Complete reference for SWML variables and the Call Object
