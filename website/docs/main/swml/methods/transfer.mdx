...
The `params` object is passed, along with the variables and the [`Call`](/swml/guides/serving-swml#the-call-object) object.
...
The `call` object is described in detail in the [introduction](/swml/guides/serving-swml#the-call-object). 
