...
>
  ...
  See [Variables](#variables) for details.<br/>Will use the [`switch method parameters`](./switch#switch-parameters) when the `return_value` is a object, and will use the [`cond method parameters`](./cond#cond-parameters) method when the `return_value` is an array.
</APIField>
