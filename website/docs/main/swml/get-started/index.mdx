...
SWML is easy to use, can be deployed with or without additional infrastructure like your own server, and enables you to create powerful voice and messaging applications using a descriptive format. 
...
## SWML deployment options

After SWML is written it can be deployed in a multitude of ways such as serverlessly via the SignalWire Dashboard, via your own hosted web server, or your own application.
