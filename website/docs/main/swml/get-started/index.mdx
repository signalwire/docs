...
<Subtitle>SignalWire Markup Language - Build powerful communication applications without infrastructure</Subtitle>

***

## Introduction

SWML is a markup and scripting language for quickly writing powerful communication applications in YAML or JSON documents. SWML is serverless, easy to use, and can be deployed without additional infrastructure like your own server. SWML enables you to create powerful voice and messaging applications using a descriptive format. Whether you're building simple call forwarding systems or complex AI-powered customer service agents, SWML provides the tools you need to deploy sophisticated communication workflows.
...
Methods are the commands that tell SWML what to do during a call - like answering, playing audio, or collecting input. Think of them as the instructions in your script. See our full list [here](/swml/methods) for more information and a detailed overview
...
An Interactive Voice Response (IVR) system routes callers to different departments based on their input. This example demonstrates a complete IVR that answers the call, plays a welcome message, records the conversation, collects user input (via keypress or speech), and routes callers to sales or support. This pattern is one of the most common use cases for SWML and demonstrates how multiple methods work together to create a professional phone system.
...
Now that you understand SWML basics, explore these topics:

- **[Quickstart guide](/swml/quickstart)**: Deploy your first SWML script step-by-step
- **[Methods reference](/swml/methods)**: Complete documentation of all SWML methods
