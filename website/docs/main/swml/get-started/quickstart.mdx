...
If needed you can also utilize this example script that answers the phone, plays two brief TTS messages, and hangs up.
...
Now that you've deployed your first SWML script, explore these resources:
  ...
  <CardGroup cols={3}>
    ...
    >
      Get started with AI agents using the Agents SDK
    </Card>
    <Card
