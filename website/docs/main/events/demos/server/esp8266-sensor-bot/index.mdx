...
description: >-
  This AI Demo showcases the power of SignalWire's AI Agents to interface with
  IoT devices, like an Arduino equipped with sensors measuring atmospheric data.
