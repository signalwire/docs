...
You'll configure a phone number, create SWML or cXML scripts to handle faxes, and use our APIs to send faxes programmatically.
...
:::info [Alternative: Using Compatibility SDKs or webhooks]
