...
You can also utilize SWML to send faxes via a POST request to the SignalWire REST API [Create a Call endpoint](/rest/signalwire-rest/endpoints/calling/create-call). 
