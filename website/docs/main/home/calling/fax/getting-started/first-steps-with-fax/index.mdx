...
### Set up your fax handler

<Tabs>
<TabItem value="cxml" label="cXML" default>
...
<Frame caption="Assigning the cXML script to your phone number's inbound call settings.">
    ![Phone number settings page showing the Assign Resource button for inbound calls.](@image/dashboard/phone-numbers/assign-resource-full.png)
</Frame>
...
<Frame caption="Navigating to and creating a new SWML resource for handling faxes.">
    ![The new resource dialog showing cXML script creation.](@image/dashboard/resources/swml-resource-vid.webp)
</Frame>
