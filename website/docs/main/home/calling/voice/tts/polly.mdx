...
| :-------------------------------------------------------- | :---------------------------------------------------------------------------- | :-------------------------------------- |
| `engine`<br/><span class="required-arg">required</span>   | `amazon`                                                                      | TTS engine                              |
| `voice`<br/><span class="required-arg">required</span>    | Choose from the **Name/ID** column of [Amazon's voice reference][polly]       | Voice ID                                |
| `model`<br/><span class="optional-arg">optional</span>    | `standard`, `neural`, or `generative`                                         | Amazon Polly model. Default: `standard` |
| `language`<br/><span class="optional-arg">optional</span> | Choose from the **Language code** column of [Amazon's voice reference][polly] | Sets model language. Default: `en-US`   |
