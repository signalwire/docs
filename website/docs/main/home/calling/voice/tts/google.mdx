...
Google Cloud supports multiple audio output formats:
- **Linear PCM** - Uncompressed audio (default)
- **MP3** - Compressed audio with adjustable bit rate
- **OGG Opus** - High-quality compressed audio

The format can be configured in your SignalWire settings.
