...
We are going to implement voicemail in a cXML bin hosted on SignalWire.
To create a new cXML bin, navigate to the **Resources** section from your sidebar.
...
Edit the settings of your selected number, and assign the SWML script or cXML bin you created to
...
We have seen how to build a basic voicemail using SWML scripts or cXML bins.
