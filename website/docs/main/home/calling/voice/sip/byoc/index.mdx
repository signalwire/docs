...
To create an outbound call using the Calling API with curl, you can use the [Create a Call endpoint](/rest/signalwire-rest/endpoints/calling/create-call) with the following format:
