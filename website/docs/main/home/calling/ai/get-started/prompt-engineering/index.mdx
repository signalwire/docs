...
description: >-
  Learn the fundamentals of prompt engineering and how it can help you create
  responsive and reliable AI agents for your SignalWire applications.
tags:
  - get-started
  - quickstart
---
...
<Tooltips tip="ASR, or 'Automatic Speech Recognition', is also known as 'Speech-to-Text' (STT).">ASR</Tooltips>, 
conversational intelligence, 
[function calling](/swml/methods/ai/swaig),
<Tooltips tip="'Retrieval Augmented Generation' systems, like SignalWire's Datasphere, empower AI Agents with structured data to improve quality and reliability.">integrated RAG</Tooltips>, and 
<Tooltips tip="'Text-to-Speech' models speak text in a variety of languages and voices.">TTS</Tooltips>,
