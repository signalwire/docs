...
<img src={require("@image/dashboard/legacy/pvc/97db962-sw-space-video-page.webp").default} className="img-800" />
...
<img src={require("@image/dashboard/legacy/pvc/f2927e5-sw-space-video-logs.webp").default} className="img-800" />
...
![Video Conference settings tab with Availability, Quality, Layout, Size, and Record options.](@image/video/conference-settings.webp)
</Frame>
...
<img
  src={require("@image/dashboard/legacy/pvc/e9f0676-sw-space-video-recordings.webp").default}
  className="img-800"
/>
