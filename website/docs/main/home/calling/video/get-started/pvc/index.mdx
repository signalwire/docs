...
![The Resource picker menu.](@image/dashboard/resources/add-new-resource-video-marked.webp)
</Frame>
...
<AccordionGroup>
  ...
  <Accordion title="Ghost">
    ...
    <Frame caption="How to add the code snippet to a post using the HTML card.">
      ![Adding Video Conference Guest embed code to a Ghost CMS HTML block.](@image/external/ghost-html.gif)
    </Frame>
  </Accordion>
