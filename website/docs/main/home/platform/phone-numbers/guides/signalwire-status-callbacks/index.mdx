...
| `SipResultCode`              | The numeric SIP response code received for the INVITE request, indicating the outcome of the call attempt. [Learn more](https://en.wikipedia.org/wiki/List_of_SIP_response_codes) about the possible SIP response codes. | integer        |
