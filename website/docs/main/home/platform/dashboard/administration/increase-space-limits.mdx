---
description: >-
  Use this process to request an increase to a Space's Daily Top-up, Projects
  per Space, numbers per Project, Verified IDs per Project, Call backlog, or
  Message backlog
slug: >-
  /platform/dashboard/guides/how-to-request-an-increase-to-your-signalwire-space-limits
x-custom:
...
Consult the [Trial Mode](/platform/dashboard/guides/trial-mode) guide for more information.
