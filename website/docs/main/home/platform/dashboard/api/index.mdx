...
- **Video Room Tokens**: Generated via the [Create Room Token](/rest/signalwire-rest/endpoints/video/create-room-token) endpoint. See our [Simple Video Demo](/video/getting-started/simple-video-demo).
