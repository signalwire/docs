...
Yes, SignalWire is STIR/ SHAKEN compliant! This means that all of your outbound calls from purchased SignalWire numbers are signed, sealed, and delivered.

### Attestation levels

By default, phone numbers bought on the SignalWire platform receive attestation level **C**.
