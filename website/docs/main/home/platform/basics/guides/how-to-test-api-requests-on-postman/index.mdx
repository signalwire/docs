...
![Postman Environments](@image/external/postman/environments.webp)
...
![Postman Collections](@image/external/postman/collections.webp)
...
![A screenshot of a request in Postman using the URL from the Number Search API documentation article.](@image/external/postman/search_number.webp)
...
![A screenshot of a GET request in Postman using the URL described in the Listing Calls documentation article.](@image/external/postman/query_example.webp)
