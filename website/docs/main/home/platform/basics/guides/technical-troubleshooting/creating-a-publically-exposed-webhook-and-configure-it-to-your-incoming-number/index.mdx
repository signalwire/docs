...
description: >-
  Through ngrok and Flask, we will learn how to turn our backend application
  into a webhook that can be executed by our SignalWire phone number once a
  given action is triggered.
slug: >-
  /platform/basics/guides/technical-troubleshooting/creating-a-publically-exposed-webhook
x-custom:
