...
![Image of SignalWire Call Flow Builder, show-casing a series of nodes being connected visually to make a call-flow.](@image/call-flow/sample-flow.webp)
...
![The phone number settings page](@image/dashboard/phone-numbers/assign-resource-voice.webp)
...
![The Logs page of the SignalWire Space](@image/dashboard/logs.webp)
...
![A Image showing the embeddable video for web-pages](@image/video/embed-pvc.webp)
...
![SignalWire Dashboard that shows the sidebar option 'AI Agent' selected, and is displaying the AI Agent page](@image/dashboard/resources/ai-agent/ai-agent-resource-page.webp)
...
![SignalWire Dashboard that shows the sidebar option 'Phone Numbers' selected](@image/dashboard/legacy/external-cxml-webhook.webp)
...
![The SIP endpoint settings with all default options selected.](@image/dashboard/legacy/sip/edit-endpoint.webp)
