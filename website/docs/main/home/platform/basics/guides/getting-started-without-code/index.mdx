...
![The phone number purchase page](@image/dashboard/phone-numbers/choose.png)
...
![The Logs page of the SignalWire Space](@image/dashboard/logs.png)
...
![SignalWire Dashboard that shows the sidebar option 'AI Agent' selected, and is displaying the AI Agent page](@image/dashboard/resources/ai-agent/ai-agent-resource-page.png)
...
![SignalWire Dashboard that shows the sidebar option 'Phone Numbers' selected](@image/dashboard/legacy/external-cxml-webhook.png)
