...
![The Set Up Action pane](@image/external/zapier/phone-call/set-up-trigger.webP)
...
![SignalWire space API Credentials](@image/dashboard/credentials/api-credentials.webp)
...
![Successfully tested trigger. A dialog reads, 'We found a phone call!' The text of the dialog includes the JSON response](@image/external/zapier/phone-call/test-trigger.webP)
...
![The Set Up Action pane](@image/external/zapier/phone-call/set-up-action.webP)
...
![The Set Up Action pane with messages](@image/external/zapier/phone-call/set-up-message-action.webP)
