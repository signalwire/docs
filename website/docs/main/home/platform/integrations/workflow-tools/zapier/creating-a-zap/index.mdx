...
![The API Credentials](@image/dashboard/credentials/api-credentials.webp)
...
![The Zapier 'New Text Messages' configuration page, with text fields for To Number, From Number, Date Sent, and Page Size](@image/external/zapier/message/set-up-trigger.webP)
...
![The Zapier Action page. Under the 'Set up Action' header, there are text fields labeled To Number, From Number, and Body](@image/external/zapier/message/setup-text-message.webP)
