...
![The Domain Applications page of the SignalWire dashboard with "Handle Incoming Calls" section selecting AI Agent](@image/dashboard/sip/sip-domain-apps-ai-agent.png)
