...
![The top right menu of the SignalWire Space](@image/dashboard/toolbar-right-open.png)

</Frame>

<Frame caption="The top-right menu">

![The personal access token page on the SignalWire space](@image/dashboard/credentials/personal-access-tokens.png)
