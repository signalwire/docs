...
![The user's account name on top right on Textit](@image/external/textit/account.webp)

Now you should see your account’s overview page. At the top, you will see a button labeled “Add Channel.” Press this button.

![Button to Add Channel selected in Textit](@image/external/textit/add_channel.webp)
...
![API Credentials.](@image/external/textit/configuration.webp)
</Frame>
