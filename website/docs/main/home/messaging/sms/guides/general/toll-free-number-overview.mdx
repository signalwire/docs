...
| Message Content                          | Sample messages that reflect the type of content you will be sending.           |
...
| Entity Type                              | The classification of the business based on ownership and purpose based on the following:<br/><ul><li>Public Profit</li><li>Private Profit</li><li>Non-Profit</li><li>Government</li><li>*Sole Proprietor</li></ul><br/>*If a business is classified as sole-proprietor, additional vetting will be required upon review. |
