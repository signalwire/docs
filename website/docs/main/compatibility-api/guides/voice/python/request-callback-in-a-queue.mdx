---
title: Request Callback in a Queue - Python
slug: /compatibility-api/guides/voice/python/request-callback-in-a-queue
x-custom:
  ported_from_readme: true
  repo: https://github.com/signalwire/examples/tree/main/Voice/Request%20Callback%20in%20a%20Queue%20with%20Python
  tags:
    - language:python
    - sdk:compatibility
    - product:voice
...
You will need the [Flask](https://pypi.org/project/Flask/) framework and the SignalWire [Python SDK](/compatibility-api/sdks) downloaded.
