...
```
From                       ...   Call Status
0  sip:+12147903161@sip.signalwire.com   ...   completed
1  +12147903161                 ...   completed

[2 rows x 8 columns]

You sent 2 total calls during your selected date range.
The total cost of calls in your selected date range is approximately $0.26 USD.
There are currently 0 calls in the queue, with 0 currently ringing and 0 currently in progress.
There have been 0 calls that have been canceled.
There have been 2 completed calls, 0 calls marked as busy, and 0 failed calls.
There were 0 inbound calls and 0 outbound messages.
