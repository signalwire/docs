...
![Google Sheet 'Covid_Survey' with columns for call data and health screening questions.](./sheets-header.png)
...
![the Google Cloud Platform Dashboard showing a dropdown menu on the project titled 'CovidSurvey'.](./google-cloud-config.png)
