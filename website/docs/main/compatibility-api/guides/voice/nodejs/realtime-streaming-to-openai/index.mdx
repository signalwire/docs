...
the [native SWML AI integration](/swml/ai)?
...
- Click **Add** 
- Select **SIP Address** or **Phone Number**
...
<Accordion title="The webhook endpoint" description="Handle incoming call webhooks from SignalWire">
...
<Accordion title="OpenAI Realtime API integration">
