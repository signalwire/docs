---
title: Building Real-Time AI Voice Assistants
description: Learn how to create bidirectional audio streaming bridges between telephony platforms and AI real-time APIs
slug: /guides/real-time-ai-voice-assistants
sidebar_label: Real-Time AI Voice Assistants
sidebar_position: 1
---
...
<Subtitle>Create bidirectional audio streaming bridges between telephony and AI</Subtitle>

Transform phone calls into intelligent conversations using WebSocket streaming and modern AI APIs.
...
<CardGroup>
  <Card
    ...
    description="Real-time audio streaming between telephony and AI"
    icon="🔌"
  />
  <Card
    title="AI Integration"
    description="Natural conversations with OpenAI's Realtime API"
    icon="🤖"
  />
  <Card
    title="Function Calling"
    description="Server-side tool execution during conversations"
    icon="⚡"
  />
</CardGroup>
...
1. **SignalWire Account** - [Sign up free](https://signalwire.com)
2. **OpenAI API Key** - [Get access](https://platform.openai.com/api-keys) (requires paid account)
3. **Node.js 20+** - For running the TypeScript server
4. **ngrok** - For local development tunneling ([Install ngrok](https://ngrok.com/download))
...
Here's what happens when someone calls your AI assistant:

<figure>
  <img className="img-800" src={require("./architecture-diagram.png").default} alt="Architecture diagram showing call flow from phone through SignalWire to WebSocket server to OpenAI"/>
  <figcaption>Real-time bidirectional audio streaming architecture</figcaption>
</figure>
...
## Step 3: Integrate with OpenAI Realtime API
...
<CardGroup>
  <Card
    ...
    description="Integrate CRM, databases, or APIs"
    icon="🔧"
  ...
  <Card
    ...
    description="Recording, analytics, and monitoring"
    icon="⚡"
