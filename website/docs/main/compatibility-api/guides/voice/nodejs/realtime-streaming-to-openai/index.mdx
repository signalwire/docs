...
| Calls not connecting | Webhook URL misconfiguration | • Verify URL is publicly accessible in SignalWire Dashboard<br/>• Ensure URL includes `/incoming-call` |
| Memory leaks | Audio buffer accumulation | • Monitor memory usage<br/>• Add buffer cleanup logic |
