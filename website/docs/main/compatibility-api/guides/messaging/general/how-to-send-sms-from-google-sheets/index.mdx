...
| Phone Number | Name         | Amount Due | Payment Due Date | Payment Link                                    | Payment Info | Status Message |
| ------------ | ------------ | ---------- | ---------------- | ----------------------------------------------- | ------------ | -------------- |
| 13152887306  | John Johnson | $69        | 2022-03-15       | [www.signalwire.com](http://www.signalwire.com) | SMS Charges  |                |
...
![example menu item with "Credentials"](@image/project/how-to-send-sms-from-google-sheets/send_sms_from_sheets.webp)
