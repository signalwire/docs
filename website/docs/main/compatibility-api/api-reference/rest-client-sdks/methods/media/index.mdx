...
The **Media** object represents a single attachment or media file that is associated with a [Message](/messaging).
...
| `date_created` <span class="optional-arg">datetime</span> | The date and time the message was sent in [RFC 2822](/rest/overview/data-formats#dates-and-times) format. |
| `date_updated` <span class="optional-arg">datetime</span> | The date and time the message was sent in [RFC 2822](/rest/overview/data-formats#dates-and-times) format. |
