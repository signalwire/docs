...
- `callInvite.invite.accept()` - accepts the call and returns a [`CallSession`](./CallSession)
- `callInvite.invite.reject()` - rejects the call

[`incomingCallHandlers`]: ./types#incomingcallhandlers
...
[`handlePushNotification`](./Types#handlepushnotificationresult) method.
