...
Authentication is scoped to [subscribers](./about_call_fabric#subscribers). 
...
## 3. Subscriber Invite Token Authentication
...
## 4. Subscriber Token Authentication
...
## 5. Exchange a C2C token for a Guest Token
...
Use this method if you don't have a backend, and you need to access a particular resource that is protected by a C2C token.
