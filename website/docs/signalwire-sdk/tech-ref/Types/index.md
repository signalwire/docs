...
| **store**        | `{   channels: InternalChannels,   instanceMap: InstanceMap,   runSaga: (saga: Saga,   args: { instance: T; runSaga: any }) => Task<any>,   sessionEmitter: EventEmitter<ClientEvents,   any> }` | Yes      |             |
...
| **getMemberOverlay**               | `(memberId: string) => undefined or UserOverlay`                | Yes      | Return the member overlay on top of the root element                                                                      |
...
| Property   | Type                                                                                                         | Required | Description |
| ---------- | ------------------------------------------------------------------------------------------------------------ | -------- | ----------- |
| **invite** | `{   accept: (param: CallParams) => CallSession,   details: IncomingInvite,   reject: () => Promise<void> }` | Yes      |             |
...
| Property            | Type                                                                                    | Required | Description                                |
| ------------------- | --------------------------------------------------------------------------------------- | -------- | ------------------------------------------ |
| **addressDetails**? | `{   channels?: number,   displayName?: string,   name: string,   type: ResourceType }` | No       |                                            |
...
| **chat**         | `{   getMessages: (params: GetConversationChatMessageParams) => Promise<GetConversationChatMessageResult>,   join: (params: JoinConversationParams) => Promise<JoinConversationResponse>,   sendMessage: (params: SendConversationMessageParams) => Promise<SendConversationMessageResponse>,   subscribe: (params: ConversationChatMessagesSubscribeParams) => Promise<ConversationSubscribeResult> }`                                                                                                                                                                  | Yes      |             |
| **conversation** | `{   getConversationMessages: (params: GetConversationMessagesParams) => Promise<GetConversationMessagesResult>,   getConversations: (params: GetConversationsParams) => Promise<GetConversationsResult>,   getMessages: (params: GetMessagesParams) => Promise<GetMessagesResult>,   join: (params: JoinConversationParams) => Promise<JoinConversationResponse>,   sendMessage: (params: SendConversationMessageParams) => Promise<SendConversationMessageResponse>,   subscribe: (callback: ConversationSubscribeCallback) => Promise<ConversationSubscribeResult> }` | Yes      |             |
