...
\*\*Type:\*\* `ConnectionOptions & BaseComponentOptions`
...
\*\*Type:\*\* `{ capabilities: CallCapabilitiesContract } & Omit<InternalCallJoinedEventParams, "capabilities">`

### CallSessionEventParams

\*\*Type:\*\* `CallJoinedEventParams | CallUpdatedEventParams | CallLeftEventParams | CallStateEventParams | CallPlayEventParams | CallConnectEventParams | CallRoomEventParams`
...
\*\*Type:\*\* `Record<SessionEvents, (params?: any) => void>`

### ConversationChatMessage

\*\*Type:\*\* `Omit<ConversationMessage, "kind"> & { text: string; user_name: string }`
...
\*\*Type:\*\* `ConversationMessageEventParams`
...
\*\*Type:\*\* `(event: ConversationEventParams) => unknown`

### GetAddressesResponse

\*\*Type:\*\* `PaginatedResponse<GetAddressResponse>`

### GetAddressesResult

\*\*Type:\*\* `PaginatedResult<GetAddressResponse>`

### GetAddressParams

\*\*Type:\*\* `GetAddressByIdParams | GetAddressByNameParams`
...
\*\*Type:\*\* `Omit<SignalWireClientParams, "host" | "token">`

### GetConversationChatMessageResult

\*\*Type:\*\* `PaginatedResult<ConversationChatMessage>`

### GetConversationMessagesResult

\*\*Type:\*\* `PaginatedResult<ConversationMessage>`

### GetConversationsResponse

\*\*Type:\*\* `PaginatedResponse<ConversationResponse>`

### GetConversationsResult

\*\*Type:\*\* `PaginatedResult<ConversationContract>`
...
\*\*Type:\*\* `GetSubscriberInfoResponse`

### HandlePushNotificationParams

\*\*Type:\*\* `PushNotificationPayload & { incomingCallHandler?: IncomingCallHandler }`

### IncomingCallHandler

\*\*Type:\*\* `(notification: IncomingCallNotification) => void`
...
\*\*Type:\*\* `{ [K] as CamelToSnakeCase<K>: MemberEntity[K] }`

### InternalVideoLayout

\*\*Type:\*\* `{ [K] as CamelToSnakeCase<K>: VideoLayout[K] } & { layers: InternalVideoLayoutLayer[] }`
...
\*\*Type:\*\* `MemberJoinedEventParams | MemberLeftEventParams | MemberUpdatedEventParams | MemberTalkingEventParams`

### OverlayMap

\*\*Type:\*\* `Map<string, UserOverlay>`
...
\*\*Type:\*\* `Record<string, VideoPosition>`
...
| `store`       | `{ channels: InternalChannels; instanceMap: InstanceMap; runSaga: (saga: Saga, args: { instance: T; runSaga: any }) => Task<any>; sessionEmitter: EventEmitter<ClientEvents, any> }` |          |          |             |
...
| `currentLayout`         | `InternalVideoLayout`                            |          |          | The layout returned from the \`\`layout.changed\`\` event based on the current room layout                                    |
| `currentLayoutEvent`    | `CallLayoutChangedEventParams`                   |          |          | The \`\`layout.changed\`\` event based on the current room layout                                                             |
| `currentPosition`       | `undefined \| VideoPosition`                     |          |          | The current position of the member returned from the \`\`layout.changed\`\` event                                             |
| `getMemberOverlay`      | `(memberId: string) => undefined \| UserOverlay` |          |          | Return the member overlay on top of the root element                                                                          |
...
| `overlayMap`            | `undefined \| OverlayMap`                        |          |          | A JS Map containing all the layers on top of the Root Element                                                                 |
...
| `screenShareList`       | `RoomSessionScreenShare[]`                       |          |          | List of screen share objects                                                                                                  |
...
| `removeAllListeners`   | `(event?: T) => EmitterContract<CallSessionEvents>`                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                 |             |
...
| Method              | Signature                                                                                                                                                                                            | Description |
| ------------------- | ---------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- | ----------- |
| `addDynamicProfile` | `(credentialsId: string, credentials: SignalWireCredentials, addressId: string, addressDetails?: { channels?: number; displayName?: string; name: string; type: ResourceType }) => Promise<Profile>` |             |
| `addProfiles`       | `(params: AddProfilesParams) => Promise<Profile[]>`                                                                                                                                                  |             |
| `addStaticProfile`  | `(credentialsId: string, credentials: SignalWireCredentials, addressId: string, addressDetails?: { channels?: number; displayName?: string; name: string; type: ResourceType }) => Promise<Profile>` |             |
| `dispose`           | `() => Promise<void>`                                                                                                                                                                                |             |
| `disposeClient`     | `(params: DisposeClientParams) => Promise<void>`                                                                                                                                                     |             |
| `getClient`         | `(params: GetClientParams) => Promise<GetClientResult>`                                                                                                                                              |             |
| `getInstance`       | `() => ClientFactory`                                                                                                                                                                                |             |
| `getProfile`        | `(profileId: string) => Promise<null \| Profile>`                                                                                                                                                    |             |
| `getStorageInfo`    | `() => Promise<null \| StorageInfo>`                                                                                                                                                                 |             |
...
| `off`                | `(event: T, fn?: EventListener<EventTypes, T>) => EmitterContract<EventTypes>` |             |
| `on`                 | `(event: T, fn: EventListener<EventTypes, T>) => EmitterContract<EventTypes>`  |             |
| `once`               | `(event: T, fn: EventListener<EventTypes, T>) => EmitterContract<EventTypes>`  |             |
| `removeAllListeners` | `(event?: T) => EmitterContract<EventTypes>`                                   |             |
...
| `options`   | `GetClientParamsOptions` |          |          | Signalwire client options                                                    |
...
| Property | Type                                                                                                   | Optional | Readonly | Description |
| -------- | ------------------------------------------------------------------------------------------------------ | -------- | -------- | ----------- |
| `invite` | `{ accept: (param: CallParams) => CallSession; details: IncomingInvite; reject: () => Promise<void> }` |          |          |             |
...
| Method                 | Signature                                                                         | Description |
| ---------------------- | --------------------------------------------------------------------------------- | ----------- |
| `createInstance`       | `(profile: Profile, options: GetClientParamsOptions) => Promise<ManagedInstance>` |             |
| `dispose`              | `() => Promise<void>`                                                             |             |
| `disposeInstance`      | `(instanceId: string) => Promise<void>`                                           |             |
| `getInstance`          | `(instanceId: string) => Promise<null \| ManagedInstance>`                        |             |
| `getInstanceByProfile` | `(profileId: string) => Promise<null \| ManagedInstance>`                         |             |
...
| Property         | Type                 | Optional | Readonly | Description                                     |
| ---------------- | -------------------- | -------- | -------- | ----------------------------------------------- |
| `client`         | `SignalWireContract` |          |          | The actual SignalWire client instance           |
...
| Property         | Type                                                                            | Optional | Readonly | Description |
| ---------------- | ------------------------------------------------------------------------------- | -------- | -------- | ----------- |
| `addressDetails` | `{ channels?: number; displayName?: string; name: string; type: ResourceType }` | ✓        |          |             |
| `addressId`      | `string`                                                                        |          |          |             |
| `createdAt`      | `number`                                                                        |          |          |             |
...
| `findProfileForAddress`     | `(addressId: string) => Promise<null \| Profile>`                                               |             |
| `getProfile`                | `(profileId: string) => Promise<null \| Profile>`                                               |             |
...
| `join`                 | `() => Promise<void>`                                                                                                                                                                  |             |
| `leave`                | `() => Promise<void>`                                                                                                                                                                  |             |
| `off`                  | `(event: T, fn?: (args: ArgumentMap<RoomSessionDeviceEvents>[Extract<T, "room.left" \| MediaEventNames \| BaseConnectionState>]) => void) => EmitterContract<RoomSessionDeviceEvents>` |             |
| `on`                   | `(event: T, fn: (args: ArgumentMap<RoomSessionDeviceEvents>[Extract<T, "room.left" \| MediaEventNames \| BaseConnectionState>]) => void) => EmitterContract<RoomSessionDeviceEvents>`  |             |
| `once`                 | `(event: T, fn: (args: ArgumentMap<RoomSessionDeviceEvents>[Extract<T, "room.left" \| MediaEventNames \| BaseConnectionState>]) => void) => EmitterContract<RoomSessionDeviceEvents>`  |             |
| `removeAllListeners`   | `(event?: T) => EmitterContract<RoomSessionDeviceEvents>`                                                                                                                              |             |
| `restoreOutboundAudio` | `() => void`                                                                                                                                                                           |             |
| `restoreOutboundVideo` | `() => void`                                                                                                                                                                           |             |
| `sendDigits`           | `(dtmf: string) => Promise<void>`                                                                                                                                                      |             |
| `setAudioDirection`    | `(direction: UpdateMediaDirection) => Promise<void>`                                                                                                                                   |             |
...
| `join`                 | `() => Promise<void>`                                                                                                                                                                            |             |
| `leave`                | `() => Promise<void>`                                                                                                                                                                            |             |
| `off`                  | `(event: T, fn?: (args: ArgumentMap<RoomSessionScreenShareEvents>[Extract<T, "room.left" \| MediaEventNames \| BaseConnectionState>]) => void) => EmitterContract<RoomSessionScreenShareEvents>` |             |
| `on`                   | `(event: T, fn: (args: ArgumentMap<RoomSessionScreenShareEvents>[Extract<T, "room.left" \| MediaEventNames \| BaseConnectionState>]) => void) => EmitterContract<RoomSessionScreenShareEvents>`  |             |
| `once`                 | `(event: T, fn: (args: ArgumentMap<RoomSessionScreenShareEvents>[Extract<T, "room.left" \| MediaEventNames \| BaseConnectionState>]) => void) => EmitterContract<RoomSessionScreenShareEvents>`  |             |
| `removeAllListeners`   | `(event?: T) => EmitterContract<RoomSessionScreenShareEvents>`                                                                                                                                   |             |
| `restoreOutboundAudio` | `() => void`                                                                                                                                                                                     |             |
| `restoreOutboundVideo` | `() => void`                                                                                                                                                                                     |             |
| `sendDigits`           | `(dtmf: string) => Promise<void>`                                                                                                                                                                |             |
| `setAudioDirection`    | `(direction: UpdateMediaDirection) => Promise<void>`                                                                                                                                             |             |
...
| `devTools`                        | `boolean`                                                       | ✓        |          |                                                                                           |
| `host`                            | `string`                                                        | ✓        |          |                                                                                           |
| `incomingCallHandlers`            | `IncomingCallHandlers`                                          | ✓        |          | Call back function to receive the incoming call                                           |
...
| `storage`                         | `SignalWireStorageContract`                                     | ✓        |          | Optional storage implementation for persisting client data                                |
...
| `chat`         | `{ getMessages: (params: GetConversationChatMessageParams) => Promise<GetConversationChatMessageResult>; join: (params: JoinConversationParams) => Promise<JoinConversationResponse>; sendMessage: (params: SendConversationMessageParams) => Promise<SendConversationMessageResponse>; subscribe: (params: ConversationChatMessagesSubscribeParams) => Promise<ConversationSubscribeResult> }`                                                                                                                                                                |          |          |             |
| `conversation` | `{ getConversationMessages: (params: GetConversationMessagesParams) => Promise<GetConversationMessagesResult>; getConversations: (params?: GetConversationsParams) => Promise<GetConversationsResult>; getMessages: (params?: GetMessagesParams) => Promise<GetMessagesResult>; join: (params: JoinConversationParams) => Promise<JoinConversationResponse>; sendMessage: (params: SendConversationMessageParams) => Promise<SendConversationMessageResponse>; subscribe: (callback: ConversationSubscribeCallback) => Promise<ConversationSubscribeResult> }` |          |          |             |
