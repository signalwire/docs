...
<Figure caption="Room Previews">

![a preview of a Video Room. Text at the top reads 'Join a room'. Four previews are shown, each labeled with the room name.](@image/project/video-thumbnail/preview-video-thumbnail.webP)
