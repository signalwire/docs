...
:::tip
For real-time call state changes within your SDK application without webhooks, use the [`onStateChanged`](/sdks/reference/realtime-sdk/voice/call#onstatechanged) event on the Call object instead.
:::
