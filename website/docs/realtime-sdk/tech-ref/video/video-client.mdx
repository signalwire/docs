...
|:-----|:---------|:------------------------|
| `id`<span className="required-arg">Required</span> | `string` | Id of the room session. |
...
| `params.EVENT`<span className="optional-arg">Optional</span> | `Callback` | The event to listen to. List of events can be found [here][link].<br />Example event: (E.g: onRoomStarted) |
...
| Name          | Type                                     |
|:--------------|:-----------------------------------------|
| `roomSession`<span className="required-arg">Required</span> | [`RoomSession`][roomsession-7] |
