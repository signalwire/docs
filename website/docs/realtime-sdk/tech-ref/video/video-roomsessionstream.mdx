...
|:---------|:-----------------------------------------------------|:-----------------------------|
| `stream`<span className="required-arg">Required</span> | [`RoomSessionStream`][roomsessionstream-1] | The stream that has started. |
...
| Name     | Type                                                 | Description                |
|:---------|:-----------------------------------------------------|:---------------------------|
| `stream`<span className="required-arg">Required</span> | [`RoomSessionStream`][roomsessionstream-1] | The stream that has ended. |
