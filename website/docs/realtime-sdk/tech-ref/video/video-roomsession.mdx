...
| `params.EVENT`  | `Callback` | The event to listen to. List og events can be found [here][link-2].<br />Example event: (E.g: `onRoomStarted` |
...
| `params.listen?`       | `Object`         | Object of event listeners. See [RoomSessionPlayback Events][video-roomsessionplayback] for a list of valid events.<br />Example event: (E.g: `onStarted`) |
...
| `params.positions?` | [`VideoPositions`][link-4] | Positions to assign as soon as the new layout is set. |
...
|:-------------------|:------------------------------------|:-----------------------------------------------|
| `params`           | `Object`                            | -                                              |
| `params.positions` | [`VideoPositions`][link-4] | Mapping of member IDs and positions to assign. |
...
|:-----------------|:---------|:-----------------------------------------------------------------------------------------------------------------------------------|
| `params?`        | `Object` | -                                                                                                                                  |
| `params.listen?` | `Object` | Object of event listeners. See [`RoomSessionRecording Events`][video-roomsessionrecording] for a list of valid events. |
...
| `params.listen?` | `Object` | Object of event listeners. See [RoomSessionStream Events][video-roomsessionstream] for a list of valid events. |
...
| Name          | Type                                     |
|:--------------|:-----------------------------------------|
| `roomSession` | [`RoomSession`][roomsession-41] |
...
| Name       | Type                                                    |
|:-----------|:--------------------------------------------------------|
| `playback` | [`RoomSessionPlayback`][roomsessionplayback-12] |
...
| Name        | Type                                                      |
|:------------|:----------------------------------------------------------|
| `recording` | [`RoomSessionRecording`][roomsessionrecording-12] |
...
| Name     | Type                                                 |
|:---------|:-----------------------------------------------------|
| `stream` | [`RoomSessionStream`][roomsessionstream-8] |
