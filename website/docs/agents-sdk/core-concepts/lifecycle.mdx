...
<Frame caption="Complete Call Lifecycle" className="diagram">
  ![Complete Call Lifecycle](@image/agents-sdk-manual/02_04_lifecycle_diagram1.png)
</Frame>
...
<Frame caption="Call Setup" className="diagram">
  ![Call Setup](@image/agents-sdk-manual/02_04_lifecycle_diagram2.png)
</Frame>
...
<Frame caption="AI Conversation Loop" className="diagram">
  ![AI Conversation Loop](@image/agents-sdk-manual/02_04_lifecycle_diagram3.png)
</Frame>
...
<Frame caption="SWAIG Function Call" className="diagram">
  ![SWAIG Function Call](@image/agents-sdk-manual/02_04_lifecycle_diagram4.png)
</Frame>
...
<Frame caption="Call Ending" className="diagram">
  ![Call Ending](@image/agents-sdk-manual/02_04_lifecycle_diagram5.png)
</Frame>
