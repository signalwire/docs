...
<Frame caption="SignalWire Agents SDK Architecture" className="diagram">
  ![SignalWire Agents SDK Architecture](@image/agents-sdk-manual/02_01_architecture_diagram1.png)
</Frame>
...
<Frame caption="AgentBase Mixin Composition" className="diagram">
  ![AgentBase](@image/agents-sdk-manual/02_01_architecture_diagram2.png)
</Frame>
