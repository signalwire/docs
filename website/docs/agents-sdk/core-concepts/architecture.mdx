...
| [SWML](/sdks/agents-sdk/api) | Understanding SWML document structure |
| [SWAIG](/sdks/agents-sdk/api/swaig-actions) | How AI calls your functions |
| [Lifecycle](lifecycle) | Request/response flow |
| [Security](/sdks/agents-sdk/security) | Authentication and token security |
