...
| [SwaigFunctionResult API](/sdks/agents-sdk/api/function-result) | Return value and actions reference |
...
| [swaig-test CLI](/sdks/agents-sdk/api/cli/swaig-test) | Testing tool reference |
...
| [Config Files](/sdks/agents-sdk/api/configuration) | File-based configuration |
...
| Topic | Reference |
|-------|-----------|
| Creating prompts | [Prompts [Prompts & POM](/sdks/agents-sdk/building-agents/prompts-pom) POM](/sdks/agents-sdk/building-agents/prompts-pom) |
| Voice configuration | [Voice [Voice & Language](/sdks/agents-sdk/building-agents/voice-language) Language](/sdks/agents-sdk/building-agents/voice-language) |
| Function definitions | [SWAIG Function API](/sdks/agents-sdk/api/swaig-function) |
| Function results | [SwaigFunctionResult API](/sdks/agents-sdk/api/function-result) |
| Multi-step workflows | [ContextBuilder API](/sdks/agents-sdk/api/contexts) |
| Testing agents | [swaig-test CLI](/sdks/agents-sdk/api/cli/swaig-test) |
