...
<Frame caption="Caller Flow" className="diagram">
  ![Caller Flow](@image/agents-sdk-manual/08_03_mapping-numbers_diagram1.png)
</Frame>
...
<Frame caption="New SWML Script">
  ![New SWML Script](@image/agents-sdk-manual/08_03_mapping-numbers_diagram3.png)
</Frame>
...
<Frame caption="Back to Resources">
  ![Back to Resources](@image/agents-sdk-manual/08_03_mapping-numbers_diagram4.png)
</Frame>
...
<Frame caption="Add an Address">
  ![Add an Address](@image/agents-sdk-manual/08_03_mapping-numbers_diagram5.png)
</Frame>
