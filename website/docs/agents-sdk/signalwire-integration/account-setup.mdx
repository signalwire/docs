...
<Frame caption="SignalWire Integration" className="diagram">
  ![SignalWire Integration](@image/agents-sdk-manual/08_01_account-setup_diagram1.png)
</Frame>
...
<Frame caption="Call Flow Architecture" className="diagram">
  ![Call Flow Architecture](@image/agents-sdk-manual/08_01_account-setup_diagram2.png)
</Frame>
