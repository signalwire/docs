...
<Frame caption="Agent Components" className="diagram">
  ![Agent Components](@image/agents-sdk-manual/03_01_agent-base_diagram1.png)
</Frame>
...
<Frame caption="AgentBase Inheritance" className="diagram">
  ![AgentBase Inheritance](@image/agents-sdk-manual/03_01_agent-base_diagram2.png)
</Frame>
...
<Frame caption="Agent Lifecycle" className="diagram">
  ![Agent Lifecycle](@image/agents-sdk-manual/03_01_agent-base_diagram3.png)
</Frame>
