...
> **Summary**: Tune conversation behavior with parameters for speech detection, timeouts, barge control, and AI model settings. For a complete parameter reference, see [AI Parameters Reference](/sdks/agents-sdk/ai-parameters-reference).
...
See the **[AI Parameters Reference](/sdks/agents-sdk/ai-parameters-reference)** in the Appendix.
