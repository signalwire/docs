...
See the [`promote` technical reference](https://developer.signalwire.com/sdks/reference/realtime-sdk/video/video-roomsession#promote)
for a full list of parameters.

`demote` removes the participant's ability to send audio and video.
[Technical reference](https://developer.signalwire.com/sdks/reference/realtime-sdk/video/video-roomsession#demote)
