...
Please check out our [RELAY Browser SDK vs RELAY SDK](/sdks/overview/relay-browser-sdk-v2-vs-v3) for more information.
:::
...
{/* <ReleaseCard version={"@signalwire/js v3.27.0"} releaseType="major"/> */}
