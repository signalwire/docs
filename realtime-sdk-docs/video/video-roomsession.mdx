...
▸ **getMemberMeta**(): `Promise`\<\{ `meta:` [`RoomSessionMember.meta`](./video-roomsessionmember.md#meta) }>
...
`Promise`\<\{ `meta:` [`RoomSessionMember.meta`](./video-roomsessionmember.md#meta) }>
...
▸ **getRecordings**(): `Promise`\<\{ `recordings:` [`RoomSessionRecording`](./video-roomsessionrecording.md) }>

Obtains a list of recordings for the current room session.

#### Returns

`Promise`\<\{ `recordings:` [`RoomSessionRecording`](./video-roomsessionrecording.md) }>

A promise that resolves to an object containing the list of [`RoomSessionRecording`](./video-roomsessionrecording.md) objects.
...
▸ **startRecording**(): `Promise`\<[`RoomSessionRecording`](./video-roomsessionrecording.md)>
...
`Promise`\<[`RoomSessionRecording`](./video-roomsessionrecording.md)>

A promise that resolves to a [`RoomSessionRecording`](./video-roomsessionrecording.md) object.
