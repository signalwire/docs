...
[call-1]: /sdks/reference/realtime-sdk/voice/call
[call-playtts-1]: /sdks/reference/realtime-sdk/voice/call#playtts
[call-prompt-1]: /sdks/reference/realtime-sdk/voice/call#prompt
[community-discord]: https://discord.com/invite/F2WNYTNjuF
[connectphone-1]: /sdks/reference/realtime-sdk/voice/call#connectphone
[connectsip-1]: /sdks/reference/realtime-sdk/voice/call#connectsip
[create-a-signalwire-account-and-space]: https://m.signalwire.com/signups/new?s=1
[device-builder-1]: /sdks/reference/realtime-sdk/voice/devicebuilder
[device-builder]: /sdks/reference/realtime-sdk/voice/device-builder
...
[signalwire-realtime-api-1]: /sdks/reference/realtime-sdk/
[signalwire-realtime-sdk-reference-2]: /sdks/reference/realtime-sdk/
[signalwire-realtime-sdk-reference]: /sdks/reference/realtime-sdk/voice/
...
[voice-client-s-1]: /sdks/reference/realtime-sdk/voice/client
...
Making calls is even simpler. Use the [Voice Client's][voice-client-s-1] `dialPhone` and `dialSip` methods to make calls. In fact, if these are too simple for you, feel free to use the more general purpose `dial` method with [`Device Builder`][device-builder-1] to make series and parallel calls at once.
