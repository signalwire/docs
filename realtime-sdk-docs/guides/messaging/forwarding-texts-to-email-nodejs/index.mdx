...
This code is quite simple. We will create a Node.js script, listen for incoming SMS messages with the [SignalWire's RELAY Realtime API](/sdks/reference/realtime-sdk/), and send an email in response to each message event with Mailgun.js.
...
- [RELAY Realtime SDK](/sdks/reference/realtime-sdk/)
