...
| `params.listen?`           | `Callback`                                               | Callback to listen for events.<br />List of collect events can be found [here](./callcollect.mdx#events).<br />Example event: [`onStarted`](./callcollect.mdx#onstarted)                                              |
...
| `params.listen?`                | `Object`  | Callback to listen for events.<br />List of detect events can be found [here](./calldetect.mdx#events).<br />Example event: [`onStarted`](./calldetect.mdx#onstarted) |
...
| `params.EVENT`  | `Callback` | The event to listen to. List of events can be found [here](#events).<br />Example event: [`onStateChanged`](#onstatechanged) |
...
| `params.listen?`  | `Object`                               | Callback to listen for events.<br />List of playback events can be found [here](./callplayback.mdx#events).<br />Example event: [`onStarted`](./callplayback.mdx#onstarted) |
...
| `params.listen?`         | `Object`                                                 | Callback to listen for events.<br />List of prompt events can be found [here](./callprompt.mdx#events). <br />Example event: [`onStarted`](./callprompt.mdx#onstarted) |
...
| `params.listen?` | `Object` | Callback to listen for events.<br />List of recording events can be found [here](./callrecording.mdx#events).<br />Example event: [`onStarted`](./callrecording.mdx#onstarted) |
...
| `params.listen?` | `Object`                             | Callback to listen for events.<br />List of tap events can be found [here](./calltap.mdx#events).<br />Example event: [`onStarted`](./calltap.mdx#onstarted) |
