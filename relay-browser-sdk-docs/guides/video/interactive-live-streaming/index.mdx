...
As a first option, you can use [RTMP Streaming](/sdks/relay-browser-sdk/guides/video/streaming-to-youtube-and-other-platforms).
...
When using the [Browser SDK](/sdks/relay-browser-sdk), the kind of
...
[RoomSession](/sdks/relay-browser-sdk/video/room-session).
...
[promote](/sdks/relay-browser-sdk/video/room-session#promote)
method:
...
[demote](/sdks/relay-browser-sdk/video/room-session#demote)
method:
...
generation communication platforms. Make sure to check out our [technical documentation](/sdks/relay-browser-sdk/video/room-session#promote).
