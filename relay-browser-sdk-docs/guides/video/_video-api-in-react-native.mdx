...
In this guide we will assume a basic knowledge about our [JavaScript Video SDK](/sdks/relay-browser-sdk). If you want to know more about it, take a look at [Getting Started with the Video API](/video/getting-started/simple-video-demo) and then come back to follow this guide.
...
- [API Reference](/sdks/relay-browser-sdk)
