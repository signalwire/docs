...
Sends a Chat Message to the Conversation. This is the same function as [`chat.sendMessage`](./chat.mdx#sendmessage).
...
were already joined to the conversation. This is the same function as [`chat.join`](./chat.mdx#join).
