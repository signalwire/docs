...
This is the same function as [`conversation.sendMessage`](./conversation.mdx#sendmessage).
...
were already joined to the conversation. This is the same function as [`conversation.join`](./conversation.mdx#join).
