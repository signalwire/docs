...
If you have passed a `rootElement` when [instantiating the SignalWire client](./client/index.mdx#instantiation), or
when [`dial`](./client/index.mdx#dial)ing a call, the SDK will manage the DOM automatically; injecting the resulting video stream
...
| `options.room`                   | [`CallFabricRoomSession`](./client/index.mdx#callfabricroomsession) | Required  | The Call Fabric Room Session to build the video element for                                                                                                                                          |
...
After the [SignalWire Client](./client/index.mdx) has been [instantiated](./client/index.mdx#instantiation), you can
