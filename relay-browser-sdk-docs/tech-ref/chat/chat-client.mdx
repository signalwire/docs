...
▸ **getMembers**(`params`): `Promise<{ members: ChatMemberEntity[] }>` - See [ChatMemberEntity documentation](/sdks/relay-browser-sdk/chat/member-entity) for more details.
...
`Promise<{ members: ChatMemberEntity[] }>` - See [ChatMemberEntity documentation](/sdks/relay-browser-sdk/chat/member-entity) for more details.
...
See [PagingCursor documentation](#paginationcursor) and [ChatMessageEntity documentation](/sdks/relay-browser-sdk/chat/message-entity) for more details.
