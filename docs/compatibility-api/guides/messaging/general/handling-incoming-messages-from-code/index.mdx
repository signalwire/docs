...
Simply open the settings for the number you want to configure, and under "**Messaging Settings**", 
...
in the guide about [Sending and Receiving SMS with the Realtime SDK](/sdks/reference/realtime-sdk/guides/messaging/first-steps-with-messaging).
