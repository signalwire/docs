...
our [Realtime SDK](/sdks/relay-realtime-sdk/). Find more details
in the guide about [Sending and Receiving SMS with the Realtime SDK](/sdks/relay-realtime-sdk/guides/messaging/first-steps-with-messaging).
