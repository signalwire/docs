...
You will only need the [SignalWire Python SDK](/compatibility-api/sdks), and your SignalWire API credentials. If you aren't sure where to find your credentials, check out [this](/platform/dashboard/getting-started/navigating-your-space) guide on naviating your Space.
