...
View [here](/platform/dashboard/getting-started/navigating-your-space#api) to see more about navigating your Space and how to find authentication variables. 
