...
Please follow this knowledge base article for more information on [forwarding an incoming message](/messaging/getting-started/how-to-forward-messages) to another number:
...
For more information about SignalWire cXML and Mustache templates, please review this SignalWire resource [HERE](docs/compatibility-api/cxml/index.mdx).
