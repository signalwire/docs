...
While bins can be created and updated programmatically more info [HERE](/rest/signalwire-rest/endpoints/fabric/list-cxml-applications),
this guide will walk you through cXML applications via the SignalWire Dashboard.
For more on the Dashboard, see our guide to [Navigating Your SignalWire Space](/platform/dashboard/getting-started/navigating-your-space).
