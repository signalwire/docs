...
For this code, the SignalWire Python SDK will need to be installed. It can be accessed here: [SignalWire Python SDK Documentation. ](https://docs.signalwire.com/topics/laml-api/#laml-rest-api-client-libraries-and-sdks-python)
