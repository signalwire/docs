...
To access your recordings, click the **LaML** tab on the left-hand side nav. Click **Recordings**, and you will be able to view, listen, and download your recording files. You will also see the call ID and recording ID that you can use to [access recordings via our API](/rest/compatibility-api/endpoints/retrieve-recording)

<figure>
  <img className="img-800" src={require("./77e869d-277409a-Screen_Shot_2021-08-10_at_2.58.18_PM.webP").default} alt="A screenshot of the Recordings page of the LaML tab in SignalWire. Recordings are organized by source, duration, date, and status." />
</figure>
