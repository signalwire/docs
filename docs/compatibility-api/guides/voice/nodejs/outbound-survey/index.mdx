...
<figure>
  <img className="img-800" src={require("./d806f4b-API_Accounts.webP").default} alt="A screenshot of the SignalWire Dashboard showing the API tab beneath the Project header." />
</figure>
