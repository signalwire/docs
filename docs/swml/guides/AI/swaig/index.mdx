...
<Accordion title="Example request sent to server" description="When your SWAIG function executes, SignalWire sends a request like the following to your server.">
