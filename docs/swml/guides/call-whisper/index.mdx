...
To perform a Call Whisper using SWML, you need to create two [SWML script resources](/platform/call-fabric/resources#swml-scripts). One will utilize the [`connect`](../../methods/connect/index.mdx)
