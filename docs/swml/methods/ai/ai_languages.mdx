...
[tts-providers]: /voice/getting-started/voice-and-languages#tts-providers
...
| `emotion`<span className="optional-arg">Optional</span>                                        | `string`                                           | None                                                                                                                   | Enables emotion detection for the set TTS engine. This allows the AI to express emotions when speaking. A global emotion or specific emotions for certain topics can be set within the prompt of the AI.<br />**IMPORTANT:** Only works with `Cartesia` TTS engine.                                                                                                                            |
