...
| `functions`<span className="optional-arg">Optional</span>      | `string[]` | -                          | An array of [`SWAIG.functions`](../../../ai_swaig/functions/index.mdx) that can be executed from this step.                                                                                                                                                                                  |
