...
Yes - text to speech is simple with either the [Relay Realtime SDK](/sdks/reference/realtime-sdk/v3/voice/call#playtts) or [Compatibility API](/compatibility-api/cxml/voice/say/).
</Accordion>

<Accordion title="What about speech-to-text capabilities?">
Speech to text is available with the `<gather>` verb in our [Compatibility API](/compatibility-api/cxml/voice/gather/) or you can collect speech and transcribe with Node.js using the [Relay Realtime SDK](/sdks/reference/realtime-sdk/v3/voice/call#collect).
</Accordion>
