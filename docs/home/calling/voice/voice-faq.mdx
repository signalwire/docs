...
Yes, SignalWire has all the components to build a very powerful IVR! You could use the [Compatibility API](/compatibility-api), [Relay SDK](sdks/01-overview/00-sdks-technical-reference.mdx), or even build a video/voice solution using our [Javascript SDKs](/sdks/reference/browser-sdk).
