...
Find the many options for what you can do with Relay in our [Relay Realtime SDK reference](/sdks/reference/realtime-sdk/) or [another SDK](pathname:///sdks/) of your choice.

## cXML Webhooks

Using the **cXML Webhooks handler** will open the wide array of options with our [cXML API](/compatibility-api/cxml). This is an easy yet powerful way to control your Domain application. [cXML Webhooks](/platform/phone-numbers/guides/how-to-configure-your-webhook) most often utilize [cXML Applications](/compatibility-api/guides/general/creating-and-using-cxml-applications), our serverless containers for simple SignalWire applications.
