...
If you follow our [guide to creating a SIP endpoint in your SignalWire Space](/voice/getting-started/sip/set-up-a-signalwire-phone-number-with-a-sip-endpoint), 
