...
- [**Relay Browser Applications**](/sdks/relay-browser-sdk/) - A JavaScript SDK for creating SignalWire applications in the browser utilizing SignalWires WebSocket APIs.
- Use the [`dial` method](/sdks/relay-browser-sdk/signalwire-client/client#dial) to dial a resource address that's linked to a SIP endpoint.
- [**Relay Server Applications**](/sdks/relay-realtime-sdk) - A Node.js SDK for creating SignalWire applications on the server utilizing SignalWires WebSocket APIs.
  - Use the [`connectSip` method](/sdks/relay-realtime-sdk/voice/call#connectsip) to connect an existing call to a sip endpoint.
  - Use the [`dialSip` method](/sdks/relay-realtime-sdk/voice/client#dialsip) to create a new call to a sip endpoint.
