...
To learn more about what you can do with Relay, have a look at our [Relay Realtime SDK documentation](/sdks/relay-realtime-sdk/).
...
[RELAY Realtime SDK](/sdks/relay-realtime-sdk/v3/voice/) is our most recent version of RELAY, and dialing out to a SIP endpoint is simpler than ever:
