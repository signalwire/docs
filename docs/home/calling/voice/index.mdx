...
<CardGroup>
  ...
  <Card title="RELAY Realtime Server SDK" icon={<MdRouter/>} href="/sdks/relay-realtime-sdk/voice">
    Next-gen server telephony applications powered by our RELAY WebSocket API
  </Card>
  <Card title="RELAY Browser SDK" icon={<MdPhoneInTalk/>} href="/sdks/relay-browser-sdk/">
...
<CardGroup>
  ...
  <Card title="Build an Interactive Voice Response (IVR) System" icon={<MdCallSplit/>} href="/sdks/relay-realtime-sdk/guides/voice/weather-phone">
