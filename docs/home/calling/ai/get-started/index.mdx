...
<div className="row">
  ...
  <div className="col col--6">
    <Admonition type="info" title="What's a Resource?"><a href="/platform/call-fabric/resources#resource-types">Resources</a> are the building blocks of every SignalWire communication application. Resources include AI Agents, Subscribers, RELAY applications, FreeSWITCH connectors, and more.</Admonition>
  </div>
</div>
