...
In the above file, we are using the [Browser SDK](/sdks/reference/browser-sdk) to establish a video connection to a video room and to display its video stream into a `div`.
