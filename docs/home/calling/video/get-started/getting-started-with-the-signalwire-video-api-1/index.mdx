...
please browse the [SDK documentation](/sdks/relay-browser-sdk).
...
Find the complete list in our [API reference](/sdks/relay-browser-sdk/video/room-session#events).
