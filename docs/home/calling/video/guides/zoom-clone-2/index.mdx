...
1. [The SignalWire Video SDK](/sdks/relay-browser-sdk/video) will run in the client's browser.
...
The `useWebRTC()` hook is the React wrapper for the [`WebRTC`](/sdks/relay-browser-sdk/webrtc) namespace in the SDK.
...
with a [`<RoomPreview/>`](https://signalwire-community.github.io/docs/react/components/roompreview) component ([described in detail here](/sdks/relay-browser-sdk/guides/video/get-thumbnails-for-your-video-calls#react)).
