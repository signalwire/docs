...
Manage [cXML Application](/compatibility-api/guides/general/creating-and-using-cxml-applications/)
...
Manage [SIP Endpoints](/voice/getting-started/sip/set-up-a-signalwire-phone-number-with-a-sip-endpoint/) 
within a SignalWire Project with these commands:
