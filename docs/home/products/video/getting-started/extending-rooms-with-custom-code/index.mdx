...
If you are using [video rooms with UI included](../creating-a-video-room/index.mdx), you don't need to write code: you
...
of parameters in the [documentation](sdks/reference/video-conference-appkit/index.mdx).
...
subscribe to the
[`room.joined`](sdks/reference/browser-sdk/video/video-roomsession.mdx#roomjoined)
event, which will trigger right after the room has been joined. Then, we would
invoke the
[`videoMute`](sdks/reference/browser-sdk/video/video-roomsession.mdx#videomute)
