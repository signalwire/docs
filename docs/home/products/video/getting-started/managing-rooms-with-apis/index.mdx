...
<figure>
  <img
    className="img-800"
    src={
      require("@site/docs/home/platform/dashboard/getting-started/navigating-your-space/3f0a3dd-sw-space-API.webP")
        .default
    }
    alt="A screenshot of the APIs page of a SignalWire Space. The page shows the active Project ID and Space URL, as well as a list of API tokens organized by Name, Token, and Last Used."
  />
  <figcaption>
    In the API section of your SignalWire Space, you will find your project ID, Space URL,
    and active API tokens. If you do not have any tokens listed, you can generate a new
    token and specify scopes.
  </figcaption>
</figure>
