...
Find it at the [Browser SDK Reference](../../../../../sdks/reference/browser-sdk/00-browser-sdk-reference.mdx) section.
...
[First Steps with Video](../../../getting-started/video-first-steps.mdx)).
