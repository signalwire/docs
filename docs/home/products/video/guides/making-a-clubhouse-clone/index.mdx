...
<div style={{ textAlign: "center" }}>
  <video height={400} controls>
    <source
      src="https://user-images.githubusercontent.com/402652/136536891-6dd7f1d3-b3dc-44af-a092-db1f35fa52f7.mp4"
      type="video/mp4"
    />
...
- [JavaScript SDK Technical Reference](/sdks/reference/browser-sdk/00-browser-sdk-reference.mdx) — find here all technical details about the JavaScript SDK.
...
<figure>
  <img
    className="img-800"
    src={require("./98bfb56-Screenshot_2021-10-08_at_20.10.33.webP").default}
    alt="A screenshot of the API tab of a SignalWire Space. The project ID, Space URL, and API token values are circled in red."
  />
  <figcaption>
