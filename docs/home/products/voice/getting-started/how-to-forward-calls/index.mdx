...
SignalWire. To create an XML bin, go to the "LaML" section in your [SignalWire Space](https://signalwire.com/signin), then click on "Bins".
...
<figure>
  <img
    ...
    alt="A screenshot of the LaML page of a SignalWire Space with the 'Bins' tab circled in red."
  />
  <figcaption>
...
<figure>
  <img
    ...
    alt="A screenshot of the Phone Numbers page of a SignalWire Space. A phone number has been configured to accept incoming calls as Voice Calls, and to Handle Calls using LaML Webhooks using the URL of the desired LaML Bin."
  />
  <figcaption>
