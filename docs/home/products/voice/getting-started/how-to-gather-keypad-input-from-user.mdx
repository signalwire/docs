...
learned the basics of using cXML bins to define the behavior of phone calls. In
...
SignalWire. First, to create a new cXML bin, navigate to the "Resources" section from your sidebar. There, create
...
The final step is to configure one of your SignalWire phone numbers to answer calls using the cXML bin we just created. 
