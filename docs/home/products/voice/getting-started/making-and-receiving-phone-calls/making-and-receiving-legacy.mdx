...
<TabItem value="newui" label="New Dashboard">
    ...
    <Frame>
    ![Attach Phone Number](./first-swml-newui.webp)
    </Frame>
...
<TabItem value="legacyui" label="Legacy Dashboard">
    ...
    <Frame>
    ![Attach Phone Number](./first-swml-script.webp)
    </Frame>
...
<TabItem value="newui" label="New Dashboard">
    ...
    <Frame>
    ![Attach Phone Number](./new-cxml-bin.png)
    </Frame>
...
<TabItem value="legacyui" label="Legacy Dashboard">
    ...
    <Frame>
    ![Legacy bin](./legacy-relay-bin.webp)
    </Frame>
...
<TabItem value="newui" label="New Dashboard">
    ...
    <Frame>
    ![Attach Resource](./assign-resource.png)
    </Frame>
...
<TabItem value="legacyui" label="Legacy Dashboard">
    ...
    <Frame>
    ![Legacy bin](./attach-phone-number.webp)
    </Frame>
