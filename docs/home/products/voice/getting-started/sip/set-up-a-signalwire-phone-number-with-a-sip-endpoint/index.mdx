...
x-custom:
  ...
  tags:
    ...
    - getting-started
---
import newEndpointImg from './new-endpoint.webp';
import configNumImg from './config-number.webp';
...
If you want to create a SIP endpoint in your SignalWire Space, visit the [SIP tab](https://my.signalwire.com?page=sip_endpoints) and click **Create a Sip Endpoint**.

<figure>
  <img
    className="img-1080"
    src={newEndpointImg}
    alt="A screenshot of the SIP page of a SignalWire Space. The Endpoints tab is selected, and a blue button is labeled 'Create a SIP Endpoint'."
  />
  <figcaption>
    Create a SIP Endpoint
  </figcaption>
...
`Handle Incoming Calls` section, select `a SIP Endpoint` from the dropdown and choose the SIP endpoint you created.

<figure>
  <img
    className="img-1080"
    src={require('./3b00100-Screen_Shot_2021-08-04_at_1.56.46_PM.webP').default}
