...
If you follow our [guide to creating a SIP endpoint in your SignalWire Space](../set-up-a-signalwire-phone-number-with-a-sip-endpoint/index.mdx), 
your setting options will look like this:

<figure>
  <img className="img-1080" src={require("./new-endpoint.webP").default} alt="A screenshot of the New SIP Endpoint page in the SIP tab of a SignalWire Space, configured to match the linked guide to creating a SIP endpoint in a SignalWire Space." />
...
[complete guide to your SIP space](/platform/dashboard/getting-started/your-signalwire-sip-space).
...
<figure>
  <img className="img-800" src={require("./number-settings.webP").default} alt="A screenshot of the edit page for a phone number. The phone number is named 'SIP Main', and it is configured to accept incoming calls as voice calls and handle using the specified SIP endpoint." />
...
All call logs can be viewed in the Usage tab of your SignalWire Dashboard. 
...
<figure>
  <img className="img-800" src={require("./Usage.webP").default} alt="A screenshot of the Usage tab, organizing call logs by date, resource, charge, and cost." />
  <figcaption>Dashboard Usage History</figcaption>
</figure>
