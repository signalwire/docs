...
- <Tooltips tip="Fillers are speech fillers that help with filling in the void during pauses making the flow of conversation more natural.">Fillers</Tooltips> for function calls and general speech fillers - helps with filling in the void during pauses making the flow of conversation more natural.
...
<PreviewCardGroup columns={2}>
  <PreviewCard title="Traditional IVR Flow" description="Detailed flow of IVR system interactions">
    <TraditionalIVRFlow />
  </PreviewCard>
  <PreviewCard title="AI IVR Flow" description="Detailed flow of IVR system interactions">
    <AIVRFlow />
  </PreviewCard>
</PreviewCardGroup>
