...
When crafting prompts, precision and specificity are crucial. The following elements should be clearly defined:

- Exact objectives and desired outcomes
...
Several key factors determine prompt effectiveness:

- Purpose and end goals
- Target audience characteristics
- Essential background information
- Interaction medium requirements

### Defining boundaries

Successful prompts require clear parameters that establish:
...
When someone asks "Can you hang this picture?", they trust the other person knows:
- How to use basic tools
- What tools are needed
- Basic safety considerations
- Standard hanging techniques

But they would need to specify:
...
Structuring and formatting prompts in a clear, organized way is crucial for effective AI communication. Without proper structure, prompts may lead
to inconsistent or unexpected responses. 
A well-structured prompt typically includes several key sections:
...
To best accomplish separating our prompt into sections, we can utilize Markdown or XML formatting.
...
Prompt development benefits from systematic refinement. The process should follow these steps:
...
Avoid over-optimization. Complex prompts can impede natural interaction, particularly in voice interfaces where conversational flow is crucial.
</Admonition>

### Examples of context definition

<PreviewCardGroup columns={2}>
<PreviewCard title="❌ Poorly defined context" description="This example lacks structure, clear objectives, and proper handling instructions." expandable={false}>
```markdown
...
## Fallback
If they don't want to schedule just talk to them 
...
<PreviewCard title="✅ Well-defined context" description="This example provides clear structure, objectives, and handling procedures." expandable={false}>
```markdown
# Demo booking process
...
- Business email
- Company name
- Preferred demo time (business hours Mon-Fri)
