...
## When to Apply Prompt Engineering in Each Area

Knowing where to apply prompt engineering is crucial for building effective AI agents:

| Application Area | When to Use |
|-------------|-------------|
| Main Conversation | Define overall agent identity and behavioral parameters; establish baseline conversational style |
| Conversation Steps | Create guided, multi-stage workflows; customize behavior for specific phases of interaction |
| Function Definitions | Define external system interactions; guide the AI on when and how to retrieve data or perform actions |
| Post-Conversation Processing | Extract business intelligence after conversations; generate summaries; categorize interactions |
| Ethical Guardrails | Establish ethical boundaries; ensure compliance; override conflicting instructions for safety |

## Next Steps

Now that you understand the different areas where prompt engineering can be applied for SignalWire AI Agents, explore our other guides:
