...
<figure>
  <img className="img-800" src={require("./billing-low-balance.webP").default} alt="A screenshot of the Low Balance Settings page. Settings for a low balance threshold, email notification toggle, auto-top-up amount and source, and webhook request are shown." />
</figure>
