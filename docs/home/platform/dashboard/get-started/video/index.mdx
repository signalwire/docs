---
title: Your SignalWire Video Space
description: Manage your SignalWire video space
slug: /platform/dashboard/getting-started/your-signalwire-video-space
---

# Your SignalWire Video Space

[//]: # "Please avoid changing section headings, title, or page slug as this will break links"
...
Both links will take you to a form to create a **New Video Conference Room**. You have the choice to create a new room with a pre-built UI or without. The pre-built UI option is a pre-built videoconferencing room that you can use with no coding required beyond copy-pasting a code snippet into your application. For a complete walkthrough on room setup, visit the [Video Conferences](/video/getting-started/video-conferences) page. If you need help incorporating the video room into your website, see our guide on [Integrating Video Conferences With Any Website in Minutes](/video/getting-started/creating-a-video-room).

The second option will create the same kind of video room created programmatically with a `POST` request to `<YOUR SPACE>.signalwire.com/api/video/rooms`. See below for more information on different [video conferences](#video-conferences).
...
You can create a new Video Conference room by clicking the "+ New" blue button on the top right. You have the option of creating a room with a prebuilt UI or without. If you choose a room with a prebuilt UI, all you need to do is copy the embeddable code from the room's details page and drop it into your application. For more information on rooms with a prebuilt UI, see our [Video Conferences guide](/video/getting-started/video-conferences) and our guide on [Integrating Video Conferences With Any Website](/video/getting-started/creating-a-video-room).
...
You can then use that token to programmatically start a Room Session, join the room, and display the video in the appropriate div in your application. You can find a full guide to using a video room like this in the [Simple Video Demo](/video/getting-started/simple-video-demo).
