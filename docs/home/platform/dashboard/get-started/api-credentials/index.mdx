...
<Frame caption="The API Credentials page on the SignalWire Dashboard.">
  ![The API Credentials page on the SignalWire Dashboard.](@image/dashboard/credentials/api-credentials.png)
</Frame>
...
Find the correct credentials structure for each specific call in the [SDK Reference](/sdks/reference/realtime-sdk), 
