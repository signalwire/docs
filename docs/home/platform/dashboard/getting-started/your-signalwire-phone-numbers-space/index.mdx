...
# Your SignalWire Phone Numbers Space

[//]: # "Please avoid changing section headings, title, or page slug as this will break links"

Whether you want to use SignalWire phone numbers for voice, messaging, fax, IVR apps, high traffic marketing, or occasional business calls, the Phone Numbers section of your SignalWire Space is the Dashboard to manage all of your SignalWire phone numbers.

SignalWire offers three main types of numbers: **10-digit long code (10DLC)**, **Toll-Free**, and **Short Code**. A 10DLC is a standard phone number suited to local voice services, conversational messaging, and fax. You may prefer to use Toll-Free numbers for business voice services, application messaging, and fax. Short Codes offer unparalleled messaging throughput and deliverability. They are the best choice for messaging-heavy applications.
...
First, you're going to need SignalWire phone numbers. This tab shows all of the 10DLC and Toll-Free phone numbers you have purchased and their capabilities. You can purchase additional phone numbers with the blue "+ New" button on the top right. See more details on the [Buying a Phone Number](/platform/phone-numbers/getting-started/buying-a-phone-number) page.
