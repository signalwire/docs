...
If you want more information about how to use and get started with SIP in SignalWire's platform, check out our [Setting Up a SIP Endpoint](/voice/getting-started/sip/set-up-a-signalwire-phone-number-with-a-sip-endpoint) guide!
