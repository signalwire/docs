...
- [SignalWire Javascript Browser SDK](/sdks/relay-browser-sdk)
- [SignalWire RELAY Realtime SDK](/sdks/relay-realtime-sdk/v3)
...
- [SignalWire Chat API](/rest/signalwire-rest/endpoints/chat/chat-tokens-create)
- [SignalWire Javascript Browser SDK](/sdks/relay-browser-sdk)
- [SignalWire RELAY Realtime SDK](/sdks/relay-realtime-sdk)
...
if you'd like to explore this API, feel free to browse the [SDK documentation](/sdks/relay-browser-sdk).
...
the two endpoints to make calls and send SMS messages using the [SignalWire RELAY Realtime SDK](/sdks/relay-realtime-sdk).
...
method. for more information on the `Call` object, see the [Voice technical reference](/sdks/relay-realtime-sdk/v3/voice/call).
...
the Realtime API Voice Client. The user's input is read over the voice call
using text-to-speech technology and then the call is ended using the `hangup`
method. for more information on the `Call` object, see the [Voice technical reference](/sdks/relay-realtime-sdk/tech-ref/voice/voice-call).
...
the [Messaging technical reference](/sdks/relay-realtime-sdk/v3/messaging/client).
...
The last endpoint sends a message using the `send` method from the Realtime API
Messaging Client. For more information on the `Messaging` client, you can visit
the [Messaging technical reference](/sdks/relay-realtime-sdk/tech-ref/messaging/messaging-client).
