...
First, you need to obtain the [JavaScript SDK](/sdks/reference/browser-sdk/00-browser-sdk-reference.mdx) using one of these two methods.
...
- [Realtime SDK](/sdks/reference/realtime-sdk/relay-v3): receive events from active chat rooms and control them server-side.
