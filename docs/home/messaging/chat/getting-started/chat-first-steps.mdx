...
First, you need to obtain the [JavaScript SDK](/sdks/relay-browser-sdk) using one of these two methods.
...
- [Realtime SDK](/sdks/relay-realtime-sdk/): receive events from active chat rooms and control them server-side.
