...
<figure>
  <img  src={require("./swml_node.webp").default} alt="Execute SWML node example that executes a remote SWML document." />
  <figcaption>Call Flow using the Execute SWML node.</figcaption>
</figure>
