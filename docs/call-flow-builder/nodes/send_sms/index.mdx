...
<figure>
  <img className="img-600" src={require("./send-sms.webP").default} alt="Sending a SMS with a variable in Call Flow Builder" />
  <figcaption>Send SMS with variable</figcaption>
</figure>
...
<figure>
  <img className="img-600" src={require("./sms-whisper.webP").default} alt="Sending a SMS notification as a Call Whisper" />
  <figcaption>SMS Whisper flow</figcaption>
</figure>