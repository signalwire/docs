...
<figure>
  <img className="img-600" src={require("./forward-sip.webP").default} alt="A Call Flow that uses the Forward to Phone node to forward the call to a sip endpoint." />
  <figcaption>Forward to SIP</figcaption>
</figure>
...
<figure>
  <img className="img-600" src={require("./forward-mix.webP").default} alt="A Call Flow that uses the Forward to Phone node to forward the call to multiple numbers." />
  <figcaption>Forward to multiple SIP endpoints and phone numbers sequentially using the Forward to Phone node.</figcaption>
</figure>