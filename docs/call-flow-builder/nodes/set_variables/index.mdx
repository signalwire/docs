...
<figure>
  <img className="img-600" src={require("./set-variables.webP").default} alt="Set Variables node example to save variable from a requests response."/>
  <figcaption>Set variables from a request response.</figcaption>
</figure>
