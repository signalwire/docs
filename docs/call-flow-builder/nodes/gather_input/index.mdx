...
<figure>
  <img className="img-600" src={require("./simple-input.webP").default} alt="Gather Input node example that accepts both DTMF and speech input." />
  <figcaption>
...
<figure>
  <img className="img-600" src={require("./input-loop-protection.webP").default} alt="Call Flow that prevents an infinite loop with a count and condition check." />
  <figcaption>Prevent an infinite loop with a count and condition check.</figcaption>
</figure>
...
<figure>
  <img className="img-600" src={require("./unknown-speech-input.webP").default} alt="Call Flow that accepts any speech and repeats it back to the caller." />
  <figcaption>Accept any speech and repeat back to caller.</figcaption>
</figure>
