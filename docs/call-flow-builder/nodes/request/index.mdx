...
[Using Variables](/docs/call-flow-builder/index.mdx#variables)
...
<figure>
  <img className="img-600" src={require("./request-test.webP").default} alt="Request node example with webhook.site" />
  <figcaption>See what the request looks like with webhook.site.</figcaption>
</figure>
...
<figure>
  <img className="img-600" src={require("./request-time.webP").default} alt="Request node example with timeapi.io" />
  <figcaption>Dynamically route calls based on time.</figcaption>
</figure>
