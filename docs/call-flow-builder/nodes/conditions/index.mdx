...
<figure>
  <img className="img-600" src={require("./block-condition.webP").default} alt="Block or pass through calls based on caller number." />
  <figcaption>Block or pass through calls based on caller number.</figcaption>
</figure>
