...
<figure>
  <img className="img-600" src={require("./simple-voicemail.webP").default} alt="Play Audio or TTS node example that plays a goodbye message." />
  <figcaption>Play TTS and record voicemail.</figcaption>
</figure>
...
<figure>
  <img className="img-600" src={require("./post-voicemail.webP").default} alt="Play Audio or TTS node example POSTS recording to URL." />
  <figcaption>Record voicemail and send URL and call data as a POST request.</figcaption>
</figure>
...
<figure>
  <img className="img-600" src={require("./voicemail-sms.webP").default} alt="Play Audio or TTS node example that sends recording URL as SMS" />
  <figcaption>Record voicemail and send URL and call data as an SMS.</figcaption>
</figure>