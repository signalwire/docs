...
<figure>
    <img 
      className="img-600" 
      src={require("./sample-flow.webP").default} 
      alt="A screenshot of a sample call flow created with Call Flow Builder, showing connections between nodes."
    />
    <figcaption>A sample Call Flow showcasing input-gathering, recording, AI Agent, and TTS features.</figcaption>
</figure>
...
<figure>
  <img className="img-800" src={require("./create_flow.webp").default} alt="Creating a new Call Flow in the SignalWire Dashboard." />
  <figcaption>Creating a new Call Flow.</figcaption>
</figure>
...
<figure>
  <img className="img-800" src={require("./edit_flow.webp").default} alt="Clicking on the edit option for a Call Flow." />
  <figcaption>Editing a Call Flow.</figcaption>
</figure>
...
<figure>
  <img className="img-800" src={require("./add_node.webp").default} alt="Adding a new node to a Call Flow." />
  <figcaption>Adding a new node to a Call Flow.</figcaption>
</figure>
...
<figure>
  <img className="img-800" src={require("./configure_node.webp").default} alt="Configuring a node in a Call Flow." />
  <figcaption>Configuring a node in a Call Flow.</figcaption>
</figure>
...
<figure>
  <img className="img-800" src={require("./delete_node.webp").default} alt="Deleting a node from a Call Flow." />
  <figcaption>Deleting a node from a Call Flow.</figcaption>
</figure>
...
<figure>
  <img className="img-800" src={require("./version_button.webp").default} alt="Opening the version history of a Call Flow." />
  <figcaption>Opening the version history of a Call Flow.</figcaption>
</figure>
...
<figure>
  <img className="img-800" src={require("./deploy_version.webp").default} alt="Deploying a new version of a Call Flow." />
  <figcaption>Deploying a new version of a Call Flow.</figcaption>
</figure>
...
<figure>
  <img className="img-800" src={require("./revert_version.webp").default} alt="Reverting to a previous version of a Call Flow." />
  <figcaption>Reverting to a previous version of a Call Flow.</figcaption>
</figure>
...
<figure>
  <img className="img-600" src={require("./to-variable.webP").default} alt="Using a phone number as a variable in a Call Flow." />
  <figcaption>Pass the caller phone number using a variable.</figcaption>
</figure>
...
<figure>
  <img className="img-600" src={require("./slice-variable.webP").default} alt="Using slice to alter a variable." />
  <figcaption>Use the `slice()` method to alter a variable.</figcaption>
</figure>