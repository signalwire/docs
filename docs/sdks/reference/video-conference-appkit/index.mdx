...
AppKit allows you to include [Video Conferences](/video/getting-started/video-conferences) with
...
[room-session]: sdks/reference/browser-sdk/video/video-roomsession.mdx
[room-session-join]: sdks/reference/browser-sdk/video/video-roomsession.mdx#join
