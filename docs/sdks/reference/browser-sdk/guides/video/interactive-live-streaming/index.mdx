---
slug: /sdks/reference/browser-sdk/guides/video/interactive-live-streaming
author: danieleds
x-custom:
  tags:
    - product:video
...
As a first option, you can use [RTMP Streaming](/sdks/reference/browser-sdk/guides/video/streaming-to-youtube-and-other-platforms).
...
When using the [Browser SDK](docs/sdks/reference/browser-sdk/00-browser-sdk-reference.mdx), the kind of
...
[RoomSession](docs/sdks/reference/browser-sdk/video/video-roomsession.mdx).
...
[promote](docs/sdks/reference/browser-sdk/video/video-roomsession.mdx#promote)
method:
...
[demote](docs/sdks/reference/browser-sdk/video/video-roomsession.mdx#demote)
method:
...
generation communication platforms. Make sure to check out our [technical documentation](docs/sdks/reference/browser-sdk/video/video-roomsession.mdx#promote).
