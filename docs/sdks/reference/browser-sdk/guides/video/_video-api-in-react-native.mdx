...
If you want to build a video-conferencing application on mobile, you can integrate the Video API inside any React Native application. In particular, you can use the [JavaScript Video SDK](/sdks/reference/browser-sdk/00-browser-sdk-reference.mdx) almost as you would on the web.


:::info Looking for the Technical SDK Reference?

Find it at the Browser SDK Reference [here](./docs/sdks/reference/browser-sdk/00-browser-sdk-reference.mdx).
...
In this guide we will assume a basic knowledge about our [JavaScript Video SDK](/sdks/reference/browser-sdk/00-browser-sdk-reference.mdx). If you want to know more about it, take a look at [Getting Started with the Video API](/video/getting-started/simple-video-demo) and then come back to follow this guide.
...
- [API Reference](/sdks/reference/browser-sdk/00-browser-sdk-reference.mdx)
