...
▸ **getMembers**(`params`): `Promise<{ members: ChatMemberEntity[] }>` - See [ChatMemberEntity documentation](./chatmemberentity) for more details.
...
`Promise<{ members: ChatMemberEntity[] }>` - See [ChatMemberEntity documentation](./chatmemberentity) for more details.
...
See [PagingCursor documentation](#paginationcursor) and [ChatMessageEntity documentation](./chatmessageentity) for more details.
