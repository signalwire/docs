...
▸ **getRoomSessions**(): `Promise<{roomSessions: RoomSession[] }>` - See [RoomSession](./video-roomsession.mdx) for more details.

Returns the currently active room sessions.

#### Returns

`Promise<{roomSessions: RoomSession[] }>` - See [RoomSession](./video-roomsession.mdx) for more details.
...
▸ **getRoomSessionById**(`id`): `Promise<{roomSessions: RoomSession[] }>` - See [RoomSession](./video-roomsession.mdx) for more details.
...
Emitted when a room session ends. Your event handler receives an object which is an instance of [Video.RoomSession](./video-roomsession.mdx).
...
Emitted when a room session is started. Your event handler receives an object which is an instance of [Video.RoomSession](./video-roomsession.mdx). Example:
