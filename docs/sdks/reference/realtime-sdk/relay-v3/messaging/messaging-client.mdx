...
▸ **send**(`params`): `Promise<MessagingSendResult>` - See [`MessagingSendResult`](./messaging-messagingsendresult.md)
...
`Promise<MessagingSendResult>` - See [`MessagingSendResult`](./messaging-messagingsendresult.md)
...
| Name      | Type                                                | Description  |
|:----------|:----------------------------------------------------|:-------------|
| `message` | [`MessageContract`](./messaging-messagecontract.md) | The message. |
