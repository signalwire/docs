---
slug: /sdks/reference/realtime-sdk/relay-v4/voice/types
---
...
| `speech.language?`          | `number`   | Language to detect. Default to `"en-US"`. Supported languages [here](/voice/getting-started/voice-and-languages)                                                                                                                                                  |
...
A device to use as a destination for [`tap`](./voice-call.mdx#tap).
