---
slug: /sdks/reference/realtime-sdk/relay-v4/video/video-roomsession
---

# RoomSession

Represents a room session. You can obtain instances of this class by subscribing to the appropriate events from [Video.Client](./video-client.mdx).
...
This example assumes that there is a [`RoomSession`](./video-roomsession.mdx)
already active.
...
Note that in addition to making a participant deaf, this will also automatically mute the microphone of the target participant. If you want, you can then manually unmute it by calling [audioUnmute](./video-roomsession.mdx#audiounmute).
...
we log the metadata for that room. This example assumes that there is a [`RoomSession`](./video-roomsession.mdx)
already active and that members are joining the room.
...
Returns a list of available layouts for the room. To set a room layout, use [`setLayout`](./video-roomsession.mdx#setlayout).
...
A promise that resolves to an object containing the list of [`RoomSessionMembers`](./video-roomsessionmember.md) in the room.
...
▸ **getMemberMeta**(): `Promise`\<\{ `meta:` [`RoomSessionMember.meta`](./video-roomsessionmember#meta) }>
...
`Promise`\<\{ `meta:` [`RoomSessionMember.meta`](./video-roomsessionmember#meta) }>

A promise that resolves to an object containing the metadata assigned to the specified [`RoomSessionMember`](./video-roomsessionmember.md).
...
▸ **getPlaybacks**(): `Promise`\<\{ `playbacks:` [`RoomSessionPlayback`](./video-roomsessionplayback.md) }>

Obtains a list of playbacks for the current room session.

#### Returns

`Promise`\<\{ `playbacks:` [`RoomSessionPlayback`](./video-roomsessionplayback.md) }>

A promise that resolves to an object containing the list of [`RoomSessionPlayback`](./video-roomsessionplayback.md) objects.
...
out the `state`, `url`, and `id` of each playback. This example assumes that there is a [`RoomSession`](./video-roomsession.mdx)
already active and that members are joining the room.
...
▸ **getRecordings**(): `Promise`\<\{ `recordings:` [`RoomSessionRecording`](./video-roomsessionrecording) }>

Obtains a list of recordings for the current room session.

#### Returns

`Promise`\<\{ `recordings:` [`RoomSessionRecording`](./video-roomsessionrecording) }>

A promise that resolves to an object containing the list of [`RoomSessionRecording`](./video-roomsessionrecording) objects.
...
Afterwards, we stop the recording. This example assumes that there is a [`RoomSession`](./video-roomsession.mdx)
already active and that members are joining the room.
...
`Promise<{ streams: RoomSessionStream }>` - See [RoomSessionStream](./video-roomsessionstream.mdx) for more information.
...
Afterwards, we stop the stream after 10 seconds. This example assumes that there is a [`RoomSession`](./video-roomsession.mdx)
already active and that members are joining the room.
...
In this example, we wait for a room ton start and then log the room's name. This example assumes that there is a [`RoomSession`](./video-roomsession.mdx)
already active and that members are joining the room.
...
new participants from joining the room. This example assumes that there is a [`RoomSession`](./video-roomsession.mdx)
already active and that members are joining the room.
...
▸ **play**(`params`): `Promise`\<[`RoomSessionPlayback`](./video-roomsessionplayback.md)>

Start a playback in the room. You can use the returned [RoomSessionPlayback](./video-roomsessionplayback.md)
...
| `params.listen?`       | `Object`         | Object of event listeners. See [RoomSessionPlayback Events](./video-roomsessionplayback.md#events) for a list of valid events.<br />Example event: (E.g: `onStarted`) |

#### Returns

`Promise`\<[`RoomSessionPlayback`](./video-roomsessionplayback.md)>

A promise that resolves to a [`RoomSessionPlayback`](./video-roomsessionplayback.md) object.
...
after 5 seconds. This example assumes that there is a [`RoomSession`](./video-roomsession.mdx)
already active and that members are joining the room.
...
that joins the room after 5 seconds. This example assumes that there is a [`RoomSession`](./video-roomsession.mdx)
already active and that members are joining the room.
...
Show or hide muted videos in the room layout. Members that have been muted via [`videoMute`](./video-roomsession.mdx#videomute) will not appear in the video stream, instead of appearing as a mute image, if this setting is enabled.
...
Sets a layout for the room. You can obtain a list of available layouts with [`getLayouts`](./video-roomsession.mdx#getlayouts).
...
Assigns custom metadata to the specified [`RoomSessionMember`](./video-roomsessionmember.md). You can use this to store metadata whose meaning is entirely defined by your application.
...
[`RoomSession`](./video-roomsession.mdx) already active and
...
▸ **startRecording**(): `Promise`\<[`RoomSessionRecording`](./video-roomsessionrecording)>

Starts the recording of the room. You can use the returned [RoomSessionRecording](./video-roomsessionrecording.md) object to control the recording (e.g., pause, resume, stop).
...
|:-----------------|:---------|:-----------------------------------------------------------------------------------------------------------------------------------|
| `params?`        | `Object` | -                                                                                                                                  |
| `params.listen?` | `Object` | Object of event listeners. See [`RoomSessionRecording Events`](./video-roomsessionrecording.md#events) for a list of valid events. |


#### Returns

`Promise`\<[`RoomSessionRecording`](./video-roomsessionrecording)>

A promise that resolves to a [`RoomSessionRecording`](./video-roomsessionrecording) object.

#### Example

In this example, we wait for a room to start and then start a recording in that room.
We then stop the recording after 5 seconds. This example assumes that there is a [`RoomSession`](./video-roomsession.mdx)
already active and that members are joining the room.
...
▸ **startStream**(): `Promise`\<[`RoomSessionStream`](./video-roomsessionstream.mdx)>

Starts streaming the audio/video of this room to an external service. You can
use the returned [`RoomSessionStream`](./video-roomsessionstream.mdx) object to
...
| `params.listen?` | `Object` | Object of event listeners. See [RoomSessionStream Events](./video-roomsessionstream.mdx#events) for a list of valid events. |

#### Returns

`Promise`\<[`RoomSessionStream`](./video-roomsessionstream.mdx)>

A promise that resolves to a [`RoomSessionStream`](./video-roomsessionstream.mdx) object.

#### Example

In this example, we wait for a room to start and then start a stream in that room.
We then stop the stream after 10 seconds. This example assumes that there is a [`RoomSession`](./video-roomsession.mdx)
already active and that members are joining the room.
...
Note that in addition to allowing a participants to hear the others, this will also automatically unmute the microphone of the target participant. If you want, you can then manually mute it by calling [audioMute](./video-roomsession.mdx#audiomute).
...
This example assumes that there is a [`RoomSession`](./video-roomsession.mdx) already active and users are joining it.
...
there is a [`RoomSession`](./video-roomsession.mdx) already active and
that members are joining the room.
...
will be called with an instance of the [`RoomSession`](./video-roomsession.mdx) object.
...
Your event handler will be called with an instance of the [`RoomSession`](./video-roomsession.mdx) object.
...
will be called with an instance of the [`RoomSessionMember`](./video-roomsessionmember.md) object.
...
will be called with an instance of the [`RoomSessionPlayback`](./video-roomsessionplayback.md) object.

#### Parameters

| Name       | Type                                                    |
|:-----------|:--------------------------------------------------------|
| `playback` | [`RoomSessionPlayback`](./video-roomsessionplayback.md) |
...
will be called with an instance of the [`RoomSessionRecording`](./video-roomsessionrecording.md) object.

#### Parameters

| Name        | Type                                                      |
|:------------|:----------------------------------------------------------|
| `recording` | [`RoomSessionRecording`](./video-roomsessionrecording.md) |
...
will be called with an instance of the [`RoomSessionStream`](./video-roomsessionstream.mdx) object.

#### Parameters

| Name     | Type                                                 |
|:---------|:-----------------------------------------------------|
| `stream` | [`RoomSessionStream`](./video-roomsessionstream.mdx) |
...
▪ **VideoPositions**:  \[ **key**: `string`\]: [`VideoPosition`](/video/guides/layout-positions)
