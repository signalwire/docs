...
You can start a stream with [RoomSession.startStream](./video-roomsession.mdx#startstream).
...
This example assumes that there is a [`RoomSession`](./video-roomsession.mdx) already active and that members are joining the room.
...
|:---------|:-----------------------------------------------------|:-----------------------------|
| `stream` | [`RoomSessionStream`](./video-roomsessionstream.mdx) | The stream that has started. |
...
| Name     | Type                                                 | Description                |
|:---------|:-----------------------------------------------------|:---------------------------|
| `stream` | [`RoomSessionStream`](./video-roomsessionstream.mdx) | The stream that has ended. |
