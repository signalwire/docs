...
slug: /sdks/reference/realtime-sdk/guides/messaging/send-sms-from-the-browser
x-custom:
...
Find the full code on Github [here](https://github.com/signalwire/guides/tree/main/Messaging/Sending%20SMS%20from%20the%20Browser%20-%20NodeJS).

You will need the [SignalWire Realtime SDK](/sdks/reference/realtime-sdk/relay-v3) running on Node.js. It'll help if you are familiar with the Express framework.
...
You will need the [SignalWire Realtime SDK](/sdks/reference/realtime-sdk/relay-v4) running on Node.js. It'll h4lp if you are familiar with the Express framework.

</LangItem>
</Language>

Additionally, you will need a SignalWire account which you can create [here](https://m.signalwire.com/signups/new?s=1). From your SignalWire Space, you need your SignalWire API credentials. If you need help finding these credentials, visit [Navigating your SignalWire Space](/platform/dashboard/getting-started/navigating-your-space).
...
Navigate to [this project](https://github.com/signalwire/guides/tree/main/Messaging/Sending%20SMS%20from%20the%20Browser%20-%20NodeJS)
in the SignalWire Guides GitHub Repo, and follow the instructions in README.md.

</LangItem>
<LangItem value="relayv4">

Navigate to [this project](https://github.com/signalwire/guides/tree/main/Messaging/Sending%20SMS%20from%20the%20Browser%20-%20NodeJS%20Relay%20v4)
in the SignalWire Guides GitHub Repo, and follow the instructions in README.md.
...
While the rest of the parameters to `client.send` (`body`, `to`, `from`) are self-explanatory, the `context` parameter needs an introduction. It is used to segregate calls and messages (so you can, for example, subscribe to events from a group of phone numbers in the same context). For further information, please read [First steps with Messaging](/sdks/reference/realtime-sdk/guides/messaging/first-steps-with-messaging).
...
While the rest of the parameters to `client.send` (`body`, `to`, `from`) are self-explanatory, the `topic` parameter needs an introduction. It is used to segregate calls and messages (so you can, for example, subscribe to events from a group of phone numbers in the same topic). For further information, please read [First steps with Messaging](/guides/first-steps-with-messaging).
...
[RealTime SDK](/sdks/reference/realtime-sdk/relay-v3)

</LangItem>
<LangItem value="relayv4">

[Github Repo](https://github.com/signalwire/guides/tree/main/Messaging/Sending%20SMS%20from%20the%20Browser%20-%20NodeJS%20Relay%20v4)  
[RealTime SDK](/sdks/reference/realtime-sdk/relay-v4)
