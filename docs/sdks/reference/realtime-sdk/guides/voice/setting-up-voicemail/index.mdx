...
<figure>
  ...
  />
  <figcaption>
    To configure your number to handle incoming calls with a Relay application, set
    "Handle calls using" to "Relay Application", then specify the name of a context (here
    we choose "office").
  </figcaption>
</figure>
